...
export const teeNewArticles: Article[] = [
  ...
  {
    slug: "tee-sealing",
    title: "TEE 데이터 봉인: Identity 정책에서 안전한 마이그레이션까지",
    subcategory: "tee-fundamentals",
    sections: [
      { id: "overview", title: "지속성과 개봉 권한" },
      { id: "identity-policy", title: "MRENCLAVE·MRSIGNER 정책" },
      { id: "blob-migration", title: "AEAD Blob과 마이그레이션" },
      { id: "release-gate", title: "Replay·Crash Release gate" },
    ],
  ...
  /* ── Fundamentals: 기존 유지 ── */
  {
    slug: "tee-attestation",
    title: "TEE 원격 증명: 로컬 → 원격 → DCAP",
    subcategory: "tee-fundamentals",
    sections: [
      { id: "overview", title: "원격 증명 전체 흐름" },
      { id: "local", title: "로컬 증명 (EREPORT)" },
      { id: "remote", title: "원격 증명 (EPID/DCAP)" },
      { id: "ias-dcap", title: "IAS vs DCAP 비교" },
    ],
    component: () => import("@/pages/articles/tee/tee-attestation"),
  },
  {
    slug: "tee-sidechannel",
    title: "TEE 사이드채널: Secret에서 관측값까지",
    subcategory: "tee-fundamentals",
    sections: [
      { id: "overview", title: "TEE의 비보장부터" },
      { id: "leakage-model", title: "Leakage model" },
      { id: "spectre-cache", title: "Spectre와 Cache 경로" },
      { id: "mitigation-release", title: "Mitigation 측정 gate" },
    ],
  ...
  {
    slug: "intel-tdx",
    title: "Intel TDX: Trust Domain 기밀 VM (심층 분석)",
    subcategory: "intel-tdx",
    sections: [
  ...
  {
    slug: "arm-cca",
    title: "ARM CCA: Realm Management Architecture (심층 분석)",
    subcategory: "arm-cca",
    sections: [
