...
export const teeNewArticles: Article[] = [
  ...
  },
  {
    ...
    title: "TEE 사이드채널: Spectre, Meltdown, Cache Timing",
    subcategory: "tee-fundamentals",
    sections: [
      { id: "overview", title: "사이드채널 공격이란" },
      { id: "spectre", title: "Spectre & Meltdown" },
      { id: "cache", title: "Cache Timing 공격 (Prime+Probe)" },
      { id: "defense", title: "방어 기법 (Oblivious RAM, Constant Time)" },
    ],
