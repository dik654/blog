...
const gpu: Category = {
  ...
  articles: [
    ...
    },
    {
      ...
      subcategory: "gpu-fundamentals",
      sections: [
        { id: "overview", title: "행렬 곱셈과 스레드 매핑" },
        { id: "naive", title: "나이브 구현" },
        { id: "tiled", title: "타일링: 공유 메모리" },
    ...
    },
    {
      ...
      subcategory: "gpu-fundamentals",
      sections: [
        { id: "overview", title: "Hopper vs 이전 세대" },
        { id: "sm-structure", title: "SM 구조" },
        { id: "tma", title: "TMA" },
        { id: "cluster", title: "Thread Block Cluster" },
        { id: "transformer-engine", title: "Transformer Engine" },
      ],
    ...
    },
    {
      ...
      subcategory: "gpu-fundamentals",
      sections: [
        { id: "overview", title: "병렬 처리 성능 지표" },
        { id: "amdahl", title: "암달의 법칙" },
        { id: "occupancy", title: "점유율" },
        { id: "profiling", title: "Nsight 프로파일링" },
      ],
      component: () => import("@/pages/articles/gpu/cuda-perf-analysis"),
    },
    {
      slug: "msm-ntt",
      title: "MSM & NTT 이론 (Pippenger, Cooley-Tukey)",
      subcategory: "zk-acceleration",
      sections: [
        { id: "overview", title: "MSM & NTT 개요" },
        { id: "pippenger", title: "Pippenger MSM" },
        { id: "ntt", title: "NTT & 나비 연산" },
        { id: "gpu-accel", title: "GPU 병렬화" },
      ],
    ...
    },
    {
      ...
      sections: [
        ...
        {
          id: "bellperson-integration",
          title: "bellperson 통합 & GPU 디스패치",
        },
