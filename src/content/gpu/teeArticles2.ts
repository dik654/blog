...
export const teeArticles2: Article[] = [
  ...
  {
    slug: "keylime",
    title: "Keylime: TPM 증거에서 정책 기반 키 반출까지",
    subcategory: "tee-infra",
    sections: [
      { id: "overview", title: "Agent에서 키 반출까지" },
      { id: "quote-policy", title: "Fresh quote와 정책" },
      { id: "ima-measured-boot", title: "IMA와 Measured Boot" },
      { id: "release-gate", title: "실패·격리·Release gate" },
    ],
