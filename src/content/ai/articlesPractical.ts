...
const compressionArticles: Article[] = [
  ...
  },
  {
    ...
    title: "지식 증류: Teacher Signal에서 Student 검증까지",
    subcategory: "ai-practical-compression",
    sections: [
      { id: "overview", title: "Logit · feature · sequence signal" },
      { id: "logit", title: "Temperature와 soft target artifact" },
      { id: "feature", title: "Representation mapping과 layer match" },
      { id: "llm", title: "Synthetic supervision과 decontamination" },
      { id: "on-policy", title: "Student rollout과 multi-teacher 통합" },
      { id: "self", title: "Generation별 bias와 marginal gain" },
    ],
