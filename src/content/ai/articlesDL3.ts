...
export const dlVisionArticles: Article[] = [
  ...
  {
    slug: "robot-action-representations",
    title: "로봇 action representation: 이산·연속 표현과 chunk 비교",
    subcategory: "ai-vision",
    sections: [
      { id: "overview", title: "Continuous·discrete 사이의 선택" },
      { id: "continuous-vs-discrete", title: "Continuous vs discrete action space" },
      { id: "pose-and-text-actions", title: "6-DoF pose와 coordinate-as-text" },
      { id: "action-chunking", title: "Action chunking과 temporal ensembling" },
      { id: "diffusion-and-flow-heads", title: "Diffusion·flow action head" },
      { id: "comparison-and-boundary", title: "표현 방법 비교와 경계" },
    ],
    component: () => import("@/pages/articles/ai/robot-action-representations"),
  },
  {
    slug: "imitation-learning-and-policy-generalization",
    title: "Imitation learning: demonstration data·behavior cloning·generalization·sim-to-real",
    subcategory: "ai-vision",
    sections: [
      { id: "overview", title: "Demonstration에서 generalization까지" },
      { id: "imitation-and-behavior-cloning", title: "Imitation learning과 behavior cloning" },
      { id: "embodied-data-scaling", title: "Embodied data scaling" },
      { id: "policy-generalization-taxonomy", title: "Policy generalization taxonomy" },
      { id: "sim-to-real-and-domain-randomization", title: "Sim-to-real과 domain randomization" },
      { id: "comparison-and-boundary", title: "네 개념의 비교와 경계" },
    ],
    component: () => import("@/pages/articles/ai/imitation-learning-and-policy-generalization"),
  },
  {
    slug: "vision-language-navigation",
    title: "Vision-Language Navigation: waypoint·SLAM·trajectory memory·two-level alignment",
    subcategory: "ai-vision",
    sections: [
      { id: "overview", title: "VLN을 구성하는 네 층" },
      { id: "vln-taxonomy", title: "VLN·VLN-CE·waypoint prediction" },
      { id: "slam-controller-and-selective-reasoning", title: "SLAM controller와 selective reasoning" },
      { id: "trajectory-and-spatial-temporal-memory", title: "Trajectory와 spatial-temporal memory" },
      { id: "two-level-alignment", title: "Two-level alignment" },
      { id: "comparison-and-boundary", title: "네 층의 비교와 경계" },
    ],
    component: () => import("@/pages/articles/ai/vision-language-navigation"),
  },
  {
    slug: "resnet",
