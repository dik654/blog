...
export const dlFoundationArticles: Article[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "sigmoid", title: "Sigmoid와 logit" },
      { id: "tanh", title: "Tanh와 recurrent gate" },
      { id: "relu", title: "ReLU" },
      { id: "relu-variants", title: "ReLU 이후의 선택지" },
      { id: "comparison", title: "출력 의미부터 고르기" },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "forward-pass", title: "순전파와 중간값" },
      { id: "loss-function", title: "Scalar loss 만들기" },
      { id: "softmax", title: "Softmax와 logits" },
      { id: "cross-entropy", title: "Cross-entropy의 역할" },
      { id: "chain-rule", title: "Chain rule과 VJP" },
      { id: "backprop-derivation", title: "출력에서 weight까지" },
      { id: "gradient-update", title: "Optimizer update" },
