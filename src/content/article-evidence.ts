...
> = {
 ...
 "ai/resnet": [
  ...
  "ai/serving-benchmark-methodology": [
    ...
    { kind: "표준 규칙", label: "MLCommons · MLPerf Inference Rules", href: "https://github.com/mlcommons/inference_policies/blob/master/inference_rules.adoc", note: "Scenario 정의, Server 의 Poisson 도착과 latency 조건 아래 최대 throughput 탐색, 최소 실행 시간·query 수의 근거" },
    { kind: "교과서", label: "Harchol-Balter · Performance Modeling and Design of Computer Systems", href: "https://doi.org/10.1017/CBO9781139226424", note: "Little's law 와 M/M/1 의 W = 1/(μ−λ) 유도, open·closed system 차이의 근거" },
  ],
  ...
  "ai/inference-cost-and-capacity-planning": [
    ...
    { kind: "표준 규칙", label: "MLCommons · MLPerf Inference Datacenter power", href: "https://mlcommons.org/benchmarks/inference-datacenter/", note: "System 전체 AC 전력을 벽에서 재는 performance per watt 측정 기준의 근거" },
  ],
