...
export const filecoinArticles: Article[] = [
  /* ── 개요 & 합의 ── */
  {
    ...
    sections: [
      ...
      { id: "consensus-proofs", title: "합의 & Sealing 파이프라인" },
      { id: "chainstore", title: "ChainStore & StateManager" },
      { id: "block-creation", title: "블록 생성 파이프라인" },
    ],
  ...
  },
  {
    ...
    subcategory: "fil-overview",
    sections: [
      { id: "overview", title: "Expected Consensus 전체 흐름" },
      { id: "sortition", title: "Poisson Sortition" },
      { id: "tipset", title: "Tipset 선택" },
      { id: "validation", title: "블록 검증 파이프라인" },
      { id: "weight", title: "체인 가중치 계산" },
    ],
    component: () => import("@/pages/articles/filecoin/expected-consensus"),
  },
  {
    slug: "filecoin-f3",
    title: "Filecoin F3: Fast Finality (GossiPBFT)",
    subcategory: "fil-overview",
    sections: [
      { id: "overview", title: "왜 F3가 필요한가" },
      { id: "gossipbft", title: "GossiPBFT 프로토콜" },
      { id: "integration", title: "EC + F3 통합" },
    ],
  ...
  /* ── Lotus 내부 (심층) ── */
  {
    ...
    sections: [
      ...
      { id: "tipset-validation", title: "Tipset 검증" },
      { id: "state-computation", title: "상태 계산 & VM" },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "sector-lifecycle", title: "섹터 라이프사이클" },
      { id: "winning-post", title: "WinningPoSt & 블록 생성" },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "storage-deal", title: "스토리지 딜 라이프사이클" },
      { id: "retrieval", title: "리트리벌 마켓" },
    ],
