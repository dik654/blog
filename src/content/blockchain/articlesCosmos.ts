...
export const cosmosArticles: Article[] = [
  ...
  {
    slug: "omni-octane",
    title: "Omni Octane — ABCI와 Engine API payload 경계",
    subcategory: "cosmos-evm",
    sections: [
      { id: "overview", title: "Consensus·adapter·execution 책임" },
      { id: "proposal-build", title: "Payload build와 proposal" },
      { id: "validate-finalize", title: "Validation과 finalized head" },
      { id: "event-release", title: "Event bridge와 release gate" },
    ],
    component: () => import("@/pages/articles/blockchain/omni-octane"),
  },
  {
    slug: "initia-evm",
    title: "Initia MiniEVM: Ethereum transaction과 Cosmos state 경계",
    subcategory: "cosmos-evm",
    sections: [
      { id: "overview", title: "Ethereum 요청이 Cosmos app으로 들어오는 길" },
      { id: "tx-envelope", title: "Transaction 변환과 sequence" },
      { id: "state-bridge", title: "StateDB·token·precompile 경계" },
      { id: "release", title: "실패·재실행·release gate" },
    ],
