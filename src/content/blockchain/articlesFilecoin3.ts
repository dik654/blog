...
export const filecoin3Articles: Article[] = [
  ...
  },
  {
    ...
    subcategory: "fil-theory",
    sections: [
      { id: "overview", title: "VDF 개요 & 동기" },
      { id: "construction", title: "구성: 순차 계산 + 빠른 검증" },
      { id: "applications", title: "응용: DRAND, Irys, Ethereum" },
    ],
  ...
  },
  {
    ...
    subcategory: "fil-theory",
    sections: [
      { id: "overview", title: "DRAND 개요" },
      { id: "protocol", title: "BLS 임계값 서명 프로토콜" },
      { id: "filecoin-integration", title: "Filecoin 연동" },
    ],
