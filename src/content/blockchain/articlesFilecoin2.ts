...
export const filecoin2Articles: Article[] = [
  /* ── 저장 증명 ── */
  {
    ...
    sections: [
      { id: "overview", title: "개요 & 봉인 파이프라인" },
      { id: "sdr", title: "SDR 그래프" },
      { id: "post", title: "PoSt 증명" },
    ],
  ...
  },
  {
    ...
    subcategory: "fil-proofs",
    sections: [
      { id: "overview", title: "봉인 전체 흐름" },
      { id: "pc1", title: "PreCommit1: SDR 그래프 생성" },
      { id: "pc2", title: "PreCommit2: 칼럼 해시 + 트리 R" },
      { id: "commit", title: "C1/C2: Groth16 증명 생성" },
    ],
  ...
  },
  {
    ...
    subcategory: "fil-proofs",
    sections: [
      { id: "overview", title: "PoSt 개요" },
      { id: "window-post", title: "WindowPoSt: 데드라인 & 파티션" },
      { id: "winning-post", title: "WinningPoSt: 블록 보상" },
      { id: "fault-recovery", title: "장애 & 복구" },
    ],
  ...
  },
  {
    ...
    subcategory: "fil-proofs",
    sections: [
      { id: "overview", title: "SNARK 개요" },
      { id: "groth16", title: "Groth16 증명/검증" },
      { id: "gpu", title: "bellperson GPU 가속" },
      { id: "supraseal", title: "SupraSeal 최적화" },
    ],
  ...
  /* ── 핫스토리지 ── */
  {
    ...
    subcategory: "fil-hot",
    sections: [
      { id: "overview", title: "PDP vs PoRep: 왜 다른 증명이 필요한가" },
      { id: "protocol", title: "SHA2 챌린지 & 160바이트 응답" },
      { id: "onchain", title: "온체인 검증 & 스케줄링" },
    ],
