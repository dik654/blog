...
export const ethereum2Articles: Article[] = [
  ...
  {
    slug: "railgun",
    title: "RAILGUN: ZKP 기반 EVM 프라이버시 프로토콜",
  ...
  },
  {
    ...
    subcategory: "eth-helios",
    sections: [
      { id: "overview", title: "왜 부트스트랩이 필요한가" },
      {
        id: "checkpoint-sources",
        title: "체크포인트 소스 (API · 하드코딩 · 사용자)",
      },
      { id: "weak-subjectivity", title: "Weak Subjectivity 유효 기간" },
      { id: "fetch-checkpoint", title: "fetch_checkpoint() HTTP + SSZ 파싱" },
      {
        id: "bootstrap-response",
        title: "Bootstrap 응답 구조 (header + committee + branch)",
      },
      { id: "committee-branch", title: "committee_branch Merkle 증명 검증" },
      { id: "store-init", title: "Store 초기화 (각 필드의 의미)" },
      { id: "first-update", title: "첫 번째 Update 요청" },
      { id: "error-cases", title: "에러 케이스 (만료 · 네트워크 불일치)" },
    ],
  ...
  },
  {
    ...
    subcategory: "eth-helios",
    sections: [
      { id: "overview", title: "왜 BLS 검증인가 (블록 실행 없이 신뢰)" },
      { id: "bls12-381", title: "BLS12-381 곡선 기초 (G1 · G2 · GT · 페어링)" },
      {
        id: "participation-bits",
        title: "참여 비트맵 필터링 (512비트 → 참여자)",
      },
      { id: "aggregate-pubkeys", title: "bls_aggregate_pubkeys() G1 점 합산" },
      { id: "signing-root", title: "compute_signing_root() SSZ + 도메인" },
      { id: "bls-verify", title: "bls_verify() 페어링 비교 (lhs == rhs)" },
      { id: "quorum", title: "2/3 정족수 검사" },
      {
        id: "committee-rotation",
        title: "위원회 교체 (256 에폭 · period 계산)",
      },
      { id: "committee-handoff", title: "위원회 핸드오프 (current → next)" },
    ],
  ...
  },
  {
    ...
    subcategory: "eth-helios",
    sections: [
      { id: "overview", title: "CL 타입 vs EL 타입 비교" },
      { id: "beacon-header", title: "BeaconBlockHeader 필드 상세" },
      { id: "sync-aggregate", title: "SyncAggregate (bits + signature)" },
      { id: "lc-update", title: "LightClientUpdate 구조체" },
      { id: "store", title: "LightClientStore 상태 관리" },
      { id: "fork-domain", title: "Fork · ForkData · Domain 계산" },
      { id: "ssz-serialization", title: "SSZ 직렬화 (이 타입들에 대해)" },
    ],
  ...
  },
  {
    ...
    subcategory: "eth-helios",
    sections: [
      { id: "overview", title: "설정 전체 구조" },
      {
        id: "network-enum",
        title: "Network enum (mainnet · sepolia · holesky)",
      },
      { id: "consensus-spec", title: "ConsensusSpec 파라미터" },
      { id: "client-builder", title: "ClientBuilder 패턴" },
      { id: "rpc-endpoints", title: "CL/EL RPC 엔드포인트 설정" },
      { id: "file-db", title: "FileDB 체크포인트 영속성" },
      { id: "multi-rpc", title: "멀티 RPC Fallback 전략" },
    ],
    component: () => import("@/pages/articles/ethereum/helios-config"),
  },
  {
    slug: "kohaku-provider",
    title: "Kohaku: 프라이버시 우선 이더리움 월렛",
    subcategory: "eth-privacy",
    sections: [
