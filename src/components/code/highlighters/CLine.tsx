...
const KW =
  /\b(struct|union|enum|typedef|void|int|char|unsigned|long|short|bool|uint8_t|uint16_t|uint32_t|uint64_t|int32_t|int64_t|size_t|ssize_t|u8|u16|u32|u64|if|else|for|while|do|switch|case|default|return|break|continue|goto|sizeof|static|const|volatile|extern|inline|NULL|true|false|__attribute__|__packed__|__aligned__|ENOSYS|EINVAL|ENOMEM)\b/g;
const STR = /("(?:[^"\\]|\\.)*")/g;
const PP = /^(\s*#\s*\w+)/g;
