...
const KW =
  /\b(pub|fn|let|mut|async|await|impl|struct|use|if|else|return|Ok|Err|match|for|where|Arc|Box|Option|Some|None|true|false|self|Self|super|crate|mod|type|const|static|enum|trait|dyn|move|in|ref|loop|break|continue|unsafe|extern)\b/g;
const STR = /("(?:[^"\\]|\\.)*")/g;
const MAC = /\b(\w+)!/g;
