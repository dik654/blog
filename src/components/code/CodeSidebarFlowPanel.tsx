...
export default function CodeSidebarFlowPanel({
  ...
  return (
    <div
      className="border-t border-[#d0d7de] dark:border-[#30363d] flex flex-col min-h-0"
    ...
    >
      ...
      >
        ...
        <span className="text-[11px] font-semibold text-[#0969da] dark:text-[#58a6ff]">
          호출 흐름 탐색
        </span>
        {!flowOpen && (
          <span className="text-xs text-[#57606a] dark:text-[#8b949e] ml-1">
            — 색상 구간 클릭 또는 여기서 열기
          </span>
        )}
