        ...
        {codeRef.code.split("\n").map((line, i) => {
          ...
          return (
            <tr
              ...
              style={
                c
                  ...
                  : hl
                    ? { backgroundColor: "rgb(255,251,204)" }
                    : undefined
              }
            ...
            >
              ...
              <td
                className="pl-5 pr-5 py-0 whitespace-pre align-top text-[#24292f] dark:text-[#e6edf3]"
                style={
                  c
