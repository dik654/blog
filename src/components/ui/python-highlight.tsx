...
const KEYWORDS =
  /\b(def|class|import|from|if|elif|else|for|while|return|self|async|await|with|try|except|finally|raise|as|in|not|and|or|is|None|True|False|yield|lambda|pass|break|continue|assert)\b/g;
