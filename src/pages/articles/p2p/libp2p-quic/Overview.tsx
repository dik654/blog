...
const COMPARE = [
  {
    label: "TCP",
    steps: ["TCP 연결", "Noise 핸드셰이크", "Yamux 협상"],
    color: "#ef4444",
    rtt: "3 RTT",
  },
  {
    label: "QUIC",
    steps: ["QUIC 1-RTT (TLS 1.3 + Mux 내장)"],
    color: "#06b6d4",
    rtt: "1 RTT",
  },
];
  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          TCP 기반 libp2p는 연결 후 <strong>Noise + Yamux</strong> 업그레이드가
          필요하다.
          <br />
          QUIC는 TLS 1.3과 멀티플렉싱이 내장되어 Transport 하나로 Security+Mux가
          완료된다.
        </p>
        <p>
          <strong>설계 판단:</strong> Output이 <code>(PeerId, Connection)</code>
          이다.
          <br />
          TCP처럼 StreamMuxerBox로 감싸지 않는다. QUIC 자체가 멀티플렉서이기
          때문이다. 0-RTT도 가능하지만 리플레이 공격 때문에 1-RTT만 사용한다.
        </p>
