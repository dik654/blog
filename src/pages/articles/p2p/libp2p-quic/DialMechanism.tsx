...
export default function DialMechanism({
  onCodeRef,
}: {
    ...
    <section id="dial-mechanism" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h3 className="text-xl font-semibold mt-6 mb-3">
          eligible_listener() — 결정론적 선택
        </h3>
        <p>
          리스너가 여러 개일 때 SocketAddr를 해시해서 인덱스를 결정한다.
          <strong>같은 대상이면 항상 같은 리스너.</strong> 홀 펀칭에서 양쪽이
          같은 소켓 쌍을 써야 NAT 매핑이 일치하기 때문이다.
        </p>
        <p>
          <strong>"l" 문자열:</strong> <code>connect_with()</code> 세 번째
          인자는 SNI다. libp2p는 도메인이 아닌 PeerId 기반이므로 더미 값
          &quot;l&quot;을 넣는다.
        </p>
        {onCodeRef && (
