    ...
    annotations: [
      {
        lines: [78, 92],
        color: "sky",
        note: "advance: 질의 발사 + 응답 수신 루프",
      },
      {
        lines: [114, 130],
        color: "emerald",
        note: "startQueries: alpha=3 제한 고루틴 생성",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [114, 130],
        color: "emerald",
        note: "startQueries: 가장 가까운 미질의 노드에 질의",
      },
      {
        lines: [132, 142],
        color: "amber",
        note: "query: FINDNODE RPC + trackRequest",
      },
    ],
  },
  "nodes-by-distance": {
    ...
    annotations: [
      {
        lines: [44, 63],
        color: "sky",
        note: "newLookup: 초기 시드 로드 + asked/seen 설정",
      },
      {
        lines: [94, 103],
        color: "emerald",
        note: "addNodes: seen 필터 + result.push",
      },
    ],
  },
  "do-refresh": {
    ...
    annotations: [
      { lines: [149, 157], color: "sky", note: "lookupIterator 구조체" },
      {
        lines: [175, 212],
        color: "emerald",
        note: "Next(): 버퍼 소진 시 advance/새 lookup",
      },
    ],
  },
  "load-seeds": {
