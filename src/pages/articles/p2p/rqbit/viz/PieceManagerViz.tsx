      ...
      {(step) => (
        ...
        >
          ...
          <motion.rect
            ...
            width={step === 0 ? 40 : step === 1 ? 120 : step === 2 ? 230 : 180}
            animate={{
              width:
                step === 0 ? 40 : step === 1 ? 120 : step === 2 ? 230 : 180,
            }}
          ...
          {Array.from({ length: 14 }).map((_, i) => (
            <motion.rect
              ...
              rx={2}
              fill={
                i < (step === 0 ? 2 : step === 1 ? 6 : step === 2 ? 12 : 9)
                  ? "#10b98140"
                  : "var(--border)"
              }
              animate={{ opacity: 1 }}
