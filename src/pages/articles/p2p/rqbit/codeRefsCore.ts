    ...
    annotations: [
      {
        lines: [109, 111],
        color: "sky",
        note: "db — 토렌트 목록을 담는 HashMap (TorrentId → ManagedTorrentHandle)",
      },
      {
        lines: [115, 121],
        color: "emerald",
        note: "네트워크 — peer_id, DHT, StreamConnector, UDP 트래커 클라이언트",
      },
      {
        lines: [125, 126],
        color: "amber",
        note: "CancellationToken — 세션 종료 시 모든 태스크에 전파",
      },
      {
        lines: [138, 139],
        color: "violet",
        note: "concurrent_initialize_semaphore — 동시 초기화 수 제한",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [97, 99],
        color: "sky",
        note: "SessionDatabase — HashMap<TorrentId, ManagedTorrentHandle>",
      },
      {
        lines: [101, 105],
        color: "emerald",
        note: "add_torrent — 새 토렌트를 DB에 등록",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [68, 68],
        color: "sky",
        note: "Initializing — 파일 무결성 체크 중",
      },
      {
        lines: [69, 69],
        color: "emerald",
        note: "Paused — 체크 완료, 아직 피어 연결 안 함",
      },
      {
        lines: [70, 70],
        color: "amber",
        note: "Live — 피어 연결 중, 다운로드/업로드 활성",
      },
      {
        lines: [71, 71],
        color: "violet",
        note: "Error — 복구 불가능한 오류 발생",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [199, 199],
        color: "sky",
        note: "shared — info_hash, peer_id, 트래커 목록 등 불변 데이터",
      },
      {
        lines: [201, 201],
        color: "emerald",
        note: "metadata — 토렌트 파일 정보 (매그넷 해석 전에는 None)",
      },
      {
        lines: [202, 203],
        color: "amber",
        note: "state_change_notify + locked — 상태 전이 알림 + RwLock 보호 상태",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [183, 183],
        color: "sky",
        note: "info_hash — 토렌트 식별 해시 (SHA-1, 20바이트)",
      },
      {
        lines: [185, 185],
        color: "emerald",
        note: "trackers — 피어를 찾을 트래커 URL 집합",
      },
      {
        lines: [191, 191],
        color: "amber",
        note: "session: Weak<Session> — 순환 참조 방지를 위한 약한 참조",
      },
    ],
  },
};
