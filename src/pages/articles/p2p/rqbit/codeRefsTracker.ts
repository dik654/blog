    ...
    annotations: [
      {
        lines: [24, 24],
        color: "sky",
        note: "queue_pieces — 다운로드 필요한 피스. 요청 시작 시 0으로 전환",
      },
      {
        lines: [27, 28],
        color: "emerald",
        note: "chunk_status — 청크 단위 수신 추적 (피스 내 부분 완료 감지)",
      },
      {
        lines: [31, 31],
        color: "amber",
        note: "have — SHA-1 검증 완료된 피스 비트맵",
      },
      {
        lines: [34, 35],
        color: "violet",
        note: "selected — 사용자가 선택한 파일에 해당하는 피스",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [49, 50],
        color: "sky",
        note: "have_bytes — 검증 완료된 바이트 수",
      },
      {
        lines: [52, 53],
        color: "emerald",
        note: "needed_bytes — 아직 필요한 바이트 수",
      },
      {
        lines: [55, 56],
        color: "amber",
        note: "selected_bytes — 사용자가 선택한 전체 바이트 수",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [29, 32],
        color: "sky",
        note: "InflightPiece — 어떤 피어가 언제부터 다운로드 중인지 기록",
      },
      {
        lines: [36, 46],
        color: "emerald",
        note: "AcquireResult — Reserved / Stolen / NoneAvailable",
      },
      {
        lines: [79, 82],
        color: "amber",
        note: "PieceTracker — chunks + inflight HashMap",
      },
    ],
  },
};
