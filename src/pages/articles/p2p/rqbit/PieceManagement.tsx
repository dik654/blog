  ...
  return (
    <section id="piece-management" className="mb-16 scroll-mt-20">
      ...
      <p className="leading-7 mb-4">
        ManagedTorrent는 토렌트의 전체 생명주기를 상태 머신(State Machine)으로
        관리합니다.
        <br />
        Initializing, Paused, Live, Error 네 가지 상태를 거칩니다.
        <br />각 상태 전환에는 리소스 할당/해제와 비트필드 관리가 수반됩니다.
      </p>
      ...
      {onCodeRef && (
        <div className="not-prose flex flex-wrap gap-2 my-4">
          <CodeViewButton
            onClick={() =>
              onCodeRef("chunk-tracker", codeRefs["chunk-tracker"])
            }
          />
          <CodeViewButton
            onClick={() =>
              onCodeRef("piece-tracker", codeRefs["piece-tracker"])
            }
          />
          <CodeViewButton
            onClick={() =>
              onCodeRef(
                ...
                codeRefs["managed-torrent-state"],
              )
            }
          />
        </div>
      ...
      <div className="mt-6 space-y-4">
        ...
        <p className="leading-7">
          ManagedTorrentLocked는 RwLock으로 보호됩니다.
          <br />
          상태 전환은 take() 메서드로 원자적으로 수행됩니다.
          <br />
