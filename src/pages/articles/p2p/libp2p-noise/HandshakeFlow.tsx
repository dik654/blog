    ...
    <section id="handshake-flow" className="mb-16 scroll-mt-20">
      ...
      <div className="rounded-xl border border-border bg-card p-5 mb-6">
          ...
          {ROUNDS.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-[10px] font-mono text-foreground/40 w-3">
                  {r.round}
                </span>
                <span
                ...
                <span className="text-[10px] text-foreground/50 flex-1 truncate">
                  {r.exchange}
                </span>
              </div>
        ...
        <motion.div
          ...
          style={{
            borderColor: ROUNDS[step].color + "30",
            background: ROUNDS[step].color + "08",
          }}
        >
          <strong style={{ color: ROUNDS[step].color }}>
            Round {ROUNDS[step].round}:
          </strong>{" "}
          {ROUNDS[step].detail}
          {step === 2 && (
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          XX 패턴의 3라운드는 <strong>대칭적</strong>이다.
          <br />
          Initiator와 Responder 모두 identity를 상대에게 공개한다.
        </p>
        <p>
          <strong>payload란?</strong> protobuf로 인코딩된 identity 정보다.
          <br />
          Ed25519 공개키 + DH 공개키에 대한 서명이 들어있다.
          <br />
