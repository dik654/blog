export const CHECKS = [
  {
    ...
    detail:
      '"noise-libp2p-static-key:" 프리픽스 + 원격 DH 공개키를 결합하여 verify() 호출. 실패 시 BadSignature 에러.',
    color: "#6366f1",
  },
  {
    ...
    detail:
      "expected_certhashes.is_subset(remote_certhashes) 검증. WebTransport 연결이 아니면 이 단계를 건너뛴다.",
    color: "#10b981",
  },
  {
    ...
    detail:
      "3라운드 완료 후 snow 라이브러리가 내부 상태를 전환한다. 이후 모든 데이터는 ChaCha20-Poly1305로 암호화/인증.",
    color: "#f59e0b",
  },
];
