  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Noise Framework는 TLS의 대안으로 설계된 암호화 핸드셰이크
          프레임워크다. libp2p는 그중 <strong>XX 패턴</strong>을 채택했다.
        </p>
        <p>
          XX의 핵심: <strong>양쪽 모두 상대의 identity를 모르는 상태</strong>
          에서 시작한다. 3번의 메시지 교환으로 상호 인증 + 암호화 채널을
          수립한다.
        </p>
        <p>
          P2P 환경에서는 CA(인증기관)가 없다.
          <br />
          Noise XX는 공개키 자체가 신원이므로 CA 없이 동작한다.
          <br />
