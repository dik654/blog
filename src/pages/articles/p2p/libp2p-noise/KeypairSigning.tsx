    ...
    <section id="keypair-signing" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong>X25519</strong>(키 교환용)와 <strong>Ed25519</strong>
          (서명용)다.
        </p>
        <p>
          <strong>왜 두 키가 필요한가?</strong> X25519는 DH 연산에 최적화된 키라
          서명이 불가능하다.
          <br />
          Ed25519 identity 키로 DH 공개키를 서명해야 "이 DH 키의 주인이
          누구인지" 증명할 수 있다.
        </p>
        <p>
          도메인 프리픽스 <code>"noise-libp2p-static-key:"</code>는 같은 Ed25519
          키를 다른 맥락에서 재사용해도 서명이 충돌하지 않도록 하는 안전장치다.
        </p>
      </div>
