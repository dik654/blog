    ...
    annotations: [
      {
        lines: [2, 5],
        color: "sky",
        note: "Output/Error — 연결 결과와 에러 타입",
      },
      {
        lines: [15, 19],
        color: "emerald",
        note: "listen_on — Multiaddr 파싱 후 리스닝 시작",
      },
      {
        lines: [25, 29],
        color: "amber",
        note: "dial — 아웃바운드 연결, DialOpts로 포트 재사용 제어",
      },
      {
        lines: [32, 36],
        color: "violet",
        note: "poll — 비동기 이벤트 루프 진입점",
      },
    ],
    ...
    annotations: [
      {
        lines: [2, 3],
        color: "sky",
        note: "NewAddress — OS가 할당한 실제 주소 보고",
      },
      {
        lines: [8, 13],
        color: "emerald",
        note: "Incoming — 새 연결, upgrade Future로 후처리",
      },
      {
        lines: [16, 16],
        color: "amber",
        note: "ListenerClosed — 정상 종료 vs 에러 구분",
      },
    ],
