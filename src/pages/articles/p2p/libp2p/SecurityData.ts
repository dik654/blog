...
export const upgradeAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "multistream-select로 보안 프로토콜 협상",
  },
  {
    lines: [6, 9] as [number, number],
    color: "emerald" as const,
    note: "Noise XX — 3-way 핸드셰이크",
  },
  {
    lines: [13, 13] as [number, number],
...
export const noiseAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "Config — DH 키 + Noise XX 패턴",
  },
  {
    lines: [7, 10] as [number, number],
    color: "emerald" as const,
    note: "AuthenticKeypair — 신원 바인딩",
  },
  {
...
export const yamuxAnnotations = [
  ...
  },
  {
    ...
    color: "emerald" as const,
    note: "12바이트 프레임 헤더 구조",
  },
  {
    lines: [16, 19] as [number, number],
    color: "amber" as const,
    note: "단일 TCP 위 멀티 스트림",
  },
];
...
export const quicAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "Security + Mux 불필요",
  },
  {
    lines: [4, 6] as [number, number],
    color: "emerald" as const,
    note: "연결 마이그레이션 + 0-RTT",
  },
];
