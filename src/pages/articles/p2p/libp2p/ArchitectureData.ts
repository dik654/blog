export const moduleRoles = [
  {
    name: "libp2p-core",
    color: "#6366f1",
    role: "핵심 트레이트: Transport, StreamMuxer, PeerId, Multiaddr 정의",
  },
  {
    name: "libp2p-swarm",
    color: "#10b981",
    role: "이벤트 루프. Behaviour ↔ Transport 중재, 연결 풀 관리",
  },
  {
    name: "libp2p-identity",
    color: "#f59e0b",
    role: "Ed25519/Secp256k1 키 쌍, PeerId 생성·검증",
  },
  {
    name: "libp2p-noise",
    color: "#ec4899",
    role: "Noise XX 핸드셰이크, X25519 DH + 신원 바인딩",
  },
  {
    name: "libp2p-yamux",
    color: "#8b5cf6",
    role: "Yamux 스트림 멀티플렉서. 단일 연결 → 다수 논리 스트림",
  },
  {
    name: "libp2p-tcp",
    color: "#ef4444",
    role: "TCP Transport 구현. tokio/async-std 런타임 지원",
  },
  {
    name: "libp2p-quic",
    color: "#06b6d4",
    role: "QUIC Transport. quinn 기반, TLS 1.3 + Mux 내장",
  },
  {
    name: "libp2p-kad",
    color: "#a855f7",
    role: "Kademlia DHT. Provider/Peer 레코드 저장·조회",
  },
  {
    name: "libp2p-gossipsub",
    color: "#14b8a6",
    role: "GossipSub pub/sub. 메시 네트워크 + 점수 기반 필터링",
  },
];
...
export const dataFlowAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "Transport — TCP/QUIC raw 연결",
  },
  {
    lines: [6, 9] as [number, number],
    color: "emerald" as const,
    note: "Security + Mux — 암호화·스트림 분할",
  },
  {
    lines: [10, 13] as [number, number],
    color: "amber" as const,
    note: "Swarm → Behaviour → App 이벤트 전파",
  },
];
...
export const depGraphAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "core + swarm — 핵심 추상화",
  },
  {
    lines: [8, 15] as [number, number],
    color: "emerald" as const,
    note: "Security·Mux·Transport 구현체",
  },
  {
