    ...
    <section id="nat-traversal" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong> AutoNAT</strong>(탐지) → <strong>Relay</strong>(중계) →{" "}
          <strong>DCUtR</strong>(직접 연결 업그레이드).
        </p>
        ...
        <p>
          Relay 중계 연결은 지연이 높고 대역폭이 제한됩니다.
          <br />
          DCUtR(Direct Connection Upgrade through Relay)은 Relay 경유 연결을
          직접 연결로 업그레이드합니다.
        </p>
        <p>
          <strong>DCUtR</strong> (Direct Connection Upgrade through Relay)
          <br />
          전제: A, B 모두 Relay R에 연결된 상태
          <br />
          1. A → B (via R): Connect — A의 관찰 외부 주소 전달
          <br />
          2. B → A (via R): Connect — B의 관찰 외부 주소 전달
          <br />
          3. 동시 Dial (Simultaneous Open) — NAT 테이블에 아웃바운드 매핑 생성
          <br />
