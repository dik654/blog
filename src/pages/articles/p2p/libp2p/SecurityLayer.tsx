...
import NoiseFrameworkViz from './viz/NoiseFrameworkViz';
import PeerIdBindingViz from './viz/PeerIdBindingViz';
import {
...
export default function SecurityLayer({ title }: { title?: string }) {
  return (
    <section id="security-layer" className="mb-16 scroll-mt-20">
      ...
      <div className="not-prose mb-4"><NoiseFrameworkViz /></div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">

        <h3 className="text-xl font-semibold mt-8 mb-3">libp2p Peer Identity Binding</h3>
      </div>
      <div className="not-prose mb-4"><PeerIdBindingViz /></div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
