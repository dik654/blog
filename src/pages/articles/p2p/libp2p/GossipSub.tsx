  ...
  return (
    <section id="gossipsub" className="mb-16 scroll-mt-20">
      <h2 className="text-2xl font-bold mb-6">
        {title ?? "GossipSub: 메시 네트워크 & 메시지 전파"}
      </h2>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          GossipSub은 <strong>메시 오버레이</strong>와{" "}
          <strong>gossip 계층</strong>을 결합한 pub/sub(발행/구독)
          프로토콜입니다.
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-8">
        ...
        <p>
          GossipSub v1.1은 피어 점수 시스템으로 Sybil 공격(가짜 노드 대량
          생성)과 메시지 스팸을 방어합니다.
          <br />
          점수가 임계값 미만이면 메시에서 제외됩니다.
        </p>
        <CodePanel
          title="Peer Scoring 파라미터"
          code={scoringCode}
