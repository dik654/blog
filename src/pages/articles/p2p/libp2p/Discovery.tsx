...
import DiscoveryStrategyViz from './viz/DiscoveryStrategyViz';
import DiscoveryMechanismDetailViz from './viz/DiscoveryMechanismDetailViz';
import {
...
export default function Discovery({ title }: { title?: string }) {
  return (
    <section id="discovery" className="mb-16 scroll-mt-20">
      ...
      <div className="not-prose mb-4"><DiscoveryStrategyViz /></div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">

        <h3 className="text-xl font-semibold mt-6 mb-3">피어 발견 기법 상세</h3>
      </div>
      <div className="not-prose mb-4"><DiscoveryMechanismDetailViz /></div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
      </div>
    </section>
  );
