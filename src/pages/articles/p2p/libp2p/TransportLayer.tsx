  ...
  return (
    <section id="transport" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Transport 트레이트는 libp2p의 <strong>네트워크 추상화 경계</strong>
          입니다.
          <br />
        ...
        <CodePanel
          title="Transport 트레이트 정의"
          code={transportTraitCode}
        ...
        <table className="w-full text-xs border-collapse">
          <thead>
            <tr className="border-b border-border">
              {["Transport", "Multiaddr", "Security", "Mux", "Latency"].map(
                (h) => (
                  <th
                    key={h}
          ...
          <tbody>
            {transportComparison.map((t) => (
              <tr key={t.transport} className="border-b border-border/30">
                ...
                <td className="py-2 px-3 font-mono text-foreground/50">
                  {t.proto}
                </td>
