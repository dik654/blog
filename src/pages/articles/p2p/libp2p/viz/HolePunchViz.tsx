...
const STEPS = [
  {
    label: "NAT 탐지",
    desc: "AutoNAT으로 A, B 모두 NAT 뒤임을 확인",
    active: ["A", "NAT_A", "B", "NAT_B"],
  },
  {
    label: "Relay 등록",
    desc: "A, B 모두 공개 Relay 서버 R에 예약(Reserve)",
    active: ["A", "NAT_A", "R", "NAT_B", "B"],
    edges: [0, 1],
  },
  {
    label: "주소 교환",
    desc: "A → R → B: Connect + 외부 주소. B → R → A: 응답",
    active: ["A", "NAT_A", "R", "NAT_B", "B"],
    edges: [0, 1, 2],
  },
  {
    label: "Hole Punching",
    desc: "동시 dial로 NAT 매핑 생성. 직접 연결 성공",
    active: ["A", "NAT_A", "NAT_B", "B"],
    edges: [3],
  },
];
