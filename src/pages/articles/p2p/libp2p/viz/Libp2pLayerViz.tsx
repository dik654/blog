...
const LAYERS = [
  ...
  { label: "Swarm", c: "#10b981", tags: ["Behaviour", "Handler", "EventLoop"] },
  {
    label: "Protocol",
    c: "#6366f1",
    tags: ["Kademlia", "GossipSub", "Identify"],
  },
];
...
const STEPS = [
  {
    label: "Transport 계층",
    body: "QUIC 내장 지원, TCP는 Noise + Yamux로 업그레이드",
  },
  {
    label: "Security 계층",
    body: "Noise XX(X25519 + ChaChaPoly) 또는 TLS 1.3(QUIC)",
  },
  {
    label: "Mux 계층",
    body: "단일 연결 위에 독립 논리 스트림 다중화 (Yamux 기본)",
  },
  { label: "Swarm 계층", body: "이벤트 루프가 연결/스트림/프로토콜을 조율" },
  {
    label: "Protocol 계층",
    body: "Kademlia·GossipSub·Identify가 NetworkBehaviour 구현",
  },
];
