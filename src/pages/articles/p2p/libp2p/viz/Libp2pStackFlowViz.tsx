...
const LAYERS = [
  {
    y: 20,
    label: "Application",
    items: ["iroh-blobs", "BitSwap"],
    color: "#ef4444",
  },
  {
    y: 70,
    label: "Protocol",
    items: ["Kademlia", "GossipSub", "Identify"],
    color: "#6366f1",
  },
  {
    y: 120,
    label: "Swarm",
    items: ["이벤트 루프 (Behaviour ↔ Transport)"],
    color: "#10b981",
  },
  {
    y: 170,
    label: "Security",
    items: ["Noise XX (DH 암호화)"],
    color: "#ec4899",
  },
  {
    y: 220,
    label: "Muxer",
    items: ["Yamux (스트림 멀티플렉싱)"],
    color: "#f59e0b",
  },
  {
    y: 270,
    label: "Transport",
    items: ["TCP", "QUIC (Security+Mux 내장)"],
    color: "#8b5cf6",
  },
];
...
const ANNOT = [
  "6계층 모듈식 프로토콜 스택",
  "Kademlia+GossipSub 프로토콜",
  "Swarm 이벤트 루프 중재",
  "Noise XX + Yamux 멀티플렉싱",
  "TCP 조합 또는 QUIC 직접",
];
