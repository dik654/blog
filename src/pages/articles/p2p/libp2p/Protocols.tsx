...
export default function LibP2PProtocols({
  title,
  onCodeRef,
}: {
  title?: string;
  ...
  return (
    <section id="protocols" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          libp2p는 P2P 네트워킹에 필요한 핵심 프로토콜을 모두 내장합니다.
          <br />각 프로토콜은 독립적인 크레이트로 분리돼 있어 필요한 것만 사용할
          수 있습니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-8">
        ...
        <CodePanel
          title="Hole Punching (DCUtR) 과정"
          code={holePunchingCode}
          annotations={[
            {
              lines: [3, 3],
              color: "sky",
              note: "1단계: Relay 서버 경유 연결",
            },
            {
              lines: [9, 11],
              color: "emerald",
