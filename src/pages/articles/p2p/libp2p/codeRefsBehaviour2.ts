    ...
    annotations: [
      {
        lines: [2, 2],
        color: "sky",
        note: "GenerateEvent — 사용자에게 이벤트 반환",
      },
      { lines: [3, 3], color: "emerald", note: "Dial — 새 피어 연결 요청" },
      {
        lines: [6, 6],
        color: "amber",
        note: "NotifyHandler — 특정 연결 핸들러에 메시지 전달",
      },
      {
        lines: [10, 10],
        color: "violet",
        note: "CloseConnection — 연결 종료 명령",
      },
    ],
    ...
    annotations: [
      {
        lines: [4, 4],
        color: "sky",
        note: "ConnectionEstablished — 연결 수립 시 피어/주소 정보",
      },
      {
        lines: [5, 5],
        color: "emerald",
        note: "ConnectionClosed — 종료 원인과 남은 연결 수",
      },
      {
        lines: [7, 8],
        color: "amber",
        note: "DialFailure/ListenFailure — 연결 실패 처리",
      },
      {
        lines: [14, 16],
        color: "violet",
        note: "외부 주소 후보/확인/만료 — NAT 탐지에 사용",
      },
    ],
    ...
    annotations: [
      {
        lines: [3, 9],
        color: "sky",
        note: "연관 타입 — Behaviour↔Handler 메시지 + 프로토콜 업그레이드",
      },
      {
        lines: [12, 14],
        color: "emerald",
        note: "listen_protocol — 인바운드 서브스트림 협상 프로토콜",
      },
      {
        lines: [18, 23],
        color: "amber",
        note: "ConnectionHandlerEvent 반환 — Handler→Behaviour 명령",
      },
      {
        lines: [26, 26],
        color: "violet",
        note: "on_behaviour_event — Behaviour에서 Handler로 메시지 수신",
      },
    ],
