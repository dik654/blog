...
const stunAnnotations: {
  ...
  { lines: [1, 4], color: "sky", note: "Binding Request — 가벼운 UDP 패킷" },
  {
    lines: [6, 8],
    color: "emerald",
    note: "XOR-MAPPED-ADDRESS — NAT 외부 주소 발견",
  },
  {
    lines: [10, 13],
    color: "amber",
    note: "NAT 타입 판별 — Symmetric 여부 확인",
  },
];
    ...
    <section id="stun" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          STUN(Session Traversal Utilities for NAT)은 NAT 외부 주소를 발견하는
          프로토콜입니다.
          <br />
          클라이언트가 STUN 서버에 바인딩 요청을 보내면, 서버는 관측한 공인
          IP:포트를 응답합니다.
          <br />이 주소를{" "}
          <strong>서버 반사 후보(Server Reflexive Candidate)</strong>라 합니다.
        </p>
        <CodePanel
          title="STUN 프로토콜 흐름"
          code={stunCode}
