...
const hpAnnotations: {
...
}[] = [
  {
    lines: [1, 8],
    color: "sky",
    note: "UDP 홀 펀칭 — 동시 전송으로 NAT 매핑 생성",
  },
  {
    lines: [10, 13],
    color: "emerald",
    note: "TCP 홀 펀칭 — Simultaneous Open, 낮은 성공률",
  },
];
    ...
    <section id="hole-punching" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          Hole Punching은 NAT 뒤의 두 피어가 직접 연결하는 핵심 기법입니다.
          <br />
          양쪽이 동시에 상대의 NAT 외부 주소로 패킷을 보내 NAT 매핑을 상호
          생성합니다.
        </p>
        <CodePanel
          title="Hole Punching 절차"
          code={hpCode}
          annotations={hpAnnotations}
        />
        <p className="leading-7">
          Symmetric NAT에서는 목적지마다 매핑이 달라 홀 펀칭이 실패합니다.
          <br />이 경우 TURN(iroh의 DERP, libp2p의 Circuit Relay)이 유일한
          대안입니다.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-3">
          Hole Punching 시퀀스 상세
        </h3>
