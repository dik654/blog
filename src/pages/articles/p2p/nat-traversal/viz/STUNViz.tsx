        ...
        >
          {step === 0 && (
            ...
            >
              ...
              {[
                ...
                "}",
                "",
                "UDP 192.168.1.5:3000 → stun:3478",
              ].map((t, i) => (
                <text
                  key={i}
                  x={20}
          ...
          {step === 1 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.nat}>
                NAT 매핑
              </text>
              {[
                "NAT table += {",
          ...
          {step === 2 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.stun}>
                Binding Response
              </text>
              {[
                "XOR-MAPPED-ADDRESS {",
          ...
          {step === 3 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.r}>
                주소 복원
              </text>
              {[
