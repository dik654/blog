    ...
    annotations: [
      {
        lines: [33, 39],
        color: "sky",
        note: "기본 상수 — 128 블록스토어 워커, 8 태스크 워커",
      },
      {
        lines: [50, 67],
        color: "emerald",
        note: "BitswapOptions — config → []bitswap.Option 변환",
      },
    ],
  },
  "kubo-bitswap-create": {
    ...
    annotations: [
      {
        lines: [84, 88],
        color: "sky",
        note: "serverEnabled, libp2pEnabled, httpEnabled 3개 플래그",
      },
      {
        lines: [92, 97],
        color: "emerald",
        note: "libp2p 네트워크 — bsnet.NewFromIpfsHost",
      },
      {
        lines: [99, 125],
        color: "amber",
        note: "HTTP 네트워크 — httpnet.New (Trustless HTTP 검색)",
      },
      {
        lines: [184, 196],
        color: "violet",
        note: "ProviderQueryManager + bitswap.New 최종 생성",
      },
    ],
  },
  "kubo-noop-exchange": {
    ...
    annotations: [
      {
        lines: [209, 221],
        color: "sky",
        note: "Bitswap 비활성 → noopExchange 반환",
      },
      {
        lines: [227, 229],
        color: "emerald",
        note: "GetBlock → ErrNotFound (로컬 전용)",
      },
    ],
  },
};
