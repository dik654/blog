  ...
  return (
    <section id="content-routing" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Content Routing은{" "}
          <strong>CID로부터 해당 블록을 보유한 피어를 찾는</strong> 과정입니다.
          <br />
          Kubo는 여러 라우터를 병렬로 실행하는 <code>
            ComposableParallel
          </code>{" "}
          구조를 사용합니다.
        </p>
        ...
        <h3>DHT 기반 콘텐츠 발견</h3>
        <p>
          Kademlia DHT의 <code>FIND_PROVIDERS</code> RPC로 CID 해시와 가장
          가까운 노드들을 탐색합니다.
          <br />
          블록 보유 노드는 주기적으로 <code>ADD_PROVIDER</code>로 자신을 DHT에
          등록합니다.
        </p>
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-composer", codeRefs["kubo-composer"])
              }
            />
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-dht-routing", codeRefs["kubo-dht-routing"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              DHT 라우팅
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-http-routing", codeRefs["kubo-http-routing"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              HTTP 위임 라우팅
        ...
        <CodePanel
          title="병렬 라우터 조합"
          code={ROUTING_CODE}
          annotations={ROUTING_ANNOTATIONS}
        />
