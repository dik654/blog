...
export default function PinningGC({
  onCodeRef,
}: {
  ...
  return (
    <section id="pinning-gc" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <ul>
          <li>
            <strong>Recursive Pin</strong> -- 루트 CID와 모든 하위 블록을 보호
          </li>
          <li>
            <strong>Direct Pin</strong> -- 단일 블록만 보호 (하위 불포함)
          </li>
          <li>
            <strong>Indirect Pin</strong> -- 재귀 핀의 하위로 자동 보호
          </li>
        </ul>
        <h3>Blockstore 계층 구조</h3>
        <p>
          Kubo의 블록 저장소는 6계층으로 구성됩니다.
          <br />
          캐싱(Two-Queue), 검증(해시 무결성), GC(락 기반 동시성 제어)를 각각
          담당합니다.
          <br />
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-gc-main", codeRefs["kubo-gc-main"])
              }
            />
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-colored-set", codeRefs["kubo-colored-set"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              ColoredSet (마킹)
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-pin-add", codeRefs["kubo-pin-add"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              Pin.Add API
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-storage-ctor", codeRefs["kubo-storage-ctor"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              Blockstore 생성
        ...
        <CodePanel
          title="GC Mark-and-Sweep"
          code={GC_CODE}
          annotations={GC_ANNOTATIONS}
        />

        <h3 className="text-xl font-semibold mt-6 mb-3">
          Mark-and-Sweep GC 상세
        </h3>
