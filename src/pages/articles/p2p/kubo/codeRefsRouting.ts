  ...
  "kubo-composer": {
    ...
    annotations: [
      { lines: [19, 25], color: "sky", note: "5개 라우터 필드 — 역할별 분리" },
      {
        lines: [27, 35],
        color: "emerald",
        note: "Provide → ProvideRouter에 위임",
      },
      {
        lines: [37, 51],
        color: "amber",
        note: "ProvideMany — 배치 제공 (ProvideManyRouter 캐스팅)",
      },
      {
        lines: [67, 70],
        color: "violet",
        note: "FindProvidersAsync → FindProvidersRouter에 위임",
      },
    ],
  },
  "kubo-parse-routing": {
    ...
    annotations: [
      { lines: [46, 47], color: "sky", note: "라우터 캐시 + Composer 생성" },
      {
        lines: [50, 69],
        color: "emerald",
        note: "메서드별 라우터 매핑 — provide/find-providers 등",
      },
    ],
  },
  "kubo-dht-routing": {
    ...
    annotations: [
      {
        lines: [296, 318],
        color: "sky",
        note: "dhtRoutingFromConfig — 모드별 분기 (auto/client/server)",
      },
      {
        lines: [321, 343],
        color: "emerald",
        note: "createDHT — public/private 네트워크 분기",
      },
      {
        lines: [346, 356],
        color: "amber",
        note: "createFullRT — BucketSize 20의 가속 DHT",
      },
    ],
  },
  "kubo-http-routing": {
    ...
    annotations: [
      {
        lines: [194, 222],
        color: "sky",
        note: "HTTP 클라이언트 — 커넥션풀 500, 호스트당 100",
      },
      {
        lines: [246, 258],
        color: "emerald",
        note: "drclient.New — 위임 라우팅 클라이언트 생성",
      },
      {
        lines: [260, 276],
        color: "amber",
        note: "ContentRoutingClient — 배치 Provide 지원",
      },
    ],
  },
  "kubo-http-wrapper": {
    ...
    annotations: [
      {
        lines: [10, 13],
        color: "sky",
        note: "ProvideManyRouter — Routing + 배치 Provide",
      },
      {
        lines: [22, 27],
        color: "emerald",
        note: "httpRoutingWrapper — 4개 인터페이스 임베딩",
      },
    ],
  },
};
