    ...
    annotations: [
      {
        lines: [50, 56],
        color: "sky",
        note: "GCLock 획득 → DAGService 생성 (오프라인)",
      },
      {
        lines: [65, 66],
        color: "emerald",
        note: "ColoredSet — 핀된 블록 + 자손을 마킹",
      },
      {
        lines: [84, 85],
        color: "amber",
        note: "AllKeysChan — 블록스토어 전체 키 순회",
      },
      {
        lines: [105, 106],
        color: "violet",
        note: "gcs.Has(k) 체크 → 미마킹이면 DeleteBlock",
      },
    ],
  },
  "kubo-colored-set": {
    ...
    annotations: [
      {
        lines: [216, 216],
        color: "sky",
        note: "gcs — CID 집합 (메모리, 향후 블룸 필터 가능)",
      },
      {
        lines: [229, 230],
        color: "emerald",
        note: "RecursiveKeys → Descendants로 자손 순회",
      },
      {
        lines: [273, 279],
        color: "amber",
        note: "DirectKeys → 직접 핀 CID 추가",
      },
      {
        lines: [281, 282],
        color: "violet",
        note: "InternalPins → 피너 내부 메타데이터 보존",
      },
    ],
  },
  "kubo-storage-ctor": {
    ...
    annotations: [
      {
        lines: [44, 47],
        color: "sky",
        note: "ProvideStrategyAll → blockstore.Provider 연결",
      },
      {
        lines: [50, 55],
        color: "emerald",
        note: "생성 순서: Datastore→VerifBS→Cache→IdStore",
      },
      {
        lines: [62, 64],
        color: "amber",
        note: "HashOnRead — 읽기 시 해시 검증 (보안)",
      },
    ],
  },
  "kubo-pin-add": {
    ...
    annotations: [
      {
        lines: [28, 31],
        color: "sky",
        note: "ResolveNode — 경로 → DAG 노드 해석",
      },
      {
        lines: [40, 40],
        color: "emerald",
        note: "PinLock — GC와 동시 실행 방지",
      },
      {
        lines: [42, 47],
        color: "amber",
        note: "Pin → Flush — 핀 등록 후 디스크 반영",
      },
    ],
  },
};
