  ...
  "kubo-gateway-option": {
    ...
    annotations: [
      { lines: [34, 38], color: "sky", note: "Config + Headers 로딩" },
      {
        lines: [40, 48],
        color: "emerald",
        note: "Backend 생성 → Handler 생성 → CORS·OTel 래핑",
      },
      {
        lines: [52, 54],
        color: "amber",
        note: "경로 등록 — /ipfs/, /ipns/ 등",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [146, 149],
        color: "sky",
        note: "기본 모드 — BlockService + Routing + Namesys",
      },
      {
        lines: [151, 178],
        color: "emerald",
        note: "NoFetch=true → 오프라인 교환기 + 오프라인 리졸버",
      },
      {
        lines: [180, 188],
        color: "amber",
        note: "gateway.NewBlocksBackend — 최종 백엔드 생성",
      },
    ],
  },
  "kubo-gateway-config": {
    ...
    annotations: [
      {
        lines: [382, 393],
        color: "sky",
        note: "gateway.Config — 직렬화 응답, 타임아웃, 동시 요청 수",
      },
      {
        lines: [396, 396],
        color: "emerald",
        note: "localhost 서브도메인 게이트웨이 (기본값)",
      },
      {
        lines: [399, 414],
        color: "amber",
        note: "PublicGateways 순회 — nil이면 삭제, 아니면 변환",
      },
    ],
  },
  "kubo-serve-option": {
    ...
    annotations: [
      {
        lines: [30, 30],
        color: "sky",
        note: "ServeOption — mux를 받아 mux를 반환하는 함수 타입",
      },
      {
        lines: [34, 43],
        color: "emerald",
        note: "MakeHandler — 옵션 체인 적용",
      },
      {
        lines: [44, 53],
        color: "amber",
        note: "CONNECT 메서드 처리 + topMux.ServeHTTP",
      },
    ],
  },
};
