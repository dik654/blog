    ...
    annotations: [
      {
        lines: [18, 26],
        color: "sky",
        note: "핵심 — Identity, Datastore, Routing, Gateway",
      },
      {
        lines: [28, 34],
        color: "emerald",
        note: "네트워킹 — Swarm, AutoNAT, AutoTLS, Peering",
      },
      {
        lines: [38, 51],
        color: "amber",
        note: "부가 — Provide, HTTPRetrieval, Pinning, Bitswap",
      },
      {
        lines: [53, 61],
        color: "violet",
        note: "경로 상수 — ~/.ipfs, IPFS_PATH 환경변수",
      },
    ],
  },
  "kubo-routing-config": {
    ...
    annotations: [
      {
        lines: [37, 40],
        color: "sky",
        note: "Type — auto/dht/delegated/custom 중 선택",
      },
      {
        lines: [43, 43],
        color: "emerald",
        note: "AcceleratedDHTClient — FullRT 모드 활성화",
      },
      {
        lines: [50, 51],
        color: "amber",
        note: "DelegatedRouters — HTTP 라우터 URL 목록",
      },
      {
        lines: [53, 54],
        color: "violet",
        note: "Routers/Methods — custom 모드용 상세 설정",
      },
    ],
  },
  "kubo-online-groups": {
    ...
    annotations: [
      {
        lines: [345, 348],
        color: "sky",
        note: "Bitswap 활성화 플래그 — libp2p/HTTP/서버 모드",
      },
      {
        lines: [353, 356],
        color: "emerald",
        note: "Bitswap + OnlineExchange + DNSResolver",
      },
      {
        lines: [358, 361],
        color: "amber",
        note: "Namesys(IPNS) + Peering + Republisher",
      },
      {
        lines: [366, 368],
        color: "violet",
        note: "LibP2P + OnlineProviders 통합",
      },
    ],
  },
};
