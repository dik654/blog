    ...
    annotations: [
      {
        lines: [67, 72],
        color: "sky",
        note: "Self — PeerID + Repo (노드 정체성)",
      },
      {
        lines: [74, 93],
        color: "emerald",
        note: "Local — Pinning, Blockstore, DAG, BlockService",
      },
      {
        lines: [97, 123],
        color: "amber",
        note: "Online — PeerHost, Bitswap, Routing, DHT",
      },
    ...
    annotations: [
      {
        lines: [66, 69],
        color: "sky",
        note: "취소 전파 차단 — valueContext로 래핑",
      },
      {
        lines: [75, 88],
        color: "emerald",
        note: "fx 옵션 조립 — IPFS() + 플러그인",
      },
      {
        lines: [90, 104],
        color: "amber",
        note: "fx.New + stop 클로저 (종료 시 역순 정리)",
      },
      {
        lines: [125, 134],
        color: "violet",
        note: "app.Start → Bootstrap (온라인 모드만)",
      },
    ],
  },
  "kubo-buildcfg": {
    ...
    annotations: [
      {
        lines: [23, 24],
        color: "sky",
        note: "Online — true면 네트워킹 활성화",
      },
      {
        lines: [30, 31],
        color: "emerald",
        note: "Permanent — 데몬 모드면 블룸 필터 등 활성화",
      },
      {
        lines: [37, 39],
        color: "amber",
        note: "Routing/Host — 라우팅·호스트 전략 함수",
      },
    ],
  },
  "kubo-ipfs-fx": {
    ...
    annotations: [
      {
        lines: [405, 406],
        color: "sky",
        note: "BuildCfg 기본값 채우기 + Config 추출",
      },
      {
        lines: [449, 456],
        color: "emerald",
        note: 'providerStrategy 결정 — "all" / "pinned" / "roots"',
      },
      {
        lines: [451, 462],
        color: "amber",
        note: "fx.Options — Storage→Identity→Networked→Core",
      },
    ],
  },
};
