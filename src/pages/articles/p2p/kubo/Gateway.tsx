  ...
  return (
    <section id="gateway" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          IPFS HTTP 게이트웨이는 웹 브라우저와 HTTP 클라이언트가 IPFS 콘텐츠에
          접근할 수 있게 하는 <strong>HTTP-to-IPFS 브리지</strong>입니다.
          <br />
          IPFS 경로를 HTTP URL로 변환하고, 콘텐츠를 표준 HTTP 응답으로
          제공합니다.
        </p>
        <h3>게이트웨이 유형</h3>
        ...
        <h3>NoFetch 모드</h3>
        <p>
          <code>Gateway.NoFetch = true</code> 설정 시 네트워크 블록을 가져오지
          않고 로컬 블록만 서빙합니다.
          <br />
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("kubo-serve-option", codeRefs["kubo-serve-option"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              ServeOption 체인
