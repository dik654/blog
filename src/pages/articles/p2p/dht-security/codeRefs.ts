    ...
    annotations: [
      {
        lines: [3, 6],
        color: "sky",
        note: "두 단계 IP 제한 상수 — /24 서브넷 기준",
      },
      {
        lines: [16, 18],
        color: "amber",
        note: "1단계: 테이블 전역 한도 체크 (/24당 10개)",
      },
      {
        lines: [19, 22],
        color: "rose",
        note: "2단계: 버킷별 한도 체크 (/24당 2개) + 롤백",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [4, 8],
        color: "sky",
        note: "서브넷 프리픽스별 카운터를 맵으로 관리",
      },
      {
        lines: [12, 18],
        color: "emerald",
        note: "한도 미만이면 카운터 증가 후 허용",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [31, 34],
        color: "amber",
        note: "버킷 가득 → 기존 노드 보호, 교체 목록으로",
      },
      { lines: [35, 37], color: "rose", note: "IP 쿼터 통과 필수" },
      {
        lines: [38, 40],
        color: "emerald",
        note: "모든 검사 통과 시 버킷에 추가",
      },
    ],
  },
};
