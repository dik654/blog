  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          discv4의 한계: 평문 통신(도청 가능), reflection 공격, 서비스 광고 기능
          없음.
          <br />
        ...
        <p>
          핵심 변경점:
          <br />
          <strong>WHOAREYOU 핸드셰이크</strong> — 세션 키 교환 후 AES-GCM
          암호화.
          <br />
          <strong>FINDNODE(distances)</strong> — 특정 거리의 노드만 요청 (기존:
          공개키 기반).
          <br />
          <strong>TALKREQ/TALKRESP</strong> — 확장 프로토콜 (portal network 등).
        </p>
        <p>
          go-ethereum <code>v5_udp.go</code> + <code>v5wire/</code> 패키지에서
          구현.
          <br />
...
// ✓ Replay protection (nonces)`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: discv5의 Topic Discovery
          </p>
          <p>
            <strong>Topic Advertisement</strong>: Service registration on DHT
            <br />
            <strong>Use cases</strong>:<br />
            - "eth/67" topic → 이더리움 sync 노드만
            <br />
            - "portal" topic → Portal Network 참여자
            <br />- Custom services (RPC nodes, archive nodes, etc.)
          </p>
          <p className="mt-2">
            <strong>구현 방식</strong>:<br />
            - TOPIC = keccak256(topic_string)
            <br />
            - Nodes "close to" topic hash store advertisements
            <br />
            - REGTOPIC / TOPICQUERY messages
            <br />- Ticket-based DoS mitigation
          </p>
        </div>
      </div>
    </section>
