import PacketStructureViz from './viz/PacketStructureViz';
import HandshakeFlowOverviewViz from './viz/HandshakeFlowOverviewViz';
  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="not-prose mb-4"><PacketStructureViz /></div>

        <h3 className="text-xl font-semibold mt-8 mb-3">WHOAREYOU Handshake</h3>
        <div className="not-prose mb-4"><HandshakeFlowOverviewViz /></div>
