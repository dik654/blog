    ...
    annotations: [
      {
        lines: [3, 4],
        color: "sky",
        note: "secp256k1 스칼라 곱: ephPriv * remotePub",
      },
      {
        lines: [6, 8],
        color: "emerald",
        note: "33바이트 compressed point 직렬화",
      },
      {
        lines: [7, 7],
        color: "amber",
        note: "Y 좌표 패리티 비트로 압축 접두어 결정",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [4, 8],
        color: "sky",
        note: "info = 고정 문자열 + nodeID1 + nodeID2",
      },
      {
        lines: [11, 11],
        color: "emerald",
        note: "HKDF(secret=ECDH, salt=challenge, info)",
      },
      {
        lines: [16, 17],
        color: "amber",
        note: "HKDF 출력에서 writeKey, readKey 순서 추출",
      },
    ],
  },
  ...
  "id-nonce-hash": {
    ...
    annotations: [
      { lines: [4, 4], color: "sky", note: "고정 프리픽스로 도메인 분리" },
      {
        lines: [5, 7],
        color: "emerald",
        note: "challengeData + ephPubkey + destID",
      },
