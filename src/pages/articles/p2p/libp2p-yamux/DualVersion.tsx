...
export default function DualVersion({
  onCodeRef,
}: {
    ...
    <section id="dual-version" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          ...
          <code>Either</code> 열거형으로 두 버전을 감싸고, 런타임에 상대 피어가
          어떤 버전을 쓰든 호환된다.
        </p>
        <p>
          왜 이중 지원? 네트워크 전체가 한 번에 업그레이드되지 않는다.
          <br />
          ...
          {showMode && (
            ...
            >
              ...
              <p className="text-[11px] text-foreground/50 mt-3">
                inbound에서는 Server 모드로, outbound에서는 Client 모드로
                초기화한다.
                <br />이 구분은 yamux의 스트림 ID 할당 규칙(짝수/홀수)에
                사용된다.
              </p>
            </motion.div>
          )}
