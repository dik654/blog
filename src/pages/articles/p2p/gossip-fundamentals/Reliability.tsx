    ...
    <section id="reliability" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          Gossip 프로토콜의 가장 큰 과제는 메시지 중복, 무한 루프, 악의적 노드
          대응입니다.
          <br />
          GossipSub v1.1은 Peer Scoring으로 Sybil 공격을 방어하고, 중복 제거와
          TTL로 대역폭 낭비를 방지합니다.
        </p>
        <CodePanel
          title="GossipSub 신뢰성 메커니즘"
          code={reliabilityCode}
          annotations={relAnnotations}
        />
        <p className="leading-7">
          Ethereum Beacon Chain은 이 스코어링 시스템으로 악의적 검증자의
          메시지를 네트워크 레벨에서 차단합니다.
        </p>
