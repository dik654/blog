...
const STEPS = [
  {
    label: "메시 구성 (D=3)",
    desc: "Publisher가 토픽에 대해 D=3 메시 피어를 유지",
    edges: [],
    gossip: false,
    iwant: false,
  },
  ...
  {
    label: "IHAVE gossip",
    desc: "비-메시 피어에게 IHAVE(메시지 ID만) 전송",
    edges: [0, 1, 2],
    gossip: true,
    iwant: false,
  },
  {
    label: "IWANT 요청",
    desc: "Gossip 피어가 메시지 미보유 시 IWANT으로 요청 → 전체 메시지 수신",
    edges: [0, 1, 2],
    gossip: true,
    iwant: true,
  },
