...
const swimAnnotations: {
  ...
  { lines: [1, 5], color: "sky", note: "SWIM — 장애 감지 + 피기백 전파" },
  {
    lines: [7, 11],
    color: "emerald",
    note: "HyParView — Active/Passive 이중 뷰",
  },
    ...
    <section id="protocols" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          Gossip 프로토콜은 멤버십 관리와 메시지 전파를 동시에 해결합니다.
          <br />
          SWIM은 장애 감지에, HyParView는 오버레이 관리에, PlumTree는 효율적
          브로드캐스트에 특화됩니다.
        </p>
        <CodePanel
          title="주요 Gossip 프로토콜"
          code={swimCode}
