...
import ConnectionIdViz from './viz/ConnectionIdViz';
import PathValidationViz from './viz/PathValidationViz';
  ...
  return (
    <section id="migration" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="not-prose mb-4"><ConnectionIdViz /></div>

        <h3 className="text-xl font-semibold mt-8 mb-3">Path Validation Protocol</h3>
        <div className="not-prose mb-4"><PathValidationViz /></div>
