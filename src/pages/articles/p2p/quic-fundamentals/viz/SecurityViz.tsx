...
const STEPS = [
  {
    label: "Initial 암호화",
    body: "연결 시작 패킷도 HKDF 파생 키로 암호화. 완전 평문 전송 불가.",
  },
  {
    label: "Handshake 암호화",
    body: "TLS 핸드셰이크 진행 중 중간 키로 보호. 서버 인증서도 암호화.",
  },
  {
    label: "1-RTT 데이터 암호화",
    body: "핸드셰이크 완료 후 AEAD(AES-GCM/ChaCha20)로 페이로드 암호화.",
  },
  {
    label: "Header Protection",
    body: "패킷 번호를 별도 키로 암호화. 트래픽 분석 공격 방어.",
  },
];
