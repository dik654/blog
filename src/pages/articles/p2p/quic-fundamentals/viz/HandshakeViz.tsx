...
const STEPS = [
  {
    label: "1-RTT: ClientHello (Initial 패킷)",
        ...
        >
          {step === 0 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.c}>
                ClientHello (Initial)
              </text>
              {[
                "Initial {",
          ...
          {step === 1 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.s}>
                ServerHello
              </text>
              {[
                "Initial: ServerHello {",
          ...
          {step === 2 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.p}>
                1-RTT 완료
              </text>
              {[
          ...
          {step === 3 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.z}>
                0-RTT (PSK)
              </text>
              {[
