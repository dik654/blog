    ...
    <section id="security" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          QUIC는 TLS 1.3을 별도 계층이 아닌 프로토콜에 직접 통합합니다.
          <br />
          모든 QUIC 패킷은 Initial 패킷을 포함해 암호화됩니다.
          <br />
          평문 전송은 불가능합니다.
        </p>
        <CodePanel
          title="QUIC TLS 1.3 보안 구조"
          code={tlsCode}
          annotations={tlsAnnotations}
        />
        <p className="leading-7">
          iroh에서는 rustls 기반 TLS 1.3을 사용합니다. libp2p-quic에서도
          quinn+rustls 조합으로 QUIC 보안을 제공합니다.
          <br />두 프로젝트 모두 자체 서명 인증서와 피어 ID 기반 인증을
          지원합니다.
        </p>
