    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          QUIC는 Google이 설계하고 IETF가 RFC 9000으로 표준화한 전송
          프로토콜입니다.
          <br />
          UDP 위에서 동작하며, TCP+TLS가 제공하는 기능을 단일 프로토콜로
          통합합니다.
          <br />
        ...
        <h3>TCP의 한계</h3>
        <p className="leading-7">
          TCP는 단일 바이트 스트림이므로 하나의 패킷 손실이 모든 데이터를
          차단합니다.
          <br />
          이를 <strong>Head-of-Line(HOL) blocking</strong>이라 합니다.
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          iroh에서는 quinn 크레이트로 QUIC 연결을 구성합니다.
          <br />
