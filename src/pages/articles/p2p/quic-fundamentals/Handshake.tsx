...
import HandshakePacketViz from './viz/HandshakePacketViz';
  ...
  return (
    <section id="handshake" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">QUIC 패킷 타입과 핸드셰이크 단계</h3>
        <div className="not-prose mb-4"><HandshakePacketViz /></div>
      </div>
    </section>
  );
}
