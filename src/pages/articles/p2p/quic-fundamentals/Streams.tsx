...
import StreamIdAndFlowViz from './viz/StreamIdAndFlowViz';
  ...
  return (
    <section id="streams" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Stream ID 와 Flow Control</h3>
        <div className="not-prose mb-4"><StreamIdAndFlowViz /></div>
      </div>
    </section>
  );
}
