  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          discv4 = Ethereum의 첫 번째 노드 발견 프로토콜. Kademlia DHT 위에
          구축된 UDP 기반 프로토콜.
          <br />
        ...
        <p>
          6가지 패킷 타입: PING, PONG, FINDNODE, NEIGHBORS, ENRREQUEST,
          ENRRESPONSE.
          <br />
...
// - Careful sizing to fit IP MTU`}</pre>
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">
          Kademlia in Ethereum Discovery
        </h3>
...
// - Query latency: 3-5 rounds typical`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            <strong>설계 단순성</strong>: ~1000 lines Go code로 구현 가능
            <br />
            <strong>No encryption</strong>: 모든 packet 평문 (signed only)
            <br />
            <strong>Amplification attack</strong>: 36B FINDNODE → 1000B+
            NEIGHBORS
            <br />
          ...
          <p className="mt-2">
            ...
            - AES-GCM encrypted handshake
            <br />
            - Session keys per peer
            <br />
            - Topic discovery (service advertising)
            <br />- Flood control, rate limiting
          </p>
        </div>
      </div>
    </section>
