...
const annotations: {
...
}[] = [
  {
    lines: [2, 7],
    color: "sky",
    note: "레코드 구조: 실제 content_type은 암호화 내부에 숨김",
  },
  {
    lines: [9, 12],
    color: "emerald",
    note: "AEAD: 암호화 + 인증을 단일 연산으로 수행",
  },
  {
    lines: [14, 17],
    color: "amber",
    note: "TLS 1.3은 AEAD만 허용 — CBC, RC4 등 제거",
  },
];
    ...
    <section id="record-protocol" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          TLS 1.3의 레코드 프로토콜은 AEAD(Authenticated Encryption with
          Associated Data)만 사용함.
          <br />
