    ...
    annotations: [
      {
        lines: [31, 40],
        color: "sky",
        note: "lookup — asked/seen 맵, result, replyCh",
      },
      {
        lines: [44, 63],
        color: "emerald",
        note: "newLookup — 로컬 테이블에서 초기 후보 선택",
      },
    ],
  },
  "geth-lookup-advance": {
    ...
    annotations: [
      {
        lines: [78, 92],
        color: "sky",
        note: "advance — replyCh에서 응답 수신 + addNodes",
      },
      {
        lines: [114, 130],
        color: "emerald",
        note: "startQueries — alpha 동시 쿼리, 미질의 노드만",
      },
      {
        lines: [132, 142],
        color: "amber",
        note: "query — goroutine에서 queryfunc 실행 후 응답",
      },
    ],
  },
};
