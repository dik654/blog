  ...
  return (
    <section id="algorithms" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Kademlia의 모든 동작은 4개의 RPC와 1개의 반복 조회 알고리즘으로
          구성됩니다.
        </p>
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("geth-lookup-struct", codeRefs["geth-lookup-struct"])
              }
            />
        ...
        <p>
          단순 재귀 조회 대신 <strong>반복적(iterative)</strong> 방식을
          사용합니다.
          <br />
          조회자가 직접 각 홉을 실행해 네트워크 연결성 문제를 회피합니다.
        </p>
        <CodePanel
          title="반복적 FIND_NODE 알고리즘"
          code={iterativeFindCode}
          annotations={[
            {
              lines: [1, 2],
              color: "sky",
              note: "alpha=3 동시 질의, K=20 목표 노드 수",
            },
            {
              lines: [18, 19],
              color: "emerald",
              note: "alpha개 동시 RPC 전송",
            },
            {
              lines: [33, 35],
              color: "amber",
              note: "수렴 체크 — 최근접 노드 불변 시 종료",
            },
          ]}
        />
          ...
          annotations={[
            {
              lines: [1, 4],
              color: "sky",
              note: "STORE — 가장 가까운 k개에 저장",
            },
            {
              lines: [6, 10],
              color: "emerald",
              note: "GET — FIND_VALUE로 반복 조회",
            },
          ]}
        />
