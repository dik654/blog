  ...
  "geth-v4wire-packets": {
    ...
    annotations: [
      { lines: [39, 46], color: "sky", note: "6가지 패킷 타입 상수 (iota)" },
      {
        lines: [50, 58],
        color: "emerald",
        note: "Ping — Version, From/To, ENRSeq",
      },
      {
        lines: [75, 80],
        color: "amber",
        note: "Findnode — Target(Pubkey) + Expiration",
      },
    ...
    annotations: [
      {
        lines: [68, 76],
        color: "sky",
        note: "UDPv4 — conn, privkey, localNode, Table",
      },
      {
        lines: [79, 83],
        color: "emerald",
        note: "비동기 채널 — replyMatcher, gotreply",
      },
    ],
  },
  "geth-v4-listen": {
    ...
    annotations: [
      {
        lines: [133, 144],
        color: "sky",
        note: "UDPv4 초기화 — conn, privkey, channels",
      },
      {
        lines: [146, 151],
        color: "emerald",
        note: "newTable로 라우팅 테이블 생성",
      },
      {
        lines: [153, 156],
        color: "amber",
        note: "goroutine: table.loop + readLoop",
      },
    ],
  },
};
