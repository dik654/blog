    ...
    annotations: [
      {
        lines: [42, 58],
        color: "sky",
        note: "alpha=3, bucketSize=16, nBuckets 상수",
      },
      {
        lines: [64, 90],
        color: "emerald",
        note: "Table 구조체 — buckets, nursery, rand, db",
      },
      {
        lines: [93, 99],
        color: "amber",
        note: "transport 인터페이스 — ping, lookupRandom 등",
      },
    ],
  },
  "geth-bucket": {
    ...
    annotations: [
      {
        lines: [103, 108],
        color: "sky",
        note: "bucket — entries + replacements + IP 제한",
      },
      {
        lines: [110, 120],
        color: "emerald",
        note: "addNodeOp, trackRequestOp 채널 메시지",
      },
    ],
  },
  "geth-new-table": {
    ...
    annotations: [
      { lines: [124, 138], color: "sky", note: "채널 초기화 + IP 제한 설정" },
      {
        lines: [139, 144],
        color: "emerald",
        note: "각 버킷 초기화 (서브넷 제한 포함)",
      },
      {
        lines: [148, 153],
        color: "amber",
        note: "부트노드 설정 + 시드 노드 로딩",
      },
    ],
  },
};
