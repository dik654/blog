  ...
  return (
    <section id="lookup" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Kademlia의 핵심 동작은{" "}
          <strong>반복적 노드 조회(iterative FIND_NODE)</strong>입니다.
          <br />
          목표 ID에 가장 가까운 노드를 찾을 때까지 반복적으로 가까운 노드들에게
          질의합니다.
        </p>

        <h3>FIND_NODE (반복적 조회)</h3>
        <CodePanel
          title="FIND_NODE 반복적 조회"
          code={findNodeCode}
          annotations={[
            {
              lines: [1, 3],
              color: "sky",
              note: "alpha=3 동시 질의, K=20 반환",
            },
            {
              lines: [20, 21],
              color: "emerald",
        ...
        <h3>수렴 보장</h3>
        <p>
          각 반복에서 새 노드가 발견되거나, 더 가까운 노드가 없으면 종료됩니다.
          <br />
          네트워크가 연결되어 있다면 <code>O(log N)</code> 홉으로 가장 가까운
          노드를 반드시 찾습니다.
        </p>
