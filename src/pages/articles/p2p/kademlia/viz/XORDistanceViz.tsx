  ...
  return (
    <StepViz steps={STEPS}>
      {(step) => (
        ...
        >
          {/* Row labels */}
          <text x={30} y={45} fontSize={11} fontWeight={600} fill="#6366f1">
            A
          </text>
          <text x={30} y={85} fontSize={11} fontWeight={600} fill="#10b981">
            B
          </text>
          {step >= 1 && (
            <text x={14} y={125} fontSize={10} fontWeight={600} fill="#f59e0b">
              A⊕B
            </text>
          )}
              ...
              return (
                ...
                >
                  ...
                  <text
                    ...
                    fontSize={13}
                    fontWeight={600}
                    fill={isDiff ? "#f59e0b" : "var(--muted-foreground)"}
                  >
                    {bit}
                  </text>
                </motion.g>
