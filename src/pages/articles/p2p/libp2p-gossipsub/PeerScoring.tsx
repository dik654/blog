...
export default function PeerScoring({
  onCodeRef,
}: {
  ...
  return (
    <section id="peer-scoring" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          GossipSub는 각 피어에게 <strong>실시간 점수</strong>를 매긴다.
          <br />
          토픽별 파라미터(P1~P4) + 앱 레벨 스코어를 합산한다.
          <br />
            ...
            >
              <div className="flex flex-col gap-2 mt-3">
                {THRESHOLDS.map((t, i) => (
                  ...
                  >
                    <span
                      className="text-xs font-mono font-bold w-40 shrink-0"
                      style={{ color: t.color }}
                    >
                      {t.name}
                    </span>
              ...
              <p className="text-[11px] text-foreground/50 mt-3">
                graylistThreshold 이하이면 해당 피어의 모든 RPC를 무시한다.
                <br />이 다단계 차단이 Sybil/Eclipse 공격 피해를 제한한다.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
