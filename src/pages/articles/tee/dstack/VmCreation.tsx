...
export default function VmCreation({
  title,
  onCodeRef,
}: {
  title?: string;
    ...
    <section id="vm-creation" className="mb-16 scroll-mt-20">
      ...
      {onCodeRef && (
        <div className="not-prose flex flex-wrap gap-2 mb-6">
          <CodeViewButton
            onClick={() => onCodeRef("td-create", codeRefs["td-create"])}
          />
          ...
          <CodeViewButton
            onClick={() =>
              onCodeRef("manifest-flow", codeRefs["manifest-flow"])
            }
          />
          <span className="text-[10px] text-muted-foreground self-center">
            create_vm() 흐름
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>사용자 입력</strong>: Docker Compose 파일 + 간단한 manifest
          <br />
          <strong>VMM 자동화</strong>: TDX 활성화, 포트 매핑, attestation, 키
          발급
          <br />
          <strong>핵심 혁신</strong>: 개발자가 TEE 디테일 몰라도 기밀 VM 배포
          가능
          <br />
          <strong>바탕</strong>: dstack-tdx (Phala Network) — Kata Containers +
          Intel TDX
        </p>

        <h3 className="text-xl font-semibold mt-8 mb-3">
          Docker Compose → Confidential VM
        </h3>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p className="mt-2">
            ...
            - Reproducible TDX image builds
            <br />
            - KMS 자동 통합 (attestation → secrets)
            <br />- Kata Containers 기반 (검증된 프레임워크)
          </p>
          <p className="mt-2">
            <strong>생태계</strong>:<br />
            - Phala Network 주도 개발
            <br />
            - Confidential Containers 프로젝트와 협력
            <br />- 오픈소스 (github.com/Dstack-TEE)
          </p>
        </div>
      </div>
    </section>
