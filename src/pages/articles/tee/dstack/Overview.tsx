  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          dStack은 Intel TDX(Trust Domain Extensions) 기반 기밀 VM 인프라
          스택입니다.
          <br />
          Phala Network에서 개발했으며, AMD SEV와 달리{" "}
          <strong>Intel TDX</strong>를 기반으로 합니다.
          <br />
          개발자는 Docker Compose 파일만 제공하면 전체 신뢰 체인이 자동
          구성됩니다.
        </p>
