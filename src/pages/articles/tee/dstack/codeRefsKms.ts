    ...
    annotations: [
      {
        lines: [7, 12],
        color: "sky",
        note: "디스크 암호화 키 — instance_id 포함 (인스턴스별 고유)",
      },
      {
        lines: [15, 19],
        color: "emerald",
        note: "환경변수 키 — instance_id 미포함 (인스턴스간 공유)",
      },
      {
        lines: [22, 26],
        color: "amber",
        note: "K256 앱 키 — secp256k1 서명용",
      },
    ],
    desc: `KMS의 핵심 키 유도 로직입니다. HKDF-SHA256으로 Root Key에서 용도별 키를 파생합니다.
    ...
    annotations: [
      {
        lines: [6, 10],
        color: "sky",
        note: "TDX Quote → X.509 OID 확장에 임베딩",
      },
      {
        lines: [13, 14],
        color: "emerald",
        note: "report_data에 공개키 바인딩 → 출처 증명",
      },
      {
        lines: [17, 21],
        color: "amber",
        note: "자체 서명 인증서 생성 → TLS 핸드셰이크에 사용",
      },
    ],
    desc: `RA-TLS(Remote Attestation TLS)는 TLS 인증서에 TDX Quote를 임베딩하는 기법입니다.
