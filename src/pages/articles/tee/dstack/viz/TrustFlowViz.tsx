...
const MSGS = [
  [
    { from: 0, to: 1, label: "Compose" },
    { from: 1, to: 2, label: "TD 생성" },
  ],
  [
    { from: 3, to: 2, label: "get_quote" },
    { from: 2, to: 3, label: "Quote" },
  ],
              ...
              return (
                <g key={`${si}-${mi}`}>
                  ...
                  <text
                    ...
                    fontSize={10}
                    fontWeight={600}
                    fill={active ? clr : "var(--muted-foreground)"}
                    opacity={active ? 1 : done ? 0.4 : 0.1}
                  >
                    {m.label}
                  </text>
                  {active && (
