    ...
    annotations: [
      {
        lines: [34, 34],
        color: "sky",
        note: "스택 카나리 검증 -- 오버플로 감지",
      },
      {
        lines: [36, 40],
        color: "emerald",
        note: "가상화 지원 시 게스트 컨텍스트 설정",
      },
      {
        lines: [42, 42],
        color: "amber",
        note: "Fast 경로 진입 -- tee_entry_fast()로 위임",
      },
      {
        lines: [48, 49],
        color: "violet",
        note: "Fast 핸들러는 예외를 언마스크하면 안 됨",
      },
    ],
    desc: `Fast SMC 핸들러입니다. Normal World에서 smc 명령어로 진입하면
  ...
  "smc-std-handler": {
    ...
    annotations: [
      ...
      { lines: [68, 70], color: "emerald", note: "RPC 복귀 시 스레드 재개" },
      {
        lines: [71, 73],
        color: "amber",
        note: "새 요청 시 스레드 할당 + 실행",
      },
      { lines: [76, 77], color: "violet", note: "가상화 게스트 해제" },
    ],
    desc: `Standard SMC 핸들러입니다. TA 세션 열기/명령 실행 등 긴 연산을 처리합니다.
  ...
  "smc-vector-table": {
    ...
    annotations: [
      ...
      { lines: [63, 64], color: "emerald", note: "STD/Fast SMC 진입점" },
      {
        lines: [65, 68],
        color: "amber",
        note: "CPU 전원 관리 (on/off/resume/suspend)",
      },
      { lines: [69, 71], color: "violet", note: "FIQ + 시스템 전원 관리" },
    ],
    desc: `ARM Trusted Firmware(ATF)에 제공하는 벡터 테이블입니다.
  ...
  "smc-std-entry-asm": {
    ...
    annotations: [
      { lines: [76, 77], color: "sky", note: "C 핸들러 호출 + 반환값 보존" },
      {
        lines: [80, 82],
        color: "emerald",
        note: "예외 마스크 + 임시 스택 전환",
      },
      {
        lines: [84, 84],
        color: "amber",
        note: "스레드 상태 해제 (FREE로 전환)",
      },
      {
        lines: [86, 91],
        color: "violet",
        note: "ATF에 CALL_DONE 반환 + smc로 세계 전환",
      },
    ],
    desc: `Standard SMC 진입 어셈블리입니다.
