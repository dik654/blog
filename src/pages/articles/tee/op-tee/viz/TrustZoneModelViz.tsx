    ...
    <StepViz steps={STEPS}>
      {(step) => (
        ...
        >
          ...
          <text x={60} y={60} fontSize={10} fill="var(--muted-foreground)">
            Linux (EL1)
          </text>
          <text x={60} y={76} fontSize={10} fill="var(--muted-foreground)">
            Apps (EL0)
          </text>
          <motion.rect
            x={60}
          ...
          />
          <text x={140} y={103} textAnchor="middle" fontSize={10} fill={C.nw}>
            smc #0 호출
          </text>
          ...
          <text x={310} y={60} fontSize={10} fill="var(--muted-foreground)">
            OP-TEE OS (S.EL1)
          </text>
          <text x={310} y={76} fontSize={10} fill="var(--muted-foreground)">
            TA (S.EL0)
          </text>
          <motion.rect
            x={310}
          ...
          />
          <text x={395} y={103} textAnchor="middle" fontSize={10} fill={C.sw}>
            최소 권한 실행
          </text>
          ...
          <motion.line
            ...
            x2={220}
            y2={135}
            stroke={step === 2 ? C.mon : "var(--border)"}
            strokeWidth={1.2}
            strokeDasharray="4,3"
