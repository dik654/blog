      ...
      {(step) => (
        ...
        >
          ...
          <motion.rect
            ...
            stroke={step <= 2 ? C.sp : `${C.sp}30`}
            strokeWidth={step <= 2 ? 1.5 : 1}
            animate={{ opacity: step <= 2 ? 1 : 0.3 }}
          />
          <text x={45} y={48} fontSize={11} fontWeight={700} fill={C.sp}>
            set_sp
          </text>
          ...
          <text
            ...
            y={77}
            fontSize={10}
            fill={step === 1 ? C.sp : "var(--muted-foreground)"}
          >
          ...
          <text
            ...
            y={112}
            fontSize={10}
            fill={step === 2 ? C.sp : "var(--muted-foreground)"}
          >
          ...
          <motion.rect
            ...
            stroke={step === 0 ? C.warn : "var(--border)"}
          ...
          <text
            ...
            y={147}
            fontSize={10}
            fill={step === 0 ? C.warn : "var(--muted-foreground)"}
          >
          ...
          <motion.rect
            ...
            stroke={step === 3 ? C.sctlr : `${C.sctlr}30`}
            strokeWidth={step === 3 ? 1.5 : 1}
            animate={{ opacity: step === 3 ? 1 : 0.3 }}
          />
          <text x={305} y={48} fontSize={11} fontWeight={700} fill={C.sctlr}>
            set_sctlr_el1
          </text>
          ...
          {[
            ...
            <motion.g key={i} animate={{ opacity: step === 3 ? 1 : 0.25 }}>
              <rect
                ...
                stroke={step === 3 ? `${C.sctlr}50` : "var(--border)"}
                strokeWidth={0.5}
              />
              <text
                x={315}
                y={72 + i * 26}
                fontSize={10}
                fill={step === 3 ? C.sctlr : "var(--muted-foreground)"}
              >
                {t}
              </text>
            </motion.g>
