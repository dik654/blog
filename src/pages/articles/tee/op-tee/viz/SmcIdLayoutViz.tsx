      ...
      {(step) => (
        ...
        >
          ...
          <motion.rect
            ...
            stroke={step === 1 ? C.fast : `${C.fast}30`}
            strokeWidth={step === 1 ? 1.5 : 1}
            animate={{ opacity: step === 1 ? 1 : 0.25 }}
          />
          <text x={45} y={87} fontSize={10} fontWeight={600} fill={C.fast}>
            Fast Call [31]=1
          </text>
          <text x={45} y={102} fontSize={10} fill="var(--muted-foreground)">
            인터럽트 마스크, 즉시 반환
          </text>
          ...
          <motion.rect
            ...
            stroke={step === 2 ? C.std : `${C.std}30`}
            strokeWidth={step === 2 ? 1.5 : 1}
            animate={{ opacity: step === 2 ? 1 : 0.25 }}
          />
          <text x={295} y={87} fontSize={10} fontWeight={600} fill={C.std}>
            Standard Call [31]=0
          </text>
          <text x={295} y={102} fontSize={10} fill="var(--muted-foreground)">
            RPC 가능, 선점 허용
          </text>
            ...
            return (
              <g key={s.name}>
                <motion.rect
                  ...
                  stroke={active ? s.color : `${s.color}25`}
