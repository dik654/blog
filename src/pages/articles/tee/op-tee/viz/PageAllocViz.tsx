      ...
      {(step) => (
        ...
        >
          ...
          <motion.rect
            ...
            stroke={step === 0 ? C.pool : `${C.pool}30`}
            strokeWidth={step === 0 ? 1.5 : 1}
            animate={{ opacity: step === 0 ? 1 : 0.3 }}
          />
          <text x={35} y={28} fontSize={10} fontWeight={700} fill={C.pool}>
            가상 메모리 풀
          </text>
          <rect
            x={30}
            ...
            stroke={step === 0 ? `${C.pool}40` : "var(--border)"}
            strokeWidth={0.5}
          />
          <text
            x={40}
            y={49}
            fontSize={10}
            fill={step === 0 ? C.pool : "var(--muted-foreground)"}
          >
          ...
          <motion.rect
            ...
            stroke={step === 1 ? C.cache : `${C.cache}30`}
            strokeWidth={step === 1 ? 1.5 : 1}
            animate={{ opacity: step === 1 ? 1 : 0.3 }}
          />
          <text x={295} y={28} fontSize={10} fontWeight={700} fill={C.cache}>
            pgt_cache
          </text>
          {[
            "mutex — 동시 접근 보호",
            ...
            <text
              ...
              y={46 + i * 15}
              fontSize={10}
              fill={step === 1 ? C.cache : "var(--muted-foreground)"}
            >
              {t}
            </text>
          ))}
