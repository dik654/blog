      ...
      {(step) => (
        ...
        >
          ...
          <motion.line
            ...
            strokeWidth={1}
            strokeDasharray="3,3"
            animate={{ opacity: step >= 3 ? 0.9 : 0.15 }}
          />
          <motion.rect
            x={310}
            y={25}
            ...
            height={30}
            rx={5}
            fill={step >= 3 ? "#f59e0b18" : "#f59e0b06"}
            stroke={step >= 3 ? "#f59e0b" : "#f59e0b30"}
            strokeWidth={1}
            animate={{ opacity: step >= 3 ? 1 : 0.2 }}
          />
          <text x={328} y={44} fontSize={10} fontWeight={600} fill="#f59e0b">
            RPMB 인증키
          </text>
          ...
          <motion.line
            ...
            strokeWidth={1}
            strokeDasharray="3,3"
            animate={{ opacity: step >= 4 ? 0.9 : 0.15 }}
          />
          <motion.rect
            x={310}
            y={65}
            ...
            height={30}
            rx={5}
            fill={step >= 4 ? "#6366f118" : "#6366f106"}
            stroke={step >= 4 ? "#6366f1" : "#6366f130"}
            strokeWidth={1}
            animate={{ opacity: step >= 4 ? 1 : 0.2 }}
          />
          <text x={328} y={84} fontSize={10} fontWeight={600} fill="#6366f1">
            TA 바이너리 키
          </text>
