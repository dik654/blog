      ...
      {(step) => (
        ...
        >
          ...
          {[
            ...
            {
              label: "try_set_busy → open",
              desc: "잠금 + 세션 열기",
              c: C.open,
              s: 2,
            },
            {
              label: "tee_ta_session",
              desc: "{id, clnt_id, ctx}",
              c: C.init,
              s: 3,
            },
              ...
              <g key={b.label}>
                {i > 0 && (
                  <motion.line
                    ...
                    x2={x}
                    y2={70}
                    stroke={done || active ? b.c : "var(--border)"}
                    strokeWidth={1.2}
                    markerEnd="url(#arr)"
          ...
          <motion.rect
            ...
            rx={5}
            fill="#f59e0b08"
            stroke={step === 1 ? "#f59e0b" : "#f59e0b30"}
            strokeWidth={0.8}
            animate={{ opacity: step === 1 ? 0.9 : 0.15 }}
          />
          <text x={195} y={133} fontSize={10} fill="#f59e0b">
            BAD_PARAMETERS
          </text>
          <motion.line
            x1={220}
          ...
          <motion.rect
            ...
            rx={5}
            fill="#f59e0b08"
            stroke={step === 2 ? "#f59e0b" : "#f59e0b30"}
            strokeWidth={0.8}
            animate={{ opacity: step === 2 ? 0.9 : 0.15 }}
          />
          <text x={340} y={133} fontSize={10} fill="#f59e0b">
            TEE_ERROR_BUSY
          </text>
          <motion.line
            x1={345}
