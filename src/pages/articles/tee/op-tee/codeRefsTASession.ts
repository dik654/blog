    ...
    annotations: [
      {
        lines: [38, 40],
        color: "sky",
        note: "UUID + 클라이언트 ID 메타 파라미터 추출",
      },
      {
        lines: [43, 45],
        color: "emerald",
        note: "공유 메모리 파라미터 복사 (NW -> SW)",
      },
      {
        lines: [48, 53],
        color: "amber",
        note: "tee_ta_open_session -- TA 로드 + 세션 생성",
      },
      {
        lines: [55, 56],
        color: "violet",
        note: "PRNG 지터 엔트로피 추가 (예측 불가성 강화)",
      },
    ],
    desc: `TA 세션 열기의 핵심 진입점입니다.
    ...
    annotations: [
      {
        lines: [96, 98],
        color: "sky",
        note: "파라미터 복사 (Normal -> Secure World)",
      },
      {
        lines: [100, 103],
        color: "emerald",
        note: "세션 ID로 TA 세션 조회 + 잠금",
      },
      {
        lines: [105, 106],
        color: "amber",
        note: "tee_ta_invoke_command -- TA 내 함수 실행",
      },
      {
        lines: [108, 108],
        color: "violet",
        note: "세션 참조 해제 (다른 스레드 사용 가능)",
      },
    ],
    desc: `TA 명령 실행 진입점입니다.
...
세션을 못 찾으면 TEE_ERROR_BAD_PARAMETERS를 반환합니다.`,
  ...
  "entry-std-dispatch": {
    ...
    desc: `Standard Call의 최상위 디스패치 함수입니다.
    ...
    annotations: [
      {
        lines: [74, 76],
        color: "sky",
        note: "파라미터가 있으면 에러 (닫기에 불필요)",
      },
      { lines: [78, 79], color: "emerald", note: "PRNG 지터 엔트로피 추가" },
      {
        lines: [81, 82],
        color: "amber",
        note: "세션 찾기 + 닫기 (TA 자원 해제)",
      },
    ],
    desc: `세션 닫기 진입점입니다.
