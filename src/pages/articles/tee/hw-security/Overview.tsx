  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>소프트웨어 한계</strong>: OS·하이퍼바이저가 침해되면 모든 앱
          보호 불가
          <br />
          <strong>해결</strong>: 신뢰의 기반(Root of Trust)을 하드웨어에 둠
          <br />
          <strong>원칙</strong>: "Never trust software alone" — 하드웨어가
          software보다 안전
          <br />
          <strong>trade-off</strong>: 유연성 감소, 업데이트 어려움, 초기 비용
          높음
        </p>
            ...
            <tbody>
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>물리적 공격</strong>
                </td>
                <td className="border border-border px-3 py-2">
                  메모리 덤프, 콜드부트, 버스 스니핑, DMA
                </td>
                <td className="border border-border px-3 py-2">
                  메모리 암호화, IOMMU
                </td>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: HW RoT의 궁극적 신뢰 문제
          </p>
          <p>
            <strong>최종 신뢰 필수 요소</strong>:<br />
            - CPU 제조사 (Intel, AMD, ARM)
            <br />
            - eFuse에 저장된 키의 true randomness
            <br />- Boot ROM이 백도어 없이 정직하게 검증
          </p>
          <p className="mt-2">
            <strong>실패 시나리오</strong>:<br />
            ✗ 제조사 내부 악성 직원이 backdoor 심음
            <br />
            ✗ 국가 압력으로 weakened cryptography
            <br />
            ✗ 공급망 공격 (supply chain)
            <br />✗ Firmware에 zero-day 존재
          </p>
          <p className="mt-2">
            <strong>완화 전략</strong>:<br />
            - Open-source hardware (OpenTitan)
            <br />
            - Formal verification of firmware
            <br />
            - Multi-vendor attestation (N-out-of-M)
            <br />
            - Regular TCB update + rollback protection
            <br />
            - Reproducible builds
            <br />→ "Zero trust"는 이론적 목표, 현실은 "minimal trust"
          </p>
        </div>
      </div>
    </section>
