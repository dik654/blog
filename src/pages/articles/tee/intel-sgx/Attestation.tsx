  ...
  return (
    <section id="attestation" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          SGX 원격 증명은 <strong>EREPORT</strong> 하드웨어 명령어로 로컬 증명
          보고서를 생성합니다.
          <br />
        ...
        <div className="not-prose flex flex-wrap gap-2 mb-4">
          <CodeViewButton
            onClick={() => onCodeRef("target-info", codeRefs["target-info"])}
          />
          ...
          <CodeViewButton
            onClick={() =>
              onCodeRef("quote-structure", codeRefs["quote-structure"])
            }
          />
          <span className="text-[10px] text-muted-foreground self-center">
            sgx_quote_t
          ...
          <CodeViewButton
            onClick={() => onCodeRef("att-key-id", codeRefs["att-key-id"])}
          />
          <span className="text-[10px] text-muted-foreground self-center">
            sgx_ql_att_key_id_t
          </span>
