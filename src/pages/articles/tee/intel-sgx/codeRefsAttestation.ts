    ...
    annotations: [
      {
        lines: [4, 5],
        color: "sky",
        note: "mr_enclave + attributes: QE 신원 지정",
      },
      {
        lines: [7, 10],
        color: "emerald",
        note: "config_svn + misc_select: KSS 확장 필드",
      },
      {
        lines: [11, 11],
        color: "amber",
        note: "384B 패딩 → 512B 정렬 (EREPORT 요구사항)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [4, 9],
        color: "sky",
        note: "Quote 헤더: 버전, 서명 유형, QE/PCE 보안 버전",
      },
      {
        lines: [11, 11],
        color: "emerald",
        note: "report_body: 앱 엔클레이브의 MRENCLAVE/MRSIGNER 포함",
      },
      {
        lines: [12, 13],
        color: "amber",
        note: "가변 길이 서명: EPID(~1KB) 또는 ECDSA-P256(64B)",
      },
    ],
  },
...
typedef struct _sgx_ql_att_key_id_t {
    ...
    annotations: [
      { lines: [3, 4], color: "sky", note: "id + version: 구조체 버전 관리" },
      {
        lines: [5, 6],
        color: "emerald",
        note: "mrsigner: QE 엔클레이브의 서명자 식별",
      },
      {
        lines: [7, 10],
        color: "amber",
        note: "제품/구성 ID: 특정 QE 빌드 식별",
      },
      {
        lines: [11, 11],
        color: "violet",
        note: "algorithm_id: ECDSA-P256(DCAP) vs EPID(레거시)",
      },
    ],
  },
};
