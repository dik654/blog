...
const STEPS = [
  {
    label: "EGETKEY로 봉인 키 파생",
    body: "key_request의 정책(MRENCLAVE/MRSIGNER)에 따라 CPU 내부 퓨즈 + SVN으로 128-bit 대칭 키 생성.",
  },
  {
    label: "AES-256-GCM 암호화 실행",
    body: "봉인 키로 평문 암호화. AAD(추가 인증 데이터)는 평문 유지하되 무결성 보호. 12-byte zero IV 사용.",
  },
  {
    label: "sgx_sealed_data_t 패키징",
    body: "key_request + payload_tag(16B MAC) + 암호문 + AAD를 하나의 구조체로 조합. 디스크 저장 준비 완료.",
  },
];
