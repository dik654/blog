...
const STEPS = [
  {
    label: "PCE: 플랫폼 프로비저닝",
    body: "EGETKEY로 PPID 생성 → Intel PCS의 RSA-3072 공개키로 PPID 암호화. PCK 인증서와 PSVN 정보 반환.",
  },
  {
    label: "QE3: ECDSA Quote 서명",
    body: "AESM 데몬이 앱 REPORT를 QE3에 전달. QE3가 CMAC 검증 후 ECDSA-P256로 서명 → Quote v3 생성.",
  },
  {
    label: "Quote v3 구조 출력",
    body: "version(3) + att_key_type(ECDSA_P256) + tee_type(SGX) + QE/PCE SVN + isv_enclave_report + ECDSA 서명.",
  },
];
            ...
            return (
              <g key={b.label}>
                ...
                <text
                  ...
                  fontSize={10}
                  fontWeight={600}
                  fill={active ? b.color : "var(--foreground)"}
                >
                  {b.label}
                </text>
                <text
