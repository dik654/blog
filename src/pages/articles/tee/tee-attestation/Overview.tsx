    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          ...
          신뢰성을 원격으로 검증
          <br />
          "이 코드가 정말 TEE 안에서, 의도한 바이너리로, 패치된 CPU에서 실행
          중인가?"
          <br />
          <strong>암호학적 증명</strong> — 단순 신뢰가 아닌 수학적 검증
          <br />
          <strong>3자 모델</strong>: Attester(TEE) → Verifier(검증자) → Relying
          Party(의존자)
        </p>
...
// 결과: TEE 신뢰 수립 + 보안 채널`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: Attestation vs Certificate
          </p>
          <p>
            ...
            <br />
            - "이 도메인은 이 회사 소유" 증명
            <br />- 코드 실행 환경에 대한 보장 없음
          </p>
          <p className="mt-2">
            <strong>TEE Attestation</strong>:<br />
            - TEE가 실시간 생성
            <br />
            - "이 코드가 지금 TEE에서 실행 중" 증명
            <br />- 매 세션/요청마다 fresh
          </p>
          <p className="mt-2">
            <strong>결합</strong>:<br />- <strong>RA-TLS</strong>: TLS cert에
            attestation 내장
            <br />
            - X.509 extension에 SGX Quote 추가
            <br />
            - 기존 TLS 인프라 그대로 + attestation 검증 추가
            <br />- → 기존 HTTPS 클라이언트 소량 수정으로 적용 가능
          </p>
        </div>
      </div>
    </section>
