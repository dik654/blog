  ...
  return (
    <section id="ias-dcap" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>IAS</strong>(Intel Attestation Service): 2015년 SGX 출시와
          함께 도입
          <br />
          <strong>DCAP</strong>(Data Center Attestation Primitives): 2019년
          도입, 점진적 대체
          <br />
          <strong>2020년</strong>: Intel이 EPID/IAS deprecation 발표
          <br />
...
// - DCAP 프로덕션 검증`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p className="mt-2">
            ...
            ✗ Intel 중앙집중 — single point of failure
            <br />
            ✗ 익명성이 enterprise에는 장애물 (audit 불가)
            <br />
            ✗ EPID 구현 복잡 → 보안 버그
            <br />
            ✗ Scale 한계 (IAS 서버 부하)
            <br />✗ Cloud-native 아키텍처와 불일치
          </p>
          <p className="mt-2">
            <strong>DCAP의 실용주의</strong>:<br />
            ✓ 표준 PKI (ECDSA, X.509) — 검증된 기술
            <br />
            ✓ Verifier 분산 → scale out
            <br />
            ✓ 기업 PKI 인프라 재활용
            <br />
            ✓ 오프라인 검증 (에어갭 환경)
            <br />→ "boring technology wins"
          </p>
        </div>
      </div>
    </section>
