    ...
    <section id="remote" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h3 className="text-xl font-semibold mt-6 mb-3">
          Remote Attestation의 구조
        </h3>
        <p>
          <strong>원격 증명</strong>: 로컬 증명의 확장 — 네트워크 너머 검증 가능
          <br />
          <strong>Quoting Enclave(QE)</strong>: EREPORT → Quote 변환, 외부 전송
          가능한 서명 생성
          <br />
          <strong>2가지 방식</strong>: EPID(old, deprecated) vs DCAP(new,
          current)
          <br />
...
// 크기: 기본 ~4KB (cert chain 포함)`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - Intel centralized verifier
            <br />
            - 각 attestation이 IAS 경유
            <br />- 대규모 scale 어려움
          </p>
          <p className="mt-2">
            <strong>DCAP의 해결</strong>:<br />
            - Intel = Certificate Authority only (PCK 발급)
            <br />
            - Verification = 운영자가 직접
            <br />
            - 표준 X.509/ECDSA 사용
            <br />- 기존 PKI 인프라 재활용
          </p>
          <p className="mt-2">
            ...
            - IETF RATS 표준화
            <br />
            - Cross-vendor verifier (Veraison)
            <br />
            - Attestation + blockchain audit
            <br />- Attestation-as-a-Service (cloud 3rd party)
          </p>
        </div>
      </div>
    </section>
