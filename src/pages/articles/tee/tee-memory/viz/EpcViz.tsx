  ...
  return (
    <motion.g animate={{ opacity: active ? 1 : 0.3 }} transition={sp}>
      ...
      <rect
        ...
        strokeWidth={0.8}
      />
      <text x={120} y={53} textAnchor="middle" fontSize={10} fill="#10b981">
        EPC: 4KB Page Pool
      </text>
    </motion.g>
  );
...
function EpcmEntry({ active }: { active: boolean }) {
  return (
    <motion.g animate={{ opacity: active ? 1 : 0.2 }} transition={sp}>
      ...
      <text x={290} y={48} fontSize={10} fill="var(--foreground)">
        SECS
      </text>
      <text x={340} y={48} fontSize={10} fill="var(--foreground)">
        Type
      </text>
      <text x={390} y={48} fontSize={10} fill="var(--foreground)">
        RWX
      </text>
      <text x={440} y={48} fontSize={10} fill="var(--foreground)">
        Valid
      </text>
    </motion.g>
  );
