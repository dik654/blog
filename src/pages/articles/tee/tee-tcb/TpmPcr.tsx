  ...
  return (
    <section id="tpm-pcr" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>TPM(Trusted Platform Module)</strong> — CPU와 별도의 보안 칩
          <br />
          측정값을 <strong>안전하게 저장</strong>하고, 외부에 서명된
          증명(quote)을 제공합니다
        </p>
        ...
        <p>
          <strong>PCR(Platform Configuration Register)</strong>은 덮어쓰기가
          불가능합니다
          <br />새 측정값은 기존 값에 <strong>확장(extend)</strong>만 할 수
          있습니다
        </p>
        ...
        <p>
          한 번 부팅하면 <strong>리셋(재부팅) 전까지 변경 불가</strong>합니다
          <br />
