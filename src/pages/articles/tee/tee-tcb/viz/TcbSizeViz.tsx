...
const STEPS = [
  ...
  },
  {
    ...
    body: '업계 평균 1~25 bugs/KLOC 기준. 30M LOC × 10 = 300,000개 vs 50K LOC × 1 = 50개. 검증 가능성 차이가 수천 배에 달합니다.',
  },
  {
    label: '트레이드오프: 보안 vs 호환성',
    body: 'SGX는 코드 재작성 필요(작은 TCB). SEV/TDX는 기존 VM 그대로(큰 TCB). 호환성을 얻는 대신 공격 표면이 확대됩니다.',
  },
];
