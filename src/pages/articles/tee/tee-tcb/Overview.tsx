  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>TCB(Trusted Computing Base)</strong> — 시스템 보안을 책임지는{" "}
          <strong>모든 하드웨어와 소프트웨어의 합</strong>
          <br />
          OS 커널, 펌웨어, 하이퍼바이저, 드라이버 등 권한이 있는 모든 코드가
          포함됩니다
        </p>
        <p>
          TCB에 포함된 코드의 버그 = <strong>전체 보안 붕괴</strong>
          <br />
        ...
        <p>
          ...
          <strong>TCB를 극단적으로 줄여</strong> 공격 표면을 최소화합니다
          <br />
          OS와 하이퍼바이저를 TCB에서 <strong>제외</strong>하는 것이 핵심 설계
          철학입니다
        </p>
