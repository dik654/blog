  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>Phala Network</strong>: TEE 기반 탈중앙화 오프체인 컴퓨팅
          프로토콜
          <br />
          <strong>주력</strong>: AI 에이전트 실행 레이어 — 기밀·검증 가능한
          off-chain 연산
          <br />
          <strong>기반</strong>: Polkadot 생태계 (Substrate) + Intel SGX TEE
          워커
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - 자체 L1 (Sapphire paratime)
            <br />
            - EVM 호환 (Solidity)
            <br />
            - Cosmos/Tendermint 기반
            <br />- 주 타겟: 기밀 DeFi
          </p>
          <p className="mt-2">
            <strong>Phala</strong>:<br />
            - Polkadot 파라체인 (Substrate)
            <br />
            - Ink! / Rust WASM
            <br />
            - Off-chain compute 중심
            <br />- 주 타겟: AI agent, oracle
          </p>
          <p className="mt-2">
