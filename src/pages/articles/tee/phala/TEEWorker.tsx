  ...
  return (
    <section id="tee-worker" className="mb-16 scroll-mt-20">
      <h2 className="text-2xl font-bold mb-6">
        {title ?? "TEE Worker (pRuntime & Phactory)"}
      </h2>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>pRuntime</strong>: Intel SGX Enclave 내부 Rust 런타임
          <br />
          <strong>Phactory</strong>: pRuntime 안의 핵심 비즈니스 로직 엔진
          <br />
          <strong>Attestation</strong>: DCAP 기반 원격 증명으로 워커 무결성 보장
          <br />
...
// - Delegator도 스테이킹 가능 (18% commission)`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - Contract 실행 fee (gas)
            <br />
            - 네트워크 공유 리워드 (inflation)
            <br />- Delegation commission
          </p>
          <p className="mt-2">
            ...
            ✗ Attestation 만료 무시
            <br />
            ✗ Double-signing (incorrect egress)
            <br />✗ Cluster 규칙 위반
          </p>
          <p className="mt-2">
