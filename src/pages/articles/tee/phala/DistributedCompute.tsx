  ...
  return (
    <section id="distributed" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>Cluster</strong>: TEE 워커의 논리 그룹 — 같은 키 공유, 같은
          컨트랙트 실행
          <br />
          <strong>Offchain Rollup</strong>: TEE 실행 결과를 on-chain commit —
          가스 절감
          <br />
          <strong>SideVM</strong>: 비동기 장기 실행 컨테이너 — 이벤트 구독,
          스트리밍
          <br />
...
// - Pre-audited 컴포넌트`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - 2024 Phala 방향 전환: AI agent 플랫폼
            <br />
            - LLM inference를 TEE 안에서
            <br />
            - 개인 프롬프트·응답 기밀성
            <br />- Agent state persistence
          </p>
          <p className="mt-2">
            <strong>주요 통합</strong>:<br />
            - Fleek: Edge compute + Phala TEE
            <br />
            - Eliza AI framework: Phat Contract 지원
            <br />- Redpill: LLM gateway (Phala 기반)
          </p>
          <p className="mt-2">
            <strong>경쟁 분야</strong>:<br />
            - Ritual (Coinbase): 탈중앙 AI
            <br />
            - Bittensor: ML 모델 네트워크
            <br />- Phala 차별점: TEE privacy + Polkadot 생태계
          </p>
        </div>
      </div>
    </section>
