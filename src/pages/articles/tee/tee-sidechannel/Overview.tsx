  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>사이드채널(Side-Channel)</strong>: 암호문이 아닌{" "}
          <strong>부수적 정보</strong>로 비밀 유추
          <br />
          <strong>부수 정보</strong>: 실행 시간, 캐시 hit/miss, 전력 소비, EM
          방사, 메모리 접근 패턴
          <br />
          <strong>TEE의 한계</strong>: 메모리 암호화만으로는 방어 불가 — 실행
          흐름 자체가 누출
          <br />
...
// - SW-only 완화 한계 명확`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            <strong>공식 위협 모델</strong>: 대부분 TEE 벤더가 "사이드채널은
            범위 밖" 선언
            <br />
            Intel SGX: "physical attacks and side channels are out of scope"
            <br />
          ...
          <p className="mt-2">
            ...
            - 학계가 지속적으로 새 공격 발표
            <br />
            - 벤더가 case-by-case로 패치
            <br />- 완화 vs 방어 차이 큼
          </p>
          <p className="mt-2">
            <strong>실무 접근</strong>:<br />
            - Defense-in-depth: TEE + 앱 레벨 hardening
            <br />
            - Constant-time crypto 필수
            <br />
            - Oblivious algorithms 검토
            <br />
            - SMT 비활성화 (데이터센터)
            <br />- TCB 패치 주기적 적용
          </p>
