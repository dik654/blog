  ...
  return (
    <section id="p2p-networking" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>libp2p</strong> 기반 모듈러 네트워킹 스택
          <br />
          <strong>GossipSub</strong>(메시 기반 pub/sub)로 Commitment·Tx 전파
          <br />
          <strong>Peer Manager</strong>가 연결 풀 관리,{" "}
          <strong>Sentry 노드</strong>가 검증인을 DDoS로부터 보호
          <br />
          <strong>2가지 네트워크 분리</strong>: Consensus P2P + Runtime P2P
          (per-ParaTime)
        </p>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>oasis/consensus/block</code>
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>oasis/runtime/{"{id}"}/commit</code>
                </td>
                <td className="border border-border px-3 py-2">
                  Executor commitment
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>oasis/runtime/{"{id}"}/proposal</code>
                </td>
...
// - Sentry 1개 다운돼도 다른 sentry로 대체`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - 각 ParaTime은 독립된 tx pool 보유
            <br />
            - ParaTime별 boostrap·topology 구성
            <br />- 악성 ParaTime의 gossip spam이 다른 ParaTime에 전파 차단
          </p>
          <p className="mt-2">
            <strong>비용</strong>:<br />
            ✗ 노드당 n개 libp2p 호스트 운영
            <br />
            ✗ Peer discovery 중복
            <br />✗ 메모리·소켓 사용량 증가
          </p>
          <p className="mt-2">
            <strong>trade-off 수용</strong>: 격리 이점이 오버헤드 상회
            <br />
            - 멀티 ParaTime 아키텍처의 핵심 보안 속성
            <br />- Cosmos IBC relayer와 유사한 분리 원칙
          </p>
        </div>
      </div>
    </section>
