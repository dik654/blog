...
const STEPS = [
  {
    label: "합의 계층: 보안 & finality",
    body: "CometBFT BFT 합의로 빠른 finality. 밸리데이터 위원회 관리. 여러 ParaTime 상태를 합의 체인에 커밋.",
  },
  {
    label: "런타임 계층: 병렬 실행",
    body: "여러 ParaTime이 독립적으로 병렬 실행. 각 ParaTime은 자체 실행 환경(EVM, WASM, 기밀). TEE 기반 기밀 런타임 지원.",
  },
  {
    label: "ParaTime 종류",
    body: "Cipher: WASM + SGX 기밀 실행.\nSapphire: EVM + SGX 기밀 실행.\nEmerald: 일반 EVM (공개 실행).",
  },
];
          ...
          {[
            ...
            <g key={p.label}>
              ...
              <text
                ...
                fontSize={10}
                fontWeight={600}
                fill={step === 2 ? p.color : "var(--muted-foreground)"}
              >
                {p.label}
              </text>
              <text
