    ...
    <StepViz steps={STEPS}>
      {(step) => (
        ...
        >
            ...
            return (
              <g key={l.label}>
                ...
                <text
                  ...
                  fontSize={12}
                  fontWeight={600}
                  fill={active ? l.color : "var(--foreground)"}
          ...
          {/* moving arrow */}
          <motion.g
            animate={{ y: LAYERS[step].y + 25 - LAYERS[0].y - 25 }}
            transition={{ duration: 0.5, type: "spring", bounce: 0.2 }}
          >
            <circle
              cx={180 - LAYERS[0].w / 2 - 18}
              cy={LAYERS[0].y + 25}
              r={8}
              fill={LAYERS[step].color}
            />
            <text
              x={180 - LAYERS[0].w / 2 - 18}
              y={LAYERS[0].y + 28}
              textAnchor="middle"
              fontSize={10}
              fontWeight={600}
