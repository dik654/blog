...
const STEPS = [
  {
    label: "밸리데이터 노드 (Validator)",
    body: "합의 계층에 참여해 블록을 제안하고 투표합니다. 스테이킹 보증금이 필요합니다.",
  },
  {
    label: "컴퓨트 노드 (Compute Worker)",
    body: "ParaTime 트랜잭션을 실행합니다. 기밀 런타임은 SGX/TDX 하드웨어가 필수입니다.",
  },
  {
    label: "키 매니저 노드 (Key Manager)",
    body: "기밀 런타임의 암호화 키를 관리합니다. SGX 엔클레이브 내에서 실행됩니다.",
  },
  {
    label: "클라이언트 노드 (Client / Seed)",
    body: "상태를 조회하고 트랜잭션을 제출합니다. P2P 네트워크 연결을 지원합니다.",
  },
];
          ...
          {NODES.map((n, i) => {
            ...
            return (
              <motion.line
                ...
                x2={x}
                y2={120}
                stroke={i === step ? n.color : "var(--border)"}
                strokeWidth={1}
                strokeDasharray="3,3"
