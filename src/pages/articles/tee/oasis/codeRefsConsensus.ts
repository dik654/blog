    ...
    annotations: [
      {
        lines: [84, 101],
        color: "sky",
        note: "ApplicationServer — ABCI 앱 + 소켓 서버, Mux 래핑",
      },
      {
        lines: [126, 134],
        color: "emerald",
        note: "Register — Oasis 앱을 ABCI 멀티플렉서에 등록",
      },
    ],
    ...
    annotations: [
      {
        lines: [215, 226],
        color: "sky",
        note: "abciMux 구조체 — 앱 맵, 메서드 라우팅, 실행 순서 관리",
      },
      {
        lines: [227, 235],
        color: "emerald",
        note: "HaltHooks, invalidatedTxs — 업그레이드 중지 & TX 무효화 감시",
      },
    ],
    ...
    annotations: [
      {
        lines: [104, 130],
        color: "sky",
        note: "fullService — CometBFT 풀 노드 구조체",
      },
      {
        lines: [133, 148],
        color: "emerald",
        note: "Start() — commonNode → startFn → CometBFT 노드 시작",
      },
    ],
