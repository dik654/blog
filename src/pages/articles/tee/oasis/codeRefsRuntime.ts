    ...
    annotations: [
      {
        lines: [64, 77],
        color: "sky",
        note: "Initializer 트레이트 — 런타임 디스패처 초기화 인터페이스",
      },
      {
        lines: [112, 143],
        color: "emerald",
        note: "TxDispatchState / State — 합의 블록, 에포크, 실행 모드 등 런타임 상태",
      },
      {
        lines: [150, 160],
        color: "amber",
        note: "Dispatcher 구조체 — mpsc 큐, Identity, Tokio 런타임 핸들",
      },
    ],
    ...
    annotations: [
      {
        lines: [17, 32],
        color: "sky",
        note: "Worker 구조체 — 다중 런타임을 관리하는 executor 워커",
      },
      {
        lines: [40, 58],
        color: "emerald",
        note: "Start() — 런타임 종료 대기 고루틴 + 초기화 대기 고루틴",
      },
    ...
    annotations: [
      {
        lines: [20, 29],
        color: "sky",
        note: "상수 — ChecksumSize, KeyPairIDSize (각 32바이트)",
      },
      {
        lines: [46, 60],
        color: "emerald",
        note: "RPC 메서드명 — Init, GetOrCreateKeys, PublishMasterSecret 등",
      },
      {
        lines: [62, 97],
        color: "amber",
        note: "RPC 메서드 — Replicate, Generate, Load (마스터/임시 비밀 관리)",
      },
    ],
    ...
    annotations: [
      {
        lines: [123, 154],
        color: "sky",
        note: "Status 구조체 — ID, IsSecure, Generation, Nodes, Policy",
      },
      {
        lines: [164, 188],
        color: "emerald",
        note: "VerifyRotationEpoch — 마스터 시크릿 회전 주기 검증",
      },
    ],
