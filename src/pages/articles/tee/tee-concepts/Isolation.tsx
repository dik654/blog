  ...
  return (
    <section id="isolation" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>메모리 컨트롤러</strong>가 CPU ↔ DRAM 사이에서 실시간
          암호화/복호화
          <br />
          <strong>CPU 캐시</strong>: 평문 상태 (빠른 연산 위해)
          <br />
          <strong>DRAM</strong>: 암호문 저장 (cold boot, probe 방어)
          <br />
          <strong>접근 제어</strong>: 하드웨어가 어느 코드가 어느 메모리
          접근하는지 강제
        </p>
...
//    방어: 앱 레벨 대응 필수`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            ✓ 직접 메모리 읽기 (host, DMA, probe)
            <br />
            ✓ 메모리 재매핑 / page table 조작
            <br />
            ✓ Cold boot attack
            <br />✓ 물리 swap 시도
          </p>
          <p className="mt-2">
            ...
            ✗ Cache side channel (접근 패턴으로 추론)
            <br />
            ✗ Transient execution (Spectre 등)
            <br />
            ✗ Power/EM analysis
            <br />✗ CPU 자체의 물리적 공격 (decapping)
          </p>
          <p className="mt-2">
            <strong>실전 결론</strong>:<br />- 메모리 암호화는{" "}
            <strong>필요 조건</strong>, 충분 조건 아님
            <br />
            - 앱 레벨 constant-time coding 필수
            <br />
            - Attestation으로 TCB 상태 검증
            <br />- Defense in depth 원칙 적용
          </p>
        </div>
      </div>
    </section>
