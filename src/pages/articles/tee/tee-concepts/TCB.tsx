  ...
  return (
    <section id="tcb" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>TCB</strong>: 시스템 보안을 책임지는 모든 하드웨어 +
          소프트웨어의 합<br />
          TCB의 <strong>어느 한 부분이라도</strong> 침해되면 전체 보안 무너짐
          <br />
          <strong>TCB 최소화</strong>가 보안 공학의 핵심 원칙
          <br />
          <strong>TCB 바깥</strong>: untrusted로 가정, 아무리 많이 악용돼도 보안
          유지
        </p>
...
// - 가능하면 formal verification`}</pre>
            ...
            <tbody>
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>Intel SGX</strong>
                </td>
                <td className="border border-border px-3 py-2">
                  CPU HW + Enclave 코드 + SDK
                </td>
                <td className="border border-border px-3 py-2">~50K LoC</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>ARM TrustZone (OP-TEE)</strong>
                </td>
                <td className="border border-border px-3 py-2">
                  TrustZone HW + OP-TEE OS + TAs
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>AMD SEV-SNP</strong>
                </td>
                <td className="border border-border px-3 py-2">
                  CPU HW + ASP firmware + Guest OS
                </td>
                <td className="border border-border px-3 py-2">30M+ LoC</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>ARM CCA</strong>
                </td>
                <td className="border border-border px-3 py-2">
                  ARM HW + TF-A + RMM + Realm OS
                </td>
                <td className="border border-border px-3 py-2">30M+ LoC</td>
              </tr>
            </tbody>
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">
          SGX vs VM-based TEE — TCB trade-off
        </h3>
...
// Microsoft VBS: Hyper-V 기반 (큰 TCB 감수)`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - 100 LoC 하드코딩 어셈블리 vs 10K LoC 검증된 Rust
            <br />
            - 후자가 더 안전할 수 있음
            <br />- 언어·아키텍처·검증 레벨 모두 고려
          </p>
          <p className="mt-2">
            <strong>질적 요소</strong>:<br />
            1. 언어 안전성 (Rust &gt; C)
            <br />
            2. 검증 여부 (formal proof &gt; tests only)
            <br />
            3. 공개 여부 (open source &gt; closed)
            <br />
            4. 감사 받은 횟수
            <br />
            5. 업데이트 빈도 (패치 용이성)
          ...
          <p className="mt-2">
            <strong>예시</strong>:<br />
            - Linux kernel 30M LoC, but 많이 검증됨
            <br />
            - Intel SGX SDK 50K LoC, but Intel 폐쇄
            <br />
            - seL4 ~10K LoC + 완전 formal verified
            <br />→ 단순 LoC 비교는 misleading
          </p>
        </div>
      </div>
    </section>
