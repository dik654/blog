  ...
  return (
    <section id="sealing" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>TEE 내부 데이터</strong>를 외부(디스크, 네트워크, 다른
          컴퓨터)에 저장 필요 시 사용
          <br />
          <strong>CPU 고유 키</strong>로 암호화 → 해당 CPU/플랫폼에서만 복호화
          가능
          <br />
          <strong>Sealing vs Attestation</strong>: Sealing은 데이터 영속성,
          Attestation은 원격 검증
          <br />
...
// - 오프라인 모드는 제약`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - Seal Key가 CPU에 결속 → 하드웨어 고장 시 데이터 손실
            <br />
            - 여러 노드 간 공유 불가
            <br />- Backup은 별도 프로토콜 필요
          </p>
          <p className="mt-2">
            <strong>복구 전략</strong>:<br />
            1. <strong>Multi-party sealing</strong>: Threshold SSS로 키 분산
            <br />
            2. <strong>Distributed key manager</strong>: Oasis KM 같은 복제
            <br />
            3. <strong>Secret sharing</strong>: M-of-N 조합으로 복구
            <br />
            4. <strong>Cross-TEE replication</strong>: RA-TLS 기반 복제
          </p>
          <p className="mt-2">
            <strong>실전 권장</strong>:<br />
            - 저가치 데이터: 단일 node sealing
            <br />
            - 중요 데이터: multi-party + threshold
            <br />- 최중요: HSM backup + attested replication
          </p>
        </div>
      </div>
    </section>
