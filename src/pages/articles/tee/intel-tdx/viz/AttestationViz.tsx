    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        {[
          {
            x: 35,
            label: "Header",
            desc: "version, att_key_type",
            color: "#6b7280",
          },
          {
            x: 115,
            label: "TD Quote Body",
            desc: "MRTD, RTMR, seam_svn",
            color: "#10b981",
          },
          {
            x: 210,
            label: "Signature",
            desc: "ECDSA P-256 (Attestation Key)",
            color: "#f59e0b",
          },
          {
            x: 330,
            label: "Cert Chain",
            desc: "QE→PCK→Intel Root CA",
            color: "#8b5cf6",
          },
        ].map((f, i) => (
          <g key={i}>
            <rect
              ...
              y={165}
              width={
                f.x === 330 ? 120 : f.x === 210 ? 110 : f.x === 115 ? 85 : 70
              }
              height={30}
              rx={4}
              fill={f.color}
            ...
            <text
              x={
                f.x +
                (f.x === 330 ? 60 : f.x === 210 ? 55 : f.x === 115 ? 42 : 35)
              }
              y={178}
              textAnchor="middle"
              fontSize={7.5}
        ...
        <text x={35} y={283} fontSize={7.5} fill="var(--muted-foreground)">
          · <tspan fontWeight={600}>TDX Module SVN (seam_svn)</tspan> — TD
          Module 바이너리 버전
        </text>
