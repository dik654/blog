            ...
            <tbody>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>TDG.VP.INFO</code>
                </td>
                <td className="border border-border px-3 py-2">
                  TD 속성 조회 (GPAW, NUM_VCPUS)
                </td>
                <td className="border border-border px-3 py-2">td_info</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>TDG.MEM.PAGE.ACCEPT</code>
                </td>
                <td className="border border-border px-3 py-2">
                  Pending 페이지 활성화
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>TDG.MEM.PAGE.ATTR.RD/WR</code>
                </td>
                <td className="border border-border px-3 py-2">
                  페이지 속성 읽기/쓰기
                </td>
...
- 이 과정 생략 시 SEAMCALL이 ENTROPY_FAIL 반환`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - TD 생성 시 초기 이미지 해시 (TDH.MR.FINALIZE로 확정)
            <br />
            - 불변 — TD 수명 내내 고정
            <br />- SGX의 MRENCLAVE에 대응
          </p>
          <p className="mt-2">
            <strong>RTMR[0..3] (Runtime Measurement Register)</strong>:<br />
            - 런타임에 확장 가능 (TDG.MR.RTMR.EXTEND)
            <br />
            - SHA-384 해시 체인
            <br />
            - TPM PCR과 유사한 개념
            <br />- 용도: 부트로더→커널→initrd 체인 측정, 동적 로드 코드 기록
          </p>
          <p className="mt-2">
