  ...
  return (
    <section id="migration" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>SEV Live Migration</strong>: VM을 평문 노출 없이 호스트 간
          이동
          <br />
          양측 ASP가 <strong>TEK</strong>(Transport Encryption Key) 협상
          <br />
          메모리 페이지를 기존 VEK로 복호화 → TEK로 재암호화 → 네트워크 전송 →
          반대편에서 역순
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: SEV 마이그레이션의 보안 한계
          </p>
          <p>
            <strong>방어 가능</strong>:<br />
            ✓ 네트워크 sniffing — TEK로 암호화
            <br />
            ✓ 중간자 공격 — PDH cert로 상호 인증
            <br />✓ 잘못된 플랫폼으로 이주 — policy로 차단
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            - Migration Agent(MA) Firmware (2022 이후)
            <br />
            - Guest owner가 migration 승인 직접 결정
            <br />- Policy가 SEV Report에 포함 → 런타임 검증
          </p>
        </div>
      </div>
    </section>
