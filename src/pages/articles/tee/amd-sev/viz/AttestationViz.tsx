...
export default function AttestationViz() {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 space-y-6">
      ...
      {/* Step detail */}
      <div
        className={`rounded-lg border p-4 ${actorColor[steps[active].actor] ?? "border-border text-foreground/80"}`}
      >
