...
const STEPS = [
  {
    label: "VMPL 계층 구조",
    body: "VMPL 0(최고 권한) ~ VMPL 3(최저) — 게스트 VM 내부를 계층화",
  },
  {
    label: "VmplPerms 비트 마스크",
    body: "READ / WRITE / EXECUTE_USER(CPL3) / EXECUTE_SUPERVISOR(CPL0-2) 4비트 권한",
  },
  {
    label: "권한 위임",
    body: "VMPL 1이 특정 페이지 RWX 권한을 VMPL 2에게 위임 — 계층적 privilege delegation",
  },
];
          ...
          {LEVELS.map((l, i) => {
            ...
            return (
              ...
              >
                ...
                <text x={80} y={y + 18} fontSize={10} fill="var(--foreground)">
                  {l.role}
                </text>
                <text
                  x={w + 26}
