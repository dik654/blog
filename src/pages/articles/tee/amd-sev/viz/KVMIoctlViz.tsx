...
const STEPS = [
  {
    label: "KVM SEV ioctl — 게스트 관리",
    body: "KVM_SEV_INIT → LAUNCH_START → UPDATE_DATA → MEASURE → FINISH 순서로 게스트 생성",
  },
  {
    label: "/dev/sev — 플랫폼 관리",
    body: "플랫폼 리셋, 상태 조회, PEK/PDH 키 생성 등 보안 플랫폼 직접 제어",
  },
  {
    label: "GHCB 기반 VMEXIT 처리",
    body: "SEV-ES에서 레지스터가 암호화됨 → GHCB(Guest-Host Communication Block)로 제한된 정보만 교환",
  },
];
