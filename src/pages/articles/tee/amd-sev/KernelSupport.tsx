  ...
  return (
    <section id="kernel-support" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>KVM</strong> 모듈 + <strong>/dev/sev</strong> +{" "}
          <strong>CCP</strong>(Cryptographic Coprocessor) 드라이버
          <br />
          QEMU/libvirt가 ioctl 인터페이스로 SEV VM 생성·관리
          <br />
          <strong>Guest 커널</strong>도 SEV-aware 필요 — mem_encrypt, GHCB 등
          <br />
          <strong>성숙 시점</strong>: Linux 5.19(SNP guest), 6.5(SNP host
          production)
        </p>
      </div>
...
# 3) Attestation 받아 pre-launch 검증`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p className="mt-2">
            ...
            - Linux 5.11: SEV-ES 정식 통합
            <br />
            - Linux 5.19: SEV-SNP guest
            <br />- Linux 6.5: SEV-SNP host production
          </p>
          <p className="mt-2">
            <strong>현재(2024)</strong>:<br />
            - 주요 배포판 기본 지원 (Ubuntu 22.04+, RHEL 9+)
            <br />
            - Kubernetes Confidential Containers 통합
            <br />
            - SNP 기능이 default SEV 모드
            <br />- Nested virtualization 지원 개선
          </p>
        </div>
      </div>
    </section>
