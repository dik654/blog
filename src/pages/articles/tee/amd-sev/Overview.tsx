  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>AMD SEV(Secure Encrypted Virtualization)</strong>: EPYC 서버
          CPU의 하드웨어 기반 VM 격리
          <br />
          <strong>첫 도입</strong>: 2016 Naples(1세대 EPYC) — SEV 1.0
          <br />
          <strong>현재</strong>: 2024 Turin(5세대 EPYC) — SEV-SNP with
          Ciphertext Hiding
          <br />
          <strong>목표</strong>: 클라우드 사업자도 게스트 VM 내부를 못 보는 환경
          제공
        </p>
        ...
        <ul>
          <li>
            <strong>기밀성(Confidentiality)</strong> — 메모리 암호화로 평문 노출
            차단
          </li>
          <li>
            <strong>무결성(Integrity)</strong> — SEV-SNP부터 메모리 변조 탐지
            (RMP)
          </li>
          <li>
            <strong>격리(Isolation)</strong> — VM마다 독립 암호 키 (ASID 기반)
          </li>
          <li>
            <strong>원격 증명(Attestation)</strong> — 게스트 측정값을 외부에
            증명
          </li>
        </ul>
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-border px-3 py-2">
                  Host 메모리 매핑 공격 가능 (완화 중)
                </td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <strong>SEV-SNP + CH</strong>
                </td>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            - VM 단위 격리 (TD/Realm과 같은 단위)
            <br />
            - AES 메모리 암호화
            <br />
            - 원격 증명 지원
            <br />- Hypervisor untrusted
          </p>
          <p className="mt-2">
            <strong>차이점</strong>:<br />- <strong>추가 TCB</strong>: TDX는 TDX
            Module(SEAM) / SEV는 ASP firmware
            <br />- <strong>무결성</strong>: TDX 1.5만 MAC 옵션 / SEV-SNP는 RMP
            기본
            <br />- <strong>격리 단위</strong>: TDX는 KeyID 별도 / SEV는 ASID
            기반 per-VM key
            <br />- <strong>Attestation</strong>: TDX는 DCAP / SEV는 VCEK
            per-CPU 인증
          </p>
          <p className="mt-2">
            ...
            - 기존 Intel 인프라 → TDX
            <br />
            - AMD EPYC 기반 클라우드 → SEV-SNP
            <br />- Linux 생태계는 양쪽 다 성숙 (6.5+)
          </p>
        </div>
      </div>
    </section>
