  ...
  return (
    <section id="asp" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>ASP(AMD Secure Processor)</strong> — 구 이름 PSP(Platform
          Security Processor)
          <br />
          EPYC CPU 다이에 내장된 <strong>ARM Cortex-A5</strong> 기반 독립 보안
          프로세서
          <br />
          <strong>자체 펌웨어</strong>(AMD 서명) 실행 — x86 코어와 완전 분리
          <br />
...
// └─────────────────────────────────┘`}</pre>
        ...
        <ul>
          <li>
            <strong>시스템 보안 부팅</strong>: BIOS, kernel 서명 검증 chain
          </li>
          <li>
            <strong>SEV 펌웨어 실행</strong>: 모든 SEV command 처리
          </li>
          <li>
            <strong>키 생성·관리</strong>: VM별 AES 키, 인증서 키
          </li>
          <li>
            <strong>Attestation</strong>: VCEK, SEV Report 서명
          </li>
          <li>
            <strong>TRNG</strong>: 안전한 무작위성 제공
          </li>
          <li>
            <strong>fTPM</strong>: firmware TPM 에뮬레이션 (옵션)
          </li>
        </ul>
...
// - 클라우드 사업자는 최신 펌웨어 강제`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: ASP는 왜 ARM Cortex-A5인가?
          </p>
          <p>
            <strong>디자인 선택 근거</strong>:<br />
            - x86 코어는 speculative execution 취약 (Spectre 등)
            <br />
            - A5는 in-order 단순 코어 → side-channel 공격 표면 작음
            <br />- 독립 ISA → x86 exploit 재활용 불가
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            - Intel Management Engine = 별도 Quark/x86 core
            <br />
            - AMD ASP = Cortex-A5
            <br />
            - 둘 다 "always-on" 보안 코어
            <br />- 그러나 ASP는 SEV 전용, ME는 광범위한 플랫폼 관리
          </p>
        </div>
      </div>
    </section>
