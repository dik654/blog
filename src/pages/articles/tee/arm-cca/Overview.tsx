  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>ARM CCA</strong>(Confidential Compute Architecture): ARMv9-A
          스펙(2021)의 일부
          <br />
          <strong>TrustZone</strong>의 2분법(Normal/Secure) 한계를 넘어{" "}
          <strong>VM 단위 기밀 컴퓨팅</strong> 제공
          <br />
          <strong>첫 구현 실리콘</strong>: Arm Neoverse V3 / Cortex-X925 (2024)
          — 클라우드 + 모바일 대상
        </p>
        ...
        <p>
          <strong>CCA의 해결책</strong>: Realm이라는{" "}
          <strong>동적 보안 영역</strong> 추가
          <br />
        ...
        <p>
          <strong>NS(Non-Secure) + NSE(Non-Secure Extension) 비트 조합</strong>
          으로 4 세계 정의
          <br />각 World는 <strong>
            독립된 Physical Address Space(PAS)
          </strong>{" "}
          보유
          <br />
...
// └───────────────────────────────────────────┘`}</pre>
        ...
        <ul>
          <li>
            <strong>RME (Realm Management Extension)</strong> — 하드웨어 확장.
            PAS·GPT·World 전환 로직
          </li>
          <li>
            <strong>GPT (Granule Protection Table)</strong> — 물리 페이지별
            World 소유권 기록
          </li>
          <li>
            <strong>RMM (Realm Management Monitor)</strong> — EL2 펌웨어. Realm
            라이프사이클 관리
          </li>
          <li>
            <strong>RMI (Realm Management Interface)</strong> — Host → RMM 호출
            규약
          </li>
          <li>
            <strong>RSI (Realm Services Interface)</strong> — Realm Guest → RMM
            호출 규약
          </li>
          <li>
            <strong>CCA Attestation</strong> — Arm CCA Attestation Token
            (CoAP/EAT)
          </li>
        </ul>
  ...
  exit/       — Realm exit 처리`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: CCA의 철학 — Attestation First
          </p>
          <p>
            TDX/SEV-SNP가 "메모리 암호화 + 격리"에서 시작했다면
            <br />
            CCA는 "<strong>원격 검증 가능한 실행 환경</strong>"에서 시작
          </p>
          <p className="mt-2">
            <strong>증거</strong>:<br />- 메모리 암호화는 <strong>옵션</strong>{" "}
            (플랫폼 선택)
            <br />
            - RMM이 CCA Attestation Token 표준화
            <br />- CoAP/EAT(Entity Attestation Token) 기반 — IETF 표준
          </p>
          <p className="mt-2">
            <strong>이유</strong>:<br />
            - 모바일·IoT까지 대상 → 다양한 위협 모델
            <br />
            - 물리적 공격 우려 낮은 서버 vs 물리 접근 가능한 엣지 구분
            <br />- 증명 토큰 받으면 사용자가 정책 결정
          </p>
        </div>
      </div>
    </section>
