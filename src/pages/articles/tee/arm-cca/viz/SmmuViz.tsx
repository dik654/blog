  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={405} y={84} textAnchor="middle" fontSize={7} fill="#10b981">
          ✓ NS→NS 접근 OK
        </text>
        <text x={405} y={96} textAnchor="middle" fontSize={7} fill="#ef4444">
          ✗ NS→Realm 거부
        </text>
        ...
        <text x={35} y={160} fontSize={8} fontWeight={700} fill="#3b82f6">
          [1] Normal World device → Realm 메모리
        </text>
        ...
        <text x={35} y={200} fontSize={8} fontWeight={700} fill="#10b981">
          [2] Realm → device (shared buffer)
        </text>
