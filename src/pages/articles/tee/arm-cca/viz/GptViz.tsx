  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={405} y={78} textAnchor="middle" fontSize={7} fill="#10b981">
          ✓ 허용
        </text>
        <text x={405} y={90} textAnchor="middle" fontSize={7} fill="#ef4444">
          ✗ GPF(Fault)
        </text>
