  ...
  return (
    <section id="rmi-rsi" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          RMM은 <strong>두 개의 독립된 ABI</strong>를 노출
          <br />
          <strong>RMI</strong>: Host → RMM (Realm 관리용)
          <br />
          <strong>RSI</strong>: Realm → RMM (서비스 요청용)
          <br />
    ...
    asm volatile("hvc #0"
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr>
                <td className="border border-border px-3 py-2" rowSpan={2}>
                  Granule
                </td>
                <td className="border border-border px-3 py-2">
                  <code>RMI_GRANULE_DELEGATE</code>
                </td>
                <td className="border border-border px-3 py-2">
                  NS → Realm PAS
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RMI_GRANULE_UNDELEGATE</code>
                </td>
                <td className="border border-border px-3 py-2">
                  Realm → NS (zeroize)
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2" rowSpan={3}>
                  Realm
                </td>
                <td className="border border-border px-3 py-2">
                  <code>RMI_REALM_CREATE</code>
                </td>
                <td className="border border-border px-3 py-2">RD 초기화</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RMI_REALM_ACTIVATE</code>
                </td>
                <td className="border border-border px-3 py-2">
                  RIM 확정, 실행 허용
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RMI_DATA_CREATE_UNKNOWN</code>
                </td>
                <td className="border border-border px-3 py-2">
                  측정 없는 페이지 (런타임)
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RMI_RTT_MAP_UNPROTECTED</code>
                </td>
                <td className="border border-border px-3 py-2">
                  Shared IPA 매핑
                </td>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_REALM_CONFIG</code>
                </td>
                <td className="border border-border px-3 py-2">
                  Realm 속성 조회 (IPA bits 등)
                </td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_IPA_STATE_GET</code>
                </td>
                <td className="border border-border px-3 py-2">
                  IPA 상태 조회 (RAM/EMPTY)
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_ATTESTATION_TOKEN_INIT</code>
                </td>
                <td className="border border-border px-3 py-2">
                  증명 토큰 생성 시작
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_ATTESTATION_TOKEN_CONTINUE</code>
                </td>
                <td className="border border-border px-3 py-2">
                  토큰 chunk 전송 (long token)
                </td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_MEASUREMENT_EXTEND</code>
                </td>
                <td className="border border-border px-3 py-2">
                  REM[0..3] 확장
                </td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code>RSI_MEASUREMENT_READ</code>
                </td>
...
// → Intel TDX의 Shared bit와 대응`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            Intel TDX는 <strong>단일 ABI</strong>로 TDH/TDG 구분 (leaf number로)
            <br />
          ...
          <p className="mt-2">
            ...
            ✓ 호출 경로에서 바로 발신자 식별
            <br />
            ✓ CPU 인스트럭션 권한 검사가 1차 방어
            <br />✓ Host가 실수로 RSI 호출 불가 (HVC는 EL1에서만)
          </p>
          <p className="mt-2">
            <strong>단점</strong>:<br />
            ✗ 두 개의 dispatcher 유지 (복잡도)
            <br />
            {"✗ 호출 오버헤드 차이 (SMC > HVC)"}
          </p>
        </div>
