      ...
      {(step) => (
        ...
        >
          ...
          <motion.rect
            ...
            rx={4}
            animate={{
              fill: step === 0 ? `${C3}20` : `${C3}08`,
              stroke: C3,
              strokeWidth: step === 0 ? 1.2 : 0.5,
            }}
            transition={sp}
          />
          <text x={250} y={70} textAnchor="middle" fontSize={10} fill={C3}>
            AES-CMAC KDF
          </text>
          ...
          {step >= 1 && (
            ...
            >
              ...
              <rect
                ...
                height={26}
                rx={5}
                fill={step === 2 ? "#ef444415" : `${C2}15`}
                stroke={step === 2 ? "#ef4444" : C2}
                strokeWidth={1}
              />
              <text
                x={140}
          ...
          {step === 2 && (
            ...
            >
              ...
              <text x={360} y={142} textAnchor="middle" fontSize={10} fill={C3}>
                v1→v2: 키 유지 (접근 가능)
              </text>
            </motion.g>
          )}
