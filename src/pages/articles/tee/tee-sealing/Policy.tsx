  ...
  return (
    <section id="policy" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          <strong>KEYPOLICY</strong>: Seal Key 파생 시 어떤 측정값 포함하는지
          결정
          <br />
          <strong>MRENCLAVE</strong>: 정확한 바이너리 고정 (엄격)
          <br />
          <strong>MRSIGNER</strong>: 서명자 기준 (유연)
          <br />
          <strong>선택이 유지보수·보안 모두 결정</strong> — 사후 변경 불가 (이미
          봉인된 데이터)
        </p>
...
//   - 키 유출 위험 관리 가능한 조직`}</pre>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            <strong>Level 1 (MRENCLAVE)</strong>: 최상위 마스터 키 (32B)
            <br />- <strong>Level 2 (MRSIGNER)</strong>: 업데이트 가능한 데이터
            키들
            <br />- 마스터 키로 데이터 키 암호화 → 이중 보호
          </p>
          <p className="mt-2">
            <strong>이점</strong>:<br />
            ✓ 마스터는 불변 (강한 root of trust)
            <br />
            ✓ 데이터 키는 자유롭게 rotate
            <br />✓ 공격자가 서명 키만 얻어도 마스터 못 얻음
          </p>
          <p className="mt-2">
            <strong>실전 사용</strong>:<br />
            - Hyperledger Fabric/Avalon
            <br />
            - Oasis Network Key Manager
            <br />- Confidential Computing Consortium 권장 패턴
          </p>
        </div>
      </div>
    </section>
