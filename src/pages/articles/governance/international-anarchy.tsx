    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            국가들 사이에는 그 자리가 없습니다. 그러면 첫 글의 문제가 그대로 돌아오는데 이번에는 강제라는 해법 없이 돌아옵니다.
          </p>
        </div>
      ...
      <section id="no-sovereign" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 사라지는 것이 정확히 무엇인지가 중요합니다. 다툼이 생겼을 때 끝을 내주는 자리와 약속을 어겼을 때 대신 집행해 주는 자리입니다. 이 둘이 없으면 남는 것은 각자의
            판단과 각자의 힘뿐이고 이 상태를 자력구제라고 부릅니다.
          </p>

          <p className="leading-7">
            여기서 오해를 하나 걷어 내야 합니다. 자력구제는 언제나 싸운다는 뜻이 아닙니다. 최후에 기댈 곳이 자기 자신뿐이라는 뜻이며 그 사실이 평시의 선택까지 바꾼다는 것이 다음 절의
            내용입니다.
          </p>
        </div>
      ...
      <section id="security-dilemma" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그러면 서로 나쁜 뜻이 없어도 같은 결과가 나옵니다. 가가 대비를 늘리면 나에게는 위협이 커진 것으로 보이고 나도 늘리면 가에게 같은 일이 일어납니다. 둘 다 자원을 더 쓰고
            둘 다 처음보다 덜 안전해집니다.
          </p>
      ...
      <section id="shadow" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그 무언가는 미래입니다. 한 번 어기고 끝나는 관계라면 어기는 쪽이 늘 낫습니다. 그런데 같은 상대를 계속 만나야 한다면 한 번 얻는 것과 앞으로 잃을 것을 견줘야 합니다.
          </p>
      ...
      <section id="institutions" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 강제력이 없다는 것이 무력하다는 뜻은 아닙니다. 기구는 약속을 집행하는 것이 아니라 약속이 스스로 서는 조건을 만듭니다. 다만 조건을 만들 뿐이므로 조건이 아무리 좋아도
            문턱을 넘지 못하는 사안에서는 아무 일도 일어나지 않습니다.
          </p>
        </div>
      ...
      <section id="limits" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            둘 다 이익을 보는 합의라도 한쪽이 더 많이 얻으면 그 차이가 나중에 힘의 차이가 됩니다. 그리고 최후에 기댈 곳이 자기 자신뿐인 상태에서는 힘의 차이가 곧 안전의 차이입니다.
            그래서 이익이 얼마인지뿐 아니라 누가 더 얻는지가 판단에 들어옵니다.
          </p>
          ...
          <p className="leading-7">
            또 하나 남는 것은 국가를 하나의 행위자로 둔 단순화입니다. 실제로 협상하는 사람은 앞의 여덟 글이 다룬 국내 구조 안에 있습니다. 상대국과 합의해도 자기 의회를 통과하지
            못하면 소용이 없고 그 사실 자체가 협상의 도구가 되기도 합니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            3편에서 거부권자가 늘수록 통과 가능한 영역이 좁아진다는 것을 봤습니다. 국제 합의도 결국 국내에서 비준되어야 한다면 그 나라가 받아들일 수 있는 안의 범위는 국내 거부권자들이
            정합니다.
          </p>
          <p className="leading-7">
            그러면 그 범위가 좁다는 사실이 협상에서 힘이 됩니다. 상대가 원하는 안을 받아들이고 싶어도 국내에서 부결될 것이 분명하면 상대는 통과 가능한 쪽으로 옮겨 올 수밖에 없습니다.
            협상 대표가 자기 손이 묶여 있다는 것을 굳이 보여 주는 이유입니다.
          </p>
          <p className="leading-7">
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            첫 글의 질문은 모두가 원하지만 각자에게는 낼 이유가 없는 것을 어떻게 만드는가였습니다. 답은 강제였고 그 뒤 일곱 글은 그 강제력을 누가 쥐고 어떻게 묶고 어떻게 쓰는지를
            따라갔습니다.
          </p>

          <p className="leading-7">
            이 글에서 그 답이 조건부였다는 것이 드러났습니다. 강제라는 해법은 강제할 자리가 있을 때만 쓸 수 있고 그 자리가 없으면 첫 글의 문제가 그대로 돌아옵니다. 그때 남는 것은
            반복과 확인과 평판이며 이것들은 강제보다 약하고 조건이 많이 붙습니다.
          </p>
