  ...
  return (
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 결정문이 곧 현실은 아닙니다. 법률에 적힌 것은 일반적인 문장이고 현실은 개별 사안이라, 둘 사이를 잇는 일이 따로 남습니다. 그 일을 하는 조직이 있고 그 조직을
            거치는 동안 결정된 것이 조금씩 달라집니다.
          </p>
      ...
      <section id="why-delegate" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            의회가 모든 것을 직접 정하면 되지 않느냐는 생각이 자연스럽습니다. 그런데 그것이 불가능한 이유가 셋 있고 셋 다 의지의 문제가 아닙니다.
          </p>
          ...
          <p className="leading-7">
            그래서 결정하는 쪽은 뼈대만 정하고 나머지를 맡깁니다. 한국 헌법도 이 구조를 전제하고 있어서 대통령령을 발할 수 있게 하되 법률이 구체적으로 범위를 정해 위임한 사항으로
            한정합니다. 맡기는 것을 금지하는 대신 맡기는 방식에 조건을 거는 쪽을 택한 것입니다.
          </p>
        </div>
      ...
      <section id="agency" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            맡긴 쪽과 맡은 쪽은 서로 다른 것을 압니다. 맡긴 쪽은 무엇을 원하는지 알고 맡은 쪽은 현장에서 무슨 일이 일어나는지 압니다. 이 어긋남이 이 글 나머지 문제의 뿌리입니다.
          </p>
          ...
          <p className="leading-7">
            이 어긋남은 나쁜 사람 때문에 생기지 않습니다. 맡긴다는 것은 곧 자기가 하지 않는다는 뜻이고 하지 않으면 보이지 않습니다. 그래서 완전히 정직한 조직에서도 같은 문제가
            남습니다.
          </p>
        </div>
      ...
      <section id="rules-or-discretion" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            어긋남에 대한 첫 번째 대응은 미리 적어 두는 것입니다. 무엇을 어떤 순서로 어떻게 처리할지를 규칙으로 정해 두면 맡은 쪽이 다르게 할 여지가 줄어듭니다. 실제로 행정 조직의
            절차가 두꺼운 이유가 여기 있습니다.
          </p>

          <p className="leading-7">
            규칙이 주는 것은 통제만이 아닙니다. 같은 사안을 누가 맡아도 같은 답이 나오므로 예측할 수 있게 되고 대상자가 이의를 제기할 근거도 생깁니다. 앞 글들에서 본 자의적 권력
            문제가 여기서도 같은 방식으로 다뤄집니다.
          </p>

          <p className="leading-7">
            대가는 분명합니다. 규칙은 만들 때 알고 있던 사안만 담을 수 있는데 현실은 그 목록 밖으로 계속 나갑니다. 규칙에 없는 사정이 있어도 담당자는 규칙대로 처리하고 그러면 결과가
            명백히 나빠도 아무도 책임지지 않습니다. 규칙을 지킨 것이 잘못일 수 없기 때문입니다.
          </p>
        ...
        <div id="street-level" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              이 자리의 특징은 자원이 늘 모자란다는 것입니다. 시간과 인력이 사안 수보다 적으면 무언가를 먼저 처리하고 무언가를 미뤄야 하고 그 순서를 정하는 기준은 대개 규칙에 적혀
              있지 않습니다. 담당자가 스스로 만든 요령이 그 자리를 채웁니다.
            </p>
            ...
            <p className="leading-7">
              이 요령은 규칙 위반이 아닙니다. 규칙이 모든 순서를 정해 주지 않았으므로 누군가는 정해야 하고 그 자리에 있는 사람이 정합니다. 집행을 바꾸려면 이 자리의 조건을 바꿔야
              하지 법문만 고쳐서는 닿지 않습니다.
            </p>
          </div>
        </div>
      ...
      <section id="measurement" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            공공 업무에는 셀 수 있는 부분과 셀 수 없는 부분이 섞여 있습니다. 처리 건수는 셀 수 있지만 판단의 질은 셀 수 없고 적발 실적은 셀 수 있지만 어려운 사안을 끝까지
            파고들었는지는 셀 수 없습니다. 그리고 두 부분은 같은 시간을 두고 다툽니다.
          </p>

          <p className="leading-7">
            그러면 셀 수 있는 쪽에만 보상을 걸었을 때 어떤 일이 생기는지가 계산됩니다. 결과는 직관보다 강합니다. 보상을 강하게 걸수록 셀 수 없는 쪽의 노력이 줄어들고 어느 지점에서는
            정확히 0이 됩니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            지표를 없애면 앞 절의 문제로 돌아갑니다. 한 일이 보이지 않으니 평가할 근거가 사라지고 그러면 통제는 절차를 지켰는지만 보는 형태로 남습니다. 결과가 좋아졌는지는 여전히
            아무도 모릅니다.
          </p>
          <p className="leading-7">
            계산이 가리키는 것은 지표를 없애라는 것이 아니라 보상의 세기를 조절하라는 것입니다. 셀 수 없는 쪽이 중요할수록 셀 수 있는 쪽에 거는 보상을 약하게 두어야 하고 그
            극단에서는 성과와 무관한 고정급이 최선이 됩니다. 공공 부문의 보수가 성과에 덜 연동되는 것이 반드시 후진적인 설계는 아닙니다.
          </p>
          <p className="leading-7">
      ...
      <section id="control" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            남은 것은 맡긴 쪽이 쓸 수 있는 수단들입니다. 크게 넷이고 넷 다 무언가를 얻는 대신 무언가를 내놓습니다.
          </p>
          ...
          <p className="leading-7">
            다음은 벌어진 뒤에 확인하는 방법입니다. 감사, 국정조사, 예산 심의가 여기 속합니다. 개별 사안을 실제로 들여다보므로 정확하지만 비용이 크고 비용이 크므로 드물게만 할 수
            있습니다. 그래서 이 방식은 문제가 소리를 내야 작동합니다.
          </p>
