    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            앞 글에서 본 힘은 약속한 두 사람 사이에만 미쳤습니다. 물건을 넘기기로
            한 사람이 어기면 그 사람에게 물릴 수 있지만, 그 물건을 가로챈 다른
            사람에게는 이 약속을 들이댈 수 없습니다.
          </p>

          <p className="leading-7">
            그런데 내 물건이라는 주장은 다릅니다. 가져간 사람이 누구든 통하고,
            그 사람과 내가 아무 약속도 하지 않았어도 통합니다. 두 사람이 정한
            것이 어떻게 그 둘의 범위를 넘어갑니까.
          </p>
      ...
      <section id="publicity" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            대가가 하나 더 있습니다. 만들 수 있는 권리의 종류가 미리 정해진
            목록으로 제한된다는 것입니다. 당사자가 마음대로 새 종류를 만들면
            제삼자가 일일이 확인할 수 없어, 알 수 있게 한다는 조건이 무너집니다.
          </p>
        </div>
      ...
      <section id="bundle" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            묶음으로 보면 풀립니다. 쓰는 권능, 거기서 나오는 것을 가져가는 권능,
            남을 배제하는 권능, 넘기거나 없앨 권능이 각각 있고, 이것들을 떼어
            다른 사람에게 줄 수 있습니다.
          </p>

          <p className="leading-7">
            세를 주는 것은 쓰는 권능을 기간을 정해 넘기는 것이고, 담보로 잡히는
            것은 갚지 않을 때 팔아 값을 받을 권능을 넘기는 것입니다. 나머지는
            그대로 두고 필요한 조각만 옮깁니다.
          </p>
      ...
      <section id="two-protections" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            하나는 가져가려면 주인에게서 사야 한다는 것입니다. 값은 주인이 정하고,
            싫으면 팔지 않아도 됩니다. 다른 하나는 값을 매겨 옮긴 뒤 그 값을 물어
            주게 하는 것입니다. 값을 정하는 것은 주인이 아니라 바깥의 기관입니다.
          </p>

          <p className="leading-7">
            앞쪽이 강해 보이지만 언제나 나은 것은 아닙니다. 사려면 협상해야 하고,
            협상해야 할 상대가 많아지면 한 사람만 버텨도 전체가 무산됩니다. 그러면
            옮기는 편이 나은 자원이 옮겨 가지 못합니다.
          </p>
      ...
      <section id="forced-transfer" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            도로나 철도를 놓으려고 땅을 모으는 경우가 대표적입니다. 필요한
            필지가 많아질수록 한 사람이 버티는 것만으로 전체가 멈추고, 그 사람은
            자기 땅의 가치가 아니라 사업 전체의 가치를 요구할 수 있게 됩니다.
          </p>
        ...
        >
          ...
          <p className="leading-7">
            그래서 물어 주는 값은 구조적으로 실제 손실보다 작게 나오는 경향이
            있습니다. 앞 절 식의 오차 항이 한쪽으로 치우쳐 있다는 뜻이고, 그
            치우침이 클수록 동의 없는 이전의 문턱을 높게 잡아야 합니다.
          </p>
          <p className="leading-7">
            그래서 제도는 값만이 아니라 절차로도 다룹니다. 미리 알리고, 다툴
            기회를 주고, 정말 필요한 범위인지 따로 심사하게 하는 것입니다. 값을
            정확히 재기 어려운 만큼 절차가 그 자리를 메웁니다.
          </p>
        </ProgressiveDetail>
      </section>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 경계를 넘을 뜻이 전혀 없었는데 넘어가는 일이 있습니다.
            사고입니다. 아무도 남의 것을 가져가려 하지 않았는데 손해가 생기고,
            그 손해를 누군가는 져야 합니다.
          </p>
