  ...
  return (
    <div className="space-y-16">
      ...
      <section id="where-loss-sits" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            법이 아무것도 하지 않으면 손해는 그것을 입은 사람에게 그대로 남습니다. 이것이 기본값이고 옮기려면 옮길 이유를 대야 합니다.
          </p>

          <p className="leading-7">
            그래서 물어야 할 것이 옮길 이유입니다. 다친 사람이 딱하다는 것만으로는 부족합니다. 딱함을 이유로 옮기면 누구에게 옮길지가 정해지지 않고 옮겨 받는 쪽도 그 사고를 막을 수
            없었다면 옮겨서 얻는 것이 없습니다.
          </p>

          <p className="leading-7">
            옮기는 이유는 대개 둘입니다. 하나는 옮겨 받는 쪽이 그 사고를 더 싸게 막을 수 있었다는 것이고 다른 하나는 그쪽이 그 위험을 더 잘 나눠 질 수 있다는 것입니다. 앞쪽은
            사고를 줄이고 뒤쪽은 충격을 줄입니다.
          </p>
      ...
      <section id="which-rule" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그러면 규칙의 선택이 곧 누가 그 계산을 할지의 선택이 됩니다. 아무도 책임지지 않게 두면 일으킨 쪽은 조심할 이유가 없고 일으킨 쪽이 결과만으로 물게 하면 당한 쪽이 조심할
            이유가 없어집니다.
          </p>
      ...
      <section id="scope" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            끊는 기준은 둘입니다. 하나는 그 조치가 막으려던 종류의 위험이었는지입니다. 다른 하나는 그 손해가 예견할 수 있는 범위였는지입니다. 둘 다 앞 절의 계산과 이어져 있습니다.
          </p>

          <p className="leading-7">
            예견할 수 없었던 손해까지 물리면 예방 계산에 넣을 수 없었던 것까지 부담하게 되고 그러면 조심하는 것과 무는 것의 연결이 끊어집니다. 그때부터 책임은 유인 장치가 아니라
            복권이 됩니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            그래서 판정은 구조적으로 한쪽으로 기웁니다. 그때는 아주 낮았던 확률이 지금 보면 충분히 높아 보이고 그러면 하지 않아도 됐을 조치를 했어야 한다고 판정하게 됩니다.
          </p>
          <p className="leading-7">
            이 편향을 줄이는 방법은 그때 알 수 있었던 정보로만 재도록 절차를 묶는 것입니다. 사후에 드러난 사실을 판단에서 빼고 그 분야에서 그때 통용되던 기준을 기준선으로 삼는
            식입니다. 완전히 없앨 수는 없고 줄이는 장치만 있습니다.
          </p>
        </ProgressiveDetail>
      </section>
