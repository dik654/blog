    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            국가 안에서는 그 자리가 있습니다. 그러면 한 번 만나고 끝나는 상대와도
            약속이 설 수 있고, 되갚을 힘이 없는 쪽도 약속을 받을 수 있습니다. 앞
            글의 조건들이 느슨해지는 것입니다.
          </p>

          <p className="leading-7">
            그런데 그 힘을 아무 약속에나 붙여 주지는 않습니다. 붙여 주는 약속과
            그렇지 않은 약속을 가르는 체가 있고, 붙여 준 뒤에도 무엇을 물릴지가
            또 하나의 선택으로 남습니다.
          </p>
        </div>
      ...
      <section id="which-promises" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이유는 비용입니다. 모든 약속에 법의 힘을 붙이면 저녁을 사겠다는 말
            하나로도 법원이 움직여야 하고, 사람들은 가벼운 말조차 하지 못하게
            됩니다. 약속의 값을 올리면 약속 자체가 줄어듭니다.
          </p>
          ...
          <p className="leading-7">
            셋째와 넷째는 내용입니다. 무엇을 언제 얼마에 할지가 정해져야 어겼는지
            판정할 수 있고, 금지된 것을 하기로 한 약속에는 힘을 붙여 줄 수
            없습니다.
          </p>
        </div>
      ...
      <section id="remedy-choice" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            하게 만들려면 계속 지켜봐야 합니다. 물건을 넘기는 것처럼 한 번에
            끝나는 일이면 시킬 수 있지만, 몇 달에 걸쳐 어떤 품질로 일하게 하는
            것은 법원이 감독할 수 없습니다. 그리고 사람에게 특정한 노동을 강제하는
            것은 그 자체로 다른 문제를 부릅니다.
          </p>
      ...
      <section id="damages" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            상황을 보겠습니다. 약속한 뒤에 사정이 바뀌어 이행하는 데 드는 비용이
            크게 올랐습니다. 이때 어기는 쪽은 배상액과 이행 비용을 견주고, 사회는
            이행 비용과 상대가 얻을 이익을 견줍니다. 두 비교의 기준이 다르면
            판단이 어긋납니다.
          </p>
      ...
      <section id="incomplete" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 적을 수 없습니다. 일어날 수 있는 일을 전부 떠올릴 수 없고,
            떠올려도 전부 적으면 협상이 끝나지 않습니다. 앞 글의 계산이 여기서
            다시 나옵니다. 미리 적어 두는 비용과 그때 가서 정하는 비용을 견주는
            문제이고, 계약 당사자에게는 사안이 한 건뿐이라 미리 적는 쪽이 대체로
            비쌉니다.
          </p>

          <p className="leading-7">
            그래서 계약에는 반드시 빈칸이 남습니다. 그 빈칸을 법이 대신 메워 두고,
            당사자가 다르게 정하면 그쪽을 따릅니다. 미리 적지 않아도 되는 기본값을
            제공하는 것입니다.
          </p>
        ...
        >
          ...
          <p className="leading-7">
            예를 들어 손해가 특별히 클 사정을 아는 쪽이 있다면, 기본값을 통상적인
            손해까지만 물어 주는 것으로 두는 편이 낫습니다. 그러면 특별한 사정이
            있는 쪽이 미리 알리고 값을 조정하게 되고, 알리지 않으면 그 위험은
            아는 쪽이 집니다.
          </p>
        </ProgressiveDetail>
      </section>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이 글에서 본 것은 전부 약속한 두 사람 사이의 이야기입니다. 물건을
            대기로 한 사람이 어기면 그 사람에게 물릴 수 있지만, 그 물건을 가로챈
            제삼자에게는 이 계약을 들이댈 수 없습니다.
          </p>
