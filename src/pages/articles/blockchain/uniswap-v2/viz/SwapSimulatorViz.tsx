  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={34} y={84} fontSize={10} fill="var(--muted-foreground)">
          reserve0 (USDC)
        </text>
        <text
          x={242}
        ...
        <line
          ...
          opacity={0.5}
        />
        <text x={34} y={104} fontSize={10} fill="var(--muted-foreground)">
          reserve1 (ETH)
        </text>
        <text
          x={242}
        ...
        <line
          ...
          opacity={0.5}
        />
        <text x={34} y={124} fontSize={10} fill="var(--muted-foreground)">
          가격 (USDC/ETH)
        </text>
        <text
          x={242}
        ...
        <text x={279} y={84} fontSize={10} fill="var(--muted-foreground)">
          reserve0 (USDC)
        </text>
        <text
          x={487}
        ...
        <line
          ...
          opacity={0.5}
        />
        <text x={279} y={104} fontSize={10} fill="var(--muted-foreground)">
          reserve1 (ETH)
        </text>
        <text
          x={487}
        ...
        <line
          ...
          opacity={0.5}
        />
        <text x={279} y={124} fontSize={10} fill="var(--muted-foreground)">
          새 marginal 가격
        </text>
        <text
          x={487}
