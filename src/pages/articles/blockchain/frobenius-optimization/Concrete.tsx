  ...
  return (
    <section id="concrete" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          가장 단순한 확장체 Fp2 위에서 Frobenius를 적용해 보자. Fp2의 원소{" "}
...
// 결과: 3 + 5·(-u) = 3 - 5u = 3 + 2u  (mod 7)`}
        ...
        <p>
          ...
          곱셈이 아니라 부호 하나 바꾸는 것이다.
          <br />
          Fp12에서는 이 패턴이 타워 구조를 따라 확장되어, 하위 6개 계수는
          유지되고 상위 6개 계수에 상수가 곱해진다.
        </p>
      </div>
    </section>
  );
