    ...
    <StepViz steps={STEPS}>
      {(step) => (
        <svg viewBox="0 0 520 280" className="w-full max-w-2xl" style={{ height: 'auto' }}>
          ...
          <motion.g animate={{ opacity: step === 0 ? 1 : 0.05 }} transition={sp}>
          ...
          <motion.g animate={{ opacity: step === 1 ? 1 : 0.05 }} transition={sp}>
            ...
            <text x={468} y={61} textAnchor="middle" fontSize={9} fill={C.muted}>(상수)</text>
          ...
          <motion.g animate={{ opacity: step === 2 ? 1 : 0.05 }} transition={sp}>
            ...
            <motion.rect initial={false} x={41} y={173} height={26} rx={3} fill={`${C.red}25`}
            ...
            <motion.rect initial={false} x={41} y={215} height={26} rx={3} fill={`${C.green}25`}
