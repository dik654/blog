      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                throughput: <code className="text-xs">100K+ TPS</code>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              ...
              <p>
                <code className="text-xs">base_timeout = 1s</code>,{" "}
                <code className="text-xs">γ = 1.2</code> (geometric backoff)
              </p>
              <p>
                k = round 지속 시간. Byzantine premature timeout 방어: TC로 자동
                동기화
              </p>
            </div>
          </div>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                ...
                → leader면 propose, timer 시작
              </p>
              <p>
                <strong>2.</strong> QC(round) 수신 → process QC, next round /
                TC(round) 수신 → skip to{" "}
                <code className="text-xs">TC.round+1</code>
              </p>
              <p>
                <strong>3.</strong> timeout 시 →{" "}
                <code className="text-xs">Timeout(round, highQC, highTC)</code>{" "}
                전송 → 2f+1 수집 → <code className="text-xs">TC(round)</code>{" "}
                형성 → next round
              </p>
            </div>
          </div>
        ...
        <div className="not-prose grid grid-cols-1 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <div className="text-sm text-muted-foreground">
              높은 QC 받으면 skip 가능: <code className="text-xs">QC(r)</code>{" "}
              received &amp;&amp;{" "}
              <code className="text-xs">current_round &lt; r</code> → update.
              빠른 view 동기화 + byzantine 저항 + async-safe (Ditto fallback)
            </div>
          </div>
        </div>
        <p className="leading-7">
          Pacemaker = <strong>view 동기화 + timeout 관리</strong>.<br />
          TC와 QC로 자동 fast-forward.
          <br />
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">epoch: u64</code> /{" "}
                <code className="text-xs">round: u64</code> /{" "}
                <code className="text-xs">timestamp: u64</code>
              </li>
              <li>
                <code className="text-xs">payload: Payload</code> — QS batches
              </li>
              <li>
                <code className="text-xs">qc: QuorumCert</code> — parent QC
              </li>
              <li>
                <code className="text-xs">tc: Option&lt;TC&gt;</code> — view
                change 시
              </li>
            </ul>
          </div>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                block payload = batch references (
        ...
        <p className="leading-7">
          ...
          100K+ TPS 목표 — production-grade BFT blockchain.
          <br />
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              검증자 간 라운드 진행 속도를 동기화.
              <br />
              timeout-certificate 기반 view 진행.
              <br />
              라운드가 분기되지 않도록 보장
            </p>
          </div>
        ...
        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 왜 Aptos는 DiemBFT v4를 채택했나</strong> — Diem 팀의 계승.
          <br />
          Aptos Labs는 Diem 개발자들이 창립 (2021).
          <br />
          3년간 Diem에서 검증된 코드 + production 경험.
          <br />
