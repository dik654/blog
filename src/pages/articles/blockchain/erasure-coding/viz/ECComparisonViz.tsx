...
const STEPS = [
  {
    label: "세 가지 이레이저 코딩 비교",
    body: "RS, Fountain, LDPC — 각각의 트레이드오프를 비교합니다.",
  },
  {
    label: "Reed-Solomon: 최적 복구, 높은 복잡도",
    body: "RS는 MDS 코드로 최적 복구율. 그러나 O(n^2) 디코딩 복잡도.",
  },
  {
    label: "Fountain Code: Rateless, 낮은 복잡도",
    body: "Fountain은 무한 패리티 생성 가능. 비율 제한 없어 유연하지만 오버헤드 발생.",
  },
  {
    label: "LDPC: 통신 표준, 균형",
    body: "LDPC는 5G/WiFi 표준. 희소 행렬로 빠른 디코딩. 블록체인에선 제한적.",
  },
];
const BX = [60, 190, 320],
  BY = 28,
