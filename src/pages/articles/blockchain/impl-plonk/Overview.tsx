    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <br />
          PLONKish는 5개 selector 계수 조합으로 Add, Mul, Bool, 상수를 하나의
          방정식으로 통합
          <br />
          q_L*a + q_R*b + q_O*c + q_M*a*b + q_C = 0 — 계수만 바꾸면 게이트 유형
          결정
        </p>
        <p className="leading-7">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h4>구현 인사이트</h4>
        <p className="leading-7">
          pad_to_power_of_two — 더미 게이트(selector 전부 0)로 패딩하여 FFT 호환
          보장
          <br />
          selector_polynomials에서 Lagrange 보간 — O(n^2) 비용이지만
          교육용에서는 충분
          <br />
