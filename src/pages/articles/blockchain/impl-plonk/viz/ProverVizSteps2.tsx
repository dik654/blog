  ...
  return (
    <g>
      ...
      <VizBox
        ...
        w={180}
        h={34}
        label="r(x) = linearization"
        sub="wire 값을 scalar로 대체"
        c={CV}
        delay={0.1}
      />
      <VizBox
...
export function VerifierStep() {
  const steps = [
    {
      n: "1",
      label: "Fiat-Shamir 재현",
      desc: "b, g, alpha, zeta, nu, u",
      c: CV,
    },
    {
      n: "2",
      label: "[r]_1 계산",
      desc: "selector + Z + sigma commitment 선형 결합",
      c: CE,
    },
    {
      n: "3",
      label: "F = [r] + nu*[a] + ... + u*[Z]",
      desc: "batched commitment",
      c: CA,
    },
    {
      n: "4",
      label: "Pairing Check",
      desc: "e(W+u*W_w, [t]_2) = e(..., G_2)",
      c: CV,
    },
  ];
  return (
