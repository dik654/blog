...
import { R1CSvsPlonkStep, GateTypesStep } from './OverviewVizSteps';
import { DomainStep, CSStep } from './OverviewVizSteps2';

const RENDERERS = [R1CSvsPlonkStep, GateTypesStep, DomainStep, CSStep];
