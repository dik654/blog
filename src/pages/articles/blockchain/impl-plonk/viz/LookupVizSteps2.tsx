...
export function SortedMergeStep() {
  ...
  return (
    <g>
      <text x={20} y={16} fontSize={8} fontWeight={600} fill={CV}>
        T (테이블)
      </text>
      {t.map((v, i) => (
        <motion.g
      ...
      <text x={200} y={16} fontSize={8} fontWeight={600} fill={CE}>
        f (조회값)
      </text>
      {f.map((v, i) => (
        <motion.g
      ...
      >
        <text x={20} y={68} fontSize={8} fontWeight={600} fill={CA}>
          sorted = f ∪ T
        </text>
      </motion.g>
      {sorted.map((v, i) => (
      ...
      {lines.map((l, i) => (
        ...
        >
          <rect
            ...
            strokeWidth={0.5}
          />
          <text x={40} y={42 + i * 30} fontSize={8} fill={l.c}>
            {l.label}
          </text>
        </motion.g>
      ))}
