...
export function CopyConstraintStep() {
  ...
  return (
    <g>
      ...
      >
        <text x={260} y={65} fontSize={8} fill={CA}>
          (C,0) = (A,1) = 7
        </text>
      </motion.g>
    </g>
...
export function UnionFindStep() {
  const nodes = [
    { label: "(A,0)", x: 40, y: 30 },
    { label: "(B,0)", x: 120, y: 30 },
    { label: "(C,0)", x: 200, y: 30 },
    { label: "(A,1)", x: 280, y: 30 },
    { label: "(B,1)", x: 360, y: 30 },
    { label: "(C,1)", x: 200, y: 90 },
  ];
  return (
    <g>
      {nodes.map((n, i) => (
        ...
        >
          ...
          <text
            ...
            textAnchor="middle"
            fontSize={8}
            fill={i === 2 || i === 3 ? CA : "var(--foreground)"}
          >
            {n.label}
          </text>
        </motion.g>
