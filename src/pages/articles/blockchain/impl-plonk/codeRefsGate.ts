    ...
    annotations: [
      {
        lines: [2, 8],
        color: "sky",
        note: "5개 selector — 계수 조합으로 다양한 게이트 표현",
      },
      {
        lines: [12, 16],
        color: "emerald",
        note: "Add: q_L=q_R=1, q_O=-1 → a+b-c=0",
      },
      { lines: [20, 23], color: "amber", note: "Mul: q_M=1, q_O=-1 → a·b-c=0" },
      {
        lines: [26, 29],
        color: "violet",
        note: "Bool: q_L=1, q_M=-1 → a-a²=0, a∈{0,1}",
      },
    ],
  },
  "plonk-cs": {
    ...
    annotations: [
      {
        lines: [1, 8],
        color: "sky",
        note: "CS 핵심 필드 — 변수 풀, 게이트, copy, lookup",
      },
      {
        lines: [12, 16],
        color: "emerald",
        note: "alloc: Vec에 push → 인덱스가 변수 ID",
      },
      {
        lines: [19, 22],
        color: "amber",
        note: "add_gate: selector + 3 wire 인덱스를 묶어 GateInstance",
      },
      {
        lines: [25, 28],
        color: "violet",
        note: "copy_constraint: (column, row) 쌍으로 변수 공유 선언",
      },
    ],
  },
};
