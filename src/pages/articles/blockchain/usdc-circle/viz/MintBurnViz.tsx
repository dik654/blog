  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        {/* Mint (상단) */}
        <text x={30} y={42} fontSize={10} fontWeight={700} fill="#10b981">
          MINT
        </text>
        ...
        {/* Burn (하단) */}
        <text x={30} y={150} fontSize={10} fontWeight={700} fill="#ef4444">
          BURN (환급)
        </text>
