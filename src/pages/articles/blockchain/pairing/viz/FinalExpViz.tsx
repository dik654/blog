        ...
        >
          {step === 0 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.ml}>
                Miller Loop 결과
              </text>
              {[
          ...
          {step === 1 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.e1}>
                Easy Part 1: f^(p⁶-1)
              </text>
              {[
          ...
          {step === 2 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.e2}>
                Easy Part 2: f₁^(p²+1)
              </text>
              {[
                "f₂ = frobenius_sq(f₁) · f₁",
          ...
          {step === 3 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.hard}>
                Hard Part: (p⁴-p²+1)/r
              </text>
              {[
