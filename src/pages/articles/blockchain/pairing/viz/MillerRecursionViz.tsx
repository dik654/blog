      ...
      {(step) => (
        ...
        >
          ...
          <motion.g animate={{ opacity: step >= 1 ? 1 : 0.12 }} transition={sp}>
            <text x={12} y={46} fontSize={9} fill={DB} fontWeight={600}>
              Double
            </text>
            {BITS.map((_, i) => (
              <motion.rect
                ...
                rx={2}
                animate={{
                  fill: step === 1 ? `${DB}22` : `${DB}0c`,
                  stroke: DB,
                  strokeWidth: step === 1 ? 1.3 : 0.4,
                }}
          ...
          <motion.g animate={{ opacity: step >= 2 ? 1 : 0.12 }} transition={sp}>
            <text x={12} y={64} fontSize={9} fill={AD} fontWeight={600}>
              Add
            </text>
            {BITS.map((b, i) => {
              const x = 30 + i * 38;
