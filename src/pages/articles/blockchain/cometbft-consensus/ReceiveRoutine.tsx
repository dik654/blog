  ...
  return (
    <section id="receive-routine" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          Peer reactor, 내부 block executor, timeout ticker가 동시에 consensus state를 수정하면 vote 중복·step 역행·lock
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          크기·message type·peer quota 같은 싼 검사는 queue 앞에서 resource abuse를 줄일 수 있고, signature·validator
          membership·H/R/S·BlockID validation은 state snapshot과 함께 수행해야 합니다. 과거 round vote는 이미 알고 있는
          evidence를 보충할 수 있지만 현재 step을 되돌리면 안 되고, 미래 message는 무제한 보관하지 않고 bounded catch-up
          정책을 거쳐야 합니다.
        </p>
        <h3>관측에는 queue time과 transition receipt가 둘 다 필요합니다</h3>
        <p>
          Trace에는 receive time·peer·message coordinates·validation result·queue wait·state-before/state-after·emitted vote와
          WAL position을 연결합니다. 그래야 “vote를 받았다”와 “현재 round의 VoteSet에 반영됐다”를 구분하고, restart 뒤
