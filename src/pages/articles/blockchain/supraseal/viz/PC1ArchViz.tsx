...
const STEPS = [
  {
    label: "PC1 소프트웨어 구조",
    body: "SPDK + NVMe 기반 파이프라인으로 PC1을 고속 처리합니다.",
  },
  {
    label: "NVMe + SPDK",
    body: "SPDK로 커널 우회 직접 NVMe 제어. 12개 드라이브 스트라이핑으로 IOPS 확보.",
  },
  {
    label: "SHA-256 해싱",
    body: "멀티버퍼 SHA Extensions로 코어당 4섹터를 동시 해싱합니다.",
  },
  {
    label: "결과 저장",
    body: "해시된 노드를 NVMe에 쓰고 다음 레이어의 부모로 사용합니다.",
  },
];
