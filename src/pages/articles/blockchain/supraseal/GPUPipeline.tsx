  ...
  return (
    <section id="gpu-pipeline" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          C2는 <strong>Groth16 zkSNARK 증명</strong>을 생성하는 단계입니다.
          <br />
          GPU에서 MSM(Multi-Scalar Multiplication)과 NTT(Number Theoretic
          Transform)를 병렬 처리하여 증명 생성 시간을 대폭 단축합니다.
        </p>
        <CodePanel
          title="C2 GPU 가속"
          code={GPU_CODE}
        ...
        <p>
          ...
          참조 플랫폼에서 Huge Pages, F2FS, NUMA 인식, 디스크 분리 전략 등
          시스템 레벨 최적화를 적용합니다.
        </p>
        <CodePanel
          title="참조 플랫폼 & 시스템"
