  ...
  return (
    <section id="pc1-pc2" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          PC1은 Stacked DRG 그래프 생성으로, 11 레이어 x 2^30 노드의 SHA-256
          해싱이 필요합니다.
          <br />
        ...
        <p>
          PC2는 그래프 컬럼의 Poseidon 해시(Tree C)와 복제본의 머클 트리(Tree
          R)를 생성합니다.
          <br />
          CUDA를 활용한 <strong>대규모 병렬 처리</strong>와 64개 스트림으로 GPU
          활용률을 극대화합니다.
        </p>
        <CodePanel
          title="PC2 GPU 가속"
