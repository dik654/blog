  ...
  return (
    <section id="memory-model" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <CitationBlock
          source="NVIDIA CUDA Programming Guide — Memory Hierarchy"
          citeKey={3}
          type="paper"
          href="https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#memory-hierarchy"
        >
          <p className="italic">
          ...
          <p className="mt-2 text-xs">
            CUDA 메모리 계층은 레지스터(per-thread) → 공유 메모리(per-block) →
            L1/L2 캐시 → 전역 메모리(global) 순으로 구성됩니다.
          </p>
        </CitationBlock>
        <CodePanel
          title="GPU 메모리 계층 & 블록체인 최적화"
          code={memoryHierarchyCode}
