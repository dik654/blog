  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          CUDA(Compute Unified Device Architecture)는 NVIDIA GPU에서 범용 병렬
          연산을 실행하기 위한 플랫폼입니다.
          <br />
          블록체인에서 GPU 가속이 필수적인 영역이 있습니다.
          <br />
          <strong>마이닝(PoW)</strong>, <strong>ZK 증명 생성</strong>,{" "}
          <strong>서명 검증</strong>, <strong>Filecoin Sealing(봉인)</strong>{" "}
          등입니다.
        </p>
        ...
        >
          <p className="italic">
            "A kernel is executed in parallel by an array of threads. All
        ...
        <CitationBlock
          source="CUDA Kernel Launch Syntax"
          citeKey={2}
          type="code"
        >
          <pre className="text-xs overflow-x-auto">
            <code>{`// 커널 호출: <<<gridDim, blockDim>>> 으로 병렬 실행 단위 지정
