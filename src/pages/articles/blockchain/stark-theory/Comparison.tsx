  ...
  return (
    <section id="comparison" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          SNARK = 작은 proof + 타원곡선 의존. STARK = 큰 proof + 양자 내성 +
          투명 셋업.
        </p>
      </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-xs">
                <tr className="border-b border-border/30">
                  ...
                  <td className="p-2">
                    Groth16 ~200 B / PLONK ~500 B / Halo2 ~1 KB
                  </td>
                ...
                <tr>
                  ...
                  <td className="p-2">
                    Required (Groth16: per-circuit / PLONK: universal)
                  </td>
        ...
        <div className="not-prose rounded-lg border border-border/60 p-4 mb-4">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            <div className="rounded border bg-card p-3 border-sky-500/30">
              <p className="font-semibold text-sky-300 text-xs mb-2">
                SNARK 선호
              </p>
            ...
            <div className="rounded border bg-card p-3 border-emerald-500/30">
              <p className="font-semibold text-emerald-300 text-xs mb-2">
                STARK 선호
              </p>
              <div className="text-xs text-muted-foreground space-y-1">
            ...
            <div className="rounded border bg-card p-3 border-purple-500/30">
              <p className="font-semibold text-purple-300 text-xs mb-2">
                Hybrid
              </p>
              <div className="text-xs text-muted-foreground space-y-1">
        ...
        <div className="not-prose rounded-lg border border-border/60 p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="rounded border bg-card p-3">
              <p className="font-semibold text-xs text-sky-300 mb-2">
                SNARK 기반
              </p>
            ...
            <div className="rounded border bg-card p-3">
              <p className="font-semibold text-xs text-emerald-300 mb-2">
                STARK 기반
              </p>
              <div className="grid grid-cols-2 gap-1 text-xs text-muted-foreground">
                <p>StarkNet (Cairo)</p>
