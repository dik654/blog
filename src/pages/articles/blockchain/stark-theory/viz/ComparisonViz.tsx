...
const STEPS = [
  {
    label: "SNARK vs STARK 비교",
    body: "proof 크기 vs 신뢰 가정 — 핵심 트레이드오프.",
  },
  {
    label: "셋업 방식",
    body: "SNARK은 trusted setup 필요. STARK은 공개 랜덤니스만 사용(투명).",
  },
  {
    label: "Proof 크기 & 검증",
    body: "SNARK은 O(1) 증명/검증. STARK은 로그 크기지만 해시만으로 검증.",
  },
  {
    label: "양자 내성",
    body: "SNARK은 타원곡선 기반(양자 취약). STARK은 해시 기반(양자 안전).",
  },
];
