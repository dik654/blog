...
const STEPS = [
  {
    label: "AIR 제약 구조",
    body: "레지스터 (a, b)의 전이 규칙과 경계 조건을 다항식으로 인코딩하여 실행 추적을 검증한다.",
  },
  {
    label: "경계 제약 (Boundary)",
    body: "특정 행의 레지스터 값을 고정. 경계점에서 다항식이 0이 되어야 제약 충족.",
  },
  {
    label: "전이 제약 (Transition)",
    body: "연속 두 행 간 관계를 강제. 모든 도메인 점에서 다항식이 0이어야 한다.",
  },
  {
    label: "몫 다항식 Q(x)",
    body: "모든 제약을 하나로 합산 후 vanishing polynomial로 나눠 저차성을 FRI로 검증.",
  },
];
        ...
        >
          {step === 0 && (
            ...
            >
              ...
              >
                <path
                  d="M 175 13 C 175 4, 200 4, 200 13"
                  fill="none"
                  stroke={C.tr}
                  strokeWidth={1}
                />
            ...
            >
              ...
              >
                ...
                <rect
                  ...
                  strokeWidth={0.4}
                />
                <text x={40} y={96} fontSize={8.5} fill={C.t}>
                  T₁(omega^0) = a(omega^1) - b(omega^0)
                </text>
                <text x={40} y={110} fontSize={8.5} fill={C.tr}>
                  = 1 - 1 = 0
                </text>
                <circle
                  cx={215}
                ...
                <rect
                  ...
                  strokeWidth={0.4}
                />
                <text x={260} y={96} fontSize={8.5} fill={C.t}>
                  T₂(omega^0) = b(omega^1) - a(omega^0) - b(omega^0)
                </text>
                <text x={260} y={110} fontSize={8.5} fill={C.tr}>
                  = 2 - 1 - 1 = 0
                </text>
                <circle
                  cx={455}
            ...
            >
              ...
              >
                <ActionBox
                  ...
                  w={200}
                  h={36}
                  label="C(x) = Sum alpha_i * constraint_i"
                  color={C.q}
                />
              </motion.g>
