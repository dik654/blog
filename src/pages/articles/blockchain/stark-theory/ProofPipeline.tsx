  ...
  return (
    <section id="proof-pipeline" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          Trace Commit &rarr; Constraint Composition &rarr; FRI &rarr; Query
          &rarr; Verify. 5단계 파이프라인.
        </p>
      </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="rounded border bg-card p-3">
              ...
              <div className="text-xs text-muted-foreground mt-1 space-y-1">
                <p>AIR 제약 다항식 생성</p>
                <p>
                  Verifier challenges <M>\alpha_i</M> (Fiat-Shamir)
                </p>
                <p>
                  Composition polynomial:{" "}
                  <M>C(x) = \sum_i \alpha_i \cdot C_i(x) / V(x)</M>
                </p>
            ...
            <div className="rounded border bg-card p-3">
              ...
              <div className="text-xs text-muted-foreground mt-1 space-y-1">
                <p>
                  Verifier가 random <M>z</M> 샘플링
                </p>
                <p>
                  Prover가 <M>z</M>에서의 trace 값 전송
                </p>
                <p>
                  DEEP composition poly로 결합 &rarr; 단일 low-degree test로
                  축소
                </p>
              </div>
            </div>
            <div className="rounded border bg-card p-3">
              ...
              <div className="text-xs text-muted-foreground mt-1 space-y-1">
                ...
                <p>
                  <M>\log(n)</M> 라운드의 commit/challenge
                </p>
          ...
          <div className="space-y-1 text-sm">
            {[
              ...
              <div key={i} className="flex gap-3 rounded border bg-card p-2">
                <span className="text-xs font-bold text-emerald-400/60 w-4 shrink-0">
                  {i + 1}
                </span>
        ...
        <div className="not-prose rounded-lg border border-border/60 p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="rounded border bg-card p-3">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <p>
                  <M>10^6</M> step trace &rarr; Proof ~80 KB
                </p>
