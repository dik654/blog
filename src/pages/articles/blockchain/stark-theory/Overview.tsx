  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          Scalable Transparent ARgument of Knowledge &mdash; 해시 함수만으로
          동작, trusted setup 불필요.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border border-border/60 p-4 mb-4">
          <p className="font-semibold text-sm text-blue-400 mb-3">
            zkSTARK 4가지 속성 (Ben-Sasson et al. 2018)
          </p>
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="rounded border bg-card p-3">
              <p className="font-semibold text-sky-300">S &mdash; Scalable</p>
              <p className="text-xs text-muted-foreground mt-1">
                Prover <M>O(n \log^2 n)</M>, Verifier <M>O(\log^2 n)</M> &mdash;
                대규모 computation 가능
              </p>
            </div>
            <div className="rounded border bg-card p-3">
            ...
            <div className="rounded border bg-card p-3">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Witness extraction 가능 &mdash; prover가 실제로 답을 알고 있음을
                보장
              </p>
            </div>
          </div>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-xs">
                <tr className="border-b border-border/30">
                  ...
                  <td className="p-2">200&ndash;500 B</td>
                  <td className="p-2">50&ndash;200 KB</td>
                </tr>
                <tr className="border-b border-border/30">
                  <td className="p-2">Verify time</td>
                  <td className="p-2">~ms</td>
                  <td className="p-2">~10&ndash;100 ms</td>
                </tr>
                <tr className="border-b border-border/30">
                  <td className="p-2">Prove time</td>
                  <td className="p-2">
                    <M>O(n \log n)</M>
                  </td>
                  <td className="p-2">
                ...
                <tr className="border-b border-border/30">
                  ...
                  <td className="p-2">Trusted</td>
                  <td className="p-2">Transparent</td>
                </tr>
                <tr className="border-b border-border/30">
                  <td className="p-2">Crypto</td>
                  <td className="p-2">Pairing / ECC</td>
                  <td className="p-2">Hash only</td>
                </tr>
                <tr>
                  <td className="p-2">Post-quantum</td>
                  <td className="p-2">No</td>
                  <td className="p-2 text-emerald-400 font-semibold">Yes</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              <div key={num} className="flex gap-3 rounded border bg-card p-3">
                <span className="text-lg font-bold text-sky-400/60 w-6 shrink-0">
                  {num}
                </span>
                <div>
