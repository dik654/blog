  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={36} y={226} fontSize={10} fill="var(--muted-foreground)">
          delta[USDC] ={" "}
        </text>
        <text x={148} y={226} fontSize={11} fontWeight={700} fill="#ef4444">
          -1000 (settle 필요)
        </text>
        <text x={36} y={240} fontSize={10} fill="var(--muted-foreground)">
          delta[ETH] ={" "}
        </text>
        <text x={148} y={240} fontSize={11} fontWeight={700} fill="#10b981">
          +0.33 (take 가능)
        </text>
        ...
        <rect
          ...
          strokeWidth={1}
        />
        <text x={36} y={278} fontSize={11} fontWeight={700} fill="#f59e0b">
          nonZeroDeltaCount:
        </text>
