    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          unlock() 패턴 — Atomic Operation 진입점
        </text>
        ...
        {[
          ...
          <g key={i}>
            <rect
              ...
              height={40}
              rx={4}
              fill={i === 3 ? "#6b7280" : "#3b82f6"}
              fillOpacity={0.1}
              stroke={i === 3 ? "#6b7280" : "#3b82f6"}
              strokeWidth={0.6}
            />
            <text
              x={op.x + 45}
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          각 op은 currencyDelta[token] 업데이트만
        </text>
        <text
          x={260}
          y={216}
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          원자적: 모든 delta를 0으로 만들지 못하면 전체 revert
        </text>
      </svg>
    </div>
  );
