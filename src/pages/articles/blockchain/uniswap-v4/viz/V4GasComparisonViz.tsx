    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <rect
          ...
          fillOpacity={0.4}
        />
        <text x={50} y={52} fontSize={10} fontWeight={600} fill="#ef4444">
          V3
        </text>
        <rect
          x={90}
          ...
          fillOpacity={0.4}
        />
        <text x={110} y={52} fontSize={10} fontWeight={600} fill="#10b981">
          V4
        </text>
        ...
        >
          Singleton(배포 제거) · Flash Accounting(transfer 제거) · ERC-6909(NFT
          제거) · Transient Storage
        </text>
      </svg>
    </div>
  );
