  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      <div className="mb-4 flex items-center gap-3">
        <label className="text-xs font-semibold text-muted-foreground min-w-[80px]">
          홉 개수
        </label>
        <input
          type="range"
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          다중 홉 가스 비교 — 홉 개수에 따른 차이
        </text>

        {/* V3 */}
        <text x={60} y={72} fontSize={12} fontWeight={700} fill="#ef4444">
          V3
        </text>
        <rect
          x={110}
          y={58}
          width={Math.min(360, (v3Gas / 700) * 360)}
          height={28}
          rx={4}
          fill="#ef4444"
          fillOpacity={0.35}
        ...
        />
        <text
          x={120 + Math.min(360, (v3Gas / 700) * 360)}
          y={76}
          fontSize={12}
          fontWeight={700}
          fill="#ef4444"
        ...
        {/* V4 */}
        <text x={60} y={118} fontSize={12} fontWeight={700} fill="#10b981">
          V4
        </text>
        <rect
          x={110}
          y={104}
          width={Math.min(360, (v4Gas / 700) * 360)}
          height={28}
          rx={4}
          fill="#10b981"
          fillOpacity={0.35}
        ...
        />
        <text
          x={120 + Math.min(360, (v4Gas / 700) * 360)}
          y={122}
          fontSize={12}
          fontWeight={700}
          fill="#10b981"
        ...
        <text x={36} y={200} fontSize={10} fill="var(--muted-foreground)">
          transfer:{" "}
        </text>
        <text
          x={242}
        ...
        <text x={36} y={218} fontSize={10} fill="var(--muted-foreground)">
          매 홉마다
        </text>
        <text
          x={242}
        ...
        <text x={281} y={200} fontSize={10} fill="var(--muted-foreground)">
          TSTORE:{" "}
        </text>
        <text
          x={487}
        ...
        <text x={281} y={218} fontSize={10} fill="var(--muted-foreground)">
          transfer:{" "}
        </text>
        <text
          x={487}
