    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          Comet USDC Market — 구조 (1 Base + N Collateral)
        </text>
        ...
        <text x={32} y={164} fontSize={10} fill="var(--muted-foreground)">
          • 예치 → 이자 수령
        </text>
        <text x={32} y={180} fontSize={10} fill="var(--muted-foreground)">
          • 차입 → 이자 지불
        </text>
        <text x={32} y={196} fontSize={10} fill="var(--muted-foreground)">
          • 이자율: utilization 기반
        </text>
        ...
        <text x={272} y={164} fontSize={10} fill="var(--muted-foreground)">
          • 담보 전용 (이자 없음)
        </text>
        <text x={272} y={180} fontSize={10} fill="var(--muted-foreground)">
          • 차입 불가
        </text>
        <text x={272} y={196} fontSize={10} fill="var(--muted-foreground)">
          • 각자 supply cap 설정
        </text>
        ...
        {collaterals.map((c, i) => {
          ...
          return (
            <g key={i}>
              ...
              >
                borrow LTV:{" "}
                <tspan fontWeight={700} fill="var(--foreground)">
                  {c.ltv}%
                </tspan>
              </text>
              <text
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          여러 Market 동시 존재: Comet USDC / Comet ETH / Comet USDbC (Base) —
          각 독립
        </text>
      </svg>
    </div>
