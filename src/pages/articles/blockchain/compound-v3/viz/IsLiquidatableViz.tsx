...
export default function IsLiquidatableViz() {
  ...
  const borrowFactors = { WETH: 0.83, WBTC: 0.7 };
  const liquidateFactors = { WETH: 0.9, WBTC: 0.77 };
  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      <div className="mb-2 flex items-center gap-3">
        <label className="text-xs font-semibold text-muted-foreground min-w-[70px]">
          WETH
        </label>
        <input
          type="range"
          ...
          step={0.1}
          value={wethBalance}
          onChange={(e) => setWethBalance(+e.target.value)}
      ...
      <div className="mb-2 flex items-center gap-3">
        ...
        <input
          ...
          step={0.01}
          value={wbtcBalance}
          onChange={(e) => setWbtcBalance(+e.target.value)}
      ...
      >
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={140} fontSize={11} fontWeight={700} fill="#3b82f6">
          WETH
        </text>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={192} fontSize={11} fontWeight={700} fill="#f59e0b">
          WBTC
        </text>
        ...
        <rect
          ...
          fillOpacity={0.12}
          stroke={isLiquidatable ? "#ef4444" : "#10b981"}
          strokeWidth={1.2}
        />
        <text
          x={422}
        ...
        <rect
          ...
          stroke={isLiquidatable ? "#ef4444" : "#10b981"}
          strokeWidth={0.8}
          strokeDasharray={isLiquidatable ? "3 2" : undefined}
        />
        <text
          x={260}
          y={366}
