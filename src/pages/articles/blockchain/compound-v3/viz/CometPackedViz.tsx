    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          UserBasic — Packed Storage (1 slot = 32 bytes)
        </text>
        ...
        {/* 눈금 */}
        <text x={startX} y={45} fontSize={7} fill="var(--muted-foreground)">
          0
        </text>
        <text
          x={startX + barWidth}
