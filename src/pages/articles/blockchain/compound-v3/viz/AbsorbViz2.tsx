  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={62} y={68} fontSize={12} fontWeight={700} fill="#ef4444">
          User HF ＜ 1 감지
        </text>
        ...
        <text x={62} y={128} fontSize={12} fontWeight={700} fill="#f59e0b">
          absorb(account) 호출
        </text>
        ...
        <text x={62} y={188} fontSize={12} fontWeight={700} fill="#8b5cf6">
          프로토콜 잔고로 이동
        </text>
        ...
        <text x={62} y={248} fontSize={12} fontWeight={700} fill="#10b981">
          buyCollateral() — 2차 시장 판매
        </text>
