    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          buyCollateral() — Storefront 할인 판매
        </text>
        ...
        <text
          ...
          fill="var(--foreground)"
        >
          차익거래 시나리오 — ${baseAmount.toLocaleString()} USDC 투입
        </text>
        ...
        {[
          {
            x: 20,
            label: `${baseAmount.toLocaleString()} USDC`,
            sub: "Protocol 입금",
            color: "#3b82f6",
          },
          {
            x: 180,
            label: `${ethReceived.toFixed(3)} WETH`,
            sub: "할인가 수령",
            color: "#10b981",
          },
          {
            x: 340,
            label: `$${Math.round(marketValue).toLocaleString()}`,
            sub: "시장 가치",
            color: "#f59e0b",
          },
        ].map((s, i) => (
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          시장 가치 − USDC 비용 = {((profit / baseAmount) * 100).toFixed(2)}%
          수익
        </text>
      </svg>
    </div>
