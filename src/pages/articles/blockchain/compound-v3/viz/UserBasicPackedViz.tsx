    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          UserBasic — 32 byte packed storage (1 SLOAD)
        </text>
        ...
        <g transform="translate(30, 62)">
          ...
          {[0, 8, 16, 24, 32].map((b) => (
            <g key={b}>
              <line
                x1={(b / totalBytes) * totalWidth}
                y1={64}
                x2={(b / totalBytes) * totalWidth}
                y2={68}
                stroke="var(--foreground)"
                strokeWidth={0.5}
              />
              <text
                x={(b / totalBytes) * totalWidth}
                y={80}
                textAnchor="middle"
                fontSize={9}
                fill="var(--muted-foreground)"
