    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          accrueInternal() — Lazy Index Update
        </text>
        ...
        <g transform="translate(30, 102)">
          ...
          <text x={12} y={4} fontSize={10} fontWeight={600} fill="#10b981">
            interaction (index 갱신)
          </text>
          <circle cx={180} cy={0} r={3} fill="#6b7280" />
          <text x={192} y={4} fontSize={10} fontWeight={600} fill="#6b7280">
            중간 블록 (skip)
          </text>
        </g>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={306} fontSize={11} fontWeight={700} fill="#10b981">
          이점:
        </text>
