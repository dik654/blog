...
export default function BorrowCapacityViz() {
  ...
  const borrowFactors = { WETH: 0.83, WBTC: 0.7, LINK: 0.67 };
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        {[
          {
            ...
            price: prices.WETH,
            value: wethValue,
            factor: borrowFactors.WETH,
            capacity: wethCapacity,
            color: "#3b82f6",
          },
          {
            y: 108,
            ...
            price: prices.WBTC,
            value: wbtcValue,
            factor: borrowFactors.WBTC,
            capacity: wbtcCapacity,
            color: "#f59e0b",
          },
          {
            y: 172,
        ...
        <line
          ...
          opacity={0.5}
        />
        <text x={36} y={284} fontSize={11} fontWeight={700} fill="#10b981">
          USDC 차입 한도:
        </text>
        <text
          x={486}
