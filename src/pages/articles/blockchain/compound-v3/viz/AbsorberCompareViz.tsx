    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <rect
          ...
          strokeWidth={0.8}
        />
        <text x={42} y={212} fontSize={10} fontWeight={700} fill="#ef4444">
          실행 흐름
        </text>
        ...
        <rect
          ...
          strokeWidth={0.8}
        />
        <text x={287} y={212} fontSize={10} fontWeight={700} fill="#10b981">
          실행 흐름
        </text>
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          동일 문제 다른 접근 — Aave: 단일 청산자 · V3: 청산+판매 분리
        </text>
      </svg>
    </div>
  );
