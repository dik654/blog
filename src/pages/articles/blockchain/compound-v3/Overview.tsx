    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">
          Compound V3 (Comet)의 철학 전환
        </h3>
        <p>
          Compound V2: Aave와 유사한 <strong>다자산 차입 모델</strong>
          <br />
          Compound V3(Comet, 2022):{" "}
          <strong>"단일 base asset" 단순화 모델</strong>
          <br />
          목표: 복잡성 ↓, 안전성 ↑, 가스 ↓
        </p>
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-5 my-4">
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="min-w-full text-sm border border-border">
              ...
              <tbody>
                <tr>
                  <td className="border border-border px-3 py-1">WETH</td>
                  <td className="border border-border px-3 py-1">83%</td>
                  <td className="border border-border px-3 py-1">90%</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-1">WBTC</td>
                  <td className="border border-border px-3 py-1">70%</td>
                  <td className="border border-border px-3 py-1">77%</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-1">LINK</td>
                  <td className="border border-border px-3 py-1">67%</td>
                  <td className="border border-border px-3 py-1">73%</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-1">UNI</td>
                  <td className="border border-border px-3 py-1">64%</td>
                  <td className="border border-border px-3 py-1">71%</td>
                </tr>
                <tr>
                  <td className="border border-border px-3 py-1">COMP</td>
                  <td className="border border-border px-3 py-1">60%</td>
                  <td className="border border-border px-3 py-1">67%</td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="mt-3 text-sm text-muted-foreground">
            여러 market 동시 존재:{" "}
            <code className="text-xs">Comet USDC (Ethereum)</code>,{" "}
            <code className="text-xs">Comet ETH (Ethereum)</code>,{" "}
            <code className="text-xs">Comet USDbC (Base)</code>
          </div>
        </div>
        <p>
          <strong>Market마다 별도 Comet</strong>: USDC market, ETH market 등
          <br />
          각 market은 독립 운영 — risk isolation
          <br />
          담보 자산은 이자 없음 — "순수 담보"
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 list-disc list-inside">
              <li>
                <code className="text-xs">cUSDC</code> 1000 (예치)
              </li>
              <li>
                <code className="text-xs">cETH</code> 2 (예치)
              </li>
              <li>
                부채: <code className="text-xs">DAI</code> 500 +{" "}
                <code className="text-xs">USDT</code> 300
              </li>
            </ul>
            <div className="mt-2 text-sm text-muted-foreground">
              담보: cUSDC + cETH / 부채: DAI + USDT
              <br />
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <ul className="text-sm space-y-1 list-disc list-inside">
              <li>
                <code className="text-xs">USDC</code> supplied: 1000 (이자 발생)
              </li>
              <li>
                <code className="text-xs">WETH</code> deposited: 2 (담보, 이자
                없음)
              </li>
              <li>USDC borrowed: 300</li>
            </ul>
            <div className="mt-2 text-sm text-muted-foreground">
              담보: WETH / 부채: USDC only
              <br />
              단순 HF 계산
            </div>
          </div>
        ...
        <p>
          <strong>V3의 단순함</strong>: 사용자가 base asset 동시 예치·차입 안 함
          <br />
          예치자: base만 공급 → 이자 받음
          <br />
          차입자: collateral 예치 + base 차입
          <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm font-mono">
              <span>supply cUSDC</span>
              <span>~150K</span>
              <span>borrow DAI</span>
              <span>~250K</span>
              <span>liquidate</span>
              <span>~300K</span>
              <span>repay</span>
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-5 my-4">
          <p className="font-semibold text-sm mb-3">
            Collateral Supply Cap (프로토콜 위험 제한)
          </p>
          ...
          <p className="text-sm text-muted-foreground mb-3">
            Base asset (USDC)에는 cap 없음 — 무제한 예치 가능. Borrowing은
            utilization에 따라 제한.
          </p>
          <ol className="text-sm space-y-1 list-decimal list-inside">
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: Compound V3의 "극도의 단순화"
          </p>
          <p>
            Aave V3는 <strong>기능 확장</strong> (E-Mode, Isolation, Portal 등)
            <br />
          ...
          <p className="mt-2">
            ...
            - Aave: 기능 풍부, 고급 사용자
            <br />
            - Compound V3: 안정적이고 예측 가능, 기관 투자자
            <br />
            - Morpho: Aave 위에 P2P 레이어 추가
            <br />- Spark: MakerDAO 기반 fork
          </p>
          <p className="mt-2">
