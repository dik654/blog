    ...
    <section id="checkpoint" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          n=100, 초당 1000 TX → 분당 18M 메시지 (각 TX 당 O(n²)).
          <br />
        ...
        <div className="not-prose space-y-3 mb-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg border p-4">
              ...
              <p className="text-sm">
                sequence number <code>n</code>이 K의 배수 (K=100 or 128) → K번째
                request execute 후 생성
              </p>
              <p className="text-xs font-mono mt-2">
                ⟨CHECKPOINT, <code>n</code>, <code>d</code>, <code>i</code>⟩
                <sub>σi</sub>
              </p>
              <ul className="text-sm space-y-0.5 mt-1 list-disc list-inside">
                <li>
                  <code>n</code>: checkpoint sequence
                </li>
                <li>
                  <code>d</code>: state digest (up to n)
                </li>
              </ul>
            </div>
            <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-4">
              ...
              <p className="text-sm">
                <code>2f+1</code> CHECKPOINT for same <code>(n, d)</code> 수집 =
                "stable checkpoint proof"
              </p>
              <ol className="text-sm space-y-0.5 mt-2 list-decimal list-inside">
                <li>
                  sequence ≤ <code>n</code> log entries 삭제
                </li>
                <li>이전 view prepared 정보 삭제</li>
                <li>
                  low watermark <code>h := n</code>
                </li>
                <li>
                  high watermark <code>H := h + L</code> (L=128)
                </li>
              </ol>
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-lg border p-4">
              <p className="font-semibold text-sm mb-2">
                Watermark 범위 (<code>h &lt; n ≤ H</code>)
              </p>
              <ul className="text-sm space-y-0.5 list-disc list-inside">
                <li>
                  <code>h</code>: 이미 stable, <code>H = h + L</code>: 최대값
                </li>
        ...
        <p className="leading-7">
          ...
          매 K=100 request마다 생성, 2f+1 동의로 stable.
          <br />
        ...
        <div className="not-prose space-y-3 mb-4">
          <div className="rounded-lg border p-4">
            ...
            <ol className="text-sm space-y-2 list-decimal list-inside">
              <li>
                <strong>Slow replica 감지</strong> — PRE-PREPARE의{" "}
                <code>n &gt; H</code> 또는 stable checkpoint notification
              </li>
              <li>
                <strong>FETCH 요청</strong> — ⟨FETCH, <code>h'</code>,{" "}
                <code>h</code>, <code>d_h</code>⟩<sub>σi</sub> (<code>h'</code>:
                현재 watermark, <code>h</code>: 원하는 checkpoint)
              </li>
              <li>
                <strong>다른 replica 응답</strong> — state 전송, Merkle tree로
                부분 검증 가능
              </li>
              <li>
                <strong>State 적용</strong> — 2f+1 CHECKPOINT proof 검증, log
                비우기, <code>h := 새 checkpoint</code>
              </li>
              <li>
                <strong>따라잡기</strong> — PRE-PREPARE, PREPARE, COMMIT
                재수신하여 현재 sequence까지 catchup
              </li>
            </ol>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
        ...
        <p className="leading-7">
          ...
          watermark 벗어난 replica는 checkpoint state 받아 catchup.
          <br />
        ...
        <div className="not-prose space-y-3 mb-4">
                ...
                <table className="text-sm w-full">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-0.5 pr-2">n</th>
                      <th className="text-left py-0.5">메시지 수</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="py-0.5 pr-2">4</td>
                      <td className="py-0.5">36</td>
                    </tr>
                    <tr>
                      <td className="py-0.5 pr-2">10</td>
                      <td className="py-0.5">360</td>
                    </tr>
                    <tr>
                      <td className="py-0.5 pr-2">50</td>
                      <td className="py-0.5">9,800</td>
                    </tr>
                    <tr>
                      <td className="py-0.5 pr-2">100</td>
                      <td className="py-0.5">39,600</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="rounded-lg border p-4">
              ...
              <table className="text-sm w-full">
                ...
                <tbody>
                  <tr className="border-b border-dashed">
                    <td className="py-1 pr-3">Zyzzyva</td>
                    <td className="py-1 pr-3">2007</td>
                    <td className="py-1">
                      Speculative execution, 정상 case 1 round-trip
                    </td>
                  </tr>
                  <tr className="border-b border-dashed">
                    <td className="py-1 pr-3">Tendermint</td>
                    <td className="py-1 pr-3">2014</td>
                    <td className="py-1">
                      Blockchain 맞춤, continuous consensus, 2/3+ weight
                    </td>
                  </tr>
                  <tr className="border-b border-dashed">
                    <td className="py-1 pr-3">HotStuff</td>
                    <td className="py-1 pr-3">2018</td>
                    <td className="py-1">
                      O(n) 통신, chained voting, threshold signature
                    </td>
                  </tr>
                  <tr className="border-b border-dashed">
                    <td className="py-1 pr-3">Jolteon</td>
                    <td className="py-1 pr-3">2021</td>
                    <td className="py-1">
                      HotStuff + 2-chain commit, async fallback (Aptos)
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1 pr-3">Mysticeti</td>
                    <td className="py-1 pr-3">2024</td>
                    <td className="py-1">
                      DAG-based, uncertified blocks, 390ms latency
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              PBFT는 concepts의 보고 — 후속 프로토콜은 모두 PBFT를 개선한 것
            </p>
          </div>
        </div>
        <p className="leading-7">
          PBFT 한계:{" "}
          <strong>O(n²) normal, O(n³) view change, static membership</strong>.
          <br />
          HotStuff가 O(n) + threshold signature로 해결.
          <br />
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              Prepare + Commit 모두 All-to-All 통신.
              <br />
        ...
        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 PBFT의 유산</strong> — 3-phase pattern.
          <br />
          Pre-prepare(propose) → Prepare(vote) → Commit(finalize).
          <br />
          Tendermint의 Proposal → Prevote → Precommit도 동일 패턴.
          <br />
