...
const STEPS = [
  {
    label: "외부 라운드 (전반 4회): 전체 S-box",
    body: "상태 16개 원소 모두에 x^7 적용 후 MDS 행렬 곱셈. 확산 극대화.",
  },
  {
    label: "내부 라운드 (13회): 부분 S-box",
    body: "첫 원소만 x^7, 나머지는 identity. 대각+랭크1 희소 행렬. 연산 절약.",
  },
  {
    label: "외부 라운드 (후반 4회): 전체 S-box",
    body: "다시 전체 S-box 적용. 최종 확산으로 암호학적 안전성 확보.",
  },
  {
    label: "DuplexChallenger: 스펀지로 Fiat-Shamir",
    body: "observe() → rate XOR + 퍼뮤테이션, sample() → rate에서 추출. 증명 파이프라인 전체 사용.",
  },
];
