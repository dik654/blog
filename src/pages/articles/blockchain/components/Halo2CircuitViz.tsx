...
const STEPS = [
  {
    label: "Advice 열: 증명자의 비밀 증인 값",
    body: "증명 생성 시에만 채워지는 비밀 데이터. 검증자에게 노출되지 않습니다.",
  },
  {
    label: "Fixed/Instance/Selector 열",
    body: "Fixed=셋업 고정 상수, Instance=공개 입력, Selector=게이트 on/off 제어.",
  },
  {
    label: "Expression<F>: 제약 표현식 트리",
    body: "Constant, Selector, Advice/Fixed Query, Sum, Product, Negated, Scaled로 제약 조합.",
  },
  {
    label: "전체 구조: 열 + 표현식 + 게이트",
    body: "열에 값을 배치하고, Expression으로 게이트를 정의하며, Selector로 활성화합니다.",
  },
];
