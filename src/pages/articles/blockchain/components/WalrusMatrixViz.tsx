...
const STEPS = [
  {
    label: "원본 데이터: k1×k2 심볼 행렬",
    body: `블롭을 ${K1}×${K2} 행렬로 배치합니다. 파란색이 원본 데이터 영역입니다.`,
  },
  {
    label: "행 방향 RS 인코딩 → Secondary 슬라이버",
    body: "각 행에 Reed-Solomon 확장. 초록색이 행 복구 심볼(Secondary)입니다.",
  },
  {
    label: "열 방향 RS 인코딩 → Primary 슬라이버",
    body: "각 열에 Reed-Solomon 확장. 주황색이 열 복구 심볼(Primary)입니다.",
  },
  {
    label: "노드 i에 Primary[i] + Secondary[n-1-i] 배포",
    body: "각 노드가 하나의 열(Primary)과 하나의 행(Secondary)을 보유합니다.",
  },
];
