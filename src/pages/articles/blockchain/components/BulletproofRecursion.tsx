...
const rounds: Round[] = [
  { n: 8, L: "L₀", R: "R₀", desc: "a = [a₀…a₃] ‖ [a₄…a₇], 도전값 u₀ 샘플링" },
  {
    ...
    L: "L₁",
    R: "R₁",
    desc: "a' = a_lo + u₀·a_hi, b' = b_lo + u₀⁻¹·b_hi",
  },
  { n: 2, L: "L₂", R: "R₂", desc: "u₁으로 절반 더 감소" },
  {
    ...
    L: "(a,b)",
    R: "",
    desc: "최종 스칼라 쌍 (a,b) 전송 — O(log n) 증명 완료",
  },
];
  ...
  return (
    <div className="rounded-xl border p-5 space-y-4 not-prose">
      <p className="text-sm font-medium">
        Inner Product Proof — O(log n) 재귀 절반 감소
      </p>
      ...
      <div className="overflow-x-auto">
        ...
        <div className="flex gap-1 mt-1 text-[10px] text-foreground/60">
          <span style={{ flex: rounds[step].n / 2 }} className="text-center">
            a_lo
          </span>
          <span style={{ flex: rounds[step].n / 2 }} className="text-center">
            a_hi
          ...
          {rounds[step].n < rounds[0].n && (
            <span
              style={{ flex: rounds[0].n - rounds[step].n }}
        ...
        >
          ...
          {step < rounds.length - 1 && (
            <div className="font-mono bg-background rounded p-2 mt-1">
              {rounds[step].L} = &lt;a_lo, G_hi&gt; + &lt;b_hi, H_lo&gt; +
              &lt;a_lo, b_hi&gt;·Q
              <br />
              {rounds[step].R} = &lt;a_hi, G_lo&gt; + &lt;b_lo, H_hi&gt; +
              &lt;a_hi, b_lo&gt;·Q
              <br />u{step} = transcript.challenge() ← Fiat-Shamir
            </div>
          )}
          {step === rounds.length - 1 && (
            <div className="font-mono bg-background rounded p-2 mt-1">
