...
const STEPS = [
  {
    label: "6개 서브회로: EVM, Bytecode, Keccak, MPT, Copy, Sig",
    body: "각 서브회로가 EVM 실행의 서로 다른 측면을 검증합니다.",
  },
  {
    label: "공유 룩업 테이블로 일관성 연결",
    body: "RwTable, BytecodeTable, TxTable, KeccakTable 등이 서브회로 간 데이터 정합성을 보장합니다.",
  },
  {
    label: "EVM Circuit: ~150종 ExecutionGadget",
    body: "ADD, CALL, SLOAD, KECCAK 등 오퍼코드별 가젯. configure → assign 2단계.",
  },
  {
    label: "전체 연결: 서브회로 ↔ 테이블 참조",
    body: "모든 서브회로의 룩업이 공유 테이블을 통해 크로스 검증됩니다.",
  },
];
