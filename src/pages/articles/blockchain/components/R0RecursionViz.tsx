...
const STEPS = [
  {
    label: "SegmentReceipt: N개 병렬 STARK 생성",
    body: "각 RISC-V 세그먼트에서 Raw STARK 증명을 GPU로 병렬 생성합니다. 약 1MB × N개.",
  },
  {
    label: "재귀 압축 → SuccinctReceipt",
    body: "재귀 회로가 N개의 SegmentReceipt를 하나의 STARK로 압축. 약 200KB로 축소.",
  },
  {
    label: "Groth16 래핑 → 256 bytes",
    body: "STARK → Groth16 SNARK로 변환. 이더리움 온체인 검증 가능 (~250k gas).",
  },
];
