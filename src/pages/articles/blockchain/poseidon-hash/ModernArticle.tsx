...
export default function ModernPoseidonArticle() {
  return <article className="space-y-14">
    ...
    <section id="release" className="space-y-6">
      <header><p className="text-sm font-semibold text-primary">04 · Release gate</p><h2 className="mt-2 text-2xl font-bold">공식 vectors와 native/circuit parity가 먼저다</h2></header>
