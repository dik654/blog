export default function PoseidonRoundViz() {
  ...
  return <figure data-viz="poseidon-round" className="not-prose rounded-xl border border-border bg-card p-4 sm:p-6">
    <figcaption className="mb-5"><p className="text-xs font-semibold text-primary">ONE HADES ROUND</p><p className="mt-1 text-sm text-muted-foreground">표현 방식은 같은 flow이고, full/partial round는 S-box 적용 word 수만 다릅니다.</p></figcaption>
