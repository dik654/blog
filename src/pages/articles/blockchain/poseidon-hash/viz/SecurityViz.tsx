...
const STEPS = [
  {
    label: "보안 전략 개요",
    body: "Full round → 차분·통계 방어. Partial round → 대수·보간 방어.",
  },
  {
    label: "Poseidon S-box",
    body: "x→x⁵. 빠르고 제약 적음 (~250). ZK 생태계 표준.",
  },
  {
    label: "Rescue S-box",
    body: "x^α ↔ x^{1/α} 교대. 역방향 지수 커서 네이티브 느림. ~500 제약.",
  },
];
      ...
      >
        {[
          ...
          <g key={s.label}>
            ...
            <text x={s.x} y={y0 + 68} fontSize={9} fontWeight={600} fill={C2}>
              {s.val}
            </text>
          </g>
        ))}
      ...
      >
        {[
          ...
          <g key={s.label}>
            ...
            <text x={s.x} y={y0 + 114} fontSize={9} fontWeight={600} fill={C3}>
              {s.val}
            </text>
          </g>
        ))}
