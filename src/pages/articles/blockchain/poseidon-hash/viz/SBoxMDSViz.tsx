...
const STEPS = [
  {
    label: "S-box: x → x⁵ 변환",
    body: "S-box는 비선형 혼합(confusion)을 담당.\ngcd(5, p-1)=1이므로 전단사(bijection) — 모든 출력이 유일.",
  },
  {
    label: "S-box 연산 체인 (x=3 예시)",
    body: "x⁵를 직접 계산하지 않고 곱셈 3회로 분해.\nx → x² → x⁴ → x⁵. 곱셈 3회 = R1CS 3제약.",
  },
  {
    label: "MDS 행렬 곱: 확산",
    body: "모든 입력이 모든 출력에 영향.\nbranch number = T+1 = 4 → 최대 확산(diffusion) 보장.",
  },
];
