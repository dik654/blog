    ...
    annotations: [
      {
        lines: [11, 12],
        color: "sky",
        note: "VoteA, VoteB: 같은 H/R에서 서로 다른 블록에 투표",
      },
      {
        lines: [15, 17],
        color: "emerald",
        note: "ABCI 정보: TotalVotingPower, ValidatorPower, Timestamp",
      },
    ],
  },
  "evidence-verify": {
    ...
    annotations: [
      {
        lines: [38, 41],
        color: "sky",
        note: "Height, Round, Type이 동일한지 확인",
      },
      {
        lines: [43, 45],
        color: "emerald",
        note: "BlockID가 다르면 유효한 비잔틴 증거",
      },
    ],
  },
  "tx-hash": {
    ...
    annotations: [
      ...
      { lines: [15, 17], color: "emerald", note: "Tx.Hash() = SHA256 해시" },
      {
        lines: [24, 28],
        color: "amber",
        note: "Txs.Hash() = 각 TX 해시 → Merkle root",
      },
    ],
  },
};
