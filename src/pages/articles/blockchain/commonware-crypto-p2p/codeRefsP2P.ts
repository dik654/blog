    ...
    annotations: [
      {
        lines: [19, 24],
        color: "sky",
        note: "UnlimitedSender — 제한 없음 (내부 시스템 메시지)",
      },
      {
        lines: [27, 31],
        color: "emerald",
        note: "LimitedSender — check() → 레이트 리밋 적용",
      },
      {
        lines: [34, 45],
        color: "amber",
        note: "Sender — check → send 기본 구현. blanket impl",
      },
      {
        lines: [47, 47],
        color: "violet",
        note: "blanket impl — 모든 LimitedSender가 Sender",
      },
    ],
  },
  "p2p-blocker": {
    ...
    annotations: [
      {
        lines: [51, 54],
        color: "sky",
        note: "Blocker — block(peer) → 연결 종료 + 거부목록",
      },
      {
        lines: [57, 61],
        color: "emerald",
        note: "block! 매크로 — tracing::warn + block 원자적 실행",
      },
    ],
  },
  "p2p-recipients": {
    ...
    annotations: [
      {
        lines: [3, 4],
        color: "sky",
        note: "Message<P> — 발신자 공개키 + 페이로드 튜플",
      },
      {
        lines: [7, 7],
        color: "emerald",
        note: "Channel = u64 — 단일 TCP 위에 다중 프로토콜",
      },
      {
        lines: [10, 15],
        color: "amber",
        note: "Recipients — All/Some/One 세 가지 수신 범위",
      },
    ],
  },
  "handshake-exchange": {
    ...
    annotations: [
      {
        lines: [15, 17],
        color: "sky",
        note: "SecretKey — 임시 비밀키. 교환 후 소멸",
      },
      {
        lines: [20, 24],
        color: "emerald",
        note: "new() — CryptoRng에서 임시 비밀키 생성",
      },
      {
        lines: [33, 39],
        color: "amber",
        note: "exchange — DH 계산 + non-contributory 검사",
      },
    ],
  },
};
