    ...
    annotations: [
      {
        lines: [7, 8],
        color: "sky",
        note: "Secret<SigningKey> — zeroize 적용 메모리 보호",
      },
      {
        lines: [15, 19],
        color: "emerald",
        note: "sign — union_unique(ns, msg) 후 서명",
      },
      {
        lines: [22, 25],
        color: "amber",
        note: "public_key — expose로 VerificationKey 추출",
      },
    ],
  },
  "ed25519-verifier": {
    ...
    annotations: [
      {
        lines: [30, 32],
        color: "sky",
        note: "Ord + PartialOrd + Hash — 정렬/집합 연산 지원",
      },
      {
        lines: [35, 40],
        color: "emerald",
        note: "verify — union_unique 후 검증",
      },
    ],
  },
  "secp256r1-signer": {
    ...
    annotations: [
      {
        lines: [16, 22],
        color: "sky",
        note: "sha256 + sign_prehash — 프리해시 서명",
      },
      {
        lines: [23, 23],
        color: "emerald",
        note: "normalize_s — BIP 62 low-s 정규화 (malleability 방지)",
      },
    ],
  },
  "secp256r1-recover": {
    ...
    annotations: [
      {
        lines: [42, 44],
        color: "sky",
        note: "recover_signer — v 바이트로 공개키 복원",
      },
    ],
  },
};
