    ...
    annotations: [
      {
        lines: [8, 9],
        color: "sky",
        note: "Secret<[u8; 32]> + Private — zeroize로 메모리 보호",
      },
      {
        lines: [18, 20],
        color: "emerald",
        note: "MinPk — 공개키가 G1(작음), 서명이 G2(큼)",
      },
      {
        lines: [22, 24],
        color: "amber",
        note: "sign_message — hash-to-curve + 스칼라 곱셈",
      },
    ],
  },
  "bls-verifier": {
    ...
    annotations: [
      {
        lines: [32, 33],
        color: "sky",
        note: "48B 압축 G1 점 + blst G1 Affine",
      },
      {
        lines: [37, 41],
        color: "emerald",
        note: "verify_message — 페어링 검증 e(pk, H(m)) = e(G1, sig)",
      },
    ],
  },
  "dkg-dealer": {
    ...
    annotations: [
      {
        lines: [4, 8],
        color: "sky",
        note: "Info — 라운드 번호, 이전 출력, 딜러/플레이어 목록",
      },
      {
        lines: [14, 19],
        color: "emerald",
        note: "start() — 다항식 생성 → PubMsg + PrivMsg 쌍",
      },
      {
        lines: [22, 25],
        color: "amber",
        note: "finalize() — ACK 미수신 → share 공개 (reveal)",
      },
    ],
  },
  "dkg-player": {
    ...
    annotations: [
      {
        lines: [36, 39],
        color: "sky",
        note: "dealer_message — 다항식 커밋먼트 검증 → ACK",
      },
      {
        lines: [42, 46],
        color: "emerald",
        note: "finalize — share 합산 → (Share, Output)",
      },
      {
        lines: [50, 55],
        color: "amber",
        note: "Output — 그룹 공개 다항식 + 참여자 목록",
      },
    ],
  },
};
