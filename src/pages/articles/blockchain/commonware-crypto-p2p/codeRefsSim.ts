    ...
    annotations: [
      {
        lines: [4, 7],
        color: "sky",
        note: "Link — 지연/지터/성공률로 현실적 네트워크 모델링",
      },
      {
        lines: [10, 14],
        color: "emerald",
        note: "Config — max_size, disconnect_on_block 등 설정",
      },
    ],
  },
  "sim-deterministic": {
    ...
    annotations: [
      {
        lines: [20, 22],
        color: "sky",
        note: "deterministic::Runner — seed 기반 재현 가능 실행",
      },
      { lines: [25, 29], color: "emerald", note: "4가지 장애 시뮬레이션 유형" },
      {
        lines: [32, 37],
        color: "amber",
        note: "progressive filling — max-min 공정 대역폭 할당",
      },
    ],
  },
};
