    ...
    annotations: [
      {
        lines: [6, 7],
        color: "sky",
        note: "연관 타입 — 스킴별 Signature/PublicKey 바인딩",
      },
      {
        lines: [11, 14],
        color: "emerald",
        note: "sign() — union_unique(ns, msg)로 도메인 분리",
      },
      {
        lines: [16, 18],
        color: "amber",
        note: "from_seed — ChaCha20 PRNG. 테스트 전용",
      },
    ],
  },
  "verifier-trait": {
    ...
    annotations: [
      {
        lines: [24, 29],
        color: "sky",
        note: "Verifier — namespace 일치 필수로 서명 검증",
      },
      {
        lines: [32, 33],
        color: "emerald",
        note: "PublicKey — Ord + Array. BTreeSet/HashMap 키로 사용",
      },
      {
        lines: [36, 37],
        color: "amber",
        note: "Signature — FixedSize 직렬화. ReadExt + Encode",
      },
    ],
  },
  "batch-verifier": {
    ...
    annotations: [
      {
        lines: [48, 50],
        color: "sky",
        note: "add — 서명을 배치에 추가. namespace 포함",
      },
      {
        lines: [52, 53],
        color: "emerald",
        note: "verify(rng) — 랜덤 가중합으로 배치 위조 방지",
      },
    ],
  },
};
