  ...
  return (
    <g>
      <rect
        ...
        strokeWidth={0.5}
      />
      <text x={30} y={30} fontSize={10} fill="var(--muted-foreground)">
        selector: 0xa9059cbb
      </text>
      <motion.text
        x={30}
  ...
  return (
    <g>
      <motion.g initial={{ opacity: 0, y: 3 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <text x={25} y={44} fontSize={11} fontWeight={600} fill={C.state}>
          2000 → 1500 (-500)
        </text>
      </motion.g>
      <motion.g
      ...
      >
        <rect
          ...
          strokeWidth={0.7}
        />
        <text x={250} y={30} fontSize={10} fill="var(--muted-foreground)">
          balances[to]:
        </text>
        <text x={250} y={44} fontSize={11} fontWeight={600} fill={C.state}>
          300 → 800 (+500)
        </text>
      </motion.g>
      <text
