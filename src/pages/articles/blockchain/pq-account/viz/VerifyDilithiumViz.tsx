...
function Step0() {
  return (
    <g>
      ...
      <text x={68} y={30} fontSize={10} fill="var(--muted-foreground)">
        *
      </text>
      <DataBox x={78} y={15} w={50} h={22} label="z" color={C.restore} />
      <text x={136} y={30} fontSize={10} fill="var(--muted-foreground)">
        -
      </text>
      <DataBox x={145} y={15} w={50} h={22} label="c" color={C.check} />
      <text x={203} y={30} fontSize={10} fill="var(--muted-foreground)">
        *
      </text>
...
function Step2() {
  return (
    <g>
      ...
      <text x={105} y={34} fontSize={11} fill="var(--muted-foreground)">
        ||
      </text>
      ...
      >
        <text x={350} y={34} fontSize={12} fill="var(--muted-foreground)">
          ==
        </text>
