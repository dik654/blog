...
function Step2() {
  return (
    <g>
      ...
      <text x={25} y={45} fontSize={10} fill={C.challenge}>
        SHAKE-256
      </text>
      <motion.line
        x1={200}
...
function Step3() {
  return (
    <g>
      ...
      <text x={85} y={36} fontSize={11} fill="var(--muted-foreground)">
        +
      </text>
      <DataBox x={95} y={20} w={60} h={24} label="c" color={C.challenge} />
      <text x={165} y={36} fontSize={11} fill="var(--muted-foreground)">
        *
      </text>
  ...
  return (
    <g>
      <rect
        ...
        strokeWidth={0.5}
      />
      <text x={25} y={30} fontSize={10} fill="var(--muted-foreground)">
        ||z||inf =
      </text>
      <motion.text
        x={80}
      ...
      <text x={25} y={45} fontSize={10} fill="var(--muted-foreground)">
        gamma1 - beta = 130570
      </text>
      <motion.g
        initial={{ opacity: 0 }}
