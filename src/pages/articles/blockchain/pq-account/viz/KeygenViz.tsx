...
function Step1() {
  return (
    <g>
      ...
      >
        <text x={290} y={40} fontSize={10} fill="var(--muted-foreground)">
          SHAKE-128
        </text>
      </motion.g>
    </g>
...
function Step2() {
  ...
  return (
    <g>
      <text x={20} y={25} fontSize={10} fill="var(--muted-foreground)">
        SampleShort(eta=2):
      </text>
      {vals.map((v, i) => (
        <motion.g
      ...
      <motion.g
        ...
        transition={{ delay: 0.6 }}
      >
        <text x={290} y={35} fontSize={10} fill="var(--muted-foreground)">
          s1: 4 polys x 256 coeff
        </text>
        <text x={290} y={50} fontSize={10} fill="var(--muted-foreground)">
          s2: 4 polys x 256 coeff
        </text>
        <text x={290} y={65} fontSize={10} fill={C.secret}>
          비밀 정보 (짧은 벡터)
        </text>
      </motion.g>
    </g>
...
function Step3() {
  return (
    <g>
      ...
      <text x={80} y={34} fontSize={11} fill="var(--muted-foreground)">
        *
      </text>
      <DataBox x={90} y={18} w={60} h={24} label="s1" color={C.secret} />
      <text x={160} y={34} fontSize={11} fill="var(--muted-foreground)">
        +
      </text>
