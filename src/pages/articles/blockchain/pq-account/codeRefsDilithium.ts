...
// pk = (rho, t), sk = (rho, s1, s2, t)`,
    annotations: [
      ...
      },
      {
        ...
        note: "t = A*s1 + s2 (Module-LWE)",
      },
    ],
  },
  "dilithium-sign": {
    path: "dilithium/src/sign.rs",
    lang: "rust",
    highlight: [4, 16],
    ...
    annotations: [
      ...
      },
      {
        ...
        color: "emerald" as const,
        note: "도전 c 생성 + 서명 벡터 z",
      },
      {
        lines: [7, 9] as [number, number],
        color: "rose" as const,
        note: "거부 샘플링: z가 크면 재시작",
      },
    ],
  },
  "dilithium-verify": {
    path: "dilithium/src/verify.rs",
    lang: "rust",
    highlight: [5, 12],
    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "힌트로 w1 상위 비트 복원",
      },
      {
        lines: [4, 5] as [number, number],
        color: "emerald" as const,
        note: "A*z - c*t = A*y - c*s2",
      },
      {
        lines: [6, 7] as [number, number],
        color: "amber" as const,
