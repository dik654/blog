...
const STEPS = [
  {
    label: "이중 합의 & 크로스 롤업 메시징",
    body: "Omni Halo — EVM 합의와 XBlock 합의를 동시에 수행.\n이중 스테이킹: OMNI 토큰 + EigenLayer restaked ETH.",
  },
  {
    label: "1단계: 소스 체인 이벤트 발생",
    body: "Rollup A에서 크로스체인 트랜잭션 실행 → Portal Contract가 XMsg 이벤트를 발행.",
  },
  {
    label: "2단계: 검증자 어테스테이션",
    body: "Omni 검증자들이 Portal Contract 모니터링 → XBlock 해시에 대해 어테스테이션 → 2/3+ 투표로 확정.",
  },
  {
    label: "3단계: 릴레이어 전달",
    body: "릴레이어가 확정된 어테스테이션을 목적지 체인의 Portal Contract에 제출.",
  },
  {
    label: "4단계: 목적지 실행",
    body: 'Portal Contract가 서명 검증 & 메시지 실행.\n확인 전략: "Finalized"(~12분, 안전) vs "Latest"(~5초, 빠름).',
  },
];
