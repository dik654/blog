...
const EDGES = [
  ...
  { s: "p3", t: "shamir" },
  { s: "shamir", t: "channel" },
  { s: "channel", t: "paillier" },
  { s: "paillier", t: "dkg" },
  { s: "dkg", t: "threshold" },
  { s: "threshold", t: "result" },
];
...
const ACTIVE: string[][] = [
  ...
  ["p1", "p2", "p3", "shamir"],
  ["shamir", "channel", "paillier"],
  ["paillier", "dkg"],
  ["dkg", "threshold", "result"],
];

const STEPS = [
  {
    label: "MPC 전체 아키텍처",
    body: "참가자들이 비밀을 공개하지 않고 협력하여 계산하는 전체 흐름",
  },
  {
    label: "비밀 입력 분산",
    body: "각 참가자가 Shamir 비밀 분산으로 자신의 입력을 n개 공유로 나눕니다",
  },
  {
    label: "보안 채널 통신",
    body: "공유를 암호화된 P2P 채널로 교환. Paillier 동형 암호로 연산합니다",
  },
  {
    label: "분산 키 생성",
    body: "DKG로 신뢰할 수 있는 딜러 없이 Paillier 키 쌍을 생성합니다",
  },
  {
    label: "임계값 서명 & 결과",
    body: "t+1명이 협력하여 서명. 개인키 복원 없이 유효한 서명 생성",
  },
];
