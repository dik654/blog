  ...
  return (
    <section id="dkg" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          DKG(Distributed Key Generation, 분산 키 생성)는 신뢰할 수 있는
          딜러(trusted dealer) 없이 여러 참가자가 협력해 Paillier 키 쌍을
          생성하는 프로토콜입니다.
          <br />
        ...
        <CodePanel
          ...
          annotations={[
            { lines: [4, 5], color: "sky", note: "독립적 소수 후보 생성" },
            {
              lines: [7, 11],
              color: "emerald",
              note: "소수성 필터링 (빠른 테스트 + Miller-Rabin)",
            },
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("mta-protocol", codeRefs["mta-protocol"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              MtA 프로토콜
