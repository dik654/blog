    ...
    annotations: [
      {
        lines: [42, 52],
        color: "sky",
        note: "ui 랜덤 생성 → VSS share 분배 (Shamir 다항식)",
      },
      {
        lines: [59, 64],
        color: "emerald",
        note: "Feldman 커밋먼트 생성 → HashCommitment(C, D)",
      },
      {
        lines: [90, 99],
        color: "amber",
        note: "DLN proof 생성 — h1, h2, NTilde 영지식 증명",
      },
      {
        lines: [117, 130],
        color: "violet",
        note: "Round 1 메시지 브로드캐스트 — (C, PaillierPK, NTilde, DLN proofs)",
      },
    ],
    ...
    annotations: [
      {
        lines: [54, 62],
        color: "sky",
        note: "k, γ 랜덤 생성 → γ·G 커밋먼트 생성",
      },
      {
        lines: [67, 78],
        color: "emerald",
        note: "MtA(Multiplicative-to-Additive) — Alice가 k를 Paillier 암호화",
      },
      {
        lines: [80, 83],
        color: "amber",
        note: "Round 1 Message 2 — 커밋먼트 C 브로드캐스트",
      },
    ],
    ...
    annotations: [
      {
        lines: [20, 32],
        color: "sky",
        note: "AliceInit — a를 Paillier 암호화, 범위증명 생성",
      },
      {
        lines: [34, 46],
        color: "emerald",
        note: "BobMid — 범위증명 검증 → c_B = b·c_A + Enc(β')",
      },
      {
        lines: [55, 63],
        color: "amber",
        note: "HomoMult(b, cA) + HomoAdd(cB, cBetaPrm) → 동형 연산",
      },
    ],
