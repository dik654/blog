    ...
    annotations: [
      {
        lines: [62, 68],
        color: "sky",
        note: "Create — threshold, secret, indexes로 VSS 공유 생성",
      },
      {
        lines: [80, 85],
        color: "emerald",
        note: "Feldman 커밋먼트 — v[i] = g^a_i (검증 가능)",
      },
      {
        lines: [87, 93],
        color: "amber",
        note: "각 참가자에게 다항식 평가값 f(id) 배포",
      },
    ],
    ...
    annotations: [
      {
        lines: [95, 98],
        color: "sky",
        note: "Verify — threshold, vs 벡터 유효성 확인",
      },
      {
        lines: [101, 113],
        color: "emerald",
        note: "∏ v_j^(id^j) == g^(share) 검증 (Feldman 조건)",
      },
    ],
    ...
    annotations: [
      {
        lines: [116, 120],
        color: "sky",
        note: "ReConstruct — threshold 이상의 share로 비밀 복원",
      },
      {
        lines: [129, 143],
        color: "emerald",
        note: "라그랑주 보간 — ∏ x_j/(x_j - x_i) 계수 계산",
      },
    ],
