  ...
  return (
    <section id="shamir" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Shamir 비밀 분산(SSS, Secret Sharing Scheme)은 비밀 s를 n개의
          "공유(share)"로 나눕니다.
          <br />
          t+1개 이상의 공유가 있어야만 복원할 수 있습니다.
          <br />
          t개 이하의 공유로는 s에 대해 어떤 정보도 얻을 수 없습니다 (정보이론적
          보안).
        </p>
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() => onCodeRef("vss-create", codeRefs["vss-create"])}
            />
            <span className="text-[10px] text-muted-foreground self-center">
              feldman_vss.go · Create
            </span>
            <CodeViewButton
              onClick={() => onCodeRef("vss-verify", codeRefs["vss-verify"])}
            />
            <span className="text-[10px] text-muted-foreground self-center">
              Verify
            </span>
            <CodeViewButton
              onClick={() =>
                onCodeRef("vss-reconstruct", codeRefs["vss-reconstruct"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              ReConstruct
