    ...
    annotations: [
      {
        lines: [40, 54],
        color: "sky",
        note: "PublicKey / PrivateKey 타입 — N, LambdaN, PhiN, P, Q",
      },
      {
        lines: [70, 97],
        color: "emerald",
        note: "GenerateKeyPair — 안전소수 2개 동시 생성, P-Q 비트 차이 검증",
      },
      {
        lines: [99, 109],
        color: "amber",
        note: "phiN = (P-1)(Q-1), lambdaN = lcm(P-1,Q-1) 계산",
      },
    ],
    ...
    annotations: [
      {
        lines: [114, 127],
        color: "sky",
        note: "Encrypt — g^m * r^N mod N² (가법 동형 암호화)",
      },
      {
        lines: [134, 144],
        color: "emerald",
        note: "HomoMult — cipher^m mod N² (스칼라 곱)",
      },
      {
        lines: [146, 156],
        color: "amber",
        note: "HomoAdd — c1 * c2 mod N² (동형 덧셈)",
      },
    ],
    ...
    annotations: [
      {
        lines: [174, 182],
        color: "sky",
        note: "Decrypt 입력 검증 — c ∈ [0, N²)",
      },
      {
        lines: [183, 189],
        color: "emerald",
        note: "L 함수 적용 — L(c^λ mod N²) · L(g^λ mod N²)⁻¹ mod N",
      },
    ],
