...
export default function Paillier({
  title,
  onCodeRef,
}: {
  title?: string;
  ...
  return (
    <section id="paillier" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Paillier 암호화 시스템은{" "}
          <strong>덧셈 동형성(Additive Homomorphism)</strong>을 가진 공개키 암호
          시스템입니다.
          <br />
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("paillier-keygen", codeRefs["paillier-keygen"])
              }
            />
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("paillier-encrypt", codeRefs["paillier-encrypt"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              Encrypt / HomoAdd
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("paillier-decrypt", codeRefs["paillier-decrypt"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              Decrypt
