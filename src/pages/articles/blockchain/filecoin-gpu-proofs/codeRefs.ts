    ...
    annotations: [
      {
        lines: [55, 58],
        color: "sky",
        note: "CpuGpuMultiexpKernel — GPU+CPU 하이브리드 MSM",
      },
      {
        lines: [60, 74],
        color: "emerald",
        note: "create — GPU 디바이스별 커널 초기화",
      },
      {
        lines: [95, 110],
        color: "amber",
        note: "multiexp — CPU/GPU 워크로드 분할",
      },
      {
        lines: [115, 141],
        color: "violet",
        note: "parallel_multiexp + CPU 결과 합산",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [35, 47],
        color: "sky",
        note: "함수 시그니처 — 배치 증명 + GPU 우선순위",
      },
      {
        lines: [50, 67],
        color: "emerald",
        note: "회로 합성 + vk/밀도 정보 추출",
      },
      {
        lines: [107, 119],
        color: "amber",
        note: "FFT 커널로 다항식 평가 (GPU 가속)",
      },
      {
        lines: [121, 143],
        color: "violet",
        note: "MSM 커널로 h 벡터 계산 (GPU 가속)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [36, 49],
        color: "sky",
        note: "verify_proof 시그니처 + 입력 길이 검사",
      },
      {
        lines: [51, 57],
        color: "emerald",
        note: "검증 방정식 재배열 — 단일 final_exp로 최적화",
      },
      {
        lines: [67, 93],
        color: "amber",
        note: "rayon 병렬: ML(A*B), ML(C*-delta), 입력 누적",
      },
      {
        lines: [96, 103],
        color: "violet",
        note: "final_exponentiation 결과 비교",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [12, 18],
        color: "sky",
        note: "Proof<E> — a: G1Affine, b: G2Affine, c: G1Affine",
      },
      {
        lines: [60, 67],
        color: "emerald",
        note: "write — G1+G2+G1 바이트 직렬화",
      },
      {
        lines: [87, 98],
        color: "amber",
        note: "read_many — 배치 역직렬화 + rayon 병렬 디코딩",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [24, 45],
        color: "sky",
        note: "generate_random_parameters — tau 샘플링 + CRS 생성",
      },
      {
        lines: [49, 59],
        color: "emerald",
        note: "KeypairAssembly — 회로를 QAP로 합성",
      },
      {
        lines: [61, 76],
        color: "amber",
        note: "ConstraintSystem 구현 — 변수 할당 + 제약 수집",
      },
    ],
  },
};
