...
export default function ModernCometBFTStateArticle() {
  ...
  <article className="space-y-14">
    ...
    <section id="blockstore" className="space-y-6">
    ...
    <section id="evidence" className="space-y-6">
      <header><p className="text-sm font-semibold text-primary">03 · State sync, replay와 evidence</p><h2 className="mt-2 text-2xl font-bold">snapshot 복원과 trusted header 검증, local crash replay를 섞지 않는다</h2></header>
