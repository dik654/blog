...
const STEPS = [
  {
    label: "MonadBFT 합의",
    body: "파이프라인 BFT로 블록 제안/투표/실행을 오버랩합니다.",
  },
  {
    label: "병렬 실행 엔진",
    body: "Fiber 기반 Optimistic Concurrency로 트랜잭션을 동시에 실행합니다.",
  },
  {
    label: "JIT 컴파일러",
    body: "EVM 바이트코드를 x86 네이티브 코드로 변환합니다. 2배 속도 향상.",
  },
  {
    label: "MonadDB (TrieDB)",
    body: "io_uring 비동기 I/O와 LRU 캐싱으로 상태 조회를 최적화합니다.",
  },
];
