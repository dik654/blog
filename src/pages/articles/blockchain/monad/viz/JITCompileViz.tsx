...
const STEPS = [
  {
    label: "EVM 바이트코드 입력",
    body: "Solidity 컴파일 결과인 EVM 바이트코드를 수신합니다.",
  },
  {
    label: "asmjit IR 변환",
    body: "옵코드를 분석하여 내부 IR(Intermediate Repr.)로 변환합니다.",
  },
  {
    label: "레지스터 할당 & 최적화",
    body: "스택 연산을 레지스터로 매핑하고 불필요한 검사를 제거합니다.",
  },
  {
    label: "x86 네이티브 코드 출력",
    body: "최적화된 네이티브 기계어를 캐시에 저장합니다.",
  },
];
...
export default function JITCompileViz({
  onOpenCode,
}: {
