...
const STEPS = [
  {
    label: "JIT 컴파일러 성능",
    body: "BurntPix: Interpreter 1025ms → Compiler 509ms. 2.01배 향상.",
  },
  {
    label: "병렬 실행 성능",
    body: "8코어, 100 TX: 순차 1000ms → 병렬 180ms. 5.56배 스피드업.",
  },
  {
    label: "io_uring I/O 성능",
    body: "동기 5,000 ops/s → io_uring 20,833 ops/s. 4.17배 향상.",
  },
];
...
export default function PerfBenchViz({
  onOpenCode,
}: {
        ...
        <div className="w-full">
          ...
          {onOpenCode && (
            <div className="flex items-center gap-2 mt-3 justify-end">
              <CodeViewButton
                onClick={() => onOpenCode("monad-perf-benchmark")}
              />
