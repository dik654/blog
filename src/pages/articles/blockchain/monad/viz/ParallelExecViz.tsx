...
const STEPS = [
  ...
  {
    label: "낙관적 실행",
    body: "각 트랜잭션이 현재 상태의 스냅샷으로 독립 실행됩니다.",
  },
  {
    label: "순서 대기",
    body: "Promise 체인으로 이전 트랜잭션의 머지를 대기합니다.",
  },
  {
    label: "충돌 감지 & 머지",
    body: "can_merge() 성공 시 머지, 실패 시 재실행합니다.",
  },
];
...
export default function ParallelExecViz({
  onOpenCode,
}: {
        ...
        <div className="w-full">
          ...
          {onOpenCode && (
            <div className="flex items-center gap-2 mt-3 justify-end">
              <CodeViewButton
                onClick={() => onOpenCode("monad-parallel-exec")}
              />
