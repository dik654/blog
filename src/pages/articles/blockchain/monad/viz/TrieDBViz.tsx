...
const STEPS = [
  {
    label: "Trie 조회 요청",
    body: "EVM 실행 중 계정/스토리지 접근 시 nibble 키로 Trie 탐색을 시작합니다.",
  },
  {
    label: "LRU 캐시 확인",
    body: "루트 근처 노드는 캐시에서 즉시 반환합니다. 히트율 최적화.",
  },
  {
    label: "io_uring 비동기 읽기",
    body: "캐시 미스 시 io_uring SQE로 디스크 읽기를 배치 제출합니다.",
  },
  {
    label: "CQE 완료 + 응답",
    body: "완료 큐에서 결과를 수신하여 노드를 역직렬화합니다.",
  },
];
...
export default function TrieDBViz({
  onOpenCode,
}: {
