    ...
    <section id="prove" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <div className="not-prose flex flex-wrap gap-2 my-4">
          ...
          <CodeViewButton
            onClick={() =>
              onCodeRef("groth16-c-calc", codeRefs["groth16-c-calc"])
            }
          />
          <span className="text-[10px] text-muted-foreground self-center">
            C 계산 + 블라인딩
        ...
        <p>
          증명자는 PK와 witness를 사용하여 증명{" "}
          <strong>Proof = (A, B, C)</strong>를 생성합니다.
          <br />
          BN254 기준으로 G1 2개 + G2 1개 = <strong>256 bytes</strong>의 간결한
          증명입니다.
          <br />
        ...
        <div className="rounded-lg border p-4 not-prose text-sm space-y-3">
          ...
          <div className="bg-sky-50 dark:bg-sky-950/30 rounded p-3 space-y-1">
            <M display>
              {
                "B \\in G_2:\\; [\\beta]_2 + \\sum_j w_j \\cdot [b_j(\\tau)]_2 + s \\cdot [\\delta]_2"
              }
            </M>
            <M display>
              {
                "B' \\in G_1:\\; [\\beta]_1 + \\sum_j w_j \\cdot [b_j(\\tau)]_1 + s \\cdot [\\delta]_1"
              }
            </M>
          </div>
        ...
        <div className="rounded-lg border p-4 not-prose text-sm space-y-3">
          ...
          <div className="bg-sky-50 dark:bg-sky-950/30 rounded p-3 space-y-1">
            ...
            <p className="font-mono text-xs">
              <M>
                {"\\sum_{j \\in \\text{private}} w_j \\cdot l\\_query[j\\,']"}
              </M>{" "}
              — 비공개 변수 기여
            </p>
            <p className="font-mono text-xs">
              <M>{"\\sum_i h_i \\cdot h\\_query[i]"}</M> — QAP 만족의 증거
            </p>
            <p className="font-mono text-xs">
              <M>
                {"s \\cdot A + r \\cdot B' - r \\cdot s \\cdot [\\delta]_1"}
              </M>{" "}
              — 블라인딩
            </p>
          </div>
        ...
        <p>
          ...
          <br />
          이것이 <strong>완전 영지식(perfect zero-knowledge)</strong>을
          보장합니다.
        </p>
        <div className="rounded-lg border p-4 not-prose text-sm space-y-2">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded border p-3 bg-red-50 dark:bg-red-950/30">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                같은 witness → 항상 같은 증명 → 정보 유출 위험
              </p>
            </div>
            <div className="rounded border p-3 bg-emerald-50 dark:bg-emerald-950/30">
              <p className="text-xs font-medium">r, s ≠ 0 이면</p>
              <p className="text-xs text-muted-foreground mt-1">
                같은 witness라도 매번 다른 증명 → 시뮬레이션 가능
              </p>
            </div>
          </div>
          <p className="text-xs text-muted-foreground mt-1">
