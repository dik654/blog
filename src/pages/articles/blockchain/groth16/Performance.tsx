  ...
  return (
    <section id="performance" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Groth16 증명 시간의 <strong>78%가 MSM</strong>입니다.
          <br />
          Pippenger 알고리즘, 멀티스레드 병렬화, 메모리 최적화를 통해 성능을
          극대화합니다.
        </p>
        ...
        <div className="rounded-lg border p-4 not-prose text-sm space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            입력: n개 스칼라 <M>{"s_i"}</M>, n개 포인트 <M>{"P_i"}</M> → 출력:{" "}
            <M>{"\\sum s_i \\cdot P_i"}</M>
          </p>
        ...
        <div className="rounded-lg border p-4 not-prose text-sm space-y-3">
          ...
          <div className="bg-sky-50 dark:bg-sky-950/30 rounded p-3 space-y-1">
            ...
            <ol className="space-y-1 text-xs list-decimal list-inside text-muted-foreground">
              <li>
                A, B MSM → <code>rayon::join</code>으로 병렬 실행
              </li>
              <li>
                B_g2, B_g1 → <code>rayon::join</code>으로 병렬 실행
              </li>
              <li>
                각 MSM 내부: 윈도우별 <code>rayon::scope</code> 병렬
              </li>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              ...
              <tbody className="text-muted-foreground">
                <tr className="border-b">
                  <td className="py-1.5 pr-4">Setup</td>
                  <td className="text-right px-4">~2.5s</td>
                  <td className="text-right pl-4">1회성</td>
                </tr>
                <tr className="border-b font-medium text-foreground">
                  <td className="py-1.5 pr-4">Prove</td>
                  <td className="text-right px-4">~1.8s</td>
                  <td className="text-right pl-4">매번</td>
                </tr>
                <tr className="border-b">
                  <td className="py-1.5 pr-4 pl-4">witness</td>
                  <td className="text-right px-4">~0.1s</td>
                  <td className="text-right pl-4">5%</td>
                </tr>
                <tr className="border-b">
                  <td className="py-1.5 pr-4 pl-4">FFT(h)</td>
                  <td className="text-right px-4">~0.3s</td>
                  <td className="text-right pl-4">17%</td>
                </tr>
                <tr className="border-b">
                  <td className="py-1.5 pr-4 pl-4">MSM(A,B,C)</td>
                  <td className="text-right px-4">~1.4s</td>
                  <td className="text-right pl-4 font-medium text-foreground">
                    78%
                  </td>
                </tr>
                <tr>
                  <td className="py-1.5 pr-4">Verify</td>
                  <td className="text-right px-4">~4ms</td>
                  <td className="text-right pl-4">O(1)</td>
                </tr>
              </tbody>
            </table>
          </div>
