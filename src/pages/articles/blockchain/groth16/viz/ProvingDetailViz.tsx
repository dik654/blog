...
const STEPS = [
  {
    label: "Witness 할당 (SynthesisMode::Prove)",
    body: "회로에 구체적 값을 대입. full_assignment 벡터에 상수 + 공개 + 비밀 순으로 채움.",
  },
  {
    label: "A 계산 -- G1 MSM",
    body: "alpha + witness 가중합 + r 블라인딩. Pippenger window=15로 O(n/log n).",
  },
  {
    label: "B 계산 -- G2+G1 병렬 MSM",
    body: "rayon::join으로 G2, G1 두 그룹 동시 계산. G1 결과는 C 블라인딩에 재사용.",
  },
  {
    label: "C 계산 -- 3개 MSM 합산",
    body: "private LC + h(x) quotient + s*A + r*B1 - rs*delta 블라인딩 항.",
  },
  {
    label: "Proof = (A, B2, C)",
    body: "G1 + G2 + G1 = 256B 상수 크기. 10^6 게이트 회로도 동일.",
  },
];
          ...
          {step === 2 && (
            ...
            >
              ...
              <ActionBox
                ...
                color={C.b}
              />
              <text x={120} y={78} fontSize={8} fill={C.p}>
                + s * [delta]2
              </text>
              ...
              <ActionBox
                ...
                color={C.b}
              />
              <text x={370} y={78} fontSize={8} fill={C.p}>
                + s * [delta]1
              </text>
