...
const STEPS = [
  {
    label: "비밀 파라미터 랜덤 샘플링",
    body: "Fr 필드에서 5개 비밀값 무작위 추출. MPC 세레모니로 1-of-N 신뢰 보장.",
  },
  {
    label: "SRS 포인트 생성",
    body: "tau 거듭제곱을 EC 스칼라곱으로 커밋. d+1개의 G1/G2 포인트 생성.",
  },
  {
    label: "alpha, beta 구조 태그 결합",
    body: "A, B 다항식을 alpha*beta 구조로 묶어 개별 위조를 방지.",
  },
  {
    label: "gamma, delta 공개/비공개 분리",
    body: "public IC는 gamma로, private L은 delta로 나눠 교차 불가.",
  },
  {
    label: "Toxic Waste 즉시 삭제",
    body: "비밀 스칼라 전부 덮어쓰기. 하나라도 노출 시 증명 위조 가능.",
  },
];
          ...
          {step === 4 && (
            ...
            >
              ...
              <AlertBox
                ...
                w={250}
                h={40}
                label="Toxic Waste Destroyed"
                sub="1개라도 노출 시 proof 위조 가능"
                color={C.del}
              />
            </motion.g>
          )}
