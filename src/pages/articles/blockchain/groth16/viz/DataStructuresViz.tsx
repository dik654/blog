...
const STEPS = [
  {
    label: "ProvingKey -- 증명자 전용",
    body: "증명 생성에 필요한 모든 SRS 포인트를 보유. 크기 O(n), 제약 수에 비례.",
  },
  {
    label: "VerifyingKey -- 검증자 전용",
    body: "페어링 검증에 필요한 최소 데이터. 크기 O(l), 공개 입력 수에 비례.",
  },
  {
    label: "Proof -- 최종 증명 (256B)",
    body: "G1 2개 + G2 1개. 회로 크기와 무관한 상수 크기.",
  },
];
            ...
            >
              ...
              >
                ...
                <text
                  ...
                  fill="var(--muted-foreground)"
                >
                  l+1 elements (public input commitments)
                </text>
              </motion.g>
