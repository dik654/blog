...
const STEPS = [
  {
    label: "1. 회로 정의 -> R1CS",
    body: "계산 문제를 곱셈 게이트로 분해하고 A, B, C 행렬로 인코딩.",
  },
  {
    label: "2. R1CS -> QAP 변환",
    body: "IFFT로 다항식 복원 후 vanishing polynomial로 나눗셈 검증.",
  },
  {
    label: "3. Trusted Setup (SRS)",
    body: "MPC 세레모니로 비밀 파라미터 생성. PK/VK 분리.",
  },
  {
    label: "4. Prove -> (A, B, C)",
    body: "MSM으로 witness 커밋. 블라인딩 추가하여 256B proof 출력.",
  },
  {
    label: "5. Verify -> O(1)",
    body: "3회 페어링으로 증명 검증. 약 4ms, 온체인 280k gas.",
  },
];
        ...
        >
          ...
          {step === 3 && (
            ...
            >
              ...
              >
                <text x={310} y={118} fontSize={9} fontWeight={600} fill={C.p}>
                  = 256 bytes
                </text>
                <text
                  x={310}
