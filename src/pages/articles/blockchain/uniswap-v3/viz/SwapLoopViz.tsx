  ...
  const steps = [
    {
      n: 1,
      label: "다음 tick 찾기",
      detail: "tickBitmap.nextInitialized...",
      color: "#3b82f6",
    },
    {
      n: 2,
      label: "tick → √P 변환",
      detail: "TickMath.getSqrtRatioAtTick()",
      color: "#06b6d4",
    },
    {
      n: 3,
      label: "computeSwapStep",
      detail: "한 구간 내 swap 계산",
      color: "#8b5cf6",
    },
    {
      n: 4,
      label: "잔여량 업데이트",
      detail: "remaining -= amountIn + fee",
      color: "#f59e0b",
    },
    {
      n: 5,
      label: "수수료 누적",
      detail: "feeGrowthGlobal += fee / L",
      color: "#ef4444",
    },
    {
      n: 6,
      label: "crossing 체크",
      detail: "√P == sqrtPriceNext? → L 조정",
      color: "#10b981",
    },
  ];
