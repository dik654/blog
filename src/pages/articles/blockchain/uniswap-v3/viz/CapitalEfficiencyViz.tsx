      ...
      >
        ...
        {(() => {
          ...
          return (
            <g>
              <rect
                x={Math.max(40, xLower)}
                y={56}
                width={Math.min(440, xUpper - xLower)}
                height={30}
                fill="#10b981"
                fillOpacity={0.4}
                stroke="#10b981"
        ...
        <text x={32} y={174} fontSize={10} fill="var(--muted-foreground)">
          P_lower
        </text>
        <text x={120} y={174} fontSize={10} fontWeight={700} fill="#10b981">
          ${pLower.toFixed(0)}
        </text>
        <text x={32} y={188} fontSize={10} fill="var(--muted-foreground)">
          P_upper
        </text>
        <text x={120} y={188} fontSize={10} fontWeight={700} fill="#10b981">
          ${pUpper.toFixed(0)}
        </text>
        ...
        <rect
          ...
          strokeDasharray="3 2"
        />
        <text x={32} y={289} fontSize={10} fontWeight={700} fill="#ef4444">
          트레이드오프:
        </text>
