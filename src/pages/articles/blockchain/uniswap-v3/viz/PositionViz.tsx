  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={207} y={202} fontSize={10} fontWeight={700} fill="#10b981">
          누적 수수료:
        </text>
        <text
          x={260}
        ...
        <text
          ...
          fill="var(--foreground)"
        >
          V2 LP (ERC20) vs V3 Position (ERC721)
        </text>
        <text
          x={260}
          y={284}
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          각 포지션은 (pool, tickLower, tickUpper)로 고유 식별
        </text>
      </svg>
    </div>
  );
