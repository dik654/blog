    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          Swap 가스 비용 — crossing 횟수에 비례
        </text>

        {/* 가스 비교 바 차트 */}
        {/* V2 */}
        <text x={40} y={72} fontSize={11} fontWeight={700} fill="#3b82f6">
          V2 swap
        </text>
        <rect
          x={110}
          y={60}
          width={(v2Gas / 400000) * 380}
          height={22}
          rx={4}
          fill="#3b82f6"
          fillOpacity={0.35}
        ...
        {/* V3 base */}
        <text x={40} y={112} fontSize={11} fontWeight={700} fill="#10b981">
          V3 (0 crossing)
        </text>
        <rect
          x={110}
          y={100}
          width={(baseGas / 400000) * 380}
          height={22}
          rx={4}
          fill="#10b981"
          fillOpacity={0.35}
        ...
        {/* V3 current */}
        <text x={40} y={152} fontSize={11} fontWeight={700} fill="#ef4444">
          V3 ({crossings} crossing)
        </text>
        <rect
          x={110}
          y={140}
          width={Math.min(380, (totalGas / 400000) * 380)}
          height={22}
          rx={4}
          fill="#ef4444"
          fillOpacity={0.35}
        ...
        />
        <text
          x={114 + Math.min(380, (totalGas / 400000) * 380)}
          y={156}
          fontSize={10}
          fontWeight={700}
          fill="#ef4444"
