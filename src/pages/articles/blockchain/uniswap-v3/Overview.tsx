    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h3 className="text-xl font-semibold mt-6 mb-3">
          V3의 핵심 혁신 — Concentrated Liquidity
        </h3>

        <ConcentratedViz />

        <p>
          Uniswap V2: 유동성이 <strong>[0, ∞]</strong> 전체 가격 범위에 분산
          <br />
          V3: LP가 <strong>특정 가격 구간</strong>에 유동성 집중 가능
          <br />
        ...
        <div className="not-prose my-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-muted/50 rounded-xl p-5 border border-border">
            ...
            <p className="text-sm mt-2">
              $100 LP 유동성이{" "}
              <code className="text-xs bg-muted px-1 rounded">$0 ~ $∞</code> 전
              구간에 분산
            </p>
            <p className="text-sm mt-1">
              $2500~$3500 구간에 실제 사용 유동성: <strong>약 $2</strong>
            </p>
          </div>
          <div className="bg-muted/50 rounded-xl p-5 border border-border">
            <p className="text-sm font-semibold text-muted-foreground mb-2">
            ...
            <p className="text-sm mt-2">
              같은 $100으로 해당 구간에 <strong>$100 전부 제공</strong>
            </p>
            <p className="text-sm mt-1">
              자본 효율: <strong>50배</strong>
            </p>
          </div>
          <div className="md:col-span-2 bg-muted/50 rounded-xl p-5 border border-border">
            ...
            <p className="text-sm">
              자본 효율: <strong>200배</strong> — 구간이 좁을수록 효율 상승
            </p>
            <p className="text-sm mt-1 text-muted-foreground">
              단, 가격 이탈 시 100% 한 쪽 자산으로 전환
            </p>
          </div>
        </div>
        <p>
          <strong>구간이 좁을수록 효율 ↑, 위험 ↑</strong>
          <br />
          가격이 구간 밖으로 나가면 100% 한 쪽 토큰으로 변환됨 — 수수료 수익
          중단
          <br />
        ...
        <div className="not-prose my-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-muted/50 rounded-xl p-5 border border-border">
            ...
            <M display>
              {
                "\\left(x + \\frac{L}{\\sqrt{P_{upper}}}\\right) \\cdot \\left(y + L \\cdot \\sqrt{P_{lower}}\\right) = L^2"
              }
            </M>
            <p className="text-xs text-muted-foreground mt-2">
              P: 현재 가격, P_lower/P_upper: 구간 경계
            </p>
          </div>
          <div className="md:col-span-2 bg-muted/50 rounded-xl p-5 border border-border">
            <p className="text-sm font-semibold text-muted-foreground mb-2">
            ...
            <div className="grid grid-cols-3 gap-3 text-sm mt-1">
              <div className="text-center">
                ...
                <p className="mt-1">
                  100%{" "}
                  <code className="text-xs bg-muted px-1 rounded">token0</code>{" "}
                  (base)
                </p>
              </div>
              <div className="text-center border-x border-border px-3">
                <p className="font-mono text-xs text-muted-foreground">
                  P_lower &le; P &le; P_upper
                </p>
              ...
              <div className="text-center">
                ...
                <p className="mt-1">
                  100%{" "}
                  <code className="text-xs bg-muted px-1 rounded">token1</code>{" "}
                  (quote)
                </p>
              </div>
            </div>
        ...
        <p>
          V3는 <strong>"가상 reserve"</strong> 개념 도입
          <br />
          실제 보유량 + 구간 경계로부터 계산된 가상 reserve가 곡선 형성
          <br />
        ...
        <div className="not-prose my-4 bg-muted/50 rounded-xl border border-border overflow-hidden">
          <div className="bg-muted px-5 py-2 border-b border-border flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground">
              V2: ERC20 (fungible) &rarr; V3: NFT (non-fungible)
            </span>
          </div>
        ...
        <p>
          <strong>포지션마다 구간 다름 → NFT로 개별 관리</strong>
          <br />
          V2처럼 ERC20으로 fungible화 불가능 — 각 포지션 고유함
          <br />
        ...
        <p>
          <strong>Tick Spacing</strong>: 유효 가격 틱 간격 — tier 높을수록 간격
          넓음
          <br />
          Tier마다 별도 Pool 배포 — ETH/USDC에 3개 풀 공존 가능 (0.05%, 0.3%,
          1%)
          <br />
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: "Professional LP"의 등장
          </p>
          <p>
            V2는 "수동 LP" — 예치하고 방치해도 수수료 누적
            <br />
            V3는 "능동 LP" — 구간 관리, 재조정, tier 선택 필수
          </p>
          <p className="mt-2">
            결과: <strong>전문 LP 시장 형성</strong>
            <br />
            - Gamma, Arrakis, Visor 같은 LP 매니저 프로토콜 등장
            <br />
            - 알고리즘 기반 자동 재조정
            <br />- 일반 사용자는 "LP 매니저 vault"에 예치
          </p>
          <p className="mt-2">
            V3는 LP를 <strong>passive → active</strong>로 전환
            <br />
            이는 전통 시장의 <strong>"market maker"</strong>와 유사 — DEX의 성숙
            과정
          </p>
        </div>
      </div>
