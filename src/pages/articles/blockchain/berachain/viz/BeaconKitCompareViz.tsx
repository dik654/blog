...
const STEPS = [
  {
    label: "전체 아키텍처 비교",
    body: "왼쪽 이더리움 Beacon Chain vs 오른쪽 Berachain BeaconKit. 레이어별 차이를 비교합니다.",
  },
  {
    label: "합의 레이어: Casper FFG → CometBFT",
    body: "Casper FFG의 확률적 최종성 대신 CometBFT 즉시 최종성으로 교체. 1블록 최종성 달성.",
  },
  {
    label: "포크 선택: LMD-GHOST → 불필요",
    body: "BFT 합의는 포크가 발생하지 않으므로 포크 선택 규칙이 필요 없습니다.",
  },
  {
    label: "네트워킹: libp2p → MConnection",
    body: "Tendermint의 MConnection 멀티플렉싱 P2P로 교체. 기존 Cosmos 생태계와 호환.",
  },
];
