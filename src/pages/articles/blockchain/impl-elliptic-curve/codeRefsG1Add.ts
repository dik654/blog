    ...
    annotations: [
      {
        lines: [3, 4],
        color: "sky",
        note: "무한원점(항등원) 처리 — P+O=P, O+Q=Q",
      },
      {
        lines: [6, 11],
        color: "emerald",
        note: "Z 보정: affine x₁=X₁/Z₁² 비교를 X₁·Z₂²==X₂·Z₁² 로 변환 (역원 회피)",
      },
      {
        lines: [13, 15],
        color: "amber",
        note: "같은 점이면 double, 역원이면 무한원점 — 특수 케이스 분기",
      },
      {
        lines: [23, 25],
        color: "violet",
        note: "최종 좌표 — 역원 없이 곱셈 16회, 제곱 4회로 완료",
      },
    ],
  },
  "g1-scalar-mul": {
    ...
    annotations: [
      {
        lines: [3, 4],
        color: "sky",
        note: "result=O(항등원), base=P에서 시작. LSB부터 스캔",
      },
      {
        lines: [7, 8],
        color: "emerald",
        note: "비트가 1인 위치에서만 add — 평균 128회 add + 256회 double",
      },
      {
        lines: [22, 25],
        color: "amber",
        note: "전체 연산 중 유일한 inv() 호출 — Jacobian 사용 이유",
      },
    ],
  },
};
