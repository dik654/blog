...
import { CurveParamStep, AffineVsJacobianStep } from './OverviewVizSteps';
import { DualReprStep, OnCurveStep } from './OverviewVizSteps2';

const RENDERERS = [CurveParamStep, AffineVsJacobianStep, DualReprStep, OnCurveStep];
