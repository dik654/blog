    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <br />
          유한체 Fp 위의 점들이 순환군을 형성 — 이산로그 문제(ECDLP)가 암호학적
          안전성 제공
          <br />
        ...
        <p className="leading-7">
          ...
          <br />
          Jacobian 좌표 (X, Y, Z): (X/Z², Y/Z³) 표현으로 역원 없이 곱셈만으로
          연산
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h4>구현 인사이트</h4>
        <p className="leading-7">
          a=0이 단순 편의가 아닌 성능 설계 — 더블링 공식에서 +aZ⁴ 항이 사라져 Fp
          곱셈 1회 절약
          <br />
          scalar_mul에서 더블링은 256회 호출 — 곱셈 1회 절약이 256회 누적
          <br />
          G1Affine/G1 이중 표현: 저장은 Affine(작음), 연산은 Jacobian(빠름) —
          역할 분리
        </p>
      </div>
    </section>
