    ...
    annotations: [
      {
        lines: [3, 5],
        color: "sky",
        note: "f=1(Fp12 항등원), T=Q에서 시작. neg_q는 -Q 미리 계산",
      },
      {
        lines: [9, 11],
        color: "emerald",
        note: "매 iteration: T에서 접선(line_double) → f²·line 누적",
      },
      {
        lines: [14, 17],
        color: "amber",
        note: "NAF=+1: T+Q 할선. NAF=-1: T+(-Q) 할선. NAF=0: 스킵",
      },
      {
        lines: [27, 33],
        color: "violet",
        note: "BN254 전용 보정: Frobenius π, π² 적용 → 정확한 Ate 페어링",
      },
    ],
  },
  "line-functions": {
    ...
    annotations: [
      {
        lines: [2, 6],
        color: "sky",
        note: "sparse Fp12: c0.c0과 c1.c0, c1.c1만 비영 → 곱셈 최적화 가능",
      },
      {
        lines: [10, 15],
        color: "emerald",
        note: "doubling step: Affine 좌표 사용 (Jacobian 아님) — 교육용 구현",
      },
      {
        lines: [18, 24],
        color: "amber",
        note: "addition step: T+Q의 할선. Affine라서 inv() 매번 호출",
      },
    ],
  },
};
