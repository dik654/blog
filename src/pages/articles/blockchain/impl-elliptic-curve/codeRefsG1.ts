    ...
    annotations: [
      {
        lines: [3, 7],
        color: "sky",
        note: "G1Affine — 직관적 좌표. 덧셈마다 inv() 필요해 내부 연산엔 부적합",
      },
      {
        lines: [10, 14],
        color: "emerald",
        note: "BN254: a=0, b=3 → y²=x³+3. a=0이라 더블링 공식이 단순",
      },
      {
        lines: [20, 24],
        color: "violet",
        note: "Jacobian 좌표: Z로 나눗셈을 미뤄 역원 호출 최소화",
      },
      {
        lines: [28, 30],
        color: "amber",
        note: "생성자 G=(1,2) — 최소 좌표. 2²=1³+3=4 ✓",
      },
    ],
  },
  "g1-double": {
    ...
    annotations: [
      {
        lines: [4, 5],
        color: "sky",
        note: "무한원점이나 Y=0(자기 역원)이면 결과는 무한원점",
      },
      {
        lines: [12, 15],
        color: "emerald",
        note: "중간 변수 A,B,C,D — 중복 계산 제거로 곱셈 횟수 최소화",
      },
      {
        lines: [17, 19],
        color: "amber",
        note: "역원(inv) 없이 곱셈+덧셈만으로 완료 — Jacobian의 핵심 이점",
      },
    ],
  },
};
