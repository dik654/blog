...
const STEPS = [
  {
    label: "R1CS 행렬 A, B, C 정의",
    body: "각 곱셈 게이트를 행렬 행으로 표현합니다. (A·s)⊙(B·s)=C·s.",
  },
  {
    label: "Witness 벡터 s 할당",
    body: "s = [1, 35, 3, 9, 27]. 공개/비공개 값을 포함한 전체 벡터.",
  },
  { label: "A·s 내적 계산", body: "A의 각 행과 s를 내적합니다. 결과: [3, 9]." },
  { label: "B·s 내적 계산", body: "B의 각 행과 s를 내적합니다. 결과: [3, 3]." },
  {
    label: "(A·s)⊙(B·s) = C·s 검증",
    body: "[3×3, 9×3] = [9, 27]. C·s = [9, 27]. 일치하면 제약 만족.",
  },
];
                  ...
                  return (
                    ...
                    >
                      <motion.rect
                        ...
                        rx={2}
                        animate={{
                          fill: active ? `${m.color}30` : `${m.color}08`,
                          stroke: m.color,
