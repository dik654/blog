...
const STEPS = [
  {
    label: "기본 가젯: S-box, Boolean, Mux",
    body: "S-box(x⁵)=3개, Boolean(b(1-b)=0)=1개, Mux=2개. ZKP의 최소 단위.",
  },
  {
    label: "Poseidon Hash — ~634 제약",
    body: "Full 8라운드 + Partial 57라운드. AddRC + S-box + MDS 조합.",
  },
  {
    label: "Merkle Proof depth=4 — ~3,186",
    body: "레벨당 Bool(1)+Mux×2(4)+Poseidon(634)≈639. 4레벨 합산.",
  },
  {
    label: "Merkle Proof depth=20 — ~12,780",
    body: "20레벨 × 639 ≈ 12,780. SHA-256 대비 10× 이상 절감.",
  },
];
