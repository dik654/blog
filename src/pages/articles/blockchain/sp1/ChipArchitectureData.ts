...
export const CPU_ROLE = [
  {
    role: "클럭 관리",
    desc: "글로벌 클럭을 증가시키고 shard 번호를 추적합니다.",
  },
  {
    role: "PC 관리",
    desc: "프로그램 카운터의 전이(+4 또는 분기)를 제약합니다.",
  },
  {
    role: "명령어 디스패치",
    desc: "opcode를 해석해 해당 ALU/메모리/시스콜 칩에 위임합니다.",
  },
  { role: "레지스터 파일", desc: "x0–x31 레지스터의 읽기/쓰기를 추적합니다." },
  {
    role: "칩 간 통신",
    desc: "send_interaction/receive_interaction으로 칩 간 데이터 교환.",
  },
];
