        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-2 px-3 text-green-400 font-medium">
                GPU
              </th>
              <th className="text-left py-2 px-3 text-amber-400 font-medium">
                배율
              </th>
            </tr>
          </thead>
