...
export const CASES = [
  {
    name: "Fibonacci",
    desc: "기본 산술 연산. ~200 사이클. 입문용.",
    perf: "Core: ~0.5s, Groth16: ~30s",
    color: "#10b981",
  },
  {
    name: "JSON 파싱",
    desc: "serde_json으로 JSON 파싱 + 검증. 표준 라이브러리 활용.",
    perf: "Core: ~2s, Groth16: ~45s",
    color: "#6366f1",
  },
  {
    name: "SHA256 해시",
    desc: "프리컴파일 가속. 일반 실행 대비 100배+ 빠름.",
    perf: "Core: ~1s (프리컴파일), Groth16: ~35s",
    color: "#f59e0b",
  },
  {
    name: "ECDSA 서명 검증",
    desc: "secp256k1 서명 검증. 타원곡선 프리컴파일 활용.",
    perf: "Core: ~3s, Groth16: ~50s",
    color: "#8b5cf6",
  },
  {
    name: "Tendermint LC",
    desc: "라이트 클라이언트 검증. 블록 헤더 + 서명 검증.",
    perf: "Core: ~10s, Groth16: ~120s",
    color: "#ec4899",
  },
];
...
export const fibGuestAnnotations = [
  ...
  {
    lines: [6, 6] as [number, number],
    color: "emerald" as const,
    note: "입력 읽기 (Host에서 제공)",
  },
  {
    lines: [8, 14] as [number, number],
    color: "amber" as const,
    note: "순수 Rust — 일반 피보나치",
  },
  {
