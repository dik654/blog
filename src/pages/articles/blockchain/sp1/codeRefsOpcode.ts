    ...
    annotations: [
      {
        lines: [1, 7],
        color: "sky",
        note: "SP1 고유 인코딩: R-type과 I-type을 하나의 opcode로 통합",
      },
      {
        lines: [10, 20],
        color: "emerald",
        note: "RV64IM 산술 연산. 각 opcode는 u8로 인코딩되어 AIR 칩에 매핑",
      },
      {
        lines: [22, 23],
        color: "amber",
        note: "Load/Store: 메모리 접근. LB(byte), LH(half), LW(word)",
      },
      {
        lines: [31, 32],
        color: "violet",
        note: "ECALL: 프리컴파일 진입점. SHA256, keccak 등 가속 연산 호출",
      },
      {
        lines: [34, 38],
        color: "rose",
        note: "RISC-V 64비트 확장. SP1은 RV32+RV64를 모두 지원",
      },
    ],
  },
};
