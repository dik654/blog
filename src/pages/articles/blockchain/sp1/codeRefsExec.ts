    ...
    annotations: [
      {
        lines: [3, 5],
        color: "sky",
        note: "이전 사이클에서 설정한 next값을 현재 상태로 적용",
      },
      {
        lines: [7, 10],
        color: "emerald",
        note: "다음 사이클의 기본값 설정. 분기 명령어가 next_pc를 덮어씀",
      },
      {
        lines: [12, 15],
        color: "amber",
        note: "HALT_PC에 도달하면 프로그램 정상 종료",
      },
      {
        lines: [17, 20],
        color: "violet",
        note: "세그먼트 경계 도달 시 TraceEnd 반환. 다음 shard로 분할",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [3, 8],
        color: "sky",
        note: "R-type: 두 레지스터에서 피연산자 읽기. rr()이 타임스탬프 기록",
      },
      {
        lines: [9, 13],
        color: "emerald",
        note: "I-type: 레지스터 + 즉시값. SP1은 ADD/ADDI를 동일 opcode로 통합",
      },
      {
        lines: [16, 29],
        color: "amber",
        note: "opcode별 연산 디스패치. Wrapping으로 오버플로우 안전 처리",
      },
      {
        lines: [30, 30],
        color: "violet",
        note: "결과를 rd 레지스터에 기록하며 MemoryWriteRecord 생성",
      },
    ],
  },
};
