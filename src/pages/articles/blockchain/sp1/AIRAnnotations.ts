export const addAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "AddSubCols — AIR 열 구조체",
  },
  {
    lines: [12, 19] as [number, number],
    color: "emerald" as const,
    note: "Air::eval — 덧셈 제약 평가",
  },
  {
    lines: [21, 21] as [number, number],
    color: "amber" as const,
    note: "is_add + is_sub = 1 제약",
  },
];
