...
export const SYSCALL_CATEGORIES = [
  {
    category: "시스템",
    items: ["HALT (0x00)", "WRITE (0x02)"],
    color: "#6b7280",
  },
  {
    category: "입출력",
    items: ["COMMIT (0x10)", "HINT_LEN (0x11)", "HINT_READ (0x12)"],
    color: "#6366f1",
  },
  {
    category: "SHA2",
    items: ["SHA_EXTEND (0x3026)", "SHA_COMPRESS (0x0105)"],
    color: "#10b981",
  },
  { category: "Keccak", items: ["KECCAK_PERMUTE (0x0109)"], color: "#f59e0b" },
  {
    category: "타원곡선",
    items: ["SECP256K1_ADD", "SECP256K1_DOUBLE", "ED_ADD", "ED_DECOMPRESS"],
    color: "#8b5cf6",
  },
