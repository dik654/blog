export const proofTypeAnnotations = [
  { lines: [4, 5] as [number, number], color: "sky" as const, note: "키 설정" },
  {
    ...
    note: "Core STARK — 개발/테스트용",
  },
  {
    lines: [10, 11] as [number, number],
    color: "amber" as const,
    note: "Compressed — 재귀 압축",
  },
  {
    lines: [13, 17] as [number, number],
    color: "violet" as const,
    note: "Groth16/PLONK — 온체인 검증용",
  },
];
...
export const pipelineAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "1단계: Core — 세그먼트별 STARK",
  },
  {
    lines: [10, 13] as [number, number],
    color: "emerald" as const,
    note: "2단계: Compress — STARK 압축",
  },
  {
    lines: [15, 17] as [number, number],
    color: "amber" as const,
    note: "3단계: Shrink — BN254 변환",
  },
  {
...
export const solidityAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "ISP1Verifier — 검증 인터페이스",
  },
  {
    lines: [10, 18] as [number, number],
    color: "emerald" as const,
    note: "앱 컨트랙트 — 증명 제출 + 검증",
  },
];
