...
import { CLI_CODE, cliAnnotations, WORKFLOW_STEPS } from "./CLIToolsData";
    ...
    <section id="cli-tools" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          하나의 워크플로우로 통합합니다.
          <code>sp1up</code>으로 도구체인을 설치하면 RISC-V 크로스 컴파일러와
          SDK가 함께 설정됩니다.
        </p>
        <CodePanel
          title="CLI 명령어"
      ...
      <div className="space-y-1.5 mt-4 mb-6">
        {WORKFLOW_STEPS.map((w) => (
          <div
            key={w.step}
            className="grid min-w-0 grid-cols-1 gap-1 rounded-lg border border-border/60 p-3 sm:grid-cols-[9rem_10rem_minmax(0,1fr)] sm:gap-3"
          >
            ...
            <span className="min-w-0 text-sm text-foreground/75">{w.desc}</span>
          </div>
        ))}
      </div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
