...
const STEPS = [
  ...
  {
    label: "ELF 실행",
    body: "Core Executor가 RISC-V 명령어를 실행하고 추적을 생성합니다.",
  },
  { label: "AIR 변환", body: "실행 추적을 칩별 AIR 제약 조건으로 변환합니다." },
  {
    label: "Core STARK",
    body: "Plonky3로 BabyBear 필드 위 STARK 증명을 생성합니다.",
  },
  {
    label: "재귀 압축",
    body: "여러 세그먼트 증명을 하나의 BabyBear STARK으로 압축합니다.",
  },
  {
    label: "필드 전환",
    body: "BabyBear STARK를 BN254 스칼라체 STARK으로 재증명합니다.",
  },
  {
    label: "Groth16 래핑",
    body: "~192바이트 SNARK으로 래핑해 이더리움에서 검증합니다.",
  },
];
