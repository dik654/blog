...
const STEPS = [
  {
    label: "실행",
    body: "RISC-V 명령어를 SHARD_SIZE(~400만) 사이클까지 실행합니다.",
  },
  {
    label: "샤드 분할",
    body: "bump_shard()가 ExecutionRecord를 완료하고 체크포인트를 저장합니다.",
  },
  {
    label: "병렬 트레이스",
    body: "각 체크포인트에서 Trace 모드로 재실행해 레코드를 병렬 생성합니다.",
  },
  {
    label: "병렬 증명",
    body: "rayon par_iter로 각 샤드의 STARK 증명을 동시 생성합니다.",
  },
  { label: "수집", body: "모든 ShardProof를 Vec로 수집합니다." },
  {
    label: "CoreProof",
    body: "SP1CoreProof = 전체 프로그램의 Core 증명 완성.",
  },
];
