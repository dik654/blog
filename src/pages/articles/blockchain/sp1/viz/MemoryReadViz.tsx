...
const STEPS = [
  ...
  {
    label: "정렬 검사",
    body: "주소가 4바이트 정렬인지 확인합니다. 미정렬 시 패닉.",
  },
  {
    label: "페이지 조회",
    body: "상위 비트(addr >> 14)로 PagedMemory 페이지를 찾습니다.",
  },
  {
    label: "레코드 읽기",
    body: "현재 value와 이전 shard/timestamp를 읽습니다.",
  },
  {
    label: "이벤트 기록",
    body: "MemoryReadRecord를 생성해 증명용 이벤트 로그에 추가합니다.",
  },
  {
    label: "타임스탬프 갱신",
    body: "현재 shard와 글로벌 클럭으로 타임스탬프를 업데이트합니다.",
  },
];
