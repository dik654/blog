...
const STEPS = [
  {
    label: "Runtime 설정",
    body: "Program과 SP1Stdin을 Executor에 로드합니다.",
  },
  {
    label: "Phase 1",
    body: "Checkpoint 모드로 실행, 샤드 경계마다 메모리 스냅샷 저장.",
  },
  {
    label: "Phase 2",
    body: "각 체크포인트에서 Trace 모드로 재실행, ExecutionRecord 병렬 생성.",
  },
  {
    label: "커밋",
    body: "트레이스 행렬을 Reed-Solomon 인코딩 후 Merkle 트리로 커밋.",
  },
  {
    label: "FRI 오프닝",
    body: "검증자의 랜덤 질의에 대한 다항식 평가 응답을 생성합니다.",
  },
