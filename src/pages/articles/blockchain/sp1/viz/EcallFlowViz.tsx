...
const STEPS = [
  {
    label: "Guest 호출",
    body: "Guest 코드가 sha2::digest() 같은 암호 함수를 호출합니다.",
  },
  {
    label: "ECALL 트랩",
    body: "SP1 패치된 크레이트가 ECALL 명령어를 발생시킵니다.",
  },
  {
    label: "코드 해석",
    body: "t0 레지스터에서 SyscallCode를 추출합니다 (예: SHA_EXTEND).",
  },
  {
    label: "핸들러 실행",
    body: "syscall_map에서 해당 Syscall 구현체를 찾아 execute()를 호출합니다.",
  },
  { label: "결과 반환", body: "반환값이 있으면 a0 레지스터에 저장합니다." },
  {
    label: "이벤트 기록",
    body: "SyscallEvent를 ExecutionRecord에 추가합니다.",
  },
];
