...
const EDGES = [
  { s: "sdk", t: "cli" },
  { s: "sdk", t: "executor" },
  { s: "executor", t: "machine" },
  { s: "machine", t: "prover" },
  { s: "prover", t: "recursion" },
  { s: "recursion", t: "plonky3" },
  { s: "prover", t: "groth16" },
  { s: "groth16", t: "verifier" },
];
...
const STEPS = [
  ...
  {
    label: "사용자 레이어",
    body: "SDK + CLI로 프로그램을 빌드하고 실행합니다",
  },
  {
    label: "실행 레이어",
    body: "Executor가 RISC-V를 실행하고 Machine이 AIR로 변환합니다",
  },
  {
    label: "증명 레이어",
    body: "Prover가 Plonky3 STARK 증명을 생성하고 재귀 압축합니다",
  },
  {
    label: "검증 레이어",
    body: "Groth16으로 래핑 후 이더리움 온체인에서 검증합니다",
  },
];
