...
const STEPS = [
  ...
  {
    label: "LLVM 컴파일",
    body: "rustc가 LLVM riscv32im 백엔드로 크로스 컴파일합니다.",
  },
  {
    label: "ELF 바이너리",
    body: ".text(코드)와 .rodata(상수) 섹션으로 구성된 ELF 생성.",
  },
  {
    label: "ELF 로드",
    body: "Program 구조체에 명령어와 초기 메모리를 매핑합니다.",
  },
  {
    label: "실행",
    body: "Executor가 PC=0x200000부터 명령어를 순차 실행합니다.",
  },
  {
    label: "추적 생성",
    body: "모든 사이클의 레지스터/메모리 변화를 기록합니다.",
  },
];
