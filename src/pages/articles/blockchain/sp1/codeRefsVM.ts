    ...
    annotations: [
      {
        lines: [2, 3],
        color: "sky",
        note: "32개 RISC-V 범용 레지스터 (x0-x31). 각 레지스터는 타임스탬프를 가짐",
      },
      {
        lines: [5, 10],
        color: "emerald",
        note: "VM 상태: clk(사이클 카운터), pc(명령어 포인터), exit_code",
      },
      {
        lines: [12, 13],
        color: "amber",
        note: "MinimalTrace에서 메모리 읽기를 순차적으로 가져오는 커서",
      },
      {
        lines: [19, 20],
        color: "violet",
        note: "RISC-V ELF를 파싱한 Program. Arc로 공유 참조",
      },
      {
        lines: [25, 26],
        color: "rose",
        note: "trace chunk 종료 클럭. 세그먼트 분할 기준점",
      },
    ],
  },
};
