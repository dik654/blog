    ...
    annotations: [
      {
        lines: [1, 8],
        color: "sky",
        note: "모듈 구성: build(회로), recursion(재귀), verify(검증), worker(병렬)",
      },
      {
        lines: [13, 19],
        color: "emerald",
        note: "버전 관리: core/recursion/plonk 변경 시 반드시 업데이트",
      },
      {
        lines: [21, 21],
        color: "amber",
        note: "sp1_hypercube: Plonky3 기반 증명 시스템의 핵심 라이브러리",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [2, 8],
        color: "sky",
        note: "SyscallRuntime 트레이트로 프리컴파일 핸들러 주입",
      },
      {
        lines: [12, 16],
        color: "emerald",
        note: "RISC-V ABI: a0(X10), a1(X11)에서 시스템 콜 인자 읽기",
      },
      {
        lines: [18, 22],
        color: "amber",
        note: "ENTER_UNCONSTRAINED: 증명 없이 실행. 힌트 생성에 사용",
      },
      {
        lines: [25, 28],
        color: "violet",
        note: "t0(X5)에 결과 기록. 클럭 +256으로 ecall 비용 반영",
      },
    ],
  },
};
