...
const STEPS = [
  {
    label: "CRT 문제 정의",
    body: "연립 합동식: x ≡ 2 (mod 3), x ≡ 3 (mod 5)\ngcd(3,5)=1 (서로소) → 유일한 해 존재. N = 3×5 = 15, 해 범위: 0 ≤ x < 15",
  },
  {
    label: "① 역원 계산",
    body: "N₁ = N/n₁ = 5, N₂ = N/n₂ = 3\ny₁ = N₁⁻¹ mod n₁ = 5⁻¹ mod 3 = 2, y₂ = N₂⁻¹ mod n₂ = 3⁻¹ mod 5 = 2",
  },
  {
    label: "② 부분 해 합산",
    body: "x = a₁·N₁·y₁ + a₂·N₂·y₂ = 2·5·2 + 3·3·2 = 38 mod 15 = 8\n검증: 8 mod 3 = 2 ✓, 8 mod 5 = 3 ✓",
  },
  {
    label: "③ 일반화: k개 모듈러스",
    body: "x = Σ aᵢ·Nᵢ·yᵢ (mod N). RSA: N=pq 기반 CRT 복호화 4× 가속",
  },
];
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={160} y={138} textAnchor="middle" fontSize={7} fill={DIM}>
          전체 모듈러스
        </text>
      </motion.g>
      ...
      >
        ...
        <text x={320} y={138} textAnchor="middle" fontSize={7} fill={DIM}>
          mod N 내 유일
        </text>
      </motion.g>
    </g>
        ...
        return (
          ...
          >
            ...
            <rect
              ...
              strokeWidth={0.8}
            />
            <text x={310} y={y + 18} textAnchor="middle" fontSize={8} fill={G}>
              결과
            </text>
            <text
              x={310}
...
function SumStep() {
  ...
  return (
    <g>
        ...
        return (
          ...
          >
            <rect
              ...
              strokeWidth={0.8}
            />
            <text x={x + 10} y={42} fontSize={8} fill={DIM}>
              a{i + 1}·N{i + 1}·y{i + 1} =
            </text>
            <text
              x={x + 80}
      ...
      >
        <text x={240} y={86} textAnchor="middle" fontSize={9} fill={DIM}>
          20 + 18 = 38
        </text>
        ...
        <text x={240} y={132} textAnchor="middle" fontSize={7} fill={DIM}>
          x = 8
        </text>
      </motion.g>
