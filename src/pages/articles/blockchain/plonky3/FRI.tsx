...
import FRILowDegreeViz from './viz/FRILowDegreeViz';
import PCSCompareViz from './viz/PCSCompareViz';
  ...
  return (
    <section id="fri" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="not-prose mb-6"><FRILowDegreeViz /></div>

        <h3 className="text-xl font-semibold mt-8 mb-3">FRI vs KZG</h3>
        <div className="not-prose mb-6"><PCSCompareViz /></div>
