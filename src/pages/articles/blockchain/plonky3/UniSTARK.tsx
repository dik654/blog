...
export default function UniSTARK({
  title,
  onCodeRef,
}: {
  title?: string;
  ...
  return (
    <section id="uni-stark" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>uni-stark</strong>는 Plonky3의 단변수(univariate) STARK
          프레임워크입니다.
          <br />
          AIR 제약조건을 다항식으로 변환하고 FRI 프로토콜로 효율적으로
          증명합니다.
          <br />
