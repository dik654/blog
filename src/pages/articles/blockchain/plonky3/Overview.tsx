  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>Plonky3</strong>는 Polygon Labs가 개발한 모듈형 STARK
          프레임워크로, SP1·Valida 등 여러 zkVM의 증명 백엔드로 사용됩니다.
          <br />
          필드·해시·커밋·FRI 등 각 컴포넌트가 독립 크레이트로 분리되어 유연하게
          조합할 수 있습니다.
        </p>
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() => onCodeRef("p3-babybear", codeRefs["p3-babybear"])}
            />
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("p3-stark-config", codeRefs["p3-stark-config"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              config.rs
        ...
        <CodePanel
          title="크레이트 맵"
          code={CRATE_MAP_CODE}
          annotations={crateMapAnnotations}
        />
        <CodePanel
          title="BabyBear 필드 (baby-bear/src/baby_bear.rs)"
          code={BABYBEAR_CODE}
          annotations={babyBearAnnotations}
        />
        <CodePanel
          title="StarkGenericConfig (uni-stark/src/config.rs)"
          code={CONFIG_CODE}
          annotations={configAnnotations}
        />

        <h3 className="text-xl font-semibold mt-8 mb-3">
          Plonky3 vs Plonky2 vs Halo2
        </h3>
