...
import {
  BABYBEAR_CODE,
  BABYBEAR_ANNOTATIONS,
  MERSENNE_CODE,
  MERSENNE_ANNOTATIONS,
  EXTENSION_CODE,
    ...
    <section id="field-arithmetic" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          2-adic 구조 덕분에 FFT가 효율적이고, 4차 확장으로 128비트 보안을
          달성합니다.
        </p>
        {onCodeRef && (
        ...
        <h3>BabyBear 필드</h3>
        <CodePanel
          title="BabyBear 정의 & Montgomery 곱셈"
          code={BABYBEAR_CODE}
