    ...
    annotations: [
      {
        lines: [9, 10],
        color: "sky",
        note: "BabyBear 타입 — MontyField31<BabyBearParameters>",
      },
      {
        lines: [15, 22],
        color: "emerald",
        note: "MontyParameters — 소수, Montgomery 비트, MU 상수",
      },
      {
        lines: [41, 51],
        color: "amber",
        note: "TwoAdicData — 27비트 2-adic 생성자 목록",
      },
      {
        lines: [65, 74],
        color: "violet",
        note: "BinomialExtension<4> — 4차 확장 (128비트 보안)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [42, 54],
        color: "sky",
        note: "TwoAdicFriPcs 구조체 — DFT + MMCS + FRI 파라미터",
      },
      {
        lines: [97, 130],
        color: "emerald",
        note: "fold_row — 단일 행 Lagrange 보간 + 접기",
      },
      {
        lines: [133, 161],
        color: "amber",
        note: "fold_matrix (arity=2) — 짝/홀 분해 + beta 접기",
      },
      {
        lines: [215, 229],
        color: "violet",
        note: "lagrange_interpolate_at — 무게중심 보간 공식",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [31, 39],
        color: "sky",
        note: "Poseidon2 구조체 — ExternalPerm + InternalPerm",
      },
      {
        lines: [48, 63],
        color: "emerald",
        note: "new() — 외부/내부 상수에서 레이어 생성",
      },
      {
        lines: [107, 112],
        color: "amber",
        note: "permute_mut — external → internal → external 3단계 순열",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [17, 29],
        color: "sky",
        note: "KeccakAir 구조체 + 트레이스 생성",
      },
      {
        lines: [37, 48],
        color: "emerald",
        note: "Air::eval — AirBuilder로 제약 평가",
      },
      {
        lines: [50, 59],
        color: "amber",
        note: "첫 단계: preimage == a (초기 상태 제약)",
      },
      {
        lines: [62, 71],
        color: "violet",
        note: "비최종 단계: local.preimage == next.preimage (전이 제약)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [24, 37],
        color: "sky",
        note: "StarkGenericConfig 트레이트 — Pcs + Challenge + Challenger",
      },
      { lines: [48, 55], color: "emerald", note: "StarkConfig 구체 구조체" },
      {
        lines: [67, 87],
        color: "amber",
        note: "impl StarkGenericConfig for StarkConfig — 트레이트 구현",
      },
    ],
  },
};
