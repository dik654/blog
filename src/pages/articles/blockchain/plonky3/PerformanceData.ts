export const DFT_COMPARISON = [
  {
    ...
    time: "O(N log N)",
    memory: "O(N)",
    desc: "전통 Cooley-Tukey. 중간 크기에 적합.",
  },
  {
    name: "Bowers FFT",
    time: "O(N log N)",
    memory: "O(N)",
    desc: "메모리 접근 패턴 최적화. LDE에 특히 효율적.",
  },
  {
    name: "DIT Parallel",
    time: "O(N log N / P)",
    memory: "O(2N)",
    desc: "멀티코어 최적화. 대용량 배치 처리.",
  },
  {
    name: "Circle FFT",
    time: "O(N log N)",
    memory: "O(N)",
    desc: "Mersenne31 전용. 특수 기하 구조 활용.",
  },
];
