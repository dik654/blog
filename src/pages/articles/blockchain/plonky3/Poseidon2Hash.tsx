    ...
    <section id="poseidon2-hash" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          128비트 보안을 달성하며, 부분 라운드 최적화로 Poseidon1 대비 약 30%
          빠릅니다.
        </p>

        <h3>Poseidon2 구조</h3>
        <CodePanel
          title="퍼뮤테이션 구조 & 라운드 설정"
          code={POSEIDON2_CODE}
