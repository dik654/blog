...
const STEPS = [
  ...
  {
    label: "Merkle 커밋",
    body: "Reed-Solomon 확장 후 Poseidon2 Merkle 트리에 커밋합니다.",
  },
  {
    label: "도전값 샘플링",
    body: "Fiat-Shamir 채린저가 beta 도전값을 생성합니다.",
  },
  {
    label: "FRI 접기",
    body: "f(x)와 f(-x)를 beta로 선형 결합해 차수를 절반으로 줄입니다.",
  },
  {
    label: "차수 감소",
    body: "접기를 반복해 상수 다항식에 도달할 때까지 진행합니다.",
  },
  {
    label: "쿼리 단계",
    body: "num_queries(100)개 랜덤 인덱스를 샘플링합니다.",
  },
  {
    label: "열기 증명",
    body: "각 쿼리 인덱스에 대해 Merkle 경로 증명을 생성합니다.",
  },
];
