...
const FIELDS = [
  {
    ...
    fft: "2-adic FFT (2^27)",
    color: "#10b981",
    pros: "FFT 도메인 최대 2^27. Montgomery 곱셈 최적화.",
    cons: "필드 크기가 작아 확장체 필요.",
  },
  {
    name: "Mersenne31",
    p: "p = 2^31 - 1",
    ...
    fft: "Circle FFT",
    color: "#6366f1",
    pros: "비트 마스크로 빠른 리덕션. 특수 기하 구조 활용.",
    cons: "2-adic 부분군 없음. Circle FFT 구현 복잡.",
  },
  {
    name: "Goldilocks",
    p: "p = 2^64 - 2^32 + 1",
    ...
    fft: "2-adic FFT (2^32)",
    color: "#f59e0b",
    pros: "64비트 네이티브 연산. 큰 FFT 도메인.",
    cons: "32비트 필드 대비 연산 비용 높음.",
  },
];
    ...
    <div className="rounded-xl border border-border bg-card p-5 space-y-4">
      ...
      <div className="flex gap-2 flex-wrap">
        {FIELDS.map((f, i) => (
          <motion.button
            ...
            style={{
              borderColor: active === i ? f.color : f.color + "30",
              background: active === i ? f.color + "18" : f.color + "06",
              color: f.color,
            }}
          >
            {f.name}
      ...
      <AnimatePresence mode="wait">
        {sel && (
          ...
          >
            <p className="font-mono text-xs" style={{ color: sel.color }}>
              {sel.p} ({sel.bits})
            </p>
