export const crateMapAnnotations = [
  {
  ...
  },
  {
    ...
    note: "해시 & PCS — 머클 트리 + FRI",
  },
  {
    lines: [15, 18] as [number, number],
    color: "amber" as const,
    note: "STARK — AIR 제약 + 증명기",
  },
  {
    lines: [20, 24] as [number, number],
    color: "violet" as const,
    note: "예시 AIR — 암호 해시 회로",
  },
];

export const babyBearAnnotations = [
  {
    lines: [4, 8] as [number, number],
    color: "sky" as const,
    note: "Montgomery 파라미터 설정",
  },
  {
    lines: [11, 19] as [number, number],
    color: "emerald" as const,
    note: "2-adicity 27 — FFT 최대 2^27",
  },
  {
    lines: [21, 25] as [number, number],
    color: "amber" as const,
    note: "Poseidon2 S-box 지수",
  },
];
