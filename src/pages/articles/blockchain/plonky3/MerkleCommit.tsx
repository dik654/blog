  ...
  return (
    <section id="merkle-commit" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Plonky3의 <strong>MMCS(Mixed Matrix Commitment Scheme)</strong>는 서로
          다른 높이의 행렬들을 하나의 Merkle 트리에 통합합니다.
          <br />
          Poseidon2로 리프를 해시하고, 비트 시프트 인덱싱으로 다중 높이를
          처리합니다.
        </p>

        <h3>MerkleTree 구조</h3>
        <CodePanel
          title="일반화된 Merkle 트리"
          code={MERKLE_TREE_CODE}
