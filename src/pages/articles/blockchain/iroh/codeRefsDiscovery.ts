    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "publish: 노드 주소 정보 게시",
      },
      {
        lines: [6, 12] as [number, number],
        color: "emerald" as const,
        note: "resolve: EndpointId → 주소 스트림",
      },
      {
        lines: [16, 20] as [number, number],
        color: "amber" as const,
        note: "Builder 패턴: Endpoint 생성 시 초기화",
      },
      {
        lines: [23, 26] as [number, number],
        color: "violet" as const,
        note: "ConcurrentAddressLookup: 동시 조회",
      },
    ],
  },
  "remote-map": {
    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "RemoteMap: 피어별 상태 + 가상 주소",
      },
      {
        lines: [12, 19] as [number, number],
        color: "emerald" as const,
        note: "MappedAddrs: 3종 주소 → IPv6 가상 주소 매핑",
      },
    ],
  },
};
