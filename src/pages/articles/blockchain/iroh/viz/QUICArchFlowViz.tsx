...
const LAYERS = [
  {
    y: 10,
    label: "Application",
    items: ["iroh-blobs", "iroh-gossip"],
    color: C.app,
  },
  {
    y: 60,
    label: "Endpoint",
    items: ["연결 관리", "Ed25519 TLS 1.3"],
    color: C.ep,
  },
  {
    y: 110,
    label: "QUIC (Quinn)",
    items: ["스트림 멀티플렉싱", "0-RTT"],
    color: C.quic,
  },
  {
    y: 160,
    label: "MagicSock",
    items: ["NodeMap", "DISCO Ping/Pong"],
    color: C.magic,
  },
];
...
const STEPS = [
  {
    label: "전체 연결 아키텍처",
    body: "iroh는 NodeId 기반 주소 체계로 IP 변경에 투명한 QUIC 연결을 제공합니다.",
  },
  {
    label: "Endpoint & QUIC",
    body: "Endpoint가 QUIC 세션을 관리하며, Ed25519 자체 서명 인증서로 TLS 1.3 인증합니다.",
  },
  {
    label: "MagicSock 라우팅",
    body: "QUIC에 가상 UDP 소켓을 제공하고, NodeMap으로 실제 주소를 결정합니다.",
  },
  {
    label: "듀얼 경로 전송",
    body: "UDP 직접 연결과 Relay를 동시에 시도하며, 최적 경로를 자동 선택합니다.",
  },
];
