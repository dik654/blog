  ...
  return (
    <AnimatePresence>
      ...
      {step === 1 && (
        ...
        >
          <motion.g
            initial={{ x: RELAY.x + 10 }}
            animate={{ x: NAT_B.x + 10 }}
      ...
      {step === 2 && (
        ...
        >
          ...
          <motion.g
            initial={{ x: NAT_B.x - 10 }}
            animate={{ x: NAT_A.x + 10 }}
