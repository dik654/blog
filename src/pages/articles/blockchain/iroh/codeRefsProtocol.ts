    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "on_accepting: 0-RTT 조기 처리 지점",
      },
      {
        lines: [12, 15] as [number, number],
        color: "emerald" as const,
        note: "accept: 핵심 연결 핸들러 (필수 구현)",
      },
      {
        lines: [17, 20] as [number, number],
        color: "amber" as const,
        note: "shutdown: 그레이스풀 종료",
      },
    ],
  },
  "router-accept-loop": {
    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "biased select: cancel 우선 체크",
      },
      {
        lines: [9, 17] as [number, number],
        color: "emerald" as const,
        note: "연결 수락 → child_token으로 독립 태스크 생성",
      },
      {
        lines: [21, 24] as [number, number],
        color: "amber" as const,
        note: "그레이스풀 셧다운 순서",
      },
    ],
