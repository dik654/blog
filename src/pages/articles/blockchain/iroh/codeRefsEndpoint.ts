    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "Endpoint: Arc로 감싼 cheaply-cloneable 핸들",
      },
      {
        lines: [6, 15] as [number, number],
        color: "emerald" as const,
        note: "EndpointInner: Socket + noq::Endpoint + Runtime",
      },
      {
        lines: [17, 21] as [number, number],
        color: "amber" as const,
        note: "StaticConfig: Ed25519 TLS 설정",
      },
    ],
  },
  "endpoint-connect": {
    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "connect(): EndpointAddr + ALPN으로 연결",
      },
      {
        lines: [8, 11] as [number, number],
        color: "emerald" as const,
        note: "connect_with_opts → TLS 핸드셰이크 대기",
      },
      {
        lines: [20, 24] as [number, number],
        color: "amber" as const,
        note: "내부: 주소 해석 → TLS 설정 → QUIC 연결",
      },
    ],
  },
};
