    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "Transports: IP + Relay + Custom 통합",
      },
      {
        lines: [12, 17] as [number, number],
        color: "emerald" as const,
        note: "Addr enum: 세 가지 전송 경로 타입",
      },
    ],
  },
  "poll-recv-fairness": {
    ...
    annotations: [
      ...
      },
      {
        ...
        color: "emerald" as const,
        note: "짝수: IP → Relay → Custom 순서",
      },
      {
        lines: [11, 15] as [number, number],
        color: "amber" as const,
        note: "홀수: Custom → Relay → IP (역순)",
      },
    ],
  },
  "path-selection": {
    ...
    annotations: [
      {
        ...
        color: "sky" as const,
        note: "PathSelectionData: 경로 품질 데이터",
      },
      {
        lines: [8, 11] as [number, number],
        color: "emerald" as const,
        note: "sort_key: (타입, RTT) 기준 정렬",
      },
      {
        lines: [15, 18] as [number, number],
        color: "amber" as const,
        note: "Primary(IP)가 Backup(Relay)보다 항상 우선",
      },
    ],
  },
};
