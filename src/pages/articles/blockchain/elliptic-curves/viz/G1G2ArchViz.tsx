...
const STEPS = [
  {
    label: "전체 구조",
    body: "Fp → Fp2 확장, G1/G2 타원곡선 군, Jacobian/Affine 좌표 변환, 페어링 연산.",
  },
  {
    label: "체 계층",
    body: "Fp(256-bit)가 모든 연산의 기초. Fp2 = Fp[u]/(u²+1)로 2차 확장.",
  },
  {
    label: "G1 / G2 점 연산",
    body: "G1은 Fp 위, G2는 Fp2 위. 동일한 더블링/덧셈 코드를 Jacobian 좌표로 처리.",
  },
  {
    label: "페어링 연결",
    body: "e: G1 × G2 → GT. Miller loop + Final Exponentiation.",
  },
];
