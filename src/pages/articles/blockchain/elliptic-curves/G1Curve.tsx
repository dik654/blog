  ...
  return (
    <section id="g1-curve" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          유한체(Finite Field) Fp 위에서 y² = x³ + ax + b를 만족하는 점의 집합과
          무한원점 O가 타원곡선군을 이룬다.
          <br />
          ...
          <br />
          반면 P와 Q = k·P로부터 k를 구하는 것은 어렵다 (ECDLP, 타원곡선
          이산로그 문제).
        </p>
        <p>
          Affine 좌표 (x, y)에서는 점 덧셈마다 역원(Fp::inv)이 필요하여 비용이
          크다.
          <br />
          Jacobian 좌표(사영 좌표) (X, Y, Z)는 affine (x, y) = (X/Z², Y/Z³)로
          대응된다.
          <br />
        ...
        <p>
          더블링(2P)은 곡선 위의 점 P에서 접선을 그어 곡선과 만나는 점을 x축
          대칭시킨다.
          <br />
          a=0 특화 공식으로 A=Y², B=4XA, C=8A², D=3X²를 구한 뒤 X₃=D²-2B,
          Y₃=D(B-X₃)-C, Z₃=2YZ로 계산한다. 역원 호출 0회.
        </p>
        <CodePanel
          title="점 더블링 (a=0 최적화)"
          code={doubleCode}
        ...
        />
        <p>
          덧셈(P+Q)은 두 점을 잇는 직선이 곡선과 만나는 세 번째 점을 x축
          대칭시킨다.
          <br />
          U₁=X₁Z₂², U₂=X₂Z₁², S₁=Y₁Z₂³, S₂=Y₂Z₁³, H=U₂-U₁, R=S₂-S₁로 계산하며,
          U₁==U₂일 때 S₁==S₂이면 double, 아니면 역원(-Q)이므로 identity를
          반환한다.
        </p>
        <CodePanel
          title="점 덧셈 (Jacobian)"
