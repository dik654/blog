    ...
    <section id="g1-g2-bn254" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h3 className="text-xl font-semibold mt-6 mb-3">
          G1 vs G2와 Sextic Twist
        </h3>
        <p>
          페어링(Pairing, 두 타원곡선 군의 원소를 곱셈 군으로 매핑하는 쌍선형
          함수) e(G1, G2) → GT의 구조다.
          <br />
          ...
          <br />
          sextic twist(6차 꼬임)를 사용하면 E&apos;(Fp2) 위의 점으로 표현
          가능하여 연산 비용이 극적으로 감소한다.
        </p>
        <CodePanel
          title="G2 sextic twist 구조"
          code={twistCode}
          annotations={[
        ...
        <p>
          G1 생성자는 (1, 2)로 간단하지만, G2 생성자는 254-bit Fp2 좌표로
          EIP-197에서 정의된 표준값이다.
          <br />
        ...
        <CodePanel
          ...
          annotations={[
            { lines: [2, 12], color: "sky", note: "EIP-197 표준 좌표" },
            {
              lines: [17, 19],
              color: "emerald",
              note: "G1/G2 공통 코드 — 타입만 다름",
            },
          ]}
        />

        <h3 className="text-xl font-semibold mt-6 mb-3">
          Affine/Jacobian 변환과 커브 검증
        </h3>
        <p>
          Jacobian → Affine 변환은 (X, Y, Z) → (X/Z², Y/Z³)로 역원 1회만
          필요하다.
          <br />
          Affine → Jacobian은 Z=1로 두면 무료이다. Jacobian 동치 비교는 X₁Z₂² ==
          X₂Z₁²와 Y₁Z₂³ == Y₂Z₁³로 to_affine 없이 가능하다.
          <br />
