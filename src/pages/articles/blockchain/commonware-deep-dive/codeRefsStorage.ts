    ...
    annotations: [
      {
        lines: [4, 4],
        color: "sky",
        note: "Storage — 로컬 파일시스템, 메모리, io_uring 등 여러 백엔드 가능",
      },
      {
        lines: [6, 6],
        color: "emerald",
        note: "Blob — read_at/write_at/resize/sync 메서드 제공. Clone으로 동시 접근",
      },
      {
        lines: [9, 12],
        color: "amber",
        note: "open() — (Blob, size) 반환. 버전 관리 지원 (open_versioned)",
      },
      {
        lines: [22, 26],
        color: "violet",
        note: "scan() — 파티션 내 모든 blob 이름 목록. 복구·마이그레이션에 활용",
      },
    ],
  },
};
