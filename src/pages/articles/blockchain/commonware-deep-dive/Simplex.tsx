    ...
    <section id="simplex" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <strong>Simplex(2023)</strong> 계보의 최신 합의
        </p>
        <p className="leading-7">
          4가지 핵심 혁신:
          <br />
          <strong>즉시 View 전환</strong> — Cert(k, x) 수집 즉시 view k+1로
          이동. 기존처럼 머무르며 View-change 전송 불가
          <br />
          <strong>No-Commit 증명</strong> — n-f개 View-change(k) = 해당 view에서
          결정 없었음을 증명
          <br />
          <strong>리더 대기 제거</strong> — 기존 2Δ 대기 완전 제거. 리더는 즉시
          제안
          <br />
        ...
        <p className="leading-7">
          ...
          <br />
          <code>consensus::threshold_simplex</code> — VRF + BLS 임계 서명 추가
          변형
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 not-prose mb-6">
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <ul className="text-sm space-y-0.5 text-muted-foreground mt-2">
              ...
              <li>
                Quadratic <code className="text-xs">O(n²)</code> view change
              </li>
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <ul className="text-sm space-y-0.5 text-muted-foreground mt-2">
              <li>
                Linear view change <code className="text-xs">O(n)</code>
              </li>
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            <h4 className="font-semibold text-sm mb-1">
              HotStuff-2 / Fast-HotStuff{" "}
              <span className="text-muted-foreground font-normal">(2022)</span>
            </h4>
            <ul className="text-sm space-y-0.5 text-muted-foreground mt-2">
          ...
          <div className="rounded-lg border border-border bg-card p-4 border-blue-500/30 bg-blue-500/5">
            ...
            <ul className="text-sm space-y-0.5 text-muted-foreground mt-2">
              ...
              <li>
                <code className="text-xs">O(n²)</code> messages but simpler
                proofs
              </li>
        ...
        <div className="rounded-lg border border-border bg-card p-5 not-prose mb-6">
          ...
          <div className="space-y-1 text-sm">
            <div>
              <strong className="text-foreground">Simplex</strong>{" "}
              <span className="text-muted-foreground">
                — simplicity + speed
              </span>
            </div>
            <div>
              <strong className="text-foreground">HotStuff</strong>{" "}
              <span className="text-muted-foreground">
                — scalability (linear view change)
              </span>
            </div>
            <div>
              <strong className="text-foreground">Tendermint</strong>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mb-6">
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <ol className="text-sm space-y-1 text-muted-foreground list-decimal list-inside">
              <li>
                Leader broadcasts{" "}
                <code className="text-xs">Propose(k, block)</code>
              </li>
              <li>
                Each replica: verify block, vote if valid, broadcast{" "}
                <code className="text-xs">Vote(k, block_hash)</code>
              </li>
              <li>
                On 2f+1 votes: form{" "}
                <code className="text-xs">Cert(k, block_hash)</code>
              </li>
            </ol>
          </div>
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <ol className="text-sm space-y-1 text-muted-foreground list-decimal list-inside">
              ...
              <li>
                Broadcasts{" "}
                <code className="text-xs">Finalize(k, block_hash)</code>
              </li>
        ...
        <div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-5 not-prose mb-6">
          ...
          <ul className="text-sm space-y-0.5 text-muted-foreground">
            <li>
              <code className="text-xs">Cert</code> 받으면 바로 k+1 진입
            </li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 not-prose mb-6">
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <ol className="text-sm space-y-0.5 text-muted-foreground list-decimal list-inside">
              <li>
                Timer expires without <code className="text-xs">Cert(k)</code>
              </li>
              <li>
                Broadcast <code className="text-xs">ViewChange(k)</code>
              </li>
