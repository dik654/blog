    ...
    annotations: [
      {
        lines: [3, 3],
        color: "sky",
        note: "Runner — 런타임 진입점. tokio::Runner, deterministic::Runner가 구현",
      },
      {
        lines: [8, 8],
        color: "emerald",
        note: "Context — Clock + Network + Storage + Spawner 등을 모두 제공하는 환경 타입",
      },
      {
        lines: [15, 18],
        color: "amber",
        note: "start() — FnOnce(Context) 클로저를 받아 루트 태스크 실행. 반환 시 전체 종료",
      },
    ],
  },
};
