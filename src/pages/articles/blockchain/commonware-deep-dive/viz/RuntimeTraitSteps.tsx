  ...
  return (
    <motion.g {...F}>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={100} y={68} textAnchor="middle" fontSize={10} fill={C2}>
        spawn() → Task A
      </text>
      <rect
        x={290}
        ...
        strokeWidth={0.6}
      />
      <text x={340} y={68} textAnchor="middle" fontSize={10} fill={C3}>
        clone() → ctx_b
      </text>
      <line
        x1={100}
      ...
      <rect
        ...
        strokeWidth={0.5}
      />
      <text x={100} y={101} textAnchor="middle" fontSize={10} fill="#ef4444">
