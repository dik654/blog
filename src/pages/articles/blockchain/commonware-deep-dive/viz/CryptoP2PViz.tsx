...
const STEPS = [
  {
    label: "BLS12-381: DKG → 임계 서명",
    body: "분산 키 생성(DKG) → 각 참여자가 부분 서명 → t개 조합 시 96 bytes 임계 서명 완성. 크로스체인 검증, VRF 리더 선출에 활용.",
  },
  {
    label: "서명 스킴 비교",
    body: "ed25519: 빠른 범용. bls12381: 집계·임계(O(1) 크기, 합의 핵심). secp256r1: HSM 호환(엔터프라이즈).",
  },
  {
    label: "p2p::authenticated 구조",
    body: "ECIES 암호화 → 서명 기반 피어 인증 → 멀티플렉싱. Blocker로 악의적 피어 차단, 동적 피어 관리, 파티션 복구.",
  },
];
              ...
              {[
                ...
                <g key={i}>
                  ...
                  <text
                    ...
                    fill={s.cert === "O(1)" ? C2 : "var(--foreground)"}
                  >
                    {s.cert}
                  </text>
                  <text
