  ...
  return (
    <motion.g {...F}>
      ...
      <rect
        ...
        strokeWidth={0.5}
      />
      <text x={220} y={122} textAnchor="middle" fontSize={10} fill={C3}>
        동일 시드 → sleep 순서 동일 → 완전 재현 가능
      </text>
    </motion.g>
  );
}
...
export function NetworkStorageStep() {
  ...
  return (
    <motion.g {...F}>
      ...
      {[
        { x1: 115, y1: 50, x2: 115, y2: 65 },
        { x1: 325, y1: 50, x2: 325, y2: 65 },
      ].map((l, i) => (
