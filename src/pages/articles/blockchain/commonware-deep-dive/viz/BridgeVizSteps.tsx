  ...
  return (
    <motion.g {...F}>
      ...
      <text
        ...
        fill="var(--muted-foreground)"
      >
        worker_threads: 2 | max_blocking: 512 | buffer_pool: 2MB
      </text>
    </motion.g>
  );
}
        ...
        return (
          <g key={t}>
            ...
            <rect
              ...
              strokeWidth={0.5}
            />
            <text x={x + 36} y={71} textAnchor="middle" fontSize={10} fill={C2}>
              {t}
            </text>
          </g>
        );
      })}
      <text x={220} y={98} textAnchor="middle" fontSize={7.5} fill={C3}>
        context 하나 = 전체 런타임 기능 접근
      </text>
    </motion.g>
  );
}
...
export function P2PChannelStep() {
  ...
  return (
    <motion.g {...F}>
      ...
      <text x={220} y={100} textAnchor="middle" fontSize={10} fill={C3}>
        채널별 Quota::per_second(10) + 256 in-flight
      </text>
    </motion.g>
  );
}
