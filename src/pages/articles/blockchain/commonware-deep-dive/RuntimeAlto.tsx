    ...
    <section id="runtime-alto" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <br />
          동일 시드 → 동일 실행 순서 (네트워크 파티션, 비잔틴 장애, 링크 손실
          포함)
          <br />
          디버거에서 단계별 실행 · 완전 재현 · 모든 커밋에서 자동 실행 · 90%+
          커버리지
        </p>
        <p className="leading-7">
          <strong>채택 현황</strong>: Tempo — simplex + broadcast + storage
          사용, 테스트넷 운영 중
          <br />
          Bridge 예제 — threshold_simplex + p2p + bls12381 조합 데모
          <br />
          <strong>향후 로드맵</strong>: QMDB 통합 · 추가 프리미티브 · MCP
          서버(LLM 개발자 경험)
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mb-6">
          ...
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <ol className="text-sm space-y-0.5 text-muted-foreground list-decimal list-inside">
              <li>
                Virtual time — <code className="text-xs">SimClock</code>
              </li>
        ...
        <div className="rounded-lg border border-border bg-card p-5 not-prose mb-6">
          <h4 className="font-semibold text-sm mb-3">
            시뮬레이션 예시: Byzantine consensus test
          </h4>
          <ol className="text-sm space-y-1 text-muted-foreground list-decimal list-inside mb-3">
            <li>
              1000개 시드에 대해{" "}
              <code className="text-xs">Simulator::new(seed)</code> 반복
            </li>
            <li>
              4 validators 생성, node 3을 Byzantine으로 지정 —{" "}
              <code className="text-xs">sim.mark_byzantine(3)</code>
            </li>
            <li>
              Byzantine 행동 주입 —{" "}
              <code className="text-xs">delay_messages_from(3, jitter)</code>,{" "}
              <code className="text-xs">drop_messages_from(3, 0.3)</code>
            </li>
            <li>
              가상 5분간 실행 —{" "}
              <code className="text-xs">sim.run_until(300s)</code>
            </li>
            <li>
              Safety 검증 —{" "}
              <code className="text-xs">assert_no_conflicts(committed)</code>
            </li>
          </ol>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <h5 className="font-semibold text-sm mb-1 text-green-600 dark:text-green-400">
                이점
              </h5>
              <ul className="text-sm space-y-0.5 text-muted-foreground">
            ...
            <div>
              <h5 className="font-semibold text-sm mb-1 text-muted-foreground">
                Coverage Metrics
              </h5>
              <ul className="text-sm space-y-0.5 text-muted-foreground">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 not-prose mb-6">
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <ul className="text-sm space-y-0.5 text-muted-foreground">
              ...
              <li>
                <code className="text-xs">p2p::authenticated</code>{" "}
                communication
              </li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mb-6">
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <ul className="text-sm space-y-0.5 text-muted-foreground">
              <li>
                <strong className="text-foreground">Avalanche HyperSDK</strong>{" "}
                — predecessor
              </li>
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Open source:{" "}
              <code className="text-xs">github.com/commonwarexyz/monorepo</code>{" "}
              — Rust-first
            </p>
          </div>
        </div>
