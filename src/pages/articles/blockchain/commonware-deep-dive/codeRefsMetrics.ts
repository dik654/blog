    ...
    annotations: [
      {
        lines: [2, 2],
        color: "sky",
        note: "Clone + Send + Sync — Context를 복제하면 자식 메트릭 네임스페이스 생성",
      },
      {
        lines: [8, 8],
        color: "emerald",
        note: 'with_label() — "engine" → "engine_votes_total" 형태로 prefix 자동 추가',
      },
      {
        lines: [12, 15],
        color: "amber",
        note: 'with_attribute() — {epoch="5"} 같은 동적 차원. Family 대체용',
      },
      {
        lines: [27, 28],
        color: "violet",
        note: "with_scope() — 에폭 종료 시 자동 해제. 메트릭 누적 방지",
      },
    ],
  },
};
