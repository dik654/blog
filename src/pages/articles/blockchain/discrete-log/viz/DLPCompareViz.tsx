...
const STEPS = [
  {
    label: "이산로그 문제 — 정방향 vs 역방향",
    body: "g^x ≡ y (mod p). 정방향은 쉽고 역방향은 어렵다. 이 비대칭이 암호학의 핵심이다.",
  },
  {
    label: "정방향 — 반복 제곱법 O(log x)",
    body: "이진 전개로 곱셈 횟수 = 비트 수. 256-bit여도 256번이면 충분.",
  },
  {
    label: "역방향 — 전수 탐색 O(p)",
    body: "x=1부터 하나씩 시도. 최선(BSGS)도 O(√p).",
  },
  {
    label: "큰 소수에서는 사실상 불가능",
    body: "BSGS도 O(√p). p=256-bit이면 √p≈2¹²⁸ — 사실상 불가능.",
  },
];
