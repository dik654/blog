  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          컴퓨터는 결정론적(deterministic) 기계이므로 "진짜 랜덤"을 만들 수
          없다.
          <br />
          일반 난수생성기(PRNG)는 시드를 알면 출력을 예측할 수 있어 암호학에서는
          치명적이다.
          <br />
          암호학적 난수생성기(CSPRNG)는 출력을 관찰해도 다음 값을 예측할 수
          없도록 설계된 특수한 PRNG로, 모든 암호 프로토콜의 안전성 기반이다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              첫 <code>k</code> bits를 관찰해도 <code>k+1</code>번째 bit 예측
              불가. 공격자 우위 = 1/2 + negligible.
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-red-500 bg-card p-4 mb-6">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>
              NIST 표준 (2006) &rarr; NSA backdoor 의혹 (2013) &rarr; 2014년
              폐기
            </li>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-2">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              항상 available (ChaCha20 기반). 현대는 urandom 권장 &mdash; Linux
              5.17+에서 통합됨.
            </p>
          </div>
        </div>
