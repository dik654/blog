    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          User는 부채 {coveredDebt.toLocaleString()} 상환됐지만, 담보{" "}
          {Math.round(collateralValue).toLocaleString()} 사용
        </text>
        <text
          x={260}
          y={264}
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={304} fontSize={10} fontWeight={700} fill="#8b5cf6">
          Bonus 적정선:
        </text>
