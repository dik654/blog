  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        >
          저장된 scaled 값은 변하지 않음 · 조회 시 index 곱해서 이자 포함 잔액
          계산
        </text>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={230} fontSize={11} fontWeight={700} fill="#10b981">
          누적 이자 수익:
        </text>
        <text
          x={484}
        ...
        <text x={36} y={252} fontSize={10} fill="var(--muted-foreground)">
          {initialDeposit} × (1 + {apy}%)^{years} − {initialDeposit} · 사용자
          행동 0 (자동 복리)
        </text>
