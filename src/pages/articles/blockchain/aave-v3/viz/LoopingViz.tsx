    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          E-Mode Looping — Leveraged Staking (93% LTV)
        </text>
        ...
        <rect
          ...
          strokeWidth={1.2}
        />
        <text x={36} y={320} fontSize={11} fontWeight={700} fill="#10b981">
          최종 포지션:
        </text>
        <text x={128} y={320} fontSize={11} fill="var(--foreground)">
          49 stETH 담보 + 39 ETH 부채 ={" "}
          <tspan fontWeight={700} fill="#10b981">
            4.9× 레버리지
          </tspan>
        </text>
        <text x={36} y={340} fontSize={9} fill="var(--muted-foreground)">
          수익: (staking 3.5% − borrow 2.5%) × 레버리지 = ~4.9% effective APY ·
          HF 1.06 (tight)
        </text>
      </svg>
    </div>
