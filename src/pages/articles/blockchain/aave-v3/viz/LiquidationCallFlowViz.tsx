  ...
  const steps = [
    {
      n: 1,
      label: "HF 계산",
      detail: "calculateUserAccountData()",
      color: "#3b82f6",
    },
    {
      n: 2,
      label: "HF < 1 확인",
      detail: "require healthFactor < 1e18",
      color: "#ef4444",
    },
    {
      n: 3,
      label: "최대 청산량 계산",
      detail: "userDebt × 50% (CLOSE_FACTOR)",
      color: "#f59e0b",
    },
    {
      n: 4,
      label: "담보 계산 + 보너스",
      detail: "debtValue × (1 + bonus) / collateralPrice",
      color: "#8b5cf6",
    },
    {
      n: 5,
      label: "토큰 이동",
      detail: "liquidator ↔ user 자산 교환",
      color: "#10b981",
    },
  ];
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          CLOSE_FACTOR 50% · HF ＜ 0.95면 100% 청산 (bad debt 방지)
        </text>
      </svg>
    </div>
  );
