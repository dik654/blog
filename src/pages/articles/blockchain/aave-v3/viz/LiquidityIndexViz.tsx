export default function LiquidityIndexViz() {
  ...
  const events = [
    ...
    { t: 6, index: 1.025, action: "updateState (interaction)", rate: 5 },
  ...
  const pathData = events
    .map((e, i) => `${i === 0 ? "M" : "L"} ${toX(e.t)} ${toY(e.index)}`)
    .join(" ");
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          liquidityIndex — 상호작용마다 갱신 (Linear 누적)
        </text>
        ...
        <text x={32} y={294} fontSize={10} fill="var(--muted-foreground)">
          scaledBalance
        </text>
        <text
          x={242}
        ...
        <text x={32} y={310} fontSize={10} fill="var(--muted-foreground)">
          index 저장
        </text>
        <text
          x={242}
        ...
        <text x={32} y={324} fontSize={10} fill="var(--muted-foreground)">
          실제 잔액
        </text>
        <text
          x={242}
        ...
        <text x={277} y={294} fontSize={10} fill="var(--muted-foreground)">
          scaledBalance
        </text>
        <text
          x={487}
        ...
        <text x={277} y={310} fontSize={10} fill="var(--muted-foreground)">
          new index
        </text>
        <text
          x={487}
        ...
        <text x={277} y={324} fontSize={10} fill="var(--muted-foreground)">
          실제 잔액
        </text>
        <text
          x={487}
