    ...
    <StepViz steps={BENCH_STEPS}>
      {(step) => (
        ...
        >
            ...
            return (
              <g key={b.label}>
                ...
                <motion.rect
                  ...
                  y={y + BAR_H / 2 + 1}
                  rx={3}
                  width={showGpu ? gpuW : 0}
                  animate={{ width: showGpu ? gpuW : 0 }}
                  height={BAR_H / 2 - 1}
                  fill="#10b98180"
                  transition={sp}
                />
          ...
          <text x={X0 + 16} y={151} fontSize={9} fill="var(--muted-foreground)">
            CPU (1M rows)
          </text>
          <rect
            x={X0 + 80}
            ...
            fill="#10b98180"
          />
          <text x={X0 + 96} y={151} fontSize={9} fill="var(--muted-foreground)">
            GPU (1M rows)
          </text>
        </svg>
      )}
