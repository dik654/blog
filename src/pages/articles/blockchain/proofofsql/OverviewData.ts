export const OVERVIEW_STEPS = [
  {
    label: "전체 아키텍처",
    body: "SQL 쿼리를 입력받아 영지식 증명을 생성하고 온체인에서 검증합니다.",
  },
  {
    label: "SQL 파싱",
    body: "QueryExpr::try_new()로 SQL을 파싱하여 AST(추상 구문 트리)를 생성합니다.",
  },
  {
    label: "증명 계획 & 실행",
    body: "AST를 ProofPlan으로 변환하고, 실행 엔진이 데이터를 처리합니다.",
  },
  {
    label: "증명 & 검증",
    body: "Sumcheck + Commitment으로 영지식 증명을 생성하고 검증합니다.",
  },
];
