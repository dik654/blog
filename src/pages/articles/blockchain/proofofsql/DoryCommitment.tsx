    ...
    <section id="dory-commitment" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong>암호학적 commitment</strong>을 생성하고 관리합니다.
          <br />
          데이터의 무결성을 보장하면서도 실제 데이터를 노출하지 않는 방식으로
          증명을 가능하게 합니다.
        </p>
        ...
        <ul>
          <li>
            <strong>Binding</strong> -- commitment 생성 후 데이터 변경 불가
          </li>
          <li>
            <strong>Hiding</strong> -- commitment만으로 원본 데이터 추론 불가
          </li>
          <li>
            <strong>Homomorphic</strong> -- commitment 간 연산이 원본 값 연산과
            대응
          </li>
        </ul>
        <CodePanel
          title="CommittableColumn & CommitmentScheme"
          code={COMMIT_CODE}
