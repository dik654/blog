...
import QueryProofViz from './viz/QueryProofViz';
  ...
  return (
    <section id="query-proof" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        <h3 className="text-xl font-semibold mt-6 mb-3">SQL → 다항식 변환 상세</h3>        <div className="not-prose mb-4"><QueryProofViz /></div>
      </div>
    </section>
  );
}
