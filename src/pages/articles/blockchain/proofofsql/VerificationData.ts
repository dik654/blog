export const VERIFY_STEPS = [
  {
    label: "검증 개요",
    body: "검증자는 증명자와 동일한 transcript를 재구성하여 증명의 유효성을 확인합니다.",
  },
  {
    label: "Transcript 재구성",
    body: "Keccak256으로 동일한 해시 체인을 구축, Fiat-Shamir 챌린지를 재생성합니다.",
  },
  {
    label: "Sumcheck 검증",
    body: "다항식의 평가값이 기대값과 일치하는지 확인합니다.",
  },
  {
    label: "EVM 온체인 검증",
    body: "Solidity Verifier.sol이 ~500,000 가스로 증명을 온체인 검증합니다.",
  },
];
