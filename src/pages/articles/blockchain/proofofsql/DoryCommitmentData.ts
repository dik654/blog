export const DORY_STEPS = [
  {
    label: "Commitment 개요",
    body: "데이터를 고정 크기 암호학적 값으로 압축. Binding, Hiding, Homomorphic 특성.",
  },
  {
    label: "CommittableColumn",
    body: "다양한 SQL 데이터 타입(bool, int, varchar 등)을 스칼라 필드로 변환합니다.",
  },
  {
    label: "HyperKZG 스킴",
    body: "KZG 기반 다항식 commitment. BN254 곡선 위에서 pairing 연산을 사용합니다.",
  },
  {
    label: "DORY 스킴",
    body: "내적 증명(Inner Product Argument) 기반. 투명 셋업으로 신뢰 문제를 완화합니다.",
  },
];
...
export const COMMIT_ANNOTATIONS = [
  ...
  },
  {
    ...
    note: "Commitment 스킴 추상화",
  },
  {
    lines: [14, 18] as [number, number],
    color: "amber" as const,
    note: "commit / prove / verify 인터페이스",
  },
];
