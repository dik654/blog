...
import ProofofSqlOverviewViz from './viz/ProofofSqlOverviewViz';
  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        <h3 className="text-xl font-semibold mt-6 mb-3">Proof of SQL 시스템 개요</h3>        <div className="not-prose mb-4"><ProofofSqlOverviewViz /></div>
      </div>
    </section>
  );
}
