  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>Proof of SQL</strong>은 영지식 증명과 SQL 처리를 통합한
          시스템입니다.
          <br />
          SQL 쿼리의 실행 결과가 올바른지를{" "}
          <strong>원본 데이터를 노출하지 않고</strong> 증명할 수 있습니다.
          <br />
        ...
        <ul>
          <li>
            <strong>SQL-to-Polynomial</strong> -- SQL 연산을 다항식으로 자동
            변환
          </li>
          <li>
            <strong>로그 크기 증명</strong> -- 데이터 크기에 O(log m) 비례하는
            증명
          </li>
          <li>
            <strong>다층 보안</strong> -- 수학적 가정부터 프로토콜까지 전방위
            보안
          </li>
          <li>
            <strong>GPU 가속</strong> -- Blitzar 라이브러리로 commitment 병렬
            처리
          </li>
        </ul>
        <h3>데이터 플로우</h3>
