export const BENCH_STEPS = [
  {
    label: "벤치마크 개요",
    body: "Hello World 예제(4행x2컬럼)부터 대규모(1M행x10컬럼)까지 성능을 측정합니다.",
  },
  {
    label: "소규모 데이터",
    body: "4행x2컬럼: 파싱 ~1ms, Commitment ~10ms, 증명 ~50ms, 검증 ~5ms (총 ~66ms).",
  },
  {
    label: "GPU 가속",
    body: "1M행x10컬럼 GPU: Commitment ~100ms, 증명 ~500ms, 검증 ~10ms.",
  },
  {
    label: "CPU vs GPU",
    body: "CPU 전용 시 Commitment ~2s, 증명 ~5s. GPU 가속으로 10-20배 성능 향상.",
  },
];
