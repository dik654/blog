export const PROOF_STEPS = [
  {
    label: "데이터 준비",
    body: "쿼리 참조 테이블들의 행 범위를 계산하고 필요한 컬럼만 메모리에 로드합니다.",
  },
  {
    label: "첫 번째 라운드",
    body: "FirstRoundBuilder로 쿼리를 실행하고 중간 MLE들에 대한 commitment을 생성합니다.",
  },
  {
    label: "Transcript 구성",
    body: "Keccak256 해시 체인으로 Fiat-Shamir 변환용 transcript를 구축합니다.",
  },
  {
    label: "Sumcheck 증명",
    body: "다항식의 합이 기대값과 일치하는지 증명하는 핵심 단계입니다.",
  },
  {
    label: "Inner Product 증명",
    body: "MLE 평가값들의 내적을 증명하여 commitment 일관성을 확인합니다.",
  },
];

export const PROOF_ACTORS = [
  "사용자",
  "SQL 파서",
  "증명 계획기",
  "실행 엔진",
