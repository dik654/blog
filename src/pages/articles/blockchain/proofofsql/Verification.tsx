  ...
  return (
    <section id="verification" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          검증자는 증명자와 <strong>정확히 동일한 순서</strong>로 transcript를
          재구성합니다.
          <br />
        ...
        <ol>
          <li>
            <strong>초기화 & 유효성 검사</strong> -- 비트 분포, 범위 길이 등
            기본 검사
          </li>
          <li>
            <strong>Transcript 재구성</strong> -- 동일한 Keccak256 해시 체인
            구축
          </li>
          <li>
            <strong>Commitment 검증</strong> -- 미리 계산된 commitment과 비교
          </li>
          <li>
            <strong>Sumcheck 검증</strong> -- 다항식 합 일치 확인
          </li>
          <li>
            <strong>MLE 평가 검증</strong> -- 결과 MLE과 검증자 평가 비교
          </li>
          <li>
            <strong>Inner Product 검증</strong> -- commitment과 실제 값의 일관성
          </li>
        </ol>
        <h3>EVM 가스 비용</h3>
