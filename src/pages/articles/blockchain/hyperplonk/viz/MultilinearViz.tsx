...
function UniVsMulti() {
  ...
  return (
    <g>
      ...
      <text x={115} y={155} textAnchor="middle" fontSize={8} fill={C.dim}>
        x
      </text>
      <text x={12} y={80} textAnchor="middle" fontSize={8} fill={C.dim}>
        f
      </text>
      {/* curve */}
      <motion.polyline
...
function HypercubeStep() {
  ...
  return (
    <g>
      ...
      >
        <text x={380} y={38} fontSize={9} fontWeight={600} fill={C.dim}>
          인덱싱
        </text>
        {TRUTH.map((t, i) => (
          <g key={i}>
            ...
            <text x={400} y={58 + i * 22} fontSize={9} fill={C.dim}>
              →
            </text>
            <text
              x={420}
