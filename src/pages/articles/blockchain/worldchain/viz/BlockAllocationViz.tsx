...
const STEPS = [
  {
    label: "블록 가스 한도",
    body: "총 블록 가스 한도 30,000,000 가스. PBH 비율에 따라 영역을 분할합니다.",
  },
  {
    label: "PBH 영역 (40%)",
    body: "12,000,000 가스가 검증된 인간 사용자 트랜잭션을 위해 예약됩니다.",
  },
  {
    label: "일반 영역 (60%)",
    body: "18,000,000 가스는 일반 트랜잭션(봇 포함)이 가스비 순으로 채웁니다.",
  },
  {
    label: "동적 할당",
    body: "PBH 트랜잭션이 부족하면 남은 공간을 일반 트랜잭션으로 채웁니다.",
  },
];
...
const BAR_W = 260,
  ...
  SX = 40,
  SY = 30;
const PBH_W = BAR_W * 0.4,
  REG_W = BAR_W * 0.6;

export default function BlockAllocationViz({
  onOpenCode,
}: {
