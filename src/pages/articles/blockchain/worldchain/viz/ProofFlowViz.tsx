...
const STEPS = [
  {
    label: "신원 생성",
    body: "사용자의 비밀 키로 Identity와 Commitment을 생성합니다.",
  },
  {
    label: "Merkle Tree 등록",
    body: "Poseidon Merkle Tree(깊이 30)에 커밋먼트를 등록하고 포함 증명을 생성합니다.",
  },
  {
    label: "Semaphore 증명",
    body: "신원, Merkle 포함 증명, external nullifier, 트랜잭션 해시로 ZK 증명을 생성합니다.",
  },
  {
    label: "Nullifier Hash",
    body: "nullifier_hash로 동일 증명의 중복 사용을 방지합니다.",
  },
  {
    label: "PBH 트랜잭션",
    body: "PBHPayload를 포함한 트랜잭션을 World Chain에 제출합니다.",
  },
];
