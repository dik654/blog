...
const STEPS = [
  {
    label: "FCU 요청",
    body: "rollup-boost가 engine_forkChoiceUpdatedV3를 호출하여 새 블록 빌드를 요청합니다.",
  },
  {
    label: "트랜잭션 조회",
    body: "Builder가 트랜잭션 풀에서 최적의 트랜잭션 목록을 조회합니다.",
  },
  {
    label: "PBH 검증",
    body: "PBH Validator가 Semaphore ZK 증명과 World ID 루트를 검증합니다.",
  },
  {
    label: "검증 결과",
    body: "검증된 PBH 트랜잭션 목록과 일반 트랜잭션을 분류합니다.",
  },
  {
    label: "Payload 반환",
    body: "PBH 트랜잭션을 우선 배치한 ExecutionPayload를 rollup-boost에 반환합니다.",
  },
];
...
export default function BuilderFlowViz({
  onOpenCode,
}: {
