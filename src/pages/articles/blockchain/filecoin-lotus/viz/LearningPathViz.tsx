...
const STEPS = [
  {
    label: "1단계: 합의",
    body: "Expected Consensus — VRF 선출, Tipset, 체인 가중치\nF3 — GossiPBFT로 수 분 내 확정",
  },
  {
    label: "2단계: 저장 증명",
    body: "PoRep — SDR 인코딩 → Merkle Tree → Groth16\nPoSt — WindowPoSt(24h) + WinningPoSt(블록 생성)",
  },
  {
    label: "3단계: GPU 가속",
    body: "bellperson — MSM/NTT CUDA 가속\nsppark, Neptune, SupraSeal 최적화",
  },
  {
    label: "4단계: 네트워크 인프라",
    body: "IPFS — CID, Bitswap, DHT\nFVM — WASM Actor, FEVM\nIPC — 서브넷 확장",
  },
  {
    label: "5단계: Lotus 코드 심층",
    body: "ChainSync, 마이닝, 스토리지 딜, 메시지 풀\n→ Go 소스 코드 수준 분석",
  },
];
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  cy={16}
                  r={10}
                  fill={active ? p.color : `${p.color}30`}
                />
                <text
                  x={x + 10}
                  y={20}
