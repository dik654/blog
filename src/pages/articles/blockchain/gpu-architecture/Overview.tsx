    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          <br />
          CPU가 복잡한 분기·제어에 최적화된 반면, GPU는 동일 연산을 수천
          데이터에 동시 적용하는 데 특화되어 있습니다.
          <br />
          <strong>SIMT(Single Instruction, Multiple Threads)</strong> 모델로
          32개 스레드가 하나의 워프(Warp)를 구성합니다.
        </p>
        ...
        >
          <p className="italic">
            "The SIMT architecture is akin to SIMD — a single instruction
            controls multiple processing elements — but applies it to
            independent threads rather than data lanes."
          </p>
        </CitationBlock>
      </div>
