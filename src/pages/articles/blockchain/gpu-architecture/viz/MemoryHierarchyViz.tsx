...
const STEPS = [
  {
    label: "레지스터: 스레드 전용 초고속 저장소",
    body: "스레드 전용 255개 32-bit 레지스터. 중간 산술 결과를 저장합니다.",
  },
  {
    label: "공유 메모리: 블록 내 스레드 간 데이터 공유",
    body: "블록 내 공유. 48~96KB. __shared__ 키워드로 선언. 코어레싱 불필요.",
  },
  {
    label: "L1/L2 캐시: SM 내 자동 캐싱 계층",
    body: "SM당 ~128KB L1 + ~40MB L2. 하드웨어가 자동 관리합니다.",
  },
  {
    label: "글로벌 메모리: 대용량 HBM, 가장 느린 계층",
    body: "GDDR6/HBM2. 8~80GB. 대역폭이 높지만 지연이 크므로 액세스 병합 필수.",
  },
];
const CX = 180;
