    ...
    <section id="memory-hierarchy" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          <br />
          레지스터에서 글로벌 메모리까지 <strong>
            지연 시간이 ~400배
          </strong>{" "}
          차이나며, 공유 메모리와 캐시를 적극 활용하는 것이 최적화의
          출발점입니다.
        </p>

        <CitationBlock
          source="CUDA Best Practices Guide — Memory Optimizations"
          citeKey={2}
          type="paper"
          href="https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/"
        >
          <p className="italic">
            "Effective use of the various memory spaces is one of the key
            methods for extracting the best performance from GPU hardware."
          </p>
        </CitationBlock>
