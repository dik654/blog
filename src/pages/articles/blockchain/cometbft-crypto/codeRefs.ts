  ...
  "ed25519-sign": {
    ...
    annotations: [
      { lines: [27, 29], color: "sky", note: "privKey 길이 64B 아니면 panic" },
      {
        lines: [30, 30],
        color: "emerald",
        note: "ed25519.Sign(): 내부에서 2회 해시 (RFC 8032)",
      },
    ],
  },
  "ed25519-verify": {
    ...
    annotations: [
      { lines: [55, 56], color: "sky", note: "sig 길이 != 64이면 즉시 false" },
      {
        lines: [58, 58],
        color: "emerald",
        note: "ed25519.Verify(pubKey, msg, sig)",
      },
    ],
  },
  "ed25519-addr": {
    ...
    annotations: [
      { lines: [46, 48], color: "sky", note: "pubKey 32B 검증" },
      {
        lines: [49, 49],
        color: "amber",
        note: "tmhash.SumTruncated: SHA256의 첫 20바이트",
      },
    ],
  },
  "merkle-hash": {
    path: "crypto/merkle/proof.go",
    code: proofGo,
    lang: "go",
    highlight: [76, 88],
    ...
    annotations: [
      ...
      { lines: [80, 81], color: "emerald", note: "1개: leafHash(0x00 ∥ item)" },
      {
        lines: [83, 86],
        color: "amber",
        note: "getSplitPoint로 분할 → 재귀 → innerHash",
      },
    ],
  },
  "merkle-verify": {
    ...
    annotations: [
      { lines: [30, 33], color: "sky", note: "leafHash 계산 → 입력값과 비교" },
      {
        lines: [35, 38],
        color: "emerald",
        note: "computeRootHash → rootHash와 비교",
      },
    ],
  },
  "merkle-leaf-inner": {
    ...
    annotations: [
      { lines: [91, 94], color: "sky", note: "leafHash: 0x00 ∥ leaf → SHA256" },
      {
        lines: [97, 102],
        color: "amber",
        note: "innerHash: 0x01 ∥ left ∥ right → SHA256",
      },
    ],
  },
  "tmhash-sum": {
    path: "crypto/tmhash/tmhash.go",
    code: tmhashGo,
    lang: "go",
    highlight: [14, 23],
    ...
    annotations: [
      {
        lines: [14, 17],
        color: "sky",
        note: "Sum(): SHA256 전체 32바이트 반환",
      },
      {
        lines: [21, 23],
        color: "amber",
        note: "SumTruncated(): SHA256[:20] — 주소용",
      },
    ],
  },
};
