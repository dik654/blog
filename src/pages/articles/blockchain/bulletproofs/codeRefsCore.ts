    ...
    annotations: [
      {
        lines: [30, 35],
        color: "sky",
        note: "PedersenGens — B(값 기저점), B_blinding(블라인딩 기저점)",
      },
      {
        lines: [39, 41],
        color: "emerald",
        note: "commit() — multiscalar_mul(&[value, blinding], &[B, B_blinding])",
      },
      {
        lines: [44, 52],
        color: "amber",
        note: "Default — Ristretto 베이스포인트 + SHA3-512 hash-to-group",
      },
    ],
    ...
    annotations: [
      {
        lines: [58, 60],
        color: "sky",
        note: "GeneratorsChain — SHAKE256 XOF 리더",
      },
      {
        lines: [62, 72],
        color: "emerald",
        note: 'new() — "GeneratorsChain" || label → SHAKE256 XOF',
      },
      {
        lines: [76, 80],
        color: "amber",
        note: "fast_forward — n번 건너뛰기 (파티별 오프셋)",
      },
    ],
    ...
    annotations: [
      {
        lines: [19, 21],
        color: "sky",
        note: "L_vec, R_vec — log2(n)개 압축 포인트",
      },
      {
        lines: [22, 23],
        color: "emerald",
        note: "a, b — 최종 스칼라 (재귀 종료)",
      },
    ],
    ...
    annotations: [
      {
        lines: [38, 47],
        color: "sky",
        note: "create 시그니처 — transcript, Q, G/H factors, G/H/a/b 벡터",
      },
      {
        lines: [77, 85],
        color: "emerald",
        note: "첫 라운드 벡터 분할 + 교차 내적 c_L, c_R",
      },
      {
        lines: [87, 99],
        color: "amber",
        note: "L 점 계산 — a_L*G_R + b_R*H_L + c_L*Q",
      },
      {
        lines: [121, 135],
        color: "violet",
        note: "접기(folding) — a = a_L*u + a_R*u_inv",
      },
      {
        lines: [187, 192],
        color: "rose",
        note: "최종 반환 — L_vec, R_vec, a[0], b[0]",
      },
    ],
