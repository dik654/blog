  ...
  return (
    <section id="range-proof" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          범위 증명 — 비밀 값 v가 [0, 2^n) 범위에 있음을 증명
          <br />
          v의 n비트 분해에 내적 인수 증명 적용
          <br />
          m개 값 동시 증명하는 <strong>집계(aggregation)</strong>로 크기 절약
          가능
        </p>
        {_onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                _onCodeRef("range-proof-struct", codeRefs["range-proof-struct"])
              }
            />
            ...
            <CodeViewButton
              onClick={() => _onCodeRef("dealer", codeRefs["dealer"])}
            />
            <span className="text-[10px] text-muted-foreground self-center">
              dealer.rs
            </span>
