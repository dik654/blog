...
import RangeProofConstructionViz from './viz/RangeProofConstructionViz';
  ...
  return (
    <section id="range-proof" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        <h3 className="text-xl font-semibold mt-6 mb-3">Range Proof 수학적 구성</h3>        <div className="not-prose mb-4"><RangeProofConstructionViz /></div>
      </div>
    </section>
  );
}
