  ...
  return (
    <section id="inner-product" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Bulletproofs 핵심 — <strong>Inner Product Argument</strong>
          <br />
          벡터 a, b에 대해 ⟨a, b⟩ = c를 O(log n) 크기 증명으로 입증
          <br />매 라운드 절반씩 접어 재귀적으로 크기 축소
        </p>
        {_onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() => _onCodeRef("ipa-create", codeRefs["ipa-create"])}
            />
            <span className="text-[10px] text-muted-foreground self-center">
              IPA create
            </span>
            <CodeViewButton
              onClick={() => _onCodeRef("ipa-struct", codeRefs["ipa-struct"])}
            />
            <span className="text-[10px] text-muted-foreground self-center">
              struct
            </span>
