  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>Bulletproofs</strong>(Bünz et al., 2017) — 투명 셋업(trusted
          setup 불필요) 영지식 증명 시스템
          <br />
          핵심 — <strong>내적 인수 증명(Inner Product Argument, IPA)</strong>
          <br />
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("pedersen-gens", codeRefs["pedersen-gens"])
              }
            />
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("generators-chain", codeRefs["generators-chain"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              GeneratorsChain
