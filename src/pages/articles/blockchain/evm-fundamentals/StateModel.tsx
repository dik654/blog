    ...
    <section id="state-model" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          이더리움은 어카운트 기반(account-based) 상태 모델 — UTXO와 달리 각
          주소가 잔액과 스토리지를 직접 보유
          <br />
          전체 상태는{" "}
          <a
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose mb-4">
          <div className="bg-muted rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              EOA: tx 카운트 / Contract: CREATE 카운트
            </p>
          </div>
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">storageRoot</code>{" "}
              <span className="text-muted-foreground font-normal">
                (bytes32)
              </span>
            </p>
            <p className="text-sm text-muted-foreground">
              Storage trie의 Merkle root
            </p>
          </div>
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          ...
          = empty trie root,{" "}
          <code className="text-xs bg-muted px-1 py-0.5 rounded">codeHash</code>{" "}
          = keccak256("") &mdash; Contract:{" "}
          <code className="text-xs bg-muted px-1 py-0.5 rounded">
            storageRoot
          </code>{" "}
          = trie root,{" "}
