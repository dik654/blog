    ...
    <section id="execution-flow" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          msg.To == nil이면 컨트랙트 생성(Create) — init code를 실행하여 결과를
          배포
          <br />
          msg.To != nil이면 일반 호출(Call) — 대상 주소의 코드를 인터프리터
          루프로 실행
        </p>

        <h3 className="text-xl font-semibold mt-8 mb-3">
          Transaction Execution 5단계
        </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                Balance check:{" "}
                <code className="text-xs">&gt;= gas*gasPrice + value</code>
              </li>
              <li>
                Intrinsic gas: <code className="text-xs">21000</code> base +
                calldata cost
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">to == nil</code> →{" "}
                <code className="text-xs">Create(contract)</code>
              </li>
              <li>
                <code className="text-xs">to != nil</code> →{" "}
                <code className="text-xs">Call(recipient, value, data)</code>
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                <code className="text-xs">
                  miner.balance += used_gas * gasPrice
                </code>{" "}
                (coinbase)
              </li>
            </ul>
          ...
          <div className="rounded-lg border bg-card p-4 sm:col-span-2">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                Create receipt (logs, status, gas used) + Update state root
              </li>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                Intrinsic: <code className="text-xs">21000</code> (base)
              </li>
              <li>
                Per zero byte: <code className="text-xs">4</code> / Non-zero:{" "}
                <code className="text-xs">16</code>
              </li>
              <li>
                Create: <code className="text-xs">+32000</code>
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                Simple transfer: <code className="text-xs">21,000</code>
              </li>
              <li>
                ERC20 transfer: <code className="text-xs">~50,000</code>
              </li>
              <li>
                Uniswap swap: <code className="text-xs">~150,000</code>
              </li>
              <li>
                Complex DeFi: <code className="text-xs">500,000+</code>
              </li>
            </ul>
          </div>
        </div>
