        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">sender</code>: 생성자 주소
              </li>
              <li>
                <code className="text-xs">nonce</code>: sender의 현재 nonce
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">salt</code>: 32-byte 선택값
              </li>
              <li>
                <code className="text-xs">init_code</code>: 배포할 코드
              </li>
          ...
          <div className="rounded-lg border bg-card p-4 sm:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm text-muted-foreground">
              <p>
                <strong>State channels</strong> — 배포 전 주소 알 수 있음
              </p>
              <p>
                <strong>Factory patterns</strong> — deterministic addresses
              </p>
              <p>
                <strong>Meta-transactions</strong> — pre-fund 가능
              </p>
              <p>
                <strong>Upgrade</strong> — 같은 주소 재사용 (
                <code className="text-xs">CREATE2 + SELFDESTRUCT</code>)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              <code className="text-xs">
                {"{ to: nil, data: init_code + constructor_args }"}
              </code>
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                <code className="text-xs">RETURN</code>으로 runtime code 반환
              </li>
            </ul>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">RETURN</code> bytes = deployed code
              </li>
              <li>
                <code className="text-xs">address.code = runtime_code</code>
              </li>
              <li>
                <code className="text-xs">
          ...
          <div className="rounded-lg border bg-card p-4 sm:col-span-2">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                Constructor 로직 → <code className="text-xs">CODECOPY</code>{" "}
                (runtime code를 메모리에 복사) →{" "}
                <code className="text-xs">RETURN</code>
              </p>
              <p className="text-xs mt-2">
                Init code는 실행 후 discard / Runtime code만 chain에 영구 저장
              </p>
            </div>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                CREATE base: <code className="text-xs">32,000</code>
              </li>
              <li>
                Code deposit: <code className="text-xs">200</code> gas/byte
              </li>
