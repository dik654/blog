    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <br />
          모든 노드가 동일한 EVM 실행으로 같은 상태에 도달 — 결정론적 실행이
          필수
        </p>
      </div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="leading-7">
          레지스터 대신 최대 깊이 1024의 스택 사용 — 각 원소는 256비트(32바이트)
          워드
        </p>
      </div>
      <div className="not-prose mb-8">
        <EVMStackViz onOpenCode={open} />
      </div>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose mb-6">
          <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              단순 해석, 간결한 bytecode &mdash; 검증 단순성 우선
            </p>
          </div>
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">Register-based</p>
            <p className="text-sm text-muted-foreground">
              더 효율적 execution, but 구조 복잡
            </p>
          </div>
        </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            <strong>단순성</strong>: 140개 opcode, 간단한 execution model
            <br />
            <strong>결정론성</strong>: 모든 노드가 동일 결과 도달
            <br />
            <strong>Sandbox</strong>: 외부 의존성 차단 → 검증 용이
            <br />
            <strong>Gas system</strong>: DoS 방지 + economic security
          </p>
          <p className="mt-2">
            <strong>단점</strong>:<br />
            ✗ 256-bit 연산 (over-specified)
            <br />
            ✗ Stack 깊이 제한 (1024)
            <br />
            ✗ Storage cost 비쌈
            <br />✗ No native floating point
          </p>
        </div>
      </div>
    </section>
