    ...
    <section id="call-flow" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-4">
        <p className="leading-7">
          ...
          <br />각 호출마다 ScopeContext(Memory, Stack)와 Contract를 새로 생성
        </p>
        <div className="not-prose flex flex-wrap gap-2 mb-4">
          <CodeViewButton
            onClick={() => onCodeRef("evm-struct", codeRefs["evm-struct"])}
          />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-4 mt-8">
        ...
        <p className="leading-7">
          깊이 검증(1024) → 잔액 확인 → 스냅샷 → 값 전송 → 코드 실행 → 에러 시
          롤백
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                Max call depth = <code className="text-xs">1024</code>
              </li>
              <li>
                Gas 63/64 rule: 호출 시 남은 gas의{" "}
                <code className="text-xs">1/64</code>는 caller에 유지
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                depth 0: <code className="text-xs">2,000,000</code> gas
              </li>
              <li>
                depth 1:{" "}
                <code className="text-xs">2,000,000 * 63/64 = 1,968,750</code>
              </li>
              <li>
                depth 2: <code className="text-xs">1,937,988</code>
              </li>
              <li>
                depth 1024: <code className="text-xs">~0</code> (거의 exhaust)
              </li>
            </ul>
          </div>
          <div className="rounded-lg border bg-card p-4">
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4 sm:col-span-3">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                <code className="text-xs">snapshot = stateDB.Snapshot()</code> →
                실행 시도
              </p>
              <p>
                <strong>REVERT</strong>: state 복구, gas는 소비됨 →{" "}
                <code className="text-xs">RevertToSnapshot(snapshot)</code> →{" "}
                <code className="text-xs">return (result, remaining_gas)</code>
              </p>
              <p>
                <strong>OutOfGas</strong>: state 전체 rollback + gas 전부 소진 →{" "}
                <code className="text-xs">RevertToSnapshot(snapshot)</code> →{" "}
                <code className="text-xs">return (ERROR, 0)</code>
              </p>
            </div>
          </div>
          <div className="rounded-lg border bg-card p-4">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                Snapshot 생성: <code className="text-xs">O(1)</code>
              </li>
              <li>
                Revert: <code className="text-xs">O(변경 수)</code>
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li>
                <code className="text-xs">SSTORE</code> 되돌리기
              </li>
              <li>Balance 복구</li>
              <li>Log 취소</li>
              <li>Refund 재계산</li>
