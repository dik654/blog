    ...
    <section id="interpreter-loop" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          ...
          <br />매 사이클:{" "}
          <strong>Fetch → Decode → Gas → Execute → pc++</strong>
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 not-prose mb-6">
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">memory</code>
            </p>
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">gas_remaining</code>
            </p>
        ...
        <div className="grid grid-cols-1 gap-3 not-prose mb-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-400 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              <code className="text-xs bg-background/50 px-1 py-0.5 rounded">
                calculate_gas(opcode, &amp;stack, &amp;memory)
              </code>{" "}
              &mdash; 부족하면{" "}
              <code className="text-xs bg-background/50 px-1 py-0.5 rounded">
                OutOfGas
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-400 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              opcode별 분기 실행 &mdash; 140+ opcodes
            </p>
          </div>
          <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-400 rounded-r-lg p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose mb-6">
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">ADD</code> (0x01)
            </p>
            <p className="text-sm text-muted-foreground">
              <code className="text-xs bg-background/50 px-1 py-0.5 rounded">
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">POP</code> (0x50)
            </p>
            <p className="text-sm text-muted-foreground">
              <code className="text-xs bg-background/50 px-1 py-0.5 rounded">
                stack.pop()
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">JUMP</code> (0x56)
            </p>
            <p className="text-sm text-muted-foreground">
              dest pop &rarr;{" "}
              <code className="text-xs bg-background/50 px-1 py-0.5 rounded">
