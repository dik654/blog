    ...
    <section id="opcodes" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          ...
          <span className="text-xs text-muted-foreground">
            각 구성요소를 클릭하면 geth 소스 코드를 볼 수 있습니다
          </span>
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          <br />
          스토리지(SLOAD/SSTORE) — StateDB 접근, cold 2100 / warm 100 gas
          (EIP-2929)
        </p>
        <div className="not-prose flex flex-wrap gap-2 mb-4">
          <CodeViewButton
            onClick={() => onCodeRef("op-add", codeRefs["op-add"])}
          />
          <span className="text-[10px] text-muted-foreground self-center">
            opAdd() 산술
          </span>
          <CodeViewButton
            onClick={() => onCodeRef("op-sload", codeRefs["op-sload"])}
          />
          <span className="text-[10px] text-muted-foreground self-center">
            opSload/Sstore 저장소
          </span>
            ...
            <tbody>
              <tr>
                <td className="border border-border px-3 py-2">
                  <code className="text-xs">SLOAD</code>
                </td>
                <td className="border border-border px-3 py-2">800</td>
              ...
              <tr>
                ...
                <td className="border border-border px-3 py-2">700</td>
                <td className="border border-border px-3 py-2 font-semibold">
                  2600
                </td>
                <td className="border border-border px-3 py-2">100</td>
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code className="text-xs">EXTCODESIZE</code> /{" "}
                  <code className="text-xs">EXTCODECOPY</code> /{" "}
                  <code className="text-xs">EXTCODEHASH</code>
                </td>
                <td className="border border-border px-3 py-2">700</td>
                <td className="border border-border px-3 py-2 font-semibold">
                  2600
              ...
              <tr>
                <td className="border border-border px-3 py-2">
                  <code className="text-xs">CALL</code> family
                </td>
                <td className="border border-border px-3 py-2">700</td>
                <td className="border border-border px-3 py-2 font-semibold">
                  base + cold
                </td>
                <td className="border border-border px-3 py-2">base + warm</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
        ...
        <p className="text-sm text-muted-foreground mb-3">
          배경: 2016 DoS 공격 &mdash; 1 tx에 수천{" "}
          <code className="text-xs bg-muted px-1 py-0.5 rounded">SLOAD</code>{" "}
          호출로 체인 정지
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 not-prose mb-4">
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">accounts</code>
            </p>
            <p className="text-sm text-muted-foreground">
              Set&lt;Address&gt; &mdash; 접근한 어카운트 집합
            </p>
          </div>
          <div className="bg-muted rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              <code className="text-xs">storageKeys</code>
            </p>
            <p className="text-sm text-muted-foreground">
              Set&lt;(Address, StorageKey)&gt; &mdash; 접근한 슬롯 집합
            </p>
          </div>
        </div>
