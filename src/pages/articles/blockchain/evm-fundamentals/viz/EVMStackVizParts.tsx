  ...
  return (
    ...
    >
      ...
      >
        ...
        <text x={280} y={40} fontSize={10} fill="var(--muted-foreground)">
          ← PUSH1 0x03
        </text>
        <text
          x={232}
        ...
        <text x={280} y={60} fontSize={10} fill="var(--muted-foreground)">
          ← PUSH1 0x05
        </text>
        <text
          x={232}
        ...
        <text x={256} y={80} fontSize={10} fill="var(--muted-foreground)">
          ← ADD
        </text>
        <line
          x1={232}
        ...
        return (
          ...
          >
            ...
            <text
              ...
              y={y}
              fontSize={10}
              fill={isData ? C1 : "var(--muted-foreground)"}
