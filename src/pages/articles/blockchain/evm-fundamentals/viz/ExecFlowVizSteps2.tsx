...
export function RunLoopStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(0.2)}>
        <rect x={15} y={24} width={510} height={22} rx={4} fill={`${C1}06`} stroke={C1} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.3)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${C2}06`} stroke={C2} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.5)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${C2}06`} stroke={C2} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.7)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${C3}08`} stroke={C3} strokeWidth={0.8} />
      ...
      <motion.g {...fade(0.9)}>
        <rect x={15} y={136} width={510} height={22} rx={4} fill={`${C3}08`} stroke={C3} strokeWidth={0.8} />
...
export function RefundStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${C3}06`} stroke={C3} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${C2}08`} stroke={C2} strokeWidth={0.8} />
        <text x={25} y={94} fontSize={10} fontWeight={600} fill={C2} fontFamily="monospace">Line 3:</text>
        <text x={80} y={94} fontSize={10} fill="var(--foreground)" fontFamily="monospace">st.gasRemaining += refund  // 잔여 가스에 환불 합산</text>
      </motion.g>
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${C2}06`} stroke={C2} strokeWidth={0.6} />
      ...
      <motion.g {...fade(1.0)}>
        <rect x={15} y={136} width={510} height={22} rx={4} fill={`${C3}06`} stroke={C3} strokeWidth={0.6} />
        <text x={25} y={150} fontSize={10} fontWeight={600} fill={C3} fontFamily="monospace">Line 5:</text>
