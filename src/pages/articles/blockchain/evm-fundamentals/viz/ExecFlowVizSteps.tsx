...
export function PreCheckStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${C3}06`} stroke={C3} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${C2}08`} stroke={C2} strokeWidth={0.8} />
      ...
      <motion.g {...fade(1.0)}>
        <rect x={15} y={136} width={510} height={22} rx={4} fill={`${C2}08`} stroke={C2} strokeWidth={0.8} />
...
export function IntrinsicGasStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${C1}06`} stroke={C1} strokeWidth={0.6} />
...
export function CallSetupStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(1.0)}>
        <rect x={15} y={136} width={510} height={22} rx={4} fill={`${C1}06`} stroke={C1} strokeWidth={0.6} />
