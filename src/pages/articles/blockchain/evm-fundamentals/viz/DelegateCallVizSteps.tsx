...
export function DelegateCallStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(0.2)}>
        <rect x={15} y={24} width={510} height={22} rx={4} fill={`${CV}06`} stroke={CV} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${CA}08`} stroke={CA} strokeWidth={0.8} />
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CE}06`} stroke={CE} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CV}06`} stroke={CV} strokeWidth={0.6} />
...
export function AsDelegateStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${CA}06`} stroke={CA} strokeWidth={0.6} />
        <text x={25} y={66} fontSize={10} fontWeight={600} fill={CA} fontFamily="monospace">Line 2:</text>
        <text x={80} y={66} fontSize={10} fill="var(--foreground)" fontFamily="monospace">c.value = parent.value  // msg.value 유지</text>
      </motion.g>
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CA}08`} stroke={CA} strokeWidth={0.8} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill="var(--background)" stroke="var(--border)" strokeWidth={0.5} />
...
export function StaticCallStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(0.2)}>
        <rect x={15} y={24} width={510} height={22} rx={4} fill={`${CE}06`} stroke={CE} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${CR}06`} stroke={CR} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CR}06`} stroke={CR} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CE}06`} stroke={CE} strokeWidth={0.6} />
...
export function SelfdestructStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(0.2)}>
        <rect x={15} y={24} width={510} height={22} rx={4} fill={`${CR}06`} stroke={CR} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CA}06`} stroke={CA} strokeWidth={0.6} />
        <text x={25} y={94} fontSize={10} fontWeight={600} fill={CA} fontFamily="monospace">Line 3:</text>
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CR}08`} stroke={CR} strokeWidth={0.8} />
