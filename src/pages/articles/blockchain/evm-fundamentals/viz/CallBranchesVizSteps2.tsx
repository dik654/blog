...
export function RunEntryStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CA}06`} stroke={CA} strokeWidth={0.6} />
...
export function ErrorHandleStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CR}08`} stroke={CR} strokeWidth={0.8} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CV}08`} stroke={CV} strokeWidth={0.8} />
