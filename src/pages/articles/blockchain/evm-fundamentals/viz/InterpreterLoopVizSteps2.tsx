...
export function GasStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...fade(0.2)}>
        <rect x={15} y={24} width={510} height={22} rx={4} fill={`${CA}06`} stroke={CA} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${CV}06`} stroke={CV} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CV}06`} stroke={CV} strokeWidth={0.6} />
      ...
      <motion.g {...fade(1.0)}>
        <rect x={15} y={136} width={510} height={22} rx={4} fill={`${CE}08`} stroke={CE} strokeWidth={0.8} />
...
export function ExecuteStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.6)}>
        <rect x={15} y={80} width={510} height={22} rx={4} fill={`${CE}08`} stroke={CE} strokeWidth={0.8} />
...
export function LoopBackStep() {
  return (
    <svg viewBox="0 0 540 160" className="w-full max-w-2xl" style={{ height: 'auto' }}>
      ...
      <motion.g {...slide(0.4)}>
        <rect x={15} y={52} width={510} height={22} rx={4} fill={`${CE}06`} stroke={CE} strokeWidth={0.6} />
      ...
      <motion.g {...slide(0.8)}>
        <rect x={15} y={108} width={510} height={22} rx={4} fill={`${CR}06`} stroke={CR} strokeWidth={0.6} />
        <text x={25} y={122} fontSize={10} fontWeight={600} fill={CR} fontFamily="monospace">Line 4:</text>
