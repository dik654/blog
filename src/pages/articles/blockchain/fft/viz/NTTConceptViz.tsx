        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={240} y={42} fontSize={11} fill="var(--muted-foreground)">
                →
              </text>
              <rect
                x={260}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <text x={30} y={25} fontSize={10} fontWeight={500} fill={C.coef}>
                f = [1, 2, 3]
              </text>
              <text x={200} y={25} fontSize={10} fontWeight={500} fill={C.coef}>
                g = [4, 5]
              </text>
                ...
                <g key={i}>
                  {i > 0 && (
                    <>
                      ...
                      />
                      <polygon
                        points={`${s.x - 4},37 ${s.x},40 ${s.x - 4},43`}
                        fill="var(--muted-foreground)"
                      />
                    </>
                  )}
