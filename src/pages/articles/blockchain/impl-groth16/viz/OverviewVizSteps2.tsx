...
export function LagrangeStep() {
  ...
  return (
    <g>
      ...
      >
        <text x={140} y={58} fontSize={10} fill={CA}>
          Lagrange
        </text>
        <path
          d="M 110 55 L 170 55"
    ...
    <g>
      ...
      >
        <path
          ...
          markerEnd="url(#gArr)"
        />
        <text x={205} y={34} fontSize={8} fill={CA} textAnchor="middle">
          ÷
        </text>
      </motion.g>
      <VizBox
      ...
      >
        <path
          ...
          markerEnd="url(#gArr)"
        />
        <text x={335} y={34} fontSize={8} fill={CA} textAnchor="middle">
          =
        </text>
      </motion.g>
      <VizBox
