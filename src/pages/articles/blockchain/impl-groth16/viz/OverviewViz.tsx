...
import { R1CSConstraintStep, VariableTypesStep } from './OverviewVizSteps';
import { LagrangeStep, QAPEquivStep } from './OverviewVizSteps2';

const RENDERERS = [R1CSConstraintStep, VariableTypesStep, LagrangeStep, QAPEquivStep];
