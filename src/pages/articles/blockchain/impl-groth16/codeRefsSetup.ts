    ...
    annotations: [
      {
        lines: [7, 12],
        color: "sky",
        note: "toxic waste 5개 — 이 값을 알면 가짜 증명 가능. 반드시 삭제",
      },
      {
        lines: [24, 29],
        color: "emerald",
        note: "각 변수 j의 다항식을 비밀 τ에서 평가 — 커브 점으로 인코딩",
      },
      {
        lines: [31, 35],
        color: "amber",
        note: "Query = [aⱼ(τ)]₁ — τ 자체는 노출 안 됨 (ECDLP)",
      },
    ],
  },
  "groth16-pk": {
    ...
    annotations: [
      {
        lines: [2, 6],
        color: "sky",
        note: "기본 커브 포인트 — α,β,δ를 G1/G2에 스칼라 곱으로 인코딩",
      },
      {
        lines: [9, 11],
        color: "emerald",
        note: "Query — aⱼ(τ), bⱼ(τ)를 커브 점으로. τ 자체는 숨겨짐",
      },
      {
        lines: [13, 17],
        color: "amber",
        note: "l_query: private용 /δ, h_query: h(x) 계수 결합용",
      },
    ],
  },
  "groth16-vk": {
    ...
    annotations: [
      {
        lines: [2, 3],
        color: "sky",
        note: "e(α,β) 사전 계산 — 검증 시 Fp12 곱셈 1회로 대체",
      },
      {
        lines: [5, 6],
        color: "emerald",
        note: "γ: 공개 변수, δ: 비공개 변수를 분리하는 역할",
      },
      {
        lines: [10, 11],
        color: "amber",
        note: "ic — 공개 입력 commitment. /γ로 나눠 e(·,[γ]₂)로 소거",
      },
    ],
  },
  "groth16-ic-l": {
    ...
    annotations: [
      {
        lines: [3, 9],
        color: "sky",
        note: "IC — 공개 변수 /γ. 검증 시 e(IC_sum, [γ]₂)로 γ 소거",
      },
      {
        lines: [12, 18],
        color: "emerald",
        note: "L — 비공개 변수 /δ. 검증 시 e(C, [δ]₂)로 δ 소거",
      },
    ],
  },
};
