    ...
    annotations: [
      {
        lines: [9, 18],
        color: "sky",
        note: "IC_sum — 공개 입력으로 ic 벡터를 MSM 결합",
      },
      {
        lines: [21, 25],
        color: "emerald",
        note: "3개 페어링: LHS 1개 + RHS 2개 (α,β는 사전계산)",
      },
      {
        lines: [27, 27],
        color: "amber",
        note: "Fp12 비교 — 페어링 결과가 일치하면 증명 유효",
      },
    ],
  },
  "groth16-proof": {
    ...
    annotations: [
      {
        lines: [5, 5],
        color: "sky",
        note: "A ∈ G1 — α + QAP A항 + rδ 블라인딩",
      },
      {
        lines: [6, 6],
        color: "emerald",
        note: "B ∈ G2 — β + QAP B항 + sδ 블라인딩",
      },
      {
        lines: [7, 7],
        color: "amber",
        note: "C ∈ G1 — private + h·t + 교차 블라인딩",
      },
    ],
  },
};
