...
const ACTIVE: string[][] = [
  ...
  ["rv", "trace"],
  ["trace", "lasso", "ram", "r1cs"],
  ["lasso", "ram", "r1cs", "batch"],
  ["batch", "dory", "proof"],
];

const STEPS = [
  {
    label: "Jolt zkVM 전체 파이프라인",
    body: "RISC-V 실행 트레이스를 Sumcheck + Dory로 증명합니다.",
  },
  {
    label: "실행 트레이스 생성",
    body: "RISC-V 프로그램을 에뮬레이션하여 명령어별 상태를 기록합니다.",
  },
  {
    label: "Lasso + RAM + R1CS 분해",
    body: "트레이스를 룩업/메모리/제약 세 갈래로 분해합니다.",
  },
  {
    label: "BatchedSumcheck 통합",
    body: "8단계의 독립 Sumcheck를 배치 계수로 단일 증명에 병합합니다.",
  },
  {
    label: "Dory PCS & 최종 증명",
    body: "다변량 다항식 평가를 Dory로 검증하고 JoltProof를 출력합니다.",
  },
];
            ...
            {EDGES.map((e, i) => {
              ...
              return (
                <motion.line
                  ...
                  strokeWidth={1}
                  markerEnd="url(#jolt-ah)"
                  animate={{ opacity: on ? 0.5 : 0.1 }}
