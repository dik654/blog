    ...
    annotations: [
      {
        lines: [167, 200],
        color: "sky",
        note: "JoltCpuProver — 트레이스, Spartan 키, RAM 상태, 오프닝 누적기",
      },
      {
        lines: [841, 875],
        color: "emerald",
        note: "prove_stage1 — Spartan Outer Sumcheck (R1CS → Sumcheck 환원)",
      },
      {
        lines: [880, 940],
        color: "amber",
        note: "prove_stage2 — RAM + Instruction + Product 결합 Sumcheck",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [32, 39],
        color: "sky",
        note: "BatchedSumcheck::prove 시그니처",
      },
      {
        lines: [46, 50],
        color: "emerald",
        note: "초기 클레임 기록 + 배치 계수 α 샘플링",
      },
      {
        lines: [61, 75],
        color: "amber",
        note: "클레임 스케일링 (라운드 수 차이 보정) + 초기 배치 클레임",
      },
      {
        lines: [84, 100],
        color: "violet",
        note: "라운드별 Sumcheck — 단변수 다항식 계산 + 도전값 바인딩",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [36, 41],
        color: "sky",
        note: "JoltProof 제네릭 — Field, Curve, PCS, Transcript",
      },
      {
        lines: [42, 46],
        color: "emerald",
        note: "커밋 + Stage 1~2 UniSkip + Sumcheck 증명",
      },
      { lines: [47, 51], color: "amber", note: "Stage 3~7 Sumcheck 증명" },
      {
        lines: [54, 63],
        color: "violet",
        note: "공동 개구 증명 + 트레이스 메타데이터",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [13, 15],
        color: "sky",
        note: "InstructionLookup — 명령어 → 룩업 테이블 매핑",
      },
      {
        lines: [21, 43],
        color: "emerald",
        note: "LookupQuery — 피연산자 → 인덱스/출력 변환",
      },
      {
        lines: [63, 80],
        color: "amber",
        note: "CircuitFlags — R1CS 제약에서 사용하는 명령어 플래그",
      },
    ],
  },
};
