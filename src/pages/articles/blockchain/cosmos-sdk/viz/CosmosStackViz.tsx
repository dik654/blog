...
const STEPS = [
  {
    label: "Cosmos SDK 레이어 스택",
    body: "Application → SDK Modules → BaseApp → ABCI → CometBFT 순서로 구성.",
  },
  {
    label: "API 진입점",
    body: "클라이언트가 gRPC/REST로 TX 전송. Protobuf 서비스로 정의.",
  },
  {
    label: "BaseApp 처리",
    body: "ABCI 메서드 구현체. AnteHandler 체인으로 서명/fee 검증 후 MsgRouter 디스패치.",
  },
  {
    label: "Module 실행 & 저장",
    body: "각 모듈 Keeper가 비즈니스 로직 실행 후 IAVL MultiStore에 상태 기록.",
  },
  {
    label: "CometBFT 합의",
    body: "ABCI를 통해 블록 제안/검증/커밋. 즉시 최종성 보장.",
  },
];
