...
const STEPS = [
  {
    label: "TX 수신",
    body: "BaseApp이 트랜잭션을 수신하고 AnteHandler 체인을 시작합니다.",
  },
  {
    label: "수수료 차감",
    body: "DeductFeeDecorator가 지정된 가스 가격으로 수수료를 선차감합니다.",
  },
  {
    label: "서명 검증",
    body: "SigVerificationDecorator가 ECDSA/Ed25519 서명을 검증합니다.",
  },
  {
    label: "시퀀스 관리",
    body: "공개키 설정 후 계정 시퀀스(nonce)를 증가시켜 재전송을 방지합니다.",
  },
  {
    label: "Msg 실행 진입",
    body: "모든 AnteHandler를 통과하면 MsgServer로 메시지 실행이 시작됩니다.",
  },
];
