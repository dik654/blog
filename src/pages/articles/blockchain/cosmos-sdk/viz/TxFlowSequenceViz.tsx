...
const STEPS = [
  {
    label: "TX 생성",
    body: "Protobuf Any 타입으로 메시지를 직렬화하고 secp256k1/ed25519로 서명합니다.",
  },
  {
    label: "CheckTx (멤풀 검증)",
    body: "AnteHandler 체인: 서명/nonce/fee 검증 → GasMeter 설정 → 멤풀 진입.",
  },
  {
    label: "PrepareProposal",
    body: "리더가 멤풀에서 TX를 선택합니다. MEV 방지 로직 삽입 가능.",
  },
  {
    label: "FinalizeBlock",
  ...
  {
    label: "IAVL 저장",
    body: "AVL 트리 노드가 RocksDB/PebbleDB에 영구 저장됩니다.",
  },
];
