...
const STEPS = [
  {
    label: "패킷 전송",
    body: "체인 A의 앱이 IBC 모듈을 통해 패킷을 커밋합니다.",
  },
  {
    label: "릴레이어 중계",
    body: "릴레이어가 체인 A의 이벤트를 감지하고 증명과 함께 체인 B로 전달합니다.",
  },
  {
    label: "증명 검증 & 수신",
    body: "체인 B의 Light Client가 증명을 검증하고 앱에 패킷을 전달합니다.",
  },
  {
    label: "Acknowledgement",
    body: "체인 B가 Ack를 작성하면 릴레이어가 체인 A로 돌려보내 완료합니다.",
  },
];
            ...
            {step === 3 && (
              <motion.g initial={{ opacity: 0 }} animate={{ opacity: 0.6 }}>
                <line
                  ...
                  markerEnd="url(#ack)"
                />
                <text x={370} y={H + 24} fontSize={9} fill="#ef4444">
                  Ack
                </text>
              </motion.g>
            )}
