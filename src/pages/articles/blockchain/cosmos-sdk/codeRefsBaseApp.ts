...
트랜잭션 디코딩, 메시지 라우팅, 상태 관리, AnteHandler 등을 통합합니다.`,
    annotations: [
      { lines: [2, 4], color: "sky", note: "logger + name + db — 기본 인프라" },
      {
        lines: [5, 5],
        color: "emerald",
        note: "CommitMultiStore — IAVL 기반 모듈별 상태 트리",
      },
      {
        lines: [8, 9],
        color: "amber",
        note: "MsgServiceRouter — Msg → 모듈 핸들러 라우팅",
      },
      {
        lines: [13, 15],
        color: "violet",
        note: "mempool + AnteHandler — TX 검증 파이프라인",
      },
      {
        lines: [22, 22],
        color: "rose",
        note: "stateManager — Check/Finalize 모드별 상태 분리",
      },
    ],
    ...
    annotations: [
      {
        lines: [1, 3],
        color: "sky",
        note: "시그니처 — name, logger, DB, txDecoder + 가변 옵션",
      },
      {
        lines: [5, 12],
        color: "emerald",
        note: "기본 설정 — CommitMultiStore, 라우터 초기화",
      },
      {
        lines: [14, 18],
        color: "amber",
        note: "옵션 적용 + 기본 mempool 설정",
      },
    ],
