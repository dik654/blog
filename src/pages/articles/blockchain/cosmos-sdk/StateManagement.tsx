  ...
  return (
    <section id="state-management" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          rootmulti.Store — 모듈별 독립 IAVL 트리를 통합 관리
          <br />
          Commit 시 모든 서브스토어 해시를 Merkle 합산 →{" "}
          <strong>app_hash</strong> (이더리움 stateRoot 대응)
        </p>
        <div className="not-prose flex flex-wrap gap-2 my-4">
          <CodeViewButton onClick={() => open("rootmulti-struct")} />
          <span className="text-[10px] text-muted-foreground self-center">
            rootmulti.Store struct
          </span>
        ...
        <p>
          💡 <strong>모듈별 독립 증명</strong> — IBC에서 특정 모듈 상태만 Merkle
          증명 가능
          <br />
...
const ROWS = [
  {
    attr: "트리 구조",
    eth: "16-ary Patricia Trie",
    cosmos: "Self-balancing AVL Tree",
  },
  { attr: "해시 함수", eth: "Keccak-256", cosmos: "SHA-256" },
  {
    attr: "증명",
    eth: "Merkle-Patricia Proof",
    cosmos: "IAVL Existence/Absence Proof",
  },
  { attr: "버전 관리", eth: "상태 루트 히스토리", cosmos: "불변 버전 스냅샷" },
  {
    attr: "커밋 해시",
    eth: "stateRoot (블록 헤더)",
    cosmos: "app_hash (블록 헤더)",
  },
];
