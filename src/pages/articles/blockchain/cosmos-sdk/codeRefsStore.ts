    ...
    annotations: [
      {
        lines: [1, 4],
        color: "sky",
        note: "DB + 로거 + lastCommitInfo (atomic 포인터)",
      },
      {
        lines: [6, 9],
        color: "emerald",
        note: "IAVL 설정 — 캐시 크기, fast node 비활성화 옵션",
      },
      {
        lines: [11, 15],
        color: "amber",
        note: "stores 맵 — StoreKey → CommitStore(IAVL)",
      },
      {
        lines: [17, 22],
        color: "violet",
        note: "listeners + commitHeader — 상태 변경 감지 + 헤더 정보",
      },
    ],
...
💡 version = previousHeight + 1 — 블록 높이와 스토어 버전이 1:1 대응.`,
    annotations: [
      { lines: [1, 5], color: "sky", note: "버전 결정 — 이전 커밋 높이 + 1" },
      {
        lines: [7, 10],
        color: "emerald",
        note: "commitStores — 모든 서브스토어 IAVL Commit()",
      },
      {
        lines: [12, 16],
        color: "amber",
        note: "삭제 예약 스토어 정리 + removalMap 리셋",
      },
      {
        lines: [18, 22],
        color: "violet",
        note: "프루닝 + CommitID{Version, Hash} 반환",
      },
    ],
