    ...
    annotations: [
      {
        lines: [1, 4],
        color: "sky",
        note: "OE Abort — 이전 라운드의 투기적 실행 중단",
      },
      {
        lines: [6, 10],
        color: "emerald",
        note: "상태 리셋 + 헤더 구성 — 라운드 반복 호출 대비",
      },
      {
        lines: [12, 17],
        color: "amber",
        note: "PrepareProposal 컨텍스트 — VoteInfo, GasMeter 설정",
      },
      {
        lines: [19, 24],
        color: "violet",
        note: "앱의 PrepareProposalHandler 호출 → TX 선택/정렬",
      },
    ],
    ...
    annotations: [
      {
        lines: [1, 4],
        color: "sky",
        note: "finalizeState에서 컨텍스트 + 헤더 추출",
      },
      {
        lines: [6, 9],
        color: "emerald",
        note: "Precommiter 콜백 + 커밋 헤더 설정",
      },
      {
        lines: [11, 14],
        color: "amber",
        note: "cms.Commit() — 모든 IAVL 트리 영구 저장",
      },
      {
        lines: [16, 20],
        color: "violet",
        note: "상태 리셋: CheckTx 갱신, Finalize 클리어",
      },
