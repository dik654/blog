  ...
  return (
    <section id="module-architecture" className="mb-16 scroll-mt-20">
      <h2 className="text-2xl font-bold mb-6">
        모듈 시스템 — AppModule + Keeper + MsgRouter
      </h2>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Cosmos SDK 모듈 = 이더리움 프리컴파일과 유사한{" "}
          <strong>네이티브 로직 단위</strong>
          <br />각 모듈: AppModule 인터페이스 구현 + Keeper(상태 접근) +
          MsgServer(메시지 처리)
        </p>
        ...
        <p>
          AppModuleBasic — 이름, 코덱 등록, gRPC 게이트웨이
          <br />
          HasServices — MsgServer/QueryServer를 라우터에 등록
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Keeper = 모듈의 <strong>상태 접근 객체</strong> — 이더리움 StateDB
          대응
          <br />
          인터페이스 기반 의존성 주입 — 컴파일 타임 검증 (EVM CALL의 런타임
          바인딩과 대조)
          <br />
