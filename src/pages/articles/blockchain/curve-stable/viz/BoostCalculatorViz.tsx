    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      <div className="mb-2 flex items-center gap-3">
        ...
        <input
          ...
          step={10}
          value={vecrv}
          onChange={(e) => setVecrv(+e.target.value)}
      ...
      >
        ...
        >
          전체 veCRV: {totalVecrv.toLocaleString()} · 전체 LP:{" "}
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={130} fontSize={10} fontWeight={700} fill="#8b5cf6">
          veCRV 지분
        </text>
        <text
          x={242}
        ...
        <line
          ...
          opacity={0.4}
        />
        <text x={32} y={154} fontSize={10} fontWeight={700} fill="#10b981">
          LP 지분
        </text>
        <text
          x={242}
