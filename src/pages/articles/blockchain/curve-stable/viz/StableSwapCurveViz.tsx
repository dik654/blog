export default function StableSwapCurveViz() {
  ...
  const toPath = (pts: [number, number][]) =>
    pts
      .map(
        ([x, y], i) =>
          `${i === 0 ? "M" : "L"} ${origin.x + x * scale} ${origin.y - y * scale}`,
      )
      .join(" ");
