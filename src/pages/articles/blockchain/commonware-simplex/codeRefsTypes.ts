    ...
    annotations: [
      {
        lines: [4, 9],
        color: "sky",
        note: "Proposal 구조체 — round·parent·payload. payload는 Digest 제네릭 (SHA256 등)",
      },
    ],
  },
  "notarize-type": {
    ...
    annotations: [
      {
        lines: [12, 16],
        color: "emerald",
        note: "Notarize = Proposal + Attestation(서명). scheme.sign()으로 생성",
      },
    ],
  },
  "notarization-type": {
    ...
    annotations: [
      {
        lines: [19, 23],
        color: "amber",
        note: "Notarization = Proposal + Certificate. BLS에서는 96바이트 집합 서명",
      },
      {
        lines: [27, 31],
        color: "violet",
        note: "from_notarizes — scheme.assemble::<_, N3f1>()로 쿼럼 검증. N3f1 = 2f+1 명 필요",
      },
    ],
  },
  "vote-tracker": {
    ...
    annotations: [
      {
        lines: [47, 53],
        color: "sky",
        note: "VoteTracker — 3종 투표를 AttributableMap으로 분리 추적. 검증자당 1표 제한",
      },
    ],
  },
};
