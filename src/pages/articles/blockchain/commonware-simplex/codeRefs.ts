    ...
    annotations: [
      {
        lines: [4, 7],
        color: "sky",
        note: "Heightable/Viewable — 블록 높이·뷰 번호 추상화",
      },
      {
        lines: [10, 14],
        color: "emerald",
        note: "Block trait — digest(해시)·parent(부모) 체인 연결",
      },
      {
        lines: [27, 43],
        color: "amber",
        note: "Automaton — propose/verify/certify를 oneshot 비동기로 위임",
      },
      {
        lines: [46, 51],
        color: "violet",
        note: "Relay — broadcast(전체)/send(특정 피어) 네트워크 추상화",
      },
    ],
  },
  "threshold-dkg": {
    path: "consensus/threshold_simplex",
    code: thresholdRs,
    lang: "rust",
    highlight: [20, 49],
    ...
    annotations: [
      {
        lines: [20, 28],
        color: "sky",
        note: "Phase 1: 비밀 공유 생성 후 P2P 암호화 전송",
      },
      {
        lines: [36, 38],
        color: "emerald",
        note: "Phase 2: 수신 공유 검증. 비잔틴 탐지",
      },
      {
        lines: [41, 45],
        color: "amber",
        note: "Phase 3: 그룹 공개키 도출 → Signer 생성",
      },
      {
        lines: [49, 53],
        color: "violet",
        note: "combine — t개 부분 서명 → 96B 임계 서명",
      },
    ],
  },
};
