    ...
    >
      <motion.g {...fade(0.2)}>
        ...
        <line
          ...
          opacity={0.3}
        />
        <text x={30} y={48} fontSize={10} fill="var(--foreground)">
          round: (epoch, view)
        </text>
        <text x={30} y={62} fontSize={10} fill="var(--foreground)">
          parent: View — 부모 뷰 번호
        </text>
        <text x={30} y={76} fontSize={10} fill="var(--foreground)">
          payload: D — 블록 해시
        </text>
      </motion.g>
      <motion.g {...slide(0.7)}>
  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(1.2)}>
        ...
        <text x={375} y={76} textAnchor="middle" fontSize={10} fill={CE}>
          2f+1 도달 감지
        </text>
      </motion.g>
    </svg>
