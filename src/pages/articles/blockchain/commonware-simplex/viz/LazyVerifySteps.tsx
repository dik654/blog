        ...
        return (
          <g key={i}>
            <rect
              ...
              strokeWidth={0.5}
            />
            <text x={x + 38} y={40} textAnchor="middle" fontSize={10} fill={CV}>
              Vote {i}
            </text>
            <rect
              x={x}
              ...
              strokeWidth={0.6}
            />
            <text x={x + 38} y={63} textAnchor="middle" fontSize={10} fill={CH}>
              verify()
            </text>
            <rect
              x={x}
              ...
              strokeWidth={0.5}
            />
            <text x={x + 38} y={85} textAnchor="middle" fontSize={10} fill={CE}>
              저장
            </text>
          </g>
        );
