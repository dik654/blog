...
// 결과: 약 $5-8B 시총, 가장 오래된 탈중앙 스테이블`}</pre>
        ...
        <p>
          <strong>CDP 관리 분산</strong>: 여러 컨트랙트가 각자 역할
          <br />
          Vat는 <strong>"중앙 원장"</strong> — 모든 담보·부채 상태 저장
          <br />각 컴포넌트는 Vat에 권한만 가짐 → 모듈화
        </p>
        ...
        <p>
          <strong>Ilk별 독립 파라미터</strong>: 담보 유형마다 다른 리스크 관리
          <br />
          같은 ETH 담보도 A/B/C 구분 — 리스크 선호도 따라 선택
          <br />
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: DAI의 "탈중앙 스테이블" 위치
          </p>
          <p>
            DAI는 7년간 운영된{" "}
            <strong>가장 성공적인 탈중앙 스테이블코인</strong>
            <br />
          ...
          <p className="mt-2">
            ...
            ✗ USDC 담보 50%+ → Circle 의존
            <br />
            ✗ RWA 담보 → 전통 금융 기관 의존
            <br />
            ✗ MKR 보유 집중 (top 5가 30%+)
            <br />✗ 긴급 shutdown 시스템 (ESM)
          </p>
          <p className="mt-2">
            <strong>현실적 평가</strong>: USDC보다 탈중앙, LUSD보다 중앙화
            <br />
