    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          Dutch Auction — 가격 하락 경매 (Liquidations 2.0)
        </text>
        ...
        <circle
          cx={toX(8)}
          cy={toY(startPrice * Math.pow(cut, 8))}
          r={6}
          fill="#10b981"
        />
        <text
          x={toX(8)}
          y={toY(startPrice * Math.pow(cut, 8)) - 12}
          textAnchor="middle"
          fontSize={11}
          fontWeight={700}
          fill="#10b981"
        ...
        <text
          x={toX(8)}
          y={toY(startPrice * Math.pow(cut, 8)) + 18}
          textAnchor="middle"
          fontSize={10}
          fontWeight={600}
          fill="var(--muted-foreground)"
