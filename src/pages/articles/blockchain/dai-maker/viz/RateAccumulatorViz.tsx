...
export default function RateAccumulatorViz() {
  ...
  const pathData = dataPoints
    .map((p, i) => `${i === 0 ? "M" : "L"} ${toX(p.t)} ${toY(p.debt)}`)
    .join(" ");
      ...
      >
        ...
        <g transform="translate(186, 242)">
          <rect
            ...
            strokeWidth={0.6}
          />
          <text x={12} y={18} fontSize={10} fontWeight={700} fill="#f59e0b">
            3년 후 부채
          </text>
          <text
            x={146}
        ...
        <g transform="translate(346, 242)">
          <rect
            ...
            strokeWidth={0.6}
          />
          <text x={12} y={18} fontSize={10} fontWeight={700} fill="#ef4444">
            이자 누적
          </text>
          <text
            x={138}
