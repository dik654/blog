export default function EndgameViz() {
  const phases = [
    ...
    },
    {
      ...
      period: "2024~",
      color: "#10b981",
      items: ["DAI → USDS 리브랜딩", "MKR → SKY 리브랜딩", "USD-agnostic 방향"],
    },
  ];
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          MakerDAO Endgame — 3단계 로드맵 (Rune Christensen 2022)
        </text>
        ...
        <text
          ...
          fill="var(--foreground)"
        >
          USDC 30% · 중앙화 의존 · MKR 보유 집중 · PSM 페그 핵심
        </text>
        ...
        <text
          ...
          fill="var(--foreground)"
        >
          USDC 담보 0% · ETH + RWA + 암호자산 담보만 · USD 페그 초월
        </text>
        <text
          x={260}
          y={308}
          ...
          fill="var(--muted-foreground)"
        >
          MakerDAO 7년 경험의 결정판 — "crypto-native" 화폐
        </text>
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          이상과 현실의 균형 — Endgame은 "더 나은 탈중앙" 이동 계획
        </text>
      </svg>
    </div>
  );
