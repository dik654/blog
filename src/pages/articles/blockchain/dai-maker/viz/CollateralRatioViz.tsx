...
export default function CollateralRatioViz() {
  ...
  const barMax = 280;
  const indicatorX =
    20 + Math.max(0, Math.min(1, (ratio - barMin) / (barMax - barMin))) * 480;
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text
          ...
          fill="#3b82f6"
        >
          urn.art × ilk.rate ≤ urn.ink × ilk.spot
        </text>
        <text
          x={260}
          y={102}
        ...
        <text x={32} y={172} fontSize={10} fill="var(--muted-foreground)">
          urn.ink
        </text>
        <text
          x={242}
        ...
        <text x={32} y={194} fontSize={10} fill="var(--muted-foreground)">
          ETH 시장가 (슬라이더)
        </text>
        <text
          x={242}
        ...
        <text x={32} y={216} fontSize={10} fill="var(--muted-foreground)">
          spot = market / 1.5
        </text>
        <text
          x={242}
        ...
        <text x={32} y={238} fontSize={10} fill="var(--muted-foreground)">
          ink × spot
        </text>
        <text
          x={242}
        ...
        <text x={277} y={172} fontSize={10} fill="var(--muted-foreground)">
          urn.art
        </text>
        <text
          x={487}
        ...
        <text x={277} y={194} fontSize={10} fill="var(--muted-foreground)">
          ilk.rate
        </text>
        <text
          x={487}
        ...
        <text x={277} y={216} fontSize={10} fill="var(--muted-foreground)">
          art × rate
        </text>
        <text
          x={487}
        ...
        <text x={277} y={238} fontSize={10} fill="var(--muted-foreground)">
          담보비율
        </text>
        <text
          x={487}
        ...
        {/* 청산선 표시 (150%) */}
        <line
          x1={20 + ((liquidationRatio - barMin) / (barMax - barMin)) * 480}
          y1={320}
        ...
        />
        <text
          x={20 + ((liquidationRatio - barMin) / (barMax - barMin)) * 480}
          y={360}
          textAnchor="middle"
          fontSize={9}
          fontWeight={700}
