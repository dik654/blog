  ...
  return (
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <text x={78} y={134} fontSize={10} fill="var(--muted-foreground)">
          DAI 공급 증가 (100K mint) → 가격 $1.02 → $1.00 회귀
        </text>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={42} y={164} fontSize={10} fontWeight={700} fill="#10b981">
          차익거래 수익:
        </text>
        ...
        <text x={78} y={302} fontSize={10} fill="var(--muted-foreground)">
          DAI 수요 증가 (DEX 매수) → 가격 $0.98 → $1.00 회귀
        </text>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={42} y={332} fontSize={10} fontWeight={700} fill="#10b981">
          차익거래 수익:
        </text>
