      ...
      >
        ...
        {[
          ...
          },
          {
            x: 330,
            label: "담보",
            value: `${collateralAmt} ETH ($${collateralValue.toLocaleString()})`,
            color: "#3b82f6",
          },
        ].map((s, i) => (
          <g key={i}>
            ...
            <text x={s.x} y={100} fontSize={11} fontWeight={700} fill={s.color}>
              {s.value}
            </text>
          </g>
        ))}
        ...
        <text
          ...
          fill="var(--foreground)"
        >
          담보 매각 ${collateralValue.toLocaleString()} 분배
        </text>
        ...
        <g transform="translate(40, 308)">
          <rect
            ...
            strokeWidth={0.6}
          />
          <text x={12} y={18} fontSize={10} fontWeight={700} fill="#3b82f6">
            원래 담보
          </text>
          <text
            x={190}
          ...
          <text x={12} y={36} fontSize={10} fontWeight={700} fill="#10b981">
            반환
          </text>
          <text
            x={190}
          ...
          <text x={12} y={50} fontSize={10} fill="var(--muted-foreground)">
            (${toUser.toLocaleString()})
          </text>
        </g>
        ...
        <g transform="translate(260, 308)">
          <rect
            ...
            strokeWidth={1}
          />
          <text x={12} y={22} fontSize={11} fontWeight={700} fill="#ef4444">
            순 손실
          </text>
          <text
            x={210}
