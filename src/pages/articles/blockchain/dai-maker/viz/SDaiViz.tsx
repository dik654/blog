    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        <text
          ...
          fill="var(--foreground)"
        >
          sDAI — ERC-4626 Vault (Pot wrapping)
        </text>
        ...
        {/* deposit 흐름 — 상단 */}
        <text x={30} y={52} fontSize={11} fontWeight={700} fill="#3b82f6">
          deposit — DAI 예치 → sDAI 발행
        </text>
        ...
        {/* redeem 흐름 — 하단 */}
        <text x={30} y={144} fontSize={11} fontWeight={700} fill="#f59e0b">
          redeem — sDAI 소각 → DAI 인출 (+이자)
        </text>
