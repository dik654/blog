  ...
  return (
    <section id="pc2" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          PC1이 만든 여러 layer의 label을 node별 column으로 모으고 hash해 encoding key를 만듭니다. 이 key를 원본 데이터에 적용해 replica를
          만들고 data·column·replica에 대응하는 Merkle commitment를 계산합니다.
        </p>
        <p>
          Poseidon은 유한체 연산으로 구성돼 proof circuit 안에서 다루기 유리하지만 “SHA-256보다 언제나 수백 배 빠르다”는 일반 성능 주장은 아닙니다. Native
          hashing 비용과 circuit constraint 비용을 구분해서 비교해야 합니다.
        </p>
      </div>
