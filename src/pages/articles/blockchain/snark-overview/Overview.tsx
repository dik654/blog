  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          SNARK는{" "}
          <strong>Succinct Non-interactive ARgument of Knowledge</strong>의
          약자다
          <br />
        ...
        <div className="grid gap-4 sm:grid-cols-2 not-prose mt-6 mb-6">
          <div className="rounded-lg border p-4">
            <h4 className="font-semibold text-sm mb-2 text-sky-400">
              Succinct (간결성)
            </h4>
            <p className="text-sm leading-relaxed">
              증명 크기가 수백 바이트에 불과하다
              <br />
              검증 시간은 밀리초 단위 &mdash; 회로가 아무리 커도 증명 크기는
              거의 일정하다
            </p>
          </div>
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm leading-relaxed">
              ...
              <br />
              검증자와 여러 라운드를 주고받을 필요가 없다 &mdash; Fiat-Shamir
              변환 덕분이다
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <h4 className="font-semibold text-sm mb-2 text-violet-400">
              ARgument (논증)
            </h4>
            <p className="text-sm leading-relaxed">
              계산적으로 안전하다는 뜻이다 &mdash; 다항식 시간 안에 위조 증명을
              만들 수 없다
              <br />
          ...
          <div className="rounded-lg border p-4">
            <h4 className="font-semibold text-sm mb-2 text-amber-400">
              of Knowledge (지식 증명)
            </h4>
            <p className="text-sm leading-relaxed">
              증명자가 실제로 witness <Math>{"w"}</Math>를 &quot;알고
              있음&quot;을 보장한다
              <br />
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mt-4 mb-6">
          <div className="rounded-lg border p-4">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li>
                - 검증 비용이 일정하므로 배치 크기를 늘려도 가스 비용이 거의
                동일
              </li>
            </ul>
          </div>
        ...
        <p>
          ...
          <br />
          setup 과정에서 생성되는 &quot;toxic waste&quot;가 노출되면 가짜 증명을
          만들 수 있다
          <br />
          MPC 세레모니로 위험을 분산하지만 신뢰 가정이 완전히 사라지진 않는다
        </p>
        <p className="text-sm text-muted-foreground mt-2">
          예외: STARK, Bulletproofs, Halo2(IPA 기반)는 trusted setup 없이
          동작한다
        </p>
      </div>
    </section>
