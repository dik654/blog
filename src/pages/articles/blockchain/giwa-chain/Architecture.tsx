      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
          ...
          >
            ...
            />
            <text x={115} y={90} fontSize={7} fill="var(--muted-foreground)">
              L1 read
            </text>
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">
          op-node — Consensus Layer 역할
        </h3>
        <p>
          <code>op-node</code>는 OP Stack의 <strong>"두뇌"</strong>:
        </p>
        <p>
          <strong>1. L1 Monitoring</strong>
          <br />
          이더리움 L1의 batch inbox contract 감시
          <br />
          sequencer가 올린 batch 데이터 수집
        </p>
        <p>
          <strong>2. Block Derivation</strong>
          <br />
          L1 calldata → L2 블록 파생 규칙 적용
          <br />
          결정론적 규칙 — 누구나 같은 L2 state 계산 가능
        </p>
        <p>
          <strong>3. Engine API 호출</strong>
          <br />
          파생된 블록을 Execution Client(geth/reth)에 주입
          <br />
          <code>engine_forkchoiceUpdatedV2</code>,{" "}
          <code>engine_newPayloadV2</code>
        </p>

        <h3 className="text-xl font-semibold mt-8 mb-3">
          Sequencer 동작 (중앙화된 부분)
        </h3>
        <p>
          <strong>Sequencer = 트랜잭션 순서 결정자</strong>
          <br />
          현재 OP Stack의 중앙화 지점 — 향후 decentralized sequencing 로드맵
          <br />
          역할:
        </p>
        <p>
          - 사용자 트랜잭션 수신
          <br />
          - 순서 결정 &amp; pre-confirmation 발행
          <br />
          - L2 블록 생성 (L1에 올리기 전)
          <br />- "soft finality" 제공 (L1 게시 전 상태)
        </p>
        ...
        <div className="not-prose grid gap-3 my-4">
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Sequencer가 블록 생성 &amp; 서명 — User UI에 "Transaction
              confirmed" 표시
              <br />
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Batch가 L1에 게시됨 — 누구나 L2 state 재구성 가능
              <br />
          ...
          <div className="rounded-lg border border-border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              L1 블록이 finalized (Ethereum 2 epochs) — 완전한 최종성
              <br />
        ...
        <p>
          <strong>L1 RPC 의존성</strong>: <code>OP_NODE_L1_ETH_RPC</code> 필수
          <br />
          Alchemy, Infura, QuickNode 또는 자체 이더리움 노드
          <br />
          L1 요청량 많음 — 유료 플랜 권장
        </p>
        <p>
          <strong>L1 Beacon 의존성</strong>: <code>OP_NODE_L1_BEACON</code>
          <br />
          EIP-4844 blob data 접근 필요
          <br />
          Lighthouse, Prysm, Teku 등 CL 연결
        </p>
        <p>
          <strong>디스크 성장</strong>:<br />
          Archive 노드: 일일 2-5GB 증가
          <br />
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            GIWA 같은 신규 L2는 <strong>OP Stack 모듈 조합</strong>으로 빠른
            구축 가능:
          </p>
          <p className="mt-2">
            - op-geth / op-reth (EL)
            ...
            <br />
            - op-proposer (상태 앵커)
            <br />- op-challenger (fraud proof, 향후)
          </p>
          <p className="mt-2">
            각 모듈은 독립 업그레이드 가능 — Flashblocks, 새 sync 모드 등<br />
            <strong>Superchain 이점</strong>: 여러 OP Stack 체인이 공통 개선
            공유
            <br />
