  ...
  return (
    <section id="mmr" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          MMR — <strong>append-only Merkle 구조</strong>
          <br />
          높이가 줄어드는 완전 이진 트리(peak)의 연속
          <br />
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">
          좌표 변환: Location ↔ Position
        </h3>
        <p>
          <strong>Location</strong> = 리프 삽입 순서 인덱스 (0, 1, 2, ...)
          <br />
          <strong>Position</strong> = post-order 순회 노드 인덱스
          <br />
        ...
        <p>
          <strong>Blueprint</strong>: fold_prefix + fetch_nodes
          <br />
          fold_prefix — 범위 이전 peak들을 하나의 accumulator로 접기
          <br />
          fetch_nodes — 리프→peak 경로의 형제 노드
          <br />
        ...
        <div className="rounded-lg border border-amber-300 bg-amber-50/30 dark:bg-amber-950/10 p-4 mt-4">
          ...
          <p className="text-sm">
            Position이 변하지 않는 안정 식별자 — 노드 추가 시 기존 Position
            불변. 이 성질이 pruning과 historical proof를 가능하게 함.
          </p>
        </div>
      </div>
    </section>
