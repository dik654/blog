  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text
        ...
        fill="var(--muted-foreground)"
      >
        Current DB = Any + Bitmap + Grafted MMR
      </text>
    </motion.g>
  );
}
...
export function GraftingStep() {
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text x={215} y={57} textAnchor="middle" fontSize={10} fill={C.bm}>
        1 1 0 1
      </text>
      <line
        x1={152}
      ...
      <defs>
        <marker
          ...
          orient="auto"
        >
          <path d="M0,0 L5,2.5 L0,5" fill={C.graft} />
        </marker>
      </defs>
    </motion.g>
  );
  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text
        ...
        fill="var(--muted-foreground)"
      >
        OperationProof = loc + chunk + RangeProof
      </text>
      <defs>
        <marker
          id="prf-arw"
    ...
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <defs>
        <marker
          ...
          orient="auto"
        >
          <path d="M0,0 L5,2.5 L0,5" fill={C.root} />
        </marker>
      </defs>
    </motion.g>
  );
