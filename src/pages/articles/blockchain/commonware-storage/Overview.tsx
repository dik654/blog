  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Commonware 저장소 — <strong>append-only</strong> 원칙
          <br />
          SSD 순차 쓰기에 최적화, 랜덤 쓰기와 GC를 제거
          <br />
          삭제 대신 비활성 마킹으로 처리
        </p>
        ...
        <p>
          <strong>commit</strong> — 메모리 → OS 페이지 캐시 플러시
          <br />
          <strong>sync</strong> — 페이지 캐시 → SSD (fsync), 복구 불필요 보장
          <br />
        ...
        <div className="rounded-lg border border-amber-300 bg-amber-50/30 dark:bg-amber-950/10 p-4 mt-4">
          ...
          <p className="text-sm">
            commit의 기본 구현이 sync를 호출 — "안전 우선" 기본값. 성능이 필요한
            구현체만 commit을 오버라이드하여 약한 보장 선택 가능.
          </p>
        </div>
      </div>
    </section>
