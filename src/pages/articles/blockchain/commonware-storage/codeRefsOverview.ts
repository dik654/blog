    ...
    annotations: [
      {
        lines: [24, 27],
        color: "sky",
        note: "Context — Storage + Clock + Metrics 번들",
      },
      { lines: [30, 31], color: "emerald", note: "Persistable trait 정의" },
      {
        lines: [35, 38],
        color: "amber",
        note: "commit — 기본 구현은 sync 위임",
      },
      {
        lines: [41, 42],
        color: "violet",
        note: "sync — fsync로 SSD까지 내구성 보장",
      },
      {
        lines: [45, 46],
        color: "rose",
        note: "destroy — 파일 삭제 + 자원 해제",
      },
    ],
  },
  "context-trait": {
    ...
    annotations: [
      {
        lines: [24, 25],
        color: "sky",
        note: "Context trait bound — 3개 trait의 합",
      },
      {
        lines: [27, 28],
        color: "emerald",
        note: "blanket impl — 조건 만족 시 자동 구현",
      },
    ],
  },
};
