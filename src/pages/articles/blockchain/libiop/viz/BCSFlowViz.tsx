        ...
        >
          {step === 0 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.iop}>
                BCS 변환
              </text>
              {[
                "IOP → zkSNARK (비상호작용)",
                ...
                "     질의 → Fiat-Shamir 해시",
                "",
                "// Ben-Sasson, Chiesa, Spooner (2016)",
              ].map((t, i) => (
                <text
                  key={i}
                  x={20}
          ...
          {step === 1 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.mt}>
                머클 커밋
              </text>
              {[
                "πᵢ = [f(ω⁰), f(ω¹), ..., f(ωⁿ⁻¹)]",
          ...
          {step === 2 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.fs}>
                Fiat-Shamir 질의
              </text>
              {[
                's₀ = H("BCS" ∥ instance)',
          ...
          {step === 3 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.out}>
                증명 출력
              </text>
              {[
                "proof = {",
