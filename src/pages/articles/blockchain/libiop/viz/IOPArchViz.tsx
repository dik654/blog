...
const STEPS = [
  {
    label: "libiop 아키텍처",
    body: "R1CS 제약을 IOP로 변환하고 BCS를 거쳐 zkSNARK로 만듭니다.",
  },
  { label: "R1CS -> IOP", body: "R1CS 제약 시스템을 다항식 IOP로 변환합니다." },
  {
    label: "LDT + BCS",
    body: "저차 테스트(LDT)와 BCS 변환으로 비상호작용화합니다.",
  },
  {
    label: "zkSNARK 출력",
    body: "머클 트리 커밋과 Fiat-Shamir로 최종 증명을 생성합니다.",
  },
];
        ...
        return (
          ...
          >
            ...
            {NODES.map((n, i) => {
              ...
              return (
                <g key={n.label}>
                  <motion.g animate={{ opacity: active ? 1 : 0.18 }} transition={sp}>
                    <ModuleBox x={n.x - 30} y={n.y - 17} w={60} h={34} label={n.label} sub={n.sub} color={n.color} />
                  </motion.g>
                </g>
              );
            })}
