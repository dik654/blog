...
const STEPS = [
  {
    label: "Fractal 전체 흐름",
    body: "인덱서가 R1CS를 전처리하여 O(log N) 검증을 가능하게 합니다.",
  },
  {
    label: "인덱서 입력",
    body: "R1CS 제약 시스템의 A, B, C 행렬을 인덱서에 전달합니다.",
  },
  {
    label: "행렬 분해",
    body: "각 행렬을 row/col/val 3개 다항식으로 분해합니다.",
  },
  {
    label: "O(log N) 검증",
    body: "전처리된 인덱스를 활용하여 O(log N) 시간에 검증합니다.",
  },
];
