...
import R1CSPolynomialViz from './viz/R1CSPolynomialViz';
  ...
  return (
    <section id="r1cs-iop" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">R1CS → Polynomial IOP 변환</h3>        <div className="not-prose mb-4"><R1CSPolynomialViz /></div>
      </div>
    </section>
  );
}
