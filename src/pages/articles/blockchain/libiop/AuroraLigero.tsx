  ...
  return (
    <section id="aurora-ligero" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Ligero는 증인 벡터를 <strong>m x n 행렬</strong>로 재배열하여 행별
          Reed-Solomon 인코딩과 열별 일관성 검사로 O(sqrt N) 크기의 증명을
          달성합니다. 2라운드 공개 코인 프로토콜로 구현이 단순합니다.
        </p>
        <CodePanel
          title="Ligero 핵심 구조"
          code={LIGERO_CODE}
        ...
        <p>
          ...
          다항식을 재귀적으로 폴딩합니다.
          <br />
          차수를 절반씩 줄이는 O(log N) 라운드로 총 O(log^2 N) 인수 크기를
          달성합니다.
        </p>
        <CodePanel
          title="Aurora + FRI 구조"
          ...
          annotations={[
            ...
            { lines: [12, 13], color: "emerald", note: "폴딩: 차수 절반 감소" },
            {
              ...
              color: "amber",
              note: "O(log^2 N) 인수 크기",
            },
          ]}
        />

        <h3 className="text-xl font-semibold mt-6 mb-3">
          Aurora vs Ligero 상세 비교
        </h3>
