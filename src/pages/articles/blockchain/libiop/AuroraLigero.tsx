...
import AuroraLigeroDeepViz from './viz/AuroraLigeroDeepViz';
  ...
  return (
    <section id="aurora-ligero" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Aurora vs Ligero 상세 비교</h3>        <div className="not-prose mb-4"><AuroraLigeroDeepViz /></div>
      </div>
    </section>
  );
}
