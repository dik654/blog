...
import IOPDefinitionViz from './viz/IOPDefinitionViz';
  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">IOP 개념 상세</h3>        <div className="not-prose mb-4"><IOPDefinitionViz /></div>
      </div>
    </section>
  );
}
