  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>libiop</strong>는 Interactive Oracle Proof(IOP) 기반 zkSNARK
          프로토콜들의 참조 구현체입니다.
          <br />
          Aurora, Ligero, Fractal 세 가지 프로토콜을 지원하며, 모두{" "}
          <strong>투명 셋업</strong>(trusted setup 불필요)과
          ...
          annotations={[
            {
              lines: [2, 5],
              color: "sky",
              note: "Aurora / Ligero / Fractal 프로토콜",
            },
