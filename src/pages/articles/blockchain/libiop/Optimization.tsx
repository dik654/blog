    ...
    <section id="optimization" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong>NTT</strong>(Number Theoretic Transform)로 다항식 연산을
          가속하고, 배치 역원 계산, 코셋 FFT, 지연 머클 트리 등으로 메모리와
          연산 비용을 줄입니다.
        </p>
        <h3>NTT(Number Theoretic Transform)</h3>
        <CodePanel
          title="OptimizedNTT 구현"
          code={FFT_CODE}
          annotations={[
