...
import OptimizationTechniquesViz from './viz/OptimizationTechniquesViz';
  ...
  return (
    <section id="optimization" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Cryptographic Engineering 최적화</h3>        <div className="not-prose mb-4"><OptimizationTechniquesViz /></div>
      </div>
    </section>
  );
}
