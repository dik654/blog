    ...
    <section id="fractal" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong>인덱서(Indexer)</strong>를 통한 전처리로 검증 시간을 O(N)에서{" "}
          <strong>O(log N)</strong>으로 단축합니다.
          <br />
          동일한 회로에 대해 인덱스를 재사용할 수 있어 대규모 시스템에서
          효율적입니다.
        </p>
        <h3>인덱서: 행렬 분해</h3>
        <CodePanel
          title="Fractal 인덱서 구조"
          code={FRACTAL_CODE}
          annotations={[
