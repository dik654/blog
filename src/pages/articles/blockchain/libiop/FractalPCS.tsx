...
import FractalHolographicViz from './viz/FractalHolographicViz';
  ...
  return (
    <section id="fractal" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Holographic IOP 개념</h3>        <div className="not-prose mb-4"><FractalHolographicViz /></div>
      </div>
    </section>
  );
}
