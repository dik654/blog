...
import BCSTransformDeepViz from './viz/BCSTransformDeepViz';
  ...
  return (
    <section id="bcs" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">BCS Transform 수학적 배경</h3>        <div className="not-prose mb-4"><BCSTransformDeepViz /></div>
      </div>
    </section>
  );
}
