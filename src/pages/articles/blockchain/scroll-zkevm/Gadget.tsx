  ...
  return (
    <section id="gadget" className="mb-16 scroll-mt-20">
      <h2 className="text-2xl font-bold mb-6">
        {title ?? "ExecutionGadget -- 오퍼코드 회로 구현"}
      </h2>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        {_onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                _onCodeRef("add-sub-gadget", codeRefs["add-sub-gadget"])
              }
            />
            ...
            <CodeViewButton
              onClick={() =>
                _onCodeRef("add-sub-assign", codeRefs["add-sub-assign"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              assign
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
            <div className="rounded border border-sky-200 dark:border-sky-800 bg-sky-50 dark:bg-sky-950/30 p-3">
              ...
              <ul className="space-y-1 text-foreground/80">
                <li>
                  <code className="text-xs">NAME: &'static str</code>
                </li>
                <li>
                  <code className="text-xs">
            ...
            <div className="rounded border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/30 p-3">
              ...
              <p className="text-foreground/80">
                <code className="text-xs">
                  fn configure(cb: &mut EVMConstraintBuilder&lt;F&gt;) -&gt;
                  Self
                </code>
              </p>
            ...
            <div className="rounded border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 p-3">
              ...
              <p className="text-foreground/80">
                <code className="text-xs">
                  fn assign_exec_step(&self, region, offset, block, transaction,
                  call, step)
                </code>
              </p>
              <p className="text-xs text-muted-foreground mt-1">
        ...
        <div className="not-prose rounded-lg border border-border bg-muted/30 p-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm mb-3">
            ...
            <div className="rounded border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/30 p-3">
              ...
              <ul className="space-y-1 text-foreground/80">
                <li>
                  <code className="text-xs">query_word_rlc()</code>로 a, b, c
                  워드 쿼리
                </li>
                <li>
                  <code className="text-xs">
                    AddWordsGadget::construct(cb, [a, b], c)
                  </code>
                </li>
                <li>
                  <code className="text-xs">PairSelectGadget</code>으로 ADD/SUB
                  분기
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div className="rounded border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 p-3">
              ...
              <ul className="space-y-1 text-foreground/80">
                <li>
                  <code className="text-xs">
                    cb.stack_pop(select(is_sub, c, a))
                  </code>
                </li>
                <li>
                  <code className="text-xs">cb.stack_pop(b)</code>
                </li>
                <li>
                  <code className="text-xs">
                    cb.stack_push(select(is_sub, a, c))
                  </code>
                </li>
              </ul>
            </div>
            <div className="rounded border border-violet-200 dark:border-violet-800 bg-violet-50 dark:bg-violet-950/30 p-3">
              ...
              <ul className="space-y-1 text-foreground/80">
                <li>
                  <code className="text-xs">rw_counter: Delta(3)</code>
                </li>
                <li>
                  <code className="text-xs">program_counter: Delta(1)</code>
                </li>
                <li>
                  <code className="text-xs">stack_pointer: Delta(1)</code>
                </li>
                <li>
                  <code className="text-xs">gas_left: Delta(-3)</code> — ADD gas
                  cost
                </li>
              </ul>
            </div>
        ...
        <div className="not-prose rounded-lg border border-border bg-muted/30 p-4 mb-6">
          <p className="text-sm font-semibold mb-3">
            <span className="text-muted-foreground font-normal">
              bus-mapping 크레이트: EVM 실행 트레이스 → 회로 입력 변환
            </span>
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div className="rounded border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/30 p-3">
              ...
              <ul className="space-y-1 text-foreground/80">
                <li>
                  <code className="text-xs">
                    a = block.get_rws(step, 0).stack_value()
                  </code>
                </li>
                <li>
                  <code className="text-xs">
                    b = block.get_rws(step, 1).stack_value()
                  </code>
                </li>
                <li>
                  <code className="text-xs">c = a.overflowing_add(b).0</code>
                </li>
                <li>
                  <code className="text-xs">
                    add_words.assign(region, offset, [a, b], c)
                  </code>
                </li>
              </ul>
            </div>
            <div className="rounded border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 p-3">
              ...
              <ol className="space-y-1 text-foreground/80 list-decimal list-inside">
                <li>
                  bus-mapping으로 EVM 트레이스 재실행 →{" "}
                  <code className="text-xs">Block</code> 생성
                </li>
                <li>
                  <code className="text-xs">
                    EvmCircuit::synthesize(&block)
                  </code>{" "}
                  → 어드바이스 열 할당
                </li>
                <li>
                  <code className="text-xs">create_proof()</code> → KZG 커밋 +
                  SHPLONK 개구 증명
                </li>
        ...
        <h3 className="text-xl font-semibold mt-8 mb-3">
          Gadget Pattern -- DRY for 140+ Opcodes
        </h3>
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          ...
          <div className="rounded-lg border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/30 p-4">
            ...
            <ul className="text-sm space-y-1 text-foreground/80">
              <li>
                <code className="text-xs">AddWordsGadget</code> — 256-bit 덧셈
              </li>
              <li>
                <code className="text-xs">CmpGadget</code> — 비교 연산
              </li>
              <li>
                <code className="text-xs">RangeCheck</code> — 값 범위 검증
              </li>
              <li>
                <code className="text-xs">LookupGadget</code> — table lookup
              </li>
            </ul>
          </div>
          <div className="rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 p-4">
            ...
            <ul className="text-sm space-y-1 text-foreground/80">
              <li>
                <code className="text-xs">AddGadget</code> — AddWordsGadget
                재사용
              </li>
              <li>
                <code className="text-xs">SubGadget</code> — AddGadget 역연산
              </li>
              <li>
                <code className="text-xs">MulGadget</code> — AddWordsGadget 반복
              </li>
            </ul>
          </div>
        </div>
        <div className="not-prose rounded-lg border border-border bg-muted/30 p-4 mb-6">
          ...
          <p className="text-sm text-foreground/80 mb-2">
            Pop x, y → Push x+y → PC+=1 → gas-=3 — 모든 step이 common gadget으로
            구성
          </p>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: configure vs assign 분리
          </p>
          <p>
            <strong>configure (compile-time)</strong>: 제약식 등록, 회로 구조
            정의
            <br />
            <strong>assign (runtime)</strong>: 실제 witness 값 할당, 증명 생성
            <br />
