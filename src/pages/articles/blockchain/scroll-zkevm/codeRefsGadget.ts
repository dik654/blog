    ...
    annotations: [
      {
        lines: [22, 27],
        color: "sky",
        note: "AddSubGadget 필드 — SameContext, AddWords, PairSelect",
      },
      {
        lines: [34, 40],
        color: "emerald",
        note: "워드 쿼리 + AddWordsGadget으로 a+b=c 제약",
      },
      {
        lines: [43, 48],
        color: "amber",
        note: "PairSelectGadget — SUB이면 a↔c 교환",
      },
      {
        lines: [52, 54],
        color: "violet",
        note: "스택 팝/푸시 — RwTable 룩업 제약",
      },
      {
        lines: [57, 64],
        color: "rose",
        note: "상태 전환 — rw_counter+3, pc+1, stack_ptr+1, gas-3",
      },
    ],
    ...
    annotations: [
      {
        lines: [85, 91],
        color: "sky",
        note: "RW 인덱스 재배치 — SUB이면 [2,1,0] 순서",
      },
      {
        lines: [92, 99],
        color: "emerald",
        note: "add_words/is_sub/same_context 셀 할당",
      },
    ],
    ...
    annotations: [
      {
        lines: [1, 10],
        color: "sky",
        note: "모듈 임포트 — Halo2, eth-types, CopyTable",
      },
    ],
