    ...
    annotations: [
      {
        lines: [40, 43],
        color: "sky",
        note: "EvmCircuitConfig — fixed_table, byte_table, execution",
      },
      {
        lines: [45, 58],
        color: "emerald",
        note: "서브회로 테이블 참조 — tx/rw/bytecode/copy/keccak/sig/ecc",
      },
    ],
    ...
    annotations: [
      {
        lines: [239, 242],
        color: "sky",
        note: "ExecutionGadget 트레이트 — NAME, EXECUTION_STATE",
      },
      {
        lines: [244, 244],
        color: "emerald",
        note: "configure — 제약 정의 (keygen 시 호출)",
      },
      {
        lines: [246, 254],
        color: "amber",
        note: "assign_exec_step — 실행 트레이스로 셀 할당 (prove 시)",
      },
    ],
    ...
    annotations: [
      {
        lines: [258, 262],
        color: "sky",
        note: "q_usable — 유효 행 선택자 (블라인딩 행 제외)",
      },
      {
        lines: [264, 268],
        color: "emerald",
        note: "q_step — 동적 높이 실행 스텝 시작점",
      },
    ],
