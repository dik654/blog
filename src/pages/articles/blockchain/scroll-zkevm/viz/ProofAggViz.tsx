...
const STEPS = [
  {
    label: "Chunk 증명",
    body: "연속된 블록 묶음을 SuperCircuit으로 증명합니다. 동적 크기(k값)를 결정합니다.",
  },
  {
    label: "Batch 집계",
    body: "여러 Chunk 증명을 집계하여 중간 상태 루트의 연속성을 검증합니다.",
  },
  {
    label: "Bundle 압축",
    body: "최종 Bundle 증명을 생성하여 L1 검증 컨트랙트에 제출합니다.",
  },
];
