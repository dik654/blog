...
const STEPS = [
  {
    label: "Scroll zkEVM 서브회로 구조",
    body: "EVM Circuit을 중심으로 6개 서브회로가 공유 테이블로 연결됩니다.",
  },
  {
    label: "EVM Circuit — 실행 엔진",
    body: "오퍼코드별 ExecutionGadget이 RwTable과 BytecodeTable을 조회합니다.",
  },
  {
    label: "Keccak & MPT — 상태 검증",
    body: "Keccak 해시와 Merkle Patricia Trie로 스토리지 무결성을 증명합니다.",
  },
  {
    label: "Copy & Sig — 보조 회로",
    body: "메모리 복사 추적과 ECDSA 서명 검증을 별도 회로로 분리합니다.",
  },
  {
    label: "RwTable & TxTable — 공유 테이블",
    body: "모든 서브회로가 공유 테이블로 일관성을 유지합니다.",
  },
];
