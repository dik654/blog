...
const STEPS = [
  {
    label: "테이블 시스템 전체",
    body: "테이블을 통해 여러 회로가 데이터를 공유하고 일관성을 검증합니다.",
  },
  {
    label: "입력: TxTable -> EVM",
    body: "트랜잭션 메타데이터(nonce, gas, value)를 EVM Circuit에 제공합니다.",
  },
  {
    label: "코드: BytecodeTable -> EVM",
    body: "바이트코드의 각 바이트를 인덱스와 매핑하여 정확성을 보장합니다.",
  },
  {
    label: "상태: EVM -> RwTable -> State",
    body: "EVM의 모든 r/w 연산이 RwTable을 거쳐 State Circuit에서 검증됩니다.",
  },
  {
    label: "해시/복사/증명",
    body: "Keccak, Copy, MPT 테이블이 해시, 복사, 상태 트리를 각각 검증합니다.",
  },
];
