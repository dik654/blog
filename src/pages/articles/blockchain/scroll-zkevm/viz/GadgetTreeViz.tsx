...
const STEPS = [
  {
    label: "Gadget 시스템 전체",
    body: "gadgets/ 크레이트가 재사용 가능한 회로 컴포넌트를 제공합니다.",
  },
  {
    label: "기본 검증 Gadget",
    body: "IsZero -> IsEqual로 확장. 값이 0인지, 두 값이 같은지 검증합니다.",
  },
  {
    label: "비교 Gadget",
    body: "Lt(바이트 분해) + IsEqual = Comparator. LT/EQ/GT를 한 번에 계산합니다.",
  },
  {
    label: "산술 & 배치",
    body: "MulAdd(256비트 곱셈), AddWords(덧셈), BinaryNumber, BatchIsZero.",
  },
];
