export const recursionAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "1단계: 세그먼트별 STARK 병렬 생성",
  },
  {
    lines: [10, 13] as [number, number],
    color: "emerald" as const,
    note: "2단계: 재귀 압축 → SuccinctReceipt",
  },
  {
    lines: [15, 18] as [number, number],
    color: "amber" as const,
    note: "3단계: STARK → Groth16 SNARK",
  },
];
...
export const bonsaiAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "Bonsai 설정 — 환경 변수",
  },
  {
    lines: [9, 15] as [number, number],
    color: "emerald" as const,
    note: "클라우드 vs 로컬 증명 분기",
  },
];
