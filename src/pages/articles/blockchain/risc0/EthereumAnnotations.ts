export const verifierAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "IRiscZeroVerifier — 검증 인터페이스",
  },
  {
    lines: [10, 21] as [number, number],
    color: "emerald" as const,
    note: "VerifierRouter — 버전별 라우팅",
  },
  {
    lines: [23, 33] as [number, number],
    color: "amber" as const,
    note: "EmergencyStop — 취약점 발견 시 중단",
  },
];
...
export const appAnnotations = [
  {
    lines: [2, 8] as [number, number],
    color: "sky" as const,
    note: "컨트랙트 설정 — verifier + imageId",
  },
  {
    lines: [10, 18] as [number, number],
    color: "emerald" as const,
    note: "증명 제출 → 검증 → 상태 업데이트",
  },
];
