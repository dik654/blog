    ...
    annotations: [
      {
        lines: [47, 52],
        color: "sky",
        note: "Session 구조체 -- 전체 실행 트레이스를 캡슐화",
      },
      {
        lines: [52, 60],
        color: "emerald",
        note: "segments + input + journal -- 세그먼트 벡터와 공개 입출력",
      },
      {
        lines: [64, 70],
        color: "amber",
        note: "assumptions + hooks -- 조건부 증명과 이벤트 훅",
      },
      {
        lines: [72, 85],
        color: "violet",
        note: "row_count, insn_count, pre/post_state -- 실행 메트릭과 상태",
      },
    ],
    desc: `Session은 zkVM 실행의 전체 트레이스를 담는 컨테이너입니다.
    ...
    annotations: [
      {
        lines: [118, 125],
        color: "sky",
        note: "Segment 구조체 -- 단일 증명 단위의 실행 청크",
      },
      {
        lines: [127, 143],
        color: "emerald",
        note: "po2() -- 2의 거듭제곱 크기, get_info() -- 행/명령어 수 메트릭",
      },
    ],
    desc: `Segment는 ZKP 시스템에 대한 단일 호출로 증명되는 실행 청크입니다.
