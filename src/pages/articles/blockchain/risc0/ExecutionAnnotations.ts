export const pipelineAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "1단계: Executor — 추적 생성",
  },
  {
    lines: [11, 16] as [number, number],
    color: "emerald" as const,
    note: "2단계: Prover — 재귀 압축 증명",
  },
];
...
export const segmentAnnotations = [
  ...
  {
    lines: [6, 16] as [number, number],
    color: "emerald" as const,
    note: "Segment 구조체 — 상태 + I/O",
  },
  {
...
export const ioAnnotations = [
  {
    ...
    color: "sky" as const,
    note: "Host → Guest: stdin (비공개)",
  },
  {
    lines: [7, 9] as [number, number],
    color: "emerald" as const,
    note: "Guest → Host: Journal (공개)",
  },
  {
