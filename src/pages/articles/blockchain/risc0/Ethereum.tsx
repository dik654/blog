    ...
    <section id="ethereum" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          Solidity 컨트랙트 + Rust 라이브러리 제공
          <br />
          오프체인 계산 수행 → 결과만 온체인 검증
        </p>
        <CodePanel
          title="Verifier Router 패턴"
          code={VERIFIER_CODE}
          annotations={verifierAnnotations}
        />
        <CodePanel
          title="앱 컨트랙트 패턴"
          code={APP_CODE}
        ...
        />
        <p>
          Steel — 이더리움 상태(스토리지, 잔액 등)를 읽는 뷰 콜을 오프체인에서
          증명하는 라이브러리
        </p>
        <CodePanel
          title="Steel: EVM View Call 증명"
          code={STEEL_CODE}
          annotations={steelAnnotations}
        />
        <CodePanel
          title="증명 집계 (Aggregation)"
