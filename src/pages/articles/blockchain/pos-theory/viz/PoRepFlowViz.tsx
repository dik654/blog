...
const STEPS = [
  ...
  {
    label: "Seal: VDE로 순차 인코딩",
    body: "VDE(Verifiable Delay Encoding)로 순차적 인코딩. 병렬화 불가.",
  },
  {
    label: "고유 복제본 R 생성",
    body: "R = Seal(D, prover_id). 각 저장자마다 고유한 복제본을 생성합니다.",
  },
  {
    label: "Merkle 경로 + ZK 증명 생성",
    body: "복제본의 Merkle tree + zk-SNARK 증명을 생성합니다.",
  },
  {
    label: "온체인 검증",
    body: "온체인에서 증명을 검증하여 고유 복제본임을 확인합니다.",
  },
];
const NW = 62,
  NH = 34,
