  ...
  return (
    <section id="memory" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          S-two Cairo의 메모리 시스템은 증명 생성 효율을 위해 특별히
          설계되었습니다.
          <br />
          이중 저장 시스템으로 작은 값과 큰 값을 분리 관리하며, 빌트인
          세그먼트는 SIMD 병렬 처리를 위해 2의 거듭제곱 크기로 패딩됩니다.
        </p>
      </div>
