  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>Cairo</strong>는 StarkWare가 개발한 증명 가능한
          프로그램(provable program) 작성을 위한 언어입니다. Rust 스타일의
          소유권 시스템과 felt252 기반 타입 시스템을 갖추며, Salsa 쿼리 DB
          기반의 증분 컴파일 파이프라인을 통해 CASM으로 변환됩니다.
        </p>
      </div>
