...
const STEPS = [
  {
    label: "Cairo → S-two 증명 시스템 전체 흐름",
    body: "Cairo 소스에서 Circle STARK 증명 생성 및 검증까지의 파이프라인.",
  },
  {
    label: "Cairo VM 실행",
    body: "소스 코드를 CASM으로 컴파일하고 VM에서 실행하여 실행 추적을 생성합니다.",
  },
  {
    label: "어댑터 변환",
    body: "Cairo VM 출력을 재배치(relocate)하여 S-two Prover 입력 형식으로 변환합니다.",
  },
  {
    label: "증명 & 검증",
    body: "Circle STARK 증명을 생성하고, Cairo로 작성된 검증기로 온체인 검증합니다.",
  },
];
