...
const STEPS = [
  {
    label: "Sierra 타입 시스템 전체 구조",
    body: "기본 타입, 데이터 구조, 빌트인으로 구성됩니다.",
  },
  {
    label: "기본 타입: Felt252 & 정수",
    body: "felt252는 소수체 원소, 정수 타입은 범위 검사(RangeCheck)로 보장.",
  },
  {
    label: "복합 타입: Array, Struct, Enum",
    body: "Cairo의 복잡한 구조를 단순한 Sierra 명령어로 변환.",
  },
  {
    label: "빌트인 타입: Gas, RangeCheck, Starknet",
    body: "실행 환경과 상호작용하는 특수 타입들.",
  },
];
