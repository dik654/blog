...
const STEPS = [
  {
    label: "Starknet 컨트랙트 컴파일 흐름",
    body: "#[starknet::contract] → Plugin 처리 → Sierra/CASM 클래스 생성",
  },
  {
    label: "플러그인 처리",
    body: "StarknetPlugin이 컨트랙트를 발견하고 속성을 처리합니다.",
  },
  {
    label: "ABI 생성",
    body: "ABIAnalyzer가 외부 함수, 이벤트, 스토리지를 분석하여 ABI를 구성합니다.",
  },
  {
    label: "클래스 생성",
    body: "Sierra ContractClass → CASM ContractClass로 최종 변환합니다.",
  },
];
