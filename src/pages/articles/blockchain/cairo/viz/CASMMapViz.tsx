...
const ROWS = [
  {
    sierra: "felt252_add(a, b)",
    casm: "[ap] = [fp-3] + [fp-4]; ap++",
    color: "#8b5cf6",
  },
...
const STEPS = [
  {
    label: "Sierra → CASM 명령어 매핑",
    body: "각 Sierra 명령어가 1개 이상의 CASM 명령어로 변환됩니다.",
  },
  {
    label: "산술 연산 매핑",
    body: "felt252_add는 CASM의 덧셈 명령어로 직접 매핑됩니다.",
  },
  {
    label: "메모리 & 제어 흐름",
    body: "store_temp는 AP 레지스터를 사용하고, branch_align은 분기를 정렬합니다.",
  },
  {
    label: "함수 호출",
    body: "function_call은 스택 프레임 설정과 함께 CASM call 명령어로 변환됩니다.",
  },
];
