  ...
  "create-proposal-block": {
    ...
    annotations: [
      ...
      },
      {
        lines: [52, 53],
        color: "amber",
        note: "앱이 반환한 transaction 목록으로 proposal 후보를 구성한다. 구체적 response 형식은 ABCI 버전을 확인한다",
      },
    ],
  },
  "proxy-prepare": {
    ...
    annotations: [
      ...
      },
      {
        lines: [27, 27],
        color: "emerald",
        note: "app.appConn이 localClient이면 transport 직렬화 없이 함수 호출 경계로 전달",
      },
    ],
  },
  "local-prepare": {
    ...
    annotations: [
      ...
      },
      {
        lines: [43, 43],
        color: "emerald",
        note: "app.Application.PrepareProposal — 구체적 Application 구현으로 진입",
      },
    ],
  },
};
