...
import { STEPS, STEP_REFS, STEP_LABELS } from './CallPathData';
import { Step0, Step1, Step2 } from './CallPathSteps';

const RENDERERS = [Step0, Step1, Step2];

export default function CallPathViz({ onOpenCode }: { onOpenCode?: (key: string) => void }) {
  return (
    <StepViz steps={STEPS}>
      {(step) => {
