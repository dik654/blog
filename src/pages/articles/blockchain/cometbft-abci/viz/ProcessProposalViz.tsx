...
import { STEPS, STEP_REFS, STEP_LABELS } from './ProcessProposalData';
import { Step0, Step1, Step2 } from './ProcessProposalSteps';

const RENDERERS = [Step0, Step1, Step2];

export default function ProcessProposalViz({ onOpenCode }: { onOpenCode?: (key: string) => void }) {
  return (
    <StepViz steps={STEPS}>
      {(step) => {
