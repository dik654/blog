...
import { STEPS, STEP_REFS, STEP_LABELS } from './PrepareProposalData';
import { Step0, Step1, Step2, Step3 } from './PrepareProposalSteps';

const RENDERERS = [Step0, Step1, Step2, Step3];

export default function PrepareProposalViz({ onOpenCode }: { onOpenCode?: (key: string) => void }) {
  return (
    <StepViz steps={STEPS}>
      {(step) => {
