    ...
    <section id="comparison" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          Fast path 덕분에 소유 객체 TX는 100ms 이내 확정.
          <br />
...
// - Mysticeti가 Bullshark 대체`}
        ...
        <p className="leading-7">
          Mysticeti: <strong>5x latency, 23% throughput, 30% bandwidth</strong>.
          <br />
          모든 metric에서 Bullshark 우위.
          <br />
...
// - Cross-chain consensus`}
        ...
        <p className="leading-7">
          후속 연구:{" "}
          <strong>async-safe, 2-round commit, sharding, privacy</strong>.<br />
          Shoal++, Autobahn 등 경쟁 연구 활발.
          <br />
...
// 각자 다른 방향 탐색`}
        ...
        <p className="leading-7">
          Sui 전환 이유:{" "}
          <strong>UX (sub-1s), scalability (160K), bandwidth (30% 절약)</strong>
          .<br />
          2024 state-of-the-art production BFT.
          <br />
          학계 vs 실무의 다른 방향 — 모두 DAG-BFT 진화.
        </p>

        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 왜 "Mysticeti를 채택한 Sui"가 중요한가</strong> — 현실
          검증.
          <br />
          HotStuff-2, Autobahn 이론 더 좋지만 production 없음.
          <br />
          Mysticeti는 실제 Sui mainnet 2024 — 수억 USD 처리.
          <br />
