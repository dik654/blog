  ...
  return (
    <section id="gpu" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          VRAM이 부족하면 chunking과 host-device transfer가 늘고, 너무 작은
          batch는 GPU utilization을 떨어뜨립니다. CPU fallback과 여러 GPU의
          work split도 circuit shape와 runtime 설정에 따라 달라집니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          CPU 대비 배수나 특정 GPU의 분 단위 결과를 일반화하지 않고, parameter
          checksum, circuit, batch, backend commit과 power limit을 고정합니다.
          이후 MSM·FFT·transfer·I/O 시간과 peak VRAM을 나눠야 어떤 최적화가
          실제 proving time을 줄였는지 확인할 수 있습니다.
        </p>
      </div>
    </section>
  );
