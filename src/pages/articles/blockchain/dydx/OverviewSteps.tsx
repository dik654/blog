...
const LINES = [
  {
    code: "priceDaemon.Start(ctx)  // 거래소 가격 피드 수집 (5ms 간격)",
    color: "#6366f1",
  },
  {
    code: "app.InitModules(clobKeeper, perpKeeper, subKeeper, ...)",
    color: "#10b981",
  },
  {
    code: "indexer := streaming.NewIndexerEventManager(kafkaProducer)",
    color: "#f59e0b",
  },
];
