...
const STEPS = [
  {
    label: "Indexer — 5개 마이크로서비스",
    body: "Protocol 이벤트를 Kafka로 수신 → PostgreSQL에 구조화 → REST/WebSocket으로 제공.",
  },
  {
    label: "Kafka: 이벤트 스트리밍 플랫폼",
    body: "Protocol Layer의 블록 이벤트를 실시간 스트리밍.\n온체인/오프체인 이벤트를 분리하여 각각 다른 서비스로 전달.",
  },
  {
    label: "Ender + Vulcan: 이벤트 처리",
    body: "Ender — 온체인 이벤트(체결, 상태 변경) 파싱 & DB 저장.\nVulcan — 오프체인 이벤트(주문 업데이트) 처리.",
  },
  {
    label: "PostgreSQL: 통합 데이터베이스",
    body: "orders 테이블: id, side, size, price, status, type.\nfills 테이블: side, liquidity(TAKER/MAKER), size, price, fee.",
  },
  {
    label: "Comlink + Socks: API 서빙",
    body: "Comlink — Express.js REST API (오더북, 포지션, 체결 조회).\nSocks — WebSocket 실시간 스트리밍 (v4_orderbook, v4_trades).",
  },
];
