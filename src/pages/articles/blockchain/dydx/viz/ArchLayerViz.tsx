...
const STEPS = [
  {
    ...
    body: "거래소 가격 수집, 이더리움 브릿지, 클라이언트 앱이 연결됩니다.",
  },
  {
    label: "Protocol Layer",
    body: "Cosmos SDK + CometBFT 기반 코어. CLOB 모듈이 온체인 오더북을 관리합니다.",
  },
  {
    label: "Daemon Processes",
    body: "Price/Liquidation/Bridge 3개 데몬이 외부 데이터를 중계합니다.",
  },
  {
    label: "Kafka 메시지 큐",
    body: "Protocol 이벤트를 비동기로 Indexer Layer에 전달합니다.",
  },
  {
    label: "Indexer Layer",
    body: "Ender, Vulcan, Comlink, Socks, Roundtable 5개 서비스로 데이터를 제공합니다.",
  },
];
        ...
        >
          ...
          <motion.g animate={{ opacity: step <= 2 ? 1 : 0.2 }} transition={sp}>
            <rect
              ...
              height={152}
              rx={8}
              fill={step === 1 ? "#10b98110" : "transparent"}
              stroke="#10b981"
            ...
            <motion.g
              animate={{ opacity: step === 2 ? 1 : step <= 2 ? 0.6 : 0.2 }}
              transition={sp}
            >
          ...
          <motion.g
            animate={{ opacity: step === 3 ? 1 : step >= 3 ? 0.6 : 0.25 }}
            transition={sp}
          >
            <text
              x={230}
          ...
          <motion.g animate={{ opacity: step === 4 ? 1 : 0.2 }} transition={sp}>
            <rect
              ...
              height={45}
              rx={8}
              fill={step === 4 ? "#ec489918" : "#ec489908"}
              stroke="#ec4899"
              strokeWidth={step === 4 ? 2 : 0.8}
            />
