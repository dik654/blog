...
const STEPS = [
  {
    label: "Protocol 이벤트",
    body: "블록 처리 중 체결, 주문 업데이트, 가격 변경 등의 이벤트 발생",
  },
  {
    label: "Kafka 전달",
    body: "Apache Kafka를 통해 비동기적으로 Indexer 서비스에 전달",
  },
  {
    label: "Ender 처리",
    body: "Ender가 온체인 이벤트를 파싱하여 구조화된 데이터로 변환",
  },
  {
    label: "PostgreSQL 저장",
    body: "변환된 데이터가 PostgreSQL에 저장되고 인덱싱",
  },
  {
    label: "API 서빙",
    body: "Comlink(REST)과 Socks(WebSocket)이 클라이언트에 데이터를 제공합니다.",
  },
];
