...
const STEPS = [
  {
    label: "주문 제출",
    body: "클라이언트가 gRPC/HTTP로 주문을 Protocol에 제출",
  },
  {
    label: "체결 이벤트",
    body: "Protocol에서 매칭 완료 후 체결 이벤트를 Kafka로 발행",
  },
  {
    label: "Indexer 수신",
    body: "Ender가 Kafka 이벤트를 소비하여 PostgreSQL에 저장합니다.",
  },
  {
    label: "실시간 전달",
    body: "Socks WebSocket으로 클라이언트에 실시간 업데이트를 전송합니다.",
  },
];
