...
const LINES = [
  {
    code: "type Orderbook struct { Bids *rbtree.Tree; Asks *rbtree.Tree }",
    color: "#6366f1",
    desc: "Bids(매수)/Asks(매도) 레드-블랙 트리",
  },
  {
    code: "type Level struct { Orders []Order } // 동일 가격 FIFO 큐",
    color: "#10b981",
    desc: "같은 가격의 주문들을 시간순 정렬",
  },
  {
    code: "type Order struct { Id OrderId; Side; Quantums; Subticks }",
    color: "#f59e0b",
    desc: "Short-Term(인메모리) / Long-Term(상태 저장) / Conditional",
  },
];
