...
const GROUPS = [
  {
    code: "clobKeeper := clob.NewKeeper(cdc, storeKey, perpKeeper, subKeeper)",
    color: "#6366f1",
    desc: "Trading: clob + perpetuals + subaccounts + feetiers",
  },
  {
    code: "pricesKeeper := prices.NewKeeper(cdc, storeKey, daemonClient)",
    color: "#10b981",
    desc: "Core: prices + assets + epochs + blocktime",
  },
  {
    code: "bridgeKeeper := bridge.NewKeeper(cdc, storeKey, accountKeeper)",
    color: "#f59e0b",
    desc: "Support: bridge + rewards + delaymsg + stats",
  },
];
