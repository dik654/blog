...
const LINES = [
  {
    code: "cacheCtx, writeCache := ctx.CacheContext()  // 롤백 준비",
    color: "#6366f1",
  },
  {
    code: "bestOrder := ob.getBestOrder(side)  // 가격-시간 우선순위",
    color: "#10b981",
  },
  {
    code: "if !canMatch(taker.Price, bestOrder.Price) { break }",
    color: "#8b5cf6",
  },
  {
    code: "if !k.CheckCollateral(ctx, subaccount) { return err }",
    color: "#f59e0b",
  },
  {
    code: "fillAmt := min(taker.Remaining, maker.Remaining); writeCache()",
    color: "#ef4444",
  },
];
