...
const STEPS = [
  {
    label: "전체 컴파일 파이프라인",
    body: ".circom 소스 → Parser → AST → 타입 분석 → 제약 생성 → 최적화 → 출력 파일",
  },
  {
    label: "파싱 단계",
    body: "LALRPOP 기반 파서가 .circom 파일을 토큰화하고 AST를 생성합니다.",
  },
  {
    label: "분석 & 제약 생성",
    body: "타입 분석으로 신호를 검증하고, build_circuit()으로 R1CS 제약을 생성합니다.",
  },
  {
    label: "최적화 & 출력",
    body: "DAG 기반 제약 최적화 후 .r1cs, .wasm, .sym 파일을 출력합니다.",
  },
];
