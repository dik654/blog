...
const STEPS = [
  {
    label: "Circom + snarkjs 전체 흐름",
    body: "컴파일 → 셋업 → 증인 → 증명 → 검증의 5단계 파이프라인",
  },
  {
    label: "컴파일 & 셋업",
    body: ".circom → .r1cs/.wasm 컴파일 후 Powers of Tau + zKey로 키를 생성합니다.",
  },
  {
    label: "증인 계산 & 증명",
    body: "WASM으로 증인을 계산하고, Groth16으로 증명을 생성합니다.",
  },
  {
    label: "온체인 검증",
    body: "검증키로 증명을 검증하거나, Solidity Verifier 계약으로 온체인 검증합니다.",
  },
];
