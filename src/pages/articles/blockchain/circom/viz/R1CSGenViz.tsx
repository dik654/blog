...
const STEPS = [
  {
    label: "제약 생성 전체 흐름",
    body: "AST → 인스턴스화 → ExecutedProgram → DAG → 최적화 → R1CS 출력",
  },
  {
    label: "인스턴스화",
    body: "메인 컴포넌트부터 재귀적으로 하위 템플릿을 인스턴스화하고 제약을 수집합니다.",
  },
  {
    label: "DAG 변환 & 최적화",
    body: "제약 그래프를 DAG로 변환하고, 상수 전파 및 중복 제거를 수행합니다.",
  },
  {
    label: "R1CS 직렬화",
    body: "최적화된 제약을 A·B=C 형태의 R1CS 바이너리 파일로 출력합니다.",
  },
];
