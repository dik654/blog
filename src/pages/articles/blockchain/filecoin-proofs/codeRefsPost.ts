    ...
    annotations: [
      {
        lines: [32, 37],
        color: "sky",
        note: "generate_window_post_with_vanilla — 바닐라 증명 → SNARK",
      },
      {
        lines: [44, 47],
        color: "emerald",
        note: "randomness/prover_id를 Hasher::Domain으로 변환",
      },
      {
        lines: [60, 62],
        color: "amber",
        note: "FallbackPoStCompound::setup + Groth16 파라미터 로드",
      },
      {
        lines: [72, 77],
        color: "violet",
        note: "PublicInputs 조립 — randomness, prover_id, sectors",
      },
    ],
    ...
    annotations: [
      {
        lines: [28, 36],
        color: "sky",
        note: "SetupParams — sector_size, challenge_count, sector_count, api_version",
      },
      {
        lines: [39, 47],
        color: "emerald",
        note: "PublicParams — PoSt 검증 파라미터",
      },
      {
        lines: [50, 53],
        color: "amber",
        note: "ChallengeRequirements — 최소 챌린지 수 (파티션 합산)",
      },
      {
        lines: [71, 80],
        color: "violet",
        note: "PublicInputs — randomness, prover_id, sectors, partition k",
      },
    ],
