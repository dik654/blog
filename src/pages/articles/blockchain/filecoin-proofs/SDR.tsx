  ...
  return (
    <section id="sdr" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          이 구조가 모든 병렬 계산을 금지하는 것은 아닙니다. 준비가 끝난 구간은 window 단위로 함께 처리할 수
          있지만, 레이어 사이의 핵심 의존성은 순서대로 따라가야 합니다. 결국 공격자가 저장 공간을 아끼려고 replica를
          필요할 때마다 다시 만들면 정상적인 저장 제공자보다 큰 시간 비용을 치르게 됩니다.
        </p>
        {onCodeRef && (
        ...
        <p className="leading-7">
          요약하면 SDR의 보안 성질은 “해시를 많이 계산한다”는 한 문장보다, 11개 레이어와 부모 의존성이 계산
          순서를 강제한다는 데 있습니다. 이 시간·공간 trade-off 때문에 replica를 계속 보관하는 편이 챌린지 때마다
          다시 계산하는 것보다 경제적으로 유리해집니다.
        </p>
      </div>
    </section>
  );
