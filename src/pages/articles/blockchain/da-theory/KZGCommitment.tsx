...
export default function KZGCommitment({
  onCodeRef,
}: {
    ...
    <section id="kzg-commitment" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          KZG(Kate-Zaverucha-Goldberg)는 다항식 커밋먼트 스킴(polynomial
          commitment scheme)이다.
          <br />
          데이터를 다항식으로 인코딩한 뒤, 그 다항식의 "지문"(커밋먼트)을
          48바이트 G₁ 점으로 만든다.
          <br />
          원본 128KB 없이 커밋먼트(48B)와 증명(48B)만으로 데이터 무결성을 O(1)에
          검증할 수 있다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-4">
        ...
        <p className="leading-7">
          go-ethereum의 <code>crypto/kzg4844</code> 패키지에서 commit, proof,
          verify가 어떻게 호출되는지 추적한다.
        </p>
      </div>
