    ...
    <motion.g initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 1: excess := interpreter.evm.Context.ExcessBlobGas // 헤더에서
          읽기
        </text>
      </motion.g>
      <motion.g
    ...
    <motion.g initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 1: jt[0x49] = operation{"{"}execute: opBlobHash, gas: 3, stack:
          1→1{"}"}
        </text>
      </motion.g>
      <motion.g
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 2: jt[0x4A] = operation{"{"}execute: opBlobBaseFee, gas: 3,
          stack: 0→1{"}"}
        </text>
      </motion.g>
      <motion.g
