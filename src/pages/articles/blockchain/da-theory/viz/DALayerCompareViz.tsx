...
const STEPS = [
  {
    label: "세 가지 DA 레이어 비교",
    body: "DA 레이어는 블록체인의 데이터 가용성만 전담하는 모듈러 인프라입니다.",
  },
  {
    label: "Celestia: 최초의 모듈러 DA",
    body: "Celestia는 2D RS 코딩 + Tendermint 합의로 DA를 제공합니다.",
  },
  {
    label: "EigenDA: 이더리움 재스테이킹 기반",
    body: "EigenDA는 ETH 재스테이킹 오퍼레이터들이 DA를 제공합니다.",
  },
  {
    label: "Avail: 앱체인 최적화 DA",
    body: "Avail은 KZG 커밋먼트 + 앱체인 전용 DA를 제공합니다.",
  },
];
const BX = [80, 230, 380],
  BY = 45,
