    ...
    annotations: [
      {
        lines: [114, 116],
        color: "sky",
        note: "블록당 최대 blob 가스 = Max블럽 x 131072",
      },
      {
        lines: [117, 119],
        color: "emerald",
        note: "blob 가스는 131072의 배수 — 부분 blob 불허",
      },
      {
        lines: [122, 125],
        color: "amber",
        note: "CalcExcessBlobGas로 계산한 기대값과 비교",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [148, 149],
        color: "sky",
        note: "부모 excess + 부모 사용량 합산",
      },
      {
        lines: [151, 153],
        color: "emerald",
        note: "target 미만이면 excess = 0 (가격 최저)",
      },
      {
        lines: [157, 166],
        color: "amber",
        note: "EIP-7918: blobPrice < reservePrice면 완화된 공식 적용",
      },
      {
        lines: [170, 170],
        color: "rose",
        note: "원본 EIP-4844: excess - target (단순 차감)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [220, 221],
        color: "sky",
        note: "accum = factor x denominator (테일러 초항)",
      },
      {
        lines: [222, 228],
        color: "emerald",
        note: "테일러 급수: accum = accum x num / denom / i (수렴할 때까지)",
      },
