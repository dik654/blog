...
export const gethTree: FileNode = d("go-ethereum", [
  d("core", [
    ...
    d("txpool", [
      f(
        "validation.go — validateBlobTx()",
        "go-ethereum/core/txpool/validation.go",
        "blob-validate-tx",
      ),
      f(
        "validation.go — validateBlobSidecar()",
        "go-ethereum/core/txpool/validation.go",
  ...
  d("crypto", [
    d("kzg4844", [
      ...
      f(
        "kzg4844.go — Commit/Verify",
        "go-ethereum/crypto/kzg4844/kzg4844.go",
        "kzg-commit-verify",
      ),
      f(
        "kzg4844.go — Cell Proofs",
        "go-ethereum/crypto/kzg4844/kzg4844.go",
        "kzg-cell-proofs",
      ),
    ]),
  ...
  d("consensus/misc", [
    d("eip4844", [
      f(
        "eip4844.go — VerifyHeader()",
        "go-ethereum/consensus/misc/eip4844/eip4844.go",
        "blob-gas-verify",
      ),
      f(
        "eip4844.go — CalcExcessBlobGas()",
        "go-ethereum/consensus/misc/eip4844/eip4844.go",
        "blob-excess-calc",
      ),
      f(
        "eip4844.go — fakeExponential()",
        "go-ethereum/consensus/misc/eip4844/eip4844.go",
