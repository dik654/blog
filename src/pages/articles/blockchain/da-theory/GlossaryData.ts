...
export const DA_TERMS: GlossaryTerm[] = [
  {
    ...
    articleLink: "/cs/blockchain/reth-eip4844",
  ...
  },
  {
    ...
    articleLink: "/cs/blockchain/polycommit",
    articleTitle: "다항식 커밋먼트: KZG·IPA·Linear Codes 구현 비교",
  },
  {
    icon: "🤝",
    name: "Trusted Setup (신뢰 설정)",
    en: "Structured Reference String",
    ...
    articleLink: "/cs/blockchain/groth16",
    articleTitle: "Groth16: Trusted Setup 상세",
  },
  {
    icon: "📐",
    name: "BLS12-381",
    en: "Barreto-Lynn-Scott curve",
  ...
  },
  {
    ...
    articleLink: "/cs/blockchain/evm-fundamentals",
    articleTitle: "EVM 완전 분석: 스택 머신에서 인터프리터까지",
  },
  {
    icon: "🔢",
    name: "Reed-Solomon 부호",
    ...
    articleLink: "/cs/blockchain/reed-solomon",
    articleTitle: "Reed-Solomon 부호: 이레이저 코딩 구현",
  },
  {
    icon: "🎲",
    name: "DAS",
    en: "Data Availability Sampling",
