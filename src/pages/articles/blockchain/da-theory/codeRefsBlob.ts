    ...
    annotations: [
      {
        lines: [57, 57],
        color: "amber",
        note: "BlobFeeCap — blob 가스의 최대 가격 (별도 수수료 시장)",
      },
      {
        lines: [58, 58],
        color: "sky",
        note: "BlobHashes — 각 blob 커밋먼트의 versioned hash",
      },
      {
        lines: [62, 62],
        color: "emerald",
        note: 'Sidecar — 실제 blob 데이터 + 증명. rlp:"-"로 블록 직렬화에서 제외',
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [72, 72],
        color: "amber",
        note: "Version — 0: blob proof(Cancun), 1: cell proof(Osaka/DAS 대비)",
      },
      {
        lines: [73, 75],
        color: "sky",
        note: "Blobs[131072B] + Commitments[48B] + Proofs[48B]",
      },
      {
        lines: [89, 96],
        color: "emerald",
        note: "SHA256(commitment)에 version byte 0x01 접두사 → versioned hash",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [168, 173],
        color: "amber",
        note: "Osaka 이후 Version1(cell proof), 이전은 Version0(blob proof)",
      },
      {
        lines: [181, 186],
        color: "sky",
        note: "빈 blob 금지 + 최대 6개 제한 (BlobTxMaxBlobs)",
      },
      {
        lines: [191, 191],
        color: "emerald",
        note: "커밋먼트에서 계산한 hash와 tx의 BlobHashes 비교",
      },
      {
        lines: [195, 199],
        color: "rose",
        note: "version별 분기: Legacy(blob proof) vs Osaka(cell proof)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [206, 208],
        color: "sky",
        note: "V0: blob마다 VerifyBlobProof — O(n) 개별 검증",
      },
      {
        lines: [214, 219],
        color: "emerald",
        note: "V1: VerifyCellProofs — 128개 cell proof 배치 검증",
      },
    ],
  },
};
