    ...
    annotations: [
      {
        lines: [42, 42],
        color: "sky",
        note: "Blob [131072]byte — 128KB 고정. 4096개 BLS 필드 원소",
      },
      {
        lines: [55, 55],
        color: "emerald",
        note: "Commitment [48]byte — 다항식 커밋먼트 (G1 점)",
      },
      {
        lines: [68, 68],
        color: "amber",
        note: "Proof [48]byte — 몫 다항식의 커밋먼트 (G1 점)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [110, 115],
        color: "sky",
        note: "BlobToCommitment — blob → 다항식 보간 → G1 커밋 (trusted setup 사용)",
      },
      {
        lines: [139, 144],
        color: "emerald",
        note: "ComputeBlobProof — (blob, commitment) → proof",
      },
      {
        lines: [147, 152],
        color: "amber",
        note: "VerifyBlobProof — blob와 commitment의 일치를 증명으로 검증",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [157, 162],
        color: "sky",
        note: "VerifyCellProofs — 128 x blobCount개 proof 배치 검증",
      },
      {
        lines: [168, 173],
        color: "emerald",
        note: "ComputeCellProofs — blob → 128개 cell proof 생성",
      },
      {
        lines: [177, 186],
        color: "amber",
        note: "CalcBlobHashV1 — SHA256(commitment)에 version 0x01 접두사",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [282, 288],
        color: "sky",
        note: "BlobHashes 배열 범위 확인 → 범위 밖이면 Clear(0)",
      },
      {
        lines: [293, 296],
        color: "emerald",
        note: "BLOBBASEFEE — 현재 블록의 blob 기본 수수료를 push",
      },
      {
        lines: [308, 313],
        color: "amber",
        note: "enable4844 — Cancun JumpTable에 BLOBHASH 등록",
      },
    ],
  },
};
