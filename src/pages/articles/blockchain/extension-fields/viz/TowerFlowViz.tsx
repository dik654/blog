...
const STEPS = [
  {
    label: "Fp: 256-bit 소수체",
    body: "BN254의 기초체. 모든 확장의 출발점입니다.",
  },
  {
    label: "Fp → Fp2: 복소수 확장",
    body: "u²=-1로 이차 확장. a₀+a₁u. G2 좌표 공간. Conjugate = Frobenius.",
  },
  {
    label: "Fp2 → Fp6: Karatsuba 적용",
    body: "v³=ξ(9+u)로 삼차 확장. Fp2 원소 3개. Karatsuba: 6×Fp2 mul.",
  },
  {
    label: "Fp6 → Fp12: 페어링 공간",
    body: "w²=v로 이차 확장. 총 12개 Fp 원소. Miller Loop 결과가 여기에.",
  },
  {
    label: "GT: 페어링 결과 부분군",
    body: "Fp12*의 r차 부분군. e(P,Q) ∈ GT. Final Exponentiation으로 투영.",
  },
];
