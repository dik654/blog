  ...
  return (
    <section id="fp6" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <CodePanel title="Fp6 원소 구조" code={`Fp6 원소 = c₀ + c₁·v + c₂·v²
  c₀, c₁, c₂ ∈ Fp2  (각각이 복소수)
  v³ = β = 9 + u ∈ Fp2

총 차원: Fp2 × 3 = Fp × 6`} defaultOpen annotations={[
        ...
        <p>
          ...
          <code className="bg-accent px-1.5 py-0.5 rounded text-sm">v³ = β</code>로 대체한다.<br />
          나이브하게 Fp2 곱셈 9회가 필요하지만, Karatsuba로 6회로 줄인다.
        </p>
        <CodePanel title="Fp6 Karatsuba 공식" code={`v₀ = a₀b₀,  v₁ = a₁b₁,  v₂ = a₂b₂        ← 3회

c₀ = v₀ + β·((a₁+a₂)(b₁+b₂) - v₁ - v₂)   ← 1회
c₁ = (a₀+a₁)(b₀+b₁) - v₀ - v₁ + β·v₂      ← 1회
c₂ = (a₀+a₂)(b₀+b₂) - v₀ + v₁ - v₂         ← 1회
                                          합계: 6회`} defaultOpen annotations={[
        ...
        <p>
          최종적으로 <strong>Fp의 pow 연산 하나</strong>로 귀결된다.<br />
