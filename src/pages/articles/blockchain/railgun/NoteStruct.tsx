...
export default function NoteStruct({
  ...
  return (
    <section id="note-struct" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        ...
        <p className="leading-7">
          <code>npk = poseidon(spendingKey)</code>로 계산한다. spendingKey는
          비밀키다.
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
          ...
          <div className="rounded-lg border border-border/60 p-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm text-muted-foreground">
              <ul className="space-y-0.5">
                <li>
                  <code>npk</code>: <code>bytes32</code> &mdash; Note public key
                  (Poseidon hash)
                </li>
                <li>
                  <code>token</code>: <code>address</code> &mdash; ERC-20 주소
                </li>
              </ul>
              <ul className="space-y-0.5">
                <li>
                  <code>value</code>: <code>uint128</code> &mdash; 수량
                </li>
                <li>
                  <code>random</code>: <code>bytes31</code> &mdash; 블라인딩
                  팩터
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-lg border border-green-500/30 p-4">
              ...
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>
                  <strong>비밀키</strong>: <code>spendingKey</code> = random 32
                  bytes
                </li>
                <li>
                  <strong>공개키</strong>:{" "}
                  <code>npk = Poseidon(spendingKey, 1)</code> (domain separator)
                </li>
                <li>
                  <strong>소유권 증명</strong>: ZK proof &quot;I know x such
                  that <code>npk = Poseidon(x, 1)</code>&quot;
                </li>
              </ul>
            </div>
            <div className="rounded-lg border border-violet-500/30 p-4">
              <p className="font-semibold text-sm text-violet-400 mb-2">
                Commitment 계산 (2단계 해시)
              </p>
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>
                  <code>inner = Poseidon(npk, token, value)</code>
                </li>
                <li>
                  <code>commitment = Poseidon(inner, random)</code>
                </li>
                <li>
                  2단계 분리 &rarr; circuit 효율성 (Poseidon constraint
                  ~200/call)
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-lg border border-amber-500/30 p-4">
              ...
              <ul className="text-sm space-y-1 text-muted-foreground">
                ...
                <li>
                  Keccak 대비 <strong>300x</strong> 회로 효율
                </li>
            ...
            <div className="rounded-lg border border-border/60 p-4">
              ...
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>
                  <strong>Pedersen</strong>: discrete log 기반, 느림
                </li>
                <li>
                  <strong>MiMC</strong>: 간단하지만 Poseidon 대비 느림
                </li>
                <li>
                  <strong>Rescue</strong>: 더 빠르지만 덜 검증됨
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          <p className="font-semibold mb-2">
            인사이트: Note의 Privacy Properties
          </p>
          <p>
            <strong>Unlinkability</strong>: commitment → owner 매핑 불가
            <br />
            <strong>Untraceability</strong>: note flow 추적 불가
            <br />
            <strong>Hiding</strong>: commitment에서 value 추출 불가
            <br />
