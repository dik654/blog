    ...
    annotations: [
      {
        lines: [22, 25],
        color: "sky",
        note: "transferFrom — 사용자 → 컨트랙트 토큰 전송",
      },
      {
        lines: [27, 27],
        color: "emerald",
        note: "hashCommitment — Note를 Poseidon 해시",
      },
      {
        lines: [29, 29],
        color: "amber",
        note: "insertLeaf — Merkle tree에 삽입",
      },
      {
        lines: [31, 31],
        color: "violet",
        note: "emit Shield — commitment + root 기록",
      },
    ],
  },
  "rg-transact": {
    ...
    annotations: [
      {
        lines: [20, 22],
        color: "sky",
        note: "poseidon4(npk, token, value, random)",
      },
    ],
  },
  "rg-merkle": {
    ...
    annotations: [
      {
        lines: [33, 37],
        color: "sky",
        note: "insertLeaf — leaves[idx] = leaf",
      },
      {
        lines: [39, 49],
        color: "emerald",
        note: "_recomputeRoot — 형제 노드와 해시 반복",
      },
    ],
  },
  "rg-verifier": {
    ...
    annotations: [
      {
        lines: [30, 33],
        color: "sky",
        note: "vk_x = ic[0] + sum(input[i] * ic[i+1])",
      },
      {
        lines: [35, 41],
        color: "emerald",
        note: "pairingCheck — e(A,B) == e(α,β)·e(vk_x,γ)·e(C,δ)",
      },
    ],
  },
};
