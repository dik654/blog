    ...
    <g>
      ...
      >
        <rect
          ...
          strokeWidth={0.5}
        />
        <text x={170} y={38} fontSize={10} fill={C.problem} fontWeight={600}>
          from: 0xAlice
        </text>
        <text x={170} y={52} fontSize={10} fill={C.problem} fontWeight={600}>
          to: 0xBob amount: 1000 USDC
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
