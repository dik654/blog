    ...
    <section id="broadcaster" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          ZK 증명으로 금액과 수신자를 숨겨도, 직접 TX를 제출하면 msg.sender가
          노출된다.
          <br />
          RAILGUN은 <strong>Broadcaster(릴레이어)</strong>로 이 문제를 해결한다.
        </p>
        <p className="leading-7">
          사용자는 TX를 AES-256-GCM으로 암호화한 뒤, <strong>Waku</strong> P2P
          네트워크에 발행한다.
          <br />
          Broadcaster가 이를 수신하고, 자신의 EOA로 온체인에 제출한다.
        </p>
        <p className="leading-7">
          결과: <code>msg.sender = Broadcaster</code>. 실제 사용자 주소는
          온체인에 나타나지 않는다.
          <br />
          Broadcaster는 수수료(fee)로 보상받는다. 누구나 Broadcaster가 될 수
          있다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose space-y-4 my-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
              ...
              <div>
                ...
                <ul className="space-y-0.5">
                  ...
                  <li>
                    payload: <code>to</code>, <code>data</code>,{" "}
                    <code>gasLimit</code>, <code>maxFee</code>
                  </li>
                  <li>
                    <code>broadcasterFee</code>: 0.01 ETH (보상)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p>
                  topic: <code>/railgun/1/broadcast/proto</code>
                </p>
                <p>
                  payload: <code>encryptedTx</code>
                </p>
              </div>
            </div>
          </div>
          <div className="rounded-lg border border-green-500/30 p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2 text-sm text-center text-muted-foreground">
              ...
              <div className="bg-muted/50 rounded p-2">
                ...
                <span className="text-xs">
                  <code>try_decrypt()</code>
                </span>
              </div>
              <div className="bg-muted/50 rounded p-2">
                3. Off-chain proof 검증
                <br />
                <span className="text-xs">(gas 절약)</span>
              </div>
              <div className="bg-muted/50 rounded p-2">
                4. 수수료 확인
                <br />
                <span className="text-xs">
                  <code>fee &ge; min_fee</code>
                </span>
              </div>
              <div className="bg-muted/50 rounded p-2">
                5. 자기 EOA로 tx submit
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Fee는 shielded tx 내부에서 unshielded ERC-20으로 수령
            </p>
          </div>
        </div>
        ...
        <div className="not-prose space-y-4 my-4">
          <div className="rounded-lg border border-border/60 p-4">
            <p className="font-semibold text-sm text-blue-400 mb-2">
              Waku = libp2p 기반 P2P messaging (Ethereum Foundation + Status)
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm text-center text-muted-foreground">
              <div className="bg-muted/50 rounded p-2">
                Decentralized
                <br />
                <span className="text-xs">no central server</span>
              </div>
              <div className="bg-muted/50 rounded p-2">
                Message store
                <br />
                <span className="text-xs">30일 보관</span>
              </div>
              <div className="bg-muted/50 rounded p-2">E2E encryption</div>
              <div className="bg-muted/50 rounded p-2">
                Spam protection
                <br />
                <span className="text-xs">PoW or RLN</span>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-lg border border-red-500/30 p-4">
              ...
              <ul className="text-sm space-y-0.5 text-muted-foreground">
                <li>
                  <strong>Centralized relay</strong>: privacy 위험
                </li>
                <li>
                  <strong>Direct mempool submit</strong>: msg.sender 노출
                </li>
                <li>
                  <strong>Tor only</strong>: latency 큼
                </li>
              </ul>
            </div>
          </div>
          <div className="rounded-lg border border-border/60 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-muted-foreground">
              ...
              <ul className="space-y-0.5">
                ...
                <li>
                  공식 broadcaster + 커뮤니티 운영 &rarr; fee competition으로
                  가격 하락
                </li>
              </ul>
            </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p>
            ...
            1. ZK proof (transaction contents 숨김)
            <br />
            2. Broadcaster (msg.sender 숨김)
            <br />
            3. Gas from pool (ETH source 숨김)
          </p>
          <p className="mt-2">
            <strong>실패 시나리오</strong>:<br />
            ✗ Direct submit: msg.sender로 추적
            <br />
            ✗ Same broadcaster 반복 사용: pattern 분석
            <br />✗ Funded by traceable address: graph analysis
          </p>
          <p className="mt-2">
