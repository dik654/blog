  ...
  return (
    <section id="ed25519" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Ed25519는 Twisted Edwards curve 위에서 동작하는 EdDSA(Edwards-curve Digital Signature Algorithm)입니다.
          ECDSA와 달리 결정론적 nonce를 사용하여 nonce 재사용 취약점이 없습니다.
        </p>
        ...
        <pre className="bg-accent rounded-lg p-4 overflow-x-auto text-sm"><code>{`// 키 생성
...
서명 = (R, S)`}</code></pre>
        ...
        <pre className="bg-accent rounded-lg p-4 overflow-x-auto text-sm"><code>{`// 검증 등식
S * B == R + H * A

// 전개:
// S * B = (r + H*a) * B = r*B + H*a*B = R + H*A  ✓`}</code></pre>
