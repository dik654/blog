  ...
  return (
    <section id="ed25519" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Ed25519는 Twisted Edwards curve 위에서 동작하는 EdDSA(Edwards-curve
          Digital Signature Algorithm, 에드워즈 곡선 전자서명)입니다.
          <br />
        ...
        <ul>
          <li>
            <strong>B (Base Point)</strong> — 곡선의 고정된 생성자
          </li>
          <li>
            <strong>L (Order)</strong> — B의 순환 차수:
            2&#x00B2;&#x2075;&#x00B2; + 27742317777372353535851937790883648493
          </li>
          <li>
            <strong>A (Public Key)</strong> — a * B, 여기서 a는 개인키에서
            파생된 스칼라
          </li>
        </ul>
          ...
          annotations={[
            {
              lines: [1, 3],
              color: "sky",
              note: "키 생성: SHA512 → 스칼라 → 점",
            },
            {
              lines: [5, 9],
              color: "emerald",
              note: "결정론적 nonce로 서명 생성",
            },
