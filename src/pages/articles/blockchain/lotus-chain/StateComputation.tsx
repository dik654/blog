  ...
  return (
    <section id="state-computation" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Tipset의 state root는 block header를 단순히 hash해서 만들지
          않습니다. State manager가 parent state를 열고 canonical message와
          implicit system message를 FVM에 적용해 receipt, event와 다음 state
          tree root를 계산합니다.
        </p>
        <p>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Replay 검증에서는 state root뿐 아니라 receipt root, gas·exit code와
          execution event를 함께 비교합니다. Cache hit가 wall time을 크게
          바꿀 수 있으므로 cold replay와 warm replay를 구분하고, tipset별
          message 수와 actor call 분포를 같이 기록합니다.
        </p>
      </div>
    </section>
  );
