  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={240} y={114} textAnchor="middle" fontSize={10} fill={C2}>
        select_loop! — Mailbox + Network + PeerSet 동시 처리
      </text>
    </motion.g>
  );
}
  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={240} y={109} textAnchor="middle" fontSize={10} fill={C1}>
