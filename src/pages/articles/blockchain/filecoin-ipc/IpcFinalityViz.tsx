...
export function IpcFinalityViz() {
  return (
    <figure data-viz="ipc-asymmetric-finality" className="not-prose rounded-xl border border-border bg-card p-4 sm:p-6">
      <figcaption className="mb-5"><p className="text-sm font-bold">Parent↔child는 대칭 복사가 아니다</p><p className="mt-1 text-xs leading-5 text-muted-foreground">Top-down은 parent finality를 child가 받아들이는 길이고, bottom-up은 child quorum checkpoint를 relayer가 parent에 제출하는 길입니다.</p></figcaption>
