  ...
  return (
    <section id="paxos" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Acceptor는 자신이 promise한 가장 큰 proposal number와 accepted proposal·value를 보존합니다. Proposer가 Prepare
          quorum을 얻었을 때 accepted value가 하나라도 있으면 가장 높은 proposal의 value를 선택하고 아무것도 없다면 새 value를 고를 수 있습니다. 이후
          Accept request가 quorum에 기록되면 value가 chosen됩니다.
        </p>
      </div>
      <PaxosViz />
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          이전 value v가 chosen됐다면 그 accept quorum과 새 Prepare quorum은 적어도 한 acceptor를 공유합니다. 그 acceptor 또는 더 높은
          proposal의 chain을 통해 새 proposer는 v를 이어받습니다. Promise는 더 낮은 proposal이 뒤늦게 accept되는 것을 막으므로 서로 다른 value가
          같은 slot에서 chosen되지 않습니다. 이것이 agreement proof의 핵심이고 proposer가 살아 있다는 liveness proof는 아닙니다.
        </p>
        <p>
