      ...
      {(step) => (
        ...
        >
          ...
          <motion.line
            ...
            stroke="#a855f7"
            strokeWidth={0.7}
            animate={{ opacity: step >= 1 ? 0.5 : 0.1 }}
            transition={sp}
          />
          {/* SRS -> VK */}
          <motion.line
          ...
          <motion.line
            ...
            stroke="#10b981"
            strokeWidth={0.7}
            animate={{ opacity: step >= 2 ? 0.5 : 0.1 }}
            transition={sp}
          />
          {/* PK -> Prove */}
          <motion.line
            ...
            stroke="#f59e0b"
            strokeWidth={0.7}
            animate={{ opacity: step >= 3 ? 0.5 : 0.1 }}
            transition={sp}
          />
          ...
          <motion.line
            ...
            strokeWidth={0.5}
            strokeDasharray="2 2"
            animate={{ opacity: step >= 3 ? 0.4 : 0.05 }}
            transition={sp}
          />
          {/* Prove -> Verify */}
          <motion.line
            ...
            stroke="#ec4899"
            strokeWidth={0.7}
            animate={{ opacity: step >= 4 ? 0.5 : 0.1 }}
            transition={sp}
          />
          {/* VK -> Verify */}
          <motion.line
            ...
            strokeWidth={0.5}
            strokeDasharray="2 2"
            animate={{ opacity: step >= 4 ? 0.4 : 0.05 }}
            transition={sp}
          />
          {/* Main row nodes */}
