export const phase1Annotations = [
  ...
  },
  {
    ...
    note: "어드바이스 열 합성 + 블라인딩",
  },
  {
    lines: [12, 16] as [number, number],
    color: "amber" as const,
    note: "Lagrange → KZG 커밋",
  },
  {
    lines: [18, 20] as [number, number],
    color: "violet" as const,
    note: "NTT — extended coset 변환",
  },
];
...
export const phase2Annotations = [
  {
    ...
    color: "sky" as const,
    note: "θ 도전값 — Plookup 선형 결합",
  },
  {
    lines: [7, 9] as [number, number],
    color: "emerald" as const,
    note: "β, γ — 그랜드 프로덕트 도전값",
  },
  {
    lines: [11, 15] as [number, number],
    color: "amber" as const,
    note: "퍼뮤테이션 & Plookup 그랜드 프로덕트",
  },
  {
    lines: [17, 21] as [number, number],
    color: "violet" as const,
    note: "y — 소멸 다항식 h(X) 구성",
  },
];
