      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-5 my-4">
          ...
          <ul className="text-sm space-y-1 mb-4 list-disc list-inside">
            <li>
              <strong>지불 수단 부적합</strong> — 커피 $5 → 내일 $4.8 or $5.2
            </li>
            <li>
              <strong>회계 단위 부적합</strong> — 급여·청구서 예측 불가
            </li>
            <li>
              <strong>저축 수단 부적합</strong> — 월급 받고 1주일 만에 -20% 가능
            </li>
          </ul>
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-border px-3 py-2">~55%</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">
                  USDC (Circle)
                ...
                <td className="border border-border px-3 py-2">~25%</td>
              </tr>
              <tr>
                ...
                <td className="border border-border px-3 py-2">$5B+</td>
                <td className="border border-border px-3 py-2">~2%</td>
              </tr>
              <tr>
                <td className="border border-border px-3 py-2">FRAX</td>
                <td className="border border-border px-3 py-2">Hybrid</td>
                <td className="border border-border px-3 py-2">$0.6B</td>
        ...
        <p>
          <strong>Fiat-backed 독점</strong>: USDT + USDC가 80% 이상 점유
          <br />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4">
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <p className="text-sm mt-1">
              은행 예치 USD를 담보로 온체인 토큰 발행 — 1:1 백업
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <p className="text-sm mt-1">
              ETH·WBTC 등을 과담보로 예치 — <code className="text-xs">CDP</code>{" "}
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <p className="text-sm mt-1">
              공급 조절로 가격 유지 — Seigniorage shares, rebase 등
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            ...
            <p className="text-sm mt-1">
              여러 메커니즘 조합 — Delta-neutral, fractional reserve 등
            </p>
          </div>
        </div>
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-5 my-4">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-start gap-2 bg-background rounded px-3 py-2">
              ...
              <span>
                안정성 + 자본효율,{" "}
                <span className="text-red-500 font-medium">but 중앙화</span>
              </span>
            </div>
            <div className="flex items-start gap-2 bg-background rounded px-3 py-2">
        ...
        <p>
          <strong>3개 속성 중 2개만</strong>: Crypto Stablecoin Trilemma
          <br />
          USDC/USDT: 탈중앙화 희생
          <br />
          DAI: 자본 효율 희생
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p className="mt-2">
            - Terra/UST: 알고리드믹 실패 ($40B 손실)
            <br />
            - DAI: 담보 중 USDC 비중 높음 (50%+) → 간접 중앙화
            <br />- USDe: Delta-neutral, 하지만 funding rate 의존
          </p>
          <p className="mt-2">
            <strong>시장은 실용 선택</strong>:<br />
            - 일상 거래: USDC/USDT (중앙화 수용)
            <br />
            - DeFi 탈중앙 강조: DAI, LUSD
            <br />- Yield seeking: USDe, sUSDS (리스크 감수)
          </p>
          <p className="mt-2">
            완벽한 스테이블코인은 아직 없음 —{" "}
            <strong>각자 장단점 이해 후 선택</strong>
          </p>
        </div>
      </div>
    </section>
