    ...
    <section id="comparison" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-border px-3 py-2 text-green-600">
                  매우 높음
                </td>
                <td className="border border-border px-3 py-2 text-green-600">
                  높음
        ...
        <div className="space-y-3 my-4">
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
              1. Yield-bearing stablecoins 대중화
            </p>
            <p className="text-sm">
              sDAI, USDe, sFRAX, stUSDT — "돈 그냥 가만히 두면 이자"가 표준
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
            ...
            <p className="text-sm">
              CBDC 또는 승인 stablecoin — PYUSD (PayPal), 홍콩·일본 CBDC 파일럿
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
            ...
            <p className="text-sm">
              MakerDAO 국채 담보, Ondo USDY (tokenized T-bills)
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
            ...
            <p className="text-sm">
              CCTP 확산, Native stablecoin on new chains
            </p>
          </div>
          <div className="bg-muted/50 border border-border rounded-lg p-4">
            <p className="font-semibold text-sm mb-1">
            ...
            <p className="text-sm">
              Ethena Network, Plasma, Stable Sonic — USDC만이 통화인 체인
            </p>
          </div>
        </div>
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-5 my-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm mb-4">
            <div className="bg-background rounded px-3 py-2">
              DEX 기준 거래쌍 (ETH/USDC, BTC/USDC)
            </div>
            <div className="bg-background rounded px-3 py-2">
              Lending 기축 자산 (Aave, Compound V3)
            </div>
            <div className="bg-background rounded px-3 py-2">
              Derivatives 결제 (Perp funding, Options)
            </div>
            <div className="bg-background rounded px-3 py-2">
              Yield farming 기본 단위
            </div>
            <div className="bg-background rounded px-3 py-2 sm:col-span-2">
              Cross-chain 브리지 표준
            </div>
          </div>
          <p className="text-sm font-medium mb-2">
            TVL 중 스테이블코인 비중: <strong>40%+</strong>
          </p>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-400 p-4 my-6 rounded-r-lg">
          ...
          <p className="mt-2">
            역할:
            <br />
            ✓ DeFi 생태계의 liquidity 주춧돌
            <br />
            ✓ 개발도상국의 달러 접근 수단 (USDT in 터키, 아르헨티나)
            <br />
            ✓ 무허가 금융 서비스의 가치 저장
            <br />✓ 실시간 글로벌 결제 (은행 영업시간 무관)
          </p>
          <p className="mt-2">
            도전:
            <br />
          ...
          <p className="mt-2">
            <strong>결론</strong>: 스테이블코인은 크립토가 실제 유용함을 증명한
            대표 사례
            <br />
            Fiat-backed가 현재 지배적이지만, 탈중앙 대안도 계속 진화
            <br />
