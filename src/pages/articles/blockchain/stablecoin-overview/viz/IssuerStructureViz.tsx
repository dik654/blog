    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-card p-4">
      ...
      >
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={260} fontSize={10} fontWeight={700} fill="#10b981">
          Mint:
        </text>
        <text x={68} y={260} fontSize={10} fill="var(--foreground)">
          사용자 USD 입금 → Issuer
        </text>
        <text x={256} y={260} fontSize={10} fill="#6b7280">
          →
        </text>
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={306} fontSize={10} fontWeight={700} fill="#f59e0b">
          Burn:
        </text>
        <text x={68} y={306} fontSize={10} fill="var(--foreground)">
          사용자 USDC → Issuer
        </text>
        <text x={256} y={306} fontSize={10} fill="#6b7280">
          →
        </text>
