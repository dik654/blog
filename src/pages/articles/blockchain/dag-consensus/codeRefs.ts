    ...
    annotations: [
      {
        lines: [29, 31],
        color: "sky",
        note: "Transaction — 직렬화된 Sui 트랜잭션 바이트",
      },
      {
        lines: [59, 65],
        color: "emerald",
        note: "Block 열거형 — V1/V2 버전 관리",
      },
      {
        lines: [69, 80],
        color: "amber",
        note: "BlockAPI 트레이트 — epoch, round, author, ancestors, transactions",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [61, 67],
        color: "sky",
        note: "Core 구조체 — context + transaction_consumer",
      },
      {
        lines: [68, 78],
        color: "emerald",
        note: "block_manager + committer — DAG 관리 + 커밋 결정",
      },
      {
        lines: [89, 101],
        color: "amber",
        note: "leader_schedule + commit_observer + dag_state",
      },
      {
        lines: [110, 116],
        color: "violet",
        note: "ancestor_state_manager + round_tracker — 블록 품질 추적",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [28, 40],
        color: "sky",
        note: "BaseCommitterOptions — wave_length, leader_offset, round_offset",
      },
      {
        lines: [56, 66],
        color: "emerald",
        note: "BaseCommitter 구조체 — context + leader_schedule + dag_state",
      },
      {
        lines: [86, 117],
        color: "amber",
        note: "try_direct_decide — 2f+1 지지/비난 검사",
      },
      {
        lines: [122, 145],
        color: "violet",
        note: "try_indirect_decide — 앵커 기반 간접 커밋",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [52, 56],
        color: "sky",
        note: "Linearizer 구조체 — context + dag_state",
      },
      {
        lines: [65, 84],
        color: "emerald",
        note: "collect_sub_dag_and_commit — 리더에서 서브DAG 수집",
      },
      {
        lines: [159, 221],
        color: "amber",
        note: "linearize_sub_dag — BFS + 정렬로 전체 순서 결정",
      },
      {
        lines: [226, 237],
        color: "violet",
        note: "handle_commit — 커밋 리더 목록에서 서브DAG 일괄 생성",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [40, 53],
        color: "sky",
        note: "DagState 구조체 — genesis + recent_blocks + recent_refs_by_authority",
      },
      {
        lines: [59, 68],
        color: "emerald",
        note: "evicted_rounds + highest_accepted_round — GC 관리",
      },
      {
        lines: [70, 82],
        color: "amber",
        note: "last_commit + scoring_subdag — 커밋 및 평판 점수",
      },
      {
        lines: [83, 97],
        color: "violet",
        note: "pending_commit_votes + blocks_to_write — 쓰기 버퍼",
      },
    ],
  },
};
