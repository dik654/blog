...
export const STEPS = [
  {
    label: "Round 1: 각 검증자가 vertex 제출",
    body: "3명의 검증자가 각각 트랜잭션 배치를 포함한",
  },
  {
    label: "Round 2: 이전 라운드 참조 (DAG 엣지)",
    body: "각 검증자의 Round 2 vertex가",
  },
  {
    label: "Round 2 Anchor 선출: 2f+1 참조",
    body: "Round 2에서 V1이 앵커(리더)로 선출",
  },
  {
    label: "Round 3-4: DAG 확장 + 앵커 커밋",
    body: "DAG가 확장되고 충분한 참조를 받은",
  },
];
