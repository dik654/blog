    ...
    >
      ...
      <motion.g {...fade(1.0)}>
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          Narwhal은 이전 라운드 전체 참조
        </text>
        <text x={327} y={84} textAnchor="middle" fontSize={10} fill={CE}>
          → DAG 구조 형성
        </text>
      </motion.g>
    </svg>
    ...
    >
      ...
      <motion.g {...fade(0.5)}>
        ...
        <rect
          ...
          strokeWidth={0.4}
        />
        <text x={135} y={29} textAnchor="middle" fontSize={10} fill={CE}>
          +
        </text>
      </motion.g>
      <motion.g {...slide(0.6)}>
        ...
        <text x={196} y={50} textAnchor="middle" fontSize={10} fill={CE}>
          2f+1 서명
        </text>
      </motion.g>
      <motion.g {...fade(0.9)}>
      ...
      <motion.g {...fade(1.3)}>
        ...
        <text x={217} y={80} textAnchor="middle" fontSize={10} fill={CE}>
          인증서 존재 = 2f+1 노드가 데이터를 보유 — 서명으로 직접 증명 (DAS
          불필요)
        </text>
      </motion.g>
      <defs>
      ...
      {steps.map((s, i) => (
        <motion.g key={i} {...slide(0.2 + i * 0.25)}>
          <rect
            ...
            height={30}
            rx={4}
            fill={`${[CV, CE, CA, CV][i]}10`}
            stroke={[CV, CE, CA, CV][i]}
            strokeWidth={0.8}
          />
          <text
            x={60 + i * 108}
