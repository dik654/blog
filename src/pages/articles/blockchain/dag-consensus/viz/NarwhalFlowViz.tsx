...
const STEPS = [
  {
    label: "Worker TX 수집",
    body: "Worker 노드가 트랜잭션을 수집합니다. 여러 Worker로 선형 확장 가능.",
  },
  {
    label: "배치 생성",
    body: "트랜잭션을 배치로 묶어 digest를 Primary에게 전달합니다.",
  },
  {
    label: "Vertex 제안",
    body: "Primary가 배치 digest + 이전 라운드 Certificate를 포함한 Vertex를 브로드캐스트합니다.",
  },
  {
    label: "투표 수집",
    body: "다른 검증자들이 Vertex의 유효성을 확인하고 서명(투표)합니다.",
  },
  {
    label: "Certificate 생성",
    body: "2f+1 투표가 모이면 Certificate가 생성되어 데이터 가용성이 보장됩니다.",
  },
  {
    label: "순서 결정",
    body: "Bullshark/Tusk 합의 엔진이 DAG를 순회하며 전체 순서를 결정합니다.",
  },
];
