...
const PRECOMPILES = [
  ...
  {
    code: "jt[0xf1] = iCosmosPrecompile{execute_cosmos, query_cosmos}",
    color: "#10b981",
  },
  {
    code: "jt[0xf2] = erc20RegistryPrecompile{register, queryPair}",
    color: "#f59e0b",
  },
  {
    code: "jt[0xf3] = jsonUtilsPrecompile{parseJSON, getField}",
    color: "#ec4899",
  },
];
