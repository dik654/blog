...
const ROWS = [
  ...
  {
    eth: "Account: nonce, balance, storageRoot",
    mini: "x/auth sequence + x/bank 잔액",
  },
  {
    eth: "Storage: mapping(bytes32→bytes32)",
    mini: "KVStore key: addr+slot → value",
  },
        ...
        return (
          ...
          >
            <rect
              ...
              height={18}
              rx={3}
              fill={glow ? "#6366f114" : "#6366f106"}
              stroke="#6366f1"
              strokeWidth={glow ? 1.2 : 0.4}
            />
            <text
              x={96}
              y={y + 12}
