  ...
  return (
    ...
    >
      ...
      <line
        ...
        strokeWidth={0.7}
      />
      <text x={cx + (7 * s) / 3 + 8} y={cy + 4} fontSize={9} fill={C.base}>
        a
      </text>
      <text x={cx + 4} y={cy - (7 * s) / 3 - 6} fontSize={9} fill={C.base}>
        bu
      </text>
      ...
      <motion.line
        ...
        strokeWidth={0.8}
        strokeDasharray="3 2"
        animate={{ x1: px, y1: py, x2: px, y2: pyC }}
        transition={sp}
      />
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={390} y={68} textAnchor="middle" fontSize={10} fill={C.base}>
        φ(a+bu) = a−bu
      </text>
      <text x={390} y={82} textAnchor="middle" fontSize={9} fill={C.muted}>
        u축 반사 = 켤레
      </text>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={390} y={118} textAnchor="middle" fontSize={10} fill={C.conj}>
        복소수 켤레와 동일
      </text>
      <text x={390} y={134} textAnchor="middle" fontSize={9} fill={C.muted}>
        ℂ: a+bi → a−bi
      </text>
      <text x={390} y={148} textAnchor="middle" fontSize={9} fill={C.muted}>
        F₇²: a+bu → a−bu
      </text>
