...
export default function IrreducibilitySvg({
  rows,
  isIrreducible,
  polyLabel,
  highlight,
  ...
  return (
    ...
    >
      ...
      {rows.map((r, i) => {
        ...
        return (
          ...
          >
            ...
            <text x={50} y={y} textAnchor="middle" fontSize={9} fill={C.base}>
              {r.x}
            </text>
            <text
              x={140}
      ...
      <rect
        ...
        stroke={isIrreducible ? `${C.fail}35` : `${C.ok}35`}
        strokeWidth={0.8}
      />
      <text
        x={392}
