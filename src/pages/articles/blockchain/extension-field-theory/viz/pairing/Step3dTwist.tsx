  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(0.8)}>
        ...
        <text x={52} y={136} fontSize={12} fill={C.m}>
          점 하나 = (x, y)
        </text>
        <text x={52} y={156} fontSize={12} fill={C.m}>
          x = a + bu (Fp 원소 2개)
        </text>
        <text x={52} y={176} fontSize={12} fill={C.m}>
          y = c + du (Fp 원소 2개)
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.3)}>
        <text x={300} y={130} fontSize={12} fontWeight={500} fill={C.g2}>
          점 1개 =
        </text>
        {["a", "b", "c", "d"].map((_label, i) => (
          <motion.rect
            key={i}
            x={300 + i * 36}
            y={140}
