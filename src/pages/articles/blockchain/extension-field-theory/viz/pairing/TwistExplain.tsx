    ...
    <g>
      ...
      <motion.g {...fade(delay)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={258} fontSize={11} fontWeight={600} fill={C.big}>
          twist 없이 G2를 쓰면
        </text>
        <text x={36} y={278} fontSize={11} fill={C.m}>
          좌표가 Fp¹² 원소
        </text>
        <text x={36} y={296} fontSize={11} fill={C.big}>
          점 1개 = Fp 원소 24개
        </text>
      </motion.g>
      ...
      <motion.g {...fade(delay + 0.3)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={296} y={258} fontSize={11} fontWeight={600} fill={C.g2}>
          twist로 압축하면
        </text>
        <text x={296} y={278} fontSize={11} fill={C.m}>
          좌표가 Fp² 원소
        </text>
        <text x={296} y={296} fontSize={11} fill={C.g2}>
          점 1개 = Fp 원소 4개 (6배 절감)
        </text>
      </motion.g>
