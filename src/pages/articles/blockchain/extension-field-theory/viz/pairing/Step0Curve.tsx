...
const draw = (d: number) => ({
  ...
  transition: {
    pathLength: { duration: 0.8, delay: d },
  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(0.9)}>
        ...
        <text x={128} y={94} fontSize={14} fontWeight={600} fill={C.g1}>
          P
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.2)}>
        ...
        <text x={181} y={88} fontSize={14} fontWeight={600} fill={C.g1}>
          Q
        </text>
      </motion.g>
      ...
      <motion.line
        ...
        {...draw(2.4)}
      />
      <motion.text x={76} y={143} fontSize={9} fill={C.line} {...fade(2.4)}>
        반사
      </motion.text>
      ...
      <motion.g {...fade(2.8)}>
        ...
        <text x={81} y={178} fontSize={14} fontWeight={600} fill={C.res}>
          P+Q
        </text>
      </motion.g>
      ...
      {[
        ...
        <motion.g key={s.n} {...fade(s.d)}>
          <text x={290} y={s.y} fontSize={15} fontWeight={500} fill={s.c}>
            {s.n}
          </text>
          <text x={318} y={s.y} fontSize={12} fill={C.m}>
            {s.t}
          </text>
        </motion.g>
      ))}
      ...
      <motion.g {...fade(3.2)}>
        ...
        <text x={290} y={240} fontSize={11} fill={C.m}>
          P+Q = Q+P (교환법칙)
        </text>
        <text x={290} y={258} fontSize={11} fill={C.m}>
          P+(-P) = O (역원 = x축 반사)
        </text>
      </motion.g>
    </svg>
