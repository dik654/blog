  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(0.4)}>
        ...
        <text x={56} y={73} fontSize={12} fontWeight={600} fill={C.g2}>
          T
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.6)}>
        ...
        <text x={130} y={212} fontSize={11} fontWeight={600} fill={C.gt}>
          2T
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.9)}>
        ...
        <text x={56} y={214} fontSize={12} fontWeight={600} fill={C.g1}>
          P
        </text>
        <line
          x1={72}
