...
export default function Step3cProblem() {
  return (
    ...
    >
      ...
      <motion.g {...fade(0.3)}>
        <text x={40} y={56} fontSize={12} fill={C.m}>
          G2 후보 점의 좌표 하나 =
        </text>
        <text x={260} y={56} fontSize={12} fontWeight={500} fill={C.g2}>
          a + bu (Fp² 원소)
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.2)}>
        <text x={40} y={146} fontSize={12} fontWeight={500} fill={C.g2}>
          G1 점:
        </text>
        {[0, 1].map((i) => (
          <rect
        ...
        <text x={180} y={148} fontSize={11} fill={C.m}>
          Fp 원소 2개
        </text>
      </motion.g>

      <motion.g {...fade(1.5)}>
        <text x={40} y={182} fontSize={12} fontWeight={500} fill={C.big}>
          G2 점 (직접):
        </text>
