    ...
    >
      ...
      <motion.g {...fade(0.3)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={62} fontSize={12} fontWeight={600} fill={C.g1}>
          곡선 정의
        </text>
      ...
      <motion.g {...fade(1.0)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={164} fontSize={12} fontWeight={600} fill={C.g1}>
          집합 (원소)
        </text>
      ...
      <motion.g {...fade(1.3)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={296} y={164} fontSize={12} fontWeight={600} fill={C.g1}>
          연산 (점 덧셈)
        </text>
