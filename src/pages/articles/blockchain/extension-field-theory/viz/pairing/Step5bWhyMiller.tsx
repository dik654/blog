    ...
    >
      ...
      <motion.g {...fade(0.3)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={78} fontSize={12} fontWeight={600} fill={C.g1}>
          스칼라 곱 rQ
        </text>
      ...
      <motion.g {...fade(1.0)}>
        <rect
          ...
          strokeWidth={0.7}
        />
        <text x={36} y={160} fontSize={12} fontWeight={600} fill={C.ml}>
          추가된 것: f 누적
        </text>
      ...
      <motion.g {...fade(1.5)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={226} fontSize={12} fontWeight={600} fill={C.gt}>
          결과
        </text>
