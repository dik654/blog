...
const draw = (d: number) => ({
  ...
  transition: {
    pathLength: { duration: 0.5, delay: d },
  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(0.6)}>
        ...
        <text x={66} y={120} fontSize={12} fontWeight={600} fill={C.g2}>
          T
        </text>
      </motion.g>
      <motion.g {...fade(1.0)}>
        <rect
          ...
          strokeWidth={0.5}
        />
        <text x={134} y={125} textAnchor="middle" fontSize={11} fill={C.g2}>
          ℓ(T) = 0
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.3)}>
        ...
        <text x={66} y={206} fontSize={12} fontWeight={600} fill={C.g1}>
          P
        </text>
      </motion.g>
      ...
      <motion.g {...fade(2.0)}>
        <text x={56} y={172} fontSize={10} fill={C.m} textAnchor="middle">
          거리
        </text>
        <text x={56} y={186} fontSize={10} fill={C.g1} textAnchor="middle">
          = ℓ(P)
        </text>
      </motion.g>
