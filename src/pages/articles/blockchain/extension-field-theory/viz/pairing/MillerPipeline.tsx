    ...
    <g>
      ...
      {ITERS.map((r, i) => (
        <motion.g key={i} {...fade(0.6 + i * 0.5)}>
          ...
          <text x={252} y={68 + i * 62} fontSize={10} fill={C.g2}>
            ① T←2T
          </text>
          <text x={330} y={68 + i * 62} fontSize={10} fill={C.ml}>
            ② ℓ(P)
          </text>
          <text x={252} y={82 + i * 62} fontSize={10} fill={C.gt}>
            ③ {r.op3}
          </text>
          {i < 2 && (
            <motion.g {...fade(1.0 + i * 0.5)}>
              ...
              />
              <polygon
                points={`369,${94 + i * 62} 372,${98 + i * 62} 375,${94 + i * 62}`}
                fill={`${C.m}40`}
              />
            </motion.g>
          )}
      ...
      <motion.g {...fade(2.0)}>
        <text x={372} y={228} textAnchor="middle" fontSize={14} fill={C.m}>
          ⋮
        </text>
        <text x={372} y={246} textAnchor="middle" fontSize={10} fill={C.m}>
          254번 반복
        </text>
      </motion.g>
