    ...
    >
      ...
      <motion.g {...fade(0.6)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={32} y={128} fontSize={12} fontWeight={600} fill={C.frob}>
          핵심 1: hᵖᵏ = Frobenius
        </text>
        <text x={32} y={148} fontSize={11} fill={C.m}>
          hᵖ = 계수에 상수 곱 (공짜)
        </text>
        <text x={32} y={162} fontSize={11} fill={C.m}>
          hᵖ², hᵖ³도 Frobenius 반복
        </text>
      </motion.g>
      ...
      <motion.g {...fade(0.8)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={292} y={128} fontSize={12} fontWeight={600} fill={C.ch}>
          핵심 2: cᵢ를 x로 표현
        </text>
        <text x={292} y={148} fontSize={11} fill={C.m}>
          BN254 파라미터 x ≈ 63-bit
        </text>
        <text x={292} y={162} fontSize={11} fill={C.m}>
          cᵢ = x의 다항식 → 체인 가능
        </text>
      </motion.g>
      ...
      {[122, 236, 350, 444].map((x, i) => (
        <motion.g key={i} {...fade(1.5 + i * 0.12)}>
          ...
          />
          <polygon
            points={`${x + 10},219 ${x + 14},222 ${x + 10},225`}
            fill={`${C.m}50`}
          />
        </motion.g>
      ))}
      ...
      <motion.g {...fade(2.2)}>
        <rect
          ...
          strokeWidth={0.5}
        />
        <text x={60} y={276} fontSize={11} fill={C.m}>
          제곱 체인: ~190번
        </text>
        <text x={230} y={276} fontSize={11} fill={C.m}>
          Fp12 곱: ~30번
        </text>
        <text x={400} y={276} fontSize={11} fill={C.frob}>
          Frobenius: 4번 (공짜)
        </text>
      </motion.g>
    </svg>
