    ...
    >
      ...
      <motion.g {...fade(0.7)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={36} y={130} fontSize={12} fontWeight={600} fill={C.g1}>
          스칼라 곱 rQ
        </text>
        <text x={36} y={150} fontSize={11} fill={C.m}>
          Q를 r번 더한다 = 덧셈 반복
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.0)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={296} y={130} fontSize={12} fontWeight={600} fill={C.gt}>
          페어링 e(P, Q)
        </text>
        <text x={296} y={150} fontSize={11} fill={C.m}>
          ℓ(P)를 r번 곱한다 = 곱셈 반복
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.4)}>
        ...
        <text x={36} y={216} fontSize={12} fill={C.m}>
          r = G1의 위수 (254-bit 소수). r의 비트 수 = 254. double-and-add로
          254번 순회
        </text>
      </motion.g>
