    ...
    >
      ...
      <motion.g {...fade(0.3)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={30} y={50} fontSize={12} fontWeight={600} fill={C.g2}>
          ① 점 더블링: T ← 2T
        </text>
      ...
      <motion.g {...fade(0.7)}>
        ...
        <text x={280} y={88} fontSize={9} fill={C.ml}>
          λ를 ②에 전달
        </text>
      </motion.g>
      ...
      <motion.g {...fade(0.9)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={30} y={114} fontSize={12} fontWeight={600} fill={C.ml}>
          ② 접선 함수 평가: ℓ(P)
        </text>
      ...
      <motion.g {...fade(1.5)}>
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={30} y={178} fontSize={12} fontWeight={600} fill={C.gt}>
          ③ f ← f² · ℓ(P)
        </text>
        ...
        {Array.from({ length: 12 }).map((_, i) => {
          ...
          return (
            <motion.rect
              ...
              stroke={nonZero ? `${C.sp}60` : "var(--border)"}
              strokeWidth={0.5}
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
