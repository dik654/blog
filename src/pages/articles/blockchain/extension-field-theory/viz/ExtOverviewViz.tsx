...
const STEPS = [
  {
    label: "실수 → 복소수: x² + 1 = 0의 근 i를 도입",
    body: "ℝ에서 해 없는 방정식의 근 i를 추가 → ℂ = ℝ[i].",
  },
  {
    label: "F₇ → F₄₉: u² + 1 = 0의 근 u를 도입",
    body: "F₇에서 해 없는 근 u 추가 → F₄₉. 원소: a+bu. 복소수와 동일 구조.",
  },
  {
    label: "왜 확장체가 필요한가?",
    body: "G2 좌표는 Fp², GT는 Fp¹² 위 — 확장체 연산 필수.",
  },
  {
    label: "BN254 페어링 전체 구조",
    body: "G1(Fp) × G2(Fp²) → GT(Fp¹²). 확장체 없이는 ZKP 불가.",
  },
];
