  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Table header */}
        <text x={30} y={38} fontSize={9} fontWeight={500} fill={C.base}>
          x
        </text>
        <text x={90} y={38} fontSize={9} fontWeight={500} fill={C.base}>
          x² mod 7
        </text>
        <text x={160} y={38} fontSize={9} fontWeight={500} fill={C.base}>
          = 6?
        </text>
        <line
          x1={20}
        ...
        {squares.map((sq, i) => (
          ...
          >
            <text x={30} y={58 + i * 17} fontSize={9} fill={C.base}>
              {i}
            </text>
            <text
              x={100}
