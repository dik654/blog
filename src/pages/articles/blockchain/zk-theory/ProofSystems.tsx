  ...
  return (
    <section id="proof-systems" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          증명 크기, 검증 속도, 셋업, 양자 내성 &mdash; 시스템별 트레이드오프
          비교.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4 overflow-x-auto">
          ...
          {[
            ...
            <div
              key={r.name}
              className="grid grid-cols-5 gap-2 text-center text-sm py-1.5 border-t border-border/50"
            >
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            증명 크기 상수/polylog, 검증 밀리초, pairing/DLP 가정
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {[
              {
                name: "Groth16",
                desc: "최소 증명 (3 group elements), per-circuit setup",
              },
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">
            증명 큼 (수십~수백 KB), Post-quantum secure, 해시 기반
          </p>
          <p className="text-xs text-muted-foreground">
            프로젝트: StarkWare, Risc0, Polygon Miden
          </p>
        </div>
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          <p className="text-sm text-muted-foreground mb-2">
            이론적 프레임워크 &mdash; Prover가 oracle 제공, Verifier가 position
            쿼리, Fiat-Shamir로 비대화형 변환
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div className="rounded bg-muted/50 p-2 text-sm text-muted-foreground">
              <span className="font-semibold">STARKs</span> &mdash; FRI-based
              IOP
            </div>
            <div className="rounded bg-muted/50 p-2 text-sm text-muted-foreground">
              <span className="font-semibold">SNARK</span> &mdash; Polynomial
              IOP + PCS
            </div>
          </div>
        </div>
