  ...
  return (
    <section id="sigma-protocol" className="mb-16 scroll-mt-20">
      ...
      <h3 className="text-lg font-bold mb-4">
        특수 건전성 (Special Soundness)
      </h3>
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          같은 커밋에 두 챌린지 모두 응답 가능하면 비밀 x 복원 가능 &rarr; x
          모르면 불가.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-blue-500 bg-card p-4 mb-4">
          ...
          <p className="text-sm text-muted-foreground">
            "나는 witness <M>w</M>를 안다" &mdash; Relation <M>R</M>:{" "}
            <M>{"(x, w) \\in R"}</M>이면 <M>w</M>는 <M>x</M>의 witness
          </p>
        </div>
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          <p className="text-sm text-muted-foreground text-center">
            Verification: Verifier는 <M>{"(a, e, z)"}</M>로 검증 &mdash;{" "}
            <M>{"V(x, a, e, z) = \\text{ACCEPT or REJECT}"}</M>
          </p>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              정직한 Prover &rarr; Verifier가 ACCEPT
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              같은 <M>a</M>에 대해 두 쌍 <M>{"(e, z), (e', z')"}</M> &rarr;
              Extractor가 <M>w</M> 복원
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Simulator <M>S</M>가 <M>{"(a, e, z)"}</M> 위조 가능 (<M>w</M>{" "}
              없이)
            </p>
          </div>
        </div>
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          <p className="text-sm text-muted-foreground">
            <span className="font-semibold">Challenge Space:</span>{" "}
            <M>{"|\\text{challenge}|"}</M> 크기 = soundness error의 역수 &mdash;
            128-bit challenge &rarr; <M>{"2^{-128}"}</M> error
          </p>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                <strong>Schnorr</strong> &mdash; DLP 기반
              </li>
              <li>
                <strong>Chaum-Pedersen</strong> &mdash; DL 동등성
              </li>
              <li>
                <strong>Okamoto</strong> &mdash; Representation
              </li>
              <li>
                <strong>Guillou-Quisquater</strong> &mdash; RSA 기반
              </li>
            </ul>
          </div>
        </div>
