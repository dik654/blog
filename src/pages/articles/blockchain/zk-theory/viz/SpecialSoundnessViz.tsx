...
const STEPS = [
  {
    label: "특수 건전성 — 같은 커밋, 다른 챌린지",
    body: "같은 커밋 a에 대해 두 번의 다른 챌린지를 받으면 비밀 x를 역산할 수 있다.",
  },
  {
    label: "① 같은 커밋 a=8, 챌린지 e₁=2 → z₁=2",
    body: "z₁ = r + e₁·x mod q = 7 + 2·3 mod 11 = 2.",
  },
  {
    label: "② 같은 커밋 a=8, 챌린지 e₂=5 → z₂=0",
    body: "z₂ = r + e₂·x mod q = 7 + 5·3 mod 11 = 0.",
  },
  {
    label: "③ 두 응답의 차이로 x 역산",
    body: "x = (z₁−z₂)·(e₁−e₂)⁻¹ mod q = 2·7 mod 11 = 3. 비밀 복원!",
  },
];
