...
const STEPS = [
  {
    label: "세팅 — 공개 파라미터",
    body: "p=23, q=11, g=4. 비밀키 x=3, 공개키 y = gˣ mod p = 4³ mod 23 = 18.",
  },
  {
    label: "① Commit — a = gʳ 전송",
    body: "Prover가 r=7 선택, a = 4⁷ mod 23 = 8 → Verifier에게 전송.",
  },
  {
    label: "② Challenge — 랜덤 e 전송",
    body: "Verifier가 e=2를 생성하여 Prover에게 전송.",
  },
  {
    label: "③ Response — z 계산",
    body: "z = r + e·x mod q = 7 + 2·3 mod 11 = 2 → Verifier에게 전송.",
  },
  {
    label: "④ 검증 — gᶻ = a·yᵉ ?",
    body: "gᶻ = 4² = 16.  a·yᵉ = 8·(18² mod 23) = 8·2 = 16.  16 = 16 ✓ 증명 성공!",
  },
];
