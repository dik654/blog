  ...
  return (
    <section id="cap" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          Brewer(2000) — 분산 시스템은 C, A, P 중 최대 2가지만 동시 보장.
          네트워크 분할은 불가피 &rarr; C vs A 선택.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-red-500 bg-card p-4 mb-6">
          <p className="text-sm text-muted-foreground">
            <span className="font-semibold">정리:</span> P가 발생하면 C와 A 모두
            만족 불가 &rarr; 2개만 선택 가능. 현실에서 Partition은 발생하므로
            P는 필수 &rarr; <span className="font-semibold">CP 또는 AP</span>{" "}
            선택.
          </p>
        </div>
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-amber-500 bg-card p-4 mb-4">
          <p className="text-sm text-muted-foreground mb-1">
            <span className="font-semibold">P</span>artition 발생 &rarr;{" "}
            <span className="font-semibold">A</span>와{" "}
            <span className="font-semibold">C</span> 중 선택 /
            <span className="font-semibold"> E</span>lse (정상) &rarr;{" "}
            <span className="font-semibold">L</span>(Latency)과{" "}
            <span className="font-semibold">C</span> 중 선택
          </p>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                <span className="font-medium">AP</span> (eventual consistency)
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                <span className="font-medium">CP</span> with finality
              </li>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                <span className="font-medium">CP</span> (consistency)
              </li>
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-blue-500 bg-card p-4 mb-2">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>
              Strong consistency &rarr; latency 증가 / High availability &rarr;
              consistency 저하
            </li>
            <li>
              <code className="text-xs bg-muted px-1 rounded">CRDT</code> —
