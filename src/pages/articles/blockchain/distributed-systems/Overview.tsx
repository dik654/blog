  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>블록체인의 이론적 토대 — 분산 시스템의 통신 모델, 한계, 해결책.</p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                메시지 지연 상한{" "}
                <code className="text-xs bg-muted px-1 rounded">known</code>
              </li>
              <li>
                Clock drift 상한{" "}
                <code className="text-xs bg-muted px-1 rounded">known</code>
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>
                <code className="text-xs bg-muted px-1 rounded">GST</code>{" "}
                (Global Stabilization Time) 이후 sync
              </li>
              <li>현실적 중간 모델</li>
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          ...
          <div className="rounded-lg border-l-4 border-l-amber-500 bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Consistency, Availability, Partition-tolerance &rarr; 2개만 선택
              가능
            </p>
          </div>
          <div className="rounded-lg border-l-4 border-l-blue-500 bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              <M>f</M> Byzantine faults &rarr; <M>{"n \\geq 3f+1"}</M> 필요
            </p>
          </div>
        </div>
