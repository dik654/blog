    ...
    <section id="comparison" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          Bullshark는 좋은 네트워크에서 <strong>2라운드 지연</strong>으로 더
          빠름.
          <br />
          Tusk는 네트워크가 불안정해도 합의가 멈추지 않음.
          <br />
...
// - DAG-BFT 지속 진화`}
        ...
        <p className="leading-7">
          ...
          99% fast path 조건 만족 → Tusk overkill.
          <br />
...
// - 이론적 선도 → 실무 접목 iteration`}
        ...
        <p className="leading-7">
          Tusk 기여:{" "}
          <strong>DAG async BFT 최초 실용, common coin timing</strong>.<br />
          Bullshark/Mysticeti가 Tusk 아이디어 계승.
          <br />
          학술적 선도 → 실무 접목의 표본.
        </p>

        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 async-safe의 현실적 가치</strong> — "insurance" policy.
          <br />
          평소 사용 안 함, but 위기 시 필수.
          <br />
          Tusk는 pure async, Bullshark는 hybrid (async fallback).
          <br />
