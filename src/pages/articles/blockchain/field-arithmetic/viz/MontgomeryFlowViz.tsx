...
const STEPS = [
  ...
  {
    label: "Montgomery 변환",
    body: "a × R² mod p → REDC로 a·R 형태 생성. 한 번만 수행.",
  },
  {
    label: "512-bit 곱셈",
    body: "T = a_mont × b_mont. 나눗셈 없이 4×4 limb 곱셈만 수행.",
  },
  { label: "REDC: m 계산" },
  {
    label: "REDC: 시프트",
    body: "t = (T + m·p) / R. R의 배수이므로 비트 시프트로 정확히 나눠집니다.",
  },
  {
    label: "최종 결과",
    body: "t ≥ p이면 t-p. 결과 a·b·R mod p. 나눗셈 0회 달성!",
  },
];
