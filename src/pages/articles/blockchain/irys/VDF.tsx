  ...
  return (
    <section id="vdf" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys의 합의는 <strong>VDF(Verifiable Delay Function)</strong>를
          기반으로 합니다.
          <br />
          VDF는 계산이 반드시 순차적으로 이루어져야 하고(병렬화 불가), 결과를
          빠르게 검증할 수 있는 암호학적 함수입니다.
        </p>
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("irys-vdf-sha", codeRefs["irys-vdf-sha"])
              }
            />
        ...
        <CodePanel
          title="VDF SHA256 순차 해시"
          code={VDF_SHA_CODE}
          annotations={[
            {
              lines: [8, 13],
              color: "sky",
              note: "체크포인트별 순차 해싱 루프",
            },
          ]}
        />
        ...
        <h3>블록 생성 흐름</h3>
        <CodePanel
          title="VDF 기반 블록 생성 루프"
          code={BLOCK_FLOW_CODE}
          annotations={[
