    ...
    <section id="cuda-acceleration" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <strong>NVIDIA GPU CUDA 가속</strong>으로 CPU 대비 수십 배 성능을
          달성합니다.
        </p>
        ...
        <CodePanel
          title="CUDA FFI 호출"
          code={CUDA_INTERFACE_CODE}
          annotations={CUDA_INTERFACE_ANNOTATIONS}
        />

        <h3>CUDA 커널 구현</h3>
        <CodePanel
          title="GPU 커널 (compute_entropy_chunks_cuda_kernel)"
          code={KERNEL_CODE}
