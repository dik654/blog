  ...
  return (
    <section id="monitoring" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys 노드는 Rust <code>tracing</code> 크레이트로 구조화 로깅을
          제공하며, VDF 성능, 블록체인 상태, P2P 연결 등 핵심 메트릭을 내장
          수집합니다. Prometheus + Grafana로 대시보드를 구성하고 Alertmanager로
          이상 알림을 전송할 수 있습니다.
        </p>
      </div>
