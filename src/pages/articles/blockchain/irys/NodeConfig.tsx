  ...
  return (
    <section id="node-config" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys 노드는 TOML 형식 <code>config.toml</code>로 구성됩니다.
          <br />
          노드 모드, 네트워크, 스토리지, 합의 등 모든 옵션을 설정하며 Prometheus
          통합 모니터링을 지원합니다.
        </p>

        <h3>기본 설정</h3>
        <CodePanel
          title="config.toml 기본 구조"
          code={CONFIG_CODE}
        ...
        <h3>메트릭 & 모니터링</h3>
        <CodePanel
          title="VDF/Chain/Storage 메트릭 + Prometheus"
          code={METRICS_CODE}
