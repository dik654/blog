  ...
  return (
    <section id="gossip-protocol" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys 가십 프로토콜은 블록, 트랜잭션, 청크 등 6가지 데이터 유형을
          네트워크에 전파합니다. <strong>점진적 브로드캐스트</strong>(라운드당
          최대 5개 피어)와
        ...
        <h3>가십 데이터 유형</h3>
        <CodePanel
          title="GossipData 열거형"
          code={GOSSIP_DATA_CODE}
