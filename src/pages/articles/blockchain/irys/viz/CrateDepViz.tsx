...
const STEPS = [
  {
    label: "전체 크레이트 의존 그래프",
    body: "irys-chain이 모든 하위 크레이트를 조립. irys-types가 공유 기반.",
  },
  {
    label: "합의 & 패킹 레이어",
    body: "VDF 합의와 매트릭스 패킹이 체인 코어에서 스케줄링됩니다.",
  },
  {
    label: "스토리지 & 네트워킹",
    body: "storage는 청킹/Merkle, gossip은 블록 전파를 담당합니다.",
  },
];
            ...
            {EDGES.map(([fi, ti], ei) => {
              ...
              return (
                <motion.line
                  ...
                  strokeWidth={show ? 1 : 1}
                  strokeDasharray="4 3"
                  animate={{ opacity: show ? 0.6 : 0.1 }}
