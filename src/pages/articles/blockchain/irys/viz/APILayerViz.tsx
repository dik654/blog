...
const ENDPOINTS = [
  {
    ...
    path: "/info",
    color: "#6366f1",
    desc: "노드 상태: 버전, 블록 높이, 피어 수, 동기화 상태",
  },
  {
    method: "POST",
    path: "/tx",
    color: "#10b981",
    desc: "데이터 트랜잭션 제출. 서명 검증 + 멤풀 추가",
  },
  {
    method: "POST",
    path: "/chunk",
    color: "#f59e0b",
    desc: "데이터 청크 제출. Merkle 증명 검증",
  },
  {
    method: "GET",
    path: "/block/{tag}",
    color: "#8b5cf6",
    desc: "블록 조회. latest, 높이, 해시로 검색",
  },
  {
    method: "GET",
    path: "/price/{l}/{s}",
    color: "#ec4899",
    desc: "데이터 저장 가격. permFee + termFee",
  },
];
      ...
      <div className="flex flex-wrap gap-2">
        {ENDPOINTS.map((ep, i) => (
          <motion.button
            ...
            style={{
              borderColor: active === i ? ep.color : ep.color + "30",
              background: active === i ? ep.color + "18" : ep.color + "06",
              color: ep.color,
            }}
          >
