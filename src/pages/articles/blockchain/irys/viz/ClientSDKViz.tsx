...
const STEPS = [
  {
    label: "SDK 초기화",
    body: "IrysApiClient와 IrysSigner를 생성하고 노드 주소를 설정합니다.",
  },
  {
    label: "트랜잭션 서명",
    body: "IrysSigner가 ECDSA(k256)로 데이터 트랜잭션에 서명합니다.",
  },
  {
    label: "노드 전송",
    body: "서명된 트랜잭션을 REST API로 Irys 노드에 전송합니다.",
  },
  {
    label: "블록 확정",
    body: "노드가 트랜잭션을 검증하고 블록에 포함시켜 영구 저장합니다.",
  },
];
