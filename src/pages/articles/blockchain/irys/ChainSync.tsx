...
import {
  SYNC_STATE_CODE,
  SYNC_STATE_ANNOTATIONS,
  BATCH_SYNC_CODE,
  BATCH_SYNC_ANNOTATIONS,
  NODE_MODE_CODE,
  NODE_MODE_ANNOTATIONS,
} from "./ChainSyncData";
  ...
  return (
    <section id="chain-sync" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys 체인 동기화는 <strong>블록 인덱스 기반 배치 동기화</strong>로
          구현됩니다.
          <br />
        ...
        <h3>동기화 상태 관리</h3>
        <CodePanel
          title="ChainSyncState 구조체"
          code={SYNC_STATE_CODE}
          annotations={SYNC_STATE_ANNOTATIONS}
        />

        <h3>배치 동기화 프로세스</h3>
        <CodePanel
          title="블록 인덱스 기반 배치 동기화"
          code={BATCH_SYNC_CODE}
          annotations={BATCH_SYNC_ANNOTATIONS}
        />

        <h3>동기화 모드</h3>
        <CodePanel
          title="Genesis / PeerSync / TrustedPeerSync"
          code={NODE_MODE_CODE}
