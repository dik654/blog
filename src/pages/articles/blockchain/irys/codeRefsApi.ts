  ...
  "irys-api-state": {
    ...
    annotations: [
      { lines: [46, 48], color: "sky", note: "mempool + chunk_ingress 채널" },
      {
        lines: [49, 53],
        color: "emerald",
        note: "chunk_provider + peer_list + DB",
      },
      {
        lines: [56, 63],
        color: "amber",
        note: "block_tree, sync_state, mining_address",
      },
    ],
  },
  "irys-api-routes": {
    ...
    annotations: [
      {
        lines: [73, 79],
        color: "sky",
        note: "/v1 스코프 — info, ready, block 엔드포인트",
      },
  ...
  "irys-api-server": {
    ...
    annotations: [
      { lines: [193, 200], color: "sky", note: "HttpServer + App 초기화" },
      {
        lines: [201, 213],
        color: "emerald",
        note: "JsonConfig 1MB 제한 + 에러 핸들러",
      },
      {
        lines: [216, 221],
        color: "amber",
        note: "CORS + Tracing + Metrics 미들웨어",
      },
    ],
  },
};
