...
export default function IrysP2P({
  title,
  onCodeRef,
}: {
  title?: string;
  ...
  return (
    <section id="p2p" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Irys P2P 네트워크는 <strong>PeerNetworkService</strong>,{" "}
          <strong>GossipService</strong>,<strong>ChainSyncService</strong> 세
          컴포넌트로 구성됩니다.
          <br />
        ...
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            <CodeViewButton
              onClick={() =>
                onCodeRef("irys-peer-service", codeRefs["irys-peer-service"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              peer_network_service.rs
            </span>
          </div>
        )}
        ...
        <CodePanel
          title="피어 네트워크 서비스 구조체"
          code={PEER_SERVICE_CODE}
          annotations={[
        ...
        <h3>피어 발견</h3>
        <CodePanel
          title="부트스트랩 + 동적 피어 확장"
          code={PEER_DISCOVERY_CODE}
          annotations={[
        ...
        <CodePanel
          title="블록 브로드캐스트 & 체인 동기화"
          code={GOSSIP_CODE}
          annotations={[
            {
              lines: [3, 9],
              color: "sky",
              note: "랜덤 피어 선택 브로드캐스트",
            },
