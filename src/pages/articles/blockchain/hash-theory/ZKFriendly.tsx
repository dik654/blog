  ...
  return (
    <section id="zk-friendly" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          SHA-256은 비트 연산 기반 &rarr; R1CS 제약 ~25,000. Poseidon은 체
          연산만 사용 &rarr; ~300 제약(80배 효율).
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-red-500 bg-card p-4 mb-4">
          <div className="text-sm font-semibold text-red-600 dark:text-red-400 mb-2">
            문제: SHA-256을 ZK circuit에서 증명하려면
          </div>
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-emerald-500 bg-card p-4 mb-6">
          ...
          <p className="text-sm text-muted-foreground">
            Field 연산만 사용 (add, mul, S-box) &rarr; Constraint 수 수백 배
            감소
          </p>
        </div>
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-sm text-muted-foreground mb-3">
            <div className="rounded bg-muted/50 p-2">
              Field: <M>{"\\mathbb{F}_p"}</M>
            </div>
            <div className="rounded bg-muted/50 p-2">
              State: <M>t</M> elements
            </div>
            <div className="rounded bg-muted/50 p-2">
              Rounds: <M>{"R_F + R_P"}</M>
            </div>
          ...
          <p className="text-sm text-muted-foreground">
            Full rounds: 모든 element에 S-box 적용 / Partial rounds: 첫
            element만. 파라미터 (128-bit security): <M>t=3</M>, <M>{"R_F=8"}</M>
            , <M>{"R_P=57"}</M> &rarr; ~300 constraints per hash (80배 이상
            효율).
          </p>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              최초 ZK 해시. <M>{"x^3"}</M> 또는 <M>{"x^5"}</M> S-box. 단순,
              오래된 분석.
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              STARK-friendly. Starkware 사용. S-box: <M>{"x^\\alpha"}</M> and{" "}
              <M>{"x^{1/\\alpha}"}</M>.
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
          ...
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Lookup-based. Plonkish arithmetization 친화적.
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="text-muted-foreground">
              <tr className="border-b border-border/50">
                ...
                <td className="p-2 text-red-500">25,000+ (R1CS)</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-2">MiMC</td>
                <td className="p-2">1,000~2,000</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-2">Poseidon</td>
                <td className="p-2 text-emerald-500">~300</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-2">Rescue</td>
                <td className="p-2 text-emerald-500">~288</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-2">Griffin</td>
                <td className="p-2 text-emerald-500">~194</td>
              </tr>
              <tr>
                <td className="p-2">Reinforced Concrete</td>
                <td className="p-2 text-emerald-500">~50 (lookup tables)</td>
              </tr>
            </tbody>
          </table>
        </div>
