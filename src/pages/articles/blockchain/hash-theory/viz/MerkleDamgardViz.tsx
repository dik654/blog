...
const STEPS = [
  {
    label: "Merkle-Damgård 전체 구조",
    body: "입력을 블록 단위로 분할한 뒤, 각 블록을 압축함수 f에 순차 입력하여 해시를 생성한다.",
  },
  {
    label: "1. IV (초기값)",
    body: "미리 정해진 상수. 첫 번째 압축함수의 왼쪽 입력.",
  },
  {
    label: "2. 첫 번째 압축",
    body: "IV + m₁을 압축함수 f에 넣어 256-bit h₁ 생성.",
  },
  {
    label: "3. 체이닝",
    body: "h₁이 다음 압축의 입력. 블록 하나만 바뀌어도 이후 전부 변경.",
  },
  { label: "4. 최종 해시", body: "마지막 블록 처리 출력이 최종 해시 H(m)." },
  {
    label: "취약점: 길이 확장",
    body: "H(m)이 내부 상태 노출 → 공격자가 체인을 이을 수 있다.",
  },
];
