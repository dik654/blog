...
const PHASES = [
  {
    title: "입력 상태",
    desc: "rate + cap이 하나의 5×5 행렬로 배열됨",
    color: C3,
  },
  {
    title: "θ (세타)",
    desc: "각 열의 패리티를 계산 → 인접 열에 XOR. 열 간 확산.",
    color: C1,
  },
  {
    title: "ρ (로)",
    desc: "각 칸을 서로 다른 양만큼 비트 회전. 칸 내부 확산.",
    color: C1,
  },
  {
    title: "π (파이)",
    desc: "칸 위치를 고정 패턴으로 재배치. 행↔열 혼합.",
    color: C1,
  },
  {
    title: "χ (카이)",
    desc: "행 내 비선형 혼합. 각 비트 = 자신 ⊕ (¬이웃 AND 이웃).",
    color: C2,
  },
  {
    title: "ι (이오타)",
    desc: "라운드 상수를 XOR. 라운드마다 다른 상수 → 대칭 파괴.",
    color: C2,
  },
  {
    title: "1라운드 완료",
    desc: "이 5단계를 24번 반복하면 Keccak-f 순열 완성.",
    color: C3,
  },
];
