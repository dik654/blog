      ...
      {(step) => (
        ...
        >
          ...
          <motion.g animate={{ opacity: step <= 1 || step === 3 ? 1 : 0.15 }}>
            <text x={20} y={20} fontSize={12} fontWeight={600} fill={C1}>
              Merkle-Damgard
            </text>
            <rect
              x={20}
            ...
            {[0, 1, 2].map((i) => (
              <g key={i}>
                ...
                />
                <polygon
                  points={`${78 + i * 90},46 ${84 + i * 90},49 ${78 + i * 90},52`}
                  fill={C1}
                />
                <rect
                  x={85 + i * 90}
          ...
          <motion.g animate={{ opacity: step >= 2 ? 1 : 0.15 }}>
            <text x={20} y={110} fontSize={12} fontWeight={600} fill={C2}>
              Sponge (SHA-3)
            </text>
            <rect
              x={20}
