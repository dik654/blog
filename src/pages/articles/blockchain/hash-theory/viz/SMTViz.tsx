...
const STEPS = [
  {
    label: "SMT 구조",
    body: "2^256 리프가 고정 위치에 항상 존재한다.\n빈 리프 = 기본값. 빈 서브트리는 깊이별 상수 해시로 대체.",
  },
  {
    label: "멤버십 증명",
    body: "리프에 실제 데이터가 있음을 sibling 경로로 증명.\n리프부터 루트까지 해시를 재계산하여 루트와 비교.",
  },
  {
    label: "비멤버십 증명",
    body: '키의 비트열로 위치를 찾아가서 리프가 기본값인지 확인.\n같은 방식으로 루트까지 재계산 → "데이터 없음" 증명.',
  },
];
