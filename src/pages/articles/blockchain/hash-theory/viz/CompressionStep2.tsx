...
function BitEx({
  ...
  return (
    <g>
      <text x={x} y={y + 11} fontSize={11} fill={color}>
        {label}
      </text>
      {bits.map((b, i) => (
        <g key={i}>
  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <line
        ...
        strokeWidth={0.8}
      />
      <text x={36} y={compY + 44} textAnchor="middle" fontSize={9} fill={C2}>
        워드 확장에서
      </text>
      <text x={36} y={compY + 54} textAnchor="middle" fontSize={9} fill={C2}>
        준비한 워드
      </text>
      ...
      <line
        ...
        strokeWidth={0.8}
      />
      <text x={36} y={compY + 106} textAnchor="middle" fontSize={9} fill={C4}>
        SHA-256 사양에
      </text>
      <text x={36} y={compY + 116} textAnchor="middle" fontSize={9} fill={C4}>
        정해진 상수
      </text>
      ...
      {(() => {
        ...
        return (
          <path
            d={`M ${vcx(3)},${inY + VH} L ${gapX},${inY + VH + 10}
