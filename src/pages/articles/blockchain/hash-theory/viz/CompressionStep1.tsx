  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={pnX + 12} y={p1Y + 18} fontSize={12} fontWeight={700} fill={C}>
        준비 ①
      </text>
      ...
      <line
        ...
        strokeWidth={0.8}
      />
      <text x={247} y={flowY1 - 8} textAnchor="middle" fontSize={12} fill={MUT}>
        8등분 →
      </text>
      ...
      <rect
        ...
        strokeWidth={0.6}
      />
      <text x={pnX + 12} y={p2Y + 18} fontSize={12} fontWeight={700} fill={C2}>
        준비 ②
      </text>
      ...
      <line
        ...
        strokeWidth={0.8}
      />
      <text x={243} y={flowY2 - 8} textAnchor="middle" fontSize={11} fill={MUT}>
        16분할 →
      </text>
      ...
      <rect
        ...
        strokeWidth={0.5}
      />
      <text x={314} y={flowY2 + 5} textAnchor="middle" fontSize={12} fill={C2}>
        16개
      </text>
      ...
      <text x={pnX + 14} y={p2Y + p2H - 12} fontSize={11} fill={MUT}>
        σ₀, σ₁ = 비트 회전(ROTR) + 시프트(SHR) + XOR. 이전 워드 4개를 섞어 새
        워드 1개 생성.
      </text>
        ...
        return (
          <g key={`p${i}`}>
            ...
            <rect
              ...
              stroke={isDots ? "transparent" : C3}
              strokeWidth={isDots ? 0 : 0.8}
            />
            <text
              x={px + pW / 2}
              y={pipeY + pH / 2 + 6}
      ...
      <path
        d={`M ${regX + VTOT / 2},${p1Y + p1H} L ${pX0 + pW / 2},${pipeY}`}
        fill="none"
        stroke={C}
        strokeWidth={0.6}
        strokeDasharray="3 2"
