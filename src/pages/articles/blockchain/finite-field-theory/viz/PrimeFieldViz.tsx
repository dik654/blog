...
const STEPS = [
  {
    label: "소수체 F₇ — mod 7 산술",
    body: "F₇ = {0,1,...,6}. 7 이상은 mod 7로 되돌아온다.",
  },
  {
    label: "덧셈군 — 3 + 5 = ?",
    body: "3+5=8 → mod 7 → 1. 항상 {0~6} 안 — 닫힘·항등원·역원 성립.",
  },
  {
    label: "곱셈군 — 3 × 5 = ?",
    body: "3×5=15 → mod 7 → 1. 0 제외 전부 역원 존재 → 체(Field).",
  },
  {
    label: "원시근 — 3을 계속 곱하면?",
    body: "3의 거듭제곱이 {1~6} 전부 순회 → 원시근. 이산로그 문제의 기반.",
  },
];
              ...
              step === 1
                ...
                : step === 2
                  ...
                  : step === 3
                    ...
                    : false;
            const color =
              step === 1 ? C.b : step === 2 ? C.b : step === 3 ? C.c : C.a;
            return (
              <motion.g key={v} animate={{ opacity: dimmed ? 0.2 : 1 }}>
                ...
                <text
                  ...
                  fill={highlight ? color : dimmed ? C.a : C.a}
                >
                  {v}
                </text>
              </motion.g>
            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              {[
                ...
                return (
                  ...
                  >
                    {showArrow && (
                      <text x={x - 16} y={y + 16} fontSize={11} fill={C.c}>
                        →
                      </text>
                    )}
                    {showRowArrow && (
