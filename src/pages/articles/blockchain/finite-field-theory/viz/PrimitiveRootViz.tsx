...
const STEPS = [
  {
    label: "원시근이란?",
    body: "위수가 p-1인 원소 — 거듭제곱으로 모든 원소를 순회.",
  },
  {
    label: "g=3은 F₇*의 원시근 ✓",
    body: "3의 거듭제곱이 {1~6} 전부 순회 → 위수 6 = p-1.",
  },
  {
    label: "g=2는 F₇*의 원시근 ✗",
    body: "2의 거듭제곱이 {1,2,4}만 순회 → 위수 3 ≠ p-1.",
  },
  {
    label: "왜 원시근이 중요한가?",
    body: "정방향(거듭제곱)은 쉽고 역방향(이산로그)은 어렵다 — 암호학의 기반.",
  },
];
              ...
              step === 1
                ...
                : step === 2
                  ...
                  : step === 3
                    ...
                    : v > 0;
            const col =
              step === 1 ? C.yes : step === 2 ? C.no : step === 3 ? C.c : C.a;
            return (
