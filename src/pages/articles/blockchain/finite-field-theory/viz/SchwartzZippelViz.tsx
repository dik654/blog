...
const STEPS = [
  {
    label: "Schwartz-Zippel 보조정리",
    body: "P(x) ≠ 0이고 deg(P)=d이면, 랜덤 r에서 P(r)=0일 확률 ≤ d/|F|.",
  },
  {
    label: "degree 3 다항식, |F|=97",
    body: "영점(zero)은 최대 3개. 97개 원소 중 3개 — 확률 ≤ 3/97 ≈ 3%.",
  },
  {
    label: "ZKP 적용: 다항식 동치",
    body: "f(x)=g(x)인지 → 랜덤 r에서 f(r)=g(r) 확인. 다르면 높은 확률로 탐지.",
  },
];
      ...
      {(step) => (
        ...
        >
          ...
          <line
            ...
            strokeWidth={0.5}
          />
          <text x={30} y={65} fontSize={9} fill="var(--muted-foreground)">
            0
          </text>
          <text
            x={327}
            ...
            ZEROS.map((z, i) => {
              ...
              return (
                ...
                >
                  ...
                  <text x={x} y={42} textAnchor="middle" fontSize={9} fill={C3}>
                    {z}
                  </text>
                </motion.g>
              );
