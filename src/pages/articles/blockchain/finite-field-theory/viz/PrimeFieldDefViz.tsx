...
const STEPS = [
  {
    label: "소수체 표기 — Fp = Z/pZ",
    body: "Fp와 Z/pZ는 같은 것을 다르게 표기한 것이다.",
  },
  {
    label: "예시 — F₇ = {0~6}",
    body: "F₇ = {0,1,2,3,4,5,6}. 7 이상은 mod 7로 되돌아온다.",
  },
  {
    label: "소수 → 역원 존재 → 체",
    body: "p가 소수이면 0 외 모든 원소에 곱셈 역원이 존재한다.",
  },
];
        ...
        <div className="w-full max-w-2xl mx-auto space-y-4 py-4">
          ...
          {step === 1 && (
            ...
            >
              ...
              >
                {["8 \\bmod 7 = 1", "15 \\bmod 7 = 1", "20 \\bmod 7 = 6"].map(
                  (eq, i) => (
                    <div
                      key={i}
                      className="rounded-md border border-emerald-500/20 bg-emerald-500/5
                    px-3 py-1 text-xs"
                    >
                      <Math>{eq}</Math>
                    </div>
