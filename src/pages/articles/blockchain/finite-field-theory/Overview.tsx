      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm mb-3">
            ...
            <span className="text-muted-foreground">⊃</span>
            <span className="rounded bg-indigo-500/10 border border-indigo-500/30 px-2 py-1 font-semibold">
              Abelian Group
            </span>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs text-muted-foreground">
            <div className="rounded bg-muted/50 p-2 text-center">
              <span className="font-semibold">Semigroup</span>
              <br />+ 결합법칙
            </div>
            <div className="rounded bg-muted/50 p-2 text-center">
              <span className="font-semibold">Monoid</span>
              <br />+ 항등원
            </div>
            <div className="rounded bg-muted/50 p-2 text-center">
            ...
            <div className="rounded bg-muted/50 p-2 text-center">
              <span className="font-semibold">Abelian</span>
              <br />+ 교환법칙
            </div>
          </div>
        </div>
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              예: <M>{"(\\mathbb{Z}, +)"}</M>, <M>{"(\\mathbb{Z}_n, +)"}</M>,
              타원곡선 점
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>
                분배법칙: <M>{"a(b+c) = ab + ac"}</M>
              </li>
            </ul>
            <p className="text-xs text-muted-foreground mt-2">
              예: <M>{"(\\mathbb{Z}_n, +, \\times)"}</M>, 다항식 환
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                환 + <M>{"(F \\setminus \\{0\\}, \\times)"}</M> 아벨 군
              </li>
              <li>모든 non-zero 원소가 역원 가짐</li>
            </ul>
            <p className="text-xs text-muted-foreground mt-2">
              예: <M>{"\\mathbb{Q}, \\mathbb{R}, \\mathbb{F}_p, GF(p^n)"}</M>
            </p>
          </div>
        </div>
        ...
        <div className="not-prose rounded-lg border bg-card p-4 mb-4">
          <p className="text-sm text-muted-foreground mb-3">
            유한 개 원소 &mdash; 암호학의 기반. 모든 <M>{"p^n"}</M> (<M>p</M>{" "}
            소수, <M>{"n \\geq 1"}</M>)에 대해 유일하게 존재.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div className="rounded bg-muted/50 p-3">
              ...
              <p className="text-xs text-muted-foreground">
                <M>{"F_r \\sim 2^{254}"}</M> &mdash; Ethereum 프리컴파일, 레거시
              </p>
            </div>
            <div className="rounded bg-muted/50 p-3">
              <p className="text-sm font-semibold">BLS12-381</p>
              <p className="text-xs text-muted-foreground">
                <M>{"F_r \\sim 2^{255}"}</M> &mdash; Zcash, Filecoin, Eth 2.0
              </p>
            </div>
            <div className="rounded bg-muted/50 p-3">
              <p className="text-sm font-semibold">Pasta (Halo2)</p>
              <p className="text-xs text-muted-foreground">
                <M>{"F_p, F_q"}</M> &mdash; cycle of curves
              </p>
            </div>
            <div className="rounded bg-muted/50 p-3">
