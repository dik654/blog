...
const STEPS = [
  {
    label: "스테이킹",
    body: "검증자가 32 ETH를 비콘체인 컨트랙트에 예치합니다.",
  },
  {
    label: "검증자 선출",
    body: "RANDAO 기반으로 각 슬롯의 제안자와 커미티를 선정합니다.",
  },
  {
    label: "제안 & 커미티 배정",
    body: "선출된 제안자가 블록을 생성하고 커미티가 검증을 준비합니다.",
  },
  {
    label: "어테스테이션",
    body: "커미티 검증자들이 블록에 대한 투표(attestation)를 전파합니다.",
  },
  {
    label: "최종성 확보",
    body: "Casper FFG로 2에폭(~12.8분) 후 최종성이 달성됩니다.",
  },
  {
    label: "보상 분배",
    body: "에폭 정산 시 제안/검증 보상이 분배됩니다. 슬래싱 조건 위반 시 벌금.",
  },
];
