...
const STEPS = [
  {
    label: "검증자 스테이킹 현황",
    body: "각 검증자가 보유한 스테이크 양에 비례하여 막대 높이가 결정됩니다.",
  },
  {
    label: "가중 랜덤 선택 시작",
    body: "스테이크 비율이 높을수록 선택될 확률이 높습니다. 룰렛이 돌아갑니다.",
  },
  {
    label: "V4 선택됨 (40%)",
    body: "가장 높은 스테이크(128 ETH, 40%)를 가진 V4가 다음 블록 제안자로 선택되었습니다.",
  },
  {
    label: "블록 제안",
    body: "선택된 V4가 새 블록을 제안하고, 나머지 검증자들이 attestation으로 확인합니다.",
  },
];
              ...
              <g key={v.name}>
                <motion.rect
                  ...
                  animate={{
                    ...
                    opacity:
                      step === 2 || step === 3 ? (selected ? 1 : 0.3) : 1,
                  }}
                  transition={sp}
                />
                <text
