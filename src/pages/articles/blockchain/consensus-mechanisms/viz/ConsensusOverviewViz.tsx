...
const STEPS = [
  {
    label: "세 가지 합의 메커니즘",
    body: "PoW, PoS, BFT — 각각 다른 트레이드오프",
  },
  {
    label: "PoW: 높은 에너지, 높은 탈중앙화",
    body: "해시 퍼즐로 Sybil 방어 — 15년간 검증된 보안",
  },
  {
    label: "PoS: 균형 잡힌 선택",
    body: "토큰 스테이킹으로 검증 — 에너지 99.95% 절감",
  },
        ...
        >
          ...
          {step > 0 && (
            <motion.circle
              ...
              cx={CX[step - 1]}
              cy={6}
              animate={{ opacity: 1, cx: CX[step - 1], cy: 6 }}
              transition={{ type: "spring", bounce: 0.3 }}
              fill={MECHS[step - 1].color}
              style={{
                filter: `drop-shadow(0 0 4px ${MECHS[step - 1].color}88)`,
              }}
            />
          )}
        </svg>
