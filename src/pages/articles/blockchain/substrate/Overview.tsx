  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>Polkadot SDK</strong>(구 Substrate) — Parity Technologies의
          모듈화 블록체인 프레임워크
          <br />
          Substrate, Polkadot, Cumulus, Bridges 네 핵심 컴포넌트로 상호 운용
          가능한 멀티체인 생태계 구축
          <br />
          FRAME 팔렛 시스템 — 비즈니스 로직에만 집중 가능, WASM 런타임으로 포크
          없는 업그레이드 지원
        </p>
        <CodePanel
