  ...
  return (
    <section id="runtime-config" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Substrate 런타임은 상태 전환 함수(State Transition Function)를
          정의하는 핵심 컴포넌트입니다. <code>construct_runtime!</code> 매크로로
          팔렛들을 조합하며, WebAssembly로 컴파일되어 포크 없이 온체인에서
          업그레이드할 수 있습니다.
        </p>
        <CodePanel
          title="런타임 구성 (lib.rs)"
          ...
          annotations={[
            {
              lines: [4, 12],
              color: "sky",
              note: "RuntimeVersion: 업그레이드 트리거",
            },
            {
              lines: [15, 22],
              color: "emerald",
              note: "construct_runtime! 팔렛 조합",
            },
            {
              lines: [25, 29],
              color: "amber",
              note: "팔렛별 Config 트레이트 구현",
            },
          ]}
        />
      </div>
