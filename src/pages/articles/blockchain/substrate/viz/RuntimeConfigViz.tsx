...
const STEPS = [
  {
    label: "런타임 아키텍처",
    body: "Client가 WASM/Native 런타임을 호출하고, Executive가 팔렛을 조율합니다.",
  },
  {
    label: "WASM vs Native",
    body: "WASM 런타임은 온체인 업그레이드 가능, Native는 성능 최적화용입니다.",
  },
  {
    label: "Executive & 팔렛",
    body: "Executive가 블록 처리를 조율하고, 각 팔렛이 상태를 변경합니다.",
  },
];
