...
const STEPS = [
  {
    label: "FRAME 아키텍처",
    body: "Runtime이 팔렛들을 조합하고, FRAME Support가 공통 인프라를 제공합니다.",
  },
  {
    label: "팔렛 모듈",
    body: "System, Balances, Staking 등 기본 팔렛과 커스텀 팔렛을 조합합니다.",
  },
  {
    label: "FRAME Support",
    body: "Storage Traits, Dispatch System, Event System 등 공통 기능을 제공합니다.",
  },
];
