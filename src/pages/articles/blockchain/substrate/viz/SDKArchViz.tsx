...
const STEPS = [
  {
    label: "Polkadot SDK 전체 구조",
    body: "4개 핵심 컴포넌트가 협력하여 멀티체인 생태계를 구성합니다.",
  },
  {
    label: "Substrate & FRAME",
    body: "모듈화된 블록체인 프레임워크. 팔렛 기반으로 기능을 조합합니다.",
  },
  {
    label: "Polkadot 릴레이 체인",
    body: "공유 보안을 제공하는 중앙 릴레이 체인. 검증자가 파라체인을 검증합니다.",
  },
  {
    label: "Cumulus & Bridges",
    body: "Cumulus로 파라체인을 개발하고, Bridges로 외부 네트워크와 연결합니다.",
  },
];
