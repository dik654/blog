...
const TXS = [
  {
    label: "TX A",
    accounts: ["Acct1(R)", "Acct2(W)"],
    color: "#6366f1",
    y: 25,
  },
  {
    label: "TX B",
    accounts: ["Acct3(R)", "Acct4(W)"],
    color: "#10b981",
    y: 60,
  },
  {
    label: "TX C",
    accounts: ["Acct2(W)", "Acct5(R)"],
    color: "#f59e0b",
    y: 95,
  },
];
...
const STEPS = [
  ...
  {
    label: "실행 스케줄링",
    body: "Thread1=TX A, Thread2=TX B(병렬) → TX A 완료 후 TX C",
  },
];

export default function SealevelViz({
  onOpenCode,
}: {
                ...
                {tx.accounts.map((a, j) => (
                  <motion.g key={j}>
                    <motion.rect
                      ...
                      stroke={
                        step >= 2 && a === "Acct2(W)" ? "#ef4444" : tx.color
                      }
