...
const STEPS = [
  {
    label: "Fetch: TX 수신",
    body: "UDP/QUIC 소켓 패킷 수신. 투표 TX / 일반 TX 분리",
  },
  {
    label: "SigVerify: GPU 서명 검증",
    body: "Ed25519 서명 GPU 병렬 검증. 무효 서명 즉시 드롭",
  },
  {
    label: "Banking: 실행 & PoH 기록",
    body: "6 스레드(2 vote + 4 non-vote) Sealevel 병렬 실행 → PoH 기록",
  },
  {
    label: "Broadcast: Shred 전파",
    body: "블록 → shred 분할 → Turbine 프로토콜 네트워크 전파",
  },
];
              ...
              return (
                <g key={i}>
                  ...
                  <motion.rect
                    ...
                    rx={8}
                    fill={s.color}
                    animate={{ opacity: active ? 1 : done ? 0.5 : 0.12 }}
