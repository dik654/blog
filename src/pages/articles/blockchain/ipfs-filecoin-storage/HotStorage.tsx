...
└────────────────────────────────────────┘`}</code>
        ...
        <CitationBlock source="Boost Docs — HTTP Retrieval" citeKey={3} type="paper" href="https://boost.filecoin.io/retrieving-data/http-retrieval">
          <p className="italic text-foreground/80">"booster-http serves retrievals over HTTP. It can be run as a standalone binary, and serves piece, IPFS Trustless Gateway, and raw block retrievals."</p>
...
핵심 특성:
  ...
  → 결정적 Merkle 트리, 암호학적 바인딩`}</code>
        ...
        <CitationBlock source="Filecoin Blog — Introducing Proof of Data Possession" citeKey={4} type="paper" href="https://filecoin.io/blog/posts/introducing-proof-of-data-possession-pdp">
          <p className="italic text-foreground/80">"PDP introduces a new lightweight proof mechanism that verifies data possession without sealing, enabling sub-second data access while maintaining cryptographic guarantees through challenge-response protocols with just 160 bytes per proof."</p>
