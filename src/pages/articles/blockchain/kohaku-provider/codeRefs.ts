    ...
    annotations: [
      {
        lines: [5, 9],
        color: "sky",
        note: "Provider trait — 3개 async 메서드",
      },
      {
        lines: [12, 17],
        color: "emerald",
        note: "KohakuProvider — Helios + ORAM + Dandelion 조합",
      },
      {
        lines: [20, 30],
        color: "amber",
        note: "get_balance — ORAM 쿼리 → Merkle 증명 검증",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [12, 19],
        color: "sky",
        note: "send_stem — 에폭 기반 고정 피어 선택",
      },
      { lines: [22, 27], color: "emerald", note: "relay — hop 카운트 확인" },
      {
        lines: [28, 31],
        color: "amber",
        note: "Fluff: 모든 피어에 가십 — 발신 노드 특정 불가",
      },
    ],
  },
};
