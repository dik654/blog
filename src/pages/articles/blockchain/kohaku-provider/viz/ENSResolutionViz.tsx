    ...
    <g>
      ...
      >
        <rect
          ...
          strokeWidth={0.5}
        />
        <text x={200} y={38} fontSize={10} fill={C.hash} fontWeight={600}>
          악의적 RPC → 가짜 주소 반환 시도
        </text>
        <text x={200} y={54} fontSize={10} fill="var(--muted-foreground)">
          → Merkle 증명 불일치로 즉시 감지/거부
        </text>
      </motion.g>
    </g>
  );
