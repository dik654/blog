    ...
    <section id="key-derivation" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          ...
          <br />키 스트레칭으로 브루트포스 공격을 억제한다.
        </p>
        <p className="leading-7">
          시드를 HMAC-SHA512에 넣으면 <strong>마스터 키</strong>와{" "}
          <strong>체인 코드</strong>가 나온다.
          <br />
          BIP-44 경로 <code>m/44'/60'/0'/0/0</code>으로 이더리움 자식 키를
          파생한다.
        </p>
        <p className="leading-7">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose space-y-3 mb-4">
          <div className="bg-muted rounded-lg p-4">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              <code>'</code> = hardened derivation (부모 공개키로 자식 비밀키
              역추적 불가)
            </p>
          </div>
          ...
          <div className="bg-muted rounded-lg p-4">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              ...
              <span className="bg-background px-2 py-1 rounded">
                <code>60'</code> Ethereum
              </span>
              <span className="bg-background px-2 py-1 rounded">
                <code>714'</code> BNB Chain
              </span>
              <span className="bg-background px-2 py-1 rounded">
                <code>501'</code> Solana
              </span>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-lg p-4">
            ...
            <ol className="text-sm text-muted-foreground space-y-2">
              <li>
                <strong>1) Mnemonic → Seed (BIP-39)</strong>:{" "}
                <code>
                  PBKDF2(password: mnemonic, salt: "mnemonic" + passphrase,
                  iterations: 2048, output: 64B)
                </code>
              </li>
              <li>
                <strong>2) Seed → Master Key (BIP-32)</strong>:{" "}
                <code>HMAC-SHA512(key: "Bitcoin seed", data: seed)</code> →
                master_priv + master_chain
              </li>
              <li>
                <strong>3) Path 따라 child key 파생</strong>: Hardened —{" "}
                <code>HMAC(chain, 0x00||priv||index+0x80000000)</code>, Normal —{" "}
                <code>HMAC(chain, pubkey||index)</code>
              </li>
              <li>
                <strong>4) Final</strong>: <code>m/44'/60'/0'/0/0</code> →
                Ethereum address 0
              </li>
            </ol>
          </div>
        ...
        <div className="not-prose space-y-3 mb-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <span className="bg-red-100 dark:bg-red-950/40 text-red-700 dark:text-red-400 px-2 py-1 rounded">
              절대 seed를 온라인 전송하지 말 것
            </span>
          </div>
        </div>
      </div>
