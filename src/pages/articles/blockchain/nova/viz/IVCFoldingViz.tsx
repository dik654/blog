        ...
        >
          {step === 0 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.pp}>
                PublicParams
              </text>
              {[
                "pp = setup(F)",
          ...
          {step === 1 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.rs}>
                RecursiveSNARK 초기화
              </text>
              {[
                "z₀ = [0]  // 초기 상태",
          ...
          {step === 2 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.f1}>
                Step 1: 첫 폴딩
              </text>
              {[
                "z₁ = F(z₀)",
          ...
          {step === 3 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.fn}>
                Step N: 재귀
              </text>
              {[
                "for i in 1..N:",
          ...
          {step === 4 && (
            <motion.g
              ...
              transition={sp}
            >
              <text x={20} y={18} fontSize={10} fontWeight={600} fill={C.comp}>
                CompressedSNARK
              </text>
              {[
