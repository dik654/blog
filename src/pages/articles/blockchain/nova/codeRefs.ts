    ...
    annotations: [
      {
        lines: [19, 21],
        color: "sky",
        note: "NIFS 구조체 — comm_T가 유일한 증거",
      },
      {
        lines: [36, 45],
        color: "emerald",
        note: "prove 시그니처 — Relaxed U1/W1 + 표준 U2/W2 입력",
      },
      {
        lines: [55, 63],
        color: "amber",
        note: "교차항 T 계산 + 커밋 + Fiat-Shamir 도전값",
      },
      {
        lines: [65, 72],
        color: "violet",
        note: "선형 폴딩 — U/W fold 후 반환",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [464, 473],
        color: "sky",
        note: "1단계: 보조 회로 폴딩 (E2 곡선)",
      },
      {
        lines: [490, 499],
        color: "emerald",
        note: "2단계: 주 회로 합성 (NovaAugmentedCircuit)",
      },
      {
        lines: [502, 511],
        color: "amber",
        note: "3단계: 주 회로 폴딩 (E1 곡선)",
      },
      {
        lines: [543, 555],
        color: "violet",
        note: "상태 업데이트 — 다음 스텝으로 전달",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [30, 39],
        color: "sky",
        note: "R1CSShape — 제약 수, 변수 수, 희소 행렬 A/B/C",
      },
      {
        lines: [44, 48],
        color: "emerald",
        note: "R1CSWitness — 증인 벡터 W + 블라인딩 r_W",
      },
      {
        lines: [62, 67],
        color: "amber",
        note: "RelaxedR1CSWitness — W + E 에러 벡터 추가",
      },
      {
        lines: [73, 80],
        color: "violet",
        note: "RelaxedR1CSInstance — comm_W, comm_E, u 스케일",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [1, 10],
        color: "sky",
        note: "Spartan 모듈 — ppsnark + snark 하위 모듈",
      },
    ],
  },
};
