    ...
    annotations: [
      {
        lines: [5, 8],
        color: "sky",
        note: "피어당 3개 고루틴: Data(블록), Votes(투표), Maj23(쿼리)",
      },
      {
        lines: [15, 21],
        color: "emerald",
        note: "4개 P2P 채널: DataChannel이 최고 Priority(10)로 블록 전파 우선",
      },
      {
        lines: [25, 27],
        color: "amber",
        note: "gossip 루프: 피어/자신이 중지되면 고루틴 종료",
      },
      {
        lines: [30, 34],
        color: "violet",
        note: "블록 파트 전파: 피어가 필요한 파트를 선택하여 전송",
      },
      {
        lines: [37, 41],
        color: "rose",
        note: "Proposal 전파: 같은 Height/Round인 피어에게 제안 전송",
      },
    ],
  },
};
