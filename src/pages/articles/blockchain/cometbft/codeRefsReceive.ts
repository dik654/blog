    ...
    annotations: [
      {
        lines: [3, 11],
        color: "sky",
        note: "메시지 디코딩 + 기본 검증 실패 시 피어 연결 차단",
      },
      {
        lines: [16, 26],
        color: "emerald",
        note: "StateChannel(0x20): 라운드 상태 동기화 — PeerState만 업데이트",
      },
      {
        lines: [28, 36],
        color: "amber",
        note: "DataChannel(0x21): 제안/블록파트 → peerMsgQueue로 전달",
      },
      {
        lines: [38, 43],
        color: "violet",
        note: "VoteChannel(0x22): 투표 메시지 → peerMsgQueue → addVote 처리",
      },
      {
        lines: [45, 49],
        color: "rose",
        note: "VoteSetBitsChannel(0x23): 투표 비트맵 교환 (Liveness 보조)",
      },
    ],
  },
};
