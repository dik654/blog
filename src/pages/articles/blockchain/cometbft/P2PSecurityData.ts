...
export const SECURITY_TABLE = [
  {
    ...
    compare: "devp2p: AES-256-CTR + HMAC",
  },
  {
    layer: "키 교환",
    mechanism: "X25519 ECDH",
    compare: "devp2p: secp256k1 ECIES",
  },
  {
    layer: "인증",
    mechanism: "Ed25519 서명",
    compare: "devp2p: secp256k1 서명",
  },
  {
    layer: "피어 발견",
    mechanism: "PEX Reactor + Seed 노드",
    compare: "devp2p: Kademlia DHT",
  },
  {
    layer: "DoS 방어",
    mechanism: "Rate Limit + TrustScore",
    compare: "devp2p: 연결 수 제한",
  },
] as const;
