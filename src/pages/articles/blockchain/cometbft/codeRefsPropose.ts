    ...
    annotations: [
      {
        lines: [4, 8],
        color: "sky",
        note: "가드절: Height/Round/Step 검증 — 이미 진행된 단계면 무시",
      },
      {
        lines: [11, 20],
        color: "emerald",
        note: "defer: Propose 완료 후 Step 갱신 → proposal 완성 시 즉시 Prevote 진입",
      },
      {
        lines: [23, 25],
        color: "amber",
        note: "timeoutPropose 스케줄링 — 제안이 늦으면 타임아웃으로 Prevote 진입",
      },
      {
        lines: [38, 44],
        color: "violet",
        note: "제안자 판별: isProposer이면 decideProposal()로 블록 생성 및 브로드캐스트",
      },
    ],
  },
};
