    ...
    annotations: [
      {
        lines: [2, 3],
        color: "sky",
        note: "뮤텍스 잠금: 상태 머신은 단일 스레드 직렬 처리 보장",
      },
      {
        lines: [8, 10],
        color: "emerald",
        note: "Proposal: 서명 검증 후 저장 → 블록 파트 수신 대기",
      },
      {
        lines: [12, 16],
        color: "amber",
        note: "BlockPart: PartSet 조립 → 완성 시 handleCompleteProposal 호출",
      },
      {
        lines: [19, 23],
        color: "violet",
        note: "Vote: addVote → +2/3 감지 시 enterPrevote/enterPrecommit 호출",
      },
      {
        lines: [26, 28],
        color: "rose",
        note: "BlockSync 블록 주입: 외부에서 검증된 블록을 직접 커밋",
      },
    ],
  },
};
