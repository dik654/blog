  ...
  "receive-routine": {
    ...
    annotations: [
      ...
      },
      {
        lines: [14, 15],
        color: "emerald",
        note: "Mempool 알림: 새 트랜잭션 도착 시 빈 블록 대기 해제",
      },
      {
        lines: [17, 22],
        color: "amber",
        note: "P2P 메시지: WAL 기록 후 handleMsg()로 Proposal/Vote 처리",
      },
      {
        lines: [24, 29],
        color: "violet",
        note: "내부 메시지: 자체 투표를 WAL에 fsync 후 처리 (크래시 안전)",
      },
      {
        lines: [31, 36],
        color: "rose",
        note: "타임아웃: Propose/Prevote/Precommit 타임아웃 → 다음 단계 전환",
      },
    ],
  },
};
