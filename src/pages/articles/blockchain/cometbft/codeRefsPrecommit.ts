    ...
    annotations: [
      {
        lines: [12, 13],
        color: "sky",
        note: "Polka 확인: Prevotes에서 +2/3 다수결 블록 조회",
      },
      {
        lines: [15, 19],
        color: "emerald",
        note: "Polka 미달성 → nil Precommit (다음 라운드로)",
      },
      {
        lines: [21, 29],
        color: "amber",
        note: "+2/3이 nil에 투표 → 기존 Lock 해제 후 nil Precommit",
      },
      {
        lines: [32, 37],
        color: "violet",
        note: "이미 Lock된 블록에 Polka → Relock 후 Precommit",
      },
      {
        lines: [40, 48],
        color: "rose",
        note: "새 블록에 Polka → Lock 설정 & Precommit (핵심 경로)",
      },
    ],
  },
};
