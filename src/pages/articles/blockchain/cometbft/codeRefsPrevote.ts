    ...
    annotations: [
      {
        lines: [4, 10],
        color: "sky",
        note: "Lock 우선: 이전 라운드에서 Lock된 블록이 있으면 해당 블록에 Prevote",
      },
      {
        lines: [12, 17],
        color: "emerald",
        note: "Proposal 없음: 제안 블록을 못 받았으면 nil에 투표 (타임아웃 경로)",
      },
      {
        lines: [20, 25],
        color: "amber",
        note: "합의 레벨 블록 검증: ValidateBlock으로 구조적 유효성 확인",
      },
      {
        lines: [28, 34],
        color: "violet",
        note: "ABCI ProcessProposal: 앱에 블록 검증 위임 — 거부 시 nil 투표",
      },
      {
        lines: [43, 46],
        color: "rose",
        note: "모든 검증 통과 시 ProposalBlock 해시에 서명하여 Prevote 브로드캐스트",
      },
    ],
  },
};
