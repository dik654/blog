    ...
    annotations: [
      {
        lines: [1, 6],
        color: "sky",
        note: "Fp6 = Fp2 3개. v^3 = beta(9+u)로 차수 제한",
      },
      {
        lines: [8, 16],
        color: "emerald",
        note: "Karatsuba — v0, v1, v2 재사용으로 곱셈 횟수 절감",
      },
    ...
    annotations: [
      {
        lines: [1, 6],
        color: "sky",
        note: "Fp12 — 페어링의 결과 공간. embedding degree k=12",
      },
      {
        lines: [8, 15],
        color: "emerald",
        note: "Karatsuba — Fp2, Fp6, Fp12 모두 동일 구조",
      },
      {
        lines: [18, 21],
        color: "amber",
        note: "conjugate + norm — Fp12 역원을 Fp6 역원으로 환원",
      },
    ],
  },
};
