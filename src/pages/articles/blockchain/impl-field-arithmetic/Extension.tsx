    ...
    <section id="extension" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="leading-7">
          ...
          <br />
          최종적으로 Fp의 Fermat 역원(a^(p-2))에 도달 — 복잡한 12차 역원이
          소수체 역원으로 환원
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose my-4 bg-muted/50 rounded-xl border border-border overflow-hidden">
          <div className="bg-muted px-5 py-2 border-b border-border">
            ...
            <span className="text-xs text-muted-foreground ml-2">
              총 차원: 2 &times; 3 &times; 2 = 12 over Fp
            </span>
          </div>
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2 mb-1">
                곱셈 — Karatsuba (4 &rarr; 3 Fp mults)
              </p>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2 mb-1">
                역원 — 2 Fp mults + 1 Fp inverse
              </p>
              <M display>{"(a + bu)^{-1} = \\frac{a - bu}{a^2 + b^2}"}</M>
              <p className="text-xs text-muted-foreground mt-1">
                켤레(conjugate): <M>{"\\overline{a + bu} = a - bu"}</M>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose my-4 bg-muted/50 rounded-xl border border-border overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-xs text-muted-foreground mb-1">
                표현: <M>{"c_0 + c_1 v + c_2 v^2"}</M>, <M>{"v^3 = u + 9"}</M>
              </p>
              <p className="text-xs text-muted-foreground mt-2 mb-1">
                곱셈 — Karatsuba-Toom (9 &rarr; 6 Fp2 mults)
              </p>
              <p className="text-xs">
                <M>{"c_0 c_0\\!\\prime"}</M>, <M>{"c_1 c_1\\!\\prime"}</M>,{" "}
                <M>{"c_2 c_2\\!\\prime"}</M> 각 1회
              </p>
              <p className="text-xs mt-1">
                <M>{"(c_0+c_1)(c_0\\!\\prime+c_1\\!\\prime)"}</M> 등 교차항 3회
              </p>
        ...
        <div className="not-prose my-4 bg-muted/50 rounded-xl border border-border overflow-hidden">
          <div className="bg-muted px-5 py-2 border-b border-border">
            ...
            <span className="text-xs text-muted-foreground ml-2">
              ...
              — <M>{"c_0 + c_1 w"}</M>, <M>{"w^2 = v"}</M>
            </span>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-xs text-muted-foreground mb-1">
                곱셈 — Karatsuba (4 &rarr; 3 Fp6 mults)
              </p>
              <p className="text-xs">
                <M>{"c_0 c_0\\!\\prime"}</M>, <M>{"c_1 c_1\\!\\prime"}</M>
              </p>
              <p className="text-xs">
                <M>{"(c_0+c_1)(c_0\\!\\prime+c_1\\!\\prime)"}</M> - 위 두 결과
              </p>
            ...
            <div>
              ...
              <p className="text-xs">
                Cyclotomic squaring (GT용): 36 &rarr;{" "}
                <strong>9 Fp mults</strong>
              </p>
              <p className="text-xs text-muted-foreground mt-2 mb-1">
                Frobenius: <M>{"x \\mapsto x^p"}</M>
              </p>
              <p className="text-xs">사전 계산된 상수로 저비용 수행</p>
              <p className="text-xs text-muted-foreground">
                final exponentiation에 사용
              </p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground mb-1">
              ...
              <p className="text-xs">
                Fp12 &rarr; Fp6 norm &rarr; Fp2 norm &rarr; Fp
              </p>
              <p className="text-xs mt-1">
                <M>{"\\text{inv}(a) = \\overline{a} / \\text{norm}(a)"}</M>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="not-prose my-4 bg-muted/50 rounded-xl border border-border overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            <div className="text-center">
              ...
              <p>
                4 &rarr; <strong>3</strong> Fp mults
              </p>
            ...
            <div className="text-center">
              ...
              <p>
                9 &rarr; <strong>6</strong> Fp2 mults
              </p>
            ...
            <div className="text-center">
              ...
              <p>
                4 &rarr; <strong>3</strong> Fp6 mults
              </p>
              <p className="text-xs text-muted-foreground">25% 절감</p>
            </div>
          </div>
          <div className="px-5 pb-5">
            <p className="text-sm text-center">
              합산: <M>{"4 \\times 9 \\times 4 = 144"}</M> &rarr;{" "}
              <M>{"3 \\times 6 \\times 3 = 54"}</M> Fp mults —{" "}
              <strong>2.67배 가속</strong>
            </p>
          </div>
        </div>
        ...
        <div className="not-prose my-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-muted/50 rounded-xl p-5 border border-border">
            ...
            <p className="text-sm">
              <M>{"e: G_1 \\times G_2 \\to \\mathbb{F}_{p^{12}}"}</M>
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              <M>{"G_1 \\in E(\\mathbb{F}_p)"}</M> — 좌표가 Fp
            </p>
            <p className="text-xs text-muted-foreground">
              <M>{"G_2 \\in E\\!\\prime(\\mathbb{F}_{p^2})"}</M> — 좌표가 Fp2
              (twist)
            </p>
            <p className="text-xs text-muted-foreground">
              결과: Fp12 (GT 부분군)
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Miller loop: Fp12 곱&middot;제곱
            </p>
            <p className="text-xs text-muted-foreground">
              Final exp: Fp12 연산 + Frobenius
            </p>
          </div>
          <div className="bg-muted/50 rounded-xl border border-border overflow-hidden">
            ...
            <div className="p-5 text-sm">
              <p className="text-xs text-muted-foreground mb-1">
                파일 구조 — 각 상위 레벨이 하위에 위임
              </p>
              <p className="text-xs">
                <code className="text-xs bg-muted px-1 rounded">fp.rs</code>{" "}
                &rarr;{" "}
                <code className="text-xs bg-muted px-1 rounded">fp2.rs</code>{" "}
                &rarr;{" "}
                <code className="text-xs bg-muted px-1 rounded">fp6.rs</code>{" "}
                &rarr;{" "}
                <code className="text-xs bg-muted px-1 rounded">fp12.rs</code>{" "}
                &rarr;{" "}
                <code className="text-xs bg-muted px-1 rounded">
                  pairing.rs
                </code>
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex justify-between text-xs">
                  <span>Fp2 mult</span>
                  <span>~60 ns (3 Fp mults + adds)</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span>Fp6 mult</span>
                  <span>~400 ns (6 Fp2 mults)</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span>Fp12 mult</span>
                  <span>~1500 ns (3 Fp6 mults)</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span>Fp12 sq (cyclotomic)</span>
                  <span>~500 ns</span>
                </div>
              </div>
              <p className="text-xs text-muted-foreground mt-3">
                라이브러리: ark-bn254 (Rust), bn256 (Go), blst (C), py_ecc
                (Python)
              </p>
            </div>
          </div>
