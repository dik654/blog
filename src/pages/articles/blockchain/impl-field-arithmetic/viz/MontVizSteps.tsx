    ...
    <g>
      ...
      >
        ...
        <text
          ...
          fontWeight={600}
        >
          a_mont = a * R mod p → R로 나누기 = 비트 시프트
        </text>
      </motion.g>
    </g>
  );
...
export function SchoolbookStep() {
  ...
  return (
    <g>
      <text x={50} y={15} fontSize={8} fill={CV} fontWeight={600}>
        x
      </text>
      <text x={130} y={15} fontSize={8} fill={CE} fontWeight={600}>
        rhs
      </text>
      {rows.map((r, i) => (
        <motion.g
        ...
        >
          ...
          <text x={100} y={34 + i * 24} fontSize={9} fill={CA}>
            x
          </text>
          <rect
            x={110}
