...
export function Fp12TowerStep() {
  ...
  return (
    <g>
      ...
      >
        <text x={350} y={35} fontSize={8} fill={CA} fontWeight={600}>
          2 x 3 x 2 = 12
        </text>
        <text x={350} y={50} fontSize={7} fill="var(--muted-foreground)">
          embedding degree
        </text>
        <text x={350} y={90} fontSize={8} fill={CE} fontWeight={600}>
          e(G1, G2) in Fp12*
        </text>
        <text x={350} y={105} fontSize={7} fill="var(--muted-foreground)">
          페어링 결과 공간
        </text>
      </motion.g>
    </g>
