    ...
    annotations: [
      {
        lines: [3, 13],
        color: "sky",
        note: "1단계: 4x4 schoolbook 곱셈 — mac로 16회 곱셈+누적",
      },
      {
        lines: [16, 16],
        color: "emerald",
        note: "2단계: REDC — 8-limb을 4-limb으로 축소",
      },
      {
        lines: [24, 25],
        color: "amber",
        note: "INV 마법 — m*p를 더하면 하위 limb이 정확히 0",
      },
      {
        lines: [38, 38],
        color: "violet",
        note: "최종 보정 — 결과 >= p이면 p를 빼줌",
      },
    ],
  },
  "fp-inv-pow": {
    ...
    annotations: [
      {
        lines: [1, 3],
        color: "sky",
        note: "square — 자기 자신과 mont_mul. 별도 최적화 가능하지만 여기선 간결함 우선",
      },
      {
        lines: [6, 18],
        color: "emerald",
        note: "square-and-multiply — 비트 하나당 1회 제곱, 1이면 추가 곱셈. O(256) 곱셈",
      },
      {
        lines: [21, 25],
        color: "amber",
        note: "Fermat 역원 — 확장 유클리드 대신 pow 한 줄로 구현. 254비트 지수 계산",
      },
    ],
  },
};
