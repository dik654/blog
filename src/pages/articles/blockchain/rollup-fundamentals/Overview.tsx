  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        ...
        <p>
          OP Stack은 Optimism의 모듈식 롤업 프레임워크로, 시퀀서(L2 트랜잭션을
          수집·정렬·실행하는 노드)를 중심으로 5개 핵심 컴포넌트로 구성된다.
          <br />
      ...
      <div className="not-prose mb-4">
        <p className="text-sm text-foreground/70 mb-4">
          핵심 데이터 흐름: <strong>L1 블록</strong> → op-node(derivation, L1
          데이터로부터 L2 블록을 재구성하는 과정) → <strong>L2 블록</strong> →
          op-batcher → <strong>L1 calldata/blob</strong>
        </p>
        <RollupOverviewViz />
      </div>
    </section>
