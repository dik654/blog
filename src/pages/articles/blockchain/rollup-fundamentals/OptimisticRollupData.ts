...
export const SECTIONS: SubSection[] = [
  {
    ...
    summary:
      "L1 블록 데이터를 7단계 pull 파이프라인으로 변환하여 L2 블록을 결정론적으로 재구성한다.",
    detail:
    ...
    why:
      "왜 pull 방식인가? 각 단계가 필요할 때만 이전 단계에서 가져오므로 메모리를 절약한다. " +
  ...
  },
  {
    ...
    summary:
      "L2 블록을 압축·프레임화하여 L1에 calldata 또는 blob으로 제출한다.",
    detail:
    ...
    why:
      "왜 동적 DA 전환? EIP-4844 이후 blob이 보통 저렴하지만, blob 수요 급증 시에는 calldata가 " +
  ...
  },
  {
    ...
    summary:
      "이진 분할(bisection)으로 불일치 지점을 특정하고 단일 명령어 실행으로 판정한다.",
    detail:
    ...
    why:
      "왜 bisection? 수십억 개의 명령어 전체를 온체인에서 재실행하는 것은 불가능하다. " +
