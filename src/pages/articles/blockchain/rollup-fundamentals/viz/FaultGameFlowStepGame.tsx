...
export function FaultStep3() {
  const methods = [
    ...
    {
      line: "GetParent(claim) (Claim, error)",
      desc: "부모 주장 조회",
      c: C.game,
    },
    {
      line: "AgreeWithClaimLevel(claim, agree) bool",
      desc: "아군/적군 판별",
      c: C.pos,
    },
    {
      line: "ChessClock(now, claim) time.Duration",
      desc: "남은 응답 시간",
      c: C.atk,
    },
      ...
      {methods.map((m, i) => {
        ...
        return (
          ...
          >
            ...
            <text x={360} y={y + 15} fontSize={10} fill="var(--foreground)">
              {m.desc}
            </text>
          </motion.g>
        );
