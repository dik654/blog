...
export function TreeNode({
  ...
  n: (typeof TREE_NODES)[number];
  i: number;
  step: number;
}) {
  const isHighlightDepth = step === 2;
  const isDefender = n.depth % 2 === 0;
  const depthColor = isHighlightDepth
    ? isDefender
      ? "#10b981"
      : "#ef4444"
    : n.color;
      ...
      {step === 2 && i <= 2 && (
        ...
        >
          <rect
            ...
            stroke={isDefender ? "#10b981" : "#ef4444"}
            strokeWidth={0.8}
          />
          <text
            x={n.x + NR + 11}
