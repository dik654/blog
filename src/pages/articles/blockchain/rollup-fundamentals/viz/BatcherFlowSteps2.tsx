    ...
    <g>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          if s.tip != eth.HeaderBlockID(block.ParentHash()) {"{"}
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          {" "}
          return ErrReorg // ParentHash 불일치 → reorg 감지, 리셋 필요
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          s.blocks.Enqueue(ToSizedBlock(block)) // 큐에 추가
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          s.tip = block.Hash() // 팁 해시 갱신 → return nil (성공)
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
