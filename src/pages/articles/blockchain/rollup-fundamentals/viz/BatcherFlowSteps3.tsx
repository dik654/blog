    ...
    <g>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          for i := s.blockCursor; ; i++ {"{"} block := s.blocks.PeekN(i)
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          {" "}
          s.currentChannel.AddBlock(block) // 블록 데이터 압축 추가
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          {" "}
          if s.currentChannel.IsFull() {"{"} break {"}"} // 채널 용량 초과 시
          중단
        </text>
      </motion.g>
      <motion.g
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          s.blockCursor += blocksAdded // 다음 호출 시 이어서 진행
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
