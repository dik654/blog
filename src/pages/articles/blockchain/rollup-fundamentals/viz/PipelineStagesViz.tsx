...
const CHAIN = [
  ...
  },
  {
    ...
    method: "NextBatch()",
    input: "Batch",
    output: "SingularBatch",
  },
  {
    name: "AttributesQueue",
    method: "NextAttributes()",
    input: "SingularBatch",
    output: "PayloadAttributes",
  },
];
          ...
          >
            ...
            {i < stages.length - 1 && (
              ...
              >
                ...
                />
                <polygon
                  points={`236,${y + 63} 244,${y + 63} 240,${y + 68}`}
                  fill={Cs[idx]}
                />
              </motion.g>
            )}
