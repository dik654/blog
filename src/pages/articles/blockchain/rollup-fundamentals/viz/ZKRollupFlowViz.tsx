...
const STEPS = [
  {
    ...
    body: "Sequencer가 L2 트랜잭션을 모아 배치로 만듭니다.",
  },
  {
    label: "Prover가 ZK 증명 생성",
    body: "Prover가 상태 전이의 정확성을 증명하는 ZK proof를 생성합니다.",
  },
  {
    label: "L1 Verifier가 증명 검증",
    body: "L1 컨트랙트의 Verifier가 proof를 검증합니다. O(1) 시간.",
  },
  {
    label: "검증 즉시 확정",
    body: "검증 통과 즉시 상태가 확정됩니다. 챌린지 기간 불필요.",
  },
];
const NW = 72,
  NH = 36,
          ...
          {step === 3 && (
            ...
            >
              <circle
                ...
                r={8}
                fill={C[1]}
                style={{ filter: `drop-shadow(0 0 4px ${C[1]}88)` }}
              />
              <text
                x={nx(3) + NW / 2}
                y={17}
