    ...
    <g>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          func (l *BatchSubmitter) loop() {"{"} l.loadBlocksIntoState(ctx) {"}"}
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0, y: -8 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          s.channelManager.AddL2Block(block) // L2 블록을 큐에 추가
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0, y: -8 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          s.channelManager.processBlocks() // 큐 → 채널 압축
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0, y: -8 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          txData, err := s.channelManager.TxData(l1Head) // DA TX 생성
        </text>
      </motion.g>
      <motion.g
      ...
      >
        <rect
          ...
          strokeWidth={0.8}
        />
        <text x={30} y={164} fontSize={10} fontWeight={600} fill={C.struct}>
        ...
        <text
          ...
          fontFamily="monospace"
        >
          blocks: Queue | blockCursor: int | currentChannel: *channel |
