...
const STEPS = [
  {
    label: "Optimistic vs ZK Rollup 비교",
    body: "두 롤업 유형의 핵심 트레이드오프를 비교합니다.",
  },
  {
    label: "Optimistic: 낮은 비용, 긴 확정 지연",
    body: "Optimistic은 7일 챌린지 기간이 필요하지만 증명 비용이 낮습니다.",
  },
  {
    label: "ZK Rollup: 즉시 확정, 높은 증명 비용",
    body: "ZK는 즉시 확정되지만 증명 생성에 높은 연산 비용이 듭니다.",
  },
];
const BX = [140, 340],
  BY = 28,
