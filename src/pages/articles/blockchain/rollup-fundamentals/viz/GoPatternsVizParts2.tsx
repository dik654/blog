...
export function PointerRecvStep() {
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text x={42} y={52} fontSize={9} fill="var(--foreground)">
        blocks: Queue
      </text>
      <text x={42} y={66} fontSize={9} fill="var(--foreground)">
        tip: Hash
      </text>
      <text x={42} y={80} fontSize={9} fill="var(--foreground)">
        currentChannel
      </text>
      <motion.path
        d="M170,55 L210,55"
      ...
      />
      <text x={190} y={48} fontSize={8} fill="#0ea5e9">
        *ptr
      </text>
      <rect
        x={220}
