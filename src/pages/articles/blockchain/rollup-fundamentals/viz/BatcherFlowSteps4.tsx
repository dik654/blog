    ...
    <g>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          ch, err := s.getReadyChannel(l1Head) // processBlocks() 내부 호출
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          if s.UseBlobs {"{"} // EIP-4844 blob TX (저렴한 DA)
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          {"}"} else {"{"} // calldata TX (blob이 비쌀 때 대체)
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          return nextTxData(ch) // 채널에서 프레임 추출 → txData 반환
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
