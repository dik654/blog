...
export function StructEmbedStep() {
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text x={40} y={54} fontSize={9} fill="var(--foreground)">
        Log, Metr, Config
      </text>
      <text x={40} y={68} fontSize={9} fill="var(--foreground)">
        TxManager, Endpoint
      </text>
      <rect
        x={200}
      ...
      <text x={340} y={48} fontSize={9} fill="var(--foreground)">
        channelMgr
      </text>
      <text x={340} y={62} fontSize={9} fill="var(--foreground)">
        publishSignal
      </text>
      <text x={340} y={76} fontSize={9} fill="var(--foreground)">
        shutdownCtx
      </text>
      <motion.path
        d="M170,50 Q185,50 200,50"
        fill="none"
        stroke="#6366f1"
        strokeWidth={1.2}
        strokeDasharray="3 2"
