  ...
  return (
    <g>
      ...
      >
        ...
        >
          Line 1: if dp.resetting {"<"} len(stages) {"{"}{" "}
          stages[dp.resetting].Reset() {"}"}
        </text>
      </motion.g>
      <motion.g
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 2: attrib, err := dp.attrib.NextAttributes(ctx, safeHead)
        </text>
      </motion.g>
      <motion.g
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 3: if err == nil {"{"} return attrib {"}"}
        </text>
      ...
      >
        ...
        <text
          ...
          fontFamily="monospace"
        >
          Line 4: if err == io.EOF {"{"} AdvanceL1 {"}"}
        </text>
      ...
      >
        ...
        >
          nil → 계속 호출 | io.EOF → L1 대기 | *Attrib → 블록 생성 | ResetError
          → 리셋
        </text>
      </motion.g>
    </g>
