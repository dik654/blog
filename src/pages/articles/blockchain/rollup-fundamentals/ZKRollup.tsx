  ...
  return (
    <section id="zk-rollup" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          ZK Rollup — 모든 상태 전이에 영지식 증명(validity proof, 상태 전이의
          수학적 정당성 증명)을 생성하는 방식. L1 컨트랙트가 O(1) 시간에 증명을
          검증하므로 챌린지 기간이 불필요하다.
          <br />
                  ...
                  style={{
                    borderColor:
                      activeStep === step.id
                        ...
                        : "var(--color-border)",
                    background:
                      activeStep === step.id ? `${step.color}15` : undefined,
                  }}
                >
                  <p
          ...
          {TRADEOFFS.map((t) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div
                  className={`rounded p-2 ${t.winner === "optimistic" ? "bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800" : "bg-muted/30"}`}
                >
                ...
                <div
                  className={`rounded p-2 ${t.winner === "zk" ? "bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-200 dark:border-indigo-800" : "bg-muted/30"}`}
                >
