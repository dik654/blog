...
export const codeRefs: Record<string, CodeRef> = {
  "sector-states": {
    ...
    lang: "go",
    highlight: [11, 41],
    desc: "Historical lotus-miner sealing snapshot — 축약된 sector state transition",
    annotations: [
      {
        lines: [12, 13],
        color: "sky",
      ...
      },
      {
        lines: [14, 23],
        color: "emerald",
        note: "snapshot의 대표 상태이며 현재 scheduler 전체 상태 수를 의미하지 않는다",
      },
      {
        lines: [27, 33],
        color: "amber",
        note: "handlePreCommit1 — SealPreCommit1 task를 호출하는 역사적 경계",
      },
      {
        lines: [34, 36],
        color: "violet",
  ...
  "winning-post": {
    ...
    lang: "go",
    highlight: [11, 39],
    desc: "Historical mining snapshot — election → WinningPoSt → block candidate",
    annotations: [
      {
        lines: [11, 15],
        color: "sky",
