...
export const codeRefs: Record<string, CodeRef> = {
  "clist-struct": {
    path: "mempool/clist_mempool.go",
    code: clistGo,
    lang: "go",
    highlight: [19, 41],
    desc: "Historical CListMempool snapshot — 이중 연결 리스트 + txByKey map + cache",
    annotations: [
      {
        lines: [20, 25],
        color: "sky",
  ...
  "clist-checktx": {
    ...
    lang: "go",
    highlight: [46, 83],
    desc: "Historical CList CheckTx snapshot — 중복 체크 → ABCI 검증 → 콜백",
    annotations: [
      {
        lines: [47, 48],
        color: "sky",
  ...
  "clist-addtx": {
    ...
    lang: "go",
    highlight: [87, 117],
    desc: "Historical CList reqResCb + addTx snapshot — ABCI 응답 후 삽입",
    annotations: [
      {
        lines: [92, 96],
        color: "sky",
  ...
  "clist-update": {
    ...
    lang: "go",
    highlight: [121, 151],
    desc: "Historical CList Update snapshot — block 반영 후 포함 TX 제거 + optional recheck",
    annotations: [
      {
        lines: [128, 136],
        color: "sky",
  ...
  "clist-recheck": {
    ...
    lang: "go",
    highlight: [156, 169],
    desc: "Historical CList recheckTxs snapshot — Front()부터 남은 TX 재검증",
    annotations: [
      {
        lines: [157, 159],
        color: "sky",
