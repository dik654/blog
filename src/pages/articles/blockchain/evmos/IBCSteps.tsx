...
const LINES = [
  {
    code: "stack := ibcCallbacksMW(erc20MW(ibcTransferModule))",
    color: "#8b5cf6",
    desc: "IBC Callbacks MW: 컨트랙트 콜백 호출",
  },
  {
    code: "erc20MW.OnRecvPacket(ctx, packet)  // 수신 시 ERC20 민팅",
    color: "#10b981",
    desc: "ERC20 Middleware: Coin ↔ ERC20 자동 변환",
  },
  {
    code: "transfer.OnRecvPacket(ctx, packet) // 기본 IBC 전송 처리",
    color: "#6366f1",
    desc: "IBC Transfer Module: 기본 토큰 전송 로직",
  },
];
