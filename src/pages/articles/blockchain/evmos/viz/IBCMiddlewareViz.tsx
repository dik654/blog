...
const STEPS = [
  {
    label: "Chain A에서 IBC 전송",
    body: "ERC20 토큰을 IBC 패킷으로 다른 체인에 전송합니다.",
  },
  {
    label: "ERC20 Middleware 변환",
    body: "송신 시 ERC20→Cosmos 코인 변환, 수신 시 역변환합니다.",
  },
  {
    label: "IBC Transfer 실행",
    body: "IBC Transfer Module이 패킷을 릴레이어로 전송합니다.",
  },
  {
    label: "Chain B에서 수신",
    body: "수신 체인에서 Cosmos 코인 민팅 후 ERC20 자동 변환합니다.",
  },
];
