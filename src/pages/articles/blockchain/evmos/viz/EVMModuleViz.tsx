...
const STEPS = [
  {
    label: "사용자 요청 (MetaMask)",
    body: "MetaMask에서 이더리움 트랜잭션을 전송합니다.",
  },
  {
    label: "Ante Handler 검증",
    body: "서명 검증, 수수료 차감, nonce 확인을 수행합니다.",
  },
  {
    label: "EVM 실행",
    body: "go-ethereum EVM이 스마트 컨트랙트 바이트코드를 실행합니다.",
  },
  {
    label: "상태 업데이트",
    body: "EVM 결과를 Cosmos KVStore에 반영하고 이벤트를 발생시킵니다.",
  },
];
