...
const STEPS = [
  {
    ...
    body: "Solidity 스마트 컨트랙트와 dApp이 실행되는 최상위 레이어.",
  },
  {
    label: "EVM Layer",
    body: "go-ethereum 포크 기반 EVM. Cosmos StateDB와 연동됩니다.",
  },
  {
    label: "Cosmos SDK Layer",
    body: "Keeper, Module, State 관리. ERC20/FeeMarket 모듈 포함.",
  },
  {
    label: "Consensus Layer",
    body: "CometBFT v0.38. Tendermint BFT 합의로 블록을 확정합니다.",
  },
];
