    ...
    annotations: [
      {
        lines: [3, 5],
        color: "sky",
        note: "Sponge — capacity(비밀 영역) + rate(입력 영역)로 상태 분할",
      },
      {
        lines: [13, 14],
        color: "emerald",
        note: "입력을 rate 위치에 배치 — capacity는 0 고정(도메인 분리)",
      },
      {
        lines: [16, 16],
        color: "amber",
        note: "출력은 state[1] — rate의 첫 원소. squeeze 단계에 해당",
      },
    ],
  },
  "poseidon-params": {
    ...
    annotations: [
      {
        lines: [1, 2],
        color: "sky",
        note: "T=3 — Sponge rate=2, capacity=1. 2-to-1 해시에 최적",
      },
      {
        lines: [3, 4],
        color: "emerald",
        note: "α=5 — gcd(5, r-1)=1이어야 S-box가 역함수를 가짐",
      },
      {
        lines: [5, 8],
        color: "amber",
        note: "RF=8(보안), RP=57(효율) — full/partial 분리가 핵심 최적화",
      },
    ],
  },
};
