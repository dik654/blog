    ...
    annotations: [
      {
        lines: [1, 5],
        color: "sky",
        note: "x⁵를 중간 변수로 분해 — R1CS는 A·B=C 형태만 허용",
      },
      {
        lines: [13, 15],
        color: "emerald",
        note: "보조 변수(witness) 할당 — 검증자가 모르는 중간 값",
      },
      {
        lines: [17, 26],
        color: "amber",
        note: "3개 제약 — S-box 하나당 곱셈 3회. full round는 9개, partial은 3개",
      },
    ],
  },
  "merkle-circuit": {
    ...
    annotations: [
      {
        lines: [3, 6],
        color: "sky",
        note: "root만 공개(instance), 나머지는 비공개(witness) — ZK의 핵심",
      },
      {
        lines: [15, 17],
        color: "emerald",
        note: "Poseidon 회로 재사용 — 리프 해시를 회로 내에서 재계산",
      },
      {
        lines: [24, 26],
        color: "amber",
        note: "boolean + mux — 비트에 따라 left/right 선택을 제약으로 강제",
      },
      {
        lines: [33, 33],
        color: "violet",
        note: "최종 등치 제약 — 재계산한 루트 == 공개 입력 루트",
      },
    ],
  },
};
