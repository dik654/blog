...
import { ShaVsPoseidonStep, RoundStructureStep } from './OverviewVizSteps';
import { SpongeStep, FullPipelineStep } from './OverviewVizSteps2';

const RENDERERS = [ShaVsPoseidonStep, RoundStructureStep, SpongeStep, FullPipelineStep];
