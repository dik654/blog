    ...
    <section id="commitment" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          <br />
          Hiding: randomness가 균일 랜덤이면 C에서 value 역산 불가 (pre-image
          resistance)
          <br />
          Binding: 같은 C에 다른 (value, randomness) 쌍을 찾는 것 = collision
          찾기
        </p>
        <p className="leading-7">
          Pedersen 커밋먼트(C = v*G + r*H)와 비교 — 동형성(homomorphism) 불필요
          시 해시 기반이 유리
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="leading-7">
          ...
          <br />
          MerkleProofCircuit에서 leaf = H(key, value)가 사실상 커밋먼트 — 같은
          패턴 재활용
          <br />
          회로 내 커밋먼트 검증: Poseidon circuit(~634 제약) + equality(1 제약)
          = 635개
        </p>
      </div>
    </section>
