    ...
    <section id="comparison" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          PBFT → HotStuff → Autobahn → Casper FFG의 종합 비교.
          <br />각 프로토콜의 <strong>trade-off</strong> 명확화.
          <br />
          용도별 최적 선택 가이드.
        </p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">
          3축 비교: Latency / Throughput / Robustness
        </h3>
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          ...
          <div className="rounded-lg border p-4">
            ...
            <ul className="text-sm space-y-1 list-disc pl-4">
              <li>
                <strong>L1 blockchain</strong>: Mysticeti, Jolteon, Autobahn
              </li>
              <li>
                <strong>Appchain</strong>: Tendermint/CometBFT
              </li>
              <li>
                <strong>Permissioned</strong>: PBFT, IBFT
              </li>
              <li>
                <strong>High-throughput</strong>: DAG-BFT
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-3 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              GST 없이 liveness 보장. Ditto, HoneyBadger BFT 계승. DDoS 저항
              강화.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">
              DAG + Sequential Hybrid
            </p>
            <p className="text-sm">
              Autobahn 확장. Mysticeti 개선. 각 tier 최적 프로토콜.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">Optimistic BFT</p>
            <p className="text-sm">
              happy path 극적 단순화. rollback + challenge 메커니즘. optimistic
              rollup 영향.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              10,000+ validators. committee sampling(VRF). shard-based
              consensus.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              ZK proof 통합. validator 익명성. confidential TX.
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">MEV-resistant BFT</p>
            <p className="text-sm">
              fair ordering. encrypted mempool. proposer-builder separation.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              MystenLabs(Mysticeti), Aptos Labs(Jolteon), UC Berkeley(Autobahn),
              Protocol Labs(F3/GossiPBFT), Ethereum Foundation(Casper)
            </p>
          </div>
          <div className="rounded-lg border p-4">
        ...
        <p className="leading-7">
          ...
          10K+ validators + 100K+ TPS + async liveness 목표.
          <br />
          2025-2026 새 L1 설계의 핵심 과제.
        </p>

        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 BFT 선택의 현실적 기준</strong> — 이론보다 성숙도.
          <br />
          HotStuff-2가 이론 최적이지만 mainnet 없음.
          <br />
          Jolteon/Mysticeti는 실무 검증 완료.
          <br />
