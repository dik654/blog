    ...
    <section id="autobahn" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p className="leading-7">
          Autobahn (SOSP 2024) —{" "}
          <strong>전통 BFT 저지연 + DAG 빠른 복구</strong> 결합.
          <br />
          Highway(합의) + Lanes(데이터) 분리 + Ride-Sharing piggyback.
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <h3 className="text-xl font-semibold mb-3">
          Highway · Lanes · Ride-Sharing
        </h3>
        <p className="leading-7">
          합의(Highway)와 데이터 전파(Lanes)를 분리 — Ride-Sharing으로 메시지
          피기백.
        </p>
      </div>
      <div className="not-prose mb-8">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border border-destructive/30 p-4">
            ...
            <p className="text-sm">
              낮은 정상 latency (3-4δ). but blip 복구 느림 — timeout + view
              change로 <strong>~2-5s halt</strong>.
            </p>
          </div>
          <div className="rounded-lg border border-destructive/30 p-4">
            <p className="font-semibold text-sm mb-1">
            ...
            <p className="text-sm">
              빠른 blip 복구 (parallel progress, <strong>~100-200ms</strong>).
              but 높은 정상 latency + DAG 구축 overhead.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              brief failure — 수 백 ms 동안 validator 응답 없음. 네트워크
              jitter, 일시적 DDoS, restart 등. 현실 운영에서 자주 발생.
            </p>
          </div>
          <div className="rounded-lg border p-4 bg-muted/50">
            <p className="font-semibold text-sm mb-1">Autobahn의 해결</p>
            <p className="text-sm">
              happy path: 전통 BFT 스타일(저지연). blip 감지 시: DAG-like 구조로
              전환. <strong>hybrid benefit</strong> — "둘 다 얻을 수 없을까?"에
              대한 답.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <ul className="text-sm space-y-1 list-disc pl-4">
              ...
              <li>
                <code className="text-xs">O(n)</code> lanes in parallel → high
                throughput
              </li>
            </ul>
          </div>
        ...
        <div className="rounded-lg border p-4 not-prose mb-4">
          ...
          <p className="text-sm mb-2">
            validator가 lane batch 생성 시 다른 validator의 batch signature를
            포함(piggyback) — additional messages 절감.
          </p>
          <p className="text-sm text-muted-foreground">
            예: validator A가 batch A1 생성 시{" "}
            <code className="text-xs">ack(B3, C2)</code> 포함 →{" "}
            <code className="text-xs">N²</code> ack →{" "}
            <code className="text-xs">N</code> ack. latency도 감소.
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              정상 시: highway sequential commit. validator failure 감지 → 해당
              lane skip + 다른 batch로 continue. failure 복구 시 누락된 batch
              replay + highway catch up.
            </p>
          </div>
          <div className="rounded-lg border p-4 bg-muted/50">
            <p className="font-semibold text-sm mb-1">성능 (SOSP 2024)</p>
            <p className="text-sm">
              Happy path: 2-3δ (HotStuff급). Blip recovery: 100-200ms (DAG급).
              Throughput: 100K+ TPS. Validators: 50-100.
            </p>
          </div>
        </div>
        <p className="leading-7">
          Highway (consensus) + Lanes (dissemination) 분리.
          <br />
        ...
        <p className="leading-7">
          Autobahn vs Mysticeti/Jolteon 비교 — <strong>happy path 최적</strong>.
          <br />
          2024 SOSP, 아직 mainnet 없음.
          <br />
          DAG + sequential hybrid가 future 방향 제시.
        </p>

        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 왜 Autobahn이 "다음 세대" 후보인가</strong> — 두 세계의
          장점.
          <br />
          기존 BFT: 낮은 latency, but 느린 복구.
          <br />
          DAG-BFT: 빠른 복구, but 높은 latency.
          <br />
