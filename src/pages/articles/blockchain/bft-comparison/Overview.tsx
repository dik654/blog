    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          ...
          PBFT(1999) → HotStuff(2019) → Autobahn(2024).
          <br />각 세대 특정 한계 해결.
        </p>
        ...
        <div className="grid gap-3 sm:grid-cols-3 not-prose mb-4">
          ...
          <div className="rounded-lg border p-4">
            ...
            <ul className="text-sm space-y-1 list-disc pl-4">
              ...
              <li>
                LibraBFT/HotStuff (2019) — <code className="text-xs">O(n)</code>{" "}
                linear
              </li>
            </ul>
            <p className="text-xs text-muted-foreground mt-2">
        ...
        <p className="leading-7">
          진화 3단계: <strong>feasibility → scalability → throughput</strong>.
          <br />
          각 단계 25년간 validator 5배, TPS 15배 증가.
          <br />
        ...
        <div className="grid gap-3 sm:grid-cols-2 not-prose mb-4">
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              PBFT: <code className="text-xs">O(n²)</code> normal /{" "}
              <code className="text-xs">O(n³)</code> VC — HotStuff:{" "}
              <code className="text-xs">O(n)</code> both — DAG-BFT:{" "}
              <code className="text-xs">O(n²)</code> amortized parallel
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">2. Latency (commit)</p>
            <p className="text-sm">
              PBFT: 3δ — HotStuff chained: 3δ — HotStuff-2: 4δ — Mysticeti:
              390ms
            </p>
          </div>
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              PBFT: normal only — Tendermint: non-responsive — HotStuff-2: fully
              responsive
            </p>
          </div>
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              PBFT: explicit, expensive — Tendermint: implicit{" "}
              <code className="text-xs">round++</code> — HotStuff: linear
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">5. Leader Selection</p>
            <p className="text-sm">
              PBFT: round-robin — Tendermint: proposer schedule — DiemBFT:
              reputation-based
            </p>
          </div>
          <div className="rounded-lg border p-4">
          ...
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm">
              전통 BFT: <code className="text-xs">O(1)</code> block/view —
              DAG-BFT: <code className="text-xs">O(n)</code> blocks/wave
            </p>
          </div>
          <div className="rounded-lg border p-4">
            <p className="font-semibold text-sm mb-1">8. Fork Resistance</p>
            <p className="text-sm">
              BFT: absolute (<code className="text-xs">f&lt;n/3</code>) —
        ...
        <p className="leading-7">
          8가지 비교 차원:{" "}
          <strong>
            complexity, latency, responsiveness, VC, leader, network,
            throughput, fork
          </strong>
          .<br />
          각 프로토콜은 차원별 trade-off 선택.
          <br />
          완벽한 프로토콜 없음 — 용도별 최적화.
        </p>

        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>💡 왜 계속 새 BFT 프로토콜이 등장하나</strong> — 각 프로토콜의
          명확한 한계.
          <br />
          BFT는 "완료된 분야"가 아님 — 각 세대가 이전 한계 해결.
          <br />
          DAG-BFT (2022-)가 최신 흐름 — throughput 10-100배 향상.
          <br />
