      ...
      {label && (
        <>
          <rect
            ...
            fill="var(--card)"
          />
          <text x={mx} y={y - 3} textAnchor="middle" fontSize={10} fill={color}>
            {label}
          </text>
        </>
      )}
    ...
    <StepViz steps={STEPS}>
      {(step) => (
        ...
        >
          ...
          {step >= 0 && (
            <Msg x1={42} x2={128} y={75} label="Request" color={C.A} />
          )}
          {step >= 1 && (
            <motion.g
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <rect
                ...
                fill="var(--card)"
              />
              <text x={185} y={97} textAnchor="middle" fontSize={10} fill={C.P}>
                Pre-Prepare
              </text>
            </motion.g>
          )}
