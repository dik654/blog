        ...
        return (
          <motion.g key={i} {...fade(0.2 + i * 0.15)}>
            ...
            <circle
              ...
              strokeWidth={1}
            />
            <text x={nx} y={ny + 4} textAnchor="middle" fontSize={10} fill={CE}>
              R{i + 1}
            </text>
          </motion.g>
        );
    ...
    >
      ...
      <motion.g {...fade(0.7)}>
        <line
          ...
          markerEnd="url(#hsA)"
        />
        <text x={255} y={18} textAnchor="middle" fontSize={10} fill={CA}>
          집계
        </text>
      </motion.g>
      <motion.g {...slide(0.9)}>
