...
const STEPS = [
  {
    label: "Autobahn 레이어 아키텍처",
    body: "Highway(합의) + Lanes(데이터) 분리로 독립 최적화",
  },
  {
    label: "Lanes — 비동기 데이터 전파",
    body: "병렬 lane + Reliable Broadcast로 데이터 가용성 보장",
  },
  {
    label: "Ride-Sharing 피기백",
    body: "합의 메시지를 lane car에 피기백 — 네트워크 메시지 50% 절감",
  },
  {
    label: "Highway — 합의 확정",
    body: "Fast 3 delays / Slow 5 delays — Hangover 없이 즉시 복구",
  },
];
