  ...
  return (
    ...
    >
      <motion.g {...fade(0.2)}>
        ...
        <text x={115} y={82} textAnchor="middle" fontSize={10} fill={CV}>
          데이터 전파는 Lanes에 위임
        </text>
      </motion.g>
      <motion.g {...slide(0.7)}>
  ...
  return (
    ...
    >
      ...
      <motion.g {...fade(1.0)}>
        ...
        <text x={332} y={70} textAnchor="middle" fontSize={10} fill={CE}>
          Highway 장애와 독립적으로 동작
        </text>
      </motion.g>
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <motion.g {...slide(0.8)}>
        ...
        <text x={332} y={80} textAnchor="middle" fontSize={10} fill={CA}>
          통신 오버헤드 최소화
        </text>
      </motion.g>
      <defs>
