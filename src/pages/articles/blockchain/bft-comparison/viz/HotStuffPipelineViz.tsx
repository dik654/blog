...
const STEPS = [
  {
    label: "Chained HotStuff 파이프라인",
    body: "각 View에서 새 블록 제안과 이전 블록의 다음 단계를 동시 진행",
  },
  {
    label: "View 1 — B1 Prepare",
    body: "리더가 B1을 제안, Threshold Signature로 O(n) 통신",
  },
  {
    label: "View 2 — B2 제안 + B1 Pre-Commit",
    body: "B2 Prepare와 B1 Pre-Commit 동시 — 파이프라인 시작",
  },
  {
    label: "View 3-4 — 풀 파이프라인",
    body: "View 4에서 B1 확정 — 3-chain commit rule로 매 View 1블록 확정",
  },
];
