...
const STEPS = [
  {
    label: "원본 블롭",
    body: "클라이언트가 walrus store 명령으로 블롭을 업로드합니다.",
  },
  {
    label: "매트릭스 구성",
    body: "블롭을 k1(=n-2f) x k2(=n-f) 심볼로 행 우선 배열합니다.",
  },
  {
    label: "2D RS 인코딩",
    body: "행(Secondary)과 열(Primary) Reed-Solomon을 SIMD로 병렬 실행합니다.",
  },
  {
    label: "슬라이버 쌍",
    body: "Primary[i]와 Secondary[n-1-i]를 쌍으로 묶어 교차 복구를 보장합니다.",
  },
  {
    label: "Merkle 메타데이터",
    body: "n x n 심볼 해시 행렬로 Blake2b256 Merkle 트리를 생성합니다.",
  },
  {
    label: "노드 배포",
    body: "Sui 체인에 메타데이터 등록 후 각 노드에 슬라이버 쌍을 전송합니다.",
  },
];
