  ...
  "walrus-bft": {
    ...
    annotations: [
      { lines: [12, 14], color: "sky", note: "max_n_faulty — f = (n-1)/3" },
      {
        lines: [21, 25],
        color: "emerald",
        note: "min_n_correct — n - f (최소 정직 노드)",
      },
      {
        lines: [34, 42],
        color: "amber",
        note: "파라미터 테스트 케이스: n=100 → f=33",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [277, 289],
        color: "sky",
        note: "빈 슬라이버 할당 (Primary + Secondary)",
      },
      {
        lines: [293, 302],
        color: "emerald",
        note: "시스테매틱 심볼 직접 복사 (행/열)",
      },
      {
        lines: [308, 324],
        color: "amber",
        note: "행 방향 RS 인코딩 → Secondary 복구 심볼",
      },
      {
        lines: [337, 345],
        color: "violet",
        note: "열 방향 RS 인코딩 → Primary 복구 + 심볼 해시",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [421, 432],
        color: "sky",
        note: "RS 인코딩 설정 구조체 — primary k₁, secondary k₂",
      },
      {
        lines: [446, 460],
        color: "emerald",
        note: "new() — source_symbols_for_n_shards로 자동 도출",
      },
      {
        lines: [717, 725],
        color: "amber",
        note: "source_symbols_for_n_shards — BFT에서 k₁, k₂ 계산",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [41, 44],
        color: "sky",
        note: "PrimarySliver / SecondarySliver 타입 별칭",
      },
      {
        lines: [48, 56],
        color: "emerald",
        note: "SliverData<T> — Symbols + SliverIndex + PhantomData",
      },
      {
        lines: [429, 434],
        color: "amber",
        note: "SliverPair — primary[i] + secondary[n-1-i] 교차 보유",
      },
    ],
  },
};
