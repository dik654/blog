  ...
  return (
    <section id="encoding" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <code>BlobEncoder</code>는 원본 블롭을 2D Reed-Solomon 슬라이버 쌍으로
          인코딩합니다.
          <br />
          실제 RS 연산은 <code>reed_solomon_simd</code> 크레이트를 통해 SIMD
          최적화됩니다.
        </p>
        {onCodeRef && (
          <div className="not-prose flex flex-wrap gap-2 my-4">
            ...
            <CodeViewButton
              onClick={() =>
                onCodeRef("walrus-slivers", codeRefs["walrus-slivers"])
              }
            />
            <span className="text-[10px] text-muted-foreground self-center">
              slivers.rs
        ...
        <CodePanel
          title="RS 인코딩 설정"
          code={RS_CONFIG_CODE}
          annotations={RS_CONFIG_ANNOTATIONS}
        />
        ...
        <CodePanel
          title="슬라이버 타입 정의"
          code={SLIVER_CODE}
          annotations={SLIVER_ANNOTATIONS}
        />
      </div>
    </section>
  );
