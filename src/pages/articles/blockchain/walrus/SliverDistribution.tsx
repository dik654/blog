  ...
  return (
    <section id="sliver-distribution" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          각 저장 노드는 블롭의 <strong>Primary + Secondary 슬라이버 쌍</strong>
          을 보유합니다. Blake2b256 Merkle 트리로 슬라이버 무결성을 검증하고,
        ...
        <CodePanel
          title="슬라이버 쌍 & 심볼 구조"
          code={SLIVER_PAIR_CODE}
          annotations={SLIVER_PAIR_ANNOTATIONS}
        />

        <h3>슬라이버 검증 & 배포</h3>
        <CodePanel
          title="Merkle 검증 + WriteCertificate + 에포크 할당"
          code={VERIFY_CODE}
