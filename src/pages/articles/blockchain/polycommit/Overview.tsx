...
import { TRAIT_CODE, TRAIT_ANNOTATIONS } from "./OverviewData";
  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>다항식 커밋먼트</strong>(Polynomial Commitment)는 유한체 위의
          다항식에 대해 커밋하고, 원하는 평가값을 암호학적 증명과 함께 공개하는
          원시입니다.
          <code>arkworks-rs/poly-commit</code>은 6가지 주요 스킴을 통합
          구현합니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mt-6">
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-blue-500 bg-card p-4 mb-4">
          ...
          <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
            <li>
              <strong>Commit</strong> &mdash; <M>{"c = \\text{Commit}(p)"}</M>{" "}
              &nbsp;다항식 요약
            </li>
            <li>
              <strong>Open</strong> &mdash; <M>{"(x, y, \\pi)"}</M> 공개 &nbsp;(
              <M>{"y = p(x)"}</M> 증명)
            </li>
            <li>
              <strong>Verify</strong> &mdash;{" "}
              <M>{"\\text{Verify}(c, x, y, \\pi) \\to \\text{true/false}"}</M>
            </li>
          </ol>
        </div>
        ...
        <div className="not-prose rounded-lg border-l-4 border-l-emerald-500 bg-card p-4 mb-4">
          ...
          <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
            <li>
              Prover: 증인 다항식 <M>{"w(x)"}</M> 생성
            </li>
            <li>
              Commit: <M>{"c_w = \\text{PC.Commit}(w)"}</M>
            </li>
            <li>
              Challenge: 랜덤 포인트 <M>{"\\zeta"}</M>
            </li>
            <li>
              Evaluate: <M>{"y = w(\\zeta)"}</M>
            </li>
            <li>
              Proof: <M>{"\\pi = \\text{PC.Open}(w, \\zeta, y)"}</M>
            </li>
            <li>
              Verifier: <M>{"\\text{PC.Verify}(c_w, \\zeta, y, \\pi)"}</M>
            </li>
          </ol>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-muted-foreground">
              <tr className="border-b border-muted">
                <td className="py-1.5 pr-4">KZG10</td>
                <td className="pr-4">
                  <M>{"O(n)"}</M> MSM
                </td>
                <td className="pr-4">
              ...
              <tr className="border-b border-muted">
                <td className="py-1.5 pr-4">IPA</td>
                <td className="pr-4">
                  <M>{"O(n)"}</M>
                </td>
                <td className="pr-4">
              ...
              <tr className="border-b border-muted">
                <td className="py-1.5 pr-4">FRI</td>
                <td className="pr-4">
                  <M>{"O(n \\log n)"}</M>
                </td>
                <td className="pr-4">
              ...
              <tr className="border-b border-muted">
                <td className="py-1.5 pr-4">Hyrax</td>
                <td className="pr-4">
                  <M>{"O(n)"}</M>
                </td>
                <td className="pr-4">
              ...
              <tr className="border-b border-muted">
                <td className="py-1.5 pr-4">Ligero</td>
                <td className="pr-4">
                  <M>{"O(n \\log n)"}</M>
                </td>
                <td className="pr-4">
              ...
              <tr>
                <td className="py-1.5 pr-4">Bulletproofs</td>
                <td className="pr-4">
                  <M>{"O(n)"}</M>
                </td>
                <td className="pr-4">
        ...
        <div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              KZG10, Marlin, Sonic &mdash; powers of <M>{"\\tau"}</M> 필요
            </p>
          </div>
          <div className="rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground">
              IPA, FRI, Ligero, Hyrax &mdash; trusted setup 불필요
            </p>
          </div>
        </div>
      </div>
