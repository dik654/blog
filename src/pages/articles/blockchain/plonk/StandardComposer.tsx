  ...
  return (
    <section id="standard-composer" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          StandardComposer는 <strong>6개 선택자 벡터</strong>와{" "}
          <strong>4개 와이어 벡터</strong>를 관리한다. 게이트가 추가될 때마다 각
          벡터에 값이 push된다.
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded border border-sky-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground font-mono">
                  <li>
                    <code>q_m</code> -- 곱셈 항 계수
                  </li>
                  <li>
                    <code>q_l</code> -- left wire 계수
                  </li>
                  <li>
                    <code>q_r</code> -- right wire 계수
                  </li>
                  <li>
                    <code>q_o</code> -- output wire 계수
                  </li>
                  <li>
                    <code>q_4</code> -- 4번째 wire 계수 (확장)
                  </li>
                  <li>
                    <code>q_c</code> -- 상수 항
                  </li>
              ...
              <div className="rounded border border-emerald-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground font-mono">
                  <li>
                    <code>w_l</code> -- left input wire
                  </li>
                  <li>
                    <code>w_r</code> -- right input wire
                  </li>
                  <li>
                    <code>w_o</code> -- output wire
                  </li>
                  <li>
                    <code>w_4</code> -- 4번째 wire (TurboComposer)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded border border-sky-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground">
                  <li>
                    <code>zero_var</code> ={" "}
                    <code>append_output_public(F::zero)</code>
                  </li>
                  <li>
                    <code>alloc()</code> → <code>Variable(index)</code> --
                    private witness
                  </li>
                  <li>
                    <code>add_input()</code> → <code>Variable</code> -- public
                    input
                  </li>
                </ul>
              </div>
              <div className="rounded border border-emerald-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground">
                  ...
                  <li>
                    <code>q_m.push(s.q_m), q_l.push(s.q_l), ...</code>
                  </li>
                  <li>
                    <code>perm.add_variables_to_map(a, b, c, d, n)</code>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="rounded-lg border border-border/60 p-4 space-y-3">
            ...
            <div className="rounded border border-emerald-500/30 p-3">
              ...
              <div className="text-sm font-mono text-muted-foreground space-y-0.5">
                ...
                <p className="pl-5">
                  .add(F::one, F::one){" "}
                  <span className="text-sky-400/70">// q_l=1, q_r=1</span>
                </p>
                <p className="pl-5">
                  .out(-F::one){" "}
                  <span className="text-sky-400/70">// q_o=-1</span>
                </p>
                <p>{"}"});</p>
              </div>
            </div>
