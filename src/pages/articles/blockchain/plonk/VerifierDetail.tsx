  ...
  return (
    <section id="verifier-detail" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          검증자는 증명자와 동일한 transcript를 구성하여{" "}
          <strong>모든 챌린지를 재생성</strong>한다. 이것이 대화형 → 비대화형
          변환의 핵심이다.
        </p>
          ...
          <div className="rounded-lg border border-border/60 p-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <div className="rounded border border-sky-500/30 p-2">
                <p>
                  Round 1 transcript:{" "}
                  <code>transcript.append([a], [b], [c])</code>
                </p>
                <p>
                  → <M>{"\\beta, \\gamma = \\text{transcript.squeeze}()"}</M>
                </p>
              </div>
              <div className="rounded border border-border/40 p-2">
                <p>
                  <code>transcript.append([Z])</code> →{" "}
                  <M>{"\\alpha = \\text{transcript.squeeze}()"}</M>
                </p>
              </div>
              <div className="rounded border border-border/40 p-2">
                <p>
                  <code>transcript.append([t_lo], [t_mid], [t_hi])</code> →{" "}
                  <M>{"\\zeta = \\text{transcript.squeeze}()"}</M>
                </p>
              </div>
              <div className="rounded border border-emerald-500/30 p-2">
                <p>
                  Round 4 transcript:{" "}
                  <code>
                    transcript.append(a&#772;, b&#772;, c&#772;, &#963;&#772;_a,
                    &#963;&#772;_b, z&#772;_&#969;)
                  </code>
                </p>
                <p>
                  → <M>{"\\nu = \\text{transcript.squeeze}()"}</M>
                </p>
              </div>
            </div>
          </div>
        ...
        <p>
          KZG의 <strong>가법 동형성</strong>을 이용하여 개별 커밋먼트로부터
          combined commitment를 재구성한다.
        </p>
        <div className="not-prose my-4">
          <div className="rounded-lg border border-amber-500/30 p-4">
            ...
            <M display>
              {
                "\\bar{r} = \\bar{a} \\cdot \\bar{b} \\cdot \\nu_{q_m} + \\bar{a} \\cdot \\nu_{q_l} + \\bar{b} \\cdot \\nu_{q_r} + \\bar{c} \\cdot \\nu_{q_o} + \\nu_{q_c}"
              }
            </M>
            <M display>
              {
                "+ \\alpha \\cdot [\\bar{z}_\\omega(\\bar{a}+\\beta\\bar{\\sigma}_a+\\gamma)(\\bar{b}+\\beta\\bar{\\sigma}_b+\\gamma) \\cdot \\beta \\cdot \\nu_z]"
              }
            </M>
            ...
            <div className="mt-3 rounded border border-violet-500/30 p-3">
              ...
              <M display>
                {
                  "[F]_1 = \\nu \\cdot [a]_1 + \\nu^2 \\cdot [b]_1 + \\nu^3 \\cdot [c]_1 + \\nu^4 \\cdot [\\sigma_a]_1 + \\nu^5 \\cdot [\\sigma_b]_1 + [\\text{linearized terms}]_1"
                }
              </M>
            </div>
          </div>
        ...
        <p>
          최종 검증은 <strong>페어링 2회</strong>로 완료된다. 증명 크기와 검증
          시간 모두 회로 크기에 무관하다.
        </p>
        <div className="not-prose my-4">
          <div className="rounded-lg border border-border/60 p-4">
            <p className="font-semibold text-sm text-muted-foreground mb-2">
              배치 KZG Pairing Check
            </p>
            <div className="rounded border border-sky-500/30 p-3 mb-3">
              ...
              <M display>
                {
                  "[E]_1 = (\\bar{r} + \\nu \\cdot \\bar{a} + \\nu^2 \\cdot \\bar{b} + \\nu^3 \\cdot \\bar{c} + \\nu^4 \\cdot \\bar{\\sigma}_a + \\nu^5 \\cdot \\bar{\\sigma}_b + u \\cdot \\bar{z}_\\omega) \\cdot G_1"
                }
              </M>
            </div>
