  ...
  return (
    <section id="proof-structure" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          증명에는 <strong>G1 점 9개</strong>가 포함된다. Round 1-3에서 생성되는
          와이어, 순열, 몫 커밋먼트이다.
        </p>
        ...
        <p>
          Round 4에서 <M>{"\\zeta"}</M>와 <M>{"\\zeta\\omega"}</M>에서 평가한
          스칼라 값들이다.
        </p>
        <div className="not-prose my-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="rounded border border-border/40 p-2">
                ...
                <p className="text-muted-foreground">
                  <M>
                    {
                      "\\bar{\\sigma}_a = \\sigma_a(\\zeta),\\; \\bar{\\sigma}_b = \\sigma_b(\\zeta)"
                    }
                  </M>
                </p>
                <p className="text-muted-foreground">
                  <M>{"\\bar{z}_\\omega = Z(\\zeta\\omega)"}</M>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border/60 p-4">
            ...
            <div className="rounded border border-rose-500/30 p-3 mb-3">
              ...
              <p className="text-sm text-muted-foreground">
                <M>{"[W_\\zeta]_1"}</M> -- <M>{"\\zeta"}</M>에서의 배치 오프닝
              </p>
              <p className="text-sm text-muted-foreground">
                <M>{"[W_{\\zeta\\omega}]_1"}</M> -- <M>{"\\zeta\\omega"}</M>
                에서의 단일 오프닝
              </p>
            </div>
            <div className="rounded border border-emerald-500/30 p-3">
              ...
              <div className="grid grid-cols-3 gap-3 text-sm text-center text-muted-foreground mt-1">
                <div className="bg-muted/50 rounded p-2">
                  <strong>G1 x 9</strong>
                  <br />
                  576 bytes
                </div>
                <div className="bg-muted/50 rounded p-2">
                  <strong>Fr x 6</strong>
                  <br />
                  192 bytes
                </div>
                <div className="bg-muted/50 rounded p-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded border border-sky-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground font-mono">
                  <li>
                    <code>a_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>b_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>c_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>z_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>t_lo_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>t_mid_comm</code>: G1Affine
                  </li>
                  <li>
                    <code>t_hi_comm</code>: G1Affine
                  </li>
                </ul>
              </div>
              <div className="rounded border border-violet-500/30 p-3">
                ...
                <ul className="text-sm space-y-0.5 text-muted-foreground font-mono">
                  <li>
                    <code>a_eval</code>, <code>b_eval</code>,{" "}
                    <code>c_eval</code>: Fr
                  </li>
                  <li>
                    <code>s_sigma_1_eval</code>, <code>s_sigma_2_eval</code>: Fr
                  </li>
                  <li>
                    <code>z_shifted_eval</code>: Fr
                  </li>
                  <li>
                    <code>w_z</code>: G1Affine
                  </li>
                  <li>
                    <code>w_zw</code>: G1Affine
                  </li>
                </ul>
              </div>
            </div>
