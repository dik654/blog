...
export const kzgVerifyCodeRefs: Record<string, CodeRef> = {
  "kzg-verify": {
    ...
    lang: "rust",
    highlight: [1, 20],
    desc: `verify()는 페어링 등식으로 commitment 검증을 완료합니다.
    ...
    annotations: [
      {
        lines: [1, 7],
        color: "sky",
        note: "verify() — commitment, point, value, proof를 받아 검증",
      },
      {
        lines: [9, 15],
        color: "emerald",
        note: "첫 번째 페어링 입력: e(C - [v]₁, h)",
      },
      {
        lines: [17, 23],
        color: "amber",
        note: "두 번째 페어링 입력: e(-π, [τ]₂ - [z]₂)",
      },
      {
        lines: [25, 25],
        color: "violet",
        note: "multi_pairing 결과가 0이면 검증 성공",
      },
    ],
  },
};
