export const PROVER_R1_R3_CODE = `Round 1: Wire Commitments
...
export const PROVER_R4_R5_CODE = `Round 4: Evaluations at ζ
  ζ ← Fiat-Shamir
...
export const VERIFIER_CODE = `입력: 증명 π = ([a],[b],[c],[Z],[t_lo],[t_mid],[t_hi],
