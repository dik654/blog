  ...
  return (
    <section id="proof-gen-verify" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          회로 작성부터 검증까지 <strong>5단계</strong>로 구성된다. 컴파일과
          키생성은 1회, 증명-검증은 매번 수행한다.
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded border border-sky-500/30 p-3">
                ...
                <ol className="text-sm space-y-0.5 text-muted-foreground list-decimal pl-5">
                  ...
                  <li>
                    SRS + 키생성: <code>pk</code>, <code>vk</code> 산출
                  </li>
                </ol>
              </div>
              <div className="rounded border border-emerald-500/30 p-3">
                ...
                <ol
                  className="text-sm space-y-0.5 text-muted-foreground list-decimal pl-5"
                  start={4}
                >
        ...
        <p>
          5-Round 프로토콜의 복잡도는 <strong>O(n log n)</strong>이다.
          FFT/IFFT가 지배적이다.
        </p>
        <div className="not-prose my-4">
          <div className="rounded-lg border border-sky-500/30 p-4">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              witness 대입 → Lagrange 보간 → 블라인딩 → KZG commit (Round 1-3) →
              평가 + 오프닝 (Round 4-5)
            </p>
        ...
        <p>
          검증자는 <strong>상수 시간 O(1)</strong>으로 증명을 검증한다. 페어링
          2회와 소수의 스칼라 곱만 필요하다.
        </p>
        <div className="not-prose my-4">
          <div className="rounded-lg border border-violet-500/30 p-4">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              <M>{"\\pi"}</M> + public inputs → Fiat-Shamir 재생 → 선형화 재구성
              → 배치 KZG check
            </p>
            <div className="grid grid-cols-2 gap-3 text-sm mt-2">
              <div className="bg-muted/50 rounded p-2 text-center">
                ...
                <p className="text-muted-foreground">
                  <M>{"O(1)"}</M> -- 페어링 2회 + G1 스칼라곱 수회
                </p>
              </div>
              <div className="bg-muted/50 rounded p-2 text-center">
                <p className="text-emerald-400 font-medium">공간</p>
                <p className="text-muted-foreground">
                  <M>{"O(1)"}</M> -- 상수 개수의 점/스칼라
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="not-prose my-4">
          <div className="rounded-lg border border-border/60 p-4">
            ...
            <p className="text-sm text-emerald-400 mt-2 font-medium text-center">
