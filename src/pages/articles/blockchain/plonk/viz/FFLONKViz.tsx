...
const STEPS = [
  {
    label: "KZG 가법 동형성 활용",
    body: "commit(f)+commit(g)=commit(f+g). PLONK의 9개 G1 점을 동형성으로 합쳐 축소.",
  },
  {
    label: "Combined Polynomial h(x)",
    body: "nu로 7개 다항식을 하나의 h(x)로 결합. 기존 커밋 재사용하여 새 커밋 불필요.",
  },
  {
    label: "Batch Opening -- 단일 증명",
    body: "PLONK은 2개 opening이 필요하지만 FFLONK은 평가점을 내재화하여 단일 W로 축소.",
  },
  {
    label: "PLONK vs FFLONK 비교",
    body: "FFLONK: G1x4 커밋, 1개 opening, ~700B 증명, ~20% gas 절감. Polygon zkEVM에서 채택.",
  },
];
