...
const STEPS = [
  {
    label: "R1: Wire 블라인딩 + KZG 커밋",
    body: "witness를 보간하고 블라인딩 항을 더한 뒤, SRS로 MSM 커밋하여 transcript에 기록.",
  },
  {
    label: "R2: Z(X) 순열 누적자",
    body: "Fiat-Shamir로 beta, gamma를 뽑고 grand product Z(X)를 구성. Z가 1로 돌아오면 순열 성립.",
  },
  {
    label: "R3: t(X) 몫 다항식",
    body: "gate + perm + boundary 제약을 alpha로 결합한 뒤 Zh(X)로 나눠 몫 t(X)를 3등분 커밋.",
  },
  {
    label: "R4: 평가값 전송",
    body: "랜덤 점 zeta에서 a, b, c, sigma1, sigma2, z_omega 6개 스칼라를 평가하여 검증자에게 전송.",
  },
  {
    label: "R5: 배치 KZG 오프닝",
    body: "nu로 선형 결합한 뒤 (X-zeta)와 (X-zeta*omega)로 나눠 2개 opening proof를 생성.",
  },
];
