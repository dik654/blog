...
const STEPS = [
  {
    label: "Initial: length-n vectors",
    body: "a와 G 벡터의 내적 P=<a,G>가 커밋. Trusted Setup 불필요(DLog 가정).",
  },
  {
    label: "Round 1: n -> n/2",
    body: "벡터를 절반으로 나누고 교차 커밋 L, R을 계산. FS 챌린지 x로 접어서 n/2 벡터 생성.",
  },
  {
    label: "Round 2: n/2 -> n/4",
    body: "동일한 접기를 반복. 매 라운드마다 L, R 커밋 2개 + 벡터 절반.",
  },
  {
    label: "Final: scalar verification",
    body: "log2(n) 라운드 후 스칼라 1개로 축소. 증명 크기: 2*log(n) G1 + 1 Fr. Setup 불필요.",
  },
];
