...
const STEPS = [
  {
    label: "Wire Commitments — G1 × 3",
    body: "Round 1에서 생성. [a]₁,[b]₁,[c]₁ = 192 bytes.",
  },
  { label: "Permutation — G1 × 1", body: "Round 2에서 생성. [Z]₁ = 64 bytes." },
  {
    label: "Quotient — G1 × 3",
    body: "Round 3에서 생성. [t_lo]₁,[t_mid]₁,[t_hi]₁ = 192 bytes.",
  },
  {
    label: "Evaluations — Fr × 6",
    body: "Round 4에서 전송. ā,b̄,c̄,σ̄_a,σ̄_b,z̄_ω = 192 bytes.",
  },
  {
    label: "Openings — G1 × 2 → 총 768B",
    body: "Round 5. [W_ζ]₁,[W_ζω]₁. 증명 크기는 회로 크기에 무관!",
  },
];
      ...
      {(step) => (
        ...
        >
          ...
          <motion.text
            ...
            animate={{ opacity: step >= 4 ? 0.6 : 0.1 }}
            transition={sp}
          >
            고정 크기
          </motion.text>
