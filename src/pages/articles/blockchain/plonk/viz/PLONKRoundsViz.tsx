...
const STEPS = [
  {
    label: "R1: a(X), b(X), c(X) 커밋",
    body: "witness를 보간하고 블라인딩 항을 추가한 뒤 KZG MSM으로 커밋. transcript에 기록.",
  },
  {
    label: "R2: copy constraint 순열 검사",
    body: "grand product 누적자 Z(X)를 구성. Z(omega^n)=1이면 와이어 간 copy constraint 성립.",
  },
  {
    label: "R3: 제약 결합 -> 몫 t(X)",
    body: "gate, perm, boundary 세 제약을 alpha로 결합하고 Zh(X)로 나눠 3등분 커밋.",
  },
  {
    label: "R4: 스칼라 평가",
    body: "랜덤 점 zeta에서 6개 다항식을 평가하여 Fr 스칼라로 전송.",
  },
  {
    label: "R5: 배치 오프닝 증명",
    body: "nu로 선형 결합한 W_zeta, W_zeta_omega 2개 opening proof를 생성. 증명 완성.",
  },
];
