    ...
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래서 방어는 층으로 쌓입니다. 맨 앞에서는 패킷을 커널에 올리기도 전에 버리고, 그다음 층에서 연결을
          맺으며 얻은 정보로 판단하고, 마지막 층에서 요청 내용을 보고 판단합니다. 뒤로 갈수록 정확하지만 한
          건당 비용이 커지므로, 값싼 층에서 최대한 걸러 내는 것이 설계 목표가 됩니다.
        </p>
        ...
        <p className="leading-7">
          순서는 패킷 층, 요청 층, 클라이언트 식별, 오리진 보호입니다. 앞의 둘은 트래픽을 얼마나 감당하느냐의
          문제이고, 뒤의 둘은 누구를 통과시키느냐의 문제입니다. 마지막에 오탐 비용과 판단 순서로 닫습니다.
        </p>
