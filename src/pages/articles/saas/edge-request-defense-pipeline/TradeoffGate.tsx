    ...
    <section id="tradeoff-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          사이트 전체에 같은 강도를 거는 것이 가장 흔한 실수입니다. 오탐 한 건의 비용은 경로마다 다릅니다.
          결제 페이지에서 정상 사용자를 막으면 매출이 사라지고, 공개 문서에서 자동화를 통과시키면 대역폭만
          조금 더 씁니다. 같은 임계를 쓸 이유가 없습니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 특정 사업자의 구현 세부는 공개된 범위까지만 다뤘고, 내부
          모델이나 비공개 신호는 알 수 없습니다. 또 여기서 정리한 층 구조는 웹 요청 방어의 일반형이며 모든
          제품이 같은 이름과 순서를 쓰지는 않습니다.
        </p>
