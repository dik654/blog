  ...
  return (
    <section id="origin-protection" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래서 주소를 바꾸는 것만으로는 부족하고, 원 서버가 앞단에서 온 연결만 받도록 만드는 편이 확실합니다.
          방법은 둘입니다. 방화벽에서 앞단 대역만 허용하거나, 원 서버가 바깥으로 연결을 만들어 앞단과 터널을
          맺고 인바운드 포트를 아예 열지 않는 것입니다.
        </p>

        <p className="leading-7">
          두 번째 방식은 연결 방향을 뒤집습니다. 원 서버가 먼저 나가서 붙기 때문에 방화벽에 들어오는 구멍을
          만들 필요가 없고, 주소가 알려져도 직접 연결할 대상이 없습니다. 대신 터널을 유지하는 구성요소가 새
          장애 지점이 되므로 이중화가 필요합니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          앞단 대역만 허용하는 방식에는 함정이 하나 있습니다. 같은 앞단 서비스를 쓰는 다른 사용자도 그 대역을
          쓴다는 점입니다. 대역 허용만으로는 "우리 앞단을 거친 요청"과 "같은 서비스를 쓰는 제3자의 요청"을
          구분하지 못하므로, 앞단과 원 서버 사이에 상호 인증을 추가로 걸어야 합니다.
        </p>
