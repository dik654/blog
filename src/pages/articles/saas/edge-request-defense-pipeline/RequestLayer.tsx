    ...
    <section id="request-layer" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          여기서 하는 일은 세 가지로 나뉩니다. 알려진 공격 패턴을 규칙으로 막는 것, 같은 출처의 요청 수를 시간당 제한하는 것, 그리고 사람인지 확인하는 절차를 끼워 넣는 것입니다.
          앞의 둘은 요청을 보고 즉시 판단하고 마지막은 클라이언트에게 일을 시켜 응답을 봅니다.
        </p>

        <p className="leading-7">
          레이트 리밋은 상태가 필요하다는 점에서 앞 층과 다릅니다. 누가 얼마나 보냈는지를 기억해야 하므로 카운터를 어디에 두고 얼마나 정확히 셀지가 설계 문제가 됩니다. 여러 지점에
          분산된 구조에서는 지점마다 따로 세면 합계가 한도를 넘고 한곳에 모으면 지연이 늘어납니다.
        </p>
      </div>
