  ...
  return (
    <section id="correlated-change" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래서 무중단 설계의 마지막 항목은 장비가 아니라 변경 절차입니다. 어떤 변경이든 한 번에 전부에
          닿지 않게 하고, 나눠 내보내는 동안 건강 지표를 보고 계속할지 되돌릴지 정하는 것입니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          공개된 사례에서는 이 판단을 사람이 아니라 지표가 합니다. 서비스마다 성공으로 볼 지표와 기준을 미리
          정해 두고, 배포가 한 단계 진행될 때마다 그 지표를 확인해 계속할지 멈출지 되돌릴지 자동으로
          결정합니다. 기준의 예로는 오류율이 0.1% 미만이어야 한다는 식의 조건이 제시됩니다.
        </p>
        ...
        <p className="leading-7">
          이 절이 앞 절들과 다른 점은 대상이 인프라가 아니라 조직의 작업 방식이라는 것입니다. 장비를 아무리
          늘려도 변경 절차가 전역 동시 적용이면 무중단은 성립하지 않습니다.
        </p>
      </div>
