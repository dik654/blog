    ...
    <section id="continuity-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          무중단 여부는 구성도로 판정되지 않습니다. 지점이 몇 개인지, 서버가 몇 대인지는 중복의 정도일 뿐이고,
          실제로 사용자가 겪는 것은 고장이 나서 트래픽이 옮겨 갈 때까지의 시간입니다. 그 시간을 셀 수 없으면
          중복 구성은 주장에 그칩니다.
        </p>
        ...
        <p className="leading-7">
          세 번째 확인이 가장 자주 빠집니다. 검사 주기와 실패 판정 횟수는 설정 파일에 적혀 있지만, 그 값이
          만드는 감지 시간을 장애 시간으로 환산해 본 적이 없는 경우가 많습니다. 주기 5초에 연속 3회면 감지에만
          최대 15초이고, 그 15초는 그대로 실패 응답입니다.
        </p>
