    ...
    <section id="site-balancing" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          같은 연결의 패킷은 네 값이 같으니 늘 같은 해시가 나오고, 따라서 늘 같은 서버로 갑니다. 상태를 어디에도
          저장하지 않고 연결 유지가 되는 셈입니다. 서버 목록이 바뀌지 않는 동안에는 이 방식이 거의 공짜입니다.
        </p>
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 구조의 이점은 용량 조절이 자유로워진다는 것입니다. 기존 연결이 끊기지 않으니 서버별 담당량을
          수시로 바꿀 수 있고, 세대가 다른 서버가 섞여 있어도 각자의 처리 능력에 맞춰 분배량을 조정할 수
          있습니다. 공개된 구현은 서버 부하를 주기적으로 재서 목표치에 수렴하도록 담당량을 늘리고 줄입니다.
        </p>

        <p className="leading-7">
          대가는 한 번의 추가 전달입니다. 재배정 직후에는 일부 패킷이 서버 두 대를 거치므로 지연이 조금 늘고
          내부 대역폭을 더 씁니다. 이 비용은 목록이 바뀐 직후에만 발생하고, 옛 연결이 모두 끝나면 사라집니다.
        </p>
      </div>
