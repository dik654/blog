  ...
  return (
    <section id="reach-scope" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그 전제가 깨지는 순간 편의는 그대로 취약점이 됩니다. 사설망 계정 하나가 뚫리면 공격자는 내부에서 온 요청이 되고 인증을 생략하도록 설정된 서비스들을 차례로 지납니다. 뚫린 것은
          계정 하나인데 열린 것은 그 대역 전체입니다.
        </p>

        <p className="leading-7">
          그래서 대응은 두 갈래입니다. 범위를 좁혀 애초에 닿을 수 있는 대상을 줄이거나 내부에서 왔다는 사실을 권한 근거로 쓰지 않는 것입니다. 앞의 절반은 다음 두 절이, 뒤의 절반은
          그다음 절이 다룹니다.
        </p>
