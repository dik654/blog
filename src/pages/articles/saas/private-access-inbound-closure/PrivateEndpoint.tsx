    ...
    <section id="private-endpoint" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          두 번째 구현은 방향을 뒤집는 대신 주소를 옮깁니다. 서비스를 쓰려는 쪽의 네트워크 안에 그 서비스를
          대신하는 인터페이스를 만들고, 그 인터페이스에 소비자 자신의 주소 대역에서 뽑은 사설 주소를 붙입니다.
          소비자 입장에서는 자기 네트워크 안의 주소 하나로 보입니다.
        </p>
        ...
        <p className="leading-7">
          두 번째 이점은 주소 겹침이 문제가 되지 않는다는 것입니다. 두 네트워크를 서로 연결하는 방식이라면 양쪽
          대역이 겹치는 순간 붙일 수 없지만, 여기서는 연결되는 것이 네트워크가 아니라 인터페이스 하나뿐이라 상대
          네트워크의 주소 체계를 알 필요가 없습니다.
        </p>
