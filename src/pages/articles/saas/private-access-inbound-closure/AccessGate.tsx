  ...
  return (
    <section id="access-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          정리하면 사설 접근 설계는 두 축의 조합입니다. 연결 방향을 뒤집어 표면을 없애는 축과, 부여 단위를
          좁히고 요청마다 판정해 통과 기준을 옮기는 축입니다. 앞의 축만 있으면 문 없는 넓은 방이 되고, 뒤의
          축만 있으면 잘 지켜지지만 두드릴 수 있는 문이 남습니다.
        </p>

        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 인용한 제품 구조는 각 사업자의 공개 문서 범위까지만 다뤘고,
          다른 제품이 같은 이름으로 같은 성질을 제공한다고 볼 수 없습니다. 자격 증명 수명이나 판정 신호의
          구체 값도 이 글에서 권고하지 않습니다.
        </p>
