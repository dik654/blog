    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            막히는 지점은 계산의 정교함이 아닙니다. 사람이 셋이고 안이 셋뿐인 가장 작은 예에서, 모두의 선호가 일관되는데도 다수결이 답을 내놓지 못합니다. 어느 안이 가장 원해지는지가
            정해지지 않습니다.
          </p>
      ...
      <section id="cycle" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여기서 무엇을 읽어야 하는지가 중요합니다. 계산을 잘못한 것이 아니고 유권자가 비합리적인 것도 아닙니다. 세 판의 다수결은 각각 정확하고 각자의 선호도 일관됩니다. 다수결이라는
            연산 자체가 이행성을 보존하지 않을 뿐입니다.
          </p>
      ...
      <section id="agenda" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            순환 자체는 추상적으로 들립니다. 그런데 실제 회의에서는 안건을 한 번에 셋씩 놓고 결정하지 않습니다. 둘을 붙여 하나를 떨어뜨리고 남은 것을 다음 것과 붙입니다. 순환이
            있으면 바로 여기서 결과가 갈립니다.
          </p>
      ...
      <section id="other-rules" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            결선투표로 바꿔도 마찬가지입니다. 이번에 깨지는 것은 더 이상합니다. 어떤 후보가 이겼는데, 그 후보를 더 좋아하게 된 유권자가 생기자 그 후보가 지는 일이 생깁니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            유권자 100명이 세 후보를 놓고 결선투표를 한다고 합시다. 40명이 가·나·다 순서, 31명이 나·다·가 순서, 29명이 다·가·나 순서입니다. 1차에서 가 40표, 나
            31표, 다 29표이므로 다가 탈락하고 다를 1위로 둔 29명의 표가 가에게 갑니다. 가가 69대 31로 이깁니다.
          </p>
          <p className="leading-7">
            이제 나를 1위로 두었던 네 명이 가를 더 좋아하게 되어 가·나·다 순서로 바꿨다고 합시다. 1차 결과는 가 44표, 나 27표, 다 29표가 됩니다. 이번에는 나가 탈락하고
            나를 1위로 둔 27명의 표가 다에게 갑니다. 다가 56대 44로 이깁니다.
          </p>
          <p className="leading-7">
            가는 지지를 잃지 않았습니다. 오히려 네 명을 더 얻었습니다. 그런데도 졌습니다. 바뀐 것은 1차에서 누가 탈락하느냐였고 그것이 결승 상대를 바꿨습니다. 규칙이 중간 단계에서
            후보를 떨어뜨리는 한 이 일은 언제든 생길 수 있습니다.
          </p>
        </ProgressiveDetail>
      </section>
      ...
      <section id="arrow" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            여기까지 보면 더 나은 규칙을 계속 찾으면 될 것 같습니다. 그런데 그 탐색이 끝나지 않는다는 것이 증명되어 있습니다. 조건 몇 개를 적어 두고 그 조건들을 동시에 만족하는
            규칙이 없다는 것을 보인 결과입니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 실제 정치를 볼 때 물어야 할 것이 바뀝니다. 어떤 규칙이 옳은가가 아니라 지금 이 사안의 선호 구조가 어떤 모양인가입니다. 봉우리가 하나로 줄어드는 사안에서는 다수결이
            깔끔하게 답을 내고 그렇지 않은 사안에서는 순서를 쥔 자리가 조용히 결과를 정합니다.
          </p>

          <p className="leading-7">
            그런데 선호의 모양은 하늘에서 주어지는 것이 아닙니다. 수많은 쟁점이 몇 개의 축으로 줄어들어 있고 사람들이 그 축 위에서 자기 위치를 갖게 되는 데에는 그렇게 만드는 장치가
            필요합니다. 그 장치가 무엇인지가 다음 질문입니다.
          </p>
