    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그러면 남는 질문이 하나입니다. 그 모양은 누가 만듭니까. 수많은 쟁점이 저절로 몇 개의 축으로 줄어들 이유가 없고 사람들이 그 축 위에서 자기 자리를 갖게 될 이유도
            없습니다.
          </p>
      ...
      <section id="competition" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            실제로 두 정당이 붙어 있는 나라들이 있고 선거가 다가올수록 양쪽의 말이 비슷해지는 현상도 흔히 관찰됩니다. 그런데 완전히 겹치지는 않습니다. 가운데로 미는 힘을 상쇄하는 힘이
            몇 개 있기 때문입니다.
          </p>

          <p className="leading-7">
            첫째는 기권입니다. 양쪽이 다 가운데로 가면 양극단의 지지자에게는 차이가 사라지고 차이가 없으면 투표할 이유도 사라집니다. 가운데로 갈수록 잃는 표가 생기므로 어느 지점에서
            멈춥니다.
          </p>

          <p className="leading-7">
            둘째는 후보를 고르는 단계가 따로 있다는 것입니다. 본선에서 이기려면 가운데가 유리하지만 본선에 나가려면 먼저 당내에서 뽑혀야 합니다. 뽑아 주는 사람들이 전체 유권자보다
            한쪽으로 치우쳐 있으면 후보는 그 치우친 중위에 맞춰집니다.
          </p>
        ...
        >
          <p className="leading-7">
            가운데로 수렴한다는 계산은 정당의 위치가 유권자에게 그대로 보인다고 가정합니다. 실제로는 선거 기간에 하는 말과 집권 후의 결정 사이에 틈이 있고 유권자가 그 틈을 확인하려면
            시간이 걸립니다.
          </p>
          <p className="leading-7">
      ...
      <section id="who-organizes" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이유는 1편에서 이미 나왔습니다. 혜택을 나눠 갖는 사람이 적으면 한 명이 회수하는 몫이 크고 많으면 몫이 작아집니다. 그래서 같은 크기의 이익도 누가 나눠 갖느냐에 따라
            조직될 수도, 되지 않을 수도 있습니다.
          </p>

          <p className="leading-7">
            특혜는 대개 소수에게 집중되고 그 비용은 전체에게 흩어집니다. 백 곳이 천억을 나눠 가지면 한 곳당 열 억이라 움직일 이유가 충분하지만 오천만 명이 천억을 나눠 내면 한 사람당
            이천 원이라 알아볼 이유조차 없습니다. 양쪽 다 합계는 같은데 한쪽만 조직됩니다.
          </p>
      ...
      <section id="rent-seeking" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            여기까지는 특혜가 누구에게 가느냐의 문제였습니다. 그런데 특혜를 얻으려는 다툼에는 그와 별개의 손실이 붙어 있습니다. 누가 가져가느냐는 옮기는 문제지만 가져가려고 쓴 돈은
            사라지는 문제입니다.
          </p>
        ...
        <div id="capture" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              사람도 같은 방향으로 움직입니다. 그 분야를 아는 사람이 규제 기관과 업계 양쪽에만 있으므로 인력이 오갑니다. 이 움직임 하나하나는 부정이 아니지만 쌓이면 기관의 시야가
              업계의 시야와 비슷해집니다.
            </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이 글은 정당과 이익집단이 무엇을 잘라 내는지를 계속 말했습니다. 그러면 그것들을 없애면 잘리는 것이 없어질 것 같지만 그렇게 되지 않습니다. 줄이는 장치가 사라지면 앞 글의
            순환이 돌아오고 그때 결정하는 것은 순서를 쥔 자리입니다.
          </p>

          <p className="leading-7">
            조직되지 않은 이익도 마찬가지입니다. 이익집단을 금지해도 집중된 쪽은 다른 형태로 조직되고 흩어진 쪽은 여전히 조직되지 않습니다. 비대칭을 만드는 것은 조직의 형태가 아니라
            1인당 이해관계이기 때문입니다.
          </p>
