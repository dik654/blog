    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            앞 글은 의석 분포를 주어진 것으로 두고 시작했습니다. 누가 몇 석을 가졌느냐에 따라 협상력이 정해지고 단독 과반이 있느냐에 따라 정부 형태의 성격까지 달라졌습니다. 그런데 그
            의석은 하늘에서 떨어지지 않습니다.
          </p>

          <p className="leading-7">
            의석은 표를 세는 규칙이 만들어 냅니다. 그리고 그 규칙은 표를 그대로 옮기는 통로가 아닙니다. 같은 표에 다른 규칙을 적용하면 전혀 다른 의회가 나옵니다. 아래 예에서 한
            정당은 44퍼센트를 얻고 아홉 석을 전부 가져가기도 하고 똑같은 44퍼센트로 세 석만 가져가기도 합니다.
          </p>
      ...
      <section id="district-magnitude" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 이 가운데 하나가 나머지를 거의 다 끌고 갑니다. 한 선거구에서 몇 명을 뽑는가입니다. 한 명만 뽑으면 그 선거구의 의석은 나눌 수 없고 1등이 아닌 모든 표는 의석으로
            바뀌지 못합니다. 열 명을 뽑으면 10퍼센트 남짓만 받아도 한 자리를 가져갈 수 있습니다.
          </p>
          ...
          <p className="leading-7">
            나머지 선택지는 이 숫자가 만든 결과를 다듬는 역할을 합니다. 봉쇄조항은 작은 정당을 한 번 더 걸러 내고 투표 방식은 유권자가 자기 표를 어디에 쓸지를 바꿉니다.
          </p>
        </div>
      ...
      <section id="plurality" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            한 선거구에서 한 명만 뽑고 1등이 가져가는 방식은 가장 단순합니다. 그리고 가장 많이 버립니다. 위 예에서 44퍼센트를 얻은 정당이 아홉 석을 전부 가져가고 41퍼센트와
            15퍼센트는 한 석도 얻지 못했습니다.
          </p>

          <p className="leading-7">
            버리는 것이 결함만은 아닙니다. 이 방식은 의회에 단독 과반을 만들어 낼 확률을 크게 올립니다. 앞 글에서 봤듯 단독 과반이 있으면 연립 협상이 필요 없고 거부권자가 줄어
            정부가 결정을 빨리 내립니다. 버려진 표는 그 대가로 지불한 값입니다.
          </p>

          <p className="leading-7">
            여기서 두 번째 효과가 따라 나옵니다. 이길 수 없는 후보에게 던진 표가 아무 의석도 만들지 못한다는 것을 유권자가 알면, 당선 가능한 후보 쪽으로 표를 옮기게 됩니다. 계산
            규칙이 표를 버리는 것이 첫째 효과이고 그 사실을 안 유권자가 스스로 선택을 바꾸는 것이 둘째 효과입니다. 다수제에서 정당 수가 줄어드는 경향은 이 둘이 함께 만듭니다.
          </p>
        ...
        <div id="districting" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              이유는 단순합니다. 다수제에서 이기는 데 필요한 것은 1등이지 큰 표차가 아닙니다. 어느 선거구에서 90 대 5로 이기면 남는 표가 전부 버려지고 다른 선거구에서 59 대
              21로 이기면 같은 한 석을 훨씬 적은 표로 삽니다. 그래서 표가 몰려 있는 쪽이 손해를 봅니다.
            </p>
            ...
            <p className="leading-7">
              그래서 다수제를 쓰는 곳에서는 경계를 누가 긋는가가 제도의 일부가 됩니다. 선거 규칙을 정하는 것과 지도를 그리는 것이 무게가 같고 지도를 그리는 쪽이 중립적인지가 별도의
              문제로 남습니다.
            </p>
          </div>
        </div>
      ...
      <section id="proportional" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            반대쪽 선택은 선거구를 크게 잡고 득표에 비례해 의석을 나누는 것입니다. 그런데 여기서 바로 문제가 생깁니다. 의석은 쪼갤 수 없습니다. 44퍼센트에 9석을 곱하면
            3.96석이고 0.96석을 줄 방법이 없습니다.
          </p>
          ...
          <p className="leading-7">
            이 방식의 성질은 아래 절차에서 바로 드러납니다. 의석을 받은 정당은 다음 계산에서 나누는 수가 커지므로 몫이 줄고 그만큼 다른 정당에게 차례가 돌아갑니다. 큰 정당의 몫이
            충분히 줄어드는 순간에만 작은 정당이 들어옵니다.
          </p>
        </div>
      ...
      <section id="disproportionality" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            지금까지는 제도를 말로 비교했습니다. 그런데 어느 제도가 표를 얼마나 비트는지는 숫자로 잴 수 있고 재고 나면 비교가 훨씬 정확해집니다.
          </p>
          ...
          <p className="leading-7">
            제곱해서 더하면 또 하나가 따라옵니다. 큰 차이가 작은 차이보다 훨씬 무겁게 들어갑니다. 이것은 결함이 아니라 의도입니다. 여러 정당이 조금씩 손해 보는 것과 한 정당이 크게
            손해 보는 것을 다른 사건으로 세겠다는 뜻입니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            값이 0이라는 것은 득표율과 의석률이 일치한다는 뜻일 뿐, 그 의회가 잘 굴러간다는 뜻이 아닙니다. 완전히 비례하는 의회는 사회의 분열을 그대로 옮겨 놓으므로 앞 글에서 본
            정부 구성 문제가 그만큼 어려워집니다.
          </p>
          <p className="leading-7">
            반대로 값이 크다는 것도 그 자체로는 판정이 아닙니다. 다수제가 만드는 높은 값은 단독 과반을 만들기 위해 지불한 값이며 그 단독 과반이 필요한지 아닌지는 이 수 바깥의
            문제입니다.
          </p>
          <p className="leading-7">
      ...
      <section id="mixed" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            많은 나라가 둘 중 하나를 고르는 대신 섞습니다. 의석의 일부는 소선거구로 뽑아 지역과 대표를 연결하고 나머지는 정당 득표에 따라 나눠 비례를 보충하는 식입니다.
          </p>
          ...
          <p className="leading-7">
            이 위임이 앞 글의 논의와 직접 이어집니다. 헌법 개정에는 높은 문턱이 있지만 법률 개정에는 없습니다. 그래서 선거 제도는 헌정 질서 가운데 가장 바꾸기 쉬운 부분이며 바꾸는
            주체가 그 제도로 당선된 사람들이라는 점에서 한 번 더 특이합니다. 규칙을 고치는 쪽과 규칙의 적용을 받는 쪽이 같습니다.
          </p>
        </div>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그리고 이 글의 계산에는 전부 같은 가정이 깔려 있었습니다. 유권자의 선호가 고정되어 있고 제도는 그 선호를 세는 방법일 뿐이라는 가정입니다. 실제로는 규칙을 아는 유권자가
            자기 표를 다르게 쓰므로 득표율 자체가 제도의 결과입니다.
          </p>
