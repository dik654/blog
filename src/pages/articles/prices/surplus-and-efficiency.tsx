    ...
    <div className="space-y-16">
      ...
      <section id="two-surpluses" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여기서 두 값이 같은 것은 우연입니다. 앞 글에서 두 줄을 대칭으로 잡아
            둔 결과일 뿐이고, 줄의 모양이 다르면 두 합도 달라집니다.
          </p>
      ...
      <section id="total-surplus" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이제 몇 쌍까지 거래해야 하는지가 나옵니다. 차이가 양수인 쌍까지는
            더할수록 커지고, 음수가 되는 쌍부터는 더할수록 줄어듭니다.
          </p>

          <p className="leading-7">
            넷째 쌍은 7과 7이라 차이가 0이고, 다섯째는 6과 8이라 −2입니다. 누적이
            6, 10, 12, 12, 10, 6이므로 네 쌍까지가 봉우리입니다.
          </p>

          <p className="leading-7">
            앞 글의 균형 수량이 정확히 넷이었습니다. 우연이 아닙니다. 값이 두 줄을
            같은 지점에서 자르기 때문에, 값이 정해 준 수량과 차이가 양수인 쌍의
            수가 같은 것입니다.
          </p>
        </div>
      ...
      <section id="price-cap" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 위 계산에는 숨은 전제가 있습니다. 낼 수 있던 금액이 가장 큰
            둘이 샀다고 두었습니다. 값이 묶이면 값으로 줄을 세울 수 없으므로 실제
            로는 다른 방식으로 나뉩니다.
          </p>
          ...
          <p className="leading-7">
            그래서 값을 묶는 결정에는 늘 두 번째 결정이 따라옵니다. 누가 받을지를
            무엇으로 정할 것인가입니다. 그것을 정하지 않으면 줄 서는 시간처럼 아무
            에게도 가지 않는 비용이 그 자리를 메웁니다.
          </p>
        </div>
        ...
        >
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              새 균형은 값 9에 둘입니다. 사는 쪽이 내는 값은 7에서 9로 2 올랐고,
              파는 쪽이 실제로 받는 값은 7에서 5로 2 내렸습니다. 세금 4가 정확히
              반반으로 나뉩니다.
            </p>
            ...
            <p className="leading-7">
              누가 내도록 정했는지는 이 결과에 들어오지 않습니다. 사는 쪽에
              물리도록 바꿔도 같은 비율로 나뉩니다. 법이 정하는 것은 누가 납부
              하느냐이고 실제 부담은 두 줄의 모양이 정합니다.
            </p>
      ...
      <section id="not-fairness" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 전제는 편한 만큼 셉니다. 낼 수 있는 금액은 원하는 정도만이 아니라
            낼 수 있는 능력도 함께 반영하므로, 많이 가진 쪽의 여유가 더 크게
            잡힙니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            3편이 남긴 빈칸은 메워졌습니다. 정해진 결과를 재는 자가 생겼고, 그
            자가 균형을 가장 높게 친다는 것도 확인했습니다. 못 산 두 사람은 낼 수
            있는 금액이 드는 값보다 낮아서 못 산 것이고, 그 거래는 일어났다면
            총량을 줄였을 것입니다.
          </p>
