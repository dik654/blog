    ...
    <div className="space-y-16">
      ...
      <section id="demand-side" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 최대 금액이 어디서 오는지는 앞 두 글이 이미 답했습니다. 그 돈을
            다른 데 썼을 때 얻을 수 있는 것이 그 사람의 기준이고, 그것이
            기회비용입니다. 지불용의는 취향의 문제가 아니라 대안의 문제입니다.
          </p>
          ...
          <p className="leading-7">
            이제 값을 하나 부르면 몇 명이 사는지가 셈으로 나옵니다. 값이 7이면
            10부터 7까지 네 명이 남고, 값이 8이면 세 명이 남습니다. 값을 올릴수록
            줄이 짧아지는 이유가 이것뿐입니다.
          </p>
      ...
      <section id="supply-side" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여섯을 드는 값이 작은 순서로 세우면 4, 5, 6, 7, 8, 9가 됩니다. 값이
            7이면 4부터 7까지 네 개가 나오고, 값이 6이면 세 개가 나옵니다.
          </p>

          <p className="leading-7">
            여기서도 드는 값의 정체가 기회비용입니다. 그 시간과 재료를 다른 데
            썼다면 얻었을 것이고, 앞 글의 표현으로는 그 사람이 직접 만들 때
            치르는 값입니다.
          </p>
      ...
      <section id="adjustment" className="scroll-mt-20">
        ...
        >
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              둘은 무엇이 먼저 움직이느냐가 다를 뿐 같은 자리로 갑니다. 이
              글처럼 사려는 양이 값에 대해 줄고 팔려는 양이 늘면, 값에서
              어긋남이 0인 지점과 수량에서 두 값이 같아지는 지점이 같은 점이기
              때문입니다.
            </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            2편이 남긴 빈칸은 이제 메워졌습니다. 구간 안 어디로 정해지는지는 두
            줄의 모양이 정합니다. 마주 앉아 다투지 않아도, 서로의 사정을 몰라도
            정해집니다.
          </p>
          ...
          <p className="leading-7">
            다루지 않은 것을 밝혀 둡니다. 여기서는 모두가 같은 물건을 사고팔고
            서로가 값을 안다고 두었습니다. 물건이 서로 다르거나 한쪽만 아는 것이
            있으면 이 그림이 달라지며, 그 경우는 이 시리즈의 뒤쪽에서 따로
            다룹니다. 그리고 파는 쪽이 하나뿐이면 값을 부르는 쪽이 생겨 이 절차
            자체가 성립하지 않습니다.
          </p>
        </div>
      </section>
