  ...
  return (
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 이 글은 새 주제를 하나 더 얹는 글이 아니라, 뒤따르는 글들이
            공통으로 딛고 설 바닥을 까는 글입니다. 채권 글은 이 식의 현금흐름
            자리에 쿠폰과 액면을 넣고, 주식 글은 배당을 넣으며, 규제 글은 손실
            시나리오를 넣습니다. 식은 그대로입니다.
          </p>
      ...
      <section id="compounding" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            연 5%로 100만 원을 3년 맡길 때, 매년 원금에만 5만 원씩 붙으면 3년 뒤
            115만 원입니다. 그런데 붙은 이자를 원금에 얹고 다음 해에 그 합계에
            이자를 매기면 115만 7,625원이 됩니다. 차이는 7,625원이고, 이 차이는
            해가 갈수록 커집니다.
          </p>
      ...
      <section id="discounting" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 선택이 결과를 크게 흔든다는 점이 중요합니다. 10년 뒤 1억 원은
            할인율 3%에서 약 7,441만 원이지만 8%에서는 약 4,632만 원입니다.
            같은 미래 금액인데 오늘 값이 1.6배 차이 납니다. 먼 미래일수록 이
            차이는 더 벌어집니다.
          </p>
        </div>
      ...
      <section id="npv" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            판단 기준은 단순합니다. 순현재가치가 0보다 크면 이 사업은 같은
            위험으로 다른 데 굴렸을 때보다 낫고, 0보다 작으면 못합니다. 여기서
            &ldquo;다른 데&rdquo;의 기준이 바로 할인율이므로, 순현재가치는
            절대적인 좋고 나쁨이 아니라 비교 대상 대비 판정입니다.
          </p>

          <p className="leading-7">
            매년 같은 금액이 같은 기간 들어오는 경우에는 계산이 더 짧아집니다.
            할인계수의 합이 등비수열이라 닫힌 식으로 정리되기 때문입니다. 이
            형태를 연금이라 부르며, 원리금 균등 상환 대출의 월 납입액이 바로 이
            식에서 나옵니다.
          </p>
        </div>
        ...
        <div id="annuity" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              합을 매번 항마다 계산하지 않아도 되는 경우가 있습니다. 매기 같은
              금액이 같은 기간 들어오면 할인계수의 합이 등비수열이 되어 짧은
              식으로 정리되며, 원리금 균등 상환 대출의 월 납입액이 바로 여기서
              나옵니다.
            </p>
          </div>
      ...
      <section id="irr" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            문제는 이 값을 손으로 풀 수 없다는 데 있습니다. 식이 r에 대한 고차
            다항식이라 일반적인 해법이 없어 수치적으로 찾아야 합니다. 다행히
            현금흐름이 처음 한 번 나가고 그 뒤로 계속 들어오는 형태라면 순현재
            가치가 r에 대해 단조 감소하므로 해가 하나뿐이고 찾기도 쉽습니다.
          </p>

          <p className="leading-7">
            그 조건이 깨지면 곧바로 문제가 생깁니다. 현금흐름의 부호가 여러 번
            바뀌면 순현재가치를 0으로 만드는 r이 둘 이상 나올 수 있고, 그중
            무엇이 &ldquo;그 사업의 수익률&rdquo;인지 말할 수 없게 됩니다. 규모가
            다른 두 사업을 내부수익률만으로 줄 세우는 것도 위험합니다.
          </p>
        </div>
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          <p className="leading-7">
            절차의 마지막 단계가 말해 주듯, 내부수익률은 &ldquo;항상 하나 있는
            값&rdquo;이 아닙니다. 아래 표는 두 지표를 어떤 질문에 써야 하는지
            정리한 것입니다.
          </p>
        </div>
      ...
      <section id="real-rate" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            둘의 관계는 흔히 &ldquo;명목에서 물가상승률을 빼면 실질&rdquo;이라고
            간단히 씁니다. 정확한 관계는 뺄셈이 아니라 나눗셈이지만, 두 값이
            작을 때는 차이가 미미해 뺄셈으로 근사합니다. 물가가 두 자릿수로
            오르는 상황에서는 이 근사가 눈에 띄게 어긋납니다.
          </p>

          <p className="leading-7">
            실질금리에는 한 가지 함정이 더 있습니다. 계약할 때 아는 것은 명목
            금리와 &ldquo;예상되는&rdquo; 물가상승률뿐이고, 실제 물가는 나중에야
            드러납니다. 그래서 사전에 계산한 실질금리와 사후에 확인된 실질금리는
            다를 수 있으며, 그 차이가 돈을 빌린 쪽과 빌려준 쪽 사이에서 이익과
            손실로 갈립니다.
          </p>
        </div>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여기에 답하려면 두 가지가 더 필요합니다. 하나는 만기가 다르면 금리도
            다르다는 사실이고, 다른 하나는 못 받을 위험이 클수록 요구하는 수익률
            이 높아진다는 사실입니다. 앞은 채권의 수익률 곡선이, 뒤는 위험의
            가격이 다룹니다.
          </p>
