    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 그물의 가장 아래에 한 칸이 있습니다. 우리가 매일 쓰면서도 정체를
            거의 묻지 않는 것, 곧 돈입니다. 통장의 100만 원은 창고 어딘가의
            금괴가 아니라 은행이 당신에게 지고 있는 빚이고, 지갑의 만 원권은
            한국은행의 장부에서 부채 항목에 적힙니다.
          </p>

          <p className="leading-7">
            그림을 먼저 보여 드리는 이유가 있습니다. 뒤따르는 글들이 저마다 다른
            주제를 다루는 것처럼 보이지만, 실은 이 한 장의 화살표를 하나씩 열어
            가는 일이기 때문입니다. 예금은 어떻게 생기는지, 중앙은행은 무엇을
            움직여 금리를 정하는지, 시장은 청구권에 어떻게 값을 매기는지,
            규제는 왜 자본을 쌓게 하는지가 모두 이 그림 안에 있습니다.
          </p>
        </div>
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            답은 세 걸음으로 나옵니다. 먼저 물건끼리 바꾸는 방식이 어디서
            막히는지 보고, 그 막힘을 푸는 도구가 사실 한 가지 일이 아니라 세 가지
            일을 한다는 것을 확인합니다. 그러면 세 가지 중 하나에는 물건일
            필요가 전혀 없다는 사실이 드러나고, 거기서 약속이 물건의 자리를
            차지합니다. 마지막으로 그렇게 만들어진 약속이 얼마나 쌓여 있는지
            세는 법으로 닫습니다.
          </p>
      ...
      <section id="exchange-problem" className="scroll-mt-20">
        ...
        <div id="price-count" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              매개의 이익은 상대를 찾는 수고를 더는 데서 끝나지 않습니다. 물건이
              서로 직접 교환되면 가격은 물건 쌍마다 하나씩 필요하지만, 모든
              물건의 값을 하나의 매개로만 적으면 물건 하나당 하나면 됩니다. 이
              차이는 물건 종류가 늘수록 빠르게 벌어집니다.
            </p>
          </div>
          ...
          <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
            <p className="leading-7">
              그런데 방금 센 이익은 넘겨받는 일이 아니라 값을 적는 일에서 나온
              것입니다. 같은 물건이 두 가지 일을 하고 있었다는 뜻이고, 둘이
              원래 한 덩어리인지 따져 볼 필요가 생깁니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="three-functions" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 분해가 이 글의 축입니다. 셋을 갈라 놓고 나면 &ldquo;매개에는
            물건이 필요한가&rdquo;라는 질문을 각 기능별로 따로 물을 수 있게 되고,
            거기서 답이 나옵니다.
          </p>
        </div>
      ...
      <section id="credit-money" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            ...
            준비금도 중앙은행의 빚입니다. 처음 그림에서 본 세 칸이 바로 이
            셋이었습니다.
          </p>
        ...
        <div id="issuer-layers" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              돈이 빚이라는 답은 곧바로 새 문제를 만듭니다. 빚은 갚지 못할 수
              있으므로, 어떤 돈을 들고 있느냐에 따라 떠안는 위험이 달라진다는
              것입니다. 예금 1억 원과 현금 1억 원은 액수가 같아도 상대가
              다릅니다. 처음 그림에서 층이 나뉘어 있던 이유가 여기 있습니다.
            </p>
          </div>
          ...
          >
            ...
            <p className="leading-7">
              현금과 지급준비금은 중앙은행의 채무입니다. 중앙은행은 자국 통화로
              진 빚을 자국 통화를 발행해 갚을 수 있으므로 &ldquo;약속한 원을 못
              준다&rdquo;는 의미의 부도는 일어나지 않습니다. 하지만 그 원으로 살
              수 있는 양이 줄어드는 일은 얼마든지 일어납니다. 상환 불능 위험과
              구매력 하락 위험은 서로 다른 위험이며, 하나가 없다고 다른 하나가
              없는 것은 아닙니다.
            </p>
            <p className="leading-7">
              보장 한도와 그 적용 범위는 나라마다 다르고 제도 개편으로 바뀌므로,
              구체적인 금액을 외우기보다 &ldquo;한도 안은 보장, 한도 밖은
              채권자로서 손실 분담&rdquo;이라는 구조를 기억하는 편이 오래갑니다.
            </p>
          </ProgressiveDetail>
        </div>
      </section>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            먼저 경계를 그어 둡니다. 신용카드로 결제해도 카드 자체는 돈이
            아닙니다. 카드는 &ldquo;내 예금을 당신에게 옮겨 달라&rdquo;는 지시를
            전달하는 수단이고, 실제로 옮겨지는 것은 은행 장부의 예금입니다. 결제
            수단과 돈은 층이 다릅니다.
          </p>
          ...
          <p className="leading-7">
            처음 그림으로 돌아가 보면, 이제 맨 아래 화살표 하나를 읽을 수 있게
            됐습니다. 남은 화살표들이 곧 다음 질문입니다. 예금이 은행의 빚이라면
            그 빚은 애초에 어떻게 생겨났는지, 중앙은행은 무엇을 움직여 금리를
            정한다고 말할 수 있는지, 시장은 청구권에 어떻게 값을 매기는지입니다.
          </p>
