  ...
  return (
    <section id="vram-budgeting-components" className="scroll-mt-20 space-y-7">
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-8">
          Model residency는 request path가 실행되는 동안 그 경로가 참조하는 weight 전체가 GPU 메모리에 함께 있어야 한다는 제약입니다. Mixed FP8 Qwen의 28.75GiB는 48GiB 카드 하나에 상주할 수 있지만, BF16 51.75GiB는 그대로는 상주 자체가 불가능합니다.
        </p>
        <p className="leading-8">
        ...
        <p className="leading-8">
          262K에서 이미 계산한 attention KV 16GiB에 동시 request 4개를 가정하면 KV만 64GiB가 되어, weight 28.75GiB를 더하기도 전에 48GiB 카드 용량을 넘습니다.
        </p>
        ...
        <p className="leading-8">
          Cache optimization은 이 KV 항 자체를 줄이는 선택을 부르는 이름입니다. 가장 직접적인 방법은 KV cache의 dtype을 낮추는 것으로, BF16 64KiB/token을 FP8로 저장하면 32KiB/token이 되어 262K KV가 16GiB에서 8GiB로 절반이 됩니다.
        </p>
        <p className="leading-8">
