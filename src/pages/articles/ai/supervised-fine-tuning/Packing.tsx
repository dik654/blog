  ...
  return (
    <section id="packing" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>EOS·BOS와 role separator도 loss에 넣을지 명시합니다. Sequence 경계에서 label shift가 다음 example 첫 token을 이전 example의 target으로 연결하면 silent contamination이 생깁니다. Packing 효율은 token utilization만 보지 말고 boundary test와 decoded sample audit로 검증합니다.</p>
      </div>
      <PackingBoundaryViz />
    </section>
  );
