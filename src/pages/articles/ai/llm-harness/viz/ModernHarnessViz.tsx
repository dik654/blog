  ...
  return (
    <VizFrame title={title} description={description} className="my-9">
      ...
      >
        ...
        <h3 className="mt-2 min-h-[4.25rem] text-lg font-bold leading-7 sm:min-h-[2rem]">
          {labels[controls.active]}
        </h3>
        <div data-viz-canvas className="mt-5 min-w-0 overflow-hidden">
          {children(controls.active)}
        </div>
        <p className="mt-4 min-h-[5.5rem] border-l border-primary/50 pl-4 text-sm leading-6 text-muted-foreground sm:min-h-[1.75rem]">
