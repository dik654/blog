  ...
  return (
    <section id="convergence" className="mb-16 scroll-mt-20">
      ...
      <ExplainedFormula
        ...
        \end{aligned}`}
        terms={[
          { symbol: "\Delta_t", name: "objective gap", description: "Step t의 objective와 optimal value의 차이입니다." },
          { symbol: "\mu", name: "strong-convexity constant", description: "함수가 minimizer에서 최소한 얼마나 빠르게 위로 굽는지 나타냅니다." },
