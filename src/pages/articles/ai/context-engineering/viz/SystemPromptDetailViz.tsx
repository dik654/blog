...
const layerVisuals = [
  ...
  {
    title: "Layer 3-5: Task + Rules + Format",
    color: "#10b981",
    rows: [
      {
        label: "Task Instructions",
        value: "문제 재정의 → 해결책 → trade-off → 권장",
      },
...
const guardVisuals = [
  {
    title: "Positive Framing + Refusal",
    color: "#ef4444",
    rows: [
      { label: "Positive", value: '"공개 가능한 정보만 포함" (not "금지")' },
      {
        label: "Refusal Triggers",
        value: "프라이버시 침해, 불법 조언, 폭력/자해",
      },
      { label: "왜?", value: "Negative는 해당 개념을 activation 시킴" },
    ],
  },
  {
    title: "Scope + Injection 방어",
    color: "#10b981",
    rows: [
