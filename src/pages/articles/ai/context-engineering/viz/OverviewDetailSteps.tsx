  ...
  return (
    <g>
      ...
      >
        ...
        <text x={260} y={68} fontSize={8} fill="var(--muted-foreground)">
          GPT-4: 128K
        </text>
        <text x={260} y={82} fontSize={8} fill="var(--muted-foreground)">
          Claude 3.5: 200K
        </text>
        <text x={260} y={96} fontSize={8} fill="var(--muted-foreground)">
          Gemini 1.5: 1M-2M
        </text>
        <text x={260} y={110} fontSize={8} fill="var(--muted-foreground)">
          OSS: 32K-128K
        </text>
      </motion.g>
    </g>
  ...
  return (
    <g>
      ...
      <motion.g initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <text x={30} y={58} fontSize={8} fill="var(--muted-foreground)">
          System 2K + RAG 10K
        </text>
        <text x={30} y={72} fontSize={8} fill="var(--muted-foreground)">
          History 5K + Query 500
        </text>
        <text x={30} y={86} fontSize={8} fill="var(--muted-foreground)">
          Buffer 2K
        </text>
        <text x={30} y={100} fontSize={8} fontWeight={600} fill={SYS_C}>
          총: ~20K tokens
        </text>
      </motion.g>
      <motion.g
      ...
      >
        ...
        <text x={260} y={72} fontSize={8} fill="var(--muted-foreground)">
          Claude Sonnet: $3/M
        </text>
        <text x={260} y={86} fontSize={8} fill="var(--muted-foreground)">
          20K × 1M requests
        </text>
        <text x={260} y={100} fontSize={8} fontWeight={600} fill={COST_C}>
          = $60-100/M reqs
        </text>
      </motion.g>
    </g>
