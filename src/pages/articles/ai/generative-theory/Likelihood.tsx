    ...
    <section id="likelihood" className="mb-16 scroll-mt-20">
      ...
      <ExplainedFormula
        ...
        terms={[
          ...
          { symbol: "p_\theta", name: "model density", description: "Normalized probability를 계산할 수 있는 parameterized distribution입니다." },
          { symbol: "H(p_{data})", name: "data entropy", description: "θ로 바꿀 수 없는 상수 항입니다." },
          { symbol: "D_{KL}(p_{data}\|p_\theta)", name: "forward KL", description: "Data가 놓인 곳에서 model density가 부족하면 크게 벌점을 줍니다." },
        ]}
      ...
      <ExplainedFormula
        ...
        terms={[
          ...
          { symbol: "p_\theta(x_t\mid x_{<t})", name: "local conditional", description: "각 step에서 normalized distribution을 출력합니다." },
        ]}
