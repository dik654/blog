  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          “지식”은 model weight가 통째로 이동한다는 뜻이 아닙니다. Student는 teacher가 관측한 input에서 내놓은 제한된 신호를 모방하며 teacher의
          오류·bias·calibration 문제도 함께 배울 수 있습니다. teacher가 크다는 이유만으로 고를 일이 아니라, target domain과 slice에서 teacher가
          hard-label baseline보다 어떤 추가 정보를 주는지 먼저 확인해야 합니다.
        </p>
        <p>
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          Distillation loss가 낮아졌다는 사실은 teacher와 가까워졌다는 뜻일 뿐, 정답이나 배포 목표에 가까워졌다는 뜻은 아닙니다. ground-truth loss를
          anchor로 남기고 teacher agreement와 독립 test quality, student-only runtime을 서로 다른 열에 기록합니다.
        </p>
      </div>
    </section>
  );
