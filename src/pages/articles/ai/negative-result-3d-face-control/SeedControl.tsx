    ...
    <section id="seed-control" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          아직 안 써 본 수단이 하나 남아 있었습니다. 원본 픽셀에서 출발시키는 방법은 노이즈 비율이 오르면
          제약이 녹지만, 매 단계를 조건화하는 방식은 최대 노이즈에서도 제약이 유지됩니다.
        </p>

        <p className="leading-7">
          깊이 신호는 추정하지 않고 직접 뽑았습니다. 렌더 이미지에 깊이 추정기를 돌리면 그 추정기가 "얼굴이란
          이렇게 생겼다"는 의견을 가진 두 번째 모델이 되어, 측정하려는 누수를 스스로 만듭니다. 그래서
          래스터라이저의 깊이 버퍼에서 바로 꺼내고 윤곽도 픽셀이 아니라 깊이 불연속에서 뽑았습니다.
        </p>
