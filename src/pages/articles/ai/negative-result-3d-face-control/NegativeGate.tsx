    ...
    <section id="negative-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          세 라운드를 정리하면 이렇습니다. 조립식 메쉬는 형태를 전달했지만 부속물까지 복사했습니다. 단일 두상은 깨끗한 대신 결과가 수렴했고, 매 단계 조건화는 성공처럼 보였지만 그 분리가
          난수와 구분되지 않았습니다.
        </p>

        <p className="leading-7">
          이 기록이 남아 있어서 두 가지가 달라집니다. 하나는 같은 발상이 다시 떠올랐을 때 같은 세 라운드를 반복하지 않는다는 점이고, 다른 하나는 이 실패가 다른 관찰과 맞물려 더 큰
          결론을 만든다는 점입니다.
        </p>
        ...
        <p className="leading-7">
          그리고 실제로 필요했던 것은 이 경로가 아니었습니다. 서로 다른 인물이 필요하면 참조에서 정체성을 가져오면 됩니다. 그 답은 이 실패를 확인한 뒤에 찾았습니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 실패한 것은 이 세 방법이며 3차원 형태로 얼굴을 제어하는 모든 접근이 불가능하다는 뜻이 아닙니다. 네 얼굴 표본이라 편차 추정이 거칠고
          수치는 한 장비의 특정 모델 조합에서 얻은 것입니다.
        </p>
