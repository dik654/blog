  ...
  return (
    <section id="forward" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Function trait에는 forward와 backward가 한 쌍으로 정의됩니다. Add나 Mul 같은 연산은 자신의 국소 미분만 알면 되고, 여러 Function을 연결했을 때 전체 미분을 만드는 일은 계산 그래프가 맡습니다. 따라서 새 연산을 추가할 때도 전역 그래프 로직을 바꾸지 않아도 됩니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          출력의 generation을 입력 중 가장 큰 값보다 하나 크게 두면, backward에서는 generation이 큰 Function부터 처리할 수 있습니다. 이 정수는 계산 그래프 전체를 매번 위상 정렬하는 대신 사용할 수 있는 우선순위이며, 분기가 있는 그래프에서도 출력에 가까운 연산부터 안정적으로 실행하게 해 줍니다.
        </p>
      </div>
    </section>
  );
