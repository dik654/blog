  ...
  return <div className="space-y-16">
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert"><p className="text-lg leading-8">
            일반 Word2Vec table은 vocabulary에 없는 word ID를 읽을 수 없습니다. fastText 방식은 word boundary를 표시한 문자열에서
            character n-grams를 만든 뒤 각 n-gram을 bucket row에 대응시켜 rows를 합합니다. 그래서 OOV도 vector를 만들 수 있습니다. 이 방식이
            주는 범위는 거기까지입니다. 같은 철자의 word가 문장마다 다른 sense vector를 얻는 contextual model은 아닙니다.
          </p></div>
