...
export const STEPS: StepDef[] = [
  { label: '① Forget Gate — 버릴 정보 결정', body: 'f_t = σ(W_f·[h_{t-1}, x_t] + b_f) → 0이면 삭제, 1이면 유지.\n실수 예시: f = 0.8이면 80% 유지, f = 0.1이면 90% 삭제.' },
  { label: '② Input Gate — 저장할 정보 결정', body: 'i_t = σ(...), C̃_t = tanh(...) → 새 정보의 크기와 내용.\ni = 0.9이면 새 정보 90% 반영, i = 0.05이면 거의 무시.' },
  { label: '③ Output Gate — 출력할 정보 선별', body: 'o_t = σ(...) → 셀 상태 중 외부에 공개할 부분.\no = 0.7이면 tanh(C_t)의 70%만 은닉 상태로 출력.' },
...
export const COL_X = [8, 68, 118, 175, 232, 294, 354, 415];
