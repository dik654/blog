          ...
          {step <= 2 && (
            <g>
              ...
              <motion.g animate={{ opacity: step >= 0 ? 1 : 0.15 }} transition={sp}>
                ...
                <text x={100} y={92} textAnchor="middle" fontSize={11} fill={FORGET_C}>f_t = σ(...)</text>
              ...
              <motion.g animate={{ opacity: step >= 1 ? 1 : 0.15 }} transition={sp}>
                ...
                <text x={230} y={92} textAnchor="middle" fontSize={11} fill={INPUT_C}>i_t · C̃_t</text>
              ...
              <motion.g animate={{ opacity: step >= 2 ? 1 : 0.15 }} transition={sp}>
                ...
                <text x={380} y={92} textAnchor="middle" fontSize={11} fill={OUTPUT_C}>o_t · tanh(C_t)</text>
                ...
                <text x={380} y={132} textAnchor="middle" fontSize={11} fill={OUTPUT_C} fontWeight={600}>h_t</text>
                {step === 2 && (
                  <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    ...
                    <text x={380} y={164} textAnchor="middle" fontSize={9} fill={OUTPUT_C} opacity={0.7}>
                      o=0.7 → tanh(C_t)의 70% 출력
                    </text>
                  </motion.g>
                )}
              </motion.g>
              {/* Input arrows from bottom */}
              <text x={30} y={170} fontSize={11} fill="#999">h_{'{t-1}'}, x_t 입력 →</text>
              {[100, 230, 380].map((x, i) => (
