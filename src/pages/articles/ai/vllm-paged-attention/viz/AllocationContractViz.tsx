...
export default function AllocationContractViz() {
  return (
    <figure data-viz="kv-manager-allocation-contract" className="not-prose my-12 overflow-hidden rounded-xl border border-border/70 bg-card">
      <figcaption className="border-b bg-muted/20 px-5 py-5 sm:px-7"><p className="text-xs font-bold text-primary">SCHEDULER → KV MANAGER</p><h3 className="mt-2 text-lg font-bold tracking-tight sm:text-xl">Token 계획을 cache lookup과 block demand로 낮춥니다</h3></figcaption>
