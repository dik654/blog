    ...
    <section id="denoise-window" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          원본을 얼마나 남길지 정하는 값은 직관적으로 연속적인 손잡이처럼 보입니다. 조금 낮추면 조금 더 남고 조금 올리면 조금 더 바뀔 것 같습니다. 실제로는 모델 종류에 따라 완전히
          다르게 동작합니다.
        </p>

        <p className="leading-7">
          지시를 받아 편집하도록 학습된 모델에서는 레버가 아니라 절벽입니다. 0.55와 0.75에서는 변환 자체가 일어나지 않고 원본이 살짝 부드러워질 뿐이며 1.0에서만 결과가 나옵니다.
          부분적으로 섞는 구간이 없습니다.
        </p>

        <p className="leading-7">
          이 모델들은 일반적인 이미지 대 이미지 변환기가 아니라 지시 편집기라서 부분 노이즈가 원본 잠재를 거의 그대로 남깁니다. 그래서 중간값이 "조금 변환"이 아니라 "변환 안 함"이
          됩니다.
        </p>
