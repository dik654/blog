    ...
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          전신 1메가픽셀 프레임에서 얼굴은 95픽셀입니다. 잠재 공간으로 내려가면 그 얼굴이 차지하는 토큰이 몇 개 되지 않습니다. 정보량이 그만큼 적으니 낮은 노이즈 비율이 보호해 주지
          못하고 모델이 가진 얼굴 사전이 그 자리를 새로 그립니다.
        </p>

        <p className="leading-7">
          같은 편집을 얼굴이 327픽셀인 패널에 걸면 성공합니다. 모델도 프롬프트도 설정도 같은데 결과가 갈립니다. 이 글은 그 경계가 어디에 있는지, 그리고 리파인을 프레임 전체가 아니라
          영역별로 걸어야 하는 이유를 다룹니다.
        </p>
