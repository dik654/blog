    ...
    <section id="token-budget" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          잠재 확산은 픽셀을 직접 다루지 않습니다. 오토인코더가 이미지를 여덟 배 줄인 잠재 표현으로 바꾸고,
          확산은 그 공간에서 일어납니다. 그 잠재 표현은 다시 작은 조각으로 쪼개져 토큰이 됩니다.
        </p>

        <p className="leading-7">
          그래서 화면에서 보이는 픽셀 수가 아니라 잠재 공간에서의 칸 수가 실제 예산입니다. 전신 1메가픽셀
          프레임의 95픽셀 얼굴은 잠재 공간에서 대략 12 곱하기 12 칸이고, 토큰으로 세면 몇 개 되지 않습니다.
        </p>
        ...
        <p className="leading-7">
          설명이 맞는지 확인하는 방법은 해상도만 올려 보는 것입니다. 같은 프레임을 4메가픽셀로 보내자 정체성
          유사도가 0.265에서 0.318로 올라갔습니다. 방향은 맞지만 여전히 부족했고, 그 부족함이 다음 결론으로
          이어집니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          그래서 프레임을 키우는 대신 대상을 키우는 쪽이 답입니다. 얼굴이 327픽셀인 패널에 같은 리파인을
          걸자 정체성이 0.531로 올라갔습니다. 전신 4메가픽셀의 0.318과 비교하면, 총 픽셀은 훨씬 적은데
          결과는 훨씬 좋습니다.
        </p>
