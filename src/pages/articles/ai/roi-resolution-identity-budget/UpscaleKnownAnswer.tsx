    ...
    <section id="upscale-known-answer" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래서 정답을 아는 실험으로 했습니다. 고해상 원본을 4분의 1로 줄여 각 방법에 복원시키고 모델이 본 적 없는 원본과 비교했습니다. 이제 "맞았는가"를 물을 수 있습니다.
        </p>

        <p className="leading-7">
          픽셀 오차 지표가 가장 흐린 결과를 1등으로 뽑았습니다. 보간법은 추측을 거부하기 때문에 평균적으로 원본에 가깝습니다. 그래서 이 지표에서 이깁니다. 원본 엣지의 절반 남짓만
          복원하면서 1등입니다.
        </p>

        <p className="leading-7">
          사람이 보는 것과 맞는 숫자는 원본 대비 엣지 에너지였습니다. 복원 전용 모델이 1.07배로 사실상 원본 수준의 디테일을 되살렸고 확대 사진을 보면 이유가 보입니다. 보간법이
          피부를 빈칸으로 두는 자리에 모공과 머리카락 한 올이 돌아옵니다.
        </p>
      </div>
