...
export function RecoveryFrame({
  ...
  return (
    <figure data-viz="claw-recovery" data-viz-canvas className="my-8 overflow-hidden rounded-lg border border-border/70 bg-background">
...
export function RecoveryRule({ children }: { children: ReactNode }) {
  return (
