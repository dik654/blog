    ...
    <section id="instrument-controls" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          "지웠는가"를 판정해야 하는 회차가 있었습니다. 픽셀 변화량으로는 판정할 수 없습니다. 물건을 지운 결과와 그 자리에 다른 물건을 그려 넣은 결과가 똑같이 큰 변화로 나오고 오히려
          바꿔치기 쪽이 더 높은 점수를 받습니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          이 프로젝트에서 지표가 틀린 것이 일곱 번입니다. 매번 모양이 같습니다. 그럴듯한 숫자가 먼저 나오고 그 숫자로 결론을 쓰려는 순간 대조군이 없다는 걸 알아차리고, 붙여 보면
          계측기가 다른 것을 재고 있었습니다. 그래서 규칙을 하나 고정했습니다.
        </p>

        <p className="leading-7">
          계측기를 새로 붙일 때는 답을 아는 입력을 하나 같이 돌립니다. 어떤 계측기든 예외 없이 적용하고 그 대조군이 실패하면 그 회차의 숫자는 쓰지 않습니다. 비용은 실행 한 번이고
          없을 때의 비용은 회차 전체입니다.
        </p>
