  ...
  return (
    <section id="roundtrip-floor" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          즉 일곱 모델 전부 마스크를 잘 지키고 있었고, 제가 매긴 순위는 실력 차이가 아니라 어느 오토인코더를
          로드하는지였습니다. 같은 오토인코더를 공유하는 모델들끼리 값이 붙어 있었다는 사실을 진작 이상하게
          봤어야 했습니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          살아남은 수치와 죽은 수치가 갈립니다. 모델 간 침범 비교는 전부 무효가 됐고, 마스크 안 변화량은
          바닥값이 마스크 밖에만 해당하므로 그대로 삽니다. 오토인코더를 거치지 않는 제거 모델의 수치도
          그대로이고, 같은 모델·같은 소스로 두 번 돌려 그 차이를 본 값도 바닥값이 상쇄되어 살아남습니다.
        </p>
