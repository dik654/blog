  ...
  return (
    <section id="measurement-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          둘째, 임계값의 근거가 무엇입니까. 어디선가 본 기본값이라면 그건 검증되지 않은 가정입니다. 남남 쌍을 만들어 재고 허용할 오탐률을 먼저 정한 뒤 그로부터 값을 얻어야 합니다.
        </p>

        <p className="leading-7">
          셋째, 이 숫자의 바닥값이 얼마입니까. 아무것도 하지 않았을 때 0이 나오지 않는 지표라면 그 바닥을 재서 빼야 하고 바닥값이 입력에 의존한다면 같은 입력에서 잰 값으로만 빼야
          합니다.
        </p>

        <p className="leading-7">
          넷째, 절대값입니까 차이입니까. 같은 조건에서 두 번 돌려 그 차이를 보는 지표는 이런 오염에 면역이고 한 번 돌린 값을 그대로 쓰는 지표는 취약합니다. 가능하면 비교를 차이로
          설계하는 편이 안전합니다.
        </p>
      </div>
