  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          서브에이전트나 외부 작업 프로세스를 실행하면 프로세스 ID 하나만으로는 작업을 맡길 준비가 됐는지 알 수 없습니다. 통신 채널이 열렸는지, 예상한 워크스페이스와 권한으로
          동작하는지, 초기 상태 보고를 정상적으로 보냈는지 확인한 뒤에야 스케줄러가 작업을 전달합니다.
        </p>
        <p>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          trust resolver는 worker의 출처·설정·권한을 기준으로 작업 가능 여부를 판정하고 observe 단계는 부팅 중 실제로 들어오는 신호를 해석합니다. 설정이
          올바르더라도 기대한 worker가 아닌 프로세스가 응답하거나 이전 실행의 메시지가 늦게 도착하는 misdelivery가 생깁니다. 식별자와 세대 번호를 함께 검증하는 이유입니다.
        </p>
        <p>
