...
export function ClassicMLStep() {
  return (
    <g>
      ...
      >
        <text x={20} y={145} fontSize={8} fill={C.muted}>
          SVM, Random Forest, XGBoost
        </text>
        <text x={240} y={145} fontSize={8} fill={C.muted}>
          구조화 데이터에 강함 / 해석 가능성 높음
        </text>
      </motion.g>
  ...
  return (
    <g>
      ...
      <motion.g
        ...
        transition={{ ...sp, delay: 0.7 }}
      >
        <text x={190} y={145} textAnchor="middle" fontSize={8} fill={C.muted}>
          CNN (자동 학습)
        </text>
      </motion.g>
