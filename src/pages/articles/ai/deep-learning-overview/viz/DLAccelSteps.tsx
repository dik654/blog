...
export function CpuVsGpuStep() {
  return (
    <g>
      ...
      >
        <text x={150} y={138} textAnchor="middle" fontSize={8} fill={C.cpu}>
          FP32: 1x
        </text>
        <text
          x={310}
    ...
    <g>
      ...
      >
        ...
        <rect
          ...
          strokeWidth={0.6}
        />
        <text x={65} y={120} textAnchor="middle" fontSize={8} fill={C.flash}>
          QK^T
        </text>
