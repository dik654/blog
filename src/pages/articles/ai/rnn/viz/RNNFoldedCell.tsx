  ...
  return (
    <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={sp}>
      ...
      <text x={225} y={37} textAnchor="middle" fontSize={12} fill={OUT_C}
        fontWeight={600}>yₜ</text>

      <line x1={80} y1={107} x2={155} y2={107} stroke={HIDDEN_C} strokeWidth={2}
        markerEnd="url(#arr-h)" />
      <text x={70} y={112} textAnchor="end" fontSize={11} fill={HIDDEN_C}
        fontWeight={600}>hₜ₋₁</text>

      <line x1={295} y1={107} x2={350} y2={107} stroke={HIDDEN_C} strokeWidth={2}
        markerEnd="url(#arr-h)" />
      <text x={360} y={112} fontSize={11} fill={HIDDEN_C} fontWeight={600}>hₜ</text>

      <path d="M350,107 Q390,107 390,80 Q390,50 340,50 Q305,50 305,72"
