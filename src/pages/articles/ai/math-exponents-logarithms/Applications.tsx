    ...
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div id="paper-log-foundation" className="not-prose mt-8 scroll-mt-24 border-l border-border/80 pl-4">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
            로그의 곱→합 성질은 긴 곱셈을 다루는 계산 도구로 쓰였고 정보이론에서는 독립 사건의 결합 정보량이 더해져야 한다는 요구를 만족시킵니다. 다만 로그 성질만으로 entropy의
            모든 공리와 source coding theorem이 자동으로 따라오는 것은 아니며, 그 범위는 다음 글에서 구분합니다.
          </p>
      </div>
    </section>
  );
