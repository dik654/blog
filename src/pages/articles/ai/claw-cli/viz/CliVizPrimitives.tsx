...
export function CliFrame({
  ...
  return (
    <figure data-viz="cli-control-flow" className="my-10 overflow-hidden rounded-xl border border-border/70 bg-card">
...
export function CliRule({ children }: { children: ReactNode }) {
  return (
