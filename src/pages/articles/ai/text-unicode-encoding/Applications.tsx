  ...
  return (
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          이제 “한글 한 글자가 여러 token이다”라는 현상을 언어 이름만으로 설명하지 않고 grapheme→code point→UTF-8 byte→subword merge의 어느 단계에서 길이가 생겼는지 추적할 수 있습니다. Normalizer가 text를 바꿨다면 byte 수와 offset도 그 뒤에 다시 계산해야 합니다.
        </p>
        <p>
