  ...
  return (
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          다음 <Link to="/cs/ai/tokenizer">Tokenizer 글</Link>에서는 이 text를 normalization·pre-tokenization·subword model·post-processing 단계로 넘기고, BPE·WordPiece·Unigram이 vocabulary와 segmentation을 만드는 방법을 비교합니다.
        </p>
      </div>
    </section>
  );
