    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          사람은 ‘가’나 가족 emoji를 화면의 한 글자로 읽습니다. 컴퓨터는 같은 text를 Unicode code point의 sequence로 다루고 파일과 network에서는 다시
          UTF-8 byte sequence로 저장합니다. 사용자가 보는 글자 경계, 문자열 API가 세는 원소, tokenizer가 받는 byte 수가 서로 다를 수 있는 이유입니다.
        </p>
