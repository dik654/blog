    ...
    annotations: [
      {
        lines: [3, 4],
        color: "sky",
        note: "은닉 상태가 단 1개 — 모든 시간 정보를 하나의 벡터에 압축",
      },
      {
        lines: [23, 28],
        color: "emerald",
        note: "tanh로 감싸는 단일 게이트 — 긴 시퀀스에서 기울기가 0에 수렴",
      },
    ],
  },
  "test-mode": {
    ...
    annotations: [
      {
        lines: [1, 3],
        color: "sky",
        note: "thread_local! — 스레드별 독립 상태. 멀티스레드에서도 안전",
      },
      {
        lines: [15, 18],
        color: "emerald",
        note: "Drop trait으로 스코프 종료 시 자동 복원 — Python의 with 문과 동일 효과",
      },
    ],
  },
};
