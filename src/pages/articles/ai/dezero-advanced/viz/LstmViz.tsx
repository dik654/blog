...
import { STEPS, STEP_REFS, STEP_LABELS } from './LstmVizData';
import { GateCalcStep, CellUpdateStep, HiddenOutputStep, FirstVsLaterStep } from './LstmVizSteps';

const RENDERERS = [GateCalcStep, CellUpdateStep, HiddenOutputStep, FirstVsLaterStep];
