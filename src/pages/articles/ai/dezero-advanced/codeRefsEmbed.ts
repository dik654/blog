    ...
    annotations: [
      {
        lines: [2, 2],
        color: "sky",
        note: "one-hot @ W와 동일하지만 실제 one-hot을 만들지 않아 메모리 효율적",
      },
      {
        lines: [7, 7],
        color: "emerald",
        note: "Xavier: sqrt(1/embed_dim) — 차원이 클수록 초기 가중치를 작게",
      },
      {
        lines: [21, 21],
        color: "amber",
        note: "embedding() 함수가 인덱스 룩업 + backward(scatter-add) 처리",
      },
    ],
  },
  "embedding-fn": {
    ...
    annotations: [
      {
        lines: [12, 14],
        color: "sky",
        note: "forward: W[i]행 복사. O(n*d) — one-hot matmul(O(V*d))보다 효율적",
      },
      {
        lines: [21, 24],
        color: "emerald",
        note: "scatter-add: 동일 인덱스면 기울기를 합산. 정확한 gradient 보장",
      },
    ],
  },
};
