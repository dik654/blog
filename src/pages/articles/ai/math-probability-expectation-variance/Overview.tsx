  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>이 글은 동전과 작은 dataset처럼 셀 수 있는 예제로 시작합니다. Outcome·event·sample space를 정한 뒤 probability와 conditional probability를 계산하고, random variable로 결과를 수치화해 expectation·variance·sample mean으로 내려갑니다. 마지막에는 같은 언어로 mini-batch gradient를 전체 gradient의 추정치로 읽습니다.</p>
        <p>글을 다 읽고 나면 독립 표본 평균의 variance가 왜 batch size에 반비례하는지뿐 아니라, 분모가 0인 조건부확률과 상관된 batch처럼 그 결론을 적용할 수 없는 경우도 설명할 수 있어야 합니다.</p>
      </div>
