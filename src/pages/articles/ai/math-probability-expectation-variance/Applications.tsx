  ...
  return (
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div className="not-prose grid gap-5 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Link to="/ai/math-optimization-convexity#overview" className="border-t border-border pt-4"><b className="text-sm">Optimization</b><p className="mt-2 text-xs leading-5 text-muted-foreground">확률적으로 추정한 gradient가 어떤 전제에서 descent에 쓰이는지 확인합니다.</p></Link>
