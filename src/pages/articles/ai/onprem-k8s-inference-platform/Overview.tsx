  ...
  return (
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          내려간 쪽이 이 글의 주제입니다. 라우팅 규칙을 어떻게 고를지는 이미 정리된 주제이므로 반복하지 않고,
          그 규칙이 쿠버네티스 안에서 어디에 놓이고 무엇이 그것을 떠받쳐야 하는지를 봅니다.
        </p>

        <ContentBoundary article="onprem-k8s-inference-platform" />

        <p className="leading-7">
          그리고 온프레미스에는 클라우드에 없는 제약이 하나 있습니다. 총 가속기 수가 고정돼 있다는 것입니다.
          부하가 늘어도 노드를 더 살 수 없으므로, 늘리는 문제가 아니라 지금 있는 것을 어떻게 나눌지의 문제가
          됩니다. 이 제약이 배치와 정책을 같은 것으로 만듭니다.
        </p>
