    ...
    <section id="platform-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          첫 질문은 복제본 선택입니다. 요청을 어느 복제본으로 보낼지 누가 정하고, 그 결정에 모델 서버의 어떤
          값이 들어가는지 답할 수 있어야 합니다. 답이 "앞단 프록시가 순서대로"라면 가속기 절반이 놀고 있을
          가능성이 높습니다.
        </p>
        ...
        <p className="leading-7">
          셋째는 총량입니다. 부하가 늘 때 어떤 모델이 자리를 내주는지, 내준 뒤 다시 뜨는 데 얼마나 걸리는지가
          정해져 있어야 합니다. 이것은 인프라 설정이 아니라 정책이므로 기술 조직 혼자 정할 수 없습니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 인용한 구성요소는 공개 문서에 적힌 구조까지만 다뤘고 특정
          구현의 성능이나 성숙도를 평가하지 않습니다. 복제본 수·갱신 단위·지표 수집 주기의 구체 값도 여기서
          권고하지 않으며, 부등식은 상한을 계산하는 방법을 보이는 데까지만 씁니다.
        </p>
