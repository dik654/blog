  ...
  return (
    <section id="fixed-pool" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          기본 스케줄러는 이 다툼을 우선순위와 선점으로 정리합니다. 우선순위가 높은 파드가 자리를 못 찾으면 낮은 파드를 쫓아내고 그 자리를 씁니다. 문제는 쫓겨나는 쪽이 진행 중이던
          요청을 들고 있다는 점입니다. 그래서 이 정리 방식은 어떤 모델이 갑자기 응답을 멈춰도 되는지를 미리 정해 둔 경우에만 안전합니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          세 방식은 배타적이지 않습니다. 실제 구성은 대개 대화형 모델에 정적 분할로 바닥을 깔아 두고 남는 자리를 배치 작업이 우선순위 낮게 쓰다가 대화형이 늘어나면 물러나는 형태가
          됩니다. 이때 물러나는 작업은 중단되어도 다시 시작할 수 있어야 합니다.
        </p>
