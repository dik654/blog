    ...
    <section id="group-replica" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이때 복제본 하나는 여러 노드의 파드 여럿으로 이뤄집니다. 이 파드들은 서로를 알아야 하고, 같이 떠야
          하고, 하나가 죽으면 나머지도 의미가 없어집니다. 절반만 살아 있는 복제본은 요청을 처리하지 못하면서
          가속기만 잡고 있습니다.
        </p>
        ...
        <p className="leading-7">
          그래서 파드 묶음 자체를 복제 단위로 다루는 추상이 따로 필요합니다. 대표 파드 하나와 나머지 파드들을
          한 그룹으로 묶어 함께 배치하고, 그룹 안에서 하나라도 실패하면 그룹 전체를 다시 만들고, 갱신도 그룹
          단위로 한 번에 하나씩 진행하는 방식입니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          같은 이유로 부분 배치도 소용이 없습니다. 그룹의 파드 여덟 개 중 여섯 개만 자리를 잡으면 그 여섯 개는
          아무 일도 못 하면서 자원을 점유합니다. 전부 놓을 수 있을 때만 놓는 판단이 필요하고, 그 판단이 없으면
          여러 그룹이 서로의 부분 배치에 막혀 아무도 뜨지 못하는 상황이 생깁니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="leading-7">
          그룹 단위 갱신은 한 번에 그룹 하나를 통째로 내렸다 올립니다. 그동안 그 그룹의 가속기는 전부 서비스에서
          빠집니다. 복제본이 네 개라면 갱신 중에는 세 개로 버텨야 하고, 그 세 개가 평소 부하를 감당하지 못하면
          갱신 자체가 장애가 됩니다.
        </p>
