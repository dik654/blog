    ...
    <section id="control-plane" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          ...
          항목들이 각각 어디론가 가야 합니다. 가지 않은 항목은 그냥 사라집니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          주인이 정해진 뒤에도 하나가 남습니다. 외부 제공자를 쓸 때는 용량 부족이 상대방 문제였습니다. 자체 클러스터에서는 우리 문제이고 그것도 "돈을 더 내면 해결되는" 종류가
          아닙니다. 그래서 넘치는 요청을 어떻게 할지가 새로 정해야 할 항목으로 들어옵니다.
        </p>

        <p className="leading-7">
          선택지는 대체로 셋입니다. 대기열에 쌓아 두고 기다리게 하거나, 즉시 거절하고 호출한 쪽이 재시도하게 하거나, 남은 용량으로 감당 가능한 더 작은 모델로 내려보내는 것입니다. 셋
          다 앞단에서 정해야 하는 일입니다. 클러스터 안의 어떤 구성요소도 대신 정해 주지 않습니다.
        </p>
