  ...
  return (
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          같은 matrix factorization도 무엇을 row·column으로 삼고 어떤 error를 줄이는지에 따라 결과가 달라집니다. Term–document나
          word–context matrix의 SVD는 관측 pattern을 압축하지만 neural network weight의 matrix multiplication은 학습된
          feature transformation을 실행합니다. 아래에서는 정의를 반복하지 않고 각 응용의 data·objective·평가 경계를 짚습니다.
        </p>
      </div>
      ...
      <div id="paper-svd-lecture" className="not-prose my-8 scroll-mt-24 border-l border-primary/50 pl-4">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          임의 matrix를 orthogonal·diagonal·orthogonal 세 factor로 분해하고 AᵀA의 eigenvalue와 singular value를 연결합니다. 이
          글에서는 eigendecomposition 전체를 선수로 요구하지 않았으므로 증명과 네 fundamental subspaces까지 확장할 때 이 강의를 사용합니다.
        </p>
