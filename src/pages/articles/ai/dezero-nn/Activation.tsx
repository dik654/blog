  ...
  return (
    <section id="activation" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          Linear layer만 여러 번 연결하면 전체 모델도 하나의 선형 변환으로 합쳐집니다. ReLU, sigmoid, tanh, GELU 같은 activation을 사이에 넣어야
          입력에 따라 다른 비선형 경계를 학습할 수 있습니다. 선택 기준도 단순한 함수 모양이 아니라 사용 위치와 gradient 특성입니다.
        </p>
        <p>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Sigmoid는 이진 분류의 확률 출력이나 gate에 쓰이지만 다중 클래스 분류의 마지막 층은 보통 softmax와 cross-entropy를 결합합니다. GELU 역시
          Transformer에서 널리 쓰인다는 사실과 모든 모델에서 항상 최선이라는 주장은 다릅니다. 프레임워크 구현에서는 여러 함수를 제공하고 선택은 모델과 실험에 맡깁니다.
        </p>
      </div>
    </section>
  );
