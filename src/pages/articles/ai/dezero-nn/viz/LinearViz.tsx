...
import { STEPS, STEP_REFS, STEP_LABELS } from './LinearVizData';
import { XavierStep, BoxMullerStep, ForwardStep, BackwardStep } from './LinearVizSteps';

const RENDERERS = [XavierStep, BoxMullerStep, ForwardStep, BackwardStep];
