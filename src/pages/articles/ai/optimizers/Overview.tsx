  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>이 글은 <Link to="/ai/math-gradients-jacobians#gradient-direction">gradient</Link>, <Link to="/ai/math-variance-sampling#gradient-estimator">stochastic estimate와 variance</Link>, <Link to="/ai/math-gradient-descent-convergence#overview">gradient descent·convergence 전제</Link>를 이미 정본으로 설명한 뒤 이어집니다. 용어가 낯설다면 각 링크를 먼저 읽고 돌아올 수 있습니다.</p>
      </div>
      <OptimizerViz />
