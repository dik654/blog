    ...
    <section id="neural-approach" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-8">
          ...
          의미가 섞입니다. Contextual model은 문장 안의 다른 token을 읽어
          position별 hidden state를 다시 계산합니다. 그렇다고 distributional
          assumption이 사라진 것은 아니며, 더 넓은 context와 더 복잡한
          objective에서 사용 패턴을 학습하게 된 것입니다.
        </p>
      </div>
