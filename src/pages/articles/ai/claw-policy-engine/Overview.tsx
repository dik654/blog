  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          에이전트가 장시간 작업하면 “테스트가 끝났으니 병합할지”, “같은 실패를
          다시 시도할지”, “사람에게 넘길지”를 반복해서 판단해야 합니다. 이런
          운영 규칙까지 매번 모델의 자연어 판단에 맡기면 같은 상태에서도 결과가
          달라질 수 있습니다. Policy engine은 관측된 상태와 명시적 규칙을
          바탕으로 다음 동작을 결정합니다.
        </p>
        <p>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          “빌드와 테스트가 성공하면 병합 가능 상태로 이동한다”는 규칙은 관측
          가능한 조건과 허용된 동작으로 나눌 수 있습니다. 평가 시점의 상태를
          고정한 뒤 조건을 검사해야 하며, 동작을 수행하는 동안 상태가 바뀌면
          같은 규칙을 다시 검증해야 합니다. 주기적 평가에서는 동일 이벤트가 여러
          번 들어와도 결과가 망가지지 않도록 action을 idempotent하게 만드는 것이
          중요합니다.
        </p>
