...
export default function OptimizationObjectivesArticle() {
  return <article className="space-y-16">
    ...
    <section id="boundaries" className="space-y-6">
      ...
      />
      <p>다음 글에서 <a className="font-semibold text-primary underline" href="/cs/ai/math-optimization-convexity">convexity와 smoothness</a>가 문제의 지형을 어떻게 제한하는지 보고, 그다음 <a className="font-semibold text-primary underline" href="/cs/ai/math-gradient-descent-convergence">gradient descent 반복</a>을 적용합니다.</p>
