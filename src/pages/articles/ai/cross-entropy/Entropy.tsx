  ...
  return (
    <section id="entropy" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          실제 분포 P를 정확히 알고 그 분포에 맞는 code를 설계해도, 어떤 sample이
          나올지는 관측 전까지 알 수 없다. Entropy는 P에서 나온 사건의 surprisal을
          다시 P로 평균내어 이 본질적인 불확실성을 잰다. 한 사건에 확률이 몰려 있으면
          예측하기 쉬워 낮고, K개 사건이 균등하면 가장 높아져 log K가 된다.
        </p>
      </div>
      ...
      <div id="paper-shannon" className="not-prose mt-8 scroll-mt-24 border-l border-border/80 pl-4">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          Shannon은 통신의 semantic meaning을 직접 점수화하지 않고, source가 어떤 symbol을 선택할지와 channel이 그 sequence를 얼마나 안정적으로 전달할지를 수학적으로 분리했습니다. Discrete source의 entropy와 coding result는 source model·alphabet·긴 sequence라는 전제 안에서 읽어야 하며, entropy가 문장의 진실성이나 인간에게 주는 의미를 재는다는 결론은 아닙니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          Shannon의 source coding theorem에서 entropy는 긴 symbol sequence를
          lossless coding할 때 달성 가능한 평균 code length의 하한과 연결된다.
          자주 나오는 symbol에 짧은 code를 배정하는 원리다. 다만 “문장 하나의
          entropy”처럼 말하려면 alphabet, tokenization, 문맥에 대한 conditional
          distribution을 먼저 정해야 하며, differential entropy를 같은 방식으로
          직접 해석해서도 안 된다.
        </p>
        <p>
