    ...
    <section id="mask-polarity" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          물건 교체가 표에서 가장 지저분한 동작이었습니다. 각반을 만들어 달라고 했더니 한쪽 다리가 하얗게 뜨고 신발이 뭉개졌습니다. 저는 이걸 모델 약점으로 적었는데 모델을 탓하기 전에
          설정을 봤어야 했습니다.
        </p>

        <p className="leading-7">
          원인이 둘이었습니다. 하나는 2메가픽셀짜리 전체 프레임을 통째로 넘긴 것이고 다른 하나는 마스크를 옛 물건에 딱 맞게 잡은 것입니다. 앞의 것을 고치자 마스크 안 변화가
          73.3에서 44.8로, 뒤의 것까지 고치자 32.4로 떨어졌습니다.
        </p>
        ...
        <p className="leading-7">
          이건 신중한 사용자의 직관과 정반대입니다. 선택을 대상에 정확히 맞추는 것이 조심스러운 태도처럼 보이는데 교체에서는 그게 결과를 나쁘게 만듭니다. 말해 주지 않으면 알 수 없는
          종류의 규칙이라 도구가 경고로 함께 내보내야 합니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래서 두 동작은 같은 도구에 들어갈 수 없습니다. 교체는 기본값 96에 경고가 붙고 지우기는 기본값 0에 넓히지 말라는 경고가 붙습니다. 같은 이름의 파라미터가 한쪽에서는
          필수이고 다른 쪽에서는 금지인 셈입니다.
        </p>
      ...
      <div className="mt-6">
        ...
        >
          ...
          <p className="leading-7">
            현재 파이프라인에서는 분리하지 않았고 96이라는 값은 두 효과가 맞바꿔지는 지점을 실측으로 찾은 타협값입니다. 분리한 구현에서 이 값이 그대로일 이유는 없습니다.
          </p>
        </ProgressiveDetail>
      </div>
