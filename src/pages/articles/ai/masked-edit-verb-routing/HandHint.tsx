  ...
  return (
    <section id="hand-hint" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 설계에는 부수적인 이점이 있습니다. 같은 모델·같은 소스로 두 번 돌린 값의 차이라 공통 오염항이
          상쇄됩니다. 오토인코더가 만드는 바닥값이 두 실행에 똑같이 들어가므로 빼면 사라지고, 절대값 비교가
          무효화된 이 표에서 유일하게 그대로 살아남는 수치가 됩니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          결과는 한 모델만 뚜렷합니다. 절제형 모델이 10.26에서 12.13으로 +1.87을 냈고, 다섯 모델은 −0.13에서
          +0.16 사이로 사실상 0이었습니다. 그림으로 확인하면 이 차이가 무엇인지 분명합니다. 그 모델에서만
          그어 준 선이 아문 흉터의 모양을 따라가고, 나머지는 선을 지우고 자기 방식대로 다시 그립니다.
        </p>
        ...
        <p className="leading-7">
          다만 이 +1.05는 해석이 다릅니다. 두 값 모두 그 모델의 무동작 범위 안에 있어서, 움직인 그림에 선이
          더해진 것이 아니라 거의 아무것도 하지 않는 상태에서 조금 덜 아무것도 하지 않은 것에 가깝습니다.
          절제형 모델의 +1.87은 10.26이라는 실제로 변한 바닥 위에서 얻은 값이라 성격이 다릅니다.
        </p>
