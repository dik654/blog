    ...
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 차이를 무시하고 한 모델로 전부 처리하면, 어떤 요청에서는 아무 일도 일어나지 않고 어떤 요청에서는
          영역이 통째로 망가집니다. 모델이 나쁜 게 아니라 각 모델이 잘하는 동작이 다르기 때문입니다.
        </p>

        <p className="leading-7">
          그래서 동작 여섯 개와 설치된 모델 일곱 개를 같은 입력·같은 마스크·같은 프롬프트·같은 시드로 고정해
          전부 돌렸습니다. 산출물은 산문이 아니라 선택에 쓸 수 있는 표입니다. 이 글은 그 표가 무엇을 말하는지와,
          표를 만들면서 드러난 두 가지 함정을 다룹니다.
        </p>

        <ContentBoundary article="masked-edit-verb-routing" />

        <p className="leading-7">
          두 함정은 각각 마스크와 지표 쪽입니다. 마스크를 넓히는 방향이 동작마다 반대라는 것이 하나이고, 같은
          동작의 수치가 그림 스타일에 따라 두 배씩 달라져 절대값으로 모델을 고르면 안 된다는 것이 다른
          하나입니다.
        </p>
