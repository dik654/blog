    ...
    <section id="model-disposition" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          표를 채우고 나서 가장 먼저 보인 것은 개별 칸이 아니라 줄이었습니다. 어떤 모델은 여섯 동작 내내
          조심스럽고, 어떤 모델은 내내 과하게 바꿉니다. 동작별로 잘하고 못하고가 흩어져 있는 게 아니라 성향이
          일관됩니다.
        </p>

        <p className="leading-7">
          가장 보수적인 모델은 여섯 동작 중 넷에서 최저 변화량을 냈고, 색 변경에서는 0.61 차이로 두 번째였습니다.
          기존 그림을 건드리면 안 되는 편집에는 최선이지만, 없던 것을 더하는 동작에서는 4.5라는 값이 나옵니다.
          안내 계수를 2.5에서 7.0까지 올려도 4.4에서 4.5로 움직였을 뿐입니다. 소심한 것이 아니라 구조적으로
          못 하는 것입니다.
        </p>

        <p className="leading-7">
          예외가 하나 있습니다. 물건 교체에서는 이 모델이 55.5로 오히려 큰 값을 냈습니다. 다만 그림을 보면
          요구한 각반이 아니라 다른 것을 만든 결과라, 많이 바꿨다는 것과 요청을 따랐다는 것이 같지 않다는
          사례이기도 합니다. 성향은 대체로 일관되지만 완전히 균일하지는 않습니다.
        </p>
        ...
        <p className="leading-7">
          요청을 가장 곧이곧대로 수행하는 모델도 있습니다. 물건 교체에서 유일하게 요구한 금속 각반을 만들어
          냈습니다. 그런데 마스크와 무관하게 얼굴을 다시 그려서, 얼굴이 프레임에 들어 있으면 정체성이 0.93까지
          떨어집니다. 인물이 없는 편집에만 쓸 수 있다는 뜻입니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 실패가 일곱 개 전부에서 같은 모양으로 나타났다는 점이 중요합니다. 모델 선택의 문제가 아니라
          디노이저라는 도구의 성질이라는 뜻이고, 그래서 다른 종류의 도구가 필요합니다. 그 이야기는 별도 글로
          다룹니다.
        </p>
