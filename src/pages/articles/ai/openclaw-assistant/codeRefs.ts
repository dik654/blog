    ...
    annotations: [
      {
        lines: [22, 30],
        color: "sky",
        note: "runEmbeddedPiAgent 시그니처 — 메시지, 세션, 도구, 프롬프트",
      },
      {
        lines: [31, 37],
        color: "emerald",
        note: "createAgentSession으로 세션 초기화",
      },
      {
        lines: [40, 54],
        color: "amber",
        note: "이벤트 루프 — text_delta, tool_execution 등 처리",
      },
    ],
  },
  ...
  "oc-model-auth": {
    ...
    annotations: [
      { lines: [25, 26], color: "sky", note: "profiles + cooldowns 맵" },
      {
        lines: [30, 40],
        color: "emerald",
        note: "getAvailableProfiles — 쿨다운 만료 시 자동 재활성화",
      },
      {
        lines: [43, 49],
        color: "amber",
        note: "resolveModel — 첫 번째 사용 가능한 프로파일 선택",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [36, 38],
        color: "sky",
        note: "handleMessage — 6단계 파이프라인 진입점",
      },
      { lines: [43, 45], color: "emerald", note: "접근 제어: DM vs 그룹 정책" },
      {
        lines: [48, 55],
        color: "amber",
        note: "세션 해석 + 에이전트 실행 (인-프로세스)",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [46, 52],
        color: "sky",
        note: "loadSkill — SKILL.md YAML frontmatter 파싱",
      },
      {
        lines: [55, 61],
        color: "emerald",
        note: "buildSkillPromptBlock — 시스템 프롬프트 XML 주입",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [37, 44],
        color: "sky",
        note: "ensureRuntime — Fail-closed: 런타임 없으면 에러",
      },
      {
        lines: [47, 50],
        color: "emerald",
        note: "needsSandbox — all/non-main/off 모드 판단",
      },
      {
        lines: [58, 67],
        color: "amber",
        note: "cleanup — 유휴/만료 컨테이너 자동 정리",
      },
    ],
  },
};
