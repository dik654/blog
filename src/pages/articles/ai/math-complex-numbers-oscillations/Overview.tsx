    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-8">
          이 글은 삼각함수나 복소수를 이미 안다고 가정하지 않습니다. 먼저 한 바퀴를 재는 radian을 정의하고, 단위원 위 점의 좌표가 sine과 cosine이라는 사실을 확인합니다. 그런 다음 <code>i²=-1</code>을 이용해 평면의 점을 하나의 복소수로 적고, Euler 공식이 지수와 회전을 연결하는 이유를 살펴봅니다. 벡터의 좌표와 길이가 낯설다면 <Link to="/cs/ai/math-vectors-inner-products">벡터·내적 글</Link>부터 읽으면 됩니다.
        </p>
      </div>
