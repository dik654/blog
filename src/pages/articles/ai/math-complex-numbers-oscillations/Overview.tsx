    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          소리의 진동, 파동, 계절성처럼 같은 패턴이 되풀이되는 현상에는 두 정보가 함께 필요합니다. 얼마나 큰지뿐 아니라 한 주기에서 지금 어디쯤 왔는지도 알아야 합니다. 실수 하나는 직선 위의 위치만 나타내지만, 복소수는 평면의 가로·세로 좌표를 한 값으로 묶기 때문에 크기와 회전 각도를 동시에 기록할 수 있습니다.
        </p>
