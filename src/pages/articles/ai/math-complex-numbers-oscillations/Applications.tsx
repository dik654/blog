  ...
  return (
    <section id="applications" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          다음 <Link to="/cs/ai/fft">DFT·FFT 글</Link>에서는 이 basis와 signal의 내적을 N개 frequency에 대해 계산합니다. 먼저 sampling rate와 frame length가 실제 Hz 좌표를 어떻게 정하는지 확인한 뒤, roots of unity의 대칭을 재사용해 O(N²) direct DFT를 O(N log N) 계산으로 바꾸는 Cooley–Tukey factorization으로 이어집니다.
        </p>
      </div>
    </section>
  );
