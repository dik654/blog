...
세션 저장:
  ...
  claude --fork-session: 세션 분기 (원본 유지)`}</code>
        ...
        <CitationBlock source="Claude Code 시스템 프롬프트 (공개)" citeKey={1} type="paper">
          <p className="italic text-foreground/80">"You are Claude Code, Anthropic's official CLI for Claude... You are an interactive agent that helps users with software engineering tasks. Use the instructions below and the tools available to you to assist the user."</p>
