    ...
    annotations: [
      {
        lines: [2, 11],
        color: "sky",
        note: "permissions — ask/deny 규칙, bypassMode 비활성화",
      },
      {
        lines: [12, 14],
        color: "emerald",
        note: "관리형 설정 잠금 — 사용자가 권한/훅 임의 변경 불가",
      },
      {
        lines: [16, 27],
        color: "amber",
        note: "sandbox 설정 — 네트워크 격리, 유닉스 소켓, 도메인 화이트리스트",
      },
    ],
    desc: `문제: 엔터프라이즈 환경에서 Claude Code의 도구 접근을 중앙에서 통제해야 합니다.
    ...
    annotations: [
      {
        lines: [96, 125],
        color: "sky",
        note: "_rule_matches — 도구 매처 확인 후 모든 조건 AND 평가",
      },
      {
        lines: [127, 142],
        color: "emerald",
        note: "_matches_tool — 와일드카드(*) 및 OR 패턴(Bash|Edit) 지원",
      },
    ],
    desc: `문제: 특정 도구에만 적용되는 규칙과 모든 도구에 적용되는 규칙을 유연하게 지원해야 합니다.
