    ...
    annotations: [
      {
        lines: [15, 21],
        color: "sky",
        note: "githubRequest — 제네릭 타입의 GitHub API 래퍼 함수",
      },
      {
        lines: [22, 32],
        color: "emerald",
        note: "fetch 호출 — Bearer 토큰 인증, JSON 바디 직렬화",
      },
      {
        lines: [34, 41],
        color: "amber",
        note: "응답 처리 — 404는 빈 객체 반환, 기타 오류는 예외 발생",
      },
    ],
    desc: `문제: Claude Code의 GitHub Actions 워크플로우에서 이슈를 자동으로 관리해야 합니다.
    ...
    annotations: [
      {
        lines: [45, 52],
        color: "sky",
        note: "markStale — 비활성 이슈 탐색 시작, 날짜 기준 계산",
      },
      {
        lines: [54, 60],
        color: "emerald",
        note: "페이지네이션 루프 — 최대 10페이지, 100개씩 조회",
      },
    ],
    desc: `문제: 수백 개의 GitHub 이슈 중 오래된 비활성 이슈를 자동으로 식별해야 합니다.
