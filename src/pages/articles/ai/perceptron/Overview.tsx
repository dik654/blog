  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p className="leading-7">
          이 구조는 생물학적 뉴런에서 영감을 받았습니다. 수상돌기로 받은 신호를 세포체가 모아 축삭으로 내보내는 모습을 입력에 weight를 적용해 합산하고 activation
          function으로 출력을 정하는 계산으로 단순화한 것입니다. 다만 이는 학습을 설명하기 위한 공학적 비유이며 실제 뉴런의 복잡한 동작을 그대로 재현한 모델은 아닙니다.
        </p>
      </div>
      <div className="mt-8">
        <PerceptronViz />
