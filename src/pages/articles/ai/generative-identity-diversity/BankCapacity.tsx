  ...
  return (
    <section id="bank-capacity" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          주입 세기가 연속 다이얼입니다. 낮으면 프롬프트의 의도가 유지되는 대신 결과들이 서로 비슷하고 높으면 정체성이 확실히 전이되는 대신 참조의 성별 같은 속성까지 따라옵니다. 세
          지표가 전부 단조로 움직입니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          뱅크 용량은 임계값을 어디에 두느냐에 따라 달라집니다. 얼굴 인식 임계에서는 열두 명 뱅크가 두 명분이지만 사람 눈으로 다른 캐릭터로 보이는 경계인 0.50 부근에서는 다섯
          명분입니다. 어느 쪽이든 혼합 기여는 0에 가깝고 용량은 전부 뱅크에서 나옵니다.
        </p>
