  ...
  return (
    <section id="diversity-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 수치는 한 장비에서 특정 모델 조합으로 얻은 것이며, 증류가
          다양성을 무너뜨린다는 결론도 한 모델 가족에서 한 번 잰 것입니다. 다른 가족에서 같은 대조를 돌려
          보지 않았으므로 증류 일반에 대한 주장으로 읽으면 안 됩니다.
        </p>

        <p className="leading-7">
          그리고 눈과 계측기가 갈리는 지점도 남아 있습니다. 스타일이 바뀌는 변환에서는 계측기가 눈보다
          관대해서, 얼굴형만 유지되면 질감과 나이가 크게 달라져도 유사도가 버팁니다. 이 부분은 미해결로
          둡니다.
        </p>
