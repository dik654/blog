    ...
    <section id="parsing" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          ...
          XSD, Relax NG 또는 application schema를 선택할 수도 있으므로, 계약에서 어느 판정을
          뜻하는지 명시합니다.
        </p>
        <p>
          둘째, domain validation은 값이 실제 업무 세계에서 가능한지 확인합니다.
          <code>&lt;refund&gt;&lt;amount&gt;-100&lt;/amount&gt;&lt;/refund&gt;</code>는
          well-formed이고 schema가 signed integer를 허용하면 schema-valid일 수도 있습니다.
        ...
        <p>
          ...
          판정합니다. 구조와 금액이 모두 정상이어도 사용자가 환불을 승인할 권한이 없으면
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          ...
          권한을 검증하지 않으므로 뒤쪽 validator는 그대로 필요합니다.
        </p>
        ...
        <p>
          ...
          local file이나 URL을 읽도록 만들 수 있습니다. 그 결과 file disclosure, SSRF와 denial
