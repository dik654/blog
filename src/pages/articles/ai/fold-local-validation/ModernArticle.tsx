...
\end{aligned}`}
      ...
      <section id="manifest" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert"><p>
            OOF row에는 row ID·fold ID·train-row manifest hash를 연결합니다. 여기에 transform revision·fitted-state
            checksum·model checkpoint·prediction까지 함께 답니다. 후보 선택이 끝나면 같은 recipe를 전체 training data에 다시 fit하되
            final holdout은 계속 닫아 둡니다.
          </p></div>
      </section>
      <section id="boundary" className="scroll-mt-20">
        <h2 className="mb-5 text-2xl font-bold">External pretrained transform도 source와 overlap을 기록합니다</h2>
        <div className="prose prose-neutral max-w-none dark:prose-invert"><p>
            공개 corpus에서 미리 학습한 tokenizer나 embedding은 fold마다 다시 fit하지 않을 수 있습니다. 대신 source
            revision·목적·evaluation entity와의 overlap을 기록해야 외부 정보 사용 범위를 판단할 수 있습니다.
          </p></div>
