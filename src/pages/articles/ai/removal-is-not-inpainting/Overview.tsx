  ...
  return (
    <section id="overview" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글은 그 결론에 도달하기까지 디퓨전에 최대한 유리한 조건을 준 과정과, 답이 왜 다른 종류의 모델이었는지,
          그리고 그 모델을 도구로 만들 때 프롬프트를 받지 않게 설계한 이유를 다룹니다. 마지막으로 가장 그럴듯해
          보였던 2단계 조합이 왜 기각됐는지까지입니다.
        </p>

        <ContentBoundary article="removal-is-not-inpainting" />

        <p className="leading-7">
          판정 근거를 먼저 밝혀 둡니다. 이 회차에는 자동 판정기가 없습니다. 시도한 계측기 둘이 각자의 대조군에서
          실패했기 때문입니다. 그래서 성공 판단은 네 그림체 대조표를 눈으로 본 것과 마스크 밖 변화량 두 가지에
          기대고 있고, "몇 퍼센트에서 실패하는가" 같은 정량 주장은 하지 않습니다.
        </p>
