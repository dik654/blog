  ...
  return (
    <section id="two-stage-rejected" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          왜 막지 못했는지도 분명합니다. 이 방식은 어디를 바꿀지는 강제하지만 무엇을 그릴지는 강제하지
          않습니다. 경계 띠에서 시작한 생성이 안쪽으로 번질 여지가 남아 있었고, 그 여지를 사전지식이 채웠습니다.
        </p>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그대로 됐습니다. 이 절차가 없었다면 "경계 띠 게이트가 마스크 밖 변화를 줄였다"는 그럴듯한 결론을
          쓸 수도 있었습니다. 실제로 바닥값을 차감하면 다시 그리기가 마스크 밖으로 새는 양은 0.04에서 0.33으로
          사실상 0이라, 그 방향으로 읽을 근거가 숫자에는 있었습니다.
        </p>

        <p className="leading-7">
          결론은 열두 칸 전부에서 전용 망 단독보다 나은 칸이 없다는 것입니다. 더 좋아지지 않으면서 시간은
          두 배에서 여덟 배가 되고, 한 칸에서는 지운 물건이 돌아왔습니다.
        </p>
