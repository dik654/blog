  ...
  return (
    <section id="propagation" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 마스크 밖 수치가 다른 모델들의 것과 성격이 다르다는 점도 짚어 둡니다. 이 모델의 계산 그래프에는 오토인코더가 없습니다. 합성곱이 픽셀을 직접 내놓으므로 압축·복원 왕복이
          없습니다. 따라서 바닥값이 0입니다. 차감할 것이 없는 진짜 값입니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          255에서 115.66이 됩니다. 프레임 전체가 천 텍스처로 뒤덮입니다. 점진적 악화가 아니라 경계 버그입니다. 254와 255 사이에 중간이 없습니다.
        </p>

        <p className="leading-7">
          그래서 도구가 254로 자릅니다. 에러로 거절하지 않고 잘라 내는 쪽을 택한 이유가 있습니다. 허용된 범위 안의 값을 넣었는데 거절당하는 것보다 "가능한 가장 강한 지우기"를 받는
          편이 호출하는 쪽의 기대와 맞기 때문입니다.
        </p>
