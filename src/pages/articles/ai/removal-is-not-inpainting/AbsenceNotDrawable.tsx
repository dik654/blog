  ...
  return (
    <section id="absence-not-drawable" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          그래도 흰 띠를 그렸습니다. 네 그림체 전부에서입니다. 마스크 안 변화량은 44.9에서 93.7까지 크게
          나오는데, 그 큰 값이 "많이 지웠다"가 아니라 "다른 띠를 크게 그렸다"였습니다.
        </p>

        <p className="leading-7">
          이 시점에서 결론은 "더 나은 디퓨전 모델"이 아니라 다른 종류의 모델이라는 쪽으로 굳었습니다.
          디노이저는 노이즈에서 무언가를 만들어 내도록 학습된 도구이고, 없음은 만들어 낼 수 있는 대상이
          아닙니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        <p className="leading-7">
          나중에 이 실험의 네거티브가 애초에 꺼져 있었다는 것을 알았습니다. 샘플러의 안내 계수가 1.0이었기
          때문입니다. 이 값에서는 조건부 예측과 무조건부 예측을 섞는 식이 조건부 예측 그 자체로 줄어들어,
          네거티브 프롬프트가 계산에서 통째로 빠집니다.
        </p>

        <p className="leading-7">
          숨기지 않고 통제 실패로 기록합니다. 다만 결론은 바뀌지 않습니다. 네거티브가 살아 있었던 다른
          회차에서도 일곱 모델이 같은 방식으로 실패했고, 무엇보다 배경을 설명하는 양의 프롬프트는 정상적으로
          들어갔는데도 띠가 그려졌습니다.
        </p>
      </div>
