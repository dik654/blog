  ...
  return (
    <section id="separation-gate" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          세 번째로 후면 뷰의 원인 진단도 틀렸습니다. 정체성 주입의 편향으로 봤는데, 주입을 꺼도 같은 결과가
          나왔고 실제 원인은 방향을 표현할 신호가 그 실행에 하나도 없었던 것이었습니다.
        </p>
      </div>
      ...
      <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          이 글이 주장하지 않는 것도 적어 둡니다. 세기와 적용 구간의 구체 값은 이 모델 조합에서 얻은 것이며
          다른 조합에서 그대로 쓸 수 없습니다. 그리고 여기서 성립한 네 각도는 한 인물·한 의상에서의 결과라
          다른 소재에서 같은 값이 나온다는 뜻이 아닙니다.
        </p>
