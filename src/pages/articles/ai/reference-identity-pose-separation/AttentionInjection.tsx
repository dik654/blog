    ...
    <section id="attention-injection" className="scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p className="text-lg leading-8">
          다른 경로가 있습니다. 참조 얼굴에서 정체성 벡터만 뽑아 어텐션 계산에 끼워 넣는 방식입니다. 참조
          픽셀 자체는 생성에 들어가지 않고, 샘플링은 빈 잠재에서 완전한 노이즈로 시작합니다.
        </p>

        <p className="leading-7">
          이 차이가 실제로 중요합니다. 픽셀이 남아 있었다면 인종과 성별과 나이가 함께 끌려옵니다. 벡터만
          넣으면 그렇지 않아서, 한 인구통계의 참조에서 다른 인구통계의 인물이 나올 수 있습니다. 골격은
          따라오는데 표현은 프롬프트가 정합니다.
        </p>
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p className="leading-7">
          다만 늦게 켤수록 정체성은 약해집니다. 0.5 지점에서는 회전이 71.9도인데 정체성이 0.100으로 무너집니다.
          그래서 이 손잡이만으로는 답이 아니고, 세기를 낮추는 쪽이 두 지표 모두에서 더 좋았습니다.
        </p>
      </div>
      ...
      <div className="mt-6">
        ...
        >
          ...
          <p className="leading-7">
            늦게 켜는 쪽은 0.3 지점에서 회전 62.7도에 정체성 0.376으로, 회전은 더 크지만 정체성이 조금
            낮습니다. 0.5 지점은 회전이 가장 크지만 정체성이 쓸 수 없는 수준입니다.
          </p>
          <p className="leading-7">
