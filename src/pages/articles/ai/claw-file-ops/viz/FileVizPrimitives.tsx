...
export function FileFrame({
  ...
  return (
    <figure data-viz="file-operation-flow" className="my-10 overflow-hidden rounded-xl border border-border/70 bg-card">
...
export function FileRule({ children }: { children: ReactNode }) {
  return (
