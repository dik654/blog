    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p>따라서 transform 이름부터 고르지 않습니다. 먼저 무엇이 달라질 수 있는지, 무엇은 반드시 같아야 하는지, target을 그대로 둘지 함께 바꿀지를 차례로 적습니다.</p>
        </div>
      ...
      <section id="target-map" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p>Classification label은 그대로일 수 있지만 detection box와 segmentation mask는 그렇지 않습니다. Random angle을 image와 annotation에서 따로 뽑으면 눈으로는 그럴듯해도 정답이 어긋난 pair가 됩니다. Receipt에는 source ID, transform revision, sampled parameter, target-map revision을 함께 둡니다.</p>
        </div>
      </section>
      ...
      <section id="objective" className="scroll-mt-20">
        ...
        <ExplainedFormula
          ...
          idea={<p>Policy에서 parameter ω를 뽑고, 같은 ω로 input과 target을 바꾼 뒤 loss를 계산합니다. 마지막에 sample과 transform randomness를 평균합니다.</p>}
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert"><p>변환 전후 target이 달라지는 fixture, annotation이 어긋나는 fixture, validation sample을 source로 사용한 fixture를 먼저 실패시킵니다. 그 뒤에만 transform strength와 probability를 tuning합니다.</p></div>
