    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 실제 시장에서는 값이 먼저 있고 식이 나중입니다. 사람들이 사고팔면서 가격이 정해지고 그 가격을 식에 거꾸로 넣어 &ldquo;이 가격이 되려면 할인율이 얼마여야
            하는가&rdquo;를 되묻습니다. 그 되물은 값이 수익률입니다.
          </p>

          <p className="leading-7">
            그래서 가격과 수익률은 서로 다른 두 정보가 아니라 같은 정보의 두 표현입니다. 한쪽이 정해지면 다른 쪽이 따라 정해지고 분모에 들어가 있으니 방향은 반대가 됩니다. 채권
            이야기가 늘 &ldquo;금리가 오르면 채권값이 떨어진다&rdquo;로 시작하는 이유입니다.
          </p>
        </div>
      ...
      <section id="ytm" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            다른 점은 하나 있습니다. 채권의 현금흐름은 처음에 한 번 나가고 그 뒤로는 계속 들어오는 모양이라 부호가 한 번만 바뀝니다. 2편에서 해가 여러 개 나올 수 있다고 경고했던
            조건이 여기서는 성립하지 않으므로 만기수익률은 하나로 정해집니다.
          </p>
        </div>
        ...
        <div id="ytm-assumption" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              현실에서 금리는 움직입니다. 받은 이자를 더 낮은 금리로 굴리면 실현 수익률은 만기수익률보다 낮아지고 더 높은 금리로 굴리면 높아집니다. 만기까지 들고 있어도 결과가
              달라집니다.
            </p>

            <p className="leading-7">
              그래서 만기수익률은 예측값이 아니라 비교를 위한 공통 척도로 쓰입니다. 만기와 표면금리가 제각각인 채권을 한 숫자로 줄 세우는 데 이 값의 쓸모가 있습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="duration" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이제 첫 질문에 답할 차례입니다. 금리가 1%포인트 오를 때 가격이 0.9% 떨어지는 채권이 있고 18% 떨어지는 채권이 있습니다. 차이는 돈이 언제 들어오느냐에서 생깁니다.
            늦게 들어올수록 할인의 영향을 더 오래 받기 때문입니다.
          </p>
          ...
          <p className="leading-7">
            이 값이 유용한 것은 가격 민감도와 직접 연결되기 때문입니다. 듀레이션을 살짝 고쳐 쓴 값이 곧 &ldquo;금리 1%포인트당 가격 변화 율&rdquo;이 됩니다. 그래서
            채권을 고르는 일이 만기를 고르는 일이 아니라 듀레이션을 고르는 일이 됩니다.
          </p>
        </div>
        ...
        <div id="duration-use" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              만기가 10년으로 같아도 표면금리가 높은 채권은 이자를 앞쪽에서 많이 받으므로 무게중심이 앞당겨집니다. 극단적으로 이자를 전혀 주지 않는 채권은 모든 돈이 만기에 한 번
              들어오므로 듀레이션이 만기와 같아지고 금리 변화에 가장 크게 흔들립니다.
            </p>
          </div>
      ...
      <section id="yield-curve" className="scroll-mt-20">
        ...
        <div id="curve-shapes" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              보통은 만기가 길수록 금리가 높아 곡선이 우상향합니다. 기다리는 데 대한 보상이 붙기 때문입니다. 그런데 가끔 짧은 쪽이 긴 쪽보다 높아져 곡선이 뒤집힙니다. 기대 가설로
              읽으면 앞으로 단기금리가 내려갈 것으로 시장이 본다는 뜻입니다.
            </p>

            <p className="leading-7">
              이 신호를 해석할 때는 조심해야 합니다. 곡선은 기대 평균과 기간 프리미엄의 합이므로 뒤집힘이 기대 때문인지 프리미엄 때문인지 곡선만 보고는 가를 수 없습니다. 프리미엄은
              관측값이 아니라 추정값이기 때문입니다.
            </p>
          </div>
          ...
          >
            <p className="leading-7">
              시장에서 관측되는 만기수익률은 여러 시점의 현금흐름을 하나의 숫자로 뭉갠 값입니다. 만기가 같아도 표면금리가 다르면 무게중심이 달라 만기수익률도 조금씩 다릅니다. 곡선을
              그대로 할인율로 쓰면 미세한 오차가 생깁니다.
            </p>
            <p className="leading-7">
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이 글은 내내 &ldquo;약속된 금액이 그대로 들어온다&rdquo;고 두었습니다. 국채처럼 발행자가 자국 통화로 빌린 경우에는 이 가정이 비교적 잘 맞지만 회사채는 갚지 못할
            가능성이 있어 같은 만기라도 금리가 더 높습니다. 그 차이가 신용 스프레드입니다.
          </p>

          <p className="leading-7">
            더 큰 문제는 현금흐름이 아예 적혀 있지 않은 청구권입니다. 주식에는 표면금리도 만기도 없고 회사가 벌어들인 것 중 채권자에게 주고 남은 것을 가질 뿐입니다. 그런데도 값이
            매겨집니다.
          </p>
