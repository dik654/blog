    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            회사가 벌어들인 돈은 정해진 순서로 나갑니다. 거래처와 직원, 세금,
            그다음 채권자의 이자와 원금, 우선주, 마지막이 보통주 주주입니다.
            앞 순위가 다 받고 남은 것이 주주 몫이고, 남지 않으면 아무것도 받지
            못합니다.
          </p>
          ...
          <p className="leading-7">
            불확실해지는 것은 분자만이 아닙니다. 마지막 순위라는 위치 때문에
            같은 회사의 실적 변화가 주주 몫에서는 더 크게 흔들리고, 그만큼 더
            높은 보상을 요구하게 되어 분모도 커집니다. 분자와 분모가 함께
            흔들리는 것이 주식 가치평가의 본질적인 어려움입니다.
          </p>
        </div>
      ...
      <section id="residual-claim" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            두 성질이 합쳐지면 독특한 모양이 나옵니다. 회사 가치가 부채보다
            작으면 주주 몫은 0에서 더 내려가지 않고, 부채를 넘어서면 넘어선
            만큼 전부 주주 몫이 됩니다. 아래는 막혀 있고 위는 열려 있는 비대칭
            구조입니다.
          </p>
      ...
      <section id="leverage" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            자산 100억 원으로 연 8억 원을 버는 회사가 있습니다. 전부 자기
            돈이면 주주 수익률은 8%입니다. 그런데 50억을 연 5%에 빌려 썼다면
            이자 2.5억을 빼고 5.5억이 남고, 주주가 넣은 50억 대비 11%가 됩니다.
            같은 사업인데 주주 수익률이 올랐습니다.
          </p>
        ...
        <div id="structure-neutrality" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              1958년의 한 논문이 이 상쇄를 엄밀하게 보였습니다. 일정한 조건
              아래에서는 회사를 어떤 비율로 조달하든 전체 가치가 같다는
              것입니다. 투자자가 스스로 돈을 빌리거나 빌려줄 수 있으므로,
              회사가 대신 해 주는 것에 웃돈을 낼 이유가 없다는 논리입니다.
            </p>

            <p className="leading-7">
              이 결과가 말해 주는 것은 &ldquo;자본구조가 중요하지 않다&rdquo;가
              아닙니다. 오히려 반대입니다. 현실에서 자본구조가 가치를 바꾼다면
              그것은 이 논문이 배제한 것들, 곧 세금과 파산 비용과 정보 비대칭
              때문이라는 뜻이고, 그래서 그 요인들을 따로 봐야 한다는 안내입니다.
            </p>
          </div>
      ...
      <section id="ddm" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            할인 식 자체는 달라지지 않습니다. 주주가 받을 현금을 시점마다 적고
            할인해 더하면 됩니다. 문제는 그 현금흐름이 끝이 없다는 것입니다.
            회사는 만기가 없으므로 배당은 원칙적으로 영원히 이어집니다.
          </p>

          <p className="leading-7">
            무한히 더할 수는 없으니 모양을 가정합니다. 가장 단순한 가정은 배당이
            매년 일정한 비율로 늘어난다는 것입니다. 그러면 2편에서 본 등비급수가
            되어 무한한 합이 짧은 식 하나로 닫힙니다.
          </p>

          <p className="leading-7">
            닫힌 식은 편하지만 위험합니다. 분모가 &ldquo;요구 수익률 빼기 성장
            률&rdquo;이라는 작은 수라서, 두 숫자 중 하나만 조금 바꿔도 결과가
            크게 달라지기 때문입니다. 이 민감도가 주식 가치평가를 어렵게 만드는
            실질적인 이유입니다.
          </p>
        </div>
      ...
      <section id="multiples" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 방법이 가정을 없애는 것은 아닙니다. 비교 대상이 제대로 평가되어
            있다는 가정을 대신 깔 뿐입니다. 시장 전체가 비싸면 배수도 비싸고,
            그 배수를 가져다 쓰면 비싼 값이 그대로 옮겨 옵니다.
          </p>
        ...
        <div id="multiple-traps" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              배수는 단순해 보이지만 분자와 분모가 같은 대상을 가리키지 않으면
              비교가 무너집니다. 주가는 주주 몫만 반영하는데 이익은 채권자 몫을
              떼기 전 값일 수 있고, 그러면 빚이 많은 회사가 자동으로 싸 보입니다.
            </p>
          </div>
          ...
          >
            <p className="leading-7">
              주가는 주주에게 귀속되는 값이므로 짝이 되는 이익도 이자를 다 뺀
              뒤의 순이익이어야 합니다. 반대로 회사 전체의 가치를 보고 싶다면
              분자에 주식 시가총액과 순부채를 더한 값을 놓고, 분모에는 이자를
              떼기 전의 영업 성과를 놓아야 합니다.
            </p>
            <p className="leading-7">
              둘을 섞으면 자본구조가 다른 회사들의 순위가 뒤집힙니다. 빚이 많은
              회사는 주주 몫이 작아져 분자가 작아지는데 분모로 이자 차감 전
              이익을 쓰면 배수가 낮게 나옵니다. 싸 보이는 이유가 사업이 아니라
              조달 구조인 것입니다.
            </p>
            <p className="leading-7">
              시점도 맞춰야 합니다. 지난 1년 실적으로 계산한 배수와 앞으로 1년
              예상으로 계산한 배수는 다른 숫자이며, 성장하는 회사일수록 차이가
              큽니다. 두 기준을 섞어 비교하면 성장률이 높은 회사가 비싸 보이는
              착시가 생깁니다.
            </p>
          </ProgressiveDetail>
        </div>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여기서 중요한 사실이 하나 있습니다. 모든 위험에 보상이 붙는 것은
            아니라는 점입니다. 여러 주식에 나눠 담으면 사라지는 위험이 있고,
            아무리 나눠도 남는 위험이 있습니다. 보상은 남는 쪽에만 붙습니다.
          </p>
