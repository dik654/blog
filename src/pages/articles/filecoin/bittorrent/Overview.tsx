  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          파일은 piece로 분할되고 메타정보에는 각 piece를 검증할 해시가 담긴다.
          클라이언트는 서로 다른 피어에게서 조각을 병렬로 받은 뒤 해시를
          확인하므로, 전송한 피어를 신뢰하지 않아도 손상 여부를 알아낼 수 있다.
          piece 크기와 메타정보 형식은 torrent 포맷 버전에 따라 달라질 수 있다.
        </p>
      </div>
    </section>
  );
