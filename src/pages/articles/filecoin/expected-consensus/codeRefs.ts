    ...
    annotations: [
      {
        lines: [114, 117],
        color: "sky",
        note: "blockSanityChecks — 기본 형식 검사",
      },
      {
        lines: [121, 131],
        color: "emerald",
        note: "부모 TipSet + Lookback TipSet 로드",
      },
      {
        lines: [140, 155],
        color: "amber",
        note: "높이 연속성 + 미래 블록 거부 (MaxHeightDrift=5)",
      },
    ],
  },
  "ec-winner": {
    ...
    annotations: [
      {
        lines: [180, 192],
        color: "sky",
        note: "WinCount 최소 1 + 마이너 자격 확인",
      },
      {
        lines: [194, 210],
        color: "emerald",
        note: "Beacon → DomainSeparation → VRF 검증",
      },
      {
        lines: [221, 232],
        color: "amber",
        note: "ComputeWinCount 재계산 → 헤더 값과 대조",
      },
    ],
  },
  "ec-async": {
    ...
    annotations: [
      {
        lines: [157, 162],
        color: "sky",
        note: "minerCheck — 최소 파워 + 자격",
      },
      {
        lines: [234, 240],
        color: "emerald",
        note: "blockSigCheck — BLS 서명 검증",
      },
    ...
    annotations: [
      {
        lines: [22, 28],
        color: "sky",
        note: "부모 가중치 상속: ts.ParentWeight()",
      },
      {
        lines: [58, 66],
        color: "emerald",
        note: "log₂P = BitLen()-1 → ×2⁸ 스케일링",
      },
      {
        lines: [70, 82],
        color: "amber",
        note: "WinCount 보너스: log₂P × wRatio × totalJ",
      },
    ],
  },
  "ec-create": {
