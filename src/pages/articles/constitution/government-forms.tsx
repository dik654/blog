    ...
    <div className="space-y-16">
      ...
      <section id="two-axes" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 하나가 왜 그렇게 큰지는 앞 글의 계산으로 설명됩니다. 생존이 분리되면 행정부와 의회가 각각 독립된 거부권자가 되고 둘의 선호가 갈리는 순간 통과 가능 영역이 좁아지거나
            비게 됩니다. 그런데 비어도 둘 다 자리에 남습니다. 교착이 해소되지 않은 채로 유지된다는 뜻입니다.
          </p>

          <p className="leading-7">
            생존이 매여 있으면 같은 상황이 다르게 끝납니다. 과반이 반대하면 행정부가 교체되므로 행정부와 의회 과반의 선호가 갈린 상태 자체가 오래 유지되지 않습니다. 거부권자 둘이
            싸우는 대신 하나가 사라집니다.
          </p>
      ...
      <section id="presidential" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            대가는 세 가지로 나옵니다. 첫째는 정통성이 둘이 된다는 것입니다. 대통령도 국민이 뽑았고 의회도 국민이 뽑았으므로 둘의 뜻이 갈릴 때 누가 국민을 대변하는지 가릴 기준이 체계
            안에 없습니다. 헌법이 정할 수 있는 것은 권한의 경계이지 누구의 주장이 더 정당한가가 아닙니다.
          </p>
          ...
          <p className="leading-7">
            셋째는 승자독식입니다. 한 자리를 두고 겨루므로 2등은 아무것도 얻지 못합니다. 의석은 득표에 비례해 나눌 수 있지만 대통령직은 나눌 수 없습니다. 그래서 선거의 판돈이 커지고
            진 쪽이 다음 기회까지 기다리는 비용도 커집니다.
          </p>
        </div>
        ...
        <div id="deadlock-exit" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              그래서 대통령제에서 교착의 출구는 구조적으로 헌법적 위기의 모양을 띠게 됩니다. 일상적 조정 수단이 없는 자리에 비상 수단만 놓여 있으니 조정이 필요할 때마다 비상 수단이
              호출됩니다. 이것이 대통령제에서 탄핵 논의가 자주 등장하는 제도적 이유입니다.
            </p>

            <p className="leading-7">
              한국 헌법은 대통령제 골격에 의회 쪽 장치를 몇 개 덧대 이 문제를 완화하려 합니다. 국무총리는 국회의 동의를 받아야 임명되고 국회는 국무총리와 국무위원의 해임을 대통령에게
              건의할 수 있습니다. 다만 해임건의는 구속력이 없고 대통령 자신의 자리에도 닿지 않으므로 위의 구조 자체를 바꾸지는 못합니다.
            </p>
          </div>
      ...
      <section id="parliamentary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            여기서 나오는 것이 유연성입니다. 실패한 내각은 임기를 기다리지 않고 교체되고 상황이 크게 바뀌면 해산과 총선으로 위임 자체를 새로 받을 수 있습니다. 앞 절에서 비상
            수단이었던 일이 여기서는 일상 절차입니다.
          </p>

          <p className="leading-7">
            대가도 분명합니다. 정부가 언제든 무너질 수 있으므로 계획의 시야가 짧아지고 단독 과반이 없으면 여러 당이 손을 잡아야 합니다. 연립은 정부를 세우지만 동시에 정부 안에
            거부권자를 새로 만듭니다. 앞 글의 교집합 계산이 이번에는 내각 안에서 돌아갑니다.
          </p>
        ...
        >
          <p className="leading-7">
            의원내각제에서 내각이 바뀌는 것은 설계된 동작입니다. 신임이 사라진 정부를 임기 때문에 붙잡아 두지 않겠다는 선택의 결과이므로 교체 빈도가 높다는 사실 자체는 체제가 흔들린다는
            뜻이 아닙니다.
          </p>
          <p className="leading-7">
      ...
      <section id="semi-presidential" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            두 체계의 장점을 같이 갖고 싶다는 생각은 자연스럽습니다. 직선 대통령이 주는 안정과 명확한 위임을 두고 동시에 의회 신임에 매인 총리를 두어 교착의 출구도 확보하자는
            것입니다.
          </p>
          ...
          <p className="leading-7">
            갈리는 순간 새 문제가 나옵니다. 의회 과반이 대통령의 반대편이면 총리도 반대편에서 나오고 하나의 행정부 안에 서로 다른 위임을 받은 두 사람이 앉습니다. 앞 절의 이중
            정통성이 기관 사이가 아니라 행정부 내부로 들어온 것입니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그 위험이 실제로 터지는지는 다른 조건들이 정합니다. 대통령의 정당이 의회 과반을 잡으면 이중 정통성 문제는 임기 내내 드러나지 않고 두 당만 있고 한쪽이 늘 과반이면 연립
            협상은 아예 필요 없습니다. 같은 헌법이 의석 분포에 따라 전혀 다르게 굴러갑니다.
          </p>

          <p className="leading-7">
            그러면 그 의석 분포는 어디서 오는지가 다음 질문이 됩니다. 앞 두 절에서 의석은 계속 주어진 것으로 두고 계산만 했지만 같은 득표가 제도에 따라 전혀 다른 의석이 되는 과정이
            실은 앞에 있습니다.
          </p>
