  ...
  return (
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            앞 글은 불편한 곳에서 끝났습니다. 통치가 유지되는 조건은 폭정에서도
            똑같이 성립하고, 지배자의 이익과 사회의 이익이 겹치는 구간은
            조건부라는 것이었습니다. 그래서 다음 질문이 나왔습니다. 선의나
            계산에 기대지 않고 미리 묶어 둘 수 있는가입니다.
          </p>

          <p className="leading-7">
            헌법이 그 답이라고들 합니다. 그런데 여기서 바로 이상한 점이
            드러납니다. 헌법은 종이에 적힌 글자이고, 그것을 어길 수 있는 힘은
            정작 묶이는 쪽이 쥐고 있습니다. 군대와 경찰을 가진 쪽이 문서 한 장
            때문에 물러설 이유가 무엇일까요.
          </p>

          <p className="leading-7">
            이 질문을 건너뛰면 헌법 이야기가 전부 당위가 됩니다. 그래서 이 글은
            거기서 시작합니다. 종이가 실제로 힘을 묶는 경로를 먼저 세우고, 그
            위에서 나누기·견제·굳히기 세 장치가 각각 무엇을 막는지 봅니다.
          </p>
        </div>
      ...
      <section id="why-paper-binds" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            앞 글에서 통치가 순응 위에 선다는 것을 봤습니다. 뒤집으면 순응이
            한꺼번에 무너지면 통치도 무너진다는 뜻입니다. 그런데 사람들이 한꺼번에
            움직이려면 조건이 하나 필요합니다. 지금이 나설 때라는 것을 서로
            알아야 한다는 것입니다.
          </p>
          ...
          <p className="leading-7">
            그래서 지배자가 물러서는 이유는 문서를 존중해서가 아닙니다. 선을
            넘으면 흩어져 있던 저항이 한꺼번에 조직될 위험이 커지기 때문입니다.
            헌법의 구속력은 종이 자체가 아니라, 그 종이가 만들어 내는 조정
            효과에서 나옵니다.
          </p>

          <p className="leading-7">
            이 설명은 한 가지를 함께 예측합니다. 선이 모호하면 구속력이
            약해진다는 것입니다. 무엇이 위반인지 사람마다 다르게 읽히면 같은
            시점에 같은 판단이 모이지 않고, 그러면 선을 넘어도 큰일이 생기지
            않습니다.
          </p>
        </div>
      ...
      <section id="separation" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            나누는 것만으로도 얻는 것이 있습니다. 하나를 장악해도 나머지를 통해
            제동이 걸리므로, 권력을 남용하려면 여러 기관을 동시에 장악해야
            합니다. 비용이 올라가고 그 과정이 눈에 띄므로 앞 절의 신호가 켜질
            시간이 생깁니다.
          </p>
        </div>
      ...
      <section id="checks" className="scroll-mt-20">
        ...
        <div id="judicial-review" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              이 긴장을 푸는 흔한 답은 층을 나누는 것입니다. 지금의 다수가 정한
              것을 뒤집는 근거가 더 앞선 시점의 더 큰 합의, 곧 헌법이라는
              설명입니다. 심사 기관은 자기 뜻을 관철하는 것이 아니라 그 합의를
              대신 읽는 자리라는 것입니다.
            </p>

            <p className="leading-7">
              이 답이 성립하려면 조건이 있습니다. 헌법의 선이 읽는 사람에 따라
              크게 달라지지 않아야 한다는 것입니다. 해석의 폭이 넓어질수록 그
              기관은 합의를 읽는 자리가 아니라 스스로 정하는 자리에 가까워지고,
              1절의 신호도 함께 흐려집니다.
            </p>
          </div>
        </div>
      ...
      <section id="entrenchment" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 장치가 필요한 이유는 분명합니다. 바꾸기 쉬우면 힘을 쥔 쪽이 제약을
            먼저 없애고 나서 원하는 것을 하면 됩니다. 문턱을 높이면 그 우회로가
            막히고, 1절의 선이 실제로 선 역할을 하게 됩니다.
          </p>

          <p className="leading-7">
            대가는 앞 절의 계산 그대로입니다. 문턱이 높다는 것은 거부권자가 많다는
            뜻이고, 그만큼 통과 가능 영역이 좁아집니다. 정말 고쳐야 할 것도 고칠
            수 없게 되며, 그 압력이 개정이 아니라 해석의 변경이나 조문 무시로
            빠져나가기도 합니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            문턱이 낮으면 헌법이 일반 법률과 다를 바 없어집니다. 힘을 쥔 쪽이
            제약을 먼저 고치고 나서 원하는 것을 하면 되므로, 1절에서 말한 선이
            선 역할을 하지 못합니다.
          </p>
          <p className="leading-7">
            문턱이 너무 높으면 반대 방향의 문제가 생깁니다. 사회가 크게 바뀌어
            조문이 현실과 어긋나도 고칠 수 없고, 그러면 실제 운용이 조문과
            따로 놀기 시작합니다. 조문을 지키지 않는 것이 관행이 되면 다른
            조문의 구속력도 함께 약해집니다.
          </p>
          <p className="leading-7">
