...
const STEPS = [
  {
    label: "MNPI 발생원: 누가 정보를 가지는가",
    body: "VASP 임직원, 대리인, 주요주주, 계약 상대방이 1차 정보 보유자. 여기서 정보가 외부로 유출되면 2차, 3차 수령자까지 규제 대상.",
  },
  {
    label: "정보 전달 경로와 규제 범위",
    body: '정보 보유자 → 가족/지인 → 제3자까지 연쇄적으로 규제. "나는 직접 거래하지 않았다"는 변명 불가. 타인에게 이용하게 하는 것 자체가 위반.',
  },
  {
    label: "정보 공개 후 거래 허용 시점",
    body: "신문 게재 → 다음날 0시+6h. 전자매체 → 게재+6h. 홈페이지 → 공개+24h. 시장 반영 시간 보장이 목적.",
  },
];
        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                모든 1차 보유자의 거래 금지 + 정보 수령자(2차, 3차)까지 확대
                적용
              </text>
              <text
                x={240}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.danger}
              >
                "직접 거래하지 않았다"는 변명 불가 -- 이용하게 하는 것 자체가
                금지
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={280} y={50} fontSize={9} fill={C.source}>
                다음날 0시 + 6시간
              </text>
              ...
              <text x={280} y={100} fontSize={9} fill={C.flow}>
                게재 시점 + 6시간
              </text>
              ...
              <text x={280} y={150} fontSize={9} fill={C.trade}>
                공개 시점 + 24시간
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                홈페이지가 24시간인 이유: 언론보다 접근 빈도 낮아 시장 전파에 더
                오래 걸림
              </text>
            </motion.g>
          )}
