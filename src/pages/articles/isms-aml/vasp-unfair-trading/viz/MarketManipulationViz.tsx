...
const STEPS = [
  {
    label: "스푸핑(Spoofing) -- 허수 주문",
    body: "체결 의사 없는 대량 주문 → 시장 반응 유도 → 즉시 취소 → 올라간 가격에 매도. 주문 생존 시간이 수초 이내면 탐지 대상.",
  },
  {
    label: "워시 트레이딩 -- 자기 자신과 거래",
    body: "동일인 또는 공모자가 매수·매도를 동시 실행하여 거래량 부풀리기. 목적: 거래량 위장(순위 조작) + 원하는 가격 설정.",
  },
  {
    label: "펌프 앤 덤프 -- 유포 후 매도",
    body: "① 저가 매집 → ② 허위 호재 유포(텔레그램·SNS) → ③ FOMO 매수 쏠림 → ④ 고점 대량 매도. 가장 빈번하고 피해가 큰 유형.",
  },
  {
    label: "부정거래 -- 허위·기망적 수단",
    body: '허위 시세 표시, 가짜 파트너십·감사 보고서, 허위 유동성 표시. 시세조종이 "가격을 움직이는 것"이면, 부정거래는 "사람을 속이는 것".',
  },
  {
    label: "자기발행 가상자산 거래 제한",
    body: "VASP·특수관계인이 발행한 가상자산의 매매 중개 금지. 가격 정보 + 상폐 권한 + 유동성 통제를 모두 보유하면 이해상충이 극단적.",
  },
];
        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                탐지: 주문 생존 시간 수초 이내 + 반복적 주문-취소 패턴
              </text>
              <text
                x={240}
                y={198}
                ...
                fill="var(--muted-foreground)"
              >
                가상자산: 주문-취소 수수료 없는 거래소가 많아 실행이 용이
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                탐지: 동일 IP/기기 지문 + 매수·매도 동시 발생 + 기계적 반복 패턴
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                strokeDasharray="4 3"
              />
              <text x={30} y={120} fontSize={8} fill="var(--muted-foreground)">
                가격
              </text>
              ...
              <motion.circle
                ...
                animate={{ scale: 1 }}
              />
              <text x={340} y={90} fontSize={7} fill={C.attack}>
                고점
              </text>
