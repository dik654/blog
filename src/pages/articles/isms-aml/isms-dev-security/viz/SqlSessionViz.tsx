          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                ORM은 자동 Prepared Statement. 단, raw query 직접 작성 시
                매개변수 바인딩 확인 필수.
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                h={50}
                label="HttpOnly"
                sub="JS에서 document.cookie 접근 차단 → XSS로 세션 탈취 방지"
                color={C.safe}
              />
              <ActionBox
                x={168}
                ...
                h={50}
                label="Secure"
                sub="HTTPS에서만 쿠키 전송 → 네트워크 도청 탈취 방지"
                color={C.primary}
              />
              <ActionBox
                x={326}
              ...
              <text
                ...
                fill={C.action}
              >
                세션 타임아웃: 금융 10~15분, 일반 30분~1시간. 미활동 시 자동
                로그아웃.
              </text>
            </motion.g>
          )}
