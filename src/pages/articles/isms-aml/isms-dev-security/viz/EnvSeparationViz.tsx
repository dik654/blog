        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={318} y={58} fontSize={7} fill={C.prod}>
                승인 후
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                운영 DB에는 고객 자산 잔고 + 개인정보 → 개발 환경에서 접근 시
                정보유출 사고
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                Critical/High → 즉시 차단, Medium → 기간 내 수정, Low → 로그
                기록
              </text>
            </motion.g>
          )}
