          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <StatusBox
                ...
                w={280}
                h={34}
                label="GPG 서명 커밋 → 작성자 위조 방지"
                sub="누가·언제·무엇을·왜 변경했는가 완벽 기록"
                color={C.git}
              />
              ...
              >
                운영 서버 직접 SSH 코드 수정 — 절대 금지 (변경 추적 불가)
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fontWeight={600}
              >
                긴급 변경: 사후 승인 가능, 48시간 내 소급 검토 완료
              </text>
              <text
                x={240}
                y={205}
                ...
                fill="var(--muted-foreground)"
              >
                모든 변경 이력: 언제·누가·무엇을·누가 승인·결과 추적 가능
              </text>
            </motion.g>
          )}
        </svg>
