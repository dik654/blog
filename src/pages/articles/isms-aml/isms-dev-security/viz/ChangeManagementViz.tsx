        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={180} y={40} fontSize={7} fill={C.action}>
                통합 테스트
              </text>
              ...
              <text x={278} y={40} fontSize={7} fill={C.safe}>
                보안 스캔
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                최소 1명 리뷰어 승인. 자체 코드 자체 승인 금지. 보안 변경은
                CODEOWNERS 추가 리뷰.
              </text>
            </motion.g>
          )}
