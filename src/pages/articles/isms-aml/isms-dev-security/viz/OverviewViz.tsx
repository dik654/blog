        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                설계 단계 반영 비용 {"<<"} 운영 중 수정 비용
              </text>

              <motion.path
                d="M 40 160 Q 200 160 460 98"
                fill="none"
                stroke={C.danger}
                strokeWidth={1}
                strokeDasharray="3 2"
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.prod}
              >
                개발 단계에서 체계적 점검 → 실제 공격의 80%+ 사전 차단
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                대부분의 시큐어코딩 가이드라인이 OWASP Top 10 기반으로 작성됨
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={220}
                h={34}
                label="Critical/High → 파이프라인 즉시 중단"
                sub="취약 코드가 운영에 도달하지 않도록 차단"
                color={C.danger}
              />
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                운영 데이터는 개발 환경에 사용 금지 — 가명처리 데이터만 허용
              </text>
            </motion.g>
          )}
        </svg>
