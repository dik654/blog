          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.safe}
              >
                운영 중 발견 vs 개발 중 발견: 수정 비용 수십 배 차이
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                브라우저가 태그가 아닌 텍스트로 해석 → 스크립트 실행 차단
              </text>
              ...
              <text
                ...
                fill={C.action}
              >
                React/Vue는 기본 인코딩 수행. dangerouslySetInnerHTML 사용 시
                인코딩 무시 — 주의!
              </text>
            </motion.g>
          )}
