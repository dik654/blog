        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                이스케이프를 우회해도 CSP가 차단, CSP를 우회해도 HttpOnly가 쿠키
                보호
              </text>
              <text
                x={240}
                ...
                fill={C.safe}
              >
                세 계층을 모두 돌파해야 공격 성공 → 난이도 기하급수적 증가
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={118} y={58} fontSize={7.5} fill={C.danger}>
                인증 상태
              </text>
              <DataBox
                x={100}
              ...
              <text
                ...
                fill={C.safe}
              >
                공격자는 토큰 값을 알 수 없어 유효한 요청 생성 불가
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                POST/PUT/DELETE는 반드시 CSRF 검증. GET은 조회 전용(부작용
                없도록 설계).
              </text>
            </motion.g>
          )}
