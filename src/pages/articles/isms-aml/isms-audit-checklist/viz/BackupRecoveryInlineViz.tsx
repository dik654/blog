...
const STEPS = [
  {
    label: "백업 검증 포인트",
    body: "연속성(빠진 날짜), 크기 일관성, 실패 알림, 암호화, 소산 백업 — 5가지를 확인.",
  },
  {
    label: "복구 테스트 + NTP",
    body: "연 1회 이상 복구 테스트 보고서 필수. NTP 동기화가 안 되면 로그 시간 정합성 붕괴.",
  },
  {
    label: "변경관리 기록",
    body: "시스템 변경 시 요청서·이력대장·긴급변경 사후보고서. 변경 건 있는데 이력 없으면 결함.",
  },
];
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                w={210}
                h={38}
                label="ls -lh /backup/daily/"
                sub="최근 파일 타임스탬프 + 크기 확인"
                color={C.ok}
              />
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                NTP 미동기화 → 서버 간 로그 시간 정합성 붕괴 → 사고 분석 불가
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                심사원이 서버 audit.log와 변경 이력 대장을 대조하여 검증 가능
              </text>
              <text
                x={240}
                y={180}
