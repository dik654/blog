        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={88} y={38} fontSize={7} fill={C.dmz}>
                HTTPS
              </text>
              ...
              <text x={218} y={54} fontSize={7} fill={C.svc}>
                특정 포트
              </text>
              ...
              <text x={348} y={54} fontSize={7} fill={C.internal}>
                DB 포트
              </text>
              ...
              >
                외부 → 내부 직접 접근 불가. 반드시 DMZ → 서비스망 → 내부망 순서.
              </text>
              <text
                x={240}
                y={192}
                ...
                fill={C.internal}
              >
                DMZ에는 민감 데이터 저장 금지. 로그만 임시 보관 후 내부망으로
                전송.
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                점프서버는 1~2대로 제한, 점프서버 자체에도 MFA + 세션 녹화 적용
              </text>
            </motion.g>
          )}
        </svg>
