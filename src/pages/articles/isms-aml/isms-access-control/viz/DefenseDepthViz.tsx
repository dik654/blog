          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                strokeWidth={0.8}
              />
              <text x={35} y={44} fontSize={8} fontWeight={600} fill={C.net}>
                네트워크 계층
              </text>
              <text x={35} y={56} fontSize={7.5} fill="var(--muted-foreground)">
                방화벽, IPS, 망분리
              </text>
              ...
              <rect
                ...
                strokeWidth={0.7}
              />
              <text x={75} y={76} fontSize={8} fontWeight={600} fill={C.srv}>
                서버 계층
              </text>
              <text x={75} y={88} fontSize={7.5} fill="var(--muted-foreground)">
                SSH 키, IP 제한, 호스트 FW
              </text>
              ...
              <rect
                ...
                strokeWidth={0.6}
              />
              <text x={115} y={108} fontSize={8} fontWeight={600} fill={C.app}>
                애플리케이션 계층
              </text>
              <text
                x={115}
              ...
              <text x={465} y={66} textAnchor="end" fontSize={8} fill={C.net}>
                차단 1
              </text>
              <text x={425} y={98} fontSize={8} fill={C.srv}>
                차단 2
              </text>
              <text x={385} y={128} fontSize={8} fill={C.app}>
                차단 3
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                "내부망은 안전하다" 전제를 폐기 → 네트워크 위치와 무관하게 모든
                접근 검증
              </text>
              <text
                x={240}
                ...
                fill={C.app}
              >
                심층 방어를 철저히 적용하면 자연스럽게 제로 트러스트에 수렴
              </text>
            </motion.g>
          )}
        </svg>
