        ...
        >
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 차단 레이블 */}
              <text x={82} y={138} fontSize={7} fill={C.danger}>
                포트 스캔 차단
              </text>
              <text x={182} y={138} fontSize={7} fill={C.rule}>
                측면 이동 차단
              </text>
              <text x={278} y={138} fontSize={7} fill={C.net}>
                SQL/XSS 차단
              </text>
              <text x={388} y={138} fontSize={7} fill={C.safe}>
                대량 유출 차단
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                VPN 돌파(네트워크) → 서버 인증 + DB 접근제어가 독립 차단
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={240} y={170} fontSize={8} fontWeight={600} fill={C.net}>
                전환
              </text>
