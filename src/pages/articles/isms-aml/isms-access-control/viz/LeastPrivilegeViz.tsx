        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                명시적으로 허용되지 않은 모든 접근은 차단 — 방화벽, 서버, DB
                모두 동일 원칙
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={105} y={43} fontSize={7} fill={C.action}>
                요청자
              </text>
              ...
              <text x={225} y={43} fontSize={7} fill={C.action}>
                승인자 A
              </text>
              ...
              <text x={345} y={43} fontSize={7} fill={C.safe}>
                승인자 B
              </text>
              ...
              <AlertBox
                ...
                h={45}
                label="한 명이 코드+배포"
                sub="악의적 코드 삽입 후 자가 승인/배포 방지 불가"
                color={C.danger}
              />
              ...
              <text
                ...
                fill={C.safe}
              >
                직무 분리 = 내부자 위협(Insider Threat) + 실수 동시 방지
              </text>
            </motion.g>
          )}
        </svg>
