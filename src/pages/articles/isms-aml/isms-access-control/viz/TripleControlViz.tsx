          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                삭제 필요 시 Soft Delete(is_deleted 플래그)
              </text>
              <text
                x={122}
                y={144}
                ...
                fill={C.ip}
              >
                SQL Injection으로 탈취해도 DROP/DELETE 불가
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                "만능 계정" 하나로 모든 작업 → 사고 시 피해 범위 무한대 확장
              </text>
              <text
                x={240}
                y={194}
