          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ModuleBox
                ...
                color={C.db}
              />
              <text x={195} y={40} fontSize={8} fill="var(--muted-foreground)">
                SELECT/INSERT/UPDATE
              </text>
              <text x={195} y={52} fontSize={8} fill={C.block} fontWeight={600}>
                DELETE 미부여 (Soft Delete)
              </text>
              ...
              <ModuleBox
                ...
                color={C.proxy}
              />
              <text x={195} y={83} fontSize={8} fill="var(--muted-foreground)">
                스키마 변경, 인덱스 관리
              </text>
              <text x={195} y={95} fontSize={8} fill="var(--muted-foreground)">
                기간 한정 접근
              </text>
              ...
              <ModuleBox
                ...
                color={C.user}
              />
              <text x={195} y={126} fontSize={8} fill="var(--muted-foreground)">
                읽기 전용, 데이터 변경 불가
              </text>
              <text x={195} y={138} fontSize={8} fill="var(--muted-foreground)">
                일일 백업 수행용
              </text>
              ...
              <text x={195} y={181} fontSize={8} fill="var(--muted-foreground)">
                사용 후 전수 감사
              </text>
              <Arrow
                x1={112}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.proxy}
              >
                "도구를 샀다"가 아니라 "무엇을 발견하고 어떻게 대응했는가"가
                심사 핵심
              </text>
            </motion.g>
          )}
