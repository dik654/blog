        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={200}
                h={40}
                label="현재 대부분 Stateful 채택"
                sub="Stateless는 클라우드 ACL 등 제한적 용도"
                color={C.utm}
              />
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={350} y={86} fontSize={7} fill="var(--muted-foreground)">
                통합 관리 — 운영 편의
              </text>
              <text x={350} y={98} fontSize={7} fill="var(--muted-foreground)">
                비용 절감 — 올인원
              </text>
              <text x={350} y={110} fontSize={7} fill="var(--muted-foreground)">
                중소규모 조직에 적합
              </text>
              ...
              <text x={350} y={164} fontSize={7} fill="var(--muted-foreground)">
                전기능 활성화 시 성능 저하
              </text>
              <text x={350} y={176} fontSize={7} fill="var(--muted-foreground)">
                단일 장애점(SPOF)
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={245} y={155} fontSize={7} fill={C.allow}>
                DMZ→내부: DB 포트(3306/5432)만 허용
              </text>
              <text x={245} y={168} fontSize={7} fill={C.allow}>
                내부→DMZ: 관리 SSH(22)만, IP 제한
              </text>
              <text x={245} y={181} fontSize={7} fill={C.dmz}>
                DMZ→인터넷: 업데이트, 외부 API만
              </text>
              <text x={245} y={194} fontSize={7} fill={C.deny}>
                DMZ 탈취 시 내부망 2차 침투 차단
              </text>
            </motion.g>
          )}
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={440}
                h={24}
                label="잘못된 규칙 순서 → 정상 트래픽 차단 or 공격 허용 — 테스트 환경에서 반드시 사전 검증"
                color={C.deny}
              />
            </motion.g>
          )}
