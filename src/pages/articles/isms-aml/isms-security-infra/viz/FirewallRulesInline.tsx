        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                opacity={0.12}
              />
              <text x={215} y={38} fontSize={8} fill={C.green}>
                1. Any → 웹서버 80/443 Allow
              </text>
              <rect
                x={210}
                y={47}
                ...
                opacity={0.12}
              />
              <text x={215} y={59} fontSize={8} fill={C.green}>
                2. 관리자IP → DMZ 22 Allow (SSH)
              </text>
              <rect
                x={210}
                y={68}
                ...
                opacity={0.12}
              />
              <text x={215} y={80} fontSize={8} fill={C.green}>
                3. Any → VPN GW 443/4500 Allow
              </text>
              <rect
                x={210}
                y={89}
                ...
                opacity={0.15}
              />
              <text x={215} y={101} fontSize={8} fill={C.red}>
                999. Any → Any Deny (기본 거부)
              </text>
              ...
              >
                첫 번째 매칭 규칙이 적용 → 구체적 허용 먼저, 포괄 차단 마지막
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={80} y={75} textAnchor="middle" fontSize={8} fill={C.red}>
                나머지 Deny All
              </text>
