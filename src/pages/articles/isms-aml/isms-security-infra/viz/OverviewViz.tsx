        ...
        >
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={30} y={160} fontSize={8} fill={C.ext}>
                2.6 접근통제
              </text>
              <text x={130} y={160} fontSize={8} fill="var(--muted-foreground)">
                방화벽 규칙, 네트워크 세그멘테이션, VPN 접근 정책
              </text>
              <text x={30} y={176} fontSize={8} fill={C.dmz}>
                2.10 시스템 개발 보안
              </text>
              <text x={170} y={176} fontSize={8} fill="var(--muted-foreground)">
                WAF 배치, 시큐어 코딩과 연계한 웹 보호
              </text>
              <text x={30} y={192} fontSize={8} fill={C.svc}>
                2.11 침해사고 관리
              </text>
              <text x={160} y={192} fontSize={8} fill="var(--muted-foreground)">
                IDS/IPS 탐지 → SIEM 상관분석 → CSIRT 대응
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={250}
                h={30}
                label="업무망 → Wallet Zone 직접 접근 전면 차단"
                color={C.ext}
              />
            </motion.g>
          )}
