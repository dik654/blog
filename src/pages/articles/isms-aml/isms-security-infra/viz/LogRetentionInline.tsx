        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={120} y={30} fontSize={8} fill="var(--muted-foreground)">
                6개월
              </text>
              <text x={210} y={30} fontSize={8} fill="var(--muted-foreground)">
                1년
              </text>
              <text x={300} y={30} fontSize={8} fill="var(--muted-foreground)">
                2년
              </text>
              <text x={440} y={30} fontSize={8} fill="var(--muted-foreground)">
                5년
              </text>
