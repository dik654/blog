        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.waf}
              >
                상호보완: 네트워크 방화벽(1차 IP/포트 필터) → WAF(2차 L7 검사)
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={271} y={48} textAnchor="middle" fontSize={7} fill={C.ok}>
                정상
              </text>
              <ModuleBox
                x={292}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={330}
                h={24}
                label="ISMS 2.6.6: VPN + MFA(OTP, 인증서, 생체) 필수 적용"
                color={C.atk}
              />
            </motion.g>
          )}
