        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <line
                ...
                strokeDasharray="3 2"
              />
              <text x={193} y={62} fontSize={7} fill={C.ids}>
                복사
              </text>
              <ActionBox
                x={120}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                color={C.ips}
              />
              <text x={85} y={118} textAnchor="middle" fontSize={7} fill={C.ok}>
                알려진 공격 정확 탐지
              </text>
              <text
                x={85}
              ...
              <rect
                ...
                strokeWidth={0.5}
              />
              <text x={205} y={95} textAnchor="middle" fontSize={8} fill={C.ok}>
                Baseline
              </text>
              ...
              >
                시그니처 기반이 메인(높은 정확도) + 이상행위 기반으로 제로데이
                보완 + 프로토콜 분석으로 터널링 탐지
              </text>
              <text x={30} y={195} fontSize={7.5} fill={C.ips}>
                시그니처 DB는 반드시 최신 유지 — 업데이트 지연 = 탐지 공백
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 장점/단점 */}
              <text x={340} y={38} fontSize={8} fill={C.ok}>
                실시간 차단
              </text>
              <text x={340} y={52} fontSize={8} fill={C.ok}>
                공격 즉각 중지
              </text>
              <text x={340} y={70} fontSize={8} fill={C.atk}>
                장비 장애 → 네트워크 단절
              </text>
              <text x={340} y={84} fontSize={8} fill={C.atk}>
                오탐 = 서비스 장애
              </text>
              ...
              <line
                ...
                strokeDasharray="3 2"
              />
              <text x={155} y={168} fontSize={7} fill={C.ids}>
                SPAN 복사
              </text>
              ...
              <text x={340} y={142} fontSize={8} fill={C.ok}>
                서비스 영향 없음
              </text>
              <text x={340} y={156} fontSize={8} fill={C.ok}>
                포렌식 데이터 수집
              </text>
              <text x={340} y={174} fontSize={8} fill={C.atk}>
                차단 불가
              </text>
              <text x={340} y={188} fontSize={8} fill={C.atk}>
                별도 장비에 차단 요청 필요
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                w={455}
                h={28}
                label="커스텀 시그니처: 자사 서비스 특화 규칙 직접 작성 — 범용 시그니처만으로는 커버 불가"
                sub=""
                color={C.ips}
              />
            </motion.g>
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ModuleBox
                ...
                h={42}
                label="내부 측면 이동"
                sub="내부 서버 간 비표준 포트 스캔, SSH 브루트포스"
                color={C.ids}
              />
              <ModuleBox
                x={250}
