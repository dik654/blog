...
const STEPS = [
  {
    label: "Tipping-off란 — SAR 사실 누설 금지",
    body: "SAR을 제출한 사실을 고객/제3자에게 알리는 행위. 증거 인멸, 자산 도피, 공범 통보, 도주를 유발하여 수사 전체를 무력화할 수 있다.",
  },
  {
    label: "위반 vs 허용 — 표현의 경계",
    body: '"AML 관련 조치" = 위반. "내부 보안 점검으로 제한" = 허용. 핵심: 고객이 SAR 사실을 추론할 수 없어야 한다.',
  },
  {
    label: "Need-to-know — 내부 공유 범위",
    body: '준법감시인과 AML 담당자만 SAR 사실 인지. CS팀은 "계정 제한" 사실만 전달받아 고객 안내. 정보 확산 = Tipping-off 위험 증가.',
  },
  {
    label: "Safe Harbor — 선의의 보고에 대한 면책",
    body: '특금법 제4조의3: 합리적 근거에 기반한 선의의 보고는 민·형사 면책. "보고가 미보고보다 안전하다"는 인센티브 구조.',
  },
  {
    label: "내부 통제 체계 5단 방어",
    body: '접근 통제 → CS 스크립트 → 정기 교육 → 감사 로그 → 내부 신고 채널. CS팀 "AML 확인 중" 발언이 가장 흔한 위반 경로.',
  },
];
        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={100} y={200} fontSize={8} fill="var(--muted-foreground)">
                처벌: 3년 이하 징역 또는 2천만 원 이하 벌금
              </text>
            </motion.g>
          )}
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={180}
                h={40}
                label="'AML 팀에서 확인 중입니다'"
                sub="AML 언급 → 보고 사실 추론 가능"
                color={C.danger}
              />
