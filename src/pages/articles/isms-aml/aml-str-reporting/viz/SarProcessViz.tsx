...
const STEPS = [
  {
    label: "1단계 — 의심 인지",
    body: "FDS(이상거래탐지시스템) 경보 또는 현업 직원이 이상 징후를 발견. 내부 보고서를 작성하여 AML 담당자에게 전달.",
  },
  {
    label: "2단계 — 1차 검토",
    body: "AML 담당자가 경보 유효성 확인, CDD 프로파일 대조, 온체인 분석. 결과: 오탐 종료 / 추가 조사 / SAR 작성 판정.",
  },
  {
    label: "3단계 — SAR 작성",
    body: '거래 일시·금액, 관련 계정·지갑, 의심 사유, 증빙자료, VASP 조치 내역을 구체적으로 기재. "왜 의심스러운지"가 핵심.',
  },
  {
    label: "4단계 — 승인 및 FIU 제출",
    body: "준법감시인 최종 승인 후 FIU 온라인 보고 시스템(goAML)으로 전자 제출. 의심 인지 후 3영업일 이내 완료.",
  },
  {
    label: "5단계 — 후속 조치",
    body: "계정 모니터링 유지, 수사기관 협조, 계정 해지 검토, 새로운 패턴을 FDS 규칙에 반영. SAR 제출은 끝이 아니라 시작.",
  },
];
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                징후: 목적 미소명 / 본인확인 회피 / 소득-거래 불일치 / 급박한
                대규모 출금
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                h={40}
                label="의심 사유 = SAR의 핵심"
                sub="'FDS 경보 발생'만으로 부족 — 왜 세탁 의심인지 논리적 서술"
                color={C.follow}
              />
