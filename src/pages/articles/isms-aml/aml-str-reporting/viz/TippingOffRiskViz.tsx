...
const STEPS = [
  {
    label: "Tipping-off 시 발생하는 피해",
    body: "증거 인멸, 자산 도피, 공범 통보, 도주 — 수개월 수사가 한 번의 누설로 무력화.",
  },
  {
    label: "허용 vs 금지 표현",
    body: '"내부 보안 점검" OK / "AML 관련 조치" NG. 고객이 SAR 사실을 추론할 수 없어야 한다.',
  },
  {
    label: "Safe Harbor 면책 보호",
    body: "선의의 보고에 대해 민·형사 면책. 보고가 미보고보다 안전한 인센티브 구조.",
  },
];
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={360}
                h={34}
                label="수개월 수사가 한 번의 누설로 무위"
                sub="특금법 제4조의2 위반 → 3년 이하 징역 또는 2천만 원 이하 벌금"
                color={C.danger}
              />
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                h={38}
                label="전제: '선의'"
                sub="고의 허위 보고·경쟁사 해하기 위한 보고는 면책 불가. 미보고도 Safe Harbor 적용 안 됨."
                color={C.danger}
              />
            </motion.g>
          )}
