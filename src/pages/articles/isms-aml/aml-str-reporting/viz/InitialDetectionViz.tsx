...
const STEPS = [
  {
    label: "인지 경로: FDS vs 현업",
    body: "FDS 자동 경보(대부분)와 현업 직원 직접 감지(보완). 두 경로 모두 내부 보고서로 수렴.",
  },
  {
    label: "현업이 감지해야 할 징후",
    body: "목적 미소명, 본인확인 회피, 소득-거래 불일치, 급박한 대규모 출금, 타인 명의 정황.",
  },
  {
    label: "1차 검토 4단계",
    body: "경보 유효성 → CDD 대조 → 온체인 분석 → 추가 정보 수집. 결과: 오탐/추가조사/SAR 판정.",
  },
];
