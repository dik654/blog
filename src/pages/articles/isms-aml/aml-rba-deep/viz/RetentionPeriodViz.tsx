...
const STEPS = [
  {
    label: "5가지 문서화 범주",
    body: '위험평가·정책·CDD·거래/보고·교육/감사 — 규제 점검은 "문서"로 이행 여부를 판단.',
  },
  {
    label: "보관 기간 5년 + 기산점",
    body: '특금법 제5조의3: 최소 5년. 기산점은 "거래 관계 종료일" 또는 "거래일" 중 늦은 날.',
  },
  {
    label: "보관 형태 요건",
    body: '"즉시 제공 가능" = 검색 가능 + 무결성 보장 + 추출 가능. 못 찾으면 미보관과 동일.',
  },
];
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={360}
                h={35}
                label='"보관하고 있었지만 찾을 수 없다"'
                sub="= 사실상 미보관 → 동일 제재 적용"
                color={C.red}
              />
            </motion.g>
          )}
