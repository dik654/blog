...
const STEPS = [
  {
    label: "1선 → 2선 견제 구조",
    body: "1선(현업)의 이해 충돌을 2선(준법감시)이 독립적으로 견제. 영업 실적 vs AML 통제.",
  },
  {
    label: "2선 핵심 업무: FDS 알림 검토",
    body: "FDS 자동 경보 → 오탐/진짜 판별 → 규칙 튜닝. 2선이 가장 많이 수행하는 업무.",
  },
  {
    label: "3선: 독립적 감사",
    body: "1선+2선 체계 전체를 독립 평가. 이사회 직보 라인이 생명선 — CCO 은폐도 견제 가능.",
  },
];
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                h={32}
                label="CCO 은폐 방지"
                sub="3선이 이사회에 직접 보고 → 2선(CCO) 자체의 부적절 행위도 견제"
                color={C.red}
              />
            </motion.g>
          )}
