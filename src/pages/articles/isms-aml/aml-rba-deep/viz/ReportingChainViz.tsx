...
const STEPS = [
  {
    label: "보고 체계 전체 흐름",
    body: '1선→2선→위원회→이사회. 3선(감사)은 이사회 직보. "위로 올라가되 중간을 건너뛰지 않는" 구조.',
  },
  {
    label: "ML/TF 위원회 역할",
    body: "전사 AML/CFT 총괄 의사결정. CEO·CCO·CISO·법무·영업부서장 참여. 분기 1회 정기 + 수시.",
  },
  {
    label: "소규모 VASP 현실",
    body: "30명 미만 시 1선+2선 겸직 허용, 단 3선(감사)만큼은 반드시 독립. 연 1회 외부 감사 필수.",
  },
];
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                h={40}
                label="감사인 독립성 확인"
                sub="동일 법인이 회계 감사 + AML 감사하면 이해 충돌"
                color={C.red}
              />
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                최소 원칙: 감사만큼은 반드시 독립 + 대표이사가 아닌 이사회에
                보고
              </text>
            </motion.g>
          )}
