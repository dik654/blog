        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 시간 막대 */}
              <text x={175} y={38} fontSize={8} fill="var(--muted-foreground)">
                cost=10
              </text>
              <rect
                x={215}
                ...
                opacity={0.3}
              />
              <text x={260} y={39} fontSize={8} fill="var(--muted-foreground)">
                ~65ms
              </text>

              <text x={175} y={55} fontSize={8} fill="var(--muted-foreground)">
                cost=12
              </text>
              <rect
                x={215}
              ...
              <text x={175} y={72} fontSize={8} fill="var(--muted-foreground)">
                cost=14
              </text>
              <rect
                x={215}
                ...
                opacity={0.7}
              />
              <text x={380} y={73} fontSize={8} fill="var(--muted-foreground)">
                ~1s
              </text>
              ...
              <StatusBox
                ...
                w={240}
                h={34}
                label="Eksblowfish 키 스케줄"
                sub="순차적 → GPU 병렬화 효과 제한"
                color={C.bcrypt}
              />
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                OWASP 권장: Argon2id, 메모리 19MB, 반복 2회, 병렬 1
              </text>
            </motion.g>
          )}
