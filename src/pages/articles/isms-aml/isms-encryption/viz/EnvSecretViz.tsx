        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                단일 서버에서는 간단하지만, 규모 확장 시 한계 — 시크릿 매니저
                도입 필요
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                w={170}
                h={38}
                label="etcd encryption at rest 활성화"
                sub="저장 시점 암호화"
                color={C.safe}
              />
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                Base64는 인코딩(변환)일 뿐 암호화(보호)가 아님 — 반드시
                encryption at rest 필요
              </text>
            </motion.g>
          )}
