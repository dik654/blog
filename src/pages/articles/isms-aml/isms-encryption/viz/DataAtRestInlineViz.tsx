...
function Arrow({
  ...
  return (
    <line
      ...
      stroke={color}
      strokeWidth={1}
      markerEnd="url(#dar-inline-arrow)"
    />
  );
}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.safe}
              >
                법령: 주민번호·여권번호·바이오 → AES-128 이상 의무
              </text>
            </motion.g>
          )}
        </svg>
