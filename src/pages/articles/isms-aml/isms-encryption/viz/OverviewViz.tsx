          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.sym}
              >
                각 영역의 위협 모델이 다르므로 알고리즘·키 관리 방식도 다름
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                국내 법령: 주민번호·여권번호·바이오 → AES-128 이상 의무
              </text>
            </motion.g>
          )}
