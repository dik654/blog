        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                KMS(Key Management Service)가 키 버전 관리 + 감사 로그 + 전체
                과정 자동화
              </text>
              <text
                x={240}
                ...
                fill={C.action}
              >
                클라우드 KMS: AWS KMS, GCP Cloud KMS, Azure Key Vault
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.safe}
              >
                유출 발생해도 다음 회전에서 키 무효화 — window 제한
              </text>
              ...
              <text
                ...
                fill={C.action}
              >
                KMS 자동 회전: 주기 설정 → 키 생성·전환·폐기 전 과정 자동화
              </text>
            </motion.g>
          )}
        </svg>
