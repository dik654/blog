        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.danger}
              >
                솔트 없는 MD5/SHA-1 → 해시값만으로 원본 즉시 복원
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={310} y={80} fontSize={8} fill={C.danger}>
                테이블 조회 가능
              </text>
              ...
              <text x={310} y={148} fontSize={8} fontWeight={600} fill={C.safe}>
                같은 비밀번호, 다른 솔트
              </text>
              <text x={310} y={162} fontSize={8} fill={C.safe}>
                → 완전히 다른 해시
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={14} y={132} fontSize={8} fill={C.danger}>
                MD5
              </text>
              <rect
                x={45}
                ...
                opacity={0.4}
              />
              <text x={450} y={134} fontSize={8} fill={C.danger}>
                수 ns
              </text>

              <text x={14} y={155} fontSize={8} fill={C.warn}>
                SHA-256
              </text>
              <rect
                x={60}
                ...
                opacity={0.4}
              />
              <text x={365} y={157} fontSize={8} fill={C.warn}>
                수 ns
              </text>

              <text x={14} y={178} fontSize={8} fill={C.safe}>
                bcrypt
              </text>
              <rect
                x={52}
                ...
                opacity={0.6}
              />
              <text x={66} y={180} fontSize={8} fill={C.safe}>
                ~250ms
              </text>
              ...
              <text
                ...
                fill={C.safe}
              >
                느린 해시 함수(bcrypt/Argon2)로 브루트포스 비용을 수백 년으로
              </text>
            </motion.g>
          )}
        </svg>
