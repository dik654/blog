...
function Arrow({
  ...
  return (
    <line
      ...
      stroke={color}
      strokeWidth={1}
      markerEnd="url(#mig-inline-arrow)"
    />
  );
}
        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={280}
                h={30}
                label="장기 미로그인 계정 → 비밀번호 재설정 강제로 전환 완료"
                color={C.warn}
              />
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                opacity={0.4}
              />
              <text x={300} y={176} fontSize={8} fill={C.warn}>
                128비트 입력
              </text>
              ...
              <rect
                ...
                opacity={0.4}
              />
              <text x={424} y={194} fontSize={8} fill={C.safe}>
                전체 엔트로피
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={440} y={128} fontSize={8} fontWeight={600} fill={C.safe}>
                병행
              </text>
