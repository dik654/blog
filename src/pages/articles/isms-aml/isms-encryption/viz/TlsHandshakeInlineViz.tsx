...
function Arrow({
  ...
  return (
    <line
      ...
      stroke={color}
      strokeWidth={1}
      markerEnd="url(#tls-inline-arrow)"
    />
  );
}
        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 바 */}
              <text x={14} y={148} fontSize={8} fill="var(--muted-foreground)">
                1.0
              </text>
              <rect
                x={30}
              ...
              <text x={14} y={168} fontSize={8} fill="var(--muted-foreground)">
                1.2
              </text>
              <rect
                x={30}
              ...
              <text x={14} y={188} fontSize={8} fill="var(--muted-foreground)">
                1.3
              </text>
              <rect
                x={30}
