          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                [항목번호]_[설명]_[BEFORE/AFTER]_[날짜].png
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                현재 상태(BEFORE) → 조치 내용(설정값·서버·일시) → 조치 후
                상태(AFTER) + 증적 첨부
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                w={200}
                h={34}
                label="잘 해도 증적 없으면 결함"
                sub="bcrypt를 써도 증명 못하면 미이행"
                color={C.red}
              />
              ...
              <DataBox
                ...
                h={34}
                label="기술적 우수성 ≠ 심사 통과"
                sub="심사 기준(KISA 검증 목록) 내에서 최선 선택"
                color={C.amber}
              />
