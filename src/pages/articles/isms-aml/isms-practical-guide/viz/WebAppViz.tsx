          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                color={C.red}
              />
              <text x={325} y={40} fontSize={9} fill={C.red}>
                ...
              </text>
              <AlertBox
                x={340}
              ...
              <rect
                ...
                strokeWidth={0.5}
              />
              <text x={52} y={178} fontSize={9} fontWeight={600} fill={C.blue}>
                DB 내부
              </text>
              <text x={52} y={193} fontSize={8} fill="var(--muted-foreground)">
                순차 PK 유지 (성능) + uuid 컬럼 추가 (외부용)
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <StatusBox
                ...
                h={50}
                label="서버사이드 세션 체크"
                sub="클라이언트 조작 무의미 — 세션에 2차 승인 기록 없으면 거부"
                color={C.green}
                progress={1}
              />
