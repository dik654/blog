          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                strokeWidth={0.8}
              />
              <text x={20} y={118} fontSize={10} fontWeight={700} fill={C.cyan}>
                MySQL 이벤트 스케줄러
              </text>
              <text x={20} y={135} fontSize={9} fill="var(--muted-foreground)">
                매일 자동 실행 → 보유 만료일 경과 레코드 영구 삭제
              </text>
              <text x={20} y={152} fontSize={9} fill="var(--muted-foreground)">
                인적 오류 배제 — 시스템 자동화가 핵심
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                원본 테이블에는 탈퇴 회원 데이터 없음 (INSERT → DELETE)
              </text>
            </motion.g>
          )}
        </svg>
