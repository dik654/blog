            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  w={320}
                  h={36}
                  label="결함 예시: 정책 승인일이 이행 완료일보다 뒤"
                  sub="정책 승인 2024-03 → 이행 완료 2024-01 = 논리 모순"
                  color={C.red}
                />
              </motion.g>
            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  w={360}
                  h={32}
                  label="전수 검사 아닌 랜덤 샘플링"
                  sub="직원 200명 중 10명 선정, 서버 20대 중 3대 선정 → '일부만 준비' 전략은 위험"
                  color={C.amber}
                />
              </motion.g>
            </motion.g>
