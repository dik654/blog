        ...
        >
            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  w={280}
                  h={22}
                  label="소스코드에 키 하드코딩 = Git 이력 포함 정리 필수"
                  color={C.red}
                />
              </motion.g>
            </motion.g>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <motion.path
                  d="M 435 68 C 465 68, 465 145, 435 145 L 50 145 C 30 145, 25 140, 25 130 L 25 120"
                  fill="none"
                  stroke={C.green}
                  strokeWidth={0.8}
                  strokeDasharray="4 3"
