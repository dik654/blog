            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  w={280}
                  h={40}
                  label="소스코드에 키 하드코딩 = 절대 금지"
                  sub="Git 이력에 키 존재 시 '키 노출 사고'로 간주"
                  color={C.red}
                />
              </motion.g>
            </motion.g>
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <ModuleBox
                ...
                w={440}
                h={30}
                label="2.11 사고 대응 — 사고는 '발생 여부'가 아니라 '발생 시기'의 문제"
                sub=""
                color={C.red}
              />
              ...
              <ModuleBox
                ...
                w={440}
                h={30}
                label="2.12 재해 복구 — 백업이 없으면 복구 불가, 테스트 없으면 보장 불가"
                sub=""
                color={C.blue}
              />
