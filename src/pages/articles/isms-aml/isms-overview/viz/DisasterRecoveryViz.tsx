        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              />
              <text x={40} y={85} fontSize={8} fill={C.blue}>
                마지막 백업
              </text>
              ...
              />
              <text x={440} y={85} fontSize={8} fill={C.green} textAnchor="end">
                서비스 복원
              </text>
