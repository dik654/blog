            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  w={360}
                  h={30}
                  label="교육 미수료 상태에서 권한 부여 = 2.2.4 결함"
                  sub="입사일 → 교육일 → 권한 부여일 시간 순서 증적 필수"
                  color={C.red}
                />
              </motion.g>
            </motion.g>
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                strokeWidth={0.8}
              />
              <text x={40} y={48} fontSize={9} fontWeight={600} fill={C.green}>
                사무실 (일반 구역)
              </text>
              <text x={40} y={60} fontSize={8} fill="var(--muted-foreground)">
                카드키 출입
              </text>
              ...
              <rect
                ...
                strokeWidth={1}
              />
              <text x={70} y={88} fontSize={9} fontWeight={600} fill={C.amber}>
                서버실 (제한 구역)
              </text>
              <text x={70} y={100} fontSize={8} fill="var(--muted-foreground)">
                카드 + 승인 필요
              </text>
              ...
              />
              <text x={240} y={96} fontSize={9} fontWeight={700} fill={C.red}>
                월렛룸 (최고 보안)
              </text>
              <text x={240} y={108} fontSize={8} fill="var(--muted-foreground)">
                지문 + 카드 이중 인증
              </text>
