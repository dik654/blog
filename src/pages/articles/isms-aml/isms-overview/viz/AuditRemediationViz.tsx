        ...
        >
            ...
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                <AlertBox
                  ...
                  h={44}
                  label="랜덤 샘플링으로 검증"
                  sub="200명 중 10명 선정, 서버 20대 중 3대 점검"
                  color={C.amber}
                />
              ...
              >
                '일부만 준비'하면 샘플에 걸릴 때 즉시 결함 -- 전수 대비 필수
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                심사 소견을 정확히 이해해야 올바른 보완 방향 설정 가능
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              />
              <text x={40} y={163} fontSize={8} fill="var(--muted-foreground)">
                결함 도출
              </text>
              <text
                x={440}
              ...
              >
                <AlertBox
                  ...
                  w={220}
                  h={34}
                  label="연장 가능: 최대 1회, 40일 추가"
                  sub="연장 사유서 + 진행 현황 + 완료 계획 제출"
                  color={C.amber}
                />
              </motion.g>
            </motion.g>
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                인증 취소 사유: 거짓 서류, 중대 사고 미보고, 사후심사 거부 --
                VASP 영업 정지 위험
              </motion.text>
            </motion.g>
          )}
