        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={260} y={88} fontSize={8} fill={C.blue}>
                AI로 극복
              </text>
              ...
              <ModuleBox
                ...
                h={48}
                label="AI 기반 FDS"
                sub="맥락(context) 종합 판단 — 고정 임계값 없음"
                color={C.green}
              />

              {/* Example */}
              <text x={18} y={175} fontSize={8} fill={C.red}>
                규칙: 단일 999만 원 → 통과
              </text>
              <text x={18} y={190} fontSize={8} fill={C.green}>
                AI: 반복·신규·즉시 출금 → 경보
              </text>
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <path
                d="M 288 188 C 320 170, 170 170, 133 188"
                fill="none"
                stroke={C.red}
                strokeWidth={0.8}
                strokeDasharray="3 2"
                markerEnd="url(#ai-fds-arrow)"
              />
              <text x={350} y={199} fontSize={8} fill="var(--muted-foreground)">
                순환 거래(Round-tripping)
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.amber}
              >
                OFAC 제재 주소 직접 거래 → 자동 차단 허용 (유일한 예외)
              </text>
            </motion.g>
          )}
        </svg>
