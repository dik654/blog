        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={375} y={100} fontSize={8} fill="var(--muted-foreground)">
                3~5홉 추적 필요
              </text>
              ...
              <DataBox
                ...
                w={320}
                h={34}
                label="클러스터링 정확도 = 분석 신뢰도"
                sub="CoinJoin은 공통 입력 소유권 휴리스틱을 의도적으로 무력화"
                color={C.amber}
              />
              <text
                x={240}
                ...
                fill="var(--muted-foreground)"
              >
                홉이 깊을수록 관련성 약화 — 그러나 세탁은 3홉 이상 경유
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                라벨링 DB 규모·갱신 속도가 분석 도구의 경쟁력을 결정
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={180}
                h={36}
                label="비호스팅 지갑(DeFi·개인)"
                sub="Travel Rule 미적용 → 우회 경로"
                color={C.red}
              />
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                VASP 간 상호 검증으로 거래소 경유 세탁 난이도 크게 상승
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                w={280}
                h={34}
                label="2개 이상 분석 도구 병행 = 최선의 실무 관행"
                sub="단일 도구 의존 → 사각지대 발생"
                color={C.green}
              />
            </motion.g>
          )}
