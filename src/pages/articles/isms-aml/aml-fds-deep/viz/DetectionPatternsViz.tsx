        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                w={220}
                h={34}
                label="두 패턴 동시 발생 → 최고 경보"
                sub="구조화+빠른이동 = 세탁 강한 의심"
                color={C.red}
              />
              <text
                x={240}
              ...
              >
                24시간 내 동일 계정에서 기준 금액의 80~99% 범위 거래 3회 이상
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={186} y={55} fontSize={8} fill="var(--muted-foreground)">
                섞인 A'
              </text>
              <text x={186} y={83} fontSize={8} fill="var(--muted-foreground)">
                섞인 B'
              </text>
              ...
              <DataBox
                ...
                w={320}
                h={30}
                label="1~2홉 이내 믹서 연결 / 브릿지 직후 출금 → 경보"
                color={C.red}
              />
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                color={C.red}
              />
              <text x={130} y={88} fontSize={8} fill={C.red}>
                깡통 계좌 의심
              </text>
              <text x={130} y={100} fontSize={8} fill="var(--muted-foreground)">
                정상: 소액→점진적 증가
              </text>
              ...
              <AlertBox
                ...
                color={C.red}
              />
              <text x={370} y={88} fontSize={8} fill={C.red}>
                계정 탈취 또는 명의 매매
              </text>
              <text x={370} y={100} fontSize={8} fill="var(--muted-foreground)">
                IP/디바이스 변경 시 추가 경보
              </text>
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.red}
              >
                자금세탁의 80%가 중개 지갑·여러 홉(Hop)을 경유
              </text>
              {[0, 1, 2, 3, 4].map((i) => (
                <g key={`hop-${i}`}>
                  <circle
                    ...
                    r={10}
                    fill="var(--card)"
                    stroke={i === 0 ? C.red : i === 4 ? C.green : C.amber}
                    strokeWidth={1}
                  />
                  <text
                    x={120 + i * 65}
