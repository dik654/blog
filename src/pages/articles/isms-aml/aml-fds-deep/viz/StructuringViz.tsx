...
function Arrow({
  ...
  return (
    <line
      ...
      stroke={color}
      strokeWidth={1}
      markerEnd="url(#struct-viz-arrow)"
    />
  );
}
        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                스머핑(Smurfing): 여러 사람이 소액씩 나눠 입금하는 변형도 탐지
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                FDS 조건: 입금 후 30분 이내 전액(90%+) 외부 출금 시 경보
              </text>
              <text
                x={240}
                y={180}
                ...
                fill="var(--muted-foreground)"
              >
                거래소를 "경유지"로 활용 — 전형적 계층화(Layering) 수법
              </text>
            </motion.g>
          )}
        </svg>
