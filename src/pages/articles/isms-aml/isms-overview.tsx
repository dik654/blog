    ...
    <div className="space-y-12">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p>
            정보통신망법상 의무대상자는 ISMS 또는 ISMS-P를 선택할 수 있습니다. 현재 시행령은 ISP·IDC 외에도 일정 범주의 상급종합병원·학교, 정보통신서비스 부문 전년도
            매출액 100억원 이상, 전년도 일일평균 이용자 100만명 이상인 자 등을 규정하지만, 금융회사 예외와 사업 구조를 함께 읽어야 합니다. 숫자 하나만 보고 해당 여부를 확정하지
            말고 법인, 서비스, 매출 산정 범위와 통지 내용을 확인해야 합니다. 의무대상이 아니어도 자율 신청은 가능합니다.
          </p>
          <p>
            인증범위(scope)는 회사 이름과 같은 말이 아닙니다. 대상 서비스, 이를 운영하는 조직과 사람, 애플리케이션·서버·네트워크·데이터, 사무실·IDC·클라우드 위치, 외부
            위탁자를 경계로 고정한 것입니다. 범위 밖 시스템이 인증 서비스의 로그인, 배포, 결제나 백업에 의존한다면 연결 관계와 제외 근거를 설명해야 합니다.
          </p>
        </div>
      ...
      <section id="asset-risk" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p>
            위험처리는 회피, 감소, 전가, 수용으로 나눕니다. 통제를 적용했다면 통제 owner, 구현 위치, 완료 기한, 검증 방법, 예상 잔여위험을 기록하고 실제 운영 결과로
            재평가합니다. 위험수용은 “아무것도 하지 않음”이 아니라 수용 권한자, 이유, 만료일, 모니터링 조건을 갖춘 명시적 결정입니다. 범위 변경·사고·중대한 취약점·법령 개정은 정기
            주기 전에도 재평가 trigger가 됩니다.
          </p>
        </div>
      </section>
      ...
      <section id="protection-measures" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p>
            세 층은 대체재가 아닙니다. 서버실 출입카드가 있어도 공유 root 비밀번호를 막지 못하고 RBAC가 있어도 승인되지 않은 backup 반출을 막지 못할 수 있습니다.
            예방·탐지·대응·복구 통제가 같은 위험을 서로 다른 시점에서 다루도록 defense in depth를 구성하되, 통제 수가 많다는 이유만으로 효과가 높다고 결론내리지 않습니다.
          </p>
        </div>
      ...
      <section id="audit-remediation" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p>
            심사 준비는 먼저 범위와 운영기간을 확정하고 요구사항별 owner와 증적 원본을 연결하는 데서 시작합니다. 심사원은 정책 문구만 읽지 않고 계정 모집단에서 표본을 뽑아
            승인·변경·회수 기록을 대조하거나, 설정 화면과 실제 차단 결과, log의 시간과 보관 상태를 함께 확인합니다. 제출용 캡처와 운영 원본이 다르면 오히려 재현성과 신뢰성이
            떨어집니다.
          </p>
          <p>
            결함이 나오면 증상만 수정하지 않습니다. 요구사항, 직접 원인, 근본 원인, 같은 원인이 영향을 준 자산·기간·계정을 조사한 뒤 수정·보상통제·재발방지를 정합니다. 이후 원래
            표본과 확장 표본으로 다시 검증하고 owner·완료일·검증자·잔여위험을 종결 기록에 남깁니다. 예를 들어 퇴직자 한 명의 계정을 끄는 것으로 끝내지 않고 HR event 누락
            원인을 고쳐 전체 퇴직자 모집단과 API key·VPN certificate까지 재대조해야 합니다.
          </p>
          <p>
            법상 인증 유효기간은 3년이고 연 1회 이상 사후관리가 수행됩니다. 그러나 그 기간 동안 시스템이 안전하다는 보증은 아닙니다. 인증은 정해진 범위와 심사시점·표본에서 관리체계가
            기준에 적합했음을 보여주는 evidence입니다. 범위 밖 서비스, 이후 변경, 발견되지 않은 취약점과 실제 공격 성공 가능성은 별도 운영 관리가 필요합니다.
          </p>
