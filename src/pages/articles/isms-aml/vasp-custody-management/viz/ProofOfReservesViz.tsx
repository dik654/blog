          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                w={220}
                h={34}
                label="프라이버시 보호 + 건전성 검증"
                sub="개별 잔고 비공개 / 전체 준비금 증명"
                color={C.purple}
              />
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                h={52}
                label="부채 미반영"
                sub="자산 100, 부채 90이면 순자산 10이지만 '100 보유'로 표시"
                color={C.red}
              />
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                모범 VASP: 법적 의무 + 기술적 PoR 모두 제공하여 신뢰 구축
              </text>
            </motion.g>
          )}
        </svg>
