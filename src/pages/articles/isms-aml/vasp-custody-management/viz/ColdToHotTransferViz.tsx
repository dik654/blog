        ...
        >
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                ...
                return (
                  <g key={i}>
                    <circle
                      ...
                      r={20}
                      fill="var(--card)"
                      stroke={signed ? C.green : C.slate}
                      strokeWidth={signed ? 1.5 : 0.5}
                    />
                    <text
                      x={cx}
                      y={56}
              ...
              >
                1명 매수·분실에도 안전 | 키 보유자는 서로 다른 부서·장소에 분산
                배치
              </text>
            </motion.g>
          )}
