          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={220}
                h={38}
                label="블록체인 자산은 복구 불가"
                sub="전통 금융보다 더 엄격한 재위탁 금지"
                color={C.red}
              />
            </motion.g>
          )}
