        ...
        >
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={170} y={68} fontSize={9} fill="var(--foreground)">
                1. 주소 및 성명
              </text>
              <text x={170} y={84} fontSize={9} fill="var(--foreground)">
                2. 가상자산 종류 및 수량
              </text>
              <text x={170} y={100} fontSize={9} fill="var(--foreground)">
                3. 가상자산주소(고유 ID)
              </text>
