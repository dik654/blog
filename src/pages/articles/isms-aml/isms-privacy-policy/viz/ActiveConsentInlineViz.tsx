...
const STEPS = [
  {
    label: "적극적 동의 4요건",
    body: "명확한 고지 → 적극적 의사표시(사전 체크 금지) → 개별 동의(필수/선택/제3자/마케팅 분리) → 중요사항 강조(민감정보 표시).",
  },
  {
    label: "포괄 동의의 위험",
    body: '"모두 동의합니다" 단일 체크박스는 제22조 위반, 과태료 대상. 필수/선택/제3자/마케팅을 각각 별도 체크박스로 분리해야 유효.',
  },
  {
    label: "마케팅 동의 특칙",
    body: "서비스 동의와 별도 분리. 2년마다 재동의 필요. 야간(21시~08시) 별도 동의. 모든 광고에 무료 수신 거부 안내.",
  },
];
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                ISMS-P 심사: 실제 가입 화면에서 선택항목 미동의 가입 가능 여부
                확인
              </text>
            </motion.g>
          )}
