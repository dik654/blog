...
const STEPS = [
  {
    label: "동의 철회 원칙",
    body: '정보주체는 언제든 동의 철회 가능(제37조). 핵심: "수집 경로보다 쉬운 방법으로 철회 가능해야." 요청 후 10일 이내 처리 완료 의무.',
  },
  {
    label: "동의 기록 보관 4종",
    body: "입증 책임은 처리자에게 있다. 동의 일시(초 단위), 동의 방법, 동의 내용(처리방침 버전), 동의 버전 번호를 5년간 보관.",
  },
];
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                입증 책임 = 개인정보처리자 (정보주체가 "동의한 적 없다" 주장 시
                처리자가 증명)
              </text>
              ...
              <StatusBox
                ...
                w={200}
                h={36}
                label="보관 기간: 5년 (버전은 영구)"
                sub="ISMS-P 심사 시 증적 제출 대상"
                color={C.ok}
              />
            </motion.g>
          )}
