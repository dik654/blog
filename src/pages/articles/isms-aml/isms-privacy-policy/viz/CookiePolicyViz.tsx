...
const STEPS = [
  {
    label: "쿠키의 4가지 유형",
    body: "필수(세션ID) — 동의 불필요. 분석(GA)·기능(다크모드)·광고(Pixel) — 사전 동의 필요. 유형별 분류가 정책의 출발점.",
  },
  {
    label: "쿠키 배너: 동의 UI",
    body: "정보통신망법 제22조의2 — 브라우저 저장 정보 접근 시 동의 필수. 수락·거부 동등 배치, 유형별 토글 제공.",
  },
  {
    label: "쿠키 보안 속성 3종",
    body: "HttpOnly(XSS 방어), Secure(HTTPS 전용), SameSite(CSRF 방어) — VASP는 금융 특성상 3종 모두 적용 권장.",
  },
  {
    label: "쿠키 외 추적 기술",
    body: "웹 비콘, localStorage, 핑거프린팅, SDK 추적 — 쿠키와 동일한 동의 의무 적용. 처리방침에 사용 여부 기재 필수.",
  },
];
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <rect
                ...
                fill={C.essential}
              />
              <text x={90} y={66} fontSize={8} fill="var(--muted-foreground)">
                필수 (항상 활성)
              </text>
              ...
              <rect
                ...
                strokeWidth={1}
              />
              <text x={220} y={66} fontSize={8} fill="var(--muted-foreground)">
                분석
              </text>
              ...
              <rect
                ...
                strokeWidth={1}
              />
              <text x={300} y={66} fontSize={8} fill="var(--muted-foreground)">
                기능
              </text>
              ...
              <rect
                ...
                strokeWidth={1}
              />
              <text x={380} y={66} fontSize={8} fill="var(--muted-foreground)">
                광고
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                VASP 권장: HttpOnly; Secure; SameSite=Strict 3종 모두 적용
                (ISMS-P 2.10 점검)
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={280}
                h={30}
                label="처리방침에 사용 여부·목적 기재 필수"
                sub="핑거프린팅은 거부 어려움 → 동의 근거 더 명확히"
                color={C.danger}
              />
            </motion.g>
          )}
