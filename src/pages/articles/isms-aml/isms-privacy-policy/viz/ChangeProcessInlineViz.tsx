...
const STEPS = [
  {
    label: "변경 사유 발생 → CPO 검토",
    body: "새 항목 수집, 제3자 제공 추가, 보유기간 변경 등이 발생하면 CPO가 변경안을 검토하고 법적 적합성을 확인한다.",
  },
  {
    label: "사전 고지 → 게시 및 시행",
    body: "변경 시행 7일 전(중요 사항 30일 전) 홈페이지 공지. 시행일에 처리방침 교체 후 이전 버전은 아카이브 보관.",
  },
  {
    label: "심사 증적 세트",
    body: "ISMS-P 심사에서 요구하는 변경 이력 증적: 변경 일자, 전후 비교표, 사전 고지 화면 캡처, CPO 검토 서명.",
  },
];
