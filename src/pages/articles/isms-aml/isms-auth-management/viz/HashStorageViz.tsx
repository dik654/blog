          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.danger}
              >
                MD5/SHA-1은 연산 속도가 빨라 무차별 대입에 취약 →
                bcrypt/scrypt/Argon2 필수
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                color={C.primary}
              />
              <text x={105} y={64} fontSize={8} fill={C.action}>
                + salt_A
              </text>
              ...
              <DataBox
                ...
                color={C.primary}
              />
              <text x={105} y={92} fontSize={8} fill={C.action}>
                + salt_B
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                무차별 대입: 초당 수십억 회 시도 → cost=12 기준 초당 4회로 제한
              </text>
              <text
                x={240}
                y={180}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                ISMS 심사: "구 해시 잔존 비율" 확인 → 100% bcrypt 전환 목표
              </text>
            </motion.g>
          )}
        </svg>
