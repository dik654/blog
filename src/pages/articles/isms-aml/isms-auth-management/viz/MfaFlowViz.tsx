        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                비밀번호만으로는 접근 불가 — 반드시 다른 범주(소유)를 추가 검증
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                color={C.primary}
              />
              <text x={130} y={134} fontSize={8} fill="var(--muted-foreground)">
                +
              </text>
              <DataBox
                x={140}
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                클라이언트와 서버가 동일 시드를 보유 → 같은 시간에 같은 코드를
                독립 계산
              </text>
              <text
                x={240}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={160} y={60} fontSize={8} fill={C.action}>
                재시도 허용
              </text>
              <text
                x={160}
              ...
              <text x={410} y={60} fontSize={8} fill={C.action}>
                재입력 허용
              </text>
              <text
                x={410}
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                공격자가 비밀번호를 탈취해도 OTP(소유 요소) 없이는 2차를 통과
                불가
              </text>
              <text
                x={240}
                ...
                fill={C.safe}
              >
                두 요소가 독립적이므로 동시에 탈취해야 공격 성공 → 난이도
                기하급수적 증가
              </text>
            </motion.g>
          )}
