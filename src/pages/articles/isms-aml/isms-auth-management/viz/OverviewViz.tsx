        ...
        >
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={105} y={56} fontSize={7} fill={C.danger}>
                종료
              </text>
              ...
              <AlertBox
                ...
                h={60}
                label="계정 공유"
                sub="하나의 관리자 계정을 여러 명 사용 → 행위 추적 불가 → 사고 발생 시 책임자 특정 불가"
                color={C.danger}
              />
              <AlertBox
                x={250}
                ...
                h={60}
                label="세션 하이재킹"
                sub="공격자가 세션 토큰 탈취 → 정상 사용자와 동시 접속 → 탐지 어려움"
                color={C.danger}
              />
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={246} y={135} fontSize={7} fill={C.mfa}>
                필요 시
              </text>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                개인이 아닌 역할(Role)에 권한 부여 → 부서 이동 시 역할만 재배정
              </text>
              <text
                x={240}
                y={210}
                ...
                fill={C.mfa}
              >
                VASP 역할 예시: 거래 모니터링 담당자, 월렛 운영자, KYC 심사자
              </text>
            </motion.g>
          )}
        </svg>
