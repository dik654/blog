        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                임시 권한의 핵심: 만료일 없는 권한 부여 = 영구 권한 = 위험
              </text>
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={145} y={22} fontSize={8} fontWeight={600} fill={C.deny}>
                당일
              </text>
              <ActionBox
                x={120}
                ...
                color={C.deny}
              />
              <text x={160} y={70} fontSize={8} fill="var(--muted-foreground)">
                삭제 X (감사추적)
              </text>
