        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                길이 4자 증가 → 탐색 공간 47만 배 확대. 복잡도보다 길이가
                엔트로피 기여도 높음
              </text>
              <text
                x={240}
                ...
                fill={C.policy}
              >
                금지: abc/123(연속), aaa(반복), 아이디 포함, 사전 단어,
                qwerty(키보드 배열)
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                bcrypt: salt 자동 포함 → 동일 PW라도 다른 해시. cost factor↑ →
                수백ms/회
              </text>
              <text
                x={240}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={253} y={16} fontSize={7.5} fill={C.safe}>
                N
              </text>
              <StatusBox
                x={278}
              ...
              <text x={253} y={47} fontSize={7.5} fill={C.danger}>
                Y
              </text>
              <AlertBox
                x={278}
