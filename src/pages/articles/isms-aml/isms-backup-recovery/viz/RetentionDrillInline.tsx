        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text x={130} y={40} fontSize={9} fill="var(--muted-foreground)">
                6개월
              </text>
              <text x={230} y={40} fontSize={9} fill="var(--muted-foreground)">
                1년
              </text>
              <text x={340} y={40} fontSize={9} fill="var(--muted-foreground)">
                3년
              </text>
              <text x={440} y={40} fontSize={9} fill="var(--muted-foreground)">
                5년
              </text>
