        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                백업 = 업무 연속성(Business Continuity)의 핵심
              </text>
            </motion.g>
          )}
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                증분 체인 중간 손상 시 이후 복원 불가 — 차등이 더 안전
              </text>
            </motion.g>
          )}
        </svg>
