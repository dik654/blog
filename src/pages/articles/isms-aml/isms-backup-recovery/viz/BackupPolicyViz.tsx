          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={195}
                h={30}
                label="2인 승인 이중 통제 (Dual Control)"
                sub=""
                color={C.red}
              />
              ...
              <DataBox
                ...
                w={300}
                h={30}
                label="백업 접근 = 원본 동일 수준 보안"
                sub="백업이 유출 경로가 되지 않도록"
                color={C.red}
              />
            </motion.g>
          )}
