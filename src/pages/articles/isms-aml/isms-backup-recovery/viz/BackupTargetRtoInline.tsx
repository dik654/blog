          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <line
                ...
                strokeWidth={1}
              />
              <text x={40} y={50} fontSize={9} fill="var(--muted-foreground)">
                사고 발생
              </text>
              ...
              <text x={300} y={50} fontSize={9} fill={C.green}>
                서비스 재개
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--foreground)"
              >
                주 1회 전체 + 매일 증분(또는 차등) = 공간 효율 + 복원 편의 균형
              </text>
              <text
                x={235}
                y={143}
