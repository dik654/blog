        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                제로데이는 WAF 규칙 추가 + 기능 비활성화로 임시 방어
              </text>
            </motion.g>
          )}
