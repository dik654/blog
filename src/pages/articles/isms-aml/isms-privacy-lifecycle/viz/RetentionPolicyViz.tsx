        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={240}
                h={38}
                label="분리보관 접근: 사전 승인 + 사유 기록 + 로그 2년"
                sub="CPO/CISO 사전 승인 없이 접근 불가"
                color={C.destroy}
              />
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={320}
                h={34}
                label="VASP: 지갑 잔액 존재 시 자산 보관 의무 충돌"
                sub="분리보관 + 자산 인출 안내 병행 필요"
                color={C.retain}
              />
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                파기 대장은 최소 3년 보관 — ISMS-P 심사 시 제출
              </text>
            </motion.g>
          )}
        </svg>
