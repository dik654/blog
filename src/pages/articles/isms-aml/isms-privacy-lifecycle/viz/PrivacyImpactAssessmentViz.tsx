        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                민간기업은 의무 아니나 ISMS-P 심사 시 수행 여부 확인
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.warn}
              >
                VASP 중점: Travel Rule 이행 시 제공 항목 최소화
              </text>
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                KYC 침해 = 이용자 신분증 유출 → PIA로 사전 위험 제거 필수
              </text>
            </motion.g>
          )}
