...
const STEPS = [
  {
    label: "PIA vs ISMS-P 심사: 5가지 차이",
    body: "시점(사전 vs 사후), 범위(특정 시스템 vs 조직 전체), 목적(위험 분석 vs 적합성 검증), 수행 주체(내부/외부 vs 인증기관), 결과(영향평가서 vs 적합/부적합).",
  },
  {
    label: "상호보완 관계와 VASP 권장 사항",
    body: "PIA는 새 시스템 도입 시 위험 사전 제거, ISMS-P는 운영 중 관리체계 지속 검증. 양쪽 모두 수행하여 개인정보 보호 전체 생명주기를 관리하는 것이 이상적.",
  },
];
