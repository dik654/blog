          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ModuleBox
                ...
                color={C.corp}
              />
              <text x={320} y={100} fontSize={8} fill={C.corp}>
                100% 보유
              </text>
              ...
              <ModuleBox
                ...
                color={C.corp}
              />
              <text x={320} y={152} fontSize={8} fill={C.trace}>
                30% 보유
              </text>
