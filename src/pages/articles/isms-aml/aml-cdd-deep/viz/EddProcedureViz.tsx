        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                자금출처: "이번 거래의 돈" / 자산출처: "전체 재산의 형성 경로" —
                범위가 다르다
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={280}
                h={40}
                label="퇴직 직후 세탁 시도 가능성"
                sub="축적한 부정 자금의 세탁 타이밍"
                color={C.edd}
              />
              <text
                x={240}
                ...
                fill="var(--muted-foreground)"
              >
                2012년 FATF 개정: 외국 PEP뿐 아니라 내국인 PEP도 EDD 대상
              </text>
            </motion.g>
          )}
        </svg>
