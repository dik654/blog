          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                위험기반 접근법(RBA) — 위험 수준에 따라 CDD 강도 조절
              </text>
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ActionBox
                ...
                w={190}
                h={38}
                label="2003년: 외국 PEP만 대상"
                sub="Foreign PEP only"
                color={C.low}
              />
              ...
              <AlertBox
                ...
                w={240}
                h={34}
                label="퇴직 후 12~24개월 EDD 유지"
                sub="퇴직 직후 부정 자금 세탁 방지"
                color={C.edd}
              />
            </motion.g>
          )}
          ...
          {step === 3 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ModuleBox
                ...
                w={220}
                h={48}
                label="지속적 CDD (Ongoing)"
                sub="기존 고객 정보의 지속적 갱신·재평가"
                color={C.cdd}
              />
              ...
              <AlertBox
                ...
                w={225}
                h={42}
                label="의심 거래 감지 시 즉시 전환"
                sub="SDD → CDD 또는 EDD로 격상"
                color={C.pep}
              />
