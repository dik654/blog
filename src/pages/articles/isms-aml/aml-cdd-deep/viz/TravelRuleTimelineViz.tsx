...
function Arrow({
  ...
  return (
    <line
      ...
      stroke={color}
      strokeWidth={1}
      markerEnd="url(#tr-timeline-arrow)"
    />
  );
}
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                w={240}
                h={28}
                label="85/117국 입법 완료·진행 (FATF 6차)"
                color={C.fatf}
              />
              <text
                x={240}
                ...
                fill="var(--muted-foreground)"
              >
                100만 원 기준은 구조화(structuring)로 우회 가능 → 기준 하향 추진
              </text>
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill="var(--muted-foreground)"
              >
                프라이버시 vs 자금세탁 방지 — 균형이 향후 입법의 핵심 쟁점
              </text>
            </motion.g>
          )}
        </svg>
