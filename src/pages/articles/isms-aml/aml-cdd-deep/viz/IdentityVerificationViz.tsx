          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <text
                ...
                fill={C.verify}
              >
                수집(Identification) 완료 → 검증(Verification) 단계로
              </text>
              <text
                x={240}
                y={128}
              ...
              <AlertBox
                ...
                h={44}
                label="직업: 합리성 판단의 기준"
                sub="월 소득 300만 원 고객이 매월 5억 입금 → 의심거래"
                color={C.warn}
              />
            </motion.g>
          )}
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <DataBox
                ...
                color={C.verify}
              />
              <text x={400} y={181} fontSize={8} fill={C.warn}>
                → 간접 30% 지분
              </text>
            </motion.g>
          )}
