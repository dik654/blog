        ...
        >
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 순환 표시 */}
              <motion.path
                d="M 448 52 Q 468 52 468 100 Q 468 200 240 200 Q 10 200 10 100 Q 10 77 10 76"
                fill="none"
                stroke={C.ctrl}
                strokeWidth={0.8}
                strokeDasharray="4 3"
          ...
          {step === 4 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              />
              <text x={275} y={43} fontSize={8} fill="var(--muted-foreground)">
                0~30점
              </text>
              ...
              />
              <text x={275} y={63} fontSize={8} fill="var(--muted-foreground)">
                0~20점
              </text>
              ...
              />
              <text x={275} y={83} fontSize={8} fill="var(--muted-foreground)">
                0~30점
              </text>
              ...
              />
              <text x={275} y={103} fontSize={8} fill="var(--muted-foreground)">
                0~20점
              </text>
