        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              >
                하나라도 빠지면 전체 체계에 구멍 → FIU 검사 시 지적 대상
              </text>
            </motion.g>
          )}
          ...
          {step === 2 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <ModuleBox
                ...
                w={230}
                h={45}
                label="VASP AML 추가 요구사항"
                sub="24/7 · 국경 무관 · 가명 기반"
                color={C.warn}
              />
              ...
              <AlertBox
                ...
                w={240}
                h={35}
                label="기술적 역량 없이는 규제 준수 불가"
                sub="블록체인 분석 = VASP AML의 핵심 차별점"
                color={C.warn}
              />
            </motion.g>
          )}
