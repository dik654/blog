        ...
        >
          ...
          {step === 0 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {/* 순환 화살표 표시 */}
              <path
                d="M 464 60 Q 472 130 240 140 Q 8 130 5 60"
                fill="none"
                stroke={C.step}
                strokeWidth={0.8}
                strokeDasharray="4 3"
          ...
          {step === 1 && (
            <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <AlertBox
                ...
                w={240}
                h={42}
                label="잔여위험은 절대 0이 될 수 없다"
                sub="목표: 수용 가능 수준까지 낮추기"
                color={C.risk}
              />
              <text
                x={240}
                ...
                fill="var(--muted-foreground)"
              >
                새로운 세탁 수법 · 시스템 장애 · 인적 오류 → 항상 잔여위험 존재
              </text>
            </motion.g>
          )}
        </svg>
