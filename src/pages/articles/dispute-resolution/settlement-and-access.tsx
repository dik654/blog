    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 글로 법 시리즈가 끝나고 마지막 절에서 네 대분류 전체를 한 번 되짚습니다.
          </p>
        </div>
      </section>
      ...
      <section id="settlement-range" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            청구하는 쪽은 재판하면 이길 확률에 판결 금액을 곱한 값에서 소송비용을 뺀 만큼을 기대합니다. 그보다 많이 주면 합의하는 편이 낫습니다. 받는 쪽은 같은 값에 자기 소송비용을
            더한 만큼을 잃을 것으로 보므로 그보다 적게 내면 합의하는 편이 낫습니다.
          </p>

          <p className="leading-7">
            그러면 두 선이 생기고 그 사이가 합의 가능한 금액입니다. 그리고 양쪽의 기대가 같다면 이 구간은 언제나 열려 있습니다. 폭이 정확히 두 소송비용의 합이기 때문입니다.
          </p>
        </div>
      ...
      <section id="selection" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            먼저 판결의 승패 비율이 실제 분쟁의 승패 비율과 다릅니다. 예측하기 어려운 사건만 올라오므로 판결의 승률은 어느 쪽으로도 크게 기울지 않는 쪽으로 끌려갑니다.
          </p>
      ...
      <section id="shadow" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            답은 앞 절의 식 안에 이미 있습니다. 합의 구간의 위치를 정하는 것은 재판했을 때의 기대값이고 그 기대값을 정하는 것은 규칙입니다. 규칙이 바뀌면 재판을 하지 않아도 합의
            금액이 움직입니다.
          </p>
      ...
      <section id="access" className="scroll-mt-20">
        ...
        >
          <p className="leading-7">
            한 번 겪고 마는 쪽에게 이 분쟁은 한 건입니다. 앞 절의 계산이 그대로 적용되고 구간이 열리면 합의합니다.
          </p>
          <p className="leading-7">
          ...
          <p className="leading-7">
            그러면 판결로 남는 사건이 한 번 더 걸러집니다. 앞 절의 치우침 위에 이 치우침이 겹치므로 판결 기록으로 법을 읽을 때 조심해야 할 이유가 하나 더 늘어납니다.
          </p>
        </ProgressiveDetail>
      </section>
