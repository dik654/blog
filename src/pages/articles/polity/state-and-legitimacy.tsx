  ...
  return (
    <div className="space-y-16">
      ...
      <section id="why-monopoly" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            한 지역에 강제할 수 있는 집단이 셋 있다고 해 봅시다. 각자 세금을
            걷고 각자 규칙을 정합니다. 그러면 같은 사람이 세 번 걷히고, 세 규칙이
            충돌할 때 어느 쪽을 따라야 하는지 정해지지 않습니다. 결국 힘으로
            겨루게 되고, 그 과정에서 생산은 멈춥니다.
          </p>
      ...
      <section id="protection-or-predation" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            여기서 불편한 사실이 하나 나옵니다. 강제력을 독점한 조직과 큰 강도
            집단은 하는 일의 형식이 비슷합니다. 둘 다 힘으로 재물을 가져가고,
            둘 다 그 힘에 저항하기 어렵습니다. 그렇다면 무엇이 다를까요.
          </p>
          ...
          <p className="leading-7">
            그래서 머물기로 한 쪽은 스스로 걷는 양을 줄이고, 심지어 생산을 늘려
            주는 일을 하게 됩니다. 도로를 놓고 도둑을 막아 주면 내년에 걷을
            것이 늘어납니다. 자기 이익을 위한 선택이 결과적으로 공공재 공급이
            되는 것입니다.
          </p>

          <p className="leading-7">
            이 논리는 국가의 기원을 설명하는 여러 이야기 가운데 하나이고, 국가가
            좋은 것이라는 증명이 아닙니다. 오히려 반대로 읽어야 합니다. 통치자의
            시간지평이 짧아지면 같은 논리가 약탈 쪽으로 다시 기웁니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            그래서 이 지점에서 두 갈래가 생깁니다. 겹치는 구간을 넓히려면 통치자의
            시간지평을 길게 만들거나, 통치자가 마음대로 정하지 못하게 제약을
            걸어야 합니다. 앞은 이 글의 남은 절이, 뒤는 다음 글이 다룹니다.
          </p>
        </ProgressiveDetail>
      </section>
      ...
      <section id="legitimacy" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            강제만으로 통치하려면 비용이 감당되지 않습니다. 모든 사람을 감시하고
            모든 위반을 적발해야 하는데, 그 일을 할 사람들도 다시 감시해야
            합니다. 실제로는 대부분의 사람이 대부분의 경우 스스로 따르기 때문에
            통치가 굴러갑니다.
          </p>
          ...
          <p className="leading-7">
            여기서 오해하기 쉬운 지점이 있습니다. 정당성은 &ldquo;정당하다&rdquo;
            는 판단이 아니라 &ldquo;정당하다고 받아들여지고 있다&rdquo;는 사실
            기술입니다. 나쁜 체제도 정당성을 가질 수 있고, 좋은 제도도 정당성을
            잃을 수 있습니다.
          </p>
        </div>
      ...
      <section id="state-capacity" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            능력은 크게 셋으로 나뉩니다. 사회를 들여다보는 정보 역량, 걷는 징세
            역량, 그리고 결정을 물리적으로 관철하는 집행 역량입니다. 셋은 서로
            맞물려 있어서, 정보가 없으면 걷을 수 없고 걷지 못하면 집행할 자원이
            없습니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이 글은 강제력이 왜 한 곳에 몰리고 어떤 조건에서 그 체제가 유지되는지
            를 보였습니다. 유지 조건을 설명한 것이지 그 체제가 옳다고 말한 것이
            아닙니다. 앞 절의 부등식은 폭정에서도 똑같이 성립합니다.
          </p>

          <p className="leading-7">
            오히려 이 글의 논리가 불편한 결론을 하나 담고 있습니다. 통치자의
            이익과 사회의 이익이 겹치는 구간은 조건부라는 것입니다. 시간지평이
            짧아지거나 순응이 공포로만 유지되면 그 구간은 좁아집니다.
          </p>

          <p className="leading-7">
            그래서 다음 질문은 이것입니다. 힘을 쥔 쪽의 선의나 계산에 기대지
            않고, 그 힘이 함부로 쓰이지 못하게 미리 묶어 둘 수 있는가입니다.
          </p>
