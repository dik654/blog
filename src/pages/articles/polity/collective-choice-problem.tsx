  ...
  return (
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            점심 메뉴는 각자 고르면 됩니다. 내가 짜장면을 골라도 옆 사람은 짬뽕을 먹을 수 있습니다. 그런데 국방을 얼마나 할지, 세율을 몇 퍼센트로 할지, 어느 쪽으로 차를 몰지는
            그렇지 않습니다. 한 사회에 하나만 존재할 수 있고 정해지면 반대한 사람에게도 그대로 적용됩니다.
          </p>

          <p className="leading-7">
            정치는 이런 결정을 다루는 일입니다. 그리고 이 성질 하나에서 뒤따르는 거의 모든 것이 나옵니다. 하나로 정해야 하니 결정을 강제할 힘이 필요하고 그 힘이 생기면 그것을 제어할
            장치가 필요하며, 누가 그 힘을 쓸지 정하는 절차가 필요해집니다.
          </p>

          <p className="leading-7">
            그림을 먼저 보여 드리는 이유가 있습니다. 뒤따르는 글들이 국가·헌법·선거·관료제·국제질서처럼 서로 다른 주제처럼 보이지만 실은 이 한 줄기를 한 칸씩 따라가는 일이기
            때문입니다.
          </p>
        </div>
      ...
      <section id="two-kinds-of-choice" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            기준은 단순합니다. 돈을 내지 않은 사람을 못 쓰게 막을 수 있으면 각자 고르는 문제이고 막을 수 없으면 하나로 정해야 하는 문제입니다. 영화표는 안 산 사람을 입장시키지 않을
            수 있지만 깨끗한 공기나 국방은 세금을 안 낸 사람만 골라 빼놓을 수 없습니다.
          </p>

          <p className="leading-7">
            두 번째 기준이 하나 더 있습니다. 한 사람이 쓴다고 남이 쓸 몫이 줄어드는가입니다. 빵은 내가 먹으면 남은 양이 줄지만 등대 불빛은 배 한 척이 더 본다고 어두워지지
            않습니다. 앞을 경합적, 뒤를 비경합적이라 합니다.
          </p>
      ...
      <section id="free-riding" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이것은 누군가의 못된 심성이 아닙니다. 모두가 공공재를 원하고 모두가 그것이 필요하다고 믿어도 각자에게는 내지 않는 편이 유리합니다. 그래서 모두가 원하는 것이 아무도 내지
            않아 만들어지지 않습니다.
          </p>

          <p className="leading-7">
            더 나쁜 것은 집단이 커질수록 이 유인이 강해진다는 점입니다. 내가 낸 돈이 만들어 낸 혜택을 여럿이 나눠 가지므로 사람이 많을수록 내 몫이 작아집니다. 그래서 큰 집단일수록
            자발적 공급이 어렵습니다.
          </p>
        </div>
      ...
      <section id="self-governance" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            전제를 다시 봅시다. 기여 여부가 남에게 보이지 않는다고 했고 한 번만 만난다고 했습니다. 작은 마을에서 대대로 같은 사람들이 같은 수로를 쓴다면 두 전제가 모두 깨집니다.
            누가 물을 더 가져갔는지 보이고 내년에도 같은 사람들과 마주쳐야 합니다.
          </p>

          <p className="leading-7">
            그래서 질문이 &ldquo;자치가 가능한가&rdquo;에서 &ldquo;어떤 조건에서 가능한가&rdquo;로 바뀝니다. 오래 유지된 사례들을 모아 보면 반복해서 나타나는 조건이
            있습니다.
          </p>
        </div>
        ...
        <div id="scale-limit" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              점검 항목을 다시 보면 공통점이 보입니다. 서로를 알아볼 수 있고 계속 마주치고 규칙을 함께 만들 수 있을 만큼 작아야 한다는 것입니다. 마을 수로에서는 가능하지만 오천만
              명의 국방에서는 성립하지 않습니다.
            </p>

            <p className="leading-7">
              국방을 예로 들면 누가 얼마나 기여했는지 서로 알 수 없고 규칙을 함께 만드는 자리에 모두가 참여할 수도 없으며, 감시도 불가능합니다. 앞 식의 세 전제가 전부
              되살아납니다.
            </p>

            <p className="leading-7">
              그래서 규모가 커지면 남는 선택지가 좁아집니다. 자발적 기여에 맡기거나 아니면 내지 않는 사람에게서도 강제로 걷는 것입니다. 앞은 방금 본 이유로 작동하지 않습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="coercion" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            강제로 걷으면 앞의 문제가 풀립니다. 내지 않는 쪽이 이득이라는 계산 자체가 사라지기 때문입니다. 세금을 안 내면 불이익이 오므로 각자 합리적으로 판단해도 내는 쪽을 고르게
            됩니다.
          </p>

          <p className="leading-7">
            그런데 이 해법은 조건을 하나 요구합니다. 강제할 수 있는 힘이 실제로 있어야 합니다. 그리고 그 힘은 공공재를 만드는 데만 쓰이는 것이 아니라 다른 데에도 쓸 수 있습니다.
            걷은 돈을 국방에 쓸지 자기 주머니에 넣을지는 힘을 쥔 쪽이 정합니다.
          </p>
        ...
        >
          <p className="leading-7">
            빼놓을 수 없다는 성질 자체를 바꾸는 길이 있습니다. 배제할 수 있게 만들면 사적재처럼 다룰 수 있습니다. 유료도로에 요금소를 세우거나 어장에 소유권을 설정해 주인이 관리하게
            하는 식입니다. 기술이 바뀌면 배제 가능성도 바뀌므로 이 경계는 고정된 것이 아닙니다.
          </p>
          <p className="leading-7">
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            이 글의 논증은 &ldquo;각자에게 맡기면 과소 공급된다&rdquo;까지만 보였습니다. 여기서 &ldquo;그러므로 정부가 공급하면 된다&rdquo;로 건너뛰면 한 단계를
            빠뜨린 것입니다. 정부도 사람이 운영하고 그 사람들에게도 각자의 유인이 있습니다.
          </p>
