    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            순서는 이렇습니다. 먼저 구별할 수 없을 때 값이 평균에 붙는다는 것을
            보고, 그 값이 좋은 쪽을 밀어내는 과정을 셉니다. 그다음 아는 쪽이
            값비싼 표시를 보내 갈라지는 길과 그 값이 어디로 가는지를 보고,
            마지막으로 계약을 맺은 뒤에 행동이 바뀌는 다른 종류의 문제를
            봅니다.
          </p>

          <p className="leading-7">
            숨기는 쪽이 나쁜 사람이라는 이야기는 하지 않습니다. 좋은 차를 가진
            사람도 자기 차가 좋다고 말할 수는 있지만, 그 말을 나쁜 차를 가진
            사람도 똑같이 할 수 있어서 아무 일도 하지 못합니다.
          </p>
        </div>
      </section>
      ...
      <section id="pooling" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            어느 대를 봐도 산 쪽이 더 높게 칩니다. 그러니 여섯 대 모두 거래되는
            것이 맞고, 그때 생기는 것이 1, 2, 3, 4, 5, 6을 더한 21입니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            논문이 든 장치들도 마찬가지입니다. 보증과 상호와 자격증은 전부 값이
            드는 것들이고, 그 값을 빼고 나서도 남는 것이 있을 때만 이득입니다.
          </p>

          <p className="leading-7">
            그리고 앞 절에서 본 대로 갈라내는 것이 모두를 낫게 하지는
            않습니다. 잘하는 쪽까지 손해를 보는 경우가 있고, 논문 자신의 수치가
            그 경우입니다.
          </p>
          ...
          <p className="leading-7">
            그 사이 어디인지를 재는 일은 이 글이 하지 않았습니다. 자격증이
            갈라내기만 하는지 실제로 사람을 낫게도 하는지는 숫자로 가려야 할
            문제이고, 이 글의 계산은 한쪽 끝을 재어 본 것입니다.
          </p>

          <p className="leading-7">
            여기까지가 값이 놓치는 것들입니다. 값에 안 적히는 몫, 빼놓을 수
            없는 것, 한쪽만 아는 것 세 가지를 차례로 보았습니다. 다음 글은
            자리를 옮겨, 이 모든 결정을 다 합치면 무엇이 보이고 무엇이 안
            보이는지를 봅니다.
          </p>
        </div>
      </section>
