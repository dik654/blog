  ...
  return (
    <section id="validator-api" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>Epoch의 proposer duty를 받았다는 사실만으로 서명할 수 있는 것은 아닙니다. Response의 dependent root와 validator index·slot을 scheduler에 넣고, deadline 전에 unsigned object를 받은 뒤 local slashing protection이 같은 duty/signing root를 허용할 때만 key를 사용합니다.</p>
        ...
        <p>Base/candidate의 OpenAPI commit·Prysm SHA·fork·state/duty fixture·authorization policy를 고정합니다. REST JSON/SSZ와 gRPC의 resolved root·typed value·status를 비교하고, unsupported media, head reorg, stale duty, unauthorized effect, timeout-after-publish, SSE disconnect와 restart를 주입합니다. Effect count·signing intent·response root·reconciliation outcome이 같아야 p50·p95를 비교할 수 있습니다.</p>
