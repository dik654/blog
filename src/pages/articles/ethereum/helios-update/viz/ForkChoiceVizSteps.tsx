...
export function Step0() {
  ...
  return (
    <g>
        ...
        return (
          <motion.g key={u.label} {...fade(i * 0.15)}>
            ...
            <text
              ...
              fontSize={10}
              fontWeight={700}
              fill={isBest ? C.best : "var(--foreground)"}
            >
              {u.label}
            </text>
            ...
            <text
              ...
              fontSize={9}
              fontWeight={600}
              fill={parseInt(u.participants) >= 480 ? C.fin : C.alert}
            >
              {u.participants}
            </text>
            ...
            <text
              ...
              fontSize={8}
              fontWeight={600}
              fill={u.type === "Finality" ? C.fin : C.opt}
            >
              {u.type}
            </text>
            ...
            <motion.g {...fade(0.6 + i * 0.1)}>
              ...
              <text
                ...
                fontSize={7}
                fontWeight={700}
                fill={isBest ? "#fff" : "var(--muted-foreground)"}
              >
                #{u.rank}
              </text>
            </motion.g>
      ...
      <motion.line
        x1={startX + cardW + gap + cardW / 2}
        y1={cardH + 32}
        x2={startX + cardW + gap + cardW / 2}
        y2={cardH + 50}
        stroke={C.best}
        strokeWidth={1.2}
        markerEnd="url(#arrowBest)"
        {...drawLine(0.8)}
      />
      ...
      <motion.g {...fade(1.0)}>
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          B가 최선: 참여자 480명(C와 동일) + Finality 타입(C는 Optimistic) → B
          선택
        </text>
      </motion.g>
    ...
    <g>
      ...
      <motion.g {...fade(0.9)}>
        ...
        <text
          ...
          fill="var(--muted-foreground)"
        >
          optimistic_header 포인터 교체 — 상태 롤백 없음
        </text>
      </motion.g>
