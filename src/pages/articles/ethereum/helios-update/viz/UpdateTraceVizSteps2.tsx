  ...
  return (
    <g>
      ...
      >
        ...
        <text x={38} y={60} fontSize={7} fill="var(--muted-foreground)">
          ~12분 간격 갱신
        </text>
      </motion.g>
      ...
      >
        ...
        <text x={38} y={120} fontSize={7} fill="var(--muted-foreground)">
          매 12초 갱신
        </text>
      </motion.g>
      ...
      >
        ...
        />
        <text x={460} y={136} fontSize={8} fontWeight={600} fill={C.optimistic}>
          최신
        </text>
      </motion.g>
