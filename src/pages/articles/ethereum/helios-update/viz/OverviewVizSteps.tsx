    ...
    <g>
      ...
      >
        <ModuleBox
          ...
          w={90}
          h={46}
          label="LightClientStore"
          sub="finalized + optimistic"
          color={C.loop}
        />
      </motion.g>
      ...
      >
        <rect
          ...
          strokeWidth={0.8}
        />
        <text x={109} y={48} textAnchor="middle" fontSize={7} fill={C.loop}>
          12s
        </text>
      </motion.g>
...
export function Step1() {
  ...
  return (
    <g>
      {/* ── Optimistic 영역 ── */}
      <text x={tlX} y={18} fontSize={9} fontWeight={700} fill={C.opt}>
        OptimisticUpdate
      </text>
      <text x={tlX + 160} y={18} fontSize={7.5} fill="var(--muted-foreground)">
        매 12초 · 빠르지만 reorg 가능
      </text>
      ...
      {/* ── Finality 영역 ── */}
      <text x={tlX} y={98} fontSize={9} fontWeight={700} fill={C.fin}>
        FinalityUpdate
      </text>
      <text x={tlX + 130} y={98} fontSize={7.5} fill="var(--muted-foreground)">
        ~12.8분 · 느리지만 되돌릴 수 없음
      </text>
