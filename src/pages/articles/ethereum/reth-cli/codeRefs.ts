...
export const codeRefs: Record<string, CodeRef> = {
  "cli-main": {
    ...
    annotations: [
      ...
      { lines: [10, 11], color: "emerald", note: "clap 파싱 → run 콜백" },
      {
        lines: [14, 14],
        color: "amber",
        note: "EthereumNode::default()로 한 번에",
      },
  ...
  "builder-struct": {
    path: "crates/node/builder/src/builder/mod.rs",
    lang: "rust",
    highlight: [3, 8],
  ...
  "builder-states": {
    path: "crates/node/builder/src/builder/states.rs",
    lang: "rust",
    highlight: [3, 28],
    ...
    annotations: [
      { lines: [4, 7], color: "sky", note: "타입 확정, 컴포넌트 미설정" },
      {
        lines: [11, 18],
        color: "emerald",
        note: "CB: NodeComponentsBuilder 제약",
      },
    ],
    code: statesSrc,
  },
    ...
    annotations: [
      {
        lines: [35, 35],
        color: "amber",
        note: "components_builder로 런타임에 빌드",
      },
  ...
  "node-components": {
    path: "crates/node/builder/src/components/mod.rs",
    lang: "rust",
    highlight: [3, 21],
    desc: "NodeComponents trait — Pool/Evm/Consensus/Network 계약과 payload handle",
    annotations: [
  ...
  "components-struct": {
    ...
    lang: "rust",
    highlight: [24, 32],
    desc: "Components struct — 실행 컴포넌트와 payload handle을 묶는 컨테이너",
    annotations: [
      {
        lines: [26, 30],
        color: "rose",
        note: "구성된 컴포넌트와 payload handle",
      },
    ],
    code: componentsSrc,
  },
