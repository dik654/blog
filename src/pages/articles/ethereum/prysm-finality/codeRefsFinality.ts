    ...
    annotations: [
      {
        lines: [8, 9],
        color: "violet",
        note: "이전보다 낮은 에폭의 체크포인트는 거부",
      },
      {
        lines: [11, 11],
        color: "emerald",
        note: "justifiedCheckpoint 포인터 교체",
      },
    ],
  },
  "prune-finalized": {
    ...
    annotations: [
      ...
      { lines: [33, 33], color: "emerald", note: "하위 노드 재귀 삭제" },
      {
        lines: [34, 35],
        color: "sky",
        note: "finalized 노드를 새 루트로 승격, parent 해제",
      },
    ],
  },
  "weak-subjectivity": {
    ...
    annotations: [
      {
        lines: [11, 11],
        color: "violet",
        note: "totalBalance * 2/3 = 슈퍼마조리티 임계값",
      },
      {
        lines: [14, 18],
        color: "emerald",
        note: "이전 에폭 투표 ≥ 2/3 → justified",
      },
      {
        lines: [20, 24],
        color: "sky",
        note: "현재 에폭 투표 ≥ 2/3 → justified",
      },
      {
        lines: [29, 31],
        color: "amber",
        note: "연속 2 에폭 justified → finalized 확정",
      },
    ],
  },
};
