    ...
    annotations: [
      {
        lines: [5, 7],
        color: "violet",
        note: "nodeByRoot: 블록 루트 → 노드 매핑 (O(1) 탐색)",
      },
      {
        lines: [8, 9],
        color: "emerald",
        note: "treeRootNode / headNode: 트리의 양 끝단",
      },
      {
        lines: [10, 12],
        color: "sky",
        note: "체크포인트 + proposer boost root",
      },
    ],
  },
  "fc-insert": {
    ...
    annotations: [
      {
        lines: [31, 35],
        color: "violet",
        note: "새 Node 생성: slot, root, epoch 정보",
      },
      {
        lines: [36, 39],
        color: "emerald",
        note: "부모 노드 탐색 → 양방향 연결",
      },
