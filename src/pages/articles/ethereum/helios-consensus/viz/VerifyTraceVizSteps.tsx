...
const participantCount = Array.from({ length: 512 }, (_, i) =>
  isParticipant(i),
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={410} y={40} fontSize={8} fill="var(--foreground)">
          참여
        </text>
        <circle cx={400} cy={52} r={4} fill="var(--border)" opacity={0.35} />
        <text x={410} y={56} fontSize={8} fill="var(--muted-foreground)">
          미참여
        </text>
...
export function Step1() {
  ...
  return (
    <g>
      ...
      >
        <text
          x={barX + barW * participantRatio + 30}
          y={barY + barH / 2 + 5}
          fontSize={18}
          fontWeight={700}
          fill={C.quorum}
      ...
      >
        {participantCount} {"×"} 3 = {participantCount * 3} {"≥"} 512 {"×"} 2 =
        1024 → 통과
      </motion.text>
