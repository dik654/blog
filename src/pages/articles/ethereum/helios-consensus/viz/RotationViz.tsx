    ...
    <g>
      ...
      >
        <rect
          ...
          strokeWidth={0.8}
        />
        <text x={400} y={30} textAnchor="middle" fontSize={9} fill={C.period}>
          같은 period =
        </text>
        <text x={400} y={42} textAnchor="middle" fontSize={9} fill={C.period}>
          같은 위원회
        </text>
      </motion.g>
    </g>
  ...
  return (
    <StepViz steps={STEPS}>
      {(step) => {
        const S = R[step];
        return (
          <svg viewBox="0 0 480 60" className="w-full max-w-2xl">
            <S />
          </svg>
        );
      }}
