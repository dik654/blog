        ...
        >
          ...
          {i < 4 && (
            ...
            >
              ...
              />
              <polygon
                points={`${s.x + 104},${58} ${s.x + 100},${55} ${s.x + 100},${61}`}
                fill="var(--border)"
              />
            </motion.g>
          )}
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={316} y={119} fontSize={7.5} fill="var(--foreground)">
          참여 (bit=1): {activeCount}명
        </text>
        <circle cx={306} cy={132} r={4} fill={C.gridOff} opacity={0.3} />
        <text x={316} y={135} fontSize={7.5} fill="var(--foreground)">
          미참여 (bit=0): {512 - activeCount}명
        </text>
        <text x={306} y={146} fontSize={7} fill="var(--muted-foreground)">
          정족수: 342명 이상 (2/3)
        </text>
