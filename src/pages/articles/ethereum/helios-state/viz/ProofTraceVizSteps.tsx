  ...
  return (
    <g>
      ...
      >
        ...
        >
          주소 분포가 편향되어도 해시가 균등 → 트라이 깊이 균형 유지 (최대 64
          nibble)
        </text>
      </motion.g>
    </g>
  ...
  return (
    <g>
      ...
      >
        ...
        {/* 압축된 경로 */}
        <text x={extX - 6} y={extY + 26} fontSize={7} fill="var(--foreground)">
      ...
      >
        ...
        <text x={16} y={165} fontSize={7} fill="var(--foreground)">
          hash(child) == parent[slot]
        </text>
        <text x={16} y={178} fontSize={7} fill="var(--muted-foreground)">
          루트→리프: 해시 체인 일치 확인
        </text>
      </motion.g>
    </g>
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={350} y={116} fontSize={7} fill="var(--foreground)">
          f8: 리스트 (1바이트 길이)
        </text>
        <text x={350} y={128} fontSize={7} fill="var(--muted-foreground)">
          필드 순서 고정 (EIP-161)
        </text>
      </motion.g>
    </g>
