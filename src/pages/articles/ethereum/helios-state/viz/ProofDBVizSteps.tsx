...
export function Step1() {
  return (
    <g>
      ...
      {/* 흐름 노드들 (작게) */}
      <text x={40} y={22} fontSize={8} fontWeight={600} fill={C.evm}>
        EVM
      </text>
      <text x={70} y={22} fontSize={8} fill="var(--muted-foreground)">
        →
      </text>
      <text x={100} y={22} fontSize={8} fontWeight={600} fill={C.proofdb}>
        ProofDB
      </text>
      <text x={150} y={22} fontSize={8} fill="var(--muted-foreground)">
        →
      </text>
      <text x={180} y={22} fontSize={8} fontWeight={600} fill={C.rpc}>
        RPC 응답
      </text>
      <text x={235} y={22} fontSize={8} fill="var(--muted-foreground)">
        →
      </text>
      <text x={265} y={22} fontSize={8} fontWeight={600} fill={C.verify}>
        Merkle 검증
      </text>
      <text x={340} y={22} fontSize={8} fill="var(--muted-foreground)">
        →
      </text>
      <text x={370} y={22} fontSize={8} fontWeight={600} fill={C.verify}>
        RLP 디코딩
      </text>
      <text x={435} y={22} fontSize={8} fill="var(--muted-foreground)">
        → 값
      </text>
      ...
      <motion.g {...fade(0.5)}>
        ...
        <AlertBox
          ...
          w={160}
          h={44}
          label="MerkleMismatch"
          sub="해시가 state_root와 불일치"
          color={C.alert}
        />
        <text
          x={295}
