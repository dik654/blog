  ...
  return (
    <g>
      ...
      >
        ...
        >
          <text x={24} y={176} fontSize={7.5} fill="var(--foreground)">
      ...
      >
        ...
        >
          <DataBox
            ...
            w={160}
            h={30}
            label="items[1] = Account"
            sub="RLP(nonce, balance, ...)"
            color={C.hash}
          />
        </motion.g>
          ...
          {i < walkSteps.length - 1 && (
            <motion.line
              x1={
                ws.shape === "circle"
                  ? ws.x + 48
                  : ws.x + (ws.shape === "pill" ? 78 : 86)
              }
              y1={ws.y + 20}
              x2={
                walkSteps[i + 1].x +
                (walkSteps[i + 1].shape === "circle" ? 12 : 0)
              }
              y2={walkSteps[i + 1].y + 20}
              stroke={C.walk}
              strokeWidth={1}
              markerEnd="url(#mtArr2W)"
          ...
          return (
            ...
            >
              ...
              <circle
                ...
                stroke={ws.offset === "done" ? C.hash : C.walk}
                strokeWidth={1}
              />
              <text
                x={markerX}
