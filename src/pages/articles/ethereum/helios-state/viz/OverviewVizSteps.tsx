    ...
    <g>
      ...
      >
        <ellipse
          ...
          strokeWidth={0.8}
        />
        <rect x={138} y={rethY + 4} width={80} height={28} fill="var(--card)" />
        <line
          x1={138}
          y1={rethY + 4}
          x2={138}
    ...
    <g>
      ...
      >
        ...
        <rect
          ...
          clipPath="url(#apClip)"
        />
        <text x={18} y={48} fontSize={9} fontWeight={700} fill={C.proof}>
          accountProof
        </text>
        <text x={128} y={48} fontSize={7} fill="var(--muted-foreground)">
          상태 트라이 경로
        </text>
      ...
      >
        ...
        <rect
          ...
          clipPath="url(#spClip)"
        />
        <text x={176} y={48} fontSize={9} fontWeight={700} fill={C.rpc}>
          storageProof
        </text>
        <text x={288} y={48} fontSize={7} fill="var(--muted-foreground)">
          스토리지 트라이
        </text>
      ...
      >
        ...
        <rect
          ...
          clipPath="url(#afClip)"
        />
        <text x={334} y={48} fontSize={9} fontWeight={700} fill={C.helios}>
          account 필드
        </text>
        <text x={446} y={48} fontSize={7} fill="var(--muted-foreground)">
          계정 상태
        </text>
      ...
      >
        ...
        {[
          { item: "상태 저장", reth: "로컬 700GB+", helios: "없음 (0 디스크)" },
          {
            item: "접근 방식",
            reth: "DB 직접 읽기",
            helios: "RPC + Merkle 증명",
          },
          {
            item: "구현",
            reth: "StateProvider trait",
            helios: "ProofDB (revm)",
          },
        ].map((r, i) => (
          <g key={r.item}>
