    ...
    <g>
      ...
      >
        ...
        <rect
          ...
          strokeWidth={0.5}
        />
        <text x={414} y={85} textAnchor="middle" fontSize={7} fill={C.danger}>
          위조 노드
        </text>
      ...
      >
        ...
        <text x={370} y={158} fontSize={7} fill="var(--foreground)">
          root가 진짜이면
        </text>
        <text x={370} y={170} fontSize={7} fill="var(--muted-foreground)">
          중간 노드 위조 불가
        </text>
      </motion.g>
    </g>
    ...
    <g>
      ...
      >
        ...
        <rect
          ...
          opacity={0.7}
        />
        <text x={44} y={48} fontSize={8} fontWeight={700} fill={C.branch}>
          Branch
        </text>
      </motion.g>
      ...
      >
        {/* 활성 슬롯 위 화살표 */}
        <motion.line
          x1={44 + activeNibble * 25 + 10.5}
          y1={42}
          x2={44 + activeNibble * 25 + 10.5}
          y2={50}
          stroke={C.branch}
          strokeWidth={1.2}
          markerEnd="url(#mtArrB)"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ delay: 0.9, duration: 0.2 }}
        />
        <rect
          x={44 + activeNibble * 25 - 16}
          y={30}
          width={54}
          height={14}
          rx={4}
