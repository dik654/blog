    ...
    <section id="cursor" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-8">
        <p className="leading-7">
          ...
          커서는 B+tree의 특정 위치를 가리키는 포인터로,
          seek으로 이동하고 next로 순회한다.
          <br />
          SQL 데이터베이스의 커서와 개념이 같다.
        </p>
        <p className="leading-7">
          Reth는 커서를 두 가지 trait으로 추상화한다.
          <code>DbCursorRO</code>(읽기 전용)와 <code>DbCursorRW</code>(읽기/쓰기).
          <br />
          읽기 전용 커서는 MVCC 스냅샷 위에서 동작하므로
          다른 트랜잭션이 쓰기 중이어도 차단되지 않는다.{' '}
        ...
        <p className="leading-7">
          ...
          RPC는 특정 키를 조회하므로 <code>seek_exact</code>를 사용한다.
          <br />
