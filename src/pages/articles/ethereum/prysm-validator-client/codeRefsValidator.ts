    ...
    annotations: [
      {
        lines: [10, 11],
        color: "violet",
        note: "NextSlot 채널에서 슬롯 틱 수신",
      },
      {
        lines: [14, 18],
        color: "emerald",
        note: "RolesAt: 비콘 노드에 의무 조회",
      },
      {
        lines: [24, 31],
        color: "sky",
        note: "역할별 분기: Proposer, Attester, SyncCommittee, Aggregator",
      },
    ],
  },
  "roles-at": {
    ...
    annotations: [
      {
        lines: [47, 49],
        color: "violet",
        note: "비콘 노드에 gRPC 호출로 duty 목록 수신",
      },
      {
        lines: [51, 57],
        color: "emerald",
        note: "duty.IsProposer / IsAttester → 역할 리스트 구성",
      },
    ],
  },
  "run-client": {
    ...
    annotations: [
      { lines: [9, 12], color: "violet", note: "gRPC로 비콘 노드에 연결" },
      {
        lines: [16, 19],
        color: "emerald",
        note: "키매니저 초기화 (로컬 키 or 원격 서명자)",
      },
      {
        lines: [22, 24],
        color: "sky",
        note: "현재 fork의 deposit 처리와 activation eligibility 충족 대기",
      },
      {
        lines: [30, 30],
        color: "amber",
        note: "v.Run(ctx) — 메인 슬롯 루프 시작",
      },
    ],
  },
};
