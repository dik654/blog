...
const STEPS = [
  {
    label: "제네시스 해시",
    body: "Mainnet genesis = 0xd4e56740…cb8fa3 (Keccak-256)",
  },
  {
    label: "포크 목록 수집",
    body: "Homestead(1,150,000), Byzantium(4,370,000), …, Cancun(1,710,338,135)",
  },
  {
    label: "CRC32 체크섬",
    body: "CRC32(genesis) ⊕ CRC32(1150000) ⊕ … = 0xfc64ec04",
  },
  {
    label: "Fork ID 비교",
    body: "로컬 0xfc64ec04/0 vs 피어 fork_hash/fork_next 비교",
  },
  {
    label: "연결 판정",
    body: "hash 일치 + next 호환 → 연결 허용. 불일치 → 즉시 거부.",
  },
];

const ANNOT = [
  "0xd4e567…cb8fa3",
  "Homestead → Cancun (14 forks)",
  "0xfc64ec04 (XOR 체인)",
  "local vs remote 비교",
  "일치 → 허용 / 불일치 → 거부",
];
