  ...
  "process-slots": {
    ...
    annotations: [
      { lines: [6, 8], color: "sky", note: "역방향 슬롯 이동 방지 가드" },
      {
        lines: [11, 12],
        color: "emerald",
        note: "ProcessSlot: 상태 루트 캐싱",
      },
      {
        lines: [15, 19],
        color: "amber",
        note: "에폭 경계 시 ProcessEpoch 트리거",
      },
    ...
    annotations: [
      {
        lines: [34, 37],
        color: "sky",
        note: "HashTreeRoot 계산 후 stateRoots 링 버퍼 저장",
      },
      {
        lines: [38, 38],
        color: "emerald",
        note: "slot % SlotsPerHistoricalRoot = 링 버퍼 인덱스",
      },
      {
        lines: [41, 42],
        color: "amber",
        note: "블록 루트도 blockRoots에 캐싱",
      },
    ],
  },
};
