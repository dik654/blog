  ...
  return (
    <g>
      ...
      >
        ...
        <text x={70} y={156} fontSize={8} fontWeight={600} fill={C.gas}>
          왜 10% 마진이 필요한가?
        </text>
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={230} y={156} textAnchor="middle" fontSize={7.5} fill="#3b82f6">
          ~1us (로컬)
        </text>
        <text
          x={380}
        ...
        <text x={230} y={170} textAnchor="middle" fontSize={7.5} fill="#3b82f6">
          700GB+ MDBX
        </text>
        <text
          x={380}
        ...
        <text x={230} y={182} textAnchor="middle" fontSize={7.5} fill="#3b82f6">
          자체 검증
        </text>
        <text
          x={380}
