      ...
      >
        ...
        >
          ...
          <rect
            ...
            fill={C.reth}
            opacity={0.7}
            clipPath="url(#ovRethClip)"
          />
          <text x={280} y={72} fontSize={8} fontWeight={600} fill={C.reth}>
            Reth
          </text>
          <rect
            x={310}
        ...
        >
          ...
          <rect
            ...
            fill={C.helios}
            opacity={0.7}
            clipPath="url(#ovHeliosClip)"
          />
          <text x={280} y={130} fontSize={8} fontWeight={600} fill={C.helios}>
            Helios
          </text>
          <rect
            x={310}
