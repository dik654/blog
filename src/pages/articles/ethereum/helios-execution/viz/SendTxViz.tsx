          ...
          >
              ...
              <g>
                ...
                {[
                  ...
                  <motion.g key={m.label} {...fade(0.15 + i * 0.08)}>
                    ...
                    />
                    {/* 체크마크 */}
                    <text x={162} y={m.y + 15} fontSize={11} fill={C.ok}>
                      ✓
                    </text>
                    {/* Merkle proof 라벨 */}
                    <text
            ...
            {step === 3 && (
              <g>
                ...
                {/* 체크마크 */}
                <motion.g {...fade(0.6)}>
                  <text x={416} y={72} fontSize={13} fill={C.ok}>
                    ✓
                  </text>
                  <text
                    x={416}
