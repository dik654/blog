          ...
          >
            ...
            {step === 1 && (
              <g>
                  ...
                  {[
                    ...
                    <g key={f.label}>
                      <rect
                        ...
                        stroke={i === 3 ? C.bloom : "transparent"}
                        strokeWidth={i === 3 ? 1 : 0}
                      />
                      <text
                        x={270}
                        ...
                        fill={i === 3 ? C.bloom : "var(--foreground)"}
                      >
                        {f.label}
                      </text>
                      <text
                        ...
                        textAnchor="end"
                        fontSize={7.5}
                        fill={i === 3 ? C.bloom : "var(--muted-foreground)"}
                      >
                        {f.val}
                      </text>
                    </g>
                ...
                {/* code_hash 추출 화살표 */}
                <motion.path
                  d="M 360 112 L 360 135 L 240 135 L 240 155"
                  fill="none"
                  stroke={C.bloom}
                  strokeWidth={1.2}
                  markerEnd="url(#gc-arrow)"
            ...
            {step === 3 && (
              <g>
                ...
                {/* 분기 화살표 — 왼쪽 */}
                <motion.path
                  d="M 210 38 L 210 48 L 110 48 L 110 62"
                  fill="none"
                  stroke={C.muted}
                  strokeWidth={1}
                  markerEnd="url(#gc-arrow)"
                ...
                {/* 분기 화살표 — 오른쪽 */}
                <motion.path
                  d="M 270 38 L 270 48 L 370 48 L 370 62"
                  fill="none"
                  stroke={C.muted}
                  strokeWidth={1}
                  markerEnd="url(#gc-arrow)"
