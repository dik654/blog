    ...
    annotations: [
      {
        lines: [23, 26],
        color: "emerald",
        note: "단계 1: ProofDB 생성 — lazy proof loading 담당",
      },
      {
        lines: [29, 32],
        color: "amber",
        note: "단계 2: revm 빌더 — with_db(db)로 ProofDB 주입",
      },
      {
        lines: [35, 36],
        color: "violet",
        note: "단계 3-4: transact() 실행 → output() 추출",
      },
    ],
  },
    ...
    annotations: [
      {
        lines: [44, 50],
        color: "emerald",
        note: "call()과 동일한 ProofDB + revm 빌드 경로",
      },
      {
        lines: [51, 51],
        color: "sky",
        note: "transact() 실행 — 동일한 EVM 엔진",
      },
      {
        lines: [54, 55],
        color: "rose",
        note: "+10% 마진: gas + gas/10 — 상태 변동 흡수",
      },
    ],
  },
};
