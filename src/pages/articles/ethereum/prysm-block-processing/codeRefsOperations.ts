    ...
    annotations: [
      {
        lines: [9, 14],
        color: "sky",
        note: "1. ProposerSlashing: 이중 제안 검증자 처벌",
      },
      {
        lines: [16, 21],
        color: "emerald",
        note: "2. AttesterSlashing: 이중 투표 검증자 처벌",
      },
      {
        lines: [23, 28],
        color: "amber",
        note: "3. Attestation: 투표를 상태에 반영",
      },
      {
        lines: [30, 35],
        color: "violet",
        note: "4. Deposit: 새 검증자 등록 처리",
      },
      {
        lines: [37, 42],
        color: "rose",
        note: "5. VoluntaryExit: 자발적 이탈 처리",
      },
    ],
  },
};
