...
export const codeRefs: Record<string, CodeRef> = {
  "precompile-enum": {
    path: "revm/precompile/src/lib.rs",
    lang: "rust",
    highlight: [6, 13],
    ...
    annotations: [
      {
        lines: [3, 5],
        color: "sky",
        note: "함수 시그니처 — input + gas_limit → Result",
      },
      {
        lines: [8, 11],
        color: "emerald",
        note: "Standard: 순수 함수 / Env: 블록 환경 필요",
      },
    ],
    code: precompSrc,
  },
    ...
    annotations: [
      {
        lines: [19, 20],
        color: "amber",
        note: "OnceLock — 한 번만 초기화, 이후 &static 참조",
      },
      {
        lines: [22, 28],
        color: "violet",
        note: "EIP-4844 KZG Point Eval (0x0a) 추가",
      },
    ],
    code: precompSrc,
  },
    ...
    annotations: [
      {
        lines: [36, 39],
        color: "rose",
        note: "Standard vs Env 분기 — pattern matching",
      },
    ],
    code: precompSrc,
  },
  "bn128-add": {
    path: "revm/precompile/src/bn128.rs",
    lang: "rust",
    highlight: [3, 14],
    ...
    annotations: [
      {
        lines: [28, 29],
        color: "amber",
        note: "가스 = 34,000 * k + 45,000 (k = 쌍 수)",
      },
      {
        lines: [34, 35],
        color: "violet",
        note: "페어링 결과가 1이면 true (검증 성공)",
      },
    ],
    code: bn128Src,
  },
