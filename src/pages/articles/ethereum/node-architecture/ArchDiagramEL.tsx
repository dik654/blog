      ...
      <div className="overflow-x-auto">
        <div className="grid grid-cols-[minmax(130px,1fr)_auto_minmax(130px,1fr)_auto_minmax(130px,1fr)_auto_minmax(130px,1fr)] min-w-[700px]">
          ...
          <HArrow
            label="tx 전파"
            dir="↔"
            animated={fa("devp2p", "txpool")}
            msgs={lm("txpool", "devp2p")}
          />
          {np("txpool")}
          <HArrow
            label="payload"
            dir="→"
            animated={fa("txpool", "engine-tree")}
            msgs={lm("engine-tree", "txpool")}
          />
          {np("engine-tree")}
          <HArrow
            label="읽기/쓰기"
            dir="↔"
            animated={fa("engine-tree", "storage")}
            msgs={lm("engine-tree", "storage")}
          />
          {np("storage")}
          <div />
          <div />
          ...
          <VConn
            label="RPC 조회"
            animated={fa("engine-tree", "rpc") || fa("rpc", "engine-tree")}
            msgs={lm("storage", "rpc")}
          />
          <div />
          <div />
