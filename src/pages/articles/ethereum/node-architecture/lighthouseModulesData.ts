...
export const vc: Mod = {
  ...
  inner: "border-violet-300/60 dark:border-violet-600/30",
  items: [
...
export const beacon: Mod = {
  ...
  inner: "border-blue-300/60 dark:border-blue-600/30",
  items: [
    ["상태 머신", "블록 검증, 상태 전이"],
...
export const store: Mod = {
  name: "Storage (HotColdDB)",
  border: "border-indigo-400",
  bg: "bg-indigo-50/50 dark:bg-indigo-950/20",
  title: "text-indigo-600 dark:text-indigo-400",
  inner: "border-indigo-300/60 dark:border-indigo-600/30",
  items: [
...
export const net: Mod = {
  ...
  inner: "border-cyan-300/60 dark:border-cyan-600/30",
  items: [
