...
export default function CodeSidebarHeader({
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 border-b border-[#d0d7de] dark:border-[#30363d] bg-[#f6f8fa] dark:bg-[#161b22] shrink-0">
      <span
        className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full border ${isReth ? "bg-[#fff3cd] border-[#d4a72c] text-[#7d4e00]" : "bg-[#ddf4ff] border-[#54aeff] text-[#0550ae]"}`}
      >
  ...
  return (
    <div className="shrink-0 border-b border-[#d0d7de] dark:border-[#30363d]">
      ...
      >
        ...
        <span className="ml-auto text-[10px] text-[#92400e] dark:text-[#d97706]">
          {descOpen ? "▲ 접기" : "▼ 펼치기"}
        </span>
      </button>
      <AnimatePresence>
