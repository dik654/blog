  ...
  return (
    <div className="space-y-1.5 text-[10px]">
      <div className="flex items-center gap-1 font-mono text-[9px]">
        <div className="rounded border-2 border-foreground/40 bg-card px-2 py-1 shrink-0">
          47289
        </div>
        <span className="">─</span>
        <div className="flex flex-col gap-1 flex-1">
          <div className="flex items-center gap-1">
            <div className="rounded border-2 border-emerald-400 bg-emerald-50/60 dark:bg-emerald-950/20 px-2 py-1 font-bold">
              47291
            </div>
      ...
      <p className="text-[9px] text-foreground/75">
        더 많은 검증자가 투표한 블록을 canonical head로 선택
      </p>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center gap-2 text-[10px]">
      <div className="space-y-1">
        ...
        <div className="rounded border border-blue-300 bg-blue-50/60 dark:bg-blue-950/20 px-2 py-1 font-mono text-[9px]">
          BeaconState
        </div>
      </div>
      <motion.span
