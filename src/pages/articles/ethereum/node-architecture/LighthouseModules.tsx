...
function HArr({
  ...
  return (
    <div
      className="flex flex-col items-center justify-start pt-5 px-1 shrink-0 gap-0.5"
      style={style}
    >
      <span className="text-[11px] text-foreground/75 whitespace-nowrap leading-none">
        {label}
      </span>
