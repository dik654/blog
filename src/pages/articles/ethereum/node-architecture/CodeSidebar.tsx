...
export default function CodeSidebar({
  ...
  const flowNodes = initialKey ? flowData[initialKey] : undefined;
          ...
          >
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-h-0">
              ...
              >
                ...
                <span className="ml-auto text-[10px] text-[#57606a] dark:text-[#8b949e]">
                  {codeOpen ? "▼ 접기" : "▶ 펼치기"}
                </span>
              </button>
              <AnimatePresence>
                  ...
                  >
                    <div className="w-[200px] shrink-0 border-r border-[#d0d7de] dark:border-[#30363d] overflow-y-auto bg-[#f6f8fa] dark:bg-[#161b22]">
                      ...
                      <FileTree
                        ...
                        onSelect={(key) => {
                          const r = codeRefs[key];
                          if (r) handleFlowNavigate(key);
                        }}
                      />
                    </div>
