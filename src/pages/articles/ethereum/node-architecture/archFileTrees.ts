...
export const lighthouseTree: FileNode = d("lighthouse", [
  d("beacon_node", [
    ...
    d("network/src", [
      ...
      d("sync", [
        ...
        f(
          "backfill_sync.rs",
          "lighthouse/beacon_node/network/src/sync/backfill_sync.rs",
        ),
      ]),
    ]),
    d("store/src", [
  ...
  d("validator_client", [
    d("validator_services/src", [
      ...
      f(
        "block_service.rs",
        "lighthouse/validator_client/validator_services/src/block_service.rs",
      ),
      f(
    ...
    d("validator_store/src", [
      f(
        "lib.rs",
        "lighthouse/validator_client/validator_store/src/lib.rs",
        "validator-3",
      ),
    ]),
  ]),
...
export const rethTree: FileNode = d("reth/crates", [
  ...
  d("net/network/src", [
    ...
    d("transactions", [
      ...
      f(
        "broadcast.rs",
        "reth/crates/net/network/src/transactions/broadcast.rs",
      ),
    ]),
  ...
  d("storage/provider/src/providers/database", [
    ...
    f(
      "state.rs",
      "reth/crates/storage/provider/src/providers/database/state.rs",
    ),
  ]),
