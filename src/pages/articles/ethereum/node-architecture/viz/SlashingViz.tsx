      ...
      {(step) => (
        ...
        >
          ...
          <motion.g
            animate={
              step >= 1
                ? { x: SIG_A_DX - SIG_A_OX, y: SIG_A_DY - SIG_A_OY }
                : { x: 0, y: 0 }
            }
            initial={{ x: 0, y: 0 }}
          ...
          <motion.g
            animate={
              step >= 1
                ? { x: SIG_B_DX - SIG_B_OX, y: SIG_B_DY - SIG_B_OY }
                : { x: 0, y: 0 }
            }
            initial={{ x: 0, y: 0 }}
            transition={{
