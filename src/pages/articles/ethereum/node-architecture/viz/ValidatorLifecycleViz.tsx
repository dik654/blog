        ...
        return (
          ...
          >
            ...
            <rect
              ...
              fill="var(--card)"
            />
            <text x={243} y={145} fontSize={9} fill="var(--muted-foreground)">
              slashed
            </text>
            <line
              x1={72}
            ...
            >
              <circle
                ...
                style={{
                  filter: `drop-shadow(0 0 5px ${STATES[step].color}99)`,
                }}
              />
              <text
                x={DOT_POS[0].x}
