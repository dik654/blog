...
const P = [
  {
    label: "Network / RPC",
    sub: "ECDSA · nonce=42 · 0.5 ETH",
    color: "#6366f1",
    y: 35,
  },
  {
    label: "TxPool",
    sub: "Pending 4,218 · Queued 892",
    color: "#0ea5e9",
    y: 90,
  },
  {
    label: "PayloadBuilder",
    sub: "base 8.2 + tip 2 = 10.2 gwei",
    color: "#f59e0b",
    y: 145,
  },
  ...
  {
    label: "Gas & Receipt",
    sub: "46,218 gas · 2 logs",
    color: "#8b5cf6",
    y: 255,
  },
  {
    label: "SparseStateTrie",
    sub: "3 슬롯 변경 · Keccak-256",
    color: "#ec4899",
    y: 310,
  },
          ...
          {P.map((s, i) => (
            <g key={s.label} opacity={i > step ? 0.22 : 1}>
              <circle
                ...
                cy={s.y}
                r={4}
                fill={i <= step ? s.color : "var(--border)"}
              />
              <line
                x1={26}
                y1={s.y}
