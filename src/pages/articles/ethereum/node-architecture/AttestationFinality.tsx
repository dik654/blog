  ...
  return (
    <section id="attestation-finality" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none mb-6">
        <p>
          이더리움 PoS의 합의는 두 메커니즘을 조합합니다.{" "}
          <strong>LMD-GHOST</strong>는 슬롯마다 "지금 어느 블록이 헤드인가"를
          결정하고, <strong>Casper FFG</strong>는 에폭마다 특정 체크포인트를
          비가역적으로 확정합니다. 둘은 하나의 어테스테이션에 함께 담겨
          전송됩니다.
        </p>
      </div>
