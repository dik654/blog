      ...
      <div className="px-3 py-2 space-y-0.5">
        ...
        <div className="border-t border-border/50 pt-1 mt-1">
          <p>
            ...
            <span className="text-blue-600">engine_newPayloadV3</span>
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="space-y-1.5 text-[10px] font-mono">
      <div className="rounded border px-3 py-2 space-y-0.5">
        <p>
          <span className="">iat: </span>1700000000
          <span className="text-foreground/75 ml-2">(JWT 발행 시각)</span>
        </p>
        <p>
          <span className="">now: </span>1700000003
          <span className="text-foreground/75 ml-2">(EL 수신 시각)</span>
        </p>
        <p>
          <span className="">diff: </span>
          <span className="text-emerald-600 font-bold">3s</span>
          <span className="text-emerald-600 ml-1">≤ 5s → ✓ accept</span>
        </p>
      </div>
