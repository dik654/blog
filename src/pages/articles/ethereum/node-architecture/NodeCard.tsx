...
import { FLOW_COLORS } from "./flowDiagramData";
...
export default function NodeCard({
  ...
  const c = FLOW_COLORS[node.color];
          ...
          <div className="flex-1 min-w-0">
            ...
            <AnimatePresence>
              {showDetail && node.detail && (
                <motion.p
                  ...
                  className="text-[10px] text-foreground/75 mt-1.5 leading-relaxed whitespace-pre-line overflow-hidden"
                >
                  {node.detail}
                </motion.p>
              )}
            ...
            <AnimatePresence>
              {showCode && node.codeRefKey && (
                ...
                >
                  {codeRefs[node.codeRefKey] && (
                    <CodePreview codeRef={codeRefs[node.codeRefKey]} />
                  )}
                </motion.div>
              )}
            </AnimatePresence>
