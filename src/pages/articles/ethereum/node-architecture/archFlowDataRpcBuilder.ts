...
export const rpcBuilderFlowData: Record<string, FlowNode[]> = {
  "rpc-0": [
    {
      id: "r0-1",
      fn: "RpcModuleBuilder::new()",
      desc: "RPC 서버 조립 빌더 패턴 시작",
      color: "sky",
      codeRefKey: "rpc-0",
      detail:
        "Reth 노드 시작 시 한 번 실행됩니다. 모든 의존성을 주입하고 jsonrpsee 서버를 구성합니다.",
      children: [
        {
          id: "r0-1-1",
          fn: ".with_provider(provider)",
        ...
        {
          id: "r0-1-6",
          fn: "RpcServerConfig.start(module)",
          desc: "HTTP(:8545), WebSocket(:8546), IPC 동시 서빙 시작",
          color: "slate",
          codeRefKey: "rpc-0",
          detail:
            "jsonrpsee의 ServerBuilder를 사용합니다. HTTP와 WebSocket을 동일 포트에서 서빙하거나 분리할 수 있습니다.",
        },
      ],
    },
  ],
