...
export default function GlossaryPanel() {
  ...
  return (
    <div className="shrink-0 border-b border-border/40">
      ...
      >
        <span className="text-[9px] font-bold uppercase tracking-wider text-foreground/75">
          📖 용어 사전
        </span>
            ...
            <div className="px-4 pb-3 space-y-1">
              {GLOSSARY.map((g) => (
                <div key={g.term} className="flex gap-2">
                  <code className="shrink-0 text-[10px] font-bold text-[#0969da] dark:text-[#58a6ff] font-mono w-32">
                    {g.term}
                  </code>
