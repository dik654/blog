  ...
  "p2p-start": {
    ...
    annotations: [
      { lines: [8, 13], color: "sky", note: "Discv5 UDP 리스너 초기화" },
      {
        lines: [16, 23],
        color: "emerald",
        note: "libp2p.New: Noise 전송 + ConnectionGater",
      },
      {
        lines: [26, 27],
        color: "amber",
        note: "RPC 핸들러 등록 + GossipSub 토픽 구독",
      },
      {
        lines: [30, 30],
        color: "violet",
        note: "피어 매니저 루프 (스코어링 + 프루닝)",
      },
    ],
  },
  "discv5-init": {
    ...
    annotations: [
      { lines: [36, 38], color: "sky", note: "로컬 키 + 부트노드 설정" },
      {
        lines: [40, 40],
        color: "emerald",
        note: "ListenV5: UDP 소켓 바인딩 + 탐색 시작",
      },
    ],
  },
  "peer-score": {
