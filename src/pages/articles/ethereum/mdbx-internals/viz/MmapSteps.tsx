...
export function Step0() {
  return (
    <g>
      ...
      <text x={200} y={165} textAnchor="middle" fontSize={10} fill={C.dim}>
        1:1 주소 대응
      </text>
    </g>
  );
...
export function Step1() {
  return (
    <g>
      <text x={20} y={28} fontSize={10} fontWeight={600} fill={C.proc}>
        Application Code
      </text>
      <rect
        x={20}
      ...
      <rect
        ...
        strokeWidth={1}
      />
      <text x={100} y={120} textAnchor="middle" fontSize={10} fill={C.disk}>
        mmap region (zero-copy)
      </text>
      <motion.g
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
