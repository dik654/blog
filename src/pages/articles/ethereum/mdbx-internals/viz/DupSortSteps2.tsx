...
export function Step3() {
  ...
  return (
    <g>
      <text x={20} y={22} fontSize={10} fontWeight={600} fill={C.key}>
      ...
      {/* Arrow */}
      <line x1={120} y1={51} x2={148} y2={51} stroke={C.sub} strokeWidth={1} />
...
export function Step4() {
  ...
  return (
    <g>
      <text x={20} y={22} fontSize={10} fontWeight={600} fill={C.cursor}>
        DupSort 커서 연산
      </text>
      {/* Values */}
      {["v0", "v1", "v2", "v3"].map((v, i) => (
      ...
      {ops.map((op, i) => (
        ...
        >
          ...
          <text x={135} y={118 + i * 24} fontSize={9} fill={C.dim}>
            {op.desc}
          </text>
        </motion.g>
      ))}
