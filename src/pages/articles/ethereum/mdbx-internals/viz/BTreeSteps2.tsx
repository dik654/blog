...
export function Step3() {
  return (
    <g>
      <text x={20} y={28} fontSize={10} fontWeight={600} fill={C.overflow}>
        Overflow Page
      </text>
      {/* Leaf with pointer */}
      <rect
        ...
        strokeWidth={0.8}
      />
      <text x={40} y={56} fontSize={9} fill={C.leaf}>
        Leaf
      </text>
      <rect
        x={70}
        ...
        strokeWidth={0.6}
      />
      <text x={110} y={61} textAnchor="middle" fontSize={8} fill={C.overflow}>
        ptr → ovfl pg
      </text>
      {/* Arrow */}
      <motion.line
...
export function Step4() {
  ...
  return (
    <g>
      <text x={20} y={16} fontSize={10} fontWeight={600} fill={C.path}>
        key = 0x5C 검색
      </text>
      {nodes.map((n, i) => (
        <motion.g
