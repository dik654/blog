  ...
  return (
    <g>
      ...
      <motion.g {...fade(0.45)}>
        ...
        <text x={391} y={50} textAnchor="middle" fontSize={7} fill={C.fail}>
          만료 가능
        </text>
      </motion.g>
      ...
      <motion.g {...fade(0.8)}>
        ...
        <text x={112} y={128} fontSize={8} fontWeight={700} fill={C.fail}>
          Reth
        </text>
        <text x={112} y={142} fontSize={7.5} fill="var(--muted-foreground)">
          MDBX: 700GB+
        </text>
        ...
        <text x={340} y={128} fontSize={8} fontWeight={700} fill={C.disk}>
          Helios
        </text>
        <text x={340} y={142} fontSize={7.5} fill="var(--muted-foreground)">
          FileDB: 32 bytes
        </text>
      </motion.g>
    ...
    <g>
      ...
      <motion.g {...fade(0.85)}>
        ...
        <g transform="translate(348, 84)">
          <path
            d="M 20 2 L 34 9 L 34 22 C 34 31 20 38 20 38 C 20 38 6 31 6 22 L 6 9 Z"
            fill={`${C.disk}20`}
            stroke={C.disk}
            strokeWidth={1.2}
          />
      ...
      <motion.g {...fade(1.1)}>
        <text
          ...
          fill="var(--muted-foreground)"
        >
          Primary 우선 → 실패 시 Fallback 순차 시도 — 어떤 응답이든 검증 통과
          필수
        </text>
      </motion.g>
