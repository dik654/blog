  ...
  return (
    <g>
      ...
      <motion.g {...fade(0.75)}>
        ...
        <text x={92} y={148} textAnchor="middle" fontSize={7} fill={C.load}>
          유효 (재사용 가능)
        </text>
        <text x={192} y={148} textAnchor="middle" fontSize={7} fill={C.fail}>
          만료 (재요청)
        </text>
      </motion.g>
    ...
    <g>
      ...
      <motion.g {...fade(0.8)}>
        ...
        <g transform="translate(351, 92)">
          <path
            d="M 20 2 L 36 10 L 36 24 C 36 34 20 42 20 42 C 20 42 4 34 4 24 L 4 10 Z"
            fill={`${C.load}20`}
            stroke={C.load}
            strokeWidth={1.2}
          />
