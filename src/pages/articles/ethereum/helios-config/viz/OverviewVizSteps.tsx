  ...
  return (
    <g>
      ...
      >
        ...
        <text x={120} y={37} textAnchor="middle" fontSize={7} fill="#94a3b8">
          terminal
        </text>
      ...
      >
        ...
        <text x={360} y={37} textAnchor="middle" fontSize={7} fill="#94a3b8">
          main.rs
        </text>
    ...
    <g>
      ...
      {methods.map((m, i) => {
        ...
        return (
          ...
          >
            ...
            {i === 0 ? (
              <path
                d={`M 65 56 L 65 ${boxY + 4} L ${boxX} ${boxY + 4}`}
                stroke={C.helios}
                strokeWidth={1}
                fill="none"
                strokeDasharray="3 2"
              ...
              <path
                d={`M ${boxX - 20 + 65} ${boxY - 12} L ${boxX + 65} ${boxY + 4}`}
                stroke={m.color}
                strokeWidth={1}
                fill="none"
                strokeDasharray="3 2"
      ...
      >
        ...
        {[
          ...
          <g key={item.label}>
            <circle cx={40 + i * 170} cy={195} r={3} fill={item.color} />
            <text
              x={48 + i * 170}
              y={198}
              fontSize={8}
