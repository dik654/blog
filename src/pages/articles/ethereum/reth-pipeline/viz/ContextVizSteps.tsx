    ...
    <g>
      <defs>
        <marker
          ...
          orient="auto"
        >
          <path d="M0,0 L6,3 L0,6" fill={C.ok} />
        </marker>
      </defs>
      {/* 피어 간 연결선 */}
      {links.map(([a, b], i) => (
      ...
      <motion.circle
        r={4}
        fill={C.block}
        initial={{ cx: 180, cy: 66, opacity: 1 }}
      ...
      <motion.circle
        r={4}
        fill={C.stage}
        initial={{ cx: 138, cy: 16, opacity: 1 }}
        animate={{ cx: 290, cy: 55, opacity: 0 }}
        transition={{
          duration: 1,
          delay: 0.5,
...
export function StepScale() {
  return (
    <g>
      ...
      <text x={310} y={57} fontSize={11} fill="var(--muted-foreground)">
        ...
      </text>
