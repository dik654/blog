  ...
  return (
    <section id="headers-stage" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          Header는 body보다 작아 긴 chain 후보를 비교하기 쉽지만, download
          성공이 validity는 아닙니다. Number가 연속이고 parent hash가 직전
          header를 가리키는지, timestamp·gas limit·base fee·difficulty/PoS
          field가 활성 chain spec과 맞는지를 순서대로 검사합니다.
        </p>
        <p>
