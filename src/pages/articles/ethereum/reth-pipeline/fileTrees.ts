...
export const rethPipelineTree: FileNode = d("reth", [
  d("crates/stages", [
    ...
    d("stages/src/stages", [
      f(
        "headers.rs — HeadersStage",
        "crates/stages/stages/src/stages/headers.rs",
        "headers-stage",
      ),
      f(
        "bodies.rs — BodiesStage",
        "crates/stages/stages/src/stages/bodies.rs",
        "bodies-stage",
      ),
      f(
        "senders.rs — SendersStage",
        "crates/stages/stages/src/stages/senders.rs",
        "senders-stage",
      ),
      f(
        "execution.rs — ExecutionStage",
        "crates/stages/stages/src/stages/execution.rs",
        "execution-stage",
      ),
      f(
        "merkle.rs — MerkleStage",
