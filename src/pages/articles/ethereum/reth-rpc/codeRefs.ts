    ...
    annotations: [
      {
        lines: [10, 11],
        color: "sky",
        note: '#[rpc] 매크로 — namespace "eth"로 자동 라우팅',
      },
      {
        lines: [14, 19],
        color: "emerald",
        note: "getBalance, call — 읽기 전용 상태 조회",
      },
      {
        lines: [22, 24],
        color: "amber",
        note: "sendRawTransaction — TX 제출 → txpool",
      },
    ],
  },
  "rpc-engine-api": {
    ...
    annotations: [
      {
        lines: [12, 17],
        color: "sky",
        note: "provider + payload_builder + beacon_engine_handle",
      },
      {
        lines: [20, 29],
        color: "emerald",
        note: "forkchoice_updated — head/safe/finalized 갱신 + 페이로드 빌드",
      },
      {
        lines: [32, 38],
        color: "amber",
        note: "new_payload — EVM 실행 → 상태 루트 검증",
      },
    ],
  },
};
