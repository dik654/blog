  ...
  return (
    <section id="fixed-bytes" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          `FixedBytes&lt;20&gt;` 안에 값이 들어온 뒤에는 길이가 20이라는 전제를 매 호출마다 다시 검사하지 않아도 됩니다. 그러나
          `&amp;[u8]`에서 만드는 경계에서는 exact length를 검사해야 하며, zero padding·truncation은 Address 변환이나 hash 절단처럼
          protocol이 명시한 함수에서만 수행합니다.
        </p>
        <p>
          같은 내부 배열을 감싸더라도 Address와 B160은 의미가 다를 수 있습니다. Transparent layout은 FFI·serialization byte
          identity의 자동 보장이 아니므로 ABI, RLP, serde와 database codec 각각의 구현을 version fixture로 확인합니다. Unsafe cast는
