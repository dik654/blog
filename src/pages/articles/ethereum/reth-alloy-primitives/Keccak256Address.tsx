  ...
  return (
    <section id="keccak256-address" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          Worked example receipt에는 algorithm 이름을 단순히 “SHA3”로 쓰지 않고 Keccak-256, domain prefix, 각 field의 exact bytes와
          order, 32-byte digest, 취한 [12..32) range를 남깁니다. Hash collision resistance는 잘못 조립한 입력이나 다른 schema를
          구분해 주지 않으므로 canonical encoding과 domain separation이 먼저입니다.
        </p>
      </div>
    </section>
  );
