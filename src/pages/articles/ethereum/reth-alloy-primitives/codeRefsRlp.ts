...
export const rlpCodeRefs: Record<string, CodeRef> = {
  ...
  "rlp-fixed": {
    ...
    lang: "rust",
    highlight: [24, 28],
    desc: "encode_fixed_size — 고정 용량 buffer를 사용하는 개념 경로",
    annotations: [{ lines: [25, 28], color: "rose", note: "고정 크기 버퍼" }],
    code: rlpSrc,
  },
  "rlp-header": {
    path: "alloy-rlp/src/lib.rs",
