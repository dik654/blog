...
export const REORG_STEPS: ReorgStep[] = [
  {
    step: 1,
    title: "새 블록 수신",
    desc: "피어로부터 현재 tip보다 높은 블록을 수신한다.",
  },
  {
    step: 2,
    title: "포크 감지",
    desc: "새 블록의 parent가 현재 canonical chain에 없으면 포크를 감지한다.",
  },
  {
    step: 3,
    title: "공통 조상 탐색",
    desc: "두 체인이 갈라진 지점(공통 조상)을 찾는다.",
  },
  {
    step: 4,
    title: "unwind",
    desc: "공통 조상까지 현재 체인의 상태를 되감는다.",
  },
  {
    step: 5,
    title: "새 체인 적용",
    desc: "새 체인의 블록을 순서대로 실행하고 canonical으로 설정한다.",
  },
];
