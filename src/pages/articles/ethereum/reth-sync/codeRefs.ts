    ...
    annotations: [
      {
        lines: [8, 12],
        color: "sky",
        note: "stages + progress + tip — 파이프라인 상태",
      },
      {
        lines: [15, 21],
        color: "emerald",
        note: "Stage trait — execute + unwind 인터페이스",
      },
      {
        lines: [24, 35],
        color: "amber",
        note: "run() — 전체 Stage 반복 실행 루프",
      },
    ],
  },
  "sync-exex": {
    ...
    annotations: [
      {
        lines: [9, 11],
        color: "sky",
        note: "ChainCommitted — 새 블록 커밋 이벤트",
      },
      {
        lines: [13, 16],
        color: "emerald",
        note: "ChainReorged — reorg 시 old + new 체인",
      },
      {
        lines: [24, 28],
        color: "amber",
        note: "ExExManager — broadcast 채널로 전파",
      },
    ],
  },
};
