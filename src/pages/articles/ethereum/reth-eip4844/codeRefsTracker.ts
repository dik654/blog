    ...
    annotations: [
      {
        lines: [7, 9],
        color: "sky",
        note: "BTreeMap: 블록 번호 순서대로 정렬 → 범위 삭제 효율적",
      },
      {
        lines: [22, 30],
        color: "emerald",
        note: "add_new_chain_blocks: is_eip4844() 필터로 blob TX만 추적",
      },
      {
        lines: [34, 48],
        color: "amber",
        note: "on_finalized_block: finalized 블록까지의 blob TX 반환",
      },
      {
        lines: [53, 56],
        color: "violet",
        note: "BlobStoreUpdates: 삭제할 TX 목록 또는 None",
      },
    ],
  },
};
