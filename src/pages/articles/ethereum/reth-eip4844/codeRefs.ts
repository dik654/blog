    ...
    annotations: [
      {
        lines: [5, 16],
        color: "sky",
        note: "calc_excess_blob_gas: 이전 블록의 excess+used가 target보다 크면 초과분 누적",
      },
      {
        lines: [20, 27],
        color: "emerald",
        note: "calc_blob_fee: fake_exponential()로 지수 가격 산출",
      },
      {
        lines: [31, 42],
        color: "amber",
        note: "fake_exponential: Taylor 급수로 정수만 사용하는 지수 근사",
      },
    ],
  },
  "blob-validate": {
    ...
    annotations: [
      {
        lines: [9, 13],
        color: "sky",
        note: "blob, commitment, proof 개수가 모두 같아야 함",
      },
      {
        lines: [16, 20],
        color: "emerald",
        note: "활성 포크의 blob parameters가 허용한 maximum을 초과하면 거부",
      },
      {
        lines: [23, 28],
        color: "amber",
        note: "KZG commitment → versioned hash 변환 후 일치 확인",
      },
      {
        lines: [31, 36],
        color: "violet",
        note: "KZG proof 배치 검증 — blob 데이터와 commitment 일치 증명",
      },
    ],
  },
};
