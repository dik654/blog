...
export const rethEip4844Tree: FileNode = d("reth", [
  ...
  d("crates/transaction-pool/src", [
    d("blobstore", [
      f(
        "mod.rs",
        "reth/crates/transaction-pool/src/blobstore/mod.rs",
        "blobstore-trait",
      ),
      f(
        "blob.rs",
        "reth/crates/transaction-pool/src/blobstore/blob.rs",
        "blob-validate",
      ),
      f(
        "disk.rs",
      ...
      f(
        "disk_inner.rs",
        "reth/crates/transaction-pool/src/blobstore/disk_inner.rs",
        "disk-inner-ops",
      ),
      f(
        "mem.rs",
        "reth/crates/transaction-pool/src/blobstore/mem.rs",
        "mem-blobstore",
      ),
      f(
        "tracker.rs",
        "reth/crates/transaction-pool/src/blobstore/tracker.rs",
        "canon-tracker",
      ),
    ]),
    d("validate", [
