    ...
    <section id="store-init" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral max-w-none dark:prose-invert">
        <p>
          ...
          current committee는 검증한 K를 사용하며 next committee는 아직 모르는 상태로 둡니다. Participation maxima와 best-valid-update 같은
          보조 상태도 spec의 초기값으로 함께 설정해야 첫 update의 safety threshold가 재현됩니다.
        </p>
        <p>
