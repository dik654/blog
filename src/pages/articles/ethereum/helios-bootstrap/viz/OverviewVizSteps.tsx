  ...
  return (
    <g>
      ...
      >
        ...
        <text x={16} y={24} fontSize={10} fontWeight={700} fill={C.checkpoint}>
          finalized_header
        </text>
        <text x={190} y={24} fontSize={7} fill="var(--muted-foreground)">
          확정 블록 헤더
        </text>
      ...
      >
        ...
        <text x={16} y={166} fontSize={9} fontWeight={600} fill={C.trust}>
          committee_branch
        </text>
        <text x={192} y={166} fontSize={7} fill="var(--muted-foreground)">
          depth=5
        </text>
  ...
  return (
    <g>
      ...
      >
        ...
        <text x={120} y={144} textAnchor="middle" fontSize={7} fill={C.danger}>
          거짓이면 다른 체인을 따라감
        </text>
      </motion.g>
      ...
      >
        <text x={120} y={186} textAnchor="middle" fontSize={7.5} fill={C.trust}>
          신뢰 1가지
        </text>
        <text
          x={362}
