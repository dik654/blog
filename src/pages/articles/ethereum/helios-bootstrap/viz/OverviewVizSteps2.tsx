  ...
  return (
    <g>
      ...
      >
        ...
        {/* 경고 삼각형 */}
        <path
          d={`M ${maxEnd + 30} ${tlY - 2} l 8 14 l -16 0 z`}
          fill="none"
          stroke={C.danger}
          strokeWidth={1.2}
        />
    ...
    <g>
      ...
      {sources.map((s, i) => (
        ...
        >
          ...
          <text x={58} y={s.y + 30} fontSize={7} fill="var(--muted-foreground)">
            {s.desc}
          </text>
          <text
            x={192}
