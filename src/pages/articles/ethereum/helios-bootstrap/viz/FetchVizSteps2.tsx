      ...
      {fields.map((f, i) => (
        ...
        >
          ...
          <text
            ...
            y={startY + i * rowH + 14}
            fontSize={10}
            fill={f.ok ? C.store : "var(--muted-foreground)"}
          >
            {f.v}
          </text>
          {f.ok && (
  ...
  return (
    <g>
      ...
      >
        ...
        />
        {/* 체크마크 */}
        <text x={370} y={108} fontSize={14} fontWeight={700} fill={C.sync}>
          {"✓"}
        </text>
      </motion.g>
      ...
      >
        ...
        <text x={110} y={115} textAnchor="middle" fontSize={8} fill={C.sync}>
          8000000 → 8000001
        </text>
      </motion.g>
