  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          이더리움에서 "현재 상태를 아는 방법"은 두 가지.
          <br />
          Reth(풀 노드)는 제네시스부터 수억 블록을 실행 — 수일 소요, 700GB+
          디스크.
          <br />
          Helios(경량)는 체크포인트 하나로 시작 — 수 초, 디스크 거의 0.
          <br />
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <table className="w-full text-sm border border-border">
            <thead>
              <tr className="bg-muted/30">
                ...
                <th className="text-left px-3 py-2 border-b border-border text-blue-600">
                  Helios (경량)
                </th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="px-3 py-1.5 border-b border-border/30 text-blue-600">
                  체크포인트 블록 루트
                </td>
              </tr>
              <tr>
        ...
        <p className="text-sm border-l-2 border-amber-500/50 pl-3 mt-4">
          <strong>{"💡"} Reth에는 Weak Subjectivity가 없다</strong>
          <br />
          제네시스부터 모든 블록을 직접 검증하므로 체크포인트 유효기간 제약
          불필요.
          <br />
