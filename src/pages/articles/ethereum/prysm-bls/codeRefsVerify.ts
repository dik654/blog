    ...
    annotations: [
      {
        lines: [6, 12],
        color: "sky",
        note: "blst.Verify: e(sig,G2)==e(H(msg),pk) 패어링",
      },
    ...
    annotations: [
      {
        lines: [30, 31],
        color: "sky",
        note: "동일 메시지 → pk 먼저 집계 → 패어링 1회",
      },
      {
        lines: [36, 36],
        color: "amber",
        note: "FastAggregateVerify: O(n) 덧셈 + O(1) 패어링",
      },
    ],
  },
  "bls-batch": {
    ...
    annotations: [
      {
        lines: [18, 19],
        color: "sky",
        note: "각 (pk, msg) 쌍이 모두 다를 수 있음",
      },
      {
        lines: [24, 24],
        color: "emerald",
        note: "n개 패어링 연산 필요 (배치 최적화)",
      },
    ],
  },
};
