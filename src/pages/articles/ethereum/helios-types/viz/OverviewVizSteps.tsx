        ...
        {clFields.map((f, i) => (
          ...
          >
            <rect
              ...
              rx={3}
              fill="var(--card)"
              stroke={f.label === "state_root" ? C.cl : "var(--border)"}
            ...
            <text
              ...
              y={66 + i * 18}
              fontSize={8}
              fontWeight={f.label === "state_root" ? 700 : 500}
              fill={f.label === "state_root" ? C.cl : "var(--foreground)"}
            >
              {f.label}
            </text>
            <text
        ...
        {elFields.map((f, i) => (
          ...
          >
            <rect
              ...
              strokeWidth={0.3}
            />
            <text x={272} y={64 + i * 13} fontSize={7} fill="var(--foreground)">
              {f.label}
            </text>
          </motion.g>
        ))}
  ...
  return (
    <g>
      ...
      <motion.path
        ...
        strokeWidth={1.2}
        fill="none"
        markerEnd="url(#ovArrowCl)"
        initial={{ pathLength: 0 }}
        animate={{ pathLength: 1 }}
        transition={{ delay: 0.5, duration: 0.3 }}
      />
      <motion.path
        d="M 116 112 L 155 108"
        stroke={C.cl}
        strokeWidth={1.2}
        fill="none"
        markerEnd="url(#ovArrowCl)"
      ...
      {/* ── 검증 → EL 화살표 ── */}
      <motion.path
        d="M 270 145 L 322 100"
        stroke={C.bridge}
        strokeWidth={1.2}
        fill="none"
        markerEnd="url(#ovArrowB)"
        initial={{ pathLength: 0 }}
        animate={{ pathLength: 1 }}
