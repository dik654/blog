  ...
  return (
    <g>
      ...
      <motion.g {...fade(1.0)}>
        ...
        {["[len]", "slot", "[len]", "parent", "..."].map((_label, i) => (
          <rect
            key={i}
            x={355 + i * 22}
            y={48}
        ...
        {["[len]", "slot", "[len]", "parent", "..."].map((label, i) => (
          <text
            ...
            textAnchor="middle"
            fontSize={5.5}
            fill={i % 2 === 0 ? C.alert : "var(--muted-foreground)"}
          >
            {label}
          </text>
        ))}
        ...
        <text x={407} y={89} textAnchor="middle" fontSize={7} fill={C.alert}>
          필드 접근 O(n)
        </text>
      </motion.g>
      ...
      <motion.g {...fade(1.15)}>
        ...
        <text x={407} y={129} textAnchor="middle" fontSize={7} fill={C.ssz}>
          필드 접근 O(1)
        </text>
      </motion.g>
...
export function Step1() {
  ...
  return (
    <g>
        ...
        return (
          <motion.g key={l.label} {...fade(0.15 + i * 0.05)}>
            ...
            <text
              ...
              textAnchor="middle"
              fontSize={6.5}
              fill={l.filled ? "var(--muted-foreground)" : C.muted}
            >
              {l.sub}
            </text>
          </motion.g>
      ...
      <motion.g {...fade(1.0)}>
        <line
          x1={d1Nodes[0].x + nodeW / 2}
          y1={d1Nodes[0].y}
          x2={rootNode.x + nodeW / 2}
          y2={rootNode.y + nodeH + 6}
          stroke={C.merkle}
          strokeWidth={0.7}
          opacity={0.5}
        />
        <line
          x1={d1Nodes[1].x + nodeW / 2}
          y1={d1Nodes[1].y}
          x2={rootNode.x + nodeW / 2}
          y2={rootNode.y + nodeH + 6}
          stroke={C.merkle}
      ...
      <motion.g {...fade(0.5)}>
        <text
          x={leafStartX + 5 * leafGap + leafW / 2}
          y={leafY - 6}
          textAnchor="middle"
          fontSize={7}
          fill={C.muted}
