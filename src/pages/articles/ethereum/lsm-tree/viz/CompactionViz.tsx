  ...
  return (
    ...
    >
      <line
        ...
        markerEnd="url(#cpArr)"
      />
      <text x={275} y={100} fontSize={10} fontWeight={600} fill={CR}>
        merge sort
      </text>
    </motion.g>
  );
        ...
        >
          ...
          <motion.g animate={{ opacity: step === 0 ? 1 : 0.15 }}>
            ...
            {Array.from({ length: 6 }, (_, i) => (
              <motion.rect
                ...
                strokeWidth={0.7}
                initial={{ y: 40 }}
                animate={{ y: 40 + Math.floor(i / 2) * 35 }}
            ...
            <text x={260} y={165} textAnchor="middle" fontSize={10} fill={CR}>
              읽기: 최대 6개 파일 순회 필요
            </text>
          </motion.g>
          {/* Step 1: L0→L1 */}
          ...
          <motion.g animate={{ opacity: step === 2 ? 1 : 0.15 }}>
            ...
            <rect
              ...
              strokeWidth={1.2}
            />
            <text x={130} y={56} textAnchor="middle" fontSize={9} fill={C1}>
              선택된 SSTable (k-p)
            </text>
            <text
              x={380}
