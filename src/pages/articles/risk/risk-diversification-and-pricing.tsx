    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 위험이 클수록 r이 크다고 단순히 말할 수는 없습니다. 위험에는
            여러 자산에 나눠 담으면 사라지는 것이 있고, 아무리 나눠도 남는 것이
            있기 때문입니다. 그리고 보상은 남는 쪽에만 붙습니다.
          </p>
      ...
      <section id="measuring-risk" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            제곱을 쓰는 이유는 둘입니다. 위로 벗어난 것과 아래로 벗어난 것이
            서로 상쇄되지 않게 하고, 크게 벗어난 경우에 더 큰 무게를 주기
            위해서입니다. 제곱한 값은 단위가 달라지므로 제곱근을 취해 원래
            단위로 되돌린 것이 표준편차입니다.
          </p>

          <p className="leading-7">
            이 척도에는 처음부터 한계가 박혀 있습니다. 위로 벗어난 것과 아래로
            벗어난 것을 같은 위험으로 센다는 점입니다. 투자자가 실제로 두려워
            하는 것은 아래쪽뿐인데도 그렇습니다. 이 한계를 기억해 두고 넘어가야
            뒤에서 이 틀이 어디서 무너지는지 알 수 있습니다.
          </p>
        </div>
      ...
      <section id="covariance" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            두 자산을 반씩 담으면 기대 수익률은 두 값의 평균이 됩니다. 그런데
            위험은 평균이 되지 않습니다. 한쪽이 나쁠 때 다른 쪽이 괜찮은 경우가
            섞여 들어가면서, 합친 것의 변동이 각각의 평균보다 작아집니다.
          </p>
        ...
        <div id="many-assets" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              결론이 여기서 나옵니다. 자산을 늘릴수록 개별 자산 고유의 변동은
              사라지지만, 서로 함께 움직이는 부분은 아무리 늘려도 남습니다.
              남는 값은 0이 아니라 평균 공분산입니다.
            </p>
          </div>
      ...
      <section id="systematic-risk" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이제 보상의 문제입니다. 어떤 투자자가 한 종목만 들고 있어서 큰
            위험을 지고 있다고 합시다. 그 위험의 상당 부분은 다른 종목 몇 개를
            더 담기만 하면 사라집니다. 없앨 수 있는 것을 굳이 지고 있는 셈이고,
            그에 대해 시장이 더 높은 수익률을 줄 이유가 없습니다.
          </p>
      ...
      <section id="capm" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            베타가 1이면 시장과 같은 만큼, 2면 두 배로 움직입니다. 베타가 0에
            가까운 자산은 시장이 어떻게 되든 자기 길을 가므로 피할 수 없는 위험을
            거의 지지 않고, 그래서 요구 수익률도 낮습니다.
          </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            실제 수익률 분포는 아주 큰 손실이 정규분포가 예측하는 것보다 자주
            나타납니다. 그리고 그런 국면에서 자산들의 상관이 함께 1에 가까워져,
            정확히 분산투자가 필요한 순간에 분산투자의 효과가 줄어듭니다.
          </p>

          <p className="leading-7">
            그래서 이 틀은 버릴 것이 아니라 경계를 알고 쓸 것입니다. 위험을 재는
            도구로는 여전히 쓸모 있지만, 꼬리에서 무엇이 일어나는지는 따로 봐야
            합니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            이것이 위험 관리에서 가장 곤란한 성질입니다. 모형이 예측한 손실
            한도가 평상시 상관으로 계산되어 있으면, 실제로 그 한도가 필요한
            국면에서는 한도 자체가 틀려 있습니다. 그래서 스트레스 상황을 따로
            가정해 계산하는 절차가 별도로 필요해집니다.
          </p>
          <p className="leading-7">
            다음 글의 출발점이 바로 여기입니다. 개별 투자자는 손실을 감수하면
            그만이지만, 은행은 그 손실이 예금자와 다른 기관으로 번집니다. 그래서
            규제는 평상시가 아니라 나쁜 상황을 기준으로 자본을 쌓게 합니다.
          </p>
        </ProgressiveDetail>
