    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            앞 글에서 위험의 값을 계산했지만 그 계산은 개인 투자자의 문제였습니다. 손실이 나면 본인이 감수하면 그만입니다. 은행은 다릅니다. 손실이 나면 예금자가 돈을 못 받고 그
            은행에 걸려 있던 다른 기관의 미결제 금액이 함께 날아갑니다.
          </p>
        ...
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            순서는 규제가 필요한 이유, 자본이 실제로 손실을 받아 내는 방식, 같은 금액이라도 위험에 따라 요구량이 달라지는 구조, 그리고 자본만으로는 막지 못하는 것입니다. 마지막에 이
            규제가 스스로 만들어 내는 문제로 닫습니다.
          </p>
      ...
      <section id="why-regulate" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            반대편에는 두 가지가 있습니다. 하나는 앞 글에서 본 예금보험입니다. 한도까지 보장되니 예금자가 은행의 건전성을 따지지 않고 은행은 위험한 자산을 담아도 조달 비용이 오르지
            않습니다. 이익은 주주가 갖고 큰 손실은 보험이 떠안는 비대칭이 생깁니다.
          </p>
      ...
      <section id="loss-absorption" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            자본비율은 곧 &ldquo;자산이 몇 퍼센트 깎일 때까지 예금자가 온전한가&rdquo;로 읽힙니다. 자본이 자산의 8%라면 자산 가치가 8% 떨어질 때까지는 손실이 전부
            주주에게 갑니다. 그 선을 넘으면 예금자와 다른 채권자의 몫이 깎이기 시작합니다.
          </p>
      ...
      <section id="rwa" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            가중치가 0이면 그 자산은 분모에 전혀 들어가지 않아 자본을 요구하지 않습니다. 100%면 금액 그대로 들어갑니다. 같은 규모의 은행이라도 안전한 자산만 담으면 요구 자본이
            작아지고 위험한 자산을 담으면 커집니다. 자본 요구가 크기가 아니라 위험에 비례하게 됩니다.
          </p>

          <p className="leading-7">
            그런데 이 설계는 새 문제를 만듭니다. 가중치를 누가 어떻게 정하느냐가 자본 요구량을 좌우하게 되고 은행은 실제 위험을 줄이는 대신 가중치가 낮은 자산으로 옮겨 가려는 유인을
            갖습니다. 규제의 역사는 상당 부분 이 유인과 싸운 역사입니다.
          </p>
        </div>
        ...
        <div id="gaming-the-weights" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              가중치가 낮은 자산으로 옮기면 실제 위험이 그대로여도 비율이 올라갑니다. 그래서 규제는 위험을 반영한 비율 하나만 두지 않고 가중치를 전혀 쓰지 않는 단순 비율을 바닥으로
              함께 둡니다. 두 기준 가운데 더 까다로운 쪽이 실제 제약이 됩니다.
            </p>
          </div>
      ...
      <section id="liquidity" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            자본은 손실을 받아 내는 층이지 오늘 지급할 현금이 아닙니다. 3편에서 본 만기 불일치는 자본이 두꺼워도 그대로 남아 있습니다. 자산이 멀쩡해도 인출이 몰리면 지급하지 못하고
            급히 팔면 앞 절의 전염 경로가 열립니다.
          </p>

          <p className="leading-7">
            그래서 건전성 규제는 두 축으로 갑니다. 손실을 견디는 능력과 현금을 내줄 수 있는 능력입니다. 뒤쪽은 짧은 기간의 인출에 대비해 빨리 팔 수 있는 자산을 일정 비율 이상 들고
            있게 하고 조달을 지나치게 짧은 자금에만 의존하지 못하게 하는 방식으로 다룹니다.
          </p>
        ...
        <div id="two-axes" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            <p className="leading-7">
              자본과 유동성을 뭉뚱그리면 &ldquo;규제가 강해졌다&rdquo;는 말만 남습니다. 앞 글의 예금보험과 최종대부자가 서로 다른 실패를 막았듯 이 둘도 다른 실패를
              막습니다.
            </p>
          </div>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            자본비율을 지키라는 요구는 나쁠 때 더 아프게 작동합니다. 경기가 나빠져 자산이 깎이면 분자인 자본이 줄고 동시에 대출의 위험 가중치가 올라 분모가 커집니다. 비율을 맞추려면
            대출을 줄이거나 자산을 팔아야 하고 그 행동이 경기를 더 나쁘게 만듭니다.
          </p>

          <p className="leading-7">
            이 성질을 경기순응성이라 합니다. 규제는 여기에 별도의 장치로 대응합니다. 좋을 때 완충자본을 더 쌓아 두게 했다가 나쁠 때 풀어 주는 방식입니다. 규제가 한 겹으로 끝나지
            않고 계속 층이 늘어나는 이유가 이런 되먹임 때문입니다.
          </p>
        </div>
        ...
        >
          <p className="leading-7">
            위험 가중치를 정해 두면 가중치가 낮은 쪽으로 옮겨 갈 유인이 생깁니다. 규제 대상을 은행으로 한정하면 같은 일을 하는 활동이 은행 밖으로 나갑니다. 어느 쪽이든 측정된 위험은
            줄지만 실제 위험은 그대로이거나 오히려 덜 보이는 곳으로 이동합니다.
          </p>
          <p className="leading-7">
            그러니 규제는 한 지표에 기대지 않고 여러 기준을 겹쳐 둡니다. 위험 기준 비율 옆에 가중치를 쓰지 않는 단순 비율을 두고 평상시 숫자 옆에 스트레스 상황의 숫자를 두는
            식입니다. 하나가 우회되어도 다른 하나가 남게 하려는 설계입니다.
          </p>
          <p className="leading-7">
            이것은 규제가 실패했다는 뜻이 아니라 이 문제가 한 번에 닫히는 종류가 아니라는 말입니다. 기준을 만들면 행동이 바뀌고 바뀐 행동이 새 기준을 부릅니다. 금융 규제를 읽을 때
            개별 수치보다 이 되먹임 구조를 먼저 보는 편이 오래 남습니다.
          </p>
        </ProgressiveDetail>
