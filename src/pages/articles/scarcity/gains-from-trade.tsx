    ...
    <div className="space-y-16">
      ...
      <section id="two-advantages" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 갈림은 우연이 아닙니다. 한 사람이 두 가지를 모두 상대보다 싸게
            만들 수는 없습니다. 한쪽이 싸다는 것은 그 값을 재는 기준이 된 다른
            쪽이 비싸다는 뜻이라, 두 값은 서로의 뒤집은 값이기 때문입니다.
          </p>
        </div>
      ...
      <section id="where-gain-comes-from" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            답은 무엇을 만들었는지가 바뀌었다는 데 있습니다. 교환할 수 있으면
            각자가 자기가 싸게 만드는 쪽에 시간을 몰 수 있고, 같은 시간에서 더
            많은 것이 나옵니다.
          </p>
          ...
          <p className="leading-7">
            나루도 같습니다. 직접 빵 3판을 만들면 케이크가 0개지만, 케이크 3개를
            만들어 2개를 넘기면 빵 3판에 케이크 1개가 남습니다.
          </p>

          <p className="leading-7">
            그래서 두 사람 모두 혼자서는 닿을 수 없던 조합에 닿습니다. 앞 글의
            경계선 바깥에서 소비하게 되는 것이고, 경계선이 밀린 것이 아니라
            교환이라는 다른 경로가 생긴 것입니다.
          </p>
        </div>
        ...
        >
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              그러면 가온이 빵에 몰아갈수록 가온의 빵 값이 올라가고, 어느
              지점에서 상대의 값과 만납니다. 그 지점에서 멈추는 것이 답입니다.
              앞 글의 한 단위 판정이 여기에도 그대로 적용됩니다.
            </p>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 구간이 열려 있다는 것까지만 나왔습니다. 1판과 2판 사이 어디가
            될지는 이 계산으로 정해지지 않습니다. 두 사람이 서로의 값을 알고 마주
            앉아 다투면 정해지겠지만, 시장에는 마주 앉을 상대가 수천 명입니다.
          </p>
          ...
          <p className="leading-7">
            다음 글부터는 그 숫자가 어떻게 정해지는지를 봅니다. 그것이 가격이고,
            앞의 두 글에서 나온 기회비용이 그 숫자의 재료가 됩니다.
          </p>
