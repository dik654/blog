...
export default function ModernGpuComparisonArticle(){return <article className="space-y-14">
  <section id="overview" className="space-y-6">
    ...
    <p>먼저 model·dataset·batch·precision·latency SLA와 concurrency를 고정하고 후보가 memory와 software 조건을 만족하는지 확인합니다. 그 뒤 같은 implementation에서 achieved throughput·latency·power를 측정합니다. 일반적인 Roofline은 <a className="text-primary hover:underline" href="/cs/gpu/gpu-architecture#gpu-peak-achieved-boundary">GPU architecture 정본</a>, PCIe·NVLink 경계는 <a className="text-primary hover:underline" href="/cs/gpu/gpu-interconnects">GPU interconnect 정본</a>, GPU–HCA direct path는 <a className="text-primary hover:underline" href="/cs/gpu/rdma-roce#gpudirect-topology">RDMA·RoCE 정본</a>을 재사용합니다.</p>
    <GpuChoiceFlowViz />
