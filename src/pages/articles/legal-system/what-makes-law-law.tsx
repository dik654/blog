    ...
    <div className="space-y-16">
      ...
      <section id="why-form-matters" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 형식 조건은 내용과 무관한 껍데기가 아닙니다. 그것이 무너지면
            법은 사람을 이끄는 장치에서 사후에 벌할 근거로 성격이 바뀌고, 그
            성격의 차이가 1절에서 협박과 법을 갈라 놓았던 바로 그 차이입니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            다만 앞 절의 조건들이 여기서 한 가지를 말해 줍니다. 심하게 부당한
            규범일수록 형식 조건을 함께 어기는 경향이 있다는 것입니다. 지목해서
            만들고, 공포하지 않고, 소급해 적용하고, 적힌 것과 다르게 집행하는 일이
            함께 나타납니다. 형식만 보고도 상당 부분이 걸러진다는 뜻이지만, 전부
            걸러진다는 뜻은 아닙니다.
          </p>
        </ProgressiveDetail>
      </section>
