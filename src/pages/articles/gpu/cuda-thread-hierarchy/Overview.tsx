  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          CUDA 프로그램은{" "}
          <strong>Grid &rarr; Block &rarr; Warp &rarr; Thread</strong> 4단계
          계층으로 구성된다.
          <br />
          커널 함수를 한 번 호출하면 Grid 하나가 생성되고, 그 안에 수백~수천
          개의 Block이 포함된다.
        </p>
        <p>
          각 Block은 최대 <strong>1024개</strong> 스레드를 담을 수 있다.
          <br />
          Block 내부의 스레드 32개가 하나의 <strong>Warp</strong>를 이루고, Warp
          단위로 명령어가 동시에 실행된다.
          <br />
        ...
        <p>
          Block과 Grid는 각각 3차원(x, y, z)으로 구성할 수 있다. 1D 벡터
          연산에는 x축만 사용하고, 2D 이미지 처리에는 x, y축을 모두 활용한다.
          <br />
        ...
        <p>
          소프트웨어 계층은 하드웨어에 직접 대응된다.
          <br />
          Block은 SM 하나에 통째로 배정되므로, 같은 Block의 스레드끼리만 공유
          메모리를 사용할 수 있다.
          <br />
