  ...
  return (
    <section id="cluster" className="mb-16 scroll-mt-20">
      <h2 className="text-2xl font-bold mb-6">
        Thread Block Cluster & 분산 공유 메모리
      </h2>
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          기존 CUDA는 Thread, Warp, Block, Grid의 4계층 구조였습니다.
          <br />
          블록 간 통신은 글로벌 메모리와 <code>__threadfence()</code>에 의존해야
          했고, 이는 L2 캐시 경유로 느렸습니다.
        </p>
        <p className="leading-7">
          Hopper는 Block과 Grid 사이에 <strong>Cluster</strong> 계층을
          추가했습니다.
          <br />
          클러스터는 같은 GPC(Graphics Processing Cluster) 내에 배치가 보장되는
          블록 그룹입니다.
          <br />
        ...
        <CitationBlock
          source="NVIDIA CUDA C++ Programming Guide -- Thread Block Clusters"
          citeKey={4}
          type="paper"
          href="https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#thread-block-clusters"
        >
          <p className="italic">
            "A cluster is a group of thread blocks that are guaranteed to be
            concurrently scheduled onto a group of SMs within a GPC."
          </p>
        </CitationBlock>
        ...
        <p className="leading-7">
          ...
          <code>cluster.map_shared_rank()</code>로 이웃 블록의 공유 메모리
          포인터를 획득하고,
          <strong>SM 간 네트워크</strong>를 통해 L2를 경유하지 않고 데이터를
          읽습니다.
          <br />
