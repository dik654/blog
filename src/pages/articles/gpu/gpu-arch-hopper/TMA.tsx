    ...
    <section id="tma" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          기존 CUDA에서 다차원 텐서를 공유 메모리로 로드하려면, 각 스레드가
          인덱스를 계산하고 경계를 검사해야 했습니다.
          <br />
          스레드 수백 개가 동일한 주소 계산 로직을 반복 실행합니다.
          비효율적입니다.
        </p>
        <p className="leading-7">
          Hopper의 <strong>TMA</strong>는 SM 내부에 탑재된 하드웨어 유닛입니다.
          <br />
          텐서 형상(shape, stride, data type)을 <strong>TMA 디스크립터</strong>
          에 미리 인코딩해 두면,
          <code>cp.async.bulk</code> 명령 하나로 글로벌 메모리에서 공유 메모리로
          DMA 전송을 수행합니다.
          <br />
        ...
        <CitationBlock
          source="NVIDIA H100 Whitepaper -- Tensor Memory Accelerator"
          citeKey={3}
          type="paper"
          href="https://resources.nvidia.com/en-us-tensor-core"
        >
          <p className="italic">
            "TMA supports up to 5-dimensional tensor addressing, handles
            out-of-bounds clamping automatically, and works asynchronously
            without occupying CUDA cores."
          </p>
        </CitationBlock>
