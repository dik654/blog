  ...
  return (
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ZK 증명은 두 단계로 나뉜다. <strong>witness 생성</strong>(제약
          시스템을 풀어 모든 와이어 값을 계산)과
          <strong>증명 생성</strong>(MSM/NTT로 다항식 커밋먼트를 계산)이다.
          <br />
          GPU 가속 연구는 증명 생성에 집중되어 왔지만, witness 생성이 전체
          시간의 <strong>40-70%</strong>를 차지하는 경우가 많다.
        </p>

        <CitationBlock
          source="Scroll Tech -- zkEVM Prover Architecture"
          citeKey={1}
          type="code"
          href="https://github.com/scroll-tech/zkevm-circuits"
        >
          <p className="text-xs">
            Scroll zkEVM 프로파일링에서 witness 생성이 전체 증명 파이프라인의
            60% 이상을 차지한다.
            <br />
        ...
        <p className="text-sm text-muted-foreground mt-2">
          회로 복잡도가 높을수록 witness 비중이 커진다. zkEVM처럼 EVM
          시뮬레이션이 필요한 경우 특히 심하다.
        </p>
      </div>
    </section>
  );
