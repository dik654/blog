    ...
    <section id="groth16-flow" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <br />
          <strong>Witness 계산</strong>만 CPU에서 실행되고, 나머지는 전부
          GPU에서 처리합니다.
          <br />
          핵심은 3번의 대규모 MSM입니다. 각각 n개 포인트를 처리하므로 GPU
          활용률이 높습니다.
        </p>
        <CitationBlock
        ...
        <CodePanel
          title="Groth16 GPU 커널 호출 순서"
          code={groth16PipelineCode}
          annotations={[
            { lines: [3, 4], color: "sky", note: "CPU 전용: witness 계산" },
            {
              lines: [6, 9],
              color: "emerald",
              note: "GPU NTT: 3회 다항식 평가",
            },
            {
              lines: [11, 13],
              color: "violet",
              note: "GPU INTT: H(x) 몫 다항식",
            },
            {
              lines: [15, 18],
              color: "amber",
              note: "GPU MSM: 증명 원소 (병목)",
            },
        ...
        <p className="mt-4">
          CRS(Common Reference String)를 GPU 메모리에 상주시키면 H2D 전송 비용을
          제거할 수 있습니다.
          <br />
