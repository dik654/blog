    ...
    <section id="overview" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ...
          <br />
          Witness를 만들고, 다항식을 평가(NTT)하고, 타원곡선 위에서
          커밋(MSM)합니다.
          <br />이 중 MSM이 전체 시간의 60-70%, NTT가 20-30%를 차지합니다.
        </p>
        <CitationBlock
          source="Filecoin bellperson — GPU Groth16 Prover"
          citeKey={1}
          type="code"
        ...
        <p>
          GPU가 효과적인 이유는 두 연산 모두 <strong>대규모 병렬 처리</strong>에
          적합하기 때문입니다.
          <br />
        ...
        <CodePanel
          title="증명 파이프라인 전체 구조"
          code={pipelineOverviewCode}
          annotations={[
            {
              lines: [3, 8],
              color: "sky",
              note: "Witness -> NTT -> MSM -> Proof 흐름",
            },
