  ...
  return (
    <section id="sppark" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          <strong>sppark</strong>는 Supranational이 개발한 프로덕션 MSM
          라이브러리다.
          <br />
          Filecoin의 SupraSeal에 통합되어 실제 증명 생성에 사용된다.
          <br />
          Rust 프론트엔드와 CUDA 백엔드로 구성되며, BLS12-381과 BN254 곡선을
          지원한다.
        </p>
        <CodePanel
          title="sppark 아키텍처와 핵심 최적화"
          code={archCode}
          annotations={[
        ...
        <p>
          Jacobian 좌표 덧셈은 16회 곱셈이 필요하지만, Affine 혼합 덧셈은 6회로
          끝난다.
          <br />
          Montgomery's trick으로 n개 역원을 곱셈 3(n-1)회 + 역원 1회로 처리하면
          모든 점을 Affine로 변환할 수 있다. sppark는 이 기법으로 bellperson
          대비 약 2배 빠르다.
        </p>
        <CodePanel
          title="Montgomery's Trick (Batch Inversion)"
          code={batchAffine}
          annotations={[
