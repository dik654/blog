    ...
    <section id="naive" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p className="leading-7">
          가장 단순한 구현입니다. 각 스레드가 A의 한 행 전체와 B의 한 열 전체를{" "}
          <strong>글로벌 메모리</strong>에서 직접 읽습니다.
        </p>
          ...
          annotations={[
            {
              lines: [3, 4],
              color: "sky",
              note: "글로벌 (row, col) 인덱스 계산",
            },
            {
              lines: [7, 10],
              color: "emerald",
              note: "내적: A 행 x B 열 순회",
            },
            {
              lines: [17, 19],
              color: "amber",
              note: "16x16 블록으로 커널 실행",
            },
          ]}
        />
        ...
        <p className="leading-7">
          C의 한 행에 속하는 K개의 스레드가 <strong>모두 A의 동일한 행</strong>
          을 읽습니다.
          <br />
          A의 한 원소는 K번 중복 로드됩니다.
          <br />
        ...
        <p className="leading-7">
          N=1024인 정사각 행렬 기준, 글로벌 메모리 로드 횟수는 약{" "}
          <strong>2 * 10^9</strong>회입니다.
          <br />
          글로벌 메모리 대역폭(~900 GB/s)이 연산 처리량(~30 TFLOPS)보다 훨씬
          먼저 포화됩니다.
          <br />이 병목을 해결하려면 공유 메모리 타일링이 필요합니다.
        </p>
      </div>
    </section>
  );
