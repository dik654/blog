  ...
  return (
    <section id="benchmark" className="mb-16 scroll-mt-20">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          ICICLE의 성능을 bellperson, sppark과 비교한다.
          <br />
        ...
        <p>
          ICICLE은 Pippenger 알고리즘을 최적화한 버킷 방식을 사용한다. 2^20
          포인트 이상에서 bellperson 대비 <strong>5~6배</strong> 빠르고,
          sppark과 유사하거나 소폭 우위다.
        </p>
        <CodePanel
          title="MSM 벤치마크: ICICLE vs bellperson vs sppark"
          code={scalingCode}
          annotations={[
        ...
        <p>
          NTT는 butterfly 연산이 규칙적이어서 GPU 점유율이 높다. 2^26 크기에서
          CPU 대비 <strong>100배 이상</strong> 빠르며, 입력이 클수록 격차가
          벌어진다.
        </p>
        <CodePanel
          title="NTT 벤치마크: GPU vs CPU"
          code={nttScalingCode}
          annotations={[
        ...
        >
          <p className="text-xs">
            H100의 SM 수(132개)가 A100(108개)보다 22% 많고, 클럭도 높아 단일 GPU
            성능이 ~1.6x 향상된다.
            <br />
            NVLink 4.0 기반 Multi-GPU에서 GPU 간 대역폭이 900GB/s로, 스케일링
            효율이 높다.
          </p>
        </CitationBlock>
      </div>
