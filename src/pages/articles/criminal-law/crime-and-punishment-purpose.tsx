    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 다른 장치가 따로 있습니다. 당한 쪽이 아니라 국가가 나서고 값을 물리는 대신 벌합니다. 그런데 벌하는 것은 아무것도 만들어 내지 않고 비용만 듭니다. 그럼에도 왜
            하는지부터 물어야 합니다.
          </p>
        </div>
      ...
      <section id="four-reasons" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            둘째는 앞으로 같은 일이 덜 일어나게 한다는 것입니다. 이 답은 형량을 효과에 묶습니다. 같은 죄라도 막기 어려우면 더 벌하는 것이 정당해지고 벌해도 줄지 않으면 벌할 이유가
            약해집니다.
          </p>

          <p className="leading-7">
            셋째는 그 사람이 당분간 하지 못하게 떼어 놓는다는 것이고 넷째는 그 사람을 바꾸어 다시 하지 않게 한다는 것입니다. 셋째는 기간에, 넷째는 처우의 내용에 묶습니다.
          </p>
      ...
      <section id="deterrence" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            네 이유 가운데 둘째만 숫자로 다룰 수 있습니다. 앞으로 덜 일어나게 한다는 것은 사람들이 그 일을 할지 말지를 어떻게 정하는지에 대한 가정을 깔고 있고 그 가정을 적으면
            계산이 나오기 때문입니다.
          </p>

          <p className="leading-7">
            가정은 단순합니다. 그 일로 얻는 것과 그 일 때문에 잃을 것을 견준다는 것입니다. 잃을 것은 잡혔을 때의 형량이지만 잡히지 않을 수도 있으므로 잡힐 확률을 곱해야 합니다.
          </p>
      ...
      <section id="why-severity-fails" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 잘 듣지 않습니다. 이유가 넷이고 넷 다 앞 절 계산의 전제가 깨지는 지점입니다.
          </p>

          <p className="leading-7">
            첫째는 확률을 잘못 안다는 것입니다. 형량은 법전에 적혀 있지만 검거율은 적혀 있지 않고 사람들은 자기가 잡히지 않을 것이라고 생각하는 쪽으로 기웁니다. 그러면 곱의 한쪽이
            실제보다 작게 계산됩니다.
          </p>
          ...
          <p className="leading-7">
            셋째는 잘못 벌했을 때의 대가입니다. 형량이 커질수록 한 번의 오판이 내는 손해가 커지고 판단하는 쪽도 그것을 알기 때문에 유죄 인정에 더 신중해집니다. 그러면 형량을 올린
            만큼 확률이 내려가 곱이 그대로이거나 오히려 줄어듭니다.
          </p>
        </div>
        ...
        <div id="marginal-deterrence" className="scroll-mt-20">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p className="leading-7">
              그래서 형량에는 층이 있어야 합니다. 더 무거운 일에 더 무거운 형이 매겨져 있어야 이미 가벼운 쪽을 저지르기로 한 사람에게도 거기서 멈출 이유가 남습니다. 억제는 하느냐
              마느냐만이 아니라 어디까지 하느냐에도 걸립니다.
            </p>
      ...
      <section id="legality" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그래서 첫 글에서 본 형식 조건이 여기서 가장 엄격한 형태로 나타납니다. 무엇이 범죄인지와 얼마를 치르는지가 행위 이전에 문언으로 적혀 있어야 하고 그 문언을 넓혀 처벌 범위를
            늘리는 것도 막힙니다.
          </p>

          <p className="leading-7">
            이것을 억제만으로 정당화하면 절반입니다. 미리 알려져 있어야 한다는 요구는 계산이 가능해야 한다는 데서도 나오지만 조심할 방법이 있어야 한다는 데서도 나옵니다. 두 번째 이유는
            억제가 전혀 작동하지 않는 경우에도 남습니다.
          </p>

          <p className="leading-7">
            그래서 이 요구는 형벌의 목적이 무엇이든 유지됩니다. 값하는 만큼 갚는다는 답을 택해도 행위 시점에 무엇이 금지되어 있었는지는 여전히 먼저 정해져 있어야 합니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            형량이 가벼우면 애매한 사건에서 유죄로 기울어도 잘못했을 때의 손해가 작습니다. 형량이 아주 무거우면 같은 애매함에서 무죄로 기웁니다. 그래서 법정형을 올린 만큼 실제 유죄율이
            내려가고 곱이 생각만큼 커지지 않습니다.
          </p>
          <p className="leading-7">
            이 연결이 다음 글의 주제와 이어집니다. 얼마나 확실해야 유죄로 할 것인가는 두 종류의 잘못을 어떻게 저울질하느냐의 문제이고 그 저울이 형량의 크기에 따라 기웁니다.
          </p>
        </ProgressiveDetail>
      </section>
