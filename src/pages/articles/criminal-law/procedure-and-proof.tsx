    ...
    <div className="space-y-16">
      <section id="overview" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            출발점은 틀리는 방식이 둘이라는 것입니다. 하지 않은 사람을 벌하는 것과
            한 사람을 놓아주는 것이고, 둘의 무게가 같지 않습니다.
          </p>
        </div>
      ...
      <section id="two-errors" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            앞쪽은 없던 불이익을 새로 만듭니다. 그 사람은 조심해서 피할 방법이
            애초에 없었고, 이미 치른 것은 되돌릴 수 없습니다. 그리고 그 일이
            알려지면 다른 사람들도 조심해서 피할 수 있다는 믿음을 잃습니다.
          </p>

          <p className="leading-7">
            뒤쪽은 손해를 남기고 억제를 약하게 만듭니다. 심각한 결과이지만
            성격이 다릅니다. 그 사람에게 없던 불이익이 새로 생기지는 않고,
            앞 글의 계산에서 확률이 조금 내려가는 형태로 나타납니다.
          </p>
      ...
      <section id="threshold" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          <p className="text-lg leading-8">
            증거를 다 보고 나면 그 사람이 했을 확률에 대한 판단이 남습니다. 완전히
            확실한 경우는 드물고, 대개는 어느 정도 그럴듯하다는 상태입니다.
          </p>
      ...
      <section id="burden" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            이 배치가 만드는 것이 몇 가지 있습니다. 먼저 스스로 하지 않았음을
            보일 필요가 없어집니다. 하지 않았다는 것을 보이는 일은 대개 훨씬
            어렵고, 어떤 경우에는 불가능합니다.
          </p>
          ...
          <p className="leading-7">
            그리고 앞 글의 계산과 다시 만납니다. 문턱이 높을수록 실제 유죄 확률이
            내려가므로, 같은 형량이라도 막는 힘이 줄어듭니다. 문턱을 높이는 것은
            공짜가 아닙니다.
          </p>
        </div>
      ...
      <section id="how-evidence" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            첫째는 그 증거가 실제로는 확률을 올려 주지 않는 경우입니다. 강요로 얻은
            진술은 한 사람이 하지 않았어도 나올 수 있으므로, 했다는 쪽으로 확률을
            올려 주지 못합니다. 쓰지 않는 것이 정확성 자체를 위한 선택입니다.
          </p>

          <p className="leading-7">
            둘째는 앞으로의 행동입니다. 그렇게 얻은 증거를 쓸 수 있게 두면 그렇게
            얻을 유인이 생깁니다. 개별 사건에서는 정확성을 조금 잃지만, 그 방식이
            반복되는 것을 막아 전체적으로는 잃지 않습니다.
          </p>
        </div>
        ...
        >
          ...
          <p className="leading-7">
            그래서 이 배제는 정확성을 희생해 다른 가치를 사는 거래가 아니라,
            상당 부분은 정확성 자체를 위한 정리입니다. 이 점이 흐려지면 배제 규칙이
            언제나 값을 치르는 것처럼 보입니다.
          </p>
          <p className="leading-7">
            다만 전부가 그렇지는 않습니다. 절차를 어겨 얻었지만 내용은 믿을 만한
            증거도 있고, 그때는 실제로 값을 치릅니다. 그 값을 치르는 이유가 앞으로
            그렇게 얻을 유인을 없애는 데 있다는 것을 분명히 해 두어야, 어디까지
            배제할지를 따질 수 있습니다.
          </p>
        </ProgressiveDetail>
      </section>
      ...
      <section id="boundary" className="scroll-mt-20">
        ...
        <div className="prose prose-neutral max-w-none dark:prose-invert">
          ...
          <p className="leading-7">
            그런데 이 절차가 실제로 돌아가는 사건은 전체의 아주 일부입니다.
            대부분의 분쟁은 판결이 아니라 합의로 끝나고, 형사에서도 다투지 않고
            끝나는 경우가 많습니다.
          </p>
