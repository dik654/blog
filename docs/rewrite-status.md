...
- [x] Knowledge graph 전용 `audit:graph --strict`: 1,785개 concept·2,611개 relation의 owner·canonical path·edge·고립·화면 stage coverage 통과
- [x] 현재 등록된 267개 글은 canonical owner·anchor·entry-level 재귀 선수 경로·기초 6개+심화 4개 coverage 통과
